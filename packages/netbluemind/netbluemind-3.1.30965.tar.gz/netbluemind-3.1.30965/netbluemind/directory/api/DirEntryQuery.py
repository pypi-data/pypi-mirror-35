...
class __DirEntryQuerySerDer__:
    ...
    def parseInternal(self, value, instance):
        ...
        instance.accountTypeFilter = __DirEntryAccountTypeSerDer__().parse(accountTypeFilterValue)
    ...
    def encodeInternal(self, value, instance):
        ...
        from netbluemind.directory.api.DirEntryAccountType import __DirEntryAccountTypeSerDer__
        accountTypeFilterValue = value.accountTypeFilter
        instance["accountTypeFilter"] = __DirEntryAccountTypeSerDer__().encode(accountTypeFilterValue)
