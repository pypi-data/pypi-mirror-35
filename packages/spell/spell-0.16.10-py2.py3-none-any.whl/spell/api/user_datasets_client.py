...
class UserDatasetsClient(base_client.BaseClient):
    ...
    def new_dataset(self, name):
        ...
        """
        payload = {"name": name}
        r = self.request("post", USER_DATASET_RESOURCE_URL, payload=payload)
    ...
    def remove_dataset(self, name):
        ...
        """
        payload = {"name": name}
        r = self.request("delete", USER_DATASET_RESOURCE_URL, payload=payload)
        self.check_and_raise(r)
    ...
    def complete_upload(self, dataset_id):
        ...
        """
        r = self.request("post", url_path_join(USER_DATASET_RESOURCE_URL, str(dataset_id), "upload_complete"))
        self.check_and_raise(r)
