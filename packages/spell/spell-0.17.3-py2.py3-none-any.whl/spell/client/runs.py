    ...
    def new(self, **kwargs):
        ...
        Args:
            ...
            workspace_label (str, optional): a workspace commit label for code to include in the run. Only applicable
                ...
                client is set or a :obj:`workflow_id` is provided). The value must correspond to one of the workspace
                commit labels specified upon workflow creation.
            ...
            workflow_id (int, optional): the id of the workflow to which this run will be associated.  This argument
                is unnecessary if the :py:attr:`~spell.client.SpellClient.active_workflow` of the client is set
                and this argument will take precedence if they differ.
