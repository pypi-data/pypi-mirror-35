...
class RunRequest:
    ...
    """
    def __init__(self, machine_type="CPU", command='', workspace_id=0, commit_hash='', commit_label='',
                 cwd='', root_directory='', pip_packages=None, apt_packages=None, docker_image=None, framework=None,
                 ...
                 idempotent=False, local_root=None, workflow_id=0):
