...
class AdvancedScorecardBuilder(object):
    ...
    def __str__(self):
        ''' Just for FUN '''
        return '<AMA Institute | Advanced Scorecard Builder>'
    ...
    def fit(self,
        ...
        _, self.model_info_ = self.__get_model_info(
    ...
    def html_report(self, name='report.html', features=None):
        ...
        <html>
            ...
            <img src="https://amainstitute.pl/wp-content/themes/ama/assets/images/ama_logo.png">
            </div>
