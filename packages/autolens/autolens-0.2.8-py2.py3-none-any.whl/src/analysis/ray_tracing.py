...
class AbstractTracer(object):
    ...
    def galaxy_images(self):
        ...
        galaxy_images: [ndarray]
            An basic for each galaxy in this ray tracer
        """
...
class Tracer(AbstractTracer):
    ...
    def __init__(self, lens_galaxies, source_galaxies, image_plane_grids, cosmology=None):
        """The ray-tracing calculations, defined by a lensing system with just one basic-plane and source-plane.
        ...
        lens_galaxies : [Galaxy]
            The list of lens galaxies in the basic-plane.
        source_galaxies : [Galaxy]
            The list of source galaxies in the source-plane.
        image_plane_grids : mask.GridCollection
            The basic-plane coordinate grids where ray-tracing calculation are performed, (this includes the
            basic-grid, sub-grid, blurring-grid, etc.).
    ...
    def generate_image_of_galaxy_light_profiles(self):
        """Generate the basic of the galaxies over the entire ray trace."""
    ...
    def generate_blurring_image_of_galaxy_light_profiles(self):
        """Generate the basic of all galaxy light profiles in the blurring regions of the basic."""
...
class TracerGeometry(object):
    ...
    def __init__(self, redshifts, cosmology):
        """The geometry of a ray-tracing grid comprising an basic-plane and source-plane.
...
class Plane(object):
    ...
    def __init__(self, galaxies, grids, compute_deflections=True):
        ...
        The basic-plane coordinates are defined on the observed basic's uniform regular grid_coords.
        ...
        mask.GridCollection The grids of (x,y) coordinates in the plane, including the basic grid_coords,
    ...
    def generate_image_of_galaxy_light_profiles(self):
        """Generate the basic of the galaxies in this plane."""
