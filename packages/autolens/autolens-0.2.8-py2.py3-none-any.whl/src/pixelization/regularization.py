...
class RegularizationWeighted(object):
    ...
    def pix_signals_from_images(self, image_to_pix, galaxy_image):
        """Compute the (scaled) signal in each pixel, where the signal is the sum of its basic-pixel fluxes. \
        ...
        1) Divided by the number of basic-pixels in the pixel, to ensure all pixels have the same \
        ...
        regularizations weights they're used to compute are defined identically for all basic units / SNR's.
