...
class Reconstructor(object):
    ...
    def __init__(self, mapping, regularization, image_to_pix, sub_to_pix):
        ...
        image_to_pix : ndarray
            The mapping between each basic-grid pixel and pixelization-grid pixel.
        sub_to_pix : ndarray
    ...
    def reconstruct_image(self, image, noise, convolver):
        """Fit the basic data using the inversion."""
...
class Reconstruction(object):
    ...
    def model_image_from_reconstruction_jit(self):
        """ Map the reconstruction pix s_vector back to the basic-plane to compute the pixelization's model-basic.
        """
