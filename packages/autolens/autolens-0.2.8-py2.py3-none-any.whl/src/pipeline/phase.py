...
class Phase(object):
    ...
    def make_analysis(self, image, previous_results=None):
        """
        Create an analysis object. Also calls the prior passing and basic modifying functions to allow child classes to
    ...
    class Result(non_linear.Result):
        ...
        def __init__(self, constant, likelihood, variable, galaxy_images):
            ...
            galaxy_images: [ndarray]
                A collection of images created by each individual galaxy which taken together form the full model basic
            """
    ...
    def modify_image(self, image, previous_results):
        """
        Customize an basic. e.g. removing lens light.
        ...
        -------
        basic: img.Image
            The modified basic (not changed by default)
        """
        return image
...
class SourceLensPhase(Phase):
    ...
    class Analysis(Phase.Analysis):
        ...
        def fit(self, lens_galaxy=None, source_galaxy=None):
            """
            Determine the fit of a lens galaxy and source galaxy to the basic in this analysis.
            ...
            -------
            fit: Fit
                A fractional value indicating how well this model fit and the model basic itself
            """
            logger.debug(
