...
class Analysis(object):
    ...
    def __init__(self, image, mask, sub_grid_size=4, cluster_grid_size=3, model_image=None, galaxy_images=None,
                 minimum_values=None):
        """
        An analysis object. Once set up with an basic and mask it takes a set of objects describing a model and
        determines how well they fit the basic.

        Parameters
        ----------
        image: Image
            An basic of a lens with associated metadata
        mask: Mask
            A mask describing the region of the basic to be modelled
        sub_grid_size: int
        ...
        logger.info("Analysis created for basic "
    ...
    def fit(self, lens_galaxies=empty_array, source_galaxies=empty_array, hyper_image=None):
        """
        Runs the analysis. Determines how well the supplied model fits the basic.
