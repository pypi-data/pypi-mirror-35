...
from swimbundle_email import EmailAttachment, EmailParser, EmailAttachmentList
...
class MSGParser(EmailParser):
    ...
    """
    def __init__(self, fn, email_data):
        """
        Parse an MSG File
        :param fn: filename of msg file
        :param email_data: base64 data of the MSG file
        """
        super(MSGParser, self).__init__(fn, email_data)
    ...
    def get_reply_to(self):
        return self.msg._getStringStream('__substg1.0_1042')

    def get_id(self):
        return self.msg._getStringStream('__substg1.0_1035')

    def get_sender(self):
        return self.msg.sender or ""

    def get_plaintext_body(self):
        return self.msg.body or ""
