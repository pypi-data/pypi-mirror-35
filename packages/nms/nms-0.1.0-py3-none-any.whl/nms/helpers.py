...
def rects2polys(rects, theta=0, origin=(0,0), ratioWidth=1, ratioHeight=1):
    ...
    :type rects: tuple
    :param theta: the angle of rotation for the rectangle in radians, defaults to 0
    :type theta: float
    :param origin: the point to rotate the rectangle around, default to (0,0)
    :type origin: tuple
    ...
    for index, box in enumerate(rects):
        ...
        rotationPoint = (int(origin[0] * ratioWidth), int(origin[1] * ratioHeight))
