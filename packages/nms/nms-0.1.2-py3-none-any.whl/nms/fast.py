...
The functions in this module are not usually called directly.  Instead use :func:`nms.nms.nms_boxes`,
:func:`nms.nms.nms_rboxess`, or :func:`nms.nms.nms_polygons`
...
def rectangle_iou(rectA, rectB):
    """Computes the ratio of the intersection area of the input rectangles to the (sum of rectangle areas -
    intersection area). Used with the NMS function.
...
def NMS(boxes, scores, **kwargs):
    ...
    As translated from the openCV c++ source in `nms.inl.hpp <https://github.com/opencv/opencv/blob/ee1e1ce377aa61ddea47a6c2114f99951153bb4f/modules/dnn/src/nms.inl.hpp#L67>`_
    which was in turn inspired by `Piotr Dollar's NMS implementation in EdgeBox. <https://goo.gl/jV3JYS>`_

    This function is not usually called directly.  Instead use :func:`nms.nms.nms_boxes`, :func:`nms.nms.nms_rboxess`, or :func:`nms.nms.nms_polygons`
    ...
    :returns: an array of indicies of the best boxes
    :kwargs:
    ...
    * eta (float): a coefficient in adaptive threshold formula: nms_thresholdi+1=eta⋅nms_threshold, default: 1.0
