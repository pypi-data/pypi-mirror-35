...
def make_soul_map(device):
    ...
    for func in get_functions(device):
        ...
        soul_map[name_function(func[1], device).encode(encoding='ascii')] = m.hexdigest()[:4]
    return soul_map
...
def assemble(module):
    ...
    for device in devices:
        ...
        for func in functions:
            ...
            cases += make_comm_case(func[1], device, int(soul_map[name_function(func[1], device)], 16))
