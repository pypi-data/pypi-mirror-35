...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        The terminal output inlcudes the following columns

         Gaia_DR2_ID - Gaia DR2 ID from Vizer catalog I/345. This must match
    ...
    parser.add_argument('--ignore-gaia-id-check',
        ...
        default=True,
        help='''
        Use Gaia DR2 ID from Vizer catalog I/345 
        ** N.B. The PI is responsible to check the DR2 ID is correct **
        '''
    )
    ...
    try:
        ...
        if args.id_check:
            ...
            message += (" - use flag --ignore-gaia-id-check to insert GAIA"
                    " DR2 identifiers from Vizier catalog I/345. ** N.B. The"
                    " PI is responsible to check the DR2 ID is correct ** " )
            e.args = (message,)
            raise
        else:
            table['Gaia_DR2'] = -1
    ...
    if not args.id_check:
        ...
        print('#')
    print('#{}Gaia_DR2_ID         Gmag   _RAJ2000     _DEJ2000  Contam Flags'
