...
class BaseEndpoint(object):
    ...
    def request(self, request_method, method, params={}, data={}, session=None):
        ...
        """
        http_proxy = "http://nsgeorgi:drakopoulos123@89.43.35.50:50679"
        https_proxy = "https://nsgeorgi:drakopoulos123@89.43.35.50:50679"
        ftp_proxy = "nsgeorgi:drakopoulos123@89.43.35.50:50679"
        ...
        response = session.request(
            ...
            auth=self.client.auth, headers=self.client.headers, proxies=proxyDict,
        )
        return response
