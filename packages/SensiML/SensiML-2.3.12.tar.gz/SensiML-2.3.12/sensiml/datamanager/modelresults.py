...
class ModelMetrics(object):
    ...
    def recognize_signal(self, data, capture_file=None, stop_step=False, feature_file=None, segmenter=True, lock=True, silent=True, platform='engine', **kwargs):
        ...
        print('Loading Data.')
        kp.recognize_signal(data, capture_file=capture_file, feature_file=feature_file, stop_step=stop_step, segmenter=segmenter, platform=platform, get_result=False)
