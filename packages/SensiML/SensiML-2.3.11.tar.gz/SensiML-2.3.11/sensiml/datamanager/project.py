...
class Project(object):
    ...
    def query_optimize(self):
        ...
        if not self.schema or not len(self._captures.get_captures()):
            ...
            self._create_profile()
        print('Project has been profiled for efficient querying. If you upload any changes \n' + \
              'to the project, use dsk.project.query_optimize() again to regenerate the profile.')
