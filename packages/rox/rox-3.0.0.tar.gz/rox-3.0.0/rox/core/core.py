...
class Core:
    ...
    def setup(self, sdk_settings, device_properties, rox_options):
        ...
        internal_flags = InternalFlags(self.experiment_repository, self.parser)
        ...
        self.impression_invoker = ImpressionInvoker(internal_flags, self.custom_property_repository, device_properties, None, roxy_path is not None)
        ...
        if rox_options is not None and rox_options.configuration_fetched_handler is not None:
            self.configuration_fetched_invoker.register_configuration_fetched_handler(rox_options.configuration_fetched_handler)
        ...
        def fetch():
            ...
            if rox_options is not None and rox_options.fetch_interval is not None:
                return periodic_task.run(self.fetch, rox_options.fetch_interval)
