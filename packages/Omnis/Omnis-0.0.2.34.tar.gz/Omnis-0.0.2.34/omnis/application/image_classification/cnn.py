...
class CNN(Model):
    ...
    def init_output_dictionary_and_model(self, class_indices, num_classes):
        """Initializes self.output_dictionary and self.model.
    ...
    def prepare_y(self, target_array, class_indices, num_classes):
        ...
        Arguments:
            ...
            class_indices {dict} --
                ...
                (A reversed dictionary of self.output_dictionary)
    ...
    def train(self,
        ...
        if use_fit_generator == False:
            ...
            y_train = self.prepare_y(self.target_array, reverse_dict(self.output_dictionary), num_classes)
