...
class GraphScope(DependencyGraph):
    ...
    def __init__(self):
        ...
        # --- we override nodes and children with custom dictionaries which
        #     fallback to the underlying graph
    ...
    def __enter__(self):
        ...
        # --- recursively invalidate all ancestors of each changed node
        for changed in self.changes:
            for parent in self.parents(changed):
