...
class LogicalDeviceMeterResponseDTO(Model):
    ...
    def __init__(self, meter_id=None, meter_code=None, meter_info=None, meter_type=None, channels=None, accounts=None, commodity=None, place=None, address=None, bill_entry_note=None, include_in_energy_star=None, primary_use=None, created_by=None, created_date=None, modified_by=None, modified_date=None, properties=None, include_in_cost_avoidance=None, route=None, meter_time_zone=None):
