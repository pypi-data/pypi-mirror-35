...
class Parametrizable(object):
    ...
    def set_param_values(self, params, only_optimizable=False, trans=False):
        """

        :param params:
        :type params:
        :param only_optimizable:
        :type only_optimizable:
        :param trans:
        :type trans:
        :return:
        :rtype:
    ...
    def set_params_to_default(self, only_optimizable=False):
        """
    ...
    def get_param_values(self, only_optimizable=False, trans=False):
        """
    ...
    def get_param_keys(self, only_optimizable=False):
        """
    ...
    def get_param_n(self, only_optimizable=False):
        """
...
class WithParameters(Parametrizable):
    ...
    def set_param_values(self, params, only_optimizable=False, trans=False):
        ...
        for hyperparameter in self.hyperparameters:
            number_of_params = \
                hyperparameter.get_param_n(only_optimizable=only_optimizable)
    ...
    def get_hyperparam(self, name):
        ...
        """
        for hyperparameter in self.hyperparameters:
            hp_keys = hyperparameter.get_param_keys(only_optimizable=False)
            if hp_keys and name in hp_keys[0]:
    ...
    def get_param_value(self, name):
        ...
        value = hyperparam.get_param_values(only_optimizable=False)
...
class OptimizableParameter(Parameter):
    ...
    def set_param_values(self, params, only_optimizable=False, trans=False):
        ...
        super(OptimizableParameter, self).set_param_values(
            params, only_optimizable=only_optimizable, trans=trans
        )
...
class FixedParameter(Parameter):
    ...
    def get_param_values(self, only_optimizable=False, trans=False):
        ...
        return super(FixedParameter, self).get_param_values(
            only_optimizable=only_optimizable, trans=trans
        )
