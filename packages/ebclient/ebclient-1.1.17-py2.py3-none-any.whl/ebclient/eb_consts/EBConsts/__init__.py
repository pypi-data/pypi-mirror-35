...
REQUEST_TYPES = {
    ...
    UOTypes.RSA_GENERATE: 'RSA_GENERATE',
    UOTypes.METERING: 'METERING',
    UOTypes.AES2RSA: 'AES2RSA',
    UOTypes.RSA2AES: 'RSA2AES',
    UOTypes.DES2RSA: 'DES2RSA',
    UOTypes.RSA2DES: 'RSA2DES',
    UOTypes.GENTOKENIZETABLEROW: 'GENTOKENIZETABLEROW',
    UOTypes.GENWRAP_GENERATEKEY: 'GENWRAP_GENERATEKEY',
    UOTypes.GENWRAP_UNWRAPKEY: 'GENWRAP_UNWRAPKEY',
    UOTypes.DUKPT_REWRAP: 'DUKPT_REWRAP',
    UOTypes.DUKPT_NEWPAYTERMINAL: 'DUKPT_NEWPAYTERMINAL',
    UOTypes.DUKPT_SESSIONKEYS: 'DUKPT_SESSIONKEYS',
    UOTypes.DUKPT_PINTRANSLATE: 'DUKPT_PINTRANSLATE',
    UOTypes.DUKPT: 'DUKPT'
}
