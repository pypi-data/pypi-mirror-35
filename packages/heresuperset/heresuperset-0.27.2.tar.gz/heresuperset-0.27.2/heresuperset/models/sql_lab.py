...
from heresuperset import security_manager
from heresuperset.models.helpers import AuditMixinNullable
from heresuperset.utils import QueryStatus, user_label
...
class Query(Model):
    ...
    # Could be configured in the heresuperset config.
...
class SavedQuery(Model, AuditMixinNullable):
    ...
    def pop_tab_link(self):
        return Markup("""
            <a href="/heresuperset/sqllab?savedQueryId={self.id}">
