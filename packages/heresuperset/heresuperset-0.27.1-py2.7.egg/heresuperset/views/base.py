...
from heresuperset import conf, db, security_manager, utils
from heresuperset.exceptions import SupersetSecurityException
from heresuperset.translations.utils import get_language_pack
...
class SupersetListWidget(ListWidget):
    template = 'heresuperset/fab_overrides/list.html'
...
class ListWidgetWithCheckboxes(ListWidget):
    ...
    template = 'heresuperset/fab_overrides/list_with_checkboxes.html'
