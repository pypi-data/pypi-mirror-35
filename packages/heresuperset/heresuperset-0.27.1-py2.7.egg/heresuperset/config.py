...
from heresuperset.stats_logger import DummyStatsLogger
...
if 'SUPERSET_HOME' in os.environ:
    ...
    DATA_DIR = os.path.join(os.path.expanduser('~'), '.heresuperset')
...
SQLALCHEMY_DATABASE_URI = 'sqlite:///' + os.path.join(DATA_DIR, 'heresuperset.db')
...
APP_ICON = '/static/assets/images/heresuperset-logo@2x.png'
...
BABEL_DEFAULT_FOLDER = 'heresuperset/translations'
...
# time grains in heresuperset/db_engine_specs.builtin_time_grains).
# For example: to disable 1 second time grain:
# TIME_GRAIN_BLACKLIST = ['PT1S']
TIME_GRAIN_BLACKLIST = []

# Additional time grains to be supported using similar definitions as in
# heresuperset/db_engine_specs.builtin_time_grains.
...
DEFAULT_MODULE_DS_MAP = OrderedDict([
    ('heresuperset.connectors.sqla.models', ['SqlaTable']),
    ('heresuperset.connectors.druid.models', ['DruidDatasource']),
])
...
FILENAME = os.path.join(DATA_DIR, 'heresuperset.log')
ROLLOVER = 'midnight'
INTERVAL = 1
BACKUP_COUNT = 30
...
class CeleryConfig(object):
  ...
  CELERY_IMPORTS = ('heresuperset.sql_lab', )
...
# from CSV files. For example, 'companyname-heresuperset'
...
SMTP_STARTTLS = True
SMTP_SSL = False
SMTP_USER = 'heresuperset'
SMTP_PORT = 25
SMTP_PASSWORD = 'heresuperset'
SMTP_MAIL_FROM = 'heresuperset@heresuperset.com'
