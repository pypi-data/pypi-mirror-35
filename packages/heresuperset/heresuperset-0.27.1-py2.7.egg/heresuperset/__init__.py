...
from heresuperset import config, utils
from heresuperset.connectors.connector_registry import ConnectorRegistry
from heresuperset.security import SupersetSecurityManager

APP_DIR = os.path.dirname(__file__)
CONFIG_MODULE = os.environ.get('SUPERSET_CONFIG', 'heresuperset.config')
...
class MyIndexView(IndexView):
    @expose('/')
    def index(self):
        return redirect('/heresuperset/welcome')
...
appbuilder = AppBuilder(
    app,
    db.session,
    base_template='heresuperset/base.html',
...
from heresuperset import views  # noqa
