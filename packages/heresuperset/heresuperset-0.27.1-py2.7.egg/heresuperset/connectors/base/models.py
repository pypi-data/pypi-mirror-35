...
from heresuperset import utils
from heresuperset.models.core import Slice
from heresuperset.models.helpers import AuditMixinNullable, ImportMixin
...
class BaseDatasource(AuditMixinNullable, ImportMixin):
    ...
    def explore_url(self):
        if self.default_endpoint:
            ...
            return '/heresuperset/explore/{obj.type}/{obj.id}/'.format(obj=self)
    ...
    def query(self, query_obj):
        ...
        Should return a ``heresuperset.models.helpers.QueryResult``
        """
        raise NotImplementedError()
