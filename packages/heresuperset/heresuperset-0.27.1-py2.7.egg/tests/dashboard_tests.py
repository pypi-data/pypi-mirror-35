...
from heresuperset import db, security_manager
...
class DashboardTests(SupersetTestCase):
    ...
    def test_save_dash(self, username='admin'):
        ...
        url = '/heresuperset/save_dash/{}/'.format(dash.id)
    ...
    def test_copy_dash(self, username='admin'):
        ...
        dash_id = dash.id
        url = '/heresuperset/save_dash/{}/'.format(dash_id)
        ...
        url = '/heresuperset/copy_dash/{}/'.format(dash_id)
    ...
    def test_add_slices(self, username='admin'):
        ...
        url = '/heresuperset/add_slices/{}/'.format(dash.id)
    ...
    def test_public_user_dashboard_access(self):
        ...
        self.assertNotIn('/heresuperset/dashboard/births/', resp)
        ...
        resp = self.get_resp('/dashboard/list/')
        self.assertIn('/heresuperset/dashboard/births/', resp)

        self.assertIn('Births', self.get_resp('/heresuperset/dashboard/births/'))
        ...
        resp = self.get_resp('/dashboard/list/')
        self.assertNotIn('/heresuperset/dashboard/world_health/', resp)
    ...
    def test_dashboard_with_created_by_can_be_accessed_by_public_users(self):
        ...
        assert 'Births' in self.get_resp('/heresuperset/dashboard/births/')
    ...
    def test_owners_can_view_empty_dashboard(self):
        ...
        resp = self.get_resp('/dashboard/list/')
        self.assertNotIn('/heresuperset/dashboard/empty_dashboard/', resp)
        ...
        resp = self.get_resp('/dashboard/list/')
        self.assertIn('/heresuperset/dashboard/empty_dashboard/', resp)
