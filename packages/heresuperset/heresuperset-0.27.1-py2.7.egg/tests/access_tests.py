...
from heresuperset import app, db, security_manager
from heresuperset.connectors.connector_registry import ConnectorRegistry
from heresuperset.connectors.druid.models import DruidDatasource
...
EXTEND_ROLE_REQUEST = (
    '/heresuperset/approve?datasource_type={}&datasource_id={}&'
...
class RequestAccessTests(SupersetTestCase):
    ...
    def test_override_role_permissions_is_admin_only(self):
        ...
        response = self.client.post(
            '/heresuperset/override_role_permissions/',
    ...
    @mock.patch('heresuperset.utils.send_MIME_email')
    ...
    def test_request_access(self):
        if app.config.get('ENABLE_ACCESS_REQUEST'):
            ...
            ACCESS_REQUEST = (
                ...
                'action={}&')
            ROLE_GRANT_LINK = (
                '<a href="/heresuperset/approve?datasource_type={}&datasource_id={}&'
