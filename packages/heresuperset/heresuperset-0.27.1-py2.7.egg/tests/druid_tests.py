...
from heresuperset.connectors.druid.models import (
...
class DruidTests(SupersetTestCase):
    ...
    @patch('heresuperset.connectors.druid.models.PyDruid')
    def test_client(self, PyDruid):
        ...
        resp = self.get_resp(
            '/heresuperset/explore/druid/{}/'.format(datasource_id))
        ...
        # One groupby
        url = ('/heresuperset/explore_json/druid/{}/'.format(datasource_id))
    ...
    def test_druid_sync_from_config(self):
        ...
        def check():
            resp = self.client.post('/heresuperset/sync_druid/', data=json.dumps(cfg))
            druid_ds = (
                db.session
