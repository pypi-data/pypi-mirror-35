...
from heresuperset import app
from heresuperset.exceptions import SpatialException
from heresuperset.utils import DTTM_ALIAS
import heresuperset.viz as viz
...
class TableVizTestCase(unittest.TestCase):
    ...
    @patch('heresuperset.viz.BaseViz.query_obj')
