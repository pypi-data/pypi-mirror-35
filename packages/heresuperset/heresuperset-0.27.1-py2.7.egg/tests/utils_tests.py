...
class UtilsTestCase(unittest.TestCase):
    ...
    @patch('heresuperset.utils.datetime')
    ...
    @patch('heresuperset.utils.to_adhoc', mock_to_adhoc)
    ...
    @patch('heresuperset.utils.parse_human_datetime', mock_parse_human_datetime)
