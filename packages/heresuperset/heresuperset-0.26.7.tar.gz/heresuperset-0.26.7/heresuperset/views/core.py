...
from heresuperset import (
    app, appbuilder, cache, db, results_backend, security_manager, sql_lab, utils,
    viz,
)
from heresuperset.connectors.connector_registry import ConnectorRegistry
from heresuperset.connectors.sqla.models import AnnotationDatasource, SqlaTable
from heresuperset.exceptions import SupersetException
from heresuperset.forms import CsvToDatabaseForm
from heresuperset.jinja_context import get_template_processor
from heresuperset.legacy import cast_form_data, update_time_range
import heresuperset.models.core as models
from heresuperset.models.sql_lab import Query
from heresuperset.models.user_attributes import UserAttribute
from heresuperset.sql_parse import SupersetQuery
from heresuperset.utils import (
...
class DatabaseView(SupersetModelView, DeleteMixin, YamlExportMixin):  # noqa
    ...
    add_template = 'heresuperset/models/database/add.html'
    edit_template = 'heresuperset/models/database/edit.html'
...
appbuilder.add_link(
    ...
    href='/heresuperset/import_dashboards',
...
class DashboardModelView(SupersetModelView, DeleteMixin):  # noqa
    ...
    def download_dashboards(self):
        ...
        return self.render_template(
            'heresuperset/export_dashboards.html',
...
class Superset(BaseSupersetView):
    ...
    def request_access(self):
        ...
        if has_access:
            return redirect('/heresuperset/dashboard/{}'.format(dashboard_id))
        ...
        return self.render_template(
            'heresuperset/request_access.html',
    ...
    def slice(self, slice_id):
        ...
        endpoint = '/heresuperset/explore/?form_data={}'.format(
    ...
    def import_dashboards(self):
        ...
        return self.render_template('heresuperset/import_dashboards.html')
    ...
    def csrf_token(self):
        return Response(
            self.render_template('heresuperset/csrf_token.json'),
            mimetype='text/json',
        )
    ...
    def fave_dashboards(self, user_id):
        ...
        for o in qry.all():
            ...
            if o.Dashboard.created_by:
                ...
                d['creator'] = str(user)
                d['creator_url'] = '/heresuperset/profile/{}/'.format(
                    user.username)
            payload.append(d)
        return json_success(
            json.dumps(payload, default=utils.json_int_dttm_ser))
    ...
    def select_star(self, database_id, table_name):
        ...
        return self.render_template(
            'heresuperset/ajah.html',
            content=mydb.select_star(table_name, show_cols=True),
        )

    @expose('/theme/')
    def theme(self):
        return self.render_template('heresuperset/theme.html')
...
appbuilder.add_link(
    ...
    href='/heresuperset/sqllab#search',
    icon='fa-search',
    category_icon='fa-flask',
    category='SQL Lab',
    category_label=__('SQL Lab'),
...
def panoramix(url):  # noqa
    return redirect(request.full_path.replace('panoramix', 'heresuperset'))


@app.route('/<regex("caravel\/.*"):url>')
def caravel(url):  # noqa
    return redirect(request.full_path.replace('caravel', 'heresuperset'))
