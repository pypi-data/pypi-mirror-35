...
from heresuperset import conf, db, import_util, security_manager, utils
from heresuperset.connectors.base.models import BaseColumn, BaseDatasource, BaseMetric
from heresuperset.exceptions import MetricPermException, SupersetException
from heresuperset.models.helpers import (
...
class DruidDatasource(Model, BaseDatasource):
    ...
    def datasource_link(self):
        url = '/heresuperset/explore/{obj.type}/{obj.id}/'.format(obj=self)
        name = escape(self.datasource_name)
