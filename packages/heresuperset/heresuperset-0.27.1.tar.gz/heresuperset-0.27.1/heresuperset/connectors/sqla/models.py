...
from heresuperset import app, db, import_util, security_manager, utils
from heresuperset.connectors.base.models import BaseColumn, BaseDatasource, BaseMetric
from heresuperset.jinja_context import get_template_processor
from heresuperset.models.annotations import Annotation
from heresuperset.models.core import Database
from heresuperset.models.helpers import QueryResult
from heresuperset.models.helpers import set_perm
from heresuperset.utils import DTTM_ALIAS, QueryStatus
...
class SqlaTable(Model, BaseDatasource):
    ...
    def import_obj(cls, i_datasource, import_time=None):
        """Imports the datasource from the object to the database.
         ...
         heresuperset instances. Audit metadata isn't copies over.
        """
