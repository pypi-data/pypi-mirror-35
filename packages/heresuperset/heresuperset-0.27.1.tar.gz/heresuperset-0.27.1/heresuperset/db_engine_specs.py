...
from heresuperset import app, cache_util, conf, db, sql_parse, utils
from heresuperset.exceptions import SupersetTemplateException
from heresuperset.utils import QueryStatus
...
class HiveEngineSpec(PrestoEngineSpec):
    ...
    def patch(cls):
        ...
        from heresuperset.db_engines import hive as patched_hive
    ...
    @staticmethod
    def create_table_from_csv(form, table):
        """Uploads a csv file and creates a heresuperset datasource in Hive."""
