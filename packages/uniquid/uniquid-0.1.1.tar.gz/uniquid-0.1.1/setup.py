...
min_version = str(constants.MIN_VERSION_MAJOR) + '.' + str(constants.MIN_VERSION_MINOR)

if sys.version_info < (constants.MIN_VERSION_MAJOR, constants.MIN_VERSION_MINOR):
    print('Current Python version: ' + platform.python_version())
    sys.exit('Incorrect version of Python installed. Python < ' + min_version + ' is not supported.')
