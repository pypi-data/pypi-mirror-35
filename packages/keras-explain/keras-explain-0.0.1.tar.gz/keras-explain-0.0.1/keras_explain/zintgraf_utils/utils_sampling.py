...
class cond_sampler_imagenet:
    ...
    def __init__(self, win_size, padding_size, image_dims, X, num_samples_fit=20000):
        '''
        ...
        self.X = X
        self.netname = "todo"  # TODO: replace parts with sth
        ...
        save_minmax_values(self.X)
        self.minMaxVals = np.load(self.path_folder+'{}_minMaxVals.npy'.format("todo"))
...
def save_minmax_values(X):
    ...
    np.save(path_folder+'{}_minMaxVals'.format("todo"), minMaxVals)  # TODO: d
