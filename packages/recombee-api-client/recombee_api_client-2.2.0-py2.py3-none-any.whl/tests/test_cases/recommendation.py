...
class RecommendationTest (RecommendationsTest ):
    ...
    def create_request(self,user_id,count,filter=None,booster=None,cascade_create=None,scenario=None,return_properties=None,included_properties=None,diversity=None,expert_settings=None):
        pass
