...
class Client:
    ...
    def describe_voices(
        ...
        *,
        language_code: shapes.LanguageCode = autoboto.ShapeBase.NOT_SET,
        include_additional_language_codes: bool = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if language_code is not autoboto.ShapeBase.NOT_SET:
                _params['language_code'] = language_code
            if include_additional_language_codes is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_speech_synthesis_tasks(
        ...
        *,
        ...
        next_token: str = autoboto.ShapeBase.NOT_SET,
        status: shapes.TaskStatus = autoboto.ShapeBase.NOT_SET,
    ...
    def start_speech_synthesis_task(
        ...
        *,
        ...
        lexicon_names: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        output_s3_key_prefix: str = autoboto.ShapeBase.NOT_SET,
        sample_rate: str = autoboto.ShapeBase.NOT_SET,
        ...
        text_type: shapes.TextType = autoboto.ShapeBase.NOT_SET,
        language_code: shapes.LanguageCode = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if output_format is not autoboto.ShapeBase.NOT_SET:
            ...
            if lexicon_names is not autoboto.ShapeBase.NOT_SET:
