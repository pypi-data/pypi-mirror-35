...
class AccountStreamLimitExceededException(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class ClientLimitExceededException(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class CreateStreamOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
class DeleteStreamInput(autoboto.ShapeBase):
    ...
    # stream.
    current_version: str = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )


@dataclasses.dataclass
class DeleteStreamOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DeviceStreamLimitExceededException(autoboto.ShapeBase):
    """
    Not implemented.
    """
...
@dataclasses.dataclass
class GetDataEndpointInput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
    ...
    api_name: "APIName" = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
...
@dataclasses.dataclass
class GetDataEndpointOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
    ...
    data_endpoint: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class InvalidDeviceException(autoboto.ShapeBase):
    """
    Not implemented.
    """
...
@dataclasses.dataclass
class InvalidResourceFormatException(autoboto.ShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                ...
                "StreamNameCondition",
                autoboto.TypeInfo(StreamNameCondition),
            ),
        ]
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "stream_info_list",
                "StreamInfoList",
                autoboto.TypeInfo(typing.List[StreamInfo]),
            ),
            (
                "next_token",
                "NextToken",
...
@dataclasses.dataclass
class StreamNameCondition(autoboto.ShapeBase):
    """
    ...
    # A value to compare.
    comparison_value: str = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )


@dataclasses.dataclass
class TagStreamInput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class TagStreamOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class TagsPerResourceExceededLimitException(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class UntagStreamInput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class UntagStreamOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class UpdateDataRetentionInput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
            ...
            (
                "operation",
                "Operation",
                autoboto.TypeInfo(UpdateDataRetentionOperation),
            ),
            (
...
@dataclasses.dataclass
class UpdateDataRetentionOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class UpdateStreamInput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class UpdateStreamOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
