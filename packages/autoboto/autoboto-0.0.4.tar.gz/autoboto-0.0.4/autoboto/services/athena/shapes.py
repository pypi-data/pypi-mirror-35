...
@dataclasses.dataclass
class BatchGetNamedQueryOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class BatchGetQueryExecutionOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
class ColumnInfo(autoboto.ShapeBase):
    ...
    catalog_name: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    ...
    precision: int = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )

    # For `DECIMAL` data types, specifies the total number of digits in the
    # fractional part of the value. Defaults to 0.
    scale: int = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
class CreateNamedQueryInput(autoboto.ShapeBase):
    ...
    database: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class CreateNamedQueryOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DeleteNamedQueryOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class GetNamedQueryOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class GetQueryExecutionOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class GetQueryResultsOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class ListNamedQueriesOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class ListQueryExecutionsOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class StartQueryExecutionOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class StopQueryExecutionOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
