...
class Client:
    ...
    def claim_devices_by_claim_code(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if claim_code is not autoboto.ShapeBase.NOT_SET:
    ...
    def invoke_device_method(
        ...
        *,
        device_id: str,
        device_method: shapes.DeviceMethod = autoboto.ShapeBase.NOT_SET,
        device_method_parameters: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if device_id is not autoboto.ShapeBase.NOT_SET:
                _params['device_id'] = device_id
            if device_method is not autoboto.ShapeBase.NOT_SET:
                _params['device_method'] = device_method
            if device_method_parameters is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_device_events(
        ...
        *,
        ...
        if _request is None:
            ...
            if device_id is not autoboto.ShapeBase.NOT_SET:
                _params['device_id'] = device_id
            if from_time_stamp is not autoboto.ShapeBase.NOT_SET:
                _params['from_time_stamp'] = from_time_stamp
            if to_time_stamp is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_devices(
        ...
        *,
        device_type: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
