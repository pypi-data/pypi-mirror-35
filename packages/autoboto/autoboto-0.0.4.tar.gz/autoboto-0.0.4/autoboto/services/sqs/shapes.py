...
@dataclasses.dataclass
class ChangeMessageVisibilityBatchResult(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class CreateQueueResult(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class DeleteMessageBatchResult(autoboto.ShapeBase):
    """
    For each message in the batch, the response contains a `
...
@dataclasses.dataclass
class GetQueueAttributesResult(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class GetQueueUrlResult(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class ListDeadLetterSourceQueuesResult(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class ListQueueTagsResult(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class ListQueuesResult(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class ReceiveMessageResult(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class SendMessageBatchResult(autoboto.ShapeBase):
    """
    For each message in the batch, the response contains a `
...
@dataclasses.dataclass
class SendMessageResult(autoboto.ShapeBase):
    """
