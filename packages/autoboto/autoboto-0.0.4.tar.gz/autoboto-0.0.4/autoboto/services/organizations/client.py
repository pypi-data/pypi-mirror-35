...
class Client:
    ...
    def accept_handshake(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if handshake_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def attach_policy(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if policy_id is not autoboto.ShapeBase.NOT_SET:
                _params['policy_id'] = policy_id
            if target_id is not autoboto.ShapeBase.NOT_SET:
        ...
        *,
        ...
        if _request is None:
            ...
            if email is not autoboto.ShapeBase.NOT_SET:
                _params['email'] = email
            if account_name is not autoboto.ShapeBase.NOT_SET:
                _params['account_name'] = account_name
            if role_name is not autoboto.ShapeBase.NOT_SET:
                _params['role_name'] = role_name
            if iam_user_access_to_billing is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_organization(
        ...
        *,
        feature_set: shapes.OrganizationFeatureSet = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if feature_set is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_organizational_unit(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if organizational_unit_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_create_account_status(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if create_account_request_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def disable_aws_service_access(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if service_principal is not autoboto.ShapeBase.NOT_SET:
    ...
    def disable_policy_type(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if root_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def invite_account_to_organization(
        ...
        *,
        ...
        notes: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if notes is not autoboto.ShapeBase.NOT_SET:
                _params['notes'] = notes
    ...
    def list_children(
        ...
        *,
        ...
        if _request is None:
            ...
            if parent_id is not autoboto.ShapeBase.NOT_SET:
                _params['parent_id'] = parent_id
            if child_type is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_create_account_status(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if states is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_handshakes_for_account(
        ...
        *,
        filter: shapes.HandshakeFilter = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
    ...
    def list_parents(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if child_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def move_account(
        ...
        *,
        ...
        if _request is None:
            ...
            if account_id is not autoboto.ShapeBase.NOT_SET:
                _params['account_id'] = account_id
            if source_parent_id is not autoboto.ShapeBase.NOT_SET:
                _params['source_parent_id'] = source_parent_id
            if destination_parent_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_policy(
        ...
        *,
        ...
        content: str = autoboto.ShapeBase.NOT_SET,
