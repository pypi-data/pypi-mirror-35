...
class Client:
    ...
    def batch_get_item(
        ...
        *,
        ...
        return_consumed_capacity: shapes.ReturnConsumedCapacity = autoboto.
        ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if request_items is not autoboto.ShapeBase.NOT_SET:
                _params['request_items'] = request_items
            if return_consumed_capacity is not autoboto.ShapeBase.NOT_SET:
    ...
    def batch_write_item(
        ...
        *,
        ...
        ReturnItemCollectionMetrics = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if return_consumed_capacity is not autoboto.ShapeBase.NOT_SET:
                _params['return_consumed_capacity'] = return_consumed_capacity
            if return_item_collection_metrics is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_backup(
        ...
        *,
        ...
        if _request is None:
            ...
            if backup_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_global_table(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if global_table_name is not autoboto.ShapeBase.NOT_SET:
                _params['global_table_name'] = global_table_name
            if replication_group is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_table(
        ...
        *,
        ...
        stream_specification: shapes.StreamSpecification = autoboto.ShapeBase.
        NOT_SET,
        sse_specification: shapes.SSESpecification = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if attribute_definitions is not autoboto.ShapeBase.NOT_SET:
                _params['attribute_definitions'] = attribute_definitions
            if table_name is not autoboto.ShapeBase.NOT_SET:
                _params['table_name'] = table_name
            if key_schema is not autoboto.ShapeBase.NOT_SET:
                _params['key_schema'] = key_schema
            if provisioned_throughput is not autoboto.ShapeBase.NOT_SET:
                _params['provisioned_throughput'] = provisioned_throughput
            if local_secondary_indexes is not autoboto.ShapeBase.NOT_SET:
                _params['local_secondary_indexes'] = local_secondary_indexes
            if global_secondary_indexes is not autoboto.ShapeBase.NOT_SET:
                _params['global_secondary_indexes'] = global_secondary_indexes
            if stream_specification is not autoboto.ShapeBase.NOT_SET:
                _params['stream_specification'] = stream_specification
            if sse_specification is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_backup(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if backup_arn is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_item(
        ...
        *,
        ...
        conditional_operator: shapes.ConditionalOperator = autoboto.ShapeBase.
        NOT_SET,
        return_values: shapes.ReturnValue = autoboto.ShapeBase.NOT_SET,
        return_consumed_capacity: shapes.ReturnConsumedCapacity = autoboto.
        ShapeBase.NOT_SET,
        return_item_collection_metrics: shapes.
        ReturnItemCollectionMetrics = autoboto.ShapeBase.NOT_SET,
        condition_expression: str = autoboto.ShapeBase.NOT_SET,
        expression_attribute_names: typing.Dict[str, str
                                               ] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if key is not autoboto.ShapeBase.NOT_SET:
                _params['key'] = key
            if expected is not autoboto.ShapeBase.NOT_SET:
                _params['expected'] = expected
            if conditional_operator is not autoboto.ShapeBase.NOT_SET:
                _params['conditional_operator'] = conditional_operator
            if return_values is not autoboto.ShapeBase.NOT_SET:
            ...
            if condition_expression is not autoboto.ShapeBase.NOT_SET:
                _params['condition_expression'] = condition_expression
            if expression_attribute_names is not autoboto.ShapeBase.NOT_SET:
                _params['expression_attribute_names'
                       ] = expression_attribute_names
            if expression_attribute_values is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_item(
        ...
        *,
        ...
        consistent_read: bool = autoboto.ShapeBase.NOT_SET,
        return_consumed_capacity: shapes.ReturnConsumedCapacity = autoboto.
        ShapeBase.NOT_SET,
        projection_expression: str = autoboto.ShapeBase.NOT_SET,
        expression_attribute_names: typing.Dict[str, str
                                               ] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if consistent_read is not autoboto.ShapeBase.NOT_SET:
                _params['consistent_read'] = consistent_read
            if return_consumed_capacity is not autoboto.ShapeBase.NOT_SET:
                _params['return_consumed_capacity'] = return_consumed_capacity
            if projection_expression is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_backups(
        ...
        *,
        table_name: str = autoboto.ShapeBase.NOT_SET,
        limit: int = autoboto.ShapeBase.NOT_SET,
        time_range_lower_bound: datetime.datetime = autoboto.ShapeBase.NOT_SET,
        time_range_upper_bound: datetime.datetime = autoboto.ShapeBase.NOT_SET,
        exclusive_start_backup_arn: str = autoboto.ShapeBase.NOT_SET,
        backup_type: shapes.BackupTypeFilter = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if limit is not autoboto.ShapeBase.NOT_SET:
                _params['limit'] = limit
            if time_range_lower_bound is not autoboto.ShapeBase.NOT_SET:
                _params['time_range_lower_bound'] = time_range_lower_bound
            if time_range_upper_bound is not autoboto.ShapeBase.NOT_SET:
                _params['time_range_upper_bound'] = time_range_upper_bound
            if exclusive_start_backup_arn is not autoboto.ShapeBase.NOT_SET:
                _params['exclusive_start_backup_arn'
                       ] = exclusive_start_backup_arn
            if backup_type is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_global_tables(
        ...
        *,
        exclusive_start_global_table_name: str = autoboto.ShapeBase.NOT_SET,
        limit: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if exclusive_start_global_table_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_tables(
        ...
        *,
        exclusive_start_table_name: str = autoboto.ShapeBase.NOT_SET,
        limit: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if exclusive_start_table_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_item(
        ...
        *,
        ...
        if _request is None:
            ...
            if table_name is not autoboto.ShapeBase.NOT_SET:
                _params['table_name'] = table_name
            if item is not autoboto.ShapeBase.NOT_SET:
                _params['item'] = item
            if expected is not autoboto.ShapeBase.NOT_SET:
                _params['expected'] = expected
            if return_values is not autoboto.ShapeBase.NOT_SET:
    ...
    def query(
        ...
        *,
        ...
        select: shapes.Select = autoboto.ShapeBase.NOT_SET,
        attributes_to_get: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        limit: int = autoboto.ShapeBase.NOT_SET,
        consistent_read: bool = autoboto.ShapeBase.NOT_SET,
        key_conditions: typing.Dict[str, shapes.Condition
                                   ] = autoboto.ShapeBase.NOT_SET,
        query_filter: typing.Dict[str, shapes.Condition
                                 ] = autoboto.ShapeBase.NOT_SET,
        conditional_operator: shapes.ConditionalOperator = autoboto.ShapeBase.
        NOT_SET,
        scan_index_forward: bool = autoboto.ShapeBase.NOT_SET,
        ...
        key_condition_expression: str = autoboto.ShapeBase.NOT_SET,
        expression_attribute_names: typing.Dict[str, str
                                               ] = autoboto.ShapeBase.NOT_SET,
        expression_attribute_values: typing.Dict[str, shapes.AttributeValue
                                                ] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if select is not autoboto.ShapeBase.NOT_SET:
            ...
            if consistent_read is not autoboto.ShapeBase.NOT_SET:
                _params['consistent_read'] = consistent_read
            if key_conditions is not autoboto.ShapeBase.NOT_SET:
                _params['key_conditions'] = key_conditions
            if query_filter is not autoboto.ShapeBase.NOT_SET:
                _params['query_filter'] = query_filter
            if conditional_operator is not autoboto.ShapeBase.NOT_SET:
                _params['conditional_operator'] = conditional_operator
            if scan_index_forward is not autoboto.ShapeBase.NOT_SET:
                _params['scan_index_forward'] = scan_index_forward
            if exclusive_start_key is not autoboto.ShapeBase.NOT_SET:
            ...
            if key_condition_expression is not autoboto.ShapeBase.NOT_SET:
    ...
    def restore_table_from_backup(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if target_table_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def restore_table_to_point_in_time(
        ...
        *,
        ...
        restore_date_time: datetime.datetime = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if restore_date_time is not autoboto.ShapeBase.NOT_SET:
    ...
    def scan(
        ...
        *,
        ...
        limit: int = autoboto.ShapeBase.NOT_SET,
        select: shapes.Select = autoboto.ShapeBase.NOT_SET,
        scan_filter: typing.Dict[str, shapes.Condition
                                ] = autoboto.ShapeBase.NOT_SET,
        conditional_operator: shapes.ConditionalOperator = autoboto.ShapeBase.
        NOT_SET,
        exclusive_start_key: typing.Dict[str, shapes.AttributeValue
        ...
        return_consumed_capacity: shapes.ReturnConsumedCapacity = autoboto.
        ShapeBase.NOT_SET,
        total_segments: int = autoboto.ShapeBase.NOT_SET,
        segment: int = autoboto.ShapeBase.NOT_SET,
        projection_expression: str = autoboto.ShapeBase.NOT_SET,
        filter_expression: str = autoboto.ShapeBase.NOT_SET,
        expression_attribute_names: typing.Dict[str, str
                                               ] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if select is not autoboto.ShapeBase.NOT_SET:
                _params['select'] = select
            if scan_filter is not autoboto.ShapeBase.NOT_SET:
            ...
            if return_consumed_capacity is not autoboto.ShapeBase.NOT_SET:
                _params['return_consumed_capacity'] = return_consumed_capacity
            if total_segments is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_continuous_backups(
        ...
        *,
        ...
        if _request is None:
            ...
            if table_name is not autoboto.ShapeBase.NOT_SET:
                _params['table_name'] = table_name
            if point_in_time_recovery_specification is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_global_table(
        ...
        *,
        ...
        if _request is None:
            ...
            if global_table_name is not autoboto.ShapeBase.NOT_SET:
                _params['global_table_name'] = global_table_name
            if replica_updates is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_global_table_settings(
        ...
        *,
        global_table_name: str,
        global_table_provisioned_write_capacity_units: int = autoboto.ShapeBase.
        NOT_SET,
        global_table_provisioned_write_capacity_auto_scaling_settings_update:
        shapes.AutoScalingSettingsUpdate = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if global_table_name is not autoboto.ShapeBase.NOT_SET:
                _params['global_table_name'] = global_table_name
            if global_table_provisioned_write_capacity_units is not autoboto.ShapeBase.NOT_SET:
                _params['global_table_provisioned_write_capacity_units'
                       ] = global_table_provisioned_write_capacity_units
            if global_table_provisioned_write_capacity_auto_scaling_settings_update is not autoboto.ShapeBase.NOT_SET:
                _params[
                    'global_table_provisioned_write_capacity_auto_scaling_settings_update'
                ] = global_table_provisioned_write_capacity_auto_scaling_settings_update
            if global_table_global_secondary_index_settings_update is not autoboto.ShapeBase.NOT_SET:
                _params['global_table_global_secondary_index_settings_update'
                       ] = global_table_global_secondary_index_settings_update
            if replica_settings_update is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_item(
        ...
        *,
        ...
        return_item_collection_metrics: shapes.
        ReturnItemCollectionMetrics = autoboto.ShapeBase.NOT_SET,
        update_expression: str = autoboto.ShapeBase.NOT_SET,
        condition_expression: str = autoboto.ShapeBase.NOT_SET,
        expression_attribute_names: typing.Dict[str, str
                                               ] = autoboto.ShapeBase.NOT_SET,
        expression_attribute_values: typing.Dict[str, shapes.AttributeValue
        ...
        if _request is None:
            ...
            if key is not autoboto.ShapeBase.NOT_SET:
                _params['key'] = key
            if attribute_updates is not autoboto.ShapeBase.NOT_SET:
            ...
            if update_expression is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_table(
        ...
        *,
        ...
        provisioned_throughput: shapes.ProvisionedThroughput = autoboto.
        ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if provisioned_throughput is not autoboto.ShapeBase.NOT_SET:
                _params['provisioned_throughput'] = provisioned_throughput
            if global_secondary_index_updates is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_time_to_live(
        ...
        *,
        ...
        if _request is None:
            ...
            if table_name is not autoboto.ShapeBase.NOT_SET:
                _params['table_name'] = table_name
            if time_to_live_specification is not autoboto.ShapeBase.NOT_SET:
