...
@dataclasses.dataclass
class ConnectionLimitExceededException(autoboto.ShapeBase):
    """
    Kinesis Video Streams has throttled the request because you have exceeded the
...
@dataclasses.dataclass
class GetMediaInput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
                "start_selector",
                "StartSelector",
                autoboto.TypeInfo(StartSelector),
            ),
            (
                "stream_name",
                "StreamName",
...
@dataclasses.dataclass
class GetMediaOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class StartSelector(autoboto.ShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "start_selector_type",
                "StartSelectorType",
                autoboto.TypeInfo(StartSelectorType),
            ),
            (
    ...
    after_fragment_number: str = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
