...
class Client:
    ...
    def create_alias(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if alias_name is not autoboto.ShapeBase.NOT_SET:
                _params['alias_name'] = alias_name
            if target_key_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_grant(
        ...
        *,
        ...
        retiring_principal: str = autoboto.ShapeBase.NOT_SET,
        constraints: shapes.GrantConstraints = autoboto.ShapeBase.NOT_SET,
        grant_tokens: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if key_id is not autoboto.ShapeBase.NOT_SET:
                _params['key_id'] = key_id
            if grantee_principal is not autoboto.ShapeBase.NOT_SET:
                _params['grantee_principal'] = grantee_principal
            if operations is not autoboto.ShapeBase.NOT_SET:
                _params['operations'] = operations
            if retiring_principal is not autoboto.ShapeBase.NOT_SET:
                _params['retiring_principal'] = retiring_principal
            if constraints is not autoboto.ShapeBase.NOT_SET:
                _params['constraints'] = constraints
            if grant_tokens is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_key(
        ...
        *,
        ...
        key_usage: shapes.KeyUsageType = autoboto.ShapeBase.NOT_SET,
        origin: shapes.OriginType = autoboto.ShapeBase.NOT_SET,
        bypass_policy_lockout_safety_check: bool = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if key_usage is not autoboto.ShapeBase.NOT_SET:
                _params['key_usage'] = key_usage
            if origin is not autoboto.ShapeBase.NOT_SET:
                _params['origin'] = origin
            if bypass_policy_lockout_safety_check is not autoboto.ShapeBase.NOT_SET:
    ...
    def decrypt(
        ...
        *,
        ...
        encryption_context: typing.Dict[str, str] = autoboto.ShapeBase.NOT_SET,
        grant_tokens: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if ciphertext_blob is not autoboto.ShapeBase.NOT_SET:
                _params['ciphertext_blob'] = ciphertext_blob
            if encryption_context is not autoboto.ShapeBase.NOT_SET:
    ...
    def encrypt(
        ...
        *,
        ...
        if _request is None:
            ...
            if key_id is not autoboto.ShapeBase.NOT_SET:
                _params['key_id'] = key_id
            if plaintext is not autoboto.ShapeBase.NOT_SET:
    ...
    def generate_data_key(
        ...
        *,
        key_id: str,
        encryption_context: typing.Dict[str, str] = autoboto.ShapeBase.NOT_SET,
        number_of_bytes: int = autoboto.ShapeBase.NOT_SET,
        key_spec: shapes.DataKeySpec = autoboto.ShapeBase.NOT_SET,
        grant_tokens: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if encryption_context is not autoboto.ShapeBase.NOT_SET:
                _params['encryption_context'] = encryption_context
            if number_of_bytes is not autoboto.ShapeBase.NOT_SET:
                _params['number_of_bytes'] = number_of_bytes
            if key_spec is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_parameters_for_import(
        ...
        *,
        ...
        if _request is None:
            ...
            if key_id is not autoboto.ShapeBase.NOT_SET:
                _params['key_id'] = key_id
            if wrapping_algorithm is not autoboto.ShapeBase.NOT_SET:
                _params['wrapping_algorithm'] = wrapping_algorithm
            if wrapping_key_spec is not autoboto.ShapeBase.NOT_SET:
    ...
    def import_key_material(
        ...
        *,
        ...
        valid_to: datetime.datetime = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if key_id is not autoboto.ShapeBase.NOT_SET:
                _params['key_id'] = key_id
            if import_token is not autoboto.ShapeBase.NOT_SET:
                _params['import_token'] = import_token
            if encrypted_key_material is not autoboto.ShapeBase.NOT_SET:
                _params['encrypted_key_material'] = encrypted_key_material
            if valid_to is not autoboto.ShapeBase.NOT_SET:
                _params['valid_to'] = valid_to
            if expiration_model is not autoboto.ShapeBase.NOT_SET:
    ...
    def re_encrypt(
        ...
        *,
        ...
        if _request is None:
            ...
            if ciphertext_blob is not autoboto.ShapeBase.NOT_SET:
                _params['ciphertext_blob'] = ciphertext_blob
            if destination_key_id is not autoboto.ShapeBase.NOT_SET:
                _params['destination_key_id'] = destination_key_id
            if source_encryption_context is not autoboto.ShapeBase.NOT_SET:
                _params['source_encryption_context'] = source_encryption_context
            if destination_encryption_context is not autoboto.ShapeBase.NOT_SET:
    ...
    def retire_grant(
        ...
        *,
        grant_token: str = autoboto.ShapeBase.NOT_SET,
        key_id: str = autoboto.ShapeBase.NOT_SET,
        grant_id: str = autoboto.ShapeBase.NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            _params = {}
            if grant_token is not autoboto.ShapeBase.NOT_SET:
                _params['grant_token'] = grant_token
            if key_id is not autoboto.ShapeBase.NOT_SET:
                _params['key_id'] = key_id
            if grant_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def schedule_key_deletion(
        ...
        *,
        key_id: str,
        pending_window_in_days: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if key_id is not autoboto.ShapeBase.NOT_SET:
                _params['key_id'] = key_id
            if pending_window_in_days is not autoboto.ShapeBase.NOT_SET:
