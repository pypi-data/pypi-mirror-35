...
class Client:
    ...
    def associate_admin_account(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if admin_account is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_compliance_detail(
        ...
        *,
        ...
        if _request is None:
            ...
            if policy_id is not autoboto.ShapeBase.NOT_SET:
                _params['policy_id'] = policy_id
            if member_account is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_notification_channel(
        ...
        *,
        ...
        if _request is None:
            ...
            if sns_role_name is not autoboto.ShapeBase.NOT_SET:
