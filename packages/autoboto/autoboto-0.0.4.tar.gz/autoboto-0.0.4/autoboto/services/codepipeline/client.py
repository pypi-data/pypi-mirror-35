...
class Client:
    ...
    def acknowledge_job(
        ...
        *,
        ...
        if _request is None:
            ...
            if nonce is not autoboto.ShapeBase.NOT_SET:
                _params['nonce'] = nonce
    ...
    def create_custom_action_type(
        ...
        *,
        ...
        settings: shapes.ActionTypeSettings = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if category is not autoboto.ShapeBase.NOT_SET:
                _params['category'] = category
            if provider is not autoboto.ShapeBase.NOT_SET:
                _params['provider'] = provider
            if version is not autoboto.ShapeBase.NOT_SET:
                _params['version'] = version
            if input_artifact_details is not autoboto.ShapeBase.NOT_SET:
                _params['input_artifact_details'] = input_artifact_details
            if output_artifact_details is not autoboto.ShapeBase.NOT_SET:
            ...
            if configuration_properties is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_pipeline(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if pipeline is not autoboto.ShapeBase.NOT_SET:
    ...
    def deregister_webhook_with_third_party(
        ...
        *,
        webhook_name: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if webhook_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_pipeline(
        ...
        *,
        name: str,
        version: int = autoboto.ShapeBase.NOT_SET,
    ...
    def get_pipeline_execution(
        ...
        *,
        ...
        if _request is None:
            ...
            if pipeline_name is not autoboto.ShapeBase.NOT_SET:
                _params['pipeline_name'] = pipeline_name
            if pipeline_execution_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_action_types(
        ...
        *,
        action_owner_filter: shapes.ActionOwner = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if action_owner_filter is not autoboto.ShapeBase.NOT_SET:
    ...
    def poll_for_jobs(
        ...
        *,
        ...
        max_batch_size: int = autoboto.ShapeBase.NOT_SET,
        query_param: typing.Dict[str, str] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if action_type_id is not autoboto.ShapeBase.NOT_SET:
                _params['action_type_id'] = action_type_id
            if max_batch_size is not autoboto.ShapeBase.NOT_SET:
                _params['max_batch_size'] = max_batch_size
            if query_param is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_action_revision(
        ...
        *,
        ...
        if _request is None:
            ...
            if stage_name is not autoboto.ShapeBase.NOT_SET:
                _params['stage_name'] = stage_name
            if action_name is not autoboto.ShapeBase.NOT_SET:
                _params['action_name'] = action_name
            if action_revision is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_job_failure_result(
        ...
        *,
        ...
        if _request is None:
            ...
            if job_id is not autoboto.ShapeBase.NOT_SET:
                _params['job_id'] = job_id
            if failure_details is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_job_success_result(
        ...
        *,
        job_id: str,
        current_revision: shapes.CurrentRevision = autoboto.ShapeBase.NOT_SET,
        continuation_token: str = autoboto.ShapeBase.NOT_SET,
        execution_details: shapes.ExecutionDetails = autoboto.ShapeBase.NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            ...
            if job_id is not autoboto.ShapeBase.NOT_SET:
                _params['job_id'] = job_id
            if current_revision is not autoboto.ShapeBase.NOT_SET:
            ...
            if execution_details is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_webhook(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if webhook is not autoboto.ShapeBase.NOT_SET:
    ...
    def retry_stage_execution(
        ...
        *,
        ...
        if _request is None:
            ...
            if pipeline_execution_id is not autoboto.ShapeBase.NOT_SET:
                _params['pipeline_execution_id'] = pipeline_execution_id
            if retry_mode is not autoboto.ShapeBase.NOT_SET:
