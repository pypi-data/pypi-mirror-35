...
class Client:
    ...
    def create_user(
        ...
        *,
        ...
        identity_info: shapes.UserIdentityInfo = autoboto.ShapeBase.NOT_SET,
        directory_user_id: str = autoboto.ShapeBase.NOT_SET,
        hierarchy_group_id: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if phone_config is not autoboto.ShapeBase.NOT_SET:
                _params['phone_config'] = phone_config
            if security_profile_ids is not autoboto.ShapeBase.NOT_SET:
                _params['security_profile_ids'] = security_profile_ids
            if routing_profile_id is not autoboto.ShapeBase.NOT_SET:
            ...
            if identity_info is not autoboto.ShapeBase.NOT_SET:
                _params['identity_info'] = identity_info
            if directory_user_id is not autoboto.ShapeBase.NOT_SET:
                _params['directory_user_id'] = directory_user_id
            if hierarchy_group_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def start_outbound_voice_contact(
        ...
        *,
        ...
        source_phone_number: str = autoboto.ShapeBase.NOT_SET,
        queue_id: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if destination_phone_number is not autoboto.ShapeBase.NOT_SET:
                _params['destination_phone_number'] = destination_phone_number
            if contact_flow_id is not autoboto.ShapeBase.NOT_SET:
            ...
            if source_phone_number is not autoboto.ShapeBase.NOT_SET:
                _params['source_phone_number'] = source_phone_number
            if queue_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def stop_contact(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if contact_id is not autoboto.ShapeBase.NOT_SET:
