...
class Client:
    ...
    def add_ip_routes(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if directory_id is not autoboto.ShapeBase.NOT_SET:
                _params['directory_id'] = directory_id
            if ip_routes is not autoboto.ShapeBase.NOT_SET:
                _params['ip_routes'] = ip_routes
            if update_security_group_for_directory_controllers is not autoboto.ShapeBase.NOT_SET:
    ...
    def cancel_schema_extension(
        ...
        *,
        ...
        if _request is None:
            ...
            if directory_id is not autoboto.ShapeBase.NOT_SET:
                _params['directory_id'] = directory_id
            if schema_extension_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def connect_directory(
        ...
        *,
        ...
        short_name: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if size is not autoboto.ShapeBase.NOT_SET:
                _params['size'] = size
            if connect_settings is not autoboto.ShapeBase.NOT_SET:
                _params['connect_settings'] = connect_settings
            if short_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_alias(
        ...
        *,
        ...
        if _request is None:
            ...
            if directory_id is not autoboto.ShapeBase.NOT_SET:
                _params['directory_id'] = directory_id
            if alias is not autoboto.ShapeBase.NOT_SET:
                _params['alias'] = alias
    ...
    def create_computer(
        ...
        *,
        ...
        if _request is None:
            ...
            if directory_id is not autoboto.ShapeBase.NOT_SET:
                _params['directory_id'] = directory_id
            if computer_name is not autoboto.ShapeBase.NOT_SET:
                _params['computer_name'] = computer_name
            if password is not autoboto.ShapeBase.NOT_SET:
                _params['password'] = password
            if organizational_unit_distinguished_name is not autoboto.ShapeBase.NOT_SET:
                _params['organizational_unit_distinguished_name'
                       ] = organizational_unit_distinguished_name
            if computer_attributes is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_conditional_forwarder(
        ...
        *,
        ...
        if _request is None:
            ...
            if directory_id is not autoboto.ShapeBase.NOT_SET:
                _params['directory_id'] = directory_id
            if remote_domain_name is not autoboto.ShapeBase.NOT_SET:
                _params['remote_domain_name'] = remote_domain_name
            if dns_ip_addrs is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_directory(
        ...
        *,
        ...
        short_name: str = autoboto.ShapeBase.NOT_SET,
        description: str = autoboto.ShapeBase.NOT_SET,
        vpc_settings: shapes.DirectoryVpcSettings = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if description is not autoboto.ShapeBase.NOT_SET:
                _params['description'] = description
            if vpc_settings is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_microsoft_ad(
        ...
        *,
        ...
        short_name: str = autoboto.ShapeBase.NOT_SET,
        description: str = autoboto.ShapeBase.NOT_SET,
        edition: shapes.DirectoryEdition = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if description is not autoboto.ShapeBase.NOT_SET:
                _params['description'] = description
            if edition is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_trust(
        ...
        *,
        ...
        trust_type: shapes.TrustType = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if remote_domain_name is not autoboto.ShapeBase.NOT_SET:
                _params['remote_domain_name'] = remote_domain_name
            if trust_password is not autoboto.ShapeBase.NOT_SET:
                _params['trust_password'] = trust_password
            if trust_direction is not autoboto.ShapeBase.NOT_SET:
                _params['trust_direction'] = trust_direction
            if trust_type is not autoboto.ShapeBase.NOT_SET:
                _params['trust_type'] = trust_type
            if conditional_forwarder_ip_addrs is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_trust(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if trust_id is not autoboto.ShapeBase.NOT_SET:
                _params['trust_id'] = trust_id
            if delete_associated_conditional_forwarder is not autoboto.ShapeBase.NOT_SET:
    ...
    def deregister_event_topic(
        ...
        *,
        ...
        if _request is None:
            ...
            if directory_id is not autoboto.ShapeBase.NOT_SET:
                _params['directory_id'] = directory_id
            if topic_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_conditional_forwarders(
        ...
        *,
        directory_id: str,
        remote_domain_names: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if directory_id is not autoboto.ShapeBase.NOT_SET:
                _params['directory_id'] = directory_id
            if remote_domain_names is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_directories(
        ...
        *,
        directory_ids: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if directory_ids is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_domain_controllers(
        ...
        *,
        directory_id: str,
        domain_controller_ids: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        limit: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if directory_id is not autoboto.ShapeBase.NOT_SET:
                _params['directory_id'] = directory_id
            if domain_controller_ids is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_event_topics(
        ...
        *,
        directory_id: str = autoboto.ShapeBase.NOT_SET,
        topic_names: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if directory_id is not autoboto.ShapeBase.NOT_SET:
                _params['directory_id'] = directory_id
            if topic_names is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_trusts(
        ...
        *,
        directory_id: str = autoboto.ShapeBase.NOT_SET,
        trust_ids: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        limit: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if directory_id is not autoboto.ShapeBase.NOT_SET:
                _params['directory_id'] = directory_id
            if trust_ids is not autoboto.ShapeBase.NOT_SET:
    ...
    def enable_radius(
        ...
        *,
        ...
        if _request is None:
            ...
            if directory_id is not autoboto.ShapeBase.NOT_SET:
                _params['directory_id'] = directory_id
            if radius_settings is not autoboto.ShapeBase.NOT_SET:
    ...
    def remove_ip_routes(
        ...
        *,
        ...
        if _request is None:
            ...
            if directory_id is not autoboto.ShapeBase.NOT_SET:
                _params['directory_id'] = directory_id
            if cidr_ips is not autoboto.ShapeBase.NOT_SET:
    ...
    def start_schema_extension(
        ...
        *,
        ...
        if _request is None:
            ...
            if directory_id is not autoboto.ShapeBase.NOT_SET:
                _params['directory_id'] = directory_id
            if create_snapshot_before_schema_extension is not autoboto.ShapeBase.NOT_SET:
                _params['create_snapshot_before_schema_extension'
                       ] = create_snapshot_before_schema_extension
            if ldif_content is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_number_of_domain_controllers(
        ...
        *,
        ...
        if _request is None:
            ...
            if directory_id is not autoboto.ShapeBase.NOT_SET:
                _params['directory_id'] = directory_id
            if desired_number is not autoboto.ShapeBase.NOT_SET:
