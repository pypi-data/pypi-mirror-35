...
class Client:
    ...
    def accept_invitation(
        ...
        *,
        detector_id: str,
        invitation_id: str = autoboto.ShapeBase.NOT_SET,
        master_id: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if detector_id is not autoboto.ShapeBase.NOT_SET:
                _params['detector_id'] = detector_id
            if invitation_id is not autoboto.ShapeBase.NOT_SET:
                _params['invitation_id'] = invitation_id
            if master_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def archive_findings(
        ...
        *,
        detector_id: str,
        finding_ids: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if detector_id is not autoboto.ShapeBase.NOT_SET:
                _params['detector_id'] = detector_id
            if finding_ids is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_filter(
        ...
        *,
        detector_id: str,
        action: shapes.FilterAction = autoboto.ShapeBase.NOT_SET,
        client_token: str = autoboto.ShapeBase.NOT_SET,
        description: str = autoboto.ShapeBase.NOT_SET,
        finding_criteria: shapes.FindingCriteria = autoboto.ShapeBase.NOT_SET,
        name: str = autoboto.ShapeBase.NOT_SET,
        rank: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if finding_criteria is not autoboto.ShapeBase.NOT_SET:
                _params['finding_criteria'] = finding_criteria
            if name is not autoboto.ShapeBase.NOT_SET:
                _params['name'] = name
            if rank is not autoboto.ShapeBase.NOT_SET:
                _params['rank'] = rank
    ...
    def create_ip_set(
        ...
        *,
        detector_id: str,
        activate: bool = autoboto.ShapeBase.NOT_SET,
        format: shapes.IpSetFormat = autoboto.ShapeBase.NOT_SET,
        location: str = autoboto.ShapeBase.NOT_SET,
        name: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if detector_id is not autoboto.ShapeBase.NOT_SET:
                _params['detector_id'] = detector_id
            if activate is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_members(
        ...
        *,
        ...
        if _request is None:
            ...
            if detector_id is not autoboto.ShapeBase.NOT_SET:
                _params['detector_id'] = detector_id
            if account_details is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_sample_findings(
        ...
        *,
        detector_id: str,
        finding_types: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if detector_id is not autoboto.ShapeBase.NOT_SET:
                _params['detector_id'] = detector_id
            if finding_types is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_threat_intel_set(
        ...
        *,
        detector_id: str,
        activate: bool = autoboto.ShapeBase.NOT_SET,
        format: shapes.ThreatIntelSetFormat = autoboto.ShapeBase.NOT_SET,
        location: str = autoboto.ShapeBase.NOT_SET,
        name: str = autoboto.ShapeBase.NOT_SET,
    ...
    def decline_invitations(
        ...
        *,
        account_ids: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if account_ids is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_ip_set(
        ...
        *,
        ...
        if _request is None:
            ...
            if detector_id is not autoboto.ShapeBase.NOT_SET:
                _params['detector_id'] = detector_id
            if ip_set_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_threat_intel_set(
        ...
        *,
        ...
        if _request is None:
            ...
            if detector_id is not autoboto.ShapeBase.NOT_SET:
                _params['detector_id'] = detector_id
            if threat_intel_set_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_findings(
        ...
        *,
        detector_id: str,
        finding_ids: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        sort_criteria: shapes.SortCriteria = autoboto.ShapeBase.NOT_SET,
    ...
    def get_findings_statistics(
        ...
        *,
        ...
        if _request is None:
            ...
            if finding_criteria is not autoboto.ShapeBase.NOT_SET:
                _params['finding_criteria'] = finding_criteria
            if finding_statistic_types is not autoboto.ShapeBase.NOT_SET:
    ...
    def invite_members(
        ...
        *,
        detector_id: str,
        account_ids: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        disable_email_notification: bool = autoboto.ShapeBase.NOT_SET,
        message: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if account_ids is not autoboto.ShapeBase.NOT_SET:
                _params['account_ids'] = account_ids
            if disable_email_notification is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_members(
        ...
        *,
        ...
        max_results: int = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        only_associated: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if next_token is not autoboto.ShapeBase.NOT_SET:
                _params['next_token'] = next_token
            if only_associated is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_findings_feedback(
        ...
        *,
        detector_id: str,
        comments: str = autoboto.ShapeBase.NOT_SET,
        feedback: shapes.Feedback = autoboto.ShapeBase.NOT_SET,
        finding_ids: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if detector_id is not autoboto.ShapeBase.NOT_SET:
                _params['detector_id'] = detector_id
            if comments is not autoboto.ShapeBase.NOT_SET:
                _params['comments'] = comments
            if feedback is not autoboto.ShapeBase.NOT_SET:
