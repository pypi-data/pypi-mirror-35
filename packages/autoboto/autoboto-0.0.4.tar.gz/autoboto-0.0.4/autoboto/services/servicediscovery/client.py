...
class Client:
    ...
    def create_service(
        ...
        *,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase.NOT_SET:
                _params['name'] = name
            if dns_config is not autoboto.ShapeBase.NOT_SET:
            ...
            if health_check_custom_config is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_instances_health_status(
        ...
        *,
        service_id: str,
        instances: typing.List[str] = autoboto.ShapeBase.NOT_SET,
    ...
    def list_services(
        ...
        *,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
        filters: typing.List[shapes.ServiceFilter] = autoboto.ShapeBase.NOT_SET,
