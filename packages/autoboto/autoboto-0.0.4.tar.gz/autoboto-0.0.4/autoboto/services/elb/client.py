...
class Client:
    ...
    def configure_health_check(
        ...
        *,
        ...
        if _request is None:
            ...
            if load_balancer_name is not autoboto.ShapeBase.NOT_SET:
                _params['load_balancer_name'] = load_balancer_name
            if health_check is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_app_cookie_stickiness_policy(
        ...
        *,
        ...
        if _request is None:
            ...
            if cookie_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_lb_cookie_stickiness_policy(
        ...
        *,
        load_balancer_name: str,
        policy_name: str,
        cookie_expiration_period: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if policy_name is not autoboto.ShapeBase.NOT_SET:
                _params['policy_name'] = policy_name
            if cookie_expiration_period is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_load_balancer(
        ...
        *,
        ...
        scheme: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if load_balancer_name is not autoboto.ShapeBase.NOT_SET:
                _params['load_balancer_name'] = load_balancer_name
            if listeners is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_load_balancer_policy(
        ...
        *,
        ...
        if _request is None:
            ...
            if policy_name is not autoboto.ShapeBase.NOT_SET:
                _params['policy_name'] = policy_name
            if policy_type_name is not autoboto.ShapeBase.NOT_SET:
                _params['policy_type_name'] = policy_type_name
            if policy_attributes is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_load_balancer_listeners(
        ...
        *,
        ...
        if _request is None:
            ...
            if load_balancer_name is not autoboto.ShapeBase.NOT_SET:
                _params['load_balancer_name'] = load_balancer_name
            if load_balancer_ports is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_instance_health(
        ...
        *,
        load_balancer_name: str,
        instances: typing.List[shapes.Instance] = autoboto.ShapeBase.NOT_SET,
    ...
    def describe_load_balancer_policies(
        ...
        *,
        load_balancer_name: str = autoboto.ShapeBase.NOT_SET,
    ...
    def describe_load_balancer_policy_types(
        ...
        *,
        policy_type_names: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if policy_type_names is not autoboto.ShapeBase.NOT_SET:
    ...
    def modify_load_balancer_attributes(
        ...
        *,
        ...
        if _request is None:
            ...
            if load_balancer_name is not autoboto.ShapeBase.NOT_SET:
                _params['load_balancer_name'] = load_balancer_name
            if load_balancer_attributes is not autoboto.ShapeBase.NOT_SET:
    ...
    def set_load_balancer_listener_ssl_certificate(
        ...
        *,
        ...
        if _request is None:
            ...
            if load_balancer_name is not autoboto.ShapeBase.NOT_SET:
                _params['load_balancer_name'] = load_balancer_name
            if load_balancer_port is not autoboto.ShapeBase.NOT_SET:
                _params['load_balancer_port'] = load_balancer_port
            if ssl_certificate_id is not autoboto.ShapeBase.NOT_SET:
