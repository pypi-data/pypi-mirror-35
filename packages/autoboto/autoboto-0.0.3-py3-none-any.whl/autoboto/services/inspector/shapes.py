...
class AccessDeniedException(autoboto.ShapeBase):
    ...
    can_retry: bool = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class AssessmentRunFilter(autoboto.ShapeBase):
    ...
    name_pattern: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class AssessmentRunNotification(autoboto.ShapeBase):
    ...
    # error.
    error: bool = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class AssetAttributes(autoboto.ShapeBase):
    ...
    ami_id: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class CreateExclusionsPreviewResponse(autoboto.ShapeBase):
    ...
    preview_token: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
class DescribeExclusionsRequest(autoboto.ShapeBase):
    ...
    locale: "Locale" = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class DurationRange(autoboto.ShapeBase):
    ...
    min_seconds: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # The maximum value of the duration range. Must be less than or equal to
    # 604800 seconds (1 week).
    max_seconds: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class Finding(autoboto.ShapeBase):
    ...
    confidence: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class Scope(autoboto.ShapeBase):
    ...
    key: "ScopeType" = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class TelemetryMetadata(autoboto.ShapeBase):
    ...
    message_type: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    # service.
    data_size: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
