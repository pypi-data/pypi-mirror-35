...
class Client:
    ...
    def create_core_definition(
        ...
        *,
        amzn_client_token: str = autoboto.ShapeBase._NOT_SET,
        initial_version: shapes.CoreDefinitionVersion = autoboto.ShapeBase.
        _NOT_SET,
        ...
        if _request is None:
            _params = {}
            if amzn_client_token is not autoboto.ShapeBase._NOT_SET:
                _params['amzn_client_token'] = amzn_client_token
            if initial_version is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_core_definition_version(
        ...
        *,
        ...
        amzn_client_token: str = autoboto.ShapeBase._NOT_SET,
        cores: typing.List[shapes.Core] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if core_definition_id is not autoboto.ShapeBase._NOT_SET:
                _params['core_definition_id'] = core_definition_id
            if amzn_client_token is not autoboto.ShapeBase._NOT_SET:
                _params['amzn_client_token'] = amzn_client_token
            if cores is not autoboto.ShapeBase._NOT_SET:
                _params['cores'] = cores
    ...
    def create_deployment(
        ...
        *,
        ...
        deployment_type: shapes.DeploymentType = autoboto.ShapeBase._NOT_SET,
        group_version_id: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if deployment_type is not autoboto.ShapeBase._NOT_SET:
                _params['deployment_type'] = deployment_type
            if group_version_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_device_definition(
        ...
        *,
        amzn_client_token: str = autoboto.ShapeBase._NOT_SET,
        initial_version: shapes.DeviceDefinitionVersion = autoboto.ShapeBase.
        _NOT_SET,
        name: str = autoboto.ShapeBase._NOT_SET,
    ...
    def create_device_definition_version(
        ...
        *,
        ...
        amzn_client_token: str = autoboto.ShapeBase._NOT_SET,
        devices: typing.List[shapes.Device] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if device_definition_id is not autoboto.ShapeBase._NOT_SET:
                _params['device_definition_id'] = device_definition_id
            if amzn_client_token is not autoboto.ShapeBase._NOT_SET:
                _params['amzn_client_token'] = amzn_client_token
            if devices is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_function_definition(
        ...
        *,
        amzn_client_token: str = autoboto.ShapeBase._NOT_SET,
        initial_version: shapes.FunctionDefinitionVersion = autoboto.ShapeBase.
        _NOT_SET,
        name: str = autoboto.ShapeBase._NOT_SET,
    ...
    def create_function_definition_version(
        ...
        *,
        ...
        amzn_client_token: str = autoboto.ShapeBase._NOT_SET,
        functions: typing.List[shapes.Function] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if function_definition_id is not autoboto.ShapeBase._NOT_SET:
                _params['function_definition_id'] = function_definition_id
            if amzn_client_token is not autoboto.ShapeBase._NOT_SET:
                _params['amzn_client_token'] = amzn_client_token
            if functions is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_group(
        ...
        *,
        amzn_client_token: str = autoboto.ShapeBase._NOT_SET,
        initial_version: shapes.GroupVersion = autoboto.ShapeBase._NOT_SET,
        name: str = autoboto.ShapeBase._NOT_SET,
    ...
    def create_group_version(
        ...
        *,
        group_id: str,
        amzn_client_token: str = autoboto.ShapeBase._NOT_SET,
        core_definition_version_arn: str = autoboto.ShapeBase._NOT_SET,
        device_definition_version_arn: str = autoboto.ShapeBase._NOT_SET,
        function_definition_version_arn: str = autoboto.ShapeBase._NOT_SET,
        logger_definition_version_arn: str = autoboto.ShapeBase._NOT_SET,
        resource_definition_version_arn: str = autoboto.ShapeBase._NOT_SET,
        subscription_definition_version_arn: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if amzn_client_token is not autoboto.ShapeBase._NOT_SET:
                _params['amzn_client_token'] = amzn_client_token
            if core_definition_version_arn is not autoboto.ShapeBase._NOT_SET:
                _params['core_definition_version_arn'
                       ] = core_definition_version_arn
            if device_definition_version_arn is not autoboto.ShapeBase._NOT_SET:
                _params['device_definition_version_arn'
                       ] = device_definition_version_arn
            if function_definition_version_arn is not autoboto.ShapeBase._NOT_SET:
                _params['function_definition_version_arn'
                       ] = function_definition_version_arn
            if logger_definition_version_arn is not autoboto.ShapeBase._NOT_SET:
                _params['logger_definition_version_arn'
                       ] = logger_definition_version_arn
            if resource_definition_version_arn is not autoboto.ShapeBase._NOT_SET:
                _params['resource_definition_version_arn'
                       ] = resource_definition_version_arn
            if subscription_definition_version_arn is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_logger_definition(
        ...
        *,
        amzn_client_token: str = autoboto.ShapeBase._NOT_SET,
        initial_version: shapes.LoggerDefinitionVersion = autoboto.ShapeBase.
        _NOT_SET,
        name: str = autoboto.ShapeBase._NOT_SET,
    ...
    def create_logger_definition_version(
        ...
        *,
        ...
        amzn_client_token: str = autoboto.ShapeBase._NOT_SET,
        loggers: typing.List[shapes.Logger] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if logger_definition_id is not autoboto.ShapeBase._NOT_SET:
                _params['logger_definition_id'] = logger_definition_id
            if amzn_client_token is not autoboto.ShapeBase._NOT_SET:
                _params['amzn_client_token'] = amzn_client_token
            if loggers is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_resource_definition(
        ...
        *,
        amzn_client_token: str = autoboto.ShapeBase._NOT_SET,
        initial_version: shapes.ResourceDefinitionVersion = autoboto.ShapeBase.
        _NOT_SET,
        name: str = autoboto.ShapeBase._NOT_SET,
    ...
    def create_resource_definition_version(
        ...
        *,
        ...
        amzn_client_token: str = autoboto.ShapeBase._NOT_SET,
        resources: typing.List[shapes.Resource] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if resource_definition_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_software_update_job(
        ...
        *,
        amzn_client_token: str = autoboto.ShapeBase._NOT_SET,
        s3_url_signer_role: str = autoboto.ShapeBase._NOT_SET,
        software_to_update: shapes.SoftwareToUpdate = autoboto.ShapeBase.
        _NOT_SET,
        update_agent_log_level: shapes.UpdateAgentLogLevel = autoboto.ShapeBase.
        _NOT_SET,
        update_targets: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        update_targets_architecture: shapes.
        UpdateTargetsArchitecture = autoboto.ShapeBase._NOT_SET,
        update_targets_operating_system: shapes.
        UpdateTargetsOperatingSystem = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if amzn_client_token is not autoboto.ShapeBase._NOT_SET:
                _params['amzn_client_token'] = amzn_client_token
            if s3_url_signer_role is not autoboto.ShapeBase._NOT_SET:
                _params['s3_url_signer_role'] = s3_url_signer_role
            if software_to_update is not autoboto.ShapeBase._NOT_SET:
                _params['software_to_update'] = software_to_update
            if update_agent_log_level is not autoboto.ShapeBase._NOT_SET:
                _params['update_agent_log_level'] = update_agent_log_level
            if update_targets is not autoboto.ShapeBase._NOT_SET:
                _params['update_targets'] = update_targets
            if update_targets_architecture is not autoboto.ShapeBase._NOT_SET:
                _params['update_targets_architecture'
                       ] = update_targets_architecture
            if update_targets_operating_system is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_subscription_definition(
        ...
        *,
        amzn_client_token: str = autoboto.ShapeBase._NOT_SET,
        initial_version: shapes.SubscriptionDefinitionVersion = autoboto.
        ShapeBase._NOT_SET,
        name: str = autoboto.ShapeBase._NOT_SET,
    ...
    def create_subscription_definition_version(
        ...
        *,
        ...
        amzn_client_token: str = autoboto.ShapeBase._NOT_SET,
        subscriptions: typing.List[shapes.Subscription
        ...
        if _request is None:
            _params = {}
            if subscription_definition_id is not autoboto.ShapeBase._NOT_SET:
                _params['subscription_definition_id'
                       ] = subscription_definition_id
            if amzn_client_token is not autoboto.ShapeBase._NOT_SET:
                _params['amzn_client_token'] = amzn_client_token
            if subscriptions is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_core_definition_version(
        ...
        *,
        ...
        if _request is None:
            ...
            if core_definition_id is not autoboto.ShapeBase._NOT_SET:
                _params['core_definition_id'] = core_definition_id
            if core_definition_version_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_device_definition_version(
        ...
        *,
        ...
        if _request is None:
            ...
            if device_definition_id is not autoboto.ShapeBase._NOT_SET:
                _params['device_definition_id'] = device_definition_id
            if device_definition_version_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_function_definition_version(
        ...
        *,
        ...
        if _request is None:
            ...
            if function_definition_id is not autoboto.ShapeBase._NOT_SET:
                _params['function_definition_id'] = function_definition_id
            if function_definition_version_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_group_certificate_authority(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if certificate_authority_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_logger_definition_version(
        ...
        *,
        ...
        if _request is None:
            ...
            if logger_definition_id is not autoboto.ShapeBase._NOT_SET:
                _params['logger_definition_id'] = logger_definition_id
            if logger_definition_version_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_resource_definition_version(
        ...
        *,
        ...
        if _request is None:
            ...
            if resource_definition_id is not autoboto.ShapeBase._NOT_SET:
                _params['resource_definition_id'] = resource_definition_id
            if resource_definition_version_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_subscription_definition_version(
        ...
        *,
        ...
        if _request is None:
            ...
            if subscription_definition_version_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_connectivity_info(
        ...
        *,
        ...
        if _request is None:
            ...
            if thing_name is not autoboto.ShapeBase._NOT_SET:
                _params['thing_name'] = thing_name
            if connectivity_info is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_group_certificate_configuration(
        ...
        *,
        group_id: str,
        certificate_expiry_in_milliseconds: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if group_id is not autoboto.ShapeBase._NOT_SET:
                _params['group_id'] = group_id
            if certificate_expiry_in_milliseconds is not autoboto.ShapeBase._NOT_SET:
