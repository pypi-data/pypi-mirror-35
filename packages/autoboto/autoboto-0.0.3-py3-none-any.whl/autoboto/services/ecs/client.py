...
class Client:
    ...
    def create_cluster(
        ...
        *,
        cluster_name: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if cluster_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_service(
        ...
        *,
        service_name: str,
        task_definition: str,
        cluster: str = autoboto.ShapeBase._NOT_SET,
        load_balancers: typing.List[shapes.LoadBalancer
                                   ] = autoboto.ShapeBase._NOT_SET,
        service_registries: typing.List[shapes.ServiceRegistry
                                       ] = autoboto.ShapeBase._NOT_SET,
        desired_count: int = autoboto.ShapeBase._NOT_SET,
        client_token: str = autoboto.ShapeBase._NOT_SET,
        launch_type: shapes.LaunchType = autoboto.ShapeBase._NOT_SET,
        platform_version: str = autoboto.ShapeBase._NOT_SET,
        role: str = autoboto.ShapeBase._NOT_SET,
        deployment_configuration: shapes.DeploymentConfiguration = autoboto.
        ShapeBase._NOT_SET,
        placement_constraints: typing.List[shapes.PlacementConstraint
                                          ] = autoboto.ShapeBase._NOT_SET,
        placement_strategy: typing.List[shapes.PlacementStrategy
                                       ] = autoboto.ShapeBase._NOT_SET,
        network_configuration: shapes.NetworkConfiguration = autoboto.ShapeBase.
        _NOT_SET,
        health_check_grace_period_seconds: int = autoboto.ShapeBase._NOT_SET,
        scheduling_strategy: shapes.SchedulingStrategy = autoboto.ShapeBase.
        _NOT_SET,
        ...
        if _request is None:
            ...
            if task_definition is not autoboto.ShapeBase._NOT_SET:
                _params['task_definition'] = task_definition
            if cluster is not autoboto.ShapeBase._NOT_SET:
                _params['cluster'] = cluster
            if load_balancers is not autoboto.ShapeBase._NOT_SET:
                _params['load_balancers'] = load_balancers
            if service_registries is not autoboto.ShapeBase._NOT_SET:
                _params['service_registries'] = service_registries
            if desired_count is not autoboto.ShapeBase._NOT_SET:
                _params['desired_count'] = desired_count
            if client_token is not autoboto.ShapeBase._NOT_SET:
                _params['client_token'] = client_token
            if launch_type is not autoboto.ShapeBase._NOT_SET:
                _params['launch_type'] = launch_type
            if platform_version is not autoboto.ShapeBase._NOT_SET:
                _params['platform_version'] = platform_version
            if role is not autoboto.ShapeBase._NOT_SET:
                _params['role'] = role
            if deployment_configuration is not autoboto.ShapeBase._NOT_SET:
                _params['deployment_configuration'] = deployment_configuration
            if placement_constraints is not autoboto.ShapeBase._NOT_SET:
                _params['placement_constraints'] = placement_constraints
            if placement_strategy is not autoboto.ShapeBase._NOT_SET:
                _params['placement_strategy'] = placement_strategy
            if network_configuration is not autoboto.ShapeBase._NOT_SET:
                _params['network_configuration'] = network_configuration
            if health_check_grace_period_seconds is not autoboto.ShapeBase._NOT_SET:
                _params['health_check_grace_period_seconds'
                       ] = health_check_grace_period_seconds
            if scheduling_strategy is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_service(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if service is not autoboto.ShapeBase._NOT_SET:
    ...
    def deregister_container_instance(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if container_instance is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_clusters(
        ...
        *,
        clusters: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        include: typing.List[shapes.ClusterField] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if clusters is not autoboto.ShapeBase._NOT_SET:
                _params['clusters'] = clusters
            if include is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_container_instances(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if container_instances is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_services(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if services is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_tasks(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if tasks is not autoboto.ShapeBase._NOT_SET:
                _params['tasks'] = tasks
            if cluster is not autoboto.ShapeBase._NOT_SET:
                _params['cluster'] = cluster
    ...
    def discover_poll_endpoint(
        ...
        *,
        container_instance: str = autoboto.ShapeBase._NOT_SET,
        cluster: str = autoboto.ShapeBase._NOT_SET,
    ...
    def list_container_instances(
        ...
        *,
        ...
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        status: shapes.ContainerInstanceStatus = autoboto.ShapeBase._NOT_SET,
    ...
    def list_task_definition_families(
        ...
        *,
        family_prefix: str = autoboto.ShapeBase._NOT_SET,
        status: shapes.TaskDefinitionFamilyStatus = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if family_prefix is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_task_definitions(
        ...
        *,
        family_prefix: str = autoboto.ShapeBase._NOT_SET,
        status: shapes.TaskDefinitionStatus = autoboto.ShapeBase._NOT_SET,
        sort: shapes.SortOrder = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if status is not autoboto.ShapeBase._NOT_SET:
                _params['status'] = status
            if sort is not autoboto.ShapeBase._NOT_SET:
                _params['sort'] = sort
            if next_token is not autoboto.ShapeBase._NOT_SET:
                _params['next_token'] = next_token
            if max_results is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_tasks(
        ...
        *,
        cluster: str = autoboto.ShapeBase._NOT_SET,
        container_instance: str = autoboto.ShapeBase._NOT_SET,
        family: str = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        started_by: str = autoboto.ShapeBase._NOT_SET,
        service_name: str = autoboto.ShapeBase._NOT_SET,
        desired_status: shapes.DesiredStatus = autoboto.ShapeBase._NOT_SET,
        launch_type: shapes.LaunchType = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if container_instance is not autoboto.ShapeBase._NOT_SET:
                _params['container_instance'] = container_instance
            if family is not autoboto.ShapeBase._NOT_SET:
                _params['family'] = family
            if next_token is not autoboto.ShapeBase._NOT_SET:
                _params['next_token'] = next_token
            if max_results is not autoboto.ShapeBase._NOT_SET:
                _params['max_results'] = max_results
            if started_by is not autoboto.ShapeBase._NOT_SET:
                _params['started_by'] = started_by
            if service_name is not autoboto.ShapeBase._NOT_SET:
                _params['service_name'] = service_name
            if desired_status is not autoboto.ShapeBase._NOT_SET:
    ...
    def register_container_instance(
        ...
        *,
        cluster: str = autoboto.ShapeBase._NOT_SET,
        instance_identity_document: str = autoboto.ShapeBase._NOT_SET,
        instance_identity_document_signature: str = autoboto.ShapeBase._NOT_SET,
        total_resources: typing.List[shapes.Resource
                                    ] = autoboto.ShapeBase._NOT_SET,
        version_info: shapes.VersionInfo = autoboto.ShapeBase._NOT_SET,
        container_instance_arn: str = autoboto.ShapeBase._NOT_SET,
        attributes: typing.List[shapes.Attribute] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if cluster is not autoboto.ShapeBase._NOT_SET:
                _params['cluster'] = cluster
            if instance_identity_document is not autoboto.ShapeBase._NOT_SET:
                _params['instance_identity_document'
                       ] = instance_identity_document
            if instance_identity_document_signature is not autoboto.ShapeBase._NOT_SET:
                _params['instance_identity_document_signature'
                       ] = instance_identity_document_signature
            if total_resources is not autoboto.ShapeBase._NOT_SET:
                _params['total_resources'] = total_resources
            if version_info is not autoboto.ShapeBase._NOT_SET:
                _params['version_info'] = version_info
            if container_instance_arn is not autoboto.ShapeBase._NOT_SET:
    ...
    def register_task_definition(
        ...
        *,
        ...
        task_role_arn: str = autoboto.ShapeBase._NOT_SET,
        execution_role_arn: str = autoboto.ShapeBase._NOT_SET,
        network_mode: shapes.NetworkMode = autoboto.ShapeBase._NOT_SET,
        volumes: typing.List[shapes.Volume] = autoboto.ShapeBase._NOT_SET,
        ...
        cpu: str = autoboto.ShapeBase._NOT_SET,
        memory: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if family is not autoboto.ShapeBase._NOT_SET:
                _params['family'] = family
            if container_definitions is not autoboto.ShapeBase._NOT_SET:
                _params['container_definitions'] = container_definitions
            if task_role_arn is not autoboto.ShapeBase._NOT_SET:
                _params['task_role_arn'] = task_role_arn
            if execution_role_arn is not autoboto.ShapeBase._NOT_SET:
                _params['execution_role_arn'] = execution_role_arn
            if network_mode is not autoboto.ShapeBase._NOT_SET:
                _params['network_mode'] = network_mode
            if volumes is not autoboto.ShapeBase._NOT_SET:
                _params['volumes'] = volumes
            if placement_constraints is not autoboto.ShapeBase._NOT_SET:
                _params['placement_constraints'] = placement_constraints
            if requires_compatibilities is not autoboto.ShapeBase._NOT_SET:
                _params['requires_compatibilities'] = requires_compatibilities
            if cpu is not autoboto.ShapeBase._NOT_SET:
                _params['cpu'] = cpu
            if memory is not autoboto.ShapeBase._NOT_SET:
    ...
    def run_task(
        ...
        *,
        task_definition: str,
        cluster: str = autoboto.ShapeBase._NOT_SET,
        overrides: shapes.TaskOverride = autoboto.ShapeBase._NOT_SET,
        count: int = autoboto.ShapeBase._NOT_SET,
        started_by: str = autoboto.ShapeBase._NOT_SET,
        group: str = autoboto.ShapeBase._NOT_SET,
        placement_constraints: typing.List[shapes.PlacementConstraint
                                          ] = autoboto.ShapeBase._NOT_SET,
        placement_strategy: typing.List[shapes.PlacementStrategy
                                       ] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if cluster is not autoboto.ShapeBase._NOT_SET:
                _params['cluster'] = cluster
            if overrides is not autoboto.ShapeBase._NOT_SET:
                _params['overrides'] = overrides
            if count is not autoboto.ShapeBase._NOT_SET:
                _params['count'] = count
            if started_by is not autoboto.ShapeBase._NOT_SET:
                _params['started_by'] = started_by
            if group is not autoboto.ShapeBase._NOT_SET:
                _params['group'] = group
            if placement_constraints is not autoboto.ShapeBase._NOT_SET:
                _params['placement_constraints'] = placement_constraints
            if placement_strategy is not autoboto.ShapeBase._NOT_SET:
    ...
    def stop_task(
        ...
        *,
        task: str,
        cluster: str = autoboto.ShapeBase._NOT_SET,
        reason: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if task is not autoboto.ShapeBase._NOT_SET:
                _params['task'] = task
            if cluster is not autoboto.ShapeBase._NOT_SET:
                _params['cluster'] = cluster
            if reason is not autoboto.ShapeBase._NOT_SET:
    ...
    def submit_container_state_change(
        ...
        *,
        cluster: str = autoboto.ShapeBase._NOT_SET,
        task: str = autoboto.ShapeBase._NOT_SET,
        container_name: str = autoboto.ShapeBase._NOT_SET,
        status: str = autoboto.ShapeBase._NOT_SET,
        exit_code: int = autoboto.ShapeBase._NOT_SET,
        reason: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if task is not autoboto.ShapeBase._NOT_SET:
                _params['task'] = task
            if container_name is not autoboto.ShapeBase._NOT_SET:
                _params['container_name'] = container_name
            if status is not autoboto.ShapeBase._NOT_SET:
                _params['status'] = status
            if exit_code is not autoboto.ShapeBase._NOT_SET:
                _params['exit_code'] = exit_code
            if reason is not autoboto.ShapeBase._NOT_SET:
                _params['reason'] = reason
            if network_bindings is not autoboto.ShapeBase._NOT_SET:
    ...
    def submit_task_state_change(
        ...
        *,
        ...
        pull_started_at: datetime.datetime = autoboto.ShapeBase._NOT_SET,
        pull_stopped_at: datetime.datetime = autoboto.ShapeBase._NOT_SET,
        execution_stopped_at: datetime.datetime = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if reason is not autoboto.ShapeBase._NOT_SET:
                _params['reason'] = reason
            if containers is not autoboto.ShapeBase._NOT_SET:
                _params['containers'] = containers
            if attachments is not autoboto.ShapeBase._NOT_SET:
                _params['attachments'] = attachments
            if pull_started_at is not autoboto.ShapeBase._NOT_SET:
                _params['pull_started_at'] = pull_started_at
            if pull_stopped_at is not autoboto.ShapeBase._NOT_SET:
                _params['pull_stopped_at'] = pull_stopped_at
            if execution_stopped_at is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_service(
        ...
        *,
        ...
        cluster: str = autoboto.ShapeBase._NOT_SET,
        desired_count: int = autoboto.ShapeBase._NOT_SET,
        task_definition: str = autoboto.ShapeBase._NOT_SET,
        deployment_configuration: shapes.DeploymentConfiguration = autoboto.
        ShapeBase._NOT_SET,
        network_configuration: shapes.NetworkConfiguration = autoboto.ShapeBase.
        _NOT_SET,
        platform_version: str = autoboto.ShapeBase._NOT_SET,
        force_new_deployment: bool = autoboto.ShapeBase._NOT_SET,
        health_check_grace_period_seconds: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if platform_version is not autoboto.ShapeBase._NOT_SET:
                _params['platform_version'] = platform_version
            if force_new_deployment is not autoboto.ShapeBase._NOT_SET:
