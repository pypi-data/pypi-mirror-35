...
class CreatePrivateDnsNamespaceRequest(autoboto.ShapeBase):
    ...
    vpc: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class DeregisterInstanceRequest(autoboto.ShapeBase):
    ...
    service_id: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class DnsConfig(autoboto.ShapeBase):
    ...
    namespace_id: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class DnsRecord(autoboto.ShapeBase):
    ...
    type: "RecordType" = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
class Namespace(autoboto.ShapeBase):
    ...
    service_count: int = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
