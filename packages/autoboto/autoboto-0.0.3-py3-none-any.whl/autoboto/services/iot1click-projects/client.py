...
class Client:
    ...
    def create_project(
        ...
        *,
        ...
        placement_template: shapes.PlacementTemplate = autoboto.ShapeBase.
        _NOT_SET,
        ...
        if _request is None:
            ...
            if placement_template is not autoboto.ShapeBase._NOT_SET:
