...
class ASN1Subject(autoboto.ShapeBase):
    """
    ...
    common_name: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    # located.
    locality: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    # ordered first.
    surname: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # First name.
    given_name: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    # of the **SurName**.
    initials: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    # Liz, or Eliza.
    pseudonym: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    generation_qualifier: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
@dataclasses.dataclass
class CertificateAuthority(autoboto.ShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "type",
                "Type",
                autoboto.TypeInfo(CertificateAuthorityType),
            ),
            (
                "serial",
                "Serial",
            ...
            (
                "status",
                "Status",
                autoboto.TypeInfo(CertificateAuthorityStatus),
            ),
            (
                "not_before",
                "NotBefore",
            ...
            (
                "failure_reason",
                "FailureReason",
                autoboto.TypeInfo(FailureReason),
            ),
            (
                "certificate_authority_configuration",
                "CertificateAuthorityConfiguration",
                autoboto.TypeInfo(CertificateAuthorityConfiguration),
            ),
            (
                "revocation_configuration",
                "RevocationConfiguration",
                autoboto.TypeInfo(RevocationConfiguration),
            ),
            (
                "restorable_until",
                "RestorableUntil",
    ...
    serial: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
@dataclasses.dataclass
class CertificateAuthorityConfiguration(autoboto.ShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "key_algorithm",
                "KeyAlgorithm",
                autoboto.TypeInfo(KeyAlgorithm),
            ),
            (
                "signing_algorithm",
                "SigningAlgorithm",
                autoboto.TypeInfo(SigningAlgorithm),
            ),
            (
                "subject",
                "Subject",
                autoboto.TypeInfo(ASN1Subject),
            ),
        ]
...
@dataclasses.dataclass
class CertificateMismatchException(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class CreateCertificateAuthorityAuditReportRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
            ...
            (
                ...
                autoboto.TypeInfo(AuditReportResponseFormat),
            ),
        ]
...
@dataclasses.dataclass
class CreateCertificateAuthorityAuditReportResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
    ...
    audit_report_id: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
@dataclasses.dataclass
class CreateCertificateAuthorityRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class CreateCertificateAuthorityResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class CrlConfiguration(autoboto.ShapeBase):
    """
    ...
    expiration_in_days: int = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
    ...
    custom_cname: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
@dataclasses.dataclass
class DeleteCertificateAuthorityRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DescribeCertificateAuthorityAuditReportRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DescribeCertificateAuthorityAuditReportResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
                "audit_report_status",
                "AuditReportStatus",
                autoboto.TypeInfo(AuditReportStatus),
            ),
            (
                "s3_bucket_name",
                "S3BucketName",
...
@dataclasses.dataclass
class DescribeCertificateAuthorityRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DescribeCertificateAuthorityResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
                ...
                autoboto.TypeInfo(CertificateAuthority),
            ),
        ]
...
@dataclasses.dataclass
class GetCertificateAuthorityCertificateRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class GetCertificateAuthorityCertificateResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class GetCertificateAuthorityCsrRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class GetCertificateAuthorityCsrResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
    ...
    # CA certificate.
    csr: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )


@dataclasses.dataclass
class GetCertificateRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class GetCertificateResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class ImportCertificateAuthorityCertificateRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
    ...
    certificate: typing.Any = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
@dataclasses.dataclass
class InvalidArgsException(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class IssueCertificateRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
    ...
    # csr/test_cert_.csr`
    csr: typing.Any = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
@dataclasses.dataclass
class IssueCertificateResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class ListCertificateAuthoritiesRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class ListCertificateAuthoritiesResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
                ...
                autoboto.TypeInfo(typing.List[CertificateAuthority]),
            ),
            (
                "next_token",
                "NextToken",
...
@dataclasses.dataclass
class MalformedCSRException(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class RequestAlreadyProcessedException(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class RequestFailedException(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class RequestInProgressException(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class RestoreCertificateAuthorityRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class RevocationConfiguration(autoboto.ShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "crl_configuration",
                "CrlConfiguration",
                autoboto.TypeInfo(CrlConfiguration),
            ),
        ]
...
@dataclasses.dataclass
class RevokeCertificateRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
            ...
            (
                "revocation_reason",
                "RevocationReason",
                autoboto.TypeInfo(RevocationReason),
            ),
        ]
    ...
    certificate_serial: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
@dataclasses.dataclass
class TagCertificateAuthorityRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class UntagCertificateAuthorityRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class UpdateCertificateAuthorityRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class Validity(autoboto.ShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "type",
                "Type",
                autoboto.TypeInfo(ValidityPeriodType),
            ),
        ]
    ...
    type: "ValidityPeriodType" = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
