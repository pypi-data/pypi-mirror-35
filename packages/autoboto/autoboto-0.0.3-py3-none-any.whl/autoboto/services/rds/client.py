...
class Client:
    ...
    def add_source_identifier_to_subscription(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if subscription_name is not autoboto.ShapeBase._NOT_SET:
                _params['subscription_name'] = subscription_name
            if source_identifier is not autoboto.ShapeBase._NOT_SET:
    ...
    def add_tags_to_resource(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if resource_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def apply_pending_maintenance_action(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if resource_identifier is not autoboto.ShapeBase._NOT_SET:
                _params['resource_identifier'] = resource_identifier
            if apply_action is not autoboto.ShapeBase._NOT_SET:
                _params['apply_action'] = apply_action
            if opt_in_type is not autoboto.ShapeBase._NOT_SET:
    ...
    def authorize_db_security_group_ingress(
        ...
        *,
        ...
        cidrip: str = autoboto.ShapeBase._NOT_SET,
        ec2_security_group_name: str = autoboto.ShapeBase._NOT_SET,
        ec2_security_group_id: str = autoboto.ShapeBase._NOT_SET,
        ec2_security_group_owner_id: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if db_security_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['db_security_group_name'] = db_security_group_name
            if cidrip is not autoboto.ShapeBase._NOT_SET:
                _params['cidrip'] = cidrip
            if ec2_security_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['ec2_security_group_name'] = ec2_security_group_name
            if ec2_security_group_id is not autoboto.ShapeBase._NOT_SET:
                _params['ec2_security_group_id'] = ec2_security_group_id
            if ec2_security_group_owner_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def backtrack_db_cluster(
        ...
        *,
        ...
        use_earliest_time_on_point_in_time_unavailable: bool = autoboto.
        ShapeBase._NOT_SET,
        ...
        Cluster](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/AuroraMySQL.Managing.Backtrack.html)
        ...
        if _request is None:
            ...
            if db_cluster_identifier is not autoboto.ShapeBase._NOT_SET:
                _params['db_cluster_identifier'] = db_cluster_identifier
            if backtrack_to is not autoboto.ShapeBase._NOT_SET:
                _params['backtrack_to'] = backtrack_to
            if force is not autoboto.ShapeBase._NOT_SET:
                _params['force'] = force
            if use_earliest_time_on_point_in_time_unavailable is not autoboto.ShapeBase._NOT_SET:
    ...
    def copy_db_cluster_parameter_group(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if source_db_cluster_parameter_group_identifier is not autoboto.ShapeBase._NOT_SET:
                _params['source_db_cluster_parameter_group_identifier'
                       ] = source_db_cluster_parameter_group_identifier
            if target_db_cluster_parameter_group_identifier is not autoboto.ShapeBase._NOT_SET:
                _params['target_db_cluster_parameter_group_identifier'
                       ] = target_db_cluster_parameter_group_identifier
            if target_db_cluster_parameter_group_description is not autoboto.ShapeBase._NOT_SET:
    ...
    def copy_db_cluster_snapshot(
        ...
        *,
        ...
        pre_signed_url: str = autoboto.ShapeBase._NOT_SET,
        copy_tags: bool = autoboto.ShapeBase._NOT_SET,
        tags: typing.List[shapes.Tag] = autoboto.ShapeBase._NOT_SET,
        source_region: str = autoboto.ShapeBase._NOT_SET,
        ...
        RDS](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/CHAP_Aurora.html) in
        the _Amazon RDS User Guide._
        """
        if _request is None:
            _params = {}
            if source_db_cluster_snapshot_identifier is not autoboto.ShapeBase._NOT_SET:
                _params['source_db_cluster_snapshot_identifier'
                       ] = source_db_cluster_snapshot_identifier
            if target_db_cluster_snapshot_identifier is not autoboto.ShapeBase._NOT_SET:
            ...
            if pre_signed_url is not autoboto.ShapeBase._NOT_SET:
                _params['pre_signed_url'] = pre_signed_url
            if copy_tags is not autoboto.ShapeBase._NOT_SET:
    ...
    def copy_db_parameter_group(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if source_db_parameter_group_identifier is not autoboto.ShapeBase._NOT_SET:
                _params['source_db_parameter_group_identifier'
                       ] = source_db_parameter_group_identifier
            if target_db_parameter_group_identifier is not autoboto.ShapeBase._NOT_SET:
                _params['target_db_parameter_group_identifier'
                       ] = target_db_parameter_group_identifier
            if target_db_parameter_group_description is not autoboto.ShapeBase._NOT_SET:
    ...
    def copy_db_snapshot(
        ...
        *,
        ...
        copy_tags: bool = autoboto.ShapeBase._NOT_SET,
        pre_signed_url: str = autoboto.ShapeBase._NOT_SET,
        option_group_name: str = autoboto.ShapeBase._NOT_SET,
        source_region: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if source_db_snapshot_identifier is not autoboto.ShapeBase._NOT_SET:
                _params['source_db_snapshot_identifier'
                       ] = source_db_snapshot_identifier
            if target_db_snapshot_identifier is not autoboto.ShapeBase._NOT_SET:
            ...
            if pre_signed_url is not autoboto.ShapeBase._NOT_SET:
                _params['pre_signed_url'] = pre_signed_url
            if option_group_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def copy_option_group(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if source_option_group_identifier is not autoboto.ShapeBase._NOT_SET:
                _params['source_option_group_identifier'
                       ] = source_option_group_identifier
            if target_option_group_identifier is not autoboto.ShapeBase._NOT_SET:
                _params['target_option_group_identifier'
                       ] = target_option_group_identifier
            if target_option_group_description is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_db_cluster(
        ...
        *,
        db_cluster_identifier: str,
        engine: str,
        availability_zones: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        backup_retention_period: int = autoboto.ShapeBase._NOT_SET,
        character_set_name: str = autoboto.ShapeBase._NOT_SET,
        database_name: str = autoboto.ShapeBase._NOT_SET,
        db_cluster_parameter_group_name: str = autoboto.ShapeBase._NOT_SET,
        vpc_security_group_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        db_subnet_group_name: str = autoboto.ShapeBase._NOT_SET,
        engine_version: str = autoboto.ShapeBase._NOT_SET,
        port: int = autoboto.ShapeBase._NOT_SET,
        master_username: str = autoboto.ShapeBase._NOT_SET,
        master_user_password: str = autoboto.ShapeBase._NOT_SET,
        option_group_name: str = autoboto.ShapeBase._NOT_SET,
        preferred_backup_window: str = autoboto.ShapeBase._NOT_SET,
        preferred_maintenance_window: str = autoboto.ShapeBase._NOT_SET,
        replication_source_identifier: str = autoboto.ShapeBase._NOT_SET,
        tags: typing.List[shapes.Tag] = autoboto.ShapeBase._NOT_SET,
        storage_encrypted: bool = autoboto.ShapeBase._NOT_SET,
        kms_key_id: str = autoboto.ShapeBase._NOT_SET,
        pre_signed_url: str = autoboto.ShapeBase._NOT_SET,
        enable_iam_database_authentication: bool = autoboto.ShapeBase._NOT_SET,
        backtrack_window: int = autoboto.ShapeBase._NOT_SET,
        enable_cloudwatch_logs_exports: typing.List[str] = autoboto.ShapeBase.
        _NOT_SET,
        engine_mode: str = autoboto.ShapeBase._NOT_SET,
        scaling_configuration: shapes.ScalingConfiguration = autoboto.ShapeBase.
        _NOT_SET,
        source_region: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if db_cluster_identifier is not autoboto.ShapeBase._NOT_SET:
                _params['db_cluster_identifier'] = db_cluster_identifier
            if engine is not autoboto.ShapeBase._NOT_SET:
                _params['engine'] = engine
            if availability_zones is not autoboto.ShapeBase._NOT_SET:
                _params['availability_zones'] = availability_zones
            if backup_retention_period is not autoboto.ShapeBase._NOT_SET:
                _params['backup_retention_period'] = backup_retention_period
            if character_set_name is not autoboto.ShapeBase._NOT_SET:
                _params['character_set_name'] = character_set_name
            if database_name is not autoboto.ShapeBase._NOT_SET:
                _params['database_name'] = database_name
            if db_cluster_parameter_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['db_cluster_parameter_group_name'
                       ] = db_cluster_parameter_group_name
            if vpc_security_group_ids is not autoboto.ShapeBase._NOT_SET:
                _params['vpc_security_group_ids'] = vpc_security_group_ids
            if db_subnet_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['db_subnet_group_name'] = db_subnet_group_name
            if engine_version is not autoboto.ShapeBase._NOT_SET:
                _params['engine_version'] = engine_version
            if port is not autoboto.ShapeBase._NOT_SET:
                _params['port'] = port
            if master_username is not autoboto.ShapeBase._NOT_SET:
                _params['master_username'] = master_username
            if master_user_password is not autoboto.ShapeBase._NOT_SET:
                _params['master_user_password'] = master_user_password
            if option_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['option_group_name'] = option_group_name
            if preferred_backup_window is not autoboto.ShapeBase._NOT_SET:
                _params['preferred_backup_window'] = preferred_backup_window
            if preferred_maintenance_window is not autoboto.ShapeBase._NOT_SET:
                _params['preferred_maintenance_window'
                       ] = preferred_maintenance_window
            if replication_source_identifier is not autoboto.ShapeBase._NOT_SET:
                _params['replication_source_identifier'
                       ] = replication_source_identifier
            if tags is not autoboto.ShapeBase._NOT_SET:
                _params['tags'] = tags
            if storage_encrypted is not autoboto.ShapeBase._NOT_SET:
                _params['storage_encrypted'] = storage_encrypted
            if kms_key_id is not autoboto.ShapeBase._NOT_SET:
                _params['kms_key_id'] = kms_key_id
            if pre_signed_url is not autoboto.ShapeBase._NOT_SET:
                _params['pre_signed_url'] = pre_signed_url
            if enable_iam_database_authentication is not autoboto.ShapeBase._NOT_SET:
                _params['enable_iam_database_authentication'
                       ] = enable_iam_database_authentication
            if backtrack_window is not autoboto.ShapeBase._NOT_SET:
                _params['backtrack_window'] = backtrack_window
            if enable_cloudwatch_logs_exports is not autoboto.ShapeBase._NOT_SET:
                _params['enable_cloudwatch_logs_exports'
                       ] = enable_cloudwatch_logs_exports
            if engine_mode is not autoboto.ShapeBase._NOT_SET:
                _params['engine_mode'] = engine_mode
            if scaling_configuration is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_db_cluster_parameter_group(
        ...
        *,
        ...
        if _request is None:
            ...
            if db_parameter_group_family is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_db_cluster_snapshot(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if db_cluster_snapshot_identifier is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_db_instance(
        ...
        *,
        ...
        engine: str,
        db_name: str = autoboto.ShapeBase._NOT_SET,
        allocated_storage: int = autoboto.ShapeBase._NOT_SET,
        master_username: str = autoboto.ShapeBase._NOT_SET,
        master_user_password: str = autoboto.ShapeBase._NOT_SET,
        db_security_groups: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        vpc_security_group_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        availability_zone: str = autoboto.ShapeBase._NOT_SET,
        db_subnet_group_name: str = autoboto.ShapeBase._NOT_SET,
        preferred_maintenance_window: str = autoboto.ShapeBase._NOT_SET,
        db_parameter_group_name: str = autoboto.ShapeBase._NOT_SET,
        backup_retention_period: int = autoboto.ShapeBase._NOT_SET,
        preferred_backup_window: str = autoboto.ShapeBase._NOT_SET,
        port: int = autoboto.ShapeBase._NOT_SET,
        multi_az: bool = autoboto.ShapeBase._NOT_SET,
        engine_version: str = autoboto.ShapeBase._NOT_SET,
        auto_minor_version_upgrade: bool = autoboto.ShapeBase._NOT_SET,
        license_model: str = autoboto.ShapeBase._NOT_SET,
        iops: int = autoboto.ShapeBase._NOT_SET,
        option_group_name: str = autoboto.ShapeBase._NOT_SET,
        character_set_name: str = autoboto.ShapeBase._NOT_SET,
        publicly_accessible: bool = autoboto.ShapeBase._NOT_SET,
        tags: typing.List[shapes.Tag] = autoboto.ShapeBase._NOT_SET,
        db_cluster_identifier: str = autoboto.ShapeBase._NOT_SET,
        storage_type: str = autoboto.ShapeBase._NOT_SET,
        tde_credential_arn: str = autoboto.ShapeBase._NOT_SET,
        tde_credential_password: str = autoboto.ShapeBase._NOT_SET,
        storage_encrypted: bool = autoboto.ShapeBase._NOT_SET,
        kms_key_id: str = autoboto.ShapeBase._NOT_SET,
        domain: str = autoboto.ShapeBase._NOT_SET,
        copy_tags_to_snapshot: bool = autoboto.ShapeBase._NOT_SET,
        monitoring_interval: int = autoboto.ShapeBase._NOT_SET,
        monitoring_role_arn: str = autoboto.ShapeBase._NOT_SET,
        domain_iam_role_name: str = autoboto.ShapeBase._NOT_SET,
        promotion_tier: int = autoboto.ShapeBase._NOT_SET,
        timezone: str = autoboto.ShapeBase._NOT_SET,
        enable_iam_database_authentication: bool = autoboto.ShapeBase._NOT_SET,
        enable_performance_insights: bool = autoboto.ShapeBase._NOT_SET,
        performance_insights_kms_key_id: str = autoboto.ShapeBase._NOT_SET,
        performance_insights_retention_period: int = autoboto.ShapeBase.
        _NOT_SET,
        enable_cloudwatch_logs_exports: typing.List[str] = autoboto.ShapeBase.
        _NOT_SET,
        ...
        if _request is None:
            _params = {}
            if db_instance_identifier is not autoboto.ShapeBase._NOT_SET:
                _params['db_instance_identifier'] = db_instance_identifier
            if db_instance_class is not autoboto.ShapeBase._NOT_SET:
                _params['db_instance_class'] = db_instance_class
            if engine is not autoboto.ShapeBase._NOT_SET:
                _params['engine'] = engine
            if db_name is not autoboto.ShapeBase._NOT_SET:
                _params['db_name'] = db_name
            if allocated_storage is not autoboto.ShapeBase._NOT_SET:
                _params['allocated_storage'] = allocated_storage
            if master_username is not autoboto.ShapeBase._NOT_SET:
                _params['master_username'] = master_username
            if master_user_password is not autoboto.ShapeBase._NOT_SET:
                _params['master_user_password'] = master_user_password
            if db_security_groups is not autoboto.ShapeBase._NOT_SET:
            ...
            if db_parameter_group_name is not autoboto.ShapeBase._NOT_SET:
            ...
            if port is not autoboto.ShapeBase._NOT_SET:
                _params['port'] = port
            if multi_az is not autoboto.ShapeBase._NOT_SET:
                _params['multi_az'] = multi_az
            if engine_version is not autoboto.ShapeBase._NOT_SET:
                _params['engine_version'] = engine_version
            if auto_minor_version_upgrade is not autoboto.ShapeBase._NOT_SET:
                _params['auto_minor_version_upgrade'
                       ] = auto_minor_version_upgrade
            if license_model is not autoboto.ShapeBase._NOT_SET:
            ...
            if character_set_name is not autoboto.ShapeBase._NOT_SET:
                _params['character_set_name'] = character_set_name
            if publicly_accessible is not autoboto.ShapeBase._NOT_SET:
                _params['publicly_accessible'] = publicly_accessible
            if tags is not autoboto.ShapeBase._NOT_SET:
                _params['tags'] = tags
            if db_cluster_identifier is not autoboto.ShapeBase._NOT_SET:
                _params['db_cluster_identifier'] = db_cluster_identifier
            if storage_type is not autoboto.ShapeBase._NOT_SET:
                _params['storage_type'] = storage_type
            if tde_credential_arn is not autoboto.ShapeBase._NOT_SET:
                _params['tde_credential_arn'] = tde_credential_arn
            if tde_credential_password is not autoboto.ShapeBase._NOT_SET:
            ...
            if copy_tags_to_snapshot is not autoboto.ShapeBase._NOT_SET:
                _params['copy_tags_to_snapshot'] = copy_tags_to_snapshot
            if monitoring_interval is not autoboto.ShapeBase._NOT_SET:
                _params['monitoring_interval'] = monitoring_interval
            if monitoring_role_arn is not autoboto.ShapeBase._NOT_SET:
                _params['monitoring_role_arn'] = monitoring_role_arn
            if domain_iam_role_name is not autoboto.ShapeBase._NOT_SET:
                _params['domain_iam_role_name'] = domain_iam_role_name
            if promotion_tier is not autoboto.ShapeBase._NOT_SET:
                _params['promotion_tier'] = promotion_tier
            if timezone is not autoboto.ShapeBase._NOT_SET:
                _params['timezone'] = timezone
            if enable_iam_database_authentication is not autoboto.ShapeBase._NOT_SET:
                _params['enable_iam_database_authentication'
                       ] = enable_iam_database_authentication
            if enable_performance_insights is not autoboto.ShapeBase._NOT_SET:
                _params['enable_performance_insights'
                       ] = enable_performance_insights
            if performance_insights_kms_key_id is not autoboto.ShapeBase._NOT_SET:
                _params['performance_insights_kms_key_id'
                       ] = performance_insights_kms_key_id
            if performance_insights_retention_period is not autoboto.ShapeBase._NOT_SET:
                _params['performance_insights_retention_period'
                       ] = performance_insights_retention_period
            if enable_cloudwatch_logs_exports is not autoboto.ShapeBase._NOT_SET:
                _params['enable_cloudwatch_logs_exports'
                       ] = enable_cloudwatch_logs_exports
            if processor_features is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_db_instance_read_replica(
        ...
        *,
        ...
        db_instance_class: str = autoboto.ShapeBase._NOT_SET,
        availability_zone: str = autoboto.ShapeBase._NOT_SET,
        port: int = autoboto.ShapeBase._NOT_SET,
        multi_az: bool = autoboto.ShapeBase._NOT_SET,
        auto_minor_version_upgrade: bool = autoboto.ShapeBase._NOT_SET,
        ...
        use_default_processor_features: bool = autoboto.ShapeBase._NOT_SET,
        source_region: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if db_instance_identifier is not autoboto.ShapeBase._NOT_SET:
                _params['db_instance_identifier'] = db_instance_identifier
            if source_db_instance_identifier is not autoboto.ShapeBase._NOT_SET:
            ...
            if processor_features is not autoboto.ShapeBase._NOT_SET:
                _params['processor_features'] = processor_features
            if use_default_processor_features is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_db_security_group(
        ...
        *,
        ...
        if _request is None:
            ...
            if db_security_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['db_security_group_name'] = db_security_group_name
            if db_security_group_description is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_db_snapshot(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if db_snapshot_identifier is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_db_subnet_group(
        ...
        *,
        ...
        if _request is None:
            ...
            if db_subnet_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['db_subnet_group_name'] = db_subnet_group_name
            if db_subnet_group_description is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_event_subscription(
        ...
        *,
        subscription_name: str,
        sns_topic_arn: str,
        source_type: str = autoboto.ShapeBase._NOT_SET,
        event_categories: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        source_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        enabled: bool = autoboto.ShapeBase._NOT_SET,
        tags: typing.List[shapes.Tag] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if subscription_name is not autoboto.ShapeBase._NOT_SET:
                _params['subscription_name'] = subscription_name
            if sns_topic_arn is not autoboto.ShapeBase._NOT_SET:
                _params['sns_topic_arn'] = sns_topic_arn
            if source_type is not autoboto.ShapeBase._NOT_SET:
                _params['source_type'] = source_type
            if event_categories is not autoboto.ShapeBase._NOT_SET:
                _params['event_categories'] = event_categories
            if source_ids is not autoboto.ShapeBase._NOT_SET:
                _params['source_ids'] = source_ids
            if enabled is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_option_group(
        ...
        *,
        ...
        if _request is None:
            ...
            if option_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['option_group_name'] = option_group_name
            if engine_name is not autoboto.ShapeBase._NOT_SET:
                _params['engine_name'] = engine_name
            if major_engine_version is not autoboto.ShapeBase._NOT_SET:
                _params['major_engine_version'] = major_engine_version
            if option_group_description is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_db_cluster(
        ...
        *,
        db_cluster_identifier: str,
        skip_final_snapshot: bool = autoboto.ShapeBase._NOT_SET,
        final_db_snapshot_identifier: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if db_cluster_identifier is not autoboto.ShapeBase._NOT_SET:
                _params['db_cluster_identifier'] = db_cluster_identifier
            if skip_final_snapshot is not autoboto.ShapeBase._NOT_SET:
                _params['skip_final_snapshot'] = skip_final_snapshot
            if final_db_snapshot_identifier is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_certificates(
        ...
        *,
        certificate_identifier: str = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        max_records: int = autoboto.ShapeBase._NOT_SET,
        marker: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if certificate_identifier is not autoboto.ShapeBase._NOT_SET:
                _params['certificate_identifier'] = certificate_identifier
            if filters is not autoboto.ShapeBase._NOT_SET:
                _params['filters'] = filters
            if max_records is not autoboto.ShapeBase._NOT_SET:
                _params['max_records'] = max_records
            if marker is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_db_cluster_backtracks(
        ...
        *,
        db_cluster_identifier: str,
        backtrack_identifier: str = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        max_records: int = autoboto.ShapeBase._NOT_SET,
        marker: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if db_cluster_identifier is not autoboto.ShapeBase._NOT_SET:
                _params['db_cluster_identifier'] = db_cluster_identifier
            if backtrack_identifier is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_db_cluster_parameters(
        ...
        *,
        db_cluster_parameter_group_name: str,
        source: str = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        max_records: int = autoboto.ShapeBase._NOT_SET,
        marker: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if source is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_db_cluster_snapshots(
        ...
        *,
        db_cluster_identifier: str = autoboto.ShapeBase._NOT_SET,
        db_cluster_snapshot_identifier: str = autoboto.ShapeBase._NOT_SET,
        snapshot_type: str = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        max_records: int = autoboto.ShapeBase._NOT_SET,
        marker: str = autoboto.ShapeBase._NOT_SET,
        include_shared: bool = autoboto.ShapeBase._NOT_SET,
        include_public: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if snapshot_type is not autoboto.ShapeBase._NOT_SET:
            ...
            if marker is not autoboto.ShapeBase._NOT_SET:
                _params['marker'] = marker
            if include_shared is not autoboto.ShapeBase._NOT_SET:
                _params['include_shared'] = include_shared
            if include_public is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_db_engine_versions(
        ...
        *,
        engine: str = autoboto.ShapeBase._NOT_SET,
        engine_version: str = autoboto.ShapeBase._NOT_SET,
        db_parameter_group_family: str = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        max_records: int = autoboto.ShapeBase._NOT_SET,
        marker: str = autoboto.ShapeBase._NOT_SET,
        default_only: bool = autoboto.ShapeBase._NOT_SET,
        list_supported_character_sets: bool = autoboto.ShapeBase._NOT_SET,
        list_supported_timezones: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if marker is not autoboto.ShapeBase._NOT_SET:
                _params['marker'] = marker
            if default_only is not autoboto.ShapeBase._NOT_SET:
                _params['default_only'] = default_only
            if list_supported_character_sets is not autoboto.ShapeBase._NOT_SET:
                _params['list_supported_character_sets'
                       ] = list_supported_character_sets
            if list_supported_timezones is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_db_instances(
        ...
        *,
        db_instance_identifier: str = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        max_records: int = autoboto.ShapeBase._NOT_SET,
        marker: str = autoboto.ShapeBase._NOT_SET,
    ...
    def describe_db_log_files(
        ...
        *,
        db_instance_identifier: str,
        filename_contains: str = autoboto.ShapeBase._NOT_SET,
        file_last_written: int = autoboto.ShapeBase._NOT_SET,
        file_size: int = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        max_records: int = autoboto.ShapeBase._NOT_SET,
        marker: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if db_instance_identifier is not autoboto.ShapeBase._NOT_SET:
                _params['db_instance_identifier'] = db_instance_identifier
            if filename_contains is not autoboto.ShapeBase._NOT_SET:
                _params['filename_contains'] = filename_contains
            if file_last_written is not autoboto.ShapeBase._NOT_SET:
                _params['file_last_written'] = file_last_written
            if file_size is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_db_security_groups(
        ...
        *,
        db_security_group_name: str = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        max_records: int = autoboto.ShapeBase._NOT_SET,
        marker: str = autoboto.ShapeBase._NOT_SET,
    ...
    def describe_db_snapshots(
        ...
        *,
        db_instance_identifier: str = autoboto.ShapeBase._NOT_SET,
        db_snapshot_identifier: str = autoboto.ShapeBase._NOT_SET,
        snapshot_type: str = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        max_records: int = autoboto.ShapeBase._NOT_SET,
        marker: str = autoboto.ShapeBase._NOT_SET,
    ...
    def describe_event_subscriptions(
        ...
        *,
        subscription_name: str = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        max_records: int = autoboto.ShapeBase._NOT_SET,
        marker: str = autoboto.ShapeBase._NOT_SET,
    ...
    def describe_events(
        ...
        *,
        source_identifier: str = autoboto.ShapeBase._NOT_SET,
        source_type: shapes.SourceType = autoboto.ShapeBase._NOT_SET,
        start_time: datetime.datetime = autoboto.ShapeBase._NOT_SET,
        end_time: datetime.datetime = autoboto.ShapeBase._NOT_SET,
        duration: int = autoboto.ShapeBase._NOT_SET,
        event_categories: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        max_records: int = autoboto.ShapeBase._NOT_SET,
        marker: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if duration is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_option_group_options(
        ...
        *,
        engine_name: str,
        major_engine_version: str = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        max_records: int = autoboto.ShapeBase._NOT_SET,
        marker: str = autoboto.ShapeBase._NOT_SET,
    ...
    def describe_option_groups(
        ...
        *,
        ...
        marker: str = autoboto.ShapeBase._NOT_SET,
        max_records: int = autoboto.ShapeBase._NOT_SET,
        engine_name: str = autoboto.ShapeBase._NOT_SET,
        major_engine_version: str = autoboto.ShapeBase._NOT_SET,
    ) -> shapes.OptionGroups:
        """
    ...
    def describe_orderable_db_instance_options(
        ...
        *,
        ...
        db_instance_class: str = autoboto.ShapeBase._NOT_SET,
        license_model: str = autoboto.ShapeBase._NOT_SET,
        vpc: bool = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        max_records: int = autoboto.ShapeBase._NOT_SET,
        marker: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if license_model is not autoboto.ShapeBase._NOT_SET:
                _params['license_model'] = license_model
            if vpc is not autoboto.ShapeBase._NOT_SET:
                _params['vpc'] = vpc
            if filters is not autoboto.ShapeBase._NOT_SET:
                _params['filters'] = filters
            if max_records is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_pending_maintenance_actions(
        ...
        *,
        resource_identifier: str = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        marker: str = autoboto.ShapeBase._NOT_SET,
        max_records: int = autoboto.ShapeBase._NOT_SET,
    ...
    def describe_reserved_db_instances(
        ...
        *,
        reserved_db_instance_id: str = autoboto.ShapeBase._NOT_SET,
        reserved_db_instances_offering_id: str = autoboto.ShapeBase._NOT_SET,
        db_instance_class: str = autoboto.ShapeBase._NOT_SET,
        duration: str = autoboto.ShapeBase._NOT_SET,
        product_description: str = autoboto.ShapeBase._NOT_SET,
        offering_type: str = autoboto.ShapeBase._NOT_SET,
        multi_az: bool = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        max_records: int = autoboto.ShapeBase._NOT_SET,
        marker: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if reserved_db_instance_id is not autoboto.ShapeBase._NOT_SET:
                _params['reserved_db_instance_id'] = reserved_db_instance_id
            if reserved_db_instances_offering_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_source_regions(
        ...
        *,
        region_name: str = autoboto.ShapeBase._NOT_SET,
        max_records: int = autoboto.ShapeBase._NOT_SET,
        marker: str = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if region_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def download_db_log_file_portion(
        ...
        *,
        ...
        log_file_name: str,
        marker: str = autoboto.ShapeBase._NOT_SET,
        number_of_lines: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if db_instance_identifier is not autoboto.ShapeBase._NOT_SET:
                _params['db_instance_identifier'] = db_instance_identifier
            if log_file_name is not autoboto.ShapeBase._NOT_SET:
                _params['log_file_name'] = log_file_name
            if marker is not autoboto.ShapeBase._NOT_SET:
                _params['marker'] = marker
            if number_of_lines is not autoboto.ShapeBase._NOT_SET:
    ...
    def failover_db_cluster(
        ...
        *,
        db_cluster_identifier: str = autoboto.ShapeBase._NOT_SET,
        target_db_instance_identifier: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if db_cluster_identifier is not autoboto.ShapeBase._NOT_SET:
                _params['db_cluster_identifier'] = db_cluster_identifier
            if target_db_instance_identifier is not autoboto.ShapeBase._NOT_SET:
    ...
    def modify_current_db_cluster_capacity(
        ...
        *,
        db_cluster_identifier: str,
        capacity: int = autoboto.ShapeBase._NOT_SET,
        seconds_before_timeout: int = autoboto.ShapeBase._NOT_SET,
        timeout_action: str = autoboto.ShapeBase._NOT_SET,
        ...
        serverless.html) in the _Amazon RDS User Guide_.
        ...
        if _request is None:
            ...
            if db_cluster_identifier is not autoboto.ShapeBase._NOT_SET:
                _params['db_cluster_identifier'] = db_cluster_identifier
            if capacity is not autoboto.ShapeBase._NOT_SET:
                _params['capacity'] = capacity
            if seconds_before_timeout is not autoboto.ShapeBase._NOT_SET:
                _params['seconds_before_timeout'] = seconds_before_timeout
            if timeout_action is not autoboto.ShapeBase._NOT_SET:
    ...
    def modify_db_cluster(
        ...
        *,
        db_cluster_identifier: str,
        new_db_cluster_identifier: str = autoboto.ShapeBase._NOT_SET,
        apply_immediately: bool = autoboto.ShapeBase._NOT_SET,
        backup_retention_period: int = autoboto.ShapeBase._NOT_SET,
        db_cluster_parameter_group_name: str = autoboto.ShapeBase._NOT_SET,
        vpc_security_group_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        port: int = autoboto.ShapeBase._NOT_SET,
        ...
        CloudwatchLogsExportConfiguration = autoboto.ShapeBase._NOT_SET,
        engine_version: str = autoboto.ShapeBase._NOT_SET,
        scaling_configuration: shapes.ScalingConfiguration = autoboto.ShapeBase.
        _NOT_SET,
        ...
        if _request is None:
            ...
            if db_cluster_identifier is not autoboto.ShapeBase._NOT_SET:
                _params['db_cluster_identifier'] = db_cluster_identifier
            if new_db_cluster_identifier is not autoboto.ShapeBase._NOT_SET:
                _params['new_db_cluster_identifier'] = new_db_cluster_identifier
            if apply_immediately is not autoboto.ShapeBase._NOT_SET:
            ...
            if backtrack_window is not autoboto.ShapeBase._NOT_SET:
                _params['backtrack_window'] = backtrack_window
            if cloudwatch_logs_export_configuration is not autoboto.ShapeBase._NOT_SET:
    ...
    def modify_db_cluster_parameter_group(
        ...
        *,
        ...
        if _request is None:
            ...
            if parameters is not autoboto.ShapeBase._NOT_SET:
    ...
    def modify_db_cluster_snapshot_attribute(
        ...
        *,
        db_cluster_snapshot_identifier: str,
        attribute_name: str,
        values_to_add: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        values_to_remove: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if attribute_name is not autoboto.ShapeBase._NOT_SET:
                _params['attribute_name'] = attribute_name
            if values_to_add is not autoboto.ShapeBase._NOT_SET:
                _params['values_to_add'] = values_to_add
            if values_to_remove is not autoboto.ShapeBase._NOT_SET:
    ...
    def modify_db_instance(
        ...
        *,
        ...
        multi_az: bool = autoboto.ShapeBase._NOT_SET,
        engine_version: str = autoboto.ShapeBase._NOT_SET,
        allow_major_version_upgrade: bool = autoboto.ShapeBase._NOT_SET,
        auto_minor_version_upgrade: bool = autoboto.ShapeBase._NOT_SET,
        license_model: str = autoboto.ShapeBase._NOT_SET,
        iops: int = autoboto.ShapeBase._NOT_SET,
        option_group_name: str = autoboto.ShapeBase._NOT_SET,
        new_db_instance_identifier: str = autoboto.ShapeBase._NOT_SET,
        storage_type: str = autoboto.ShapeBase._NOT_SET,
        tde_credential_arn: str = autoboto.ShapeBase._NOT_SET,
        tde_credential_password: str = autoboto.ShapeBase._NOT_SET,
        ca_certificate_identifier: str = autoboto.ShapeBase._NOT_SET,
        domain: str = autoboto.ShapeBase._NOT_SET,
        copy_tags_to_snapshot: bool = autoboto.ShapeBase._NOT_SET,
        monitoring_interval: int = autoboto.ShapeBase._NOT_SET,
        db_port_number: int = autoboto.ShapeBase._NOT_SET,
        publicly_accessible: bool = autoboto.ShapeBase._NOT_SET,
        monitoring_role_arn: str = autoboto.ShapeBase._NOT_SET,
        domain_iam_role_name: str = autoboto.ShapeBase._NOT_SET,
        promotion_tier: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if engine_version is not autoboto.ShapeBase._NOT_SET:
                _params['engine_version'] = engine_version
            if allow_major_version_upgrade is not autoboto.ShapeBase._NOT_SET:
            ...
            if option_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['option_group_name'] = option_group_name
            if new_db_instance_identifier is not autoboto.ShapeBase._NOT_SET:
            ...
            if tde_credential_password is not autoboto.ShapeBase._NOT_SET:
                _params['tde_credential_password'] = tde_credential_password
            if ca_certificate_identifier is not autoboto.ShapeBase._NOT_SET:
            ...
            if monitoring_interval is not autoboto.ShapeBase._NOT_SET:
                _params['monitoring_interval'] = monitoring_interval
            if db_port_number is not autoboto.ShapeBase._NOT_SET:
    ...
    def modify_db_subnet_group(
        ...
        *,
        db_subnet_group_name: str,
        subnet_ids: typing.List[str],
        db_subnet_group_description: str = autoboto.ShapeBase._NOT_SET,
    ...
    def modify_event_subscription(
        ...
        *,
        subscription_name: str,
        sns_topic_arn: str = autoboto.ShapeBase._NOT_SET,
        source_type: str = autoboto.ShapeBase._NOT_SET,
        event_categories: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        enabled: bool = autoboto.ShapeBase._NOT_SET,
    ...
    def modify_option_group(
        ...
        *,
        ...
        options_to_remove: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        apply_immediately: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if option_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['option_group_name'] = option_group_name
            if options_to_include is not autoboto.ShapeBase._NOT_SET:
                _params['options_to_include'] = options_to_include
            if options_to_remove is not autoboto.ShapeBase._NOT_SET:
    ...
    def purchase_reserved_db_instances_offering(
        ...
        *,
        ...
        reserved_db_instance_id: str = autoboto.ShapeBase._NOT_SET,
        db_instance_count: int = autoboto.ShapeBase._NOT_SET,
        tags: typing.List[shapes.Tag] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if reserved_db_instance_id is not autoboto.ShapeBase._NOT_SET:
                _params['reserved_db_instance_id'] = reserved_db_instance_id
            if db_instance_count is not autoboto.ShapeBase._NOT_SET:
    ...
    def reboot_db_instance(
        ...
        *,
        db_instance_identifier: str,
        force_failover: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if db_instance_identifier is not autoboto.ShapeBase._NOT_SET:
                _params['db_instance_identifier'] = db_instance_identifier
            if force_failover is not autoboto.ShapeBase._NOT_SET:
    ...
    def remove_tags_from_resource(
        ...
        *,
        ...
        if _request is None:
            ...
            if resource_name is not autoboto.ShapeBase._NOT_SET:
                _params['resource_name'] = resource_name
            if tag_keys is not autoboto.ShapeBase._NOT_SET:
    ...
    def reset_db_cluster_parameter_group(
        ...
        *,
        db_cluster_parameter_group_name: str,
        reset_all_parameters: bool = autoboto.ShapeBase._NOT_SET,
        parameters: typing.List[shapes.Parameter] = autoboto.ShapeBase._NOT_SET,
    ) -> shapes.DBClusterParameterGroupNameMessage:
        """
        ...
        if _request is None:
            ...
            if reset_all_parameters is not autoboto.ShapeBase._NOT_SET:
    ...
    def restore_db_cluster_from_s3(
        ...
        *,
        ...
        kms_key_id: str = autoboto.ShapeBase._NOT_SET,
        enable_iam_database_authentication: bool = autoboto.ShapeBase._NOT_SET,
        s3_prefix: str = autoboto.ShapeBase._NOT_SET,
        backtrack_window: int = autoboto.ShapeBase._NOT_SET,
        enable_cloudwatch_logs_exports: typing.List[str] = autoboto.ShapeBase.
        _NOT_SET,
        ...
        from MySQL by Using an Amazon S3
        ...
        if _request is None:
            ...
            if master_user_password is not autoboto.ShapeBase._NOT_SET:
                _params['master_user_password'] = master_user_password
            if source_engine is not autoboto.ShapeBase._NOT_SET:
                _params['source_engine'] = source_engine
            if source_engine_version is not autoboto.ShapeBase._NOT_SET:
                _params['source_engine_version'] = source_engine_version
            if s3_bucket_name is not autoboto.ShapeBase._NOT_SET:
                _params['s3_bucket_name'] = s3_bucket_name
            if s3_ingestion_role_arn is not autoboto.ShapeBase._NOT_SET:
            ...
            if s3_prefix is not autoboto.ShapeBase._NOT_SET:
    ...
    def restore_db_cluster_from_snapshot(
        ...
        *,
        ...
        if _request is None:
            ...
            if db_cluster_identifier is not autoboto.ShapeBase._NOT_SET:
                _params['db_cluster_identifier'] = db_cluster_identifier
            if snapshot_identifier is not autoboto.ShapeBase._NOT_SET:
    ...
    def restore_db_cluster_to_point_in_time(
        ...
        *,
        ...
        restore_type: str = autoboto.ShapeBase._NOT_SET,
        restore_to_time: datetime.datetime = autoboto.ShapeBase._NOT_SET,
        use_latest_restorable_time: bool = autoboto.ShapeBase._NOT_SET,
        port: int = autoboto.ShapeBase._NOT_SET,
        db_subnet_group_name: str = autoboto.ShapeBase._NOT_SET,
        option_group_name: str = autoboto.ShapeBase._NOT_SET,
        vpc_security_group_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if db_cluster_identifier is not autoboto.ShapeBase._NOT_SET:
                _params['db_cluster_identifier'] = db_cluster_identifier
            if source_db_cluster_identifier is not autoboto.ShapeBase._NOT_SET:
                _params['source_db_cluster_identifier'
                       ] = source_db_cluster_identifier
            if restore_type is not autoboto.ShapeBase._NOT_SET:
                _params['restore_type'] = restore_type
            if restore_to_time is not autoboto.ShapeBase._NOT_SET:
                _params['restore_to_time'] = restore_to_time
            if use_latest_restorable_time is not autoboto.ShapeBase._NOT_SET:
    ...
    def restore_db_instance_to_point_in_time(
        ...
        *,
        ...
        restore_time: datetime.datetime = autoboto.ShapeBase._NOT_SET,
        use_latest_restorable_time: bool = autoboto.ShapeBase._NOT_SET,
        db_instance_class: str = autoboto.ShapeBase._NOT_SET,
        port: int = autoboto.ShapeBase._NOT_SET,
        availability_zone: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if restore_time is not autoboto.ShapeBase._NOT_SET:
