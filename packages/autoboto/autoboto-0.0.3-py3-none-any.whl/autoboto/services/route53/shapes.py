...
class CreateTrafficPolicyInstanceRequest(autoboto.ShapeBase):
    ...
    ttl: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class HealthCheckConfig(autoboto.ShapeBase):
    ...
    resource_path: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
    ...
    # response body.
    search_string: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
    ...
    inverted: bool = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    # message.
    enable_sni: bool = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class HostedZoneConfig(autoboto.ShapeBase):
    ...
    private_zone: bool = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
class ListHostedZonesByNameResponse(autoboto.ShapeBase):
    ...
    next_dns_name: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
class ResourceRecordSet(autoboto.ShapeBase):
    ...
    type: "RRType" = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class TestDNSAnswerRequest(autoboto.ShapeBase):
    ...
    record_name: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    # (`us-east-1`).
    resolver_ip: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class TestDNSAnswerResponse(autoboto.ShapeBase):
    ...
    nameserver: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
