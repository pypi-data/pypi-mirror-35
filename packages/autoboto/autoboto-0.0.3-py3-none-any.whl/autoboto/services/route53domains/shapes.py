...
class BillingRecord(autoboto.ShapeBase):
    ...
    invoice_id: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    # Example value: 12.0
    price: float = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class CheckDomainAvailabilityRequest(autoboto.ShapeBase):
    ...
    idn_lang_code: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
class CheckDomainTransferabilityRequest(autoboto.ShapeBase):
    ...
    auth_code: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class ContactDetail(autoboto.ShapeBase):
    ...
    first_name: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # Last name of contact.
    last_name: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    # dialing code].[number including any area code]". For example, a US phone
    # number might appear as `"+1.1234567890"`.
    fax: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class DomainSuggestion(autoboto.ShapeBase):
    ...
    # The domain name is forbidden.
    availability: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class DomainSummary(autoboto.ShapeBase):
    ...
    auto_renew: bool = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class GetDomainDetailResponse(autoboto.ShapeBase):
    ...
    # contact.
    tech_privacy: bool = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
    ...
    who_is_server: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )

    # Web address of the registrar.
    registrar_url: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
    ...
    reseller: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # Reserved for future use.
    dns_sec: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class UpdateDomainNameserversRequest(autoboto.ShapeBase):
    ...
    fi_auth_key: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
