...
class Client:
        ...
        *,
        ...
        if _request is None:
            ...
            if tags is not autoboto.ShapeBase._NOT_SET:
                _params['tags'] = tags
            if instance_names is not autoboto.ShapeBase._NOT_SET:
    ...
    def batch_get_application_revisions(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if application_name is not autoboto.ShapeBase._NOT_SET:
                _params['application_name'] = application_name
            if revisions is not autoboto.ShapeBase._NOT_SET:
    ...
    def batch_get_applications(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if application_names is not autoboto.ShapeBase._NOT_SET:
    ...
    def batch_get_deployment_groups(
        ...
        *,
        ...
        if _request is None:
            ...
            if application_name is not autoboto.ShapeBase._NOT_SET:
                _params['application_name'] = application_name
            if deployment_group_names is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_application(
        ...
        *,
        application_name: str,
        compute_platform: shapes.ComputePlatform = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if application_name is not autoboto.ShapeBase._NOT_SET:
                _params['application_name'] = application_name
            if compute_platform is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_deployment(
        ...
        *,
        application_name: str,
        deployment_group_name: str = autoboto.ShapeBase._NOT_SET,
        revision: shapes.RevisionLocation = autoboto.ShapeBase._NOT_SET,
        deployment_config_name: str = autoboto.ShapeBase._NOT_SET,
        description: str = autoboto.ShapeBase._NOT_SET,
        ignore_application_stop_failures: bool = autoboto.ShapeBase._NOT_SET,
        target_instances: shapes.TargetInstances = autoboto.ShapeBase._NOT_SET,
        auto_rollback_configuration: shapes.
        AutoRollbackConfiguration = autoboto.ShapeBase._NOT_SET,
        update_outdated_instances_only: bool = autoboto.ShapeBase._NOT_SET,
        file_exists_behavior: shapes.FileExistsBehavior = autoboto.ShapeBase.
        _NOT_SET,
        ...
        if _request is None:
            ...
            if application_name is not autoboto.ShapeBase._NOT_SET:
                _params['application_name'] = application_name
            if deployment_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['deployment_group_name'] = deployment_group_name
            if revision is not autoboto.ShapeBase._NOT_SET:
                _params['revision'] = revision
            if deployment_config_name is not autoboto.ShapeBase._NOT_SET:
                _params['deployment_config_name'] = deployment_config_name
            if description is not autoboto.ShapeBase._NOT_SET:
                _params['description'] = description
            if ignore_application_stop_failures is not autoboto.ShapeBase._NOT_SET:
                _params['ignore_application_stop_failures'
                       ] = ignore_application_stop_failures
            if target_instances is not autoboto.ShapeBase._NOT_SET:
                _params['target_instances'] = target_instances
            if auto_rollback_configuration is not autoboto.ShapeBase._NOT_SET:
                _params['auto_rollback_configuration'
                       ] = auto_rollback_configuration
            if update_outdated_instances_only is not autoboto.ShapeBase._NOT_SET:
                _params['update_outdated_instances_only'
                       ] = update_outdated_instances_only
            if file_exists_behavior is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_deployment_config(
        ...
        *,
        ...
        minimum_healthy_hosts: shapes.MinimumHealthyHosts = autoboto.ShapeBase.
        _NOT_SET,
        traffic_routing_config: shapes.TrafficRoutingConfig = autoboto.
        ShapeBase._NOT_SET,
        compute_platform: shapes.ComputePlatform = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if deployment_config_name is not autoboto.ShapeBase._NOT_SET:
                _params['deployment_config_name'] = deployment_config_name
            if minimum_healthy_hosts is not autoboto.ShapeBase._NOT_SET:
                _params['minimum_healthy_hosts'] = minimum_healthy_hosts
            if traffic_routing_config is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_deployment_group(
        ...
        *,
        ...
        deployment_config_name: str = autoboto.ShapeBase._NOT_SET,
        ec2_tag_filters: typing.List[shapes.EC2TagFilter
                                    ] = autoboto.ShapeBase._NOT_SET,
        on_premises_instance_tag_filters: typing.List[
            shapes.TagFilter
        ] = autoboto.ShapeBase._NOT_SET,
        auto_scaling_groups: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        trigger_configurations: typing.List[shapes.TriggerConfig
                                           ] = autoboto.ShapeBase._NOT_SET,
        alarm_configuration: shapes.AlarmConfiguration = autoboto.ShapeBase.
        _NOT_SET,
        auto_rollback_configuration: shapes.
        AutoRollbackConfiguration = autoboto.ShapeBase._NOT_SET,
        deployment_style: shapes.DeploymentStyle = autoboto.ShapeBase._NOT_SET,
        blue_green_deployment_configuration: shapes.
        BlueGreenDeploymentConfiguration = autoboto.ShapeBase._NOT_SET,
        load_balancer_info: shapes.LoadBalancerInfo = autoboto.ShapeBase.
        _NOT_SET,
        ec2_tag_set: shapes.EC2TagSet = autoboto.ShapeBase._NOT_SET,
        on_premises_tag_set: shapes.OnPremisesTagSet = autoboto.ShapeBase.
        _NOT_SET,
        ...
        if _request is None:
            ...
            if deployment_config_name is not autoboto.ShapeBase._NOT_SET:
                _params['deployment_config_name'] = deployment_config_name
            if ec2_tag_filters is not autoboto.ShapeBase._NOT_SET:
                _params['ec2_tag_filters'] = ec2_tag_filters
            if on_premises_instance_tag_filters is not autoboto.ShapeBase._NOT_SET:
                _params['on_premises_instance_tag_filters'
                       ] = on_premises_instance_tag_filters
            if auto_scaling_groups is not autoboto.ShapeBase._NOT_SET:
                _params['auto_scaling_groups'] = auto_scaling_groups
            if trigger_configurations is not autoboto.ShapeBase._NOT_SET:
                _params['trigger_configurations'] = trigger_configurations
            if alarm_configuration is not autoboto.ShapeBase._NOT_SET:
                _params['alarm_configuration'] = alarm_configuration
            if auto_rollback_configuration is not autoboto.ShapeBase._NOT_SET:
                _params['auto_rollback_configuration'
                       ] = auto_rollback_configuration
            if deployment_style is not autoboto.ShapeBase._NOT_SET:
                _params['deployment_style'] = deployment_style
            if blue_green_deployment_configuration is not autoboto.ShapeBase._NOT_SET:
                _params['blue_green_deployment_configuration'
                       ] = blue_green_deployment_configuration
            if load_balancer_info is not autoboto.ShapeBase._NOT_SET:
                _params['load_balancer_info'] = load_balancer_info
            if ec2_tag_set is not autoboto.ShapeBase._NOT_SET:
                _params['ec2_tag_set'] = ec2_tag_set
            if on_premises_tag_set is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_git_hub_account_token(
        ...
        *,
        token_name: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if token_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def deregister_on_premises_instance(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if instance_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_application_revisions(
        ...
        *,
        application_name: str,
        sort_by: shapes.ApplicationRevisionSortBy = autoboto.ShapeBase._NOT_SET,
        sort_order: shapes.SortOrder = autoboto.ShapeBase._NOT_SET,
        s3_bucket: str = autoboto.ShapeBase._NOT_SET,
        s3_key_prefix: str = autoboto.ShapeBase._NOT_SET,
        deployed: shapes.ListStateFilterAction = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if application_name is not autoboto.ShapeBase._NOT_SET:
                _params['application_name'] = application_name
            if sort_by is not autoboto.ShapeBase._NOT_SET:
                _params['sort_by'] = sort_by
            if sort_order is not autoboto.ShapeBase._NOT_SET:
                _params['sort_order'] = sort_order
            if s3_bucket is not autoboto.ShapeBase._NOT_SET:
                _params['s3_bucket'] = s3_bucket
            if s3_key_prefix is not autoboto.ShapeBase._NOT_SET:
                _params['s3_key_prefix'] = s3_key_prefix
            if deployed is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_deployment_instances(
        ...
        *,
        ...
        if _request is None:
            ...
            if next_token is not autoboto.ShapeBase._NOT_SET:
                _params['next_token'] = next_token
            if instance_status_filter is not autoboto.ShapeBase._NOT_SET:
                _params['instance_status_filter'] = instance_status_filter
            if instance_type_filter is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_deployments(
        ...
        *,
        application_name: str = autoboto.ShapeBase._NOT_SET,
        deployment_group_name: str = autoboto.ShapeBase._NOT_SET,
        include_only_statuses: typing.List[shapes.DeploymentStatus
                                          ] = autoboto.ShapeBase._NOT_SET,
        create_time_range: shapes.TimeRange = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if deployment_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['deployment_group_name'] = deployment_group_name
            if include_only_statuses is not autoboto.ShapeBase._NOT_SET:
                _params['include_only_statuses'] = include_only_statuses
            if create_time_range is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_on_premises_instances(
        ...
        *,
        registration_status: shapes.RegistrationStatus = autoboto.ShapeBase.
        _NOT_SET,
        tag_filters: typing.List[shapes.TagFilter
                                ] = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if registration_status is not autoboto.ShapeBase._NOT_SET:
                _params['registration_status'] = registration_status
            if tag_filters is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_lifecycle_event_hook_execution_status(
        ...
        *,
        deployment_id: str = autoboto.ShapeBase._NOT_SET,
        lifecycle_event_hook_execution_id: str = autoboto.ShapeBase._NOT_SET,
        status: shapes.LifecycleEventStatus = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if deployment_id is not autoboto.ShapeBase._NOT_SET:
                _params['deployment_id'] = deployment_id
            if lifecycle_event_hook_execution_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def register_on_premises_instance(
        ...
        *,
        instance_name: str,
        iam_session_arn: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if instance_name is not autoboto.ShapeBase._NOT_SET:
                _params['instance_name'] = instance_name
            if iam_session_arn is not autoboto.ShapeBase._NOT_SET:
    ...
    def stop_deployment(
        ...
        *,
        deployment_id: str,
        auto_rollback_enabled: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if deployment_id is not autoboto.ShapeBase._NOT_SET:
                _params['deployment_id'] = deployment_id
            if auto_rollback_enabled is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_application(
        ...
        *,
        application_name: str = autoboto.ShapeBase._NOT_SET,
        new_application_name: str = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            ...
            if application_name is not autoboto.ShapeBase._NOT_SET:
                _params['application_name'] = application_name
            if new_application_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_deployment_group(
        ...
        *,
        ...
        new_deployment_group_name: str = autoboto.ShapeBase._NOT_SET,
        deployment_config_name: str = autoboto.ShapeBase._NOT_SET,
        ec2_tag_filters: typing.List[shapes.EC2TagFilter
                                    ] = autoboto.ShapeBase._NOT_SET,
        on_premises_instance_tag_filters: typing.List[
        ...
        if _request is None:
            ...
            if application_name is not autoboto.ShapeBase._NOT_SET:
                _params['application_name'] = application_name
            if current_deployment_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['current_deployment_group_name'
                       ] = current_deployment_group_name
            if new_deployment_group_name is not autoboto.ShapeBase._NOT_SET:
