...
class Client:
    ...
    def attach_instances(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if auto_scaling_group_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def attach_load_balancer_target_groups(
        ...
        *,
        ...
        if _request is None:
            ...
            if auto_scaling_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['auto_scaling_group_name'] = auto_scaling_group_name
            if target_group_arns is not autoboto.ShapeBase._NOT_SET:
    ...
    def attach_load_balancers(
        ...
        *,
        ...
        if _request is None:
            ...
            if auto_scaling_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['auto_scaling_group_name'] = auto_scaling_group_name
            if load_balancer_names is not autoboto.ShapeBase._NOT_SET:
    ...
    def batch_delete_scheduled_action(
        ...
        *,
        ...
        if _request is None:
            ...
            if auto_scaling_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['auto_scaling_group_name'] = auto_scaling_group_name
            if scheduled_action_names is not autoboto.ShapeBase._NOT_SET:
    ...
    def batch_put_scheduled_update_group_action(
        ...
        *,
        ...
        if _request is None:
            ...
            if auto_scaling_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['auto_scaling_group_name'] = auto_scaling_group_name
            if scheduled_update_group_actions is not autoboto.ShapeBase._NOT_SET:
    ...
    def complete_lifecycle_action(
        ...
        *,
        ...
        lifecycle_action_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if lifecycle_hook_name is not autoboto.ShapeBase._NOT_SET:
                _params['lifecycle_hook_name'] = lifecycle_hook_name
            if auto_scaling_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['auto_scaling_group_name'] = auto_scaling_group_name
            if lifecycle_action_result is not autoboto.ShapeBase._NOT_SET:
                _params['lifecycle_action_result'] = lifecycle_action_result
            if lifecycle_action_token is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_auto_scaling_group(
        ...
        *,
        ...
        min_size: int,
        max_size: int,
        launch_configuration_name: str = autoboto.ShapeBase._NOT_SET,
        launch_template: shapes.LaunchTemplateSpecification = autoboto.
        ShapeBase._NOT_SET,
        instance_id: str = autoboto.ShapeBase._NOT_SET,
        desired_capacity: int = autoboto.ShapeBase._NOT_SET,
        default_cooldown: int = autoboto.ShapeBase._NOT_SET,
        availability_zones: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        load_balancer_names: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        target_group_arns: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        health_check_type: str = autoboto.ShapeBase._NOT_SET,
        health_check_grace_period: int = autoboto.ShapeBase._NOT_SET,
        placement_group: str = autoboto.ShapeBase._NOT_SET,
        vpc_zone_identifier: str = autoboto.ShapeBase._NOT_SET,
        termination_policies: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        new_instances_protected_from_scale_in: bool = autoboto.ShapeBase.
        _NOT_SET,
        ...
        service_linked_role_arn: str = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            ...
            if auto_scaling_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['auto_scaling_group_name'] = auto_scaling_group_name
            if min_size is not autoboto.ShapeBase._NOT_SET:
                _params['min_size'] = min_size
            if max_size is not autoboto.ShapeBase._NOT_SET:
                _params['max_size'] = max_size
            if launch_configuration_name is not autoboto.ShapeBase._NOT_SET:
            ...
            if instance_id is not autoboto.ShapeBase._NOT_SET:
                _params['instance_id'] = instance_id
            if desired_capacity is not autoboto.ShapeBase._NOT_SET:
                _params['desired_capacity'] = desired_capacity
            if default_cooldown is not autoboto.ShapeBase._NOT_SET:
            ...
            if target_group_arns is not autoboto.ShapeBase._NOT_SET:
                _params['target_group_arns'] = target_group_arns
            if health_check_type is not autoboto.ShapeBase._NOT_SET:
                _params['health_check_type'] = health_check_type
            if health_check_grace_period is not autoboto.ShapeBase._NOT_SET:
                _params['health_check_grace_period'] = health_check_grace_period
            if placement_group is not autoboto.ShapeBase._NOT_SET:
                _params['placement_group'] = placement_group
            if vpc_zone_identifier is not autoboto.ShapeBase._NOT_SET:
                _params['vpc_zone_identifier'] = vpc_zone_identifier
            if termination_policies is not autoboto.ShapeBase._NOT_SET:
                _params['termination_policies'] = termination_policies
            if new_instances_protected_from_scale_in is not autoboto.ShapeBase._NOT_SET:
                _params['new_instances_protected_from_scale_in'
                       ] = new_instances_protected_from_scale_in
            if lifecycle_hook_specification_list is not autoboto.ShapeBase._NOT_SET:
                _params['lifecycle_hook_specification_list'
                       ] = lifecycle_hook_specification_list
            if tags is not autoboto.ShapeBase._NOT_SET:
                _params['tags'] = tags
            if service_linked_role_arn is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_launch_configuration(
        ...
        *,
        ...
        classic_link_vpc_id: str = autoboto.ShapeBase._NOT_SET,
        classic_link_vpc_security_groups: typing.List[str] = autoboto.ShapeBase.
        _NOT_SET,
        ...
        instance_monitoring: shapes.InstanceMonitoring = autoboto.ShapeBase.
        _NOT_SET,
        spot_price: str = autoboto.ShapeBase._NOT_SET,
        iam_instance_profile: str = autoboto.ShapeBase._NOT_SET,
        ebs_optimized: bool = autoboto.ShapeBase._NOT_SET,
        associate_public_ip_address: bool = autoboto.ShapeBase._NOT_SET,
        placement_tenancy: str = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            ...
            if classic_link_vpc_id is not autoboto.ShapeBase._NOT_SET:
                _params['classic_link_vpc_id'] = classic_link_vpc_id
            if classic_link_vpc_security_groups is not autoboto.ShapeBase._NOT_SET:
            ...
            if instance_monitoring is not autoboto.ShapeBase._NOT_SET:
            ...
            if associate_public_ip_address is not autoboto.ShapeBase._NOT_SET:
                _params['associate_public_ip_address'
                       ] = associate_public_ip_address
            if placement_tenancy is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_notification_configuration(
        ...
        *,
        ...
        if _request is None:
            ...
            if auto_scaling_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['auto_scaling_group_name'] = auto_scaling_group_name
            if topic_arn is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_policy(
        ...
        *,
        policy_name: str,
        auto_scaling_group_name: str = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
    ...
    def delete_scheduled_action(
        ...
        *,
        ...
        if _request is None:
            ...
            if auto_scaling_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['auto_scaling_group_name'] = auto_scaling_group_name
            if scheduled_action_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_auto_scaling_groups(
        ...
        *,
        auto_scaling_group_names: typing.List[str
                                             ] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if auto_scaling_group_names is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_launch_configurations(
        ...
        *,
        launch_configuration_names: typing.List[str
                                               ] = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_records: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if launch_configuration_names is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_lifecycle_hooks(
        ...
        *,
        auto_scaling_group_name: str,
        lifecycle_hook_names: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if auto_scaling_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['auto_scaling_group_name'] = auto_scaling_group_name
            if lifecycle_hook_names is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_policies(
        ...
        *,
        auto_scaling_group_name: str = autoboto.ShapeBase._NOT_SET,
        policy_names: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        policy_types: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_records: int = autoboto.ShapeBase._NOT_SET,
    ) -> shapes.PoliciesType:
        """
        ...
        if _request is None:
            ...
            if auto_scaling_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['auto_scaling_group_name'] = auto_scaling_group_name
            if policy_names is not autoboto.ShapeBase._NOT_SET:
                _params['policy_names'] = policy_names
            if policy_types is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_scaling_activities(
        ...
        *,
        activity_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        auto_scaling_group_name: str = autoboto.ShapeBase._NOT_SET,
        max_records: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if activity_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_scheduled_actions(
        ...
        *,
        auto_scaling_group_name: str = autoboto.ShapeBase._NOT_SET,
        scheduled_action_names: typing.List[str] = autoboto.ShapeBase._NOT_SET,
    ...
    def detach_instances(
        ...
        *,
        ...
        if _request is None:
            ...
            if auto_scaling_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['auto_scaling_group_name'] = auto_scaling_group_name
            if should_decrement_desired_capacity is not autoboto.ShapeBase._NOT_SET:
    ...
    def disable_metrics_collection(
        ...
        *,
        auto_scaling_group_name: str,
        metrics: typing.List[str] = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            ...
            if auto_scaling_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['auto_scaling_group_name'] = auto_scaling_group_name
            if metrics is not autoboto.ShapeBase._NOT_SET:
    ...
    def enable_metrics_collection(
        ...
        *,
        ...
        if _request is None:
            ...
            if auto_scaling_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['auto_scaling_group_name'] = auto_scaling_group_name
            if granularity is not autoboto.ShapeBase._NOT_SET:
    ...
    def execute_policy(
        ...
        *,
        policy_name: str,
        auto_scaling_group_name: str = autoboto.ShapeBase._NOT_SET,
        honor_cooldown: bool = autoboto.ShapeBase._NOT_SET,
        metric_value: float = autoboto.ShapeBase._NOT_SET,
        breach_threshold: float = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            ...
            if auto_scaling_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['auto_scaling_group_name'] = auto_scaling_group_name
            if honor_cooldown is not autoboto.ShapeBase._NOT_SET:
                _params['honor_cooldown'] = honor_cooldown
            if metric_value is not autoboto.ShapeBase._NOT_SET:
                _params['metric_value'] = metric_value
            if breach_threshold is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_lifecycle_hook(
        ...
        *,
        lifecycle_hook_name: str,
        auto_scaling_group_name: str,
        lifecycle_transition: str = autoboto.ShapeBase._NOT_SET,
        role_arn: str = autoboto.ShapeBase._NOT_SET,
        notification_target_arn: str = autoboto.ShapeBase._NOT_SET,
        notification_metadata: str = autoboto.ShapeBase._NOT_SET,
        heartbeat_timeout: int = autoboto.ShapeBase._NOT_SET,
        default_result: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if auto_scaling_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['auto_scaling_group_name'] = auto_scaling_group_name
            if lifecycle_transition is not autoboto.ShapeBase._NOT_SET:
                _params['lifecycle_transition'] = lifecycle_transition
            if role_arn is not autoboto.ShapeBase._NOT_SET:
                _params['role_arn'] = role_arn
            if notification_target_arn is not autoboto.ShapeBase._NOT_SET:
                _params['notification_target_arn'] = notification_target_arn
            if notification_metadata is not autoboto.ShapeBase._NOT_SET:
                _params['notification_metadata'] = notification_metadata
            if heartbeat_timeout is not autoboto.ShapeBase._NOT_SET:
                _params['heartbeat_timeout'] = heartbeat_timeout
            if default_result is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_notification_configuration(
        ...
        *,
        ...
        if _request is None:
            ...
            if topic_arn is not autoboto.ShapeBase._NOT_SET:
                _params['topic_arn'] = topic_arn
            if notification_types is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_scaling_policy(
        ...
        *,
        auto_scaling_group_name: str,
        policy_name: str,
        policy_type: str = autoboto.ShapeBase._NOT_SET,
        adjustment_type: str = autoboto.ShapeBase._NOT_SET,
        min_adjustment_step: int = autoboto.ShapeBase._NOT_SET,
        min_adjustment_magnitude: int = autoboto.ShapeBase._NOT_SET,
        scaling_adjustment: int = autoboto.ShapeBase._NOT_SET,
        cooldown: int = autoboto.ShapeBase._NOT_SET,
        metric_aggregation_type: str = autoboto.ShapeBase._NOT_SET,
        step_adjustments: typing.List[shapes.StepAdjustment
                                     ] = autoboto.ShapeBase._NOT_SET,
        estimated_instance_warmup: int = autoboto.ShapeBase._NOT_SET,
        target_tracking_configuration: shapes.
        TargetTrackingConfiguration = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if policy_name is not autoboto.ShapeBase._NOT_SET:
                _params['policy_name'] = policy_name
            if policy_type is not autoboto.ShapeBase._NOT_SET:
                _params['policy_type'] = policy_type
            if adjustment_type is not autoboto.ShapeBase._NOT_SET:
                _params['adjustment_type'] = adjustment_type
            if min_adjustment_step is not autoboto.ShapeBase._NOT_SET:
                _params['min_adjustment_step'] = min_adjustment_step
            if min_adjustment_magnitude is not autoboto.ShapeBase._NOT_SET:
                _params['min_adjustment_magnitude'] = min_adjustment_magnitude
            if scaling_adjustment is not autoboto.ShapeBase._NOT_SET:
                _params['scaling_adjustment'] = scaling_adjustment
            if cooldown is not autoboto.ShapeBase._NOT_SET:
                _params['cooldown'] = cooldown
            if metric_aggregation_type is not autoboto.ShapeBase._NOT_SET:
                _params['metric_aggregation_type'] = metric_aggregation_type
            if step_adjustments is not autoboto.ShapeBase._NOT_SET:
                _params['step_adjustments'] = step_adjustments
            if estimated_instance_warmup is not autoboto.ShapeBase._NOT_SET:
                _params['estimated_instance_warmup'] = estimated_instance_warmup
            if target_tracking_configuration is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_scheduled_update_group_action(
        ...
        *,
        auto_scaling_group_name: str,
        scheduled_action_name: str,
        time: datetime.datetime = autoboto.ShapeBase._NOT_SET,
        start_time: datetime.datetime = autoboto.ShapeBase._NOT_SET,
        end_time: datetime.datetime = autoboto.ShapeBase._NOT_SET,
        recurrence: str = autoboto.ShapeBase._NOT_SET,
        min_size: int = autoboto.ShapeBase._NOT_SET,
        max_size: int = autoboto.ShapeBase._NOT_SET,
        desired_capacity: int = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            ...
            if scheduled_action_name is not autoboto.ShapeBase._NOT_SET:
                _params['scheduled_action_name'] = scheduled_action_name
            if time is not autoboto.ShapeBase._NOT_SET:
                _params['time'] = time
            if start_time is not autoboto.ShapeBase._NOT_SET:
                _params['start_time'] = start_time
            if end_time is not autoboto.ShapeBase._NOT_SET:
    ...
    def resume_processes(
        ...
        *,
        auto_scaling_group_name: str,
        scaling_processes: typing.List[str] = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            ...
            if auto_scaling_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['auto_scaling_group_name'] = auto_scaling_group_name
            if scaling_processes is not autoboto.ShapeBase._NOT_SET:
    ...
    def set_instance_health(
        ...
        *,
        instance_id: str,
        health_status: str,
        should_respect_grace_period: bool = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            ...
            if instance_id is not autoboto.ShapeBase._NOT_SET:
                _params['instance_id'] = instance_id
            if health_status is not autoboto.ShapeBase._NOT_SET:
                _params['health_status'] = health_status
            if should_respect_grace_period is not autoboto.ShapeBase._NOT_SET:
    ...
    def set_instance_protection(
        ...
        *,
        ...
        if _request is None:
            ...
            if auto_scaling_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['auto_scaling_group_name'] = auto_scaling_group_name
            if protected_from_scale_in is not autoboto.ShapeBase._NOT_SET:
