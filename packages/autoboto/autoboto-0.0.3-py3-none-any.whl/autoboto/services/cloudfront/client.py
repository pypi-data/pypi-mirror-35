...
class Client:
    ...
    def create_cloud_front_origin_access_identity(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if cloud_front_origin_access_identity_config is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_distribution(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if distribution_config is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_distribution_with_tags(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if distribution_config_with_tags is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_field_level_encryption_config(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if field_level_encryption_config is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_field_level_encryption_profile(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if field_level_encryption_profile_config is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_invalidation(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if distribution_id is not autoboto.ShapeBase._NOT_SET:
                _params['distribution_id'] = distribution_id
            if invalidation_batch is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_public_key(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if public_key_config is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_streaming_distribution(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if streaming_distribution_config is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_streaming_distribution_with_tags(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if streaming_distribution_config_with_tags is not autoboto.ShapeBase._NOT_SET:
