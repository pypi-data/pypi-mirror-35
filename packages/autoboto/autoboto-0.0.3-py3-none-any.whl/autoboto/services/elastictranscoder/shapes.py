...
class Artwork(autoboto.ShapeBase):
    ...
    input_key: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    max_width: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    max_height: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    sizing_policy: str = dataclasses.field(
...
class AudioCodecOptions(autoboto.ShapeBase):
    ...
    profile: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    bit_depth: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    bit_order: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    signed: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class AudioParameters(autoboto.ShapeBase):
    ...
    # rate.
    sample_rate: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # The bit rate of the audio stream in the output file, in kilobits/second.
    # Enter an integer between 64 and 320, inclusive.
    bit_rate: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    channels: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class CaptionSource(autoboto.ShapeBase):
    ...
    time_offset: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class Captions(autoboto.ShapeBase):
    ...
    merge_policy: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class CreateJobOutput(autoboto.ShapeBase):
    ...
    rotate: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    # transcoding.
    preset_id: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class CreateJobRequest(autoboto.ShapeBase):
    ...
    pipeline_id: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class CreatePipelineRequest(autoboto.ShapeBase):
    ...
    # transcode.
    input_bucket: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    output_bucket: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
class CreatePresetRequest(autoboto.ShapeBase):
    ...
    container: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class DetectedProperties(autoboto.ShapeBase):
    ...
    frame_rate: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class Encryption(autoboto.ShapeBase):
    ...
    key_md5: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class JobInput(autoboto.ShapeBase):
    ...
    aspect_ratio: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    interlaced: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class ListJobsByPipelineRequest(autoboto.ShapeBase):
    ...
    # `false`.
    ascending: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # When Elastic Transcoder returns more than one page of results, use
    # `pageToken` in subsequent `GET` requests to get each successive page of
    # results.
    page_token: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class Notifications(autoboto.ShapeBase):
    ...
    progressing: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    error: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class Permission(autoboto.ShapeBase):
    ...
    grantee_type: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    grantee: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class PipelineOutputConfig(autoboto.ShapeBase):
    ...
    storage_class: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
class PresetWatermark(autoboto.ShapeBase):
    ...
    opacity: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class TestRoleResponse(autoboto.ShapeBase):
    ...
    # is `false`.
    success: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class Thumbnails(autoboto.ShapeBase):
    ...
    # value.
    interval: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class VideoParameters(autoboto.ShapeBase):
    ...
    fixed_gop: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
