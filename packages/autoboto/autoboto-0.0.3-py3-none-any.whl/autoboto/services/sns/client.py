...
class Client:
    ...
    def add_permission(
        ...
        *,
        ...
        if _request is None:
            ...
            if label is not autoboto.ShapeBase._NOT_SET:
                _params['label'] = label
    ...
    def confirm_subscription(
        ...
        *,
        topic_arn: str,
        token: str,
        authenticate_on_unsubscribe: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if token is not autoboto.ShapeBase._NOT_SET:
                _params['token'] = token
            if authenticate_on_unsubscribe is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_platform_endpoint(
        ...
        *,
        ...
        token: str,
        custom_user_data: str = autoboto.ShapeBase._NOT_SET,
        attributes: typing.Dict[str, str] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if platform_application_arn is not autoboto.ShapeBase._NOT_SET:
                _params['platform_application_arn'] = platform_application_arn
            if token is not autoboto.ShapeBase._NOT_SET:
                _params['token'] = token
            if custom_user_data is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_sms_attributes(
        ...
        *,
        attributes: typing.List[str] = autoboto.ShapeBase._NOT_SET,
    ...
    def get_subscription_attributes(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if subscription_arn is not autoboto.ShapeBase._NOT_SET:
    ...
    def publish(
        ...
        *,
        message: str,
        topic_arn: str = autoboto.ShapeBase._NOT_SET,
        target_arn: str = autoboto.ShapeBase._NOT_SET,
        phone_number: str = autoboto.ShapeBase._NOT_SET,
        subject: str = autoboto.ShapeBase._NOT_SET,
        message_structure: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if message_structure is not autoboto.ShapeBase._NOT_SET:
                _params['message_structure'] = message_structure
            if message_attributes is not autoboto.ShapeBase._NOT_SET:
    ...
    def subscribe(
        ...
        *,
        topic_arn: str,
        protocol: str,
        endpoint: str = autoboto.ShapeBase._NOT_SET,
        attributes: typing.Dict[str, str] = autoboto.ShapeBase._NOT_SET,
        return_subscription_arn: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if attributes is not autoboto.ShapeBase._NOT_SET:
                _params['attributes'] = attributes
            if return_subscription_arn is not autoboto.ShapeBase._NOT_SET:
