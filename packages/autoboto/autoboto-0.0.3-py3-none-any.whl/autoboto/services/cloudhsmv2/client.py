...
class Client:
    ...
    def create_cluster(
        ...
        *,
        ...
        hsm_type: str,
        source_backup_id: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if hsm_type is not autoboto.ShapeBase._NOT_SET:
                _params['hsm_type'] = hsm_type
            if source_backup_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_hsm(
        ...
        *,
        cluster_id: str,
        hsm_id: str = autoboto.ShapeBase._NOT_SET,
        eni_id: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if cluster_id is not autoboto.ShapeBase._NOT_SET:
                _params['cluster_id'] = cluster_id
            if hsm_id is not autoboto.ShapeBase._NOT_SET:
                _params['hsm_id'] = hsm_id
            if eni_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_backups(
        ...
        *,
        ...
        filters: typing.Dict[str, typing.List[str]
                            ] = autoboto.ShapeBase._NOT_SET,
        sort_ascending: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if sort_ascending is not autoboto.ShapeBase._NOT_SET:
    ...
    def initialize_cluster(
        ...
        *,
        ...
        if _request is None:
            ...
            if cluster_id is not autoboto.ShapeBase._NOT_SET:
                _params['cluster_id'] = cluster_id
            if signed_cert is not autoboto.ShapeBase._NOT_SET:
                _params['signed_cert'] = signed_cert
            if trust_anchor is not autoboto.ShapeBase._NOT_SET:
