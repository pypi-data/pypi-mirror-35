...
class CreateStreamInput(autoboto.ShapeBase):
    ...
    media_type: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
@dataclasses.dataclass
class CreateStreamOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DeleteStreamOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return []
...
@dataclasses.dataclass
class GetDataEndpointOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
    ...
    data_endpoint: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
@dataclasses.dataclass
class TagStreamOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return []
...
@dataclasses.dataclass
class UntagStreamOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return []
...
@dataclasses.dataclass
class UpdateDataRetentionOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return []
...
@dataclasses.dataclass
class UpdateStreamOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return []
