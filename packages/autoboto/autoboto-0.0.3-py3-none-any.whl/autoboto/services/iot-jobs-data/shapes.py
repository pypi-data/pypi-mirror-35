...
@dataclasses.dataclass
class GetPendingJobExecutionsResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
class JobExecution(autoboto.ShapeBase):
    ...
    # enqueued.
    queued_at: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    job_document: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
@dataclasses.dataclass
class StartNextPendingJobExecutionResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class UpdateJobExecutionResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
