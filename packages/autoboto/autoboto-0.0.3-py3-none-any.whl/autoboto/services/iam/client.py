...
class Client:
    ...
    def add_client_id_to_open_id_connect_provider(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if open_id_connect_provider_arn is not autoboto.ShapeBase._NOT_SET:
    ...
    def add_role_to_instance_profile(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if instance_profile_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def add_user_to_group(
        ...
        *,
        ...
        if _request is None:
            ...
            if user_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def attach_group_policy(
        ...
        *,
        ...
        if _request is None:
            ...
            if group_name is not autoboto.ShapeBase._NOT_SET:
                _params['group_name'] = group_name
            if policy_arn is not autoboto.ShapeBase._NOT_SET:
    ...
    def change_password(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if old_password is not autoboto.ShapeBase._NOT_SET:
                _params['old_password'] = old_password
            if new_password is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_access_key(
        ...
        *,
        user_name: str = autoboto.ShapeBase._NOT_SET,
    ...
    def create_account_alias(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if account_alias is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_login_profile(
        ...
        *,
        user_name: str,
        password: str,
        password_reset_required: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if password_reset_required is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_open_id_connect_provider(
        ...
        *,
        ...
        client_id_list: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if url is not autoboto.ShapeBase._NOT_SET:
                _params['url'] = url
            if thumbprint_list is not autoboto.ShapeBase._NOT_SET:
                _params['thumbprint_list'] = thumbprint_list
            if client_id_list is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_role(
        ...
        *,
        ...
        path: str = autoboto.ShapeBase._NOT_SET,
        description: str = autoboto.ShapeBase._NOT_SET,
        max_session_duration: int = autoboto.ShapeBase._NOT_SET,
        permissions_boundary: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if role_name is not autoboto.ShapeBase._NOT_SET:
                _params['role_name'] = role_name
            if assume_role_policy_document is not autoboto.ShapeBase._NOT_SET:
            ...
            if description is not autoboto.ShapeBase._NOT_SET:
                _params['description'] = description
            if max_session_duration is not autoboto.ShapeBase._NOT_SET:
                _params['max_session_duration'] = max_session_duration
            if permissions_boundary is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_saml_provider(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if saml_metadata_document is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_service_linked_role(
        ...
        *,
        ...
        description: str = autoboto.ShapeBase._NOT_SET,
        custom_suffix: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if aws_service_name is not autoboto.ShapeBase._NOT_SET:
                _params['aws_service_name'] = aws_service_name
            if description is not autoboto.ShapeBase._NOT_SET:
                _params['description'] = description
            if custom_suffix is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_virtual_mfa_device(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if virtual_mfa_device_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def deactivate_mfa_device(
        ...
        *,
        ...
        if _request is None:
            ...
            if user_name is not autoboto.ShapeBase._NOT_SET:
                _params['user_name'] = user_name
            if serial_number is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_access_key(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if access_key_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_saml_provider(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if saml_provider_arn is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_ssh_public_key(
        ...
        *,
        ...
        if _request is None:
            ...
            if user_name is not autoboto.ShapeBase._NOT_SET:
                _params['user_name'] = user_name
            if ssh_public_key_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_server_certificate(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if server_certificate_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_service_specific_credential(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if service_specific_credential_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def enable_mfa_device(
        ...
        *,
        ...
        if _request is None:
            ...
            if serial_number is not autoboto.ShapeBase._NOT_SET:
                _params['serial_number'] = serial_number
            if authentication_code1 is not autoboto.ShapeBase._NOT_SET:
                _params['authentication_code1'] = authentication_code1
            if authentication_code2 is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_account_authorization_details(
        ...
        *,
        filter: typing.List[shapes.EntityType] = autoboto.ShapeBase._NOT_SET,
        max_items: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if max_items is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_context_keys_for_custom_policy(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if policy_input_list is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_context_keys_for_principal_policy(
        ...
        *,
        ...
        policy_input_list: typing.List[str] = autoboto.ShapeBase._NOT_SET,
    ) -> shapes.GetContextKeysForPolicyResponse:
        """
        ...
        **Note:** This API discloses information about the permissions granted to other
        ...
        if _request is None:
            _params = {}
            if policy_source_arn is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_ssh_public_key(
        ...
        *,
        ...
        if _request is None:
            ...
            if ssh_public_key_id is not autoboto.ShapeBase._NOT_SET:
                _params['ssh_public_key_id'] = ssh_public_key_id
            if encoding is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_service_linked_role_deletion_status(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if deletion_task_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_attached_group_policies(
        ...
        *,
        group_name: str,
        path_prefix: str = autoboto.ShapeBase._NOT_SET,
        marker: str = autoboto.ShapeBase._NOT_SET,
        max_items: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if group_name is not autoboto.ShapeBase._NOT_SET:
                _params['group_name'] = group_name
            if path_prefix is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_entities_for_policy(
        ...
        *,
        policy_arn: str,
        entity_filter: shapes.EntityType = autoboto.ShapeBase._NOT_SET,
        path_prefix: str = autoboto.ShapeBase._NOT_SET,
        policy_usage_filter: shapes.PolicyUsageType = autoboto.ShapeBase.
        _NOT_SET,
        marker: str = autoboto.ShapeBase._NOT_SET,
        max_items: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if policy_arn is not autoboto.ShapeBase._NOT_SET:
                _params['policy_arn'] = policy_arn
            if entity_filter is not autoboto.ShapeBase._NOT_SET:
                _params['entity_filter'] = entity_filter
            if path_prefix is not autoboto.ShapeBase._NOT_SET:
                _params['path_prefix'] = path_prefix
            if policy_usage_filter is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_policies(
        ...
        *,
        scope: shapes.policyScopeType = autoboto.ShapeBase._NOT_SET,
        only_attached: bool = autoboto.ShapeBase._NOT_SET,
        path_prefix: str = autoboto.ShapeBase._NOT_SET,
        policy_usage_filter: shapes.PolicyUsageType = autoboto.ShapeBase.
        _NOT_SET,
        marker: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if scope is not autoboto.ShapeBase._NOT_SET:
                _params['scope'] = scope
            if only_attached is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_service_specific_credentials(
        ...
        *,
        user_name: str = autoboto.ShapeBase._NOT_SET,
        service_name: str = autoboto.ShapeBase._NOT_SET,
    ...
    def list_virtual_mfa_devices(
        ...
        *,
        assignment_status: shapes.assignmentStatusType = autoboto.ShapeBase.
        _NOT_SET,
        marker: str = autoboto.ShapeBase._NOT_SET,
        max_items: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if assignment_status is not autoboto.ShapeBase._NOT_SET:
    ...
    def simulate_custom_policy(
        ...
        *,
        ...
        resource_arns: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        resource_policy: str = autoboto.ShapeBase._NOT_SET,
        resource_owner: str = autoboto.ShapeBase._NOT_SET,
        caller_arn: str = autoboto.ShapeBase._NOT_SET,
        context_entries: typing.List[shapes.ContextEntry
                                    ] = autoboto.ShapeBase._NOT_SET,
        resource_handling_option: str = autoboto.ShapeBase._NOT_SET,
        max_items: int = autoboto.ShapeBase._NOT_SET,
        marker: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if policy_input_list is not autoboto.ShapeBase._NOT_SET:
                _params['policy_input_list'] = policy_input_list
            if action_names is not autoboto.ShapeBase._NOT_SET:
                _params['action_names'] = action_names
            if resource_arns is not autoboto.ShapeBase._NOT_SET:
                _params['resource_arns'] = resource_arns
            if resource_policy is not autoboto.ShapeBase._NOT_SET:
                _params['resource_policy'] = resource_policy
            if resource_owner is not autoboto.ShapeBase._NOT_SET:
                _params['resource_owner'] = resource_owner
            if caller_arn is not autoboto.ShapeBase._NOT_SET:
                _params['caller_arn'] = caller_arn
            if context_entries is not autoboto.ShapeBase._NOT_SET:
                _params['context_entries'] = context_entries
            if resource_handling_option is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_account_password_policy(
        ...
        *,
        minimum_password_length: int = autoboto.ShapeBase._NOT_SET,
        require_symbols: bool = autoboto.ShapeBase._NOT_SET,
        require_numbers: bool = autoboto.ShapeBase._NOT_SET,
        require_uppercase_characters: bool = autoboto.ShapeBase._NOT_SET,
        require_lowercase_characters: bool = autoboto.ShapeBase._NOT_SET,
        allow_users_to_change_password: bool = autoboto.ShapeBase._NOT_SET,
        max_password_age: int = autoboto.ShapeBase._NOT_SET,
        password_reuse_prevention: int = autoboto.ShapeBase._NOT_SET,
        hard_expiry: bool = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            _params = {}
            if minimum_password_length is not autoboto.ShapeBase._NOT_SET:
                _params['minimum_password_length'] = minimum_password_length
            if require_symbols is not autoboto.ShapeBase._NOT_SET:
                _params['require_symbols'] = require_symbols
            if require_numbers is not autoboto.ShapeBase._NOT_SET:
                _params['require_numbers'] = require_numbers
            if require_uppercase_characters is not autoboto.ShapeBase._NOT_SET:
                _params['require_uppercase_characters'
                       ] = require_uppercase_characters
            if require_lowercase_characters is not autoboto.ShapeBase._NOT_SET:
                _params['require_lowercase_characters'
                       ] = require_lowercase_characters
            if allow_users_to_change_password is not autoboto.ShapeBase._NOT_SET:
                _params['allow_users_to_change_password'
                       ] = allow_users_to_change_password
            if max_password_age is not autoboto.ShapeBase._NOT_SET:
                _params['max_password_age'] = max_password_age
            if password_reuse_prevention is not autoboto.ShapeBase._NOT_SET:
                _params['password_reuse_prevention'] = password_reuse_prevention
            if hard_expiry is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_group(
        ...
        *,
        group_name: str,
        new_path: str = autoboto.ShapeBase._NOT_SET,
        new_group_name: str = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            ...
            if group_name is not autoboto.ShapeBase._NOT_SET:
                _params['group_name'] = group_name
            if new_path is not autoboto.ShapeBase._NOT_SET:
                _params['new_path'] = new_path
            if new_group_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_server_certificate(
        ...
        *,
        server_certificate_name: str,
        new_path: str = autoboto.ShapeBase._NOT_SET,
        new_server_certificate_name: str = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            ...
            if new_path is not autoboto.ShapeBase._NOT_SET:
                _params['new_path'] = new_path
            if new_server_certificate_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_user(
        ...
        *,
        user_name: str,
        new_path: str = autoboto.ShapeBase._NOT_SET,
        new_user_name: str = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            ...
            if new_path is not autoboto.ShapeBase._NOT_SET:
                _params['new_path'] = new_path
            if new_user_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def upload_ssh_public_key(
        ...
        *,
        ...
        if _request is None:
            ...
            if user_name is not autoboto.ShapeBase._NOT_SET:
                _params['user_name'] = user_name
            if ssh_public_key_body is not autoboto.ShapeBase._NOT_SET:
    ...
    def upload_server_certificate(
        ...
        *,
        ...
        if _request is None:
            ...
            if private_key is not autoboto.ShapeBase._NOT_SET:
