...
class CreateExportTaskRequest(autoboto.ShapeBase):
    ...
    task_name: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
@dataclasses.dataclass
class CreateExportTaskResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DescribeDestinationsResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DescribeLogGroupsResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
class DescribeLogStreamsRequest(autoboto.ShapeBase):
    ...
    # value is false.
    descending: bool = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
@dataclasses.dataclass
class DescribeLogStreamsResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DescribeMetricFiltersResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DescribeResourcePoliciesResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DescribeSubscriptionFiltersResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
class Destination(autoboto.ShapeBase):
    ...
    access_policy: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
    ...
    creation_time: int = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
class FilterLogEventsRequest(autoboto.ShapeBase):
    ...
    # returned.
    start_time: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # The end of the time range, expressed as the number of milliseconds after
    # Jan 1, 1970 00:00:00 UTC. Events with a time stamp later than this time are
    # not returned.
    end_time: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    interleaved: bool = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )


@dataclasses.dataclass
class FilterLogEventsResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class GetLogEventsResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class ListTagsLogGroupResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
class LogGroup(autoboto.ShapeBase):
    ...
    stored_bytes: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class MetricFilterMatchRecord(autoboto.ShapeBase):
    ...
    # The event number.
    event_number: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # The raw event data.
    event_message: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
@dataclasses.dataclass
class PutDestinationResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class PutLogEventsResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class TestMetricFilterResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
