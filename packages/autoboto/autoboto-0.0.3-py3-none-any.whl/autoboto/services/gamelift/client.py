...
class Client:
    ...
    def accept_match(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if ticket_id is not autoboto.ShapeBase._NOT_SET:
                _params['ticket_id'] = ticket_id
            if player_ids is not autoboto.ShapeBase._NOT_SET:
                _params['player_ids'] = player_ids
            if acceptance_type is not autoboto.ShapeBase._NOT_SET:
        ...
        *,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if routing_strategy is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_build(
        ...
        *,
        ...
        storage_location: shapes.S3Location = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if storage_location is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_fleet(
        ...
        *,
        ...
        description: str = autoboto.ShapeBase._NOT_SET,
        server_launch_path: str = autoboto.ShapeBase._NOT_SET,
        server_launch_parameters: str = autoboto.ShapeBase._NOT_SET,
        log_paths: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        ResourceCreationLimitPolicy = autoboto.ShapeBase._NOT_SET,
        metric_groups: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        peer_vpc_aws_account_id: str = autoboto.ShapeBase._NOT_SET,
        peer_vpc_id: str = autoboto.ShapeBase._NOT_SET,
        fleet_type: shapes.FleetType = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if build_id is not autoboto.ShapeBase._NOT_SET:
                _params['build_id'] = build_id
            if ec2_instance_type is not autoboto.ShapeBase._NOT_SET:
                _params['ec2_instance_type'] = ec2_instance_type
            if description is not autoboto.ShapeBase._NOT_SET:
                _params['description'] = description
            if server_launch_path is not autoboto.ShapeBase._NOT_SET:
                _params['server_launch_path'] = server_launch_path
            if server_launch_parameters is not autoboto.ShapeBase._NOT_SET:
                _params['server_launch_parameters'] = server_launch_parameters
            if log_paths is not autoboto.ShapeBase._NOT_SET:
                _params['log_paths'] = log_paths
            if ec2_inbound_permissions is not autoboto.ShapeBase._NOT_SET:
                _params['ec2_inbound_permissions'] = ec2_inbound_permissions
            if new_game_session_protection_policy is not autoboto.ShapeBase._NOT_SET:
                _params['new_game_session_protection_policy'
                       ] = new_game_session_protection_policy
            if runtime_configuration is not autoboto.ShapeBase._NOT_SET:
                _params['runtime_configuration'] = runtime_configuration
            if resource_creation_limit_policy is not autoboto.ShapeBase._NOT_SET:
                _params['resource_creation_limit_policy'
                       ] = resource_creation_limit_policy
            if metric_groups is not autoboto.ShapeBase._NOT_SET:
                _params['metric_groups'] = metric_groups
            if peer_vpc_aws_account_id is not autoboto.ShapeBase._NOT_SET:
            ...
            if fleet_type is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_game_session(
        ...
        *,
        ...
        fleet_id: str = autoboto.ShapeBase._NOT_SET,
        alias_id: str = autoboto.ShapeBase._NOT_SET,
        name: str = autoboto.ShapeBase._NOT_SET,
        game_properties: typing.List[shapes.GameProperty
                                    ] = autoboto.ShapeBase._NOT_SET,
        creator_id: str = autoboto.ShapeBase._NOT_SET,
        game_session_id: str = autoboto.ShapeBase._NOT_SET,
        idempotency_token: str = autoboto.ShapeBase._NOT_SET,
        game_session_data: str = autoboto.ShapeBase._NOT_SET,
        ...
        **Game session logs.** Logs are retained for all active game sessions for 14
        ...
        if _request is None:
            _params = {}
            if maximum_player_session_count is not autoboto.ShapeBase._NOT_SET:
                _params['maximum_player_session_count'
                       ] = maximum_player_session_count
            if fleet_id is not autoboto.ShapeBase._NOT_SET:
                _params['fleet_id'] = fleet_id
            if alias_id is not autoboto.ShapeBase._NOT_SET:
                _params['alias_id'] = alias_id
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if game_properties is not autoboto.ShapeBase._NOT_SET:
                _params['game_properties'] = game_properties
            if creator_id is not autoboto.ShapeBase._NOT_SET:
                _params['creator_id'] = creator_id
            if game_session_id is not autoboto.ShapeBase._NOT_SET:
                _params['game_session_id'] = game_session_id
            if idempotency_token is not autoboto.ShapeBase._NOT_SET:
                _params['idempotency_token'] = idempotency_token
            if game_session_data is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_game_session_queue(
        ...
        *,
        name: str,
        timeout_in_seconds: int = autoboto.ShapeBase._NOT_SET,
        ...
        **Player latency policies.** For placement requests containing player latency
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if timeout_in_seconds is not autoboto.ShapeBase._NOT_SET:
                _params['timeout_in_seconds'] = timeout_in_seconds
            if player_latency_policies is not autoboto.ShapeBase._NOT_SET:
                _params['player_latency_policies'] = player_latency_policies
            if destinations is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_matchmaking_configuration(
        ...
        *,
        ...
        rule_set_name: str,
        description: str = autoboto.ShapeBase._NOT_SET,
        acceptance_timeout_seconds: int = autoboto.ShapeBase._NOT_SET,
        notification_target: str = autoboto.ShapeBase._NOT_SET,
        additional_player_count: int = autoboto.ShapeBase._NOT_SET,
        custom_event_data: str = autoboto.ShapeBase._NOT_SET,
        game_properties: typing.List[shapes.GameProperty
                                    ] = autoboto.ShapeBase._NOT_SET,
        game_session_data: str = autoboto.ShapeBase._NOT_SET,
        ...
        **Matchmaking status notification** \-- There are two ways to track the progress
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if game_session_queue_arns is not autoboto.ShapeBase._NOT_SET:
                _params['game_session_queue_arns'] = game_session_queue_arns
            if request_timeout_seconds is not autoboto.ShapeBase._NOT_SET:
            ...
            if rule_set_name is not autoboto.ShapeBase._NOT_SET:
                _params['rule_set_name'] = rule_set_name
            if description is not autoboto.ShapeBase._NOT_SET:
                _params['description'] = description
            if acceptance_timeout_seconds is not autoboto.ShapeBase._NOT_SET:
                _params['acceptance_timeout_seconds'
                       ] = acceptance_timeout_seconds
            if notification_target is not autoboto.ShapeBase._NOT_SET:
                _params['notification_target'] = notification_target
            if additional_player_count is not autoboto.ShapeBase._NOT_SET:
                _params['additional_player_count'] = additional_player_count
            if custom_event_data is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_matchmaking_rule_set(
        ...
        *,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if rule_set_body is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_player_session(
        ...
        *,
        game_session_id: str,
        player_id: str,
        player_data: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if game_session_id is not autoboto.ShapeBase._NOT_SET:
                _params['game_session_id'] = game_session_id
            if player_id is not autoboto.ShapeBase._NOT_SET:
                _params['player_id'] = player_id
            if player_data is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_player_sessions(
        ...
        *,
        game_session_id: str,
        player_ids: typing.List[str],
        player_data_map: typing.Dict[str, str] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if player_ids is not autoboto.ShapeBase._NOT_SET:
                _params['player_ids'] = player_ids
            if player_data_map is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_vpc_peering_authorization(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if game_lift_aws_account_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_ec2_instance_limits(
        ...
        *,
        ec2_instance_type: shapes.EC2InstanceType = autoboto.ShapeBase._NOT_SET,
    ...
    def describe_game_session_details(
        ...
        *,
        ...
        game_session_id: str = autoboto.ShapeBase._NOT_SET,
        alias_id: str = autoboto.ShapeBase._NOT_SET,
        status_filter: str = autoboto.ShapeBase._NOT_SET,
        limit: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if alias_id is not autoboto.ShapeBase._NOT_SET:
                _params['alias_id'] = alias_id
            if status_filter is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_game_session_placement(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if placement_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_game_session_queues(
        ...
        *,
        names: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        limit: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
    ...
    def describe_matchmaking(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if ticket_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_matchmaking_configurations(
        ...
        *,
        names: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        rule_set_name: str = autoboto.ShapeBase._NOT_SET,
        limit: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
    ...
    def describe_player_sessions(
        ...
        *,
        game_session_id: str = autoboto.ShapeBase._NOT_SET,
        player_id: str = autoboto.ShapeBase._NOT_SET,
        player_session_id: str = autoboto.ShapeBase._NOT_SET,
        player_session_status_filter: str = autoboto.ShapeBase._NOT_SET,
        limit: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if player_id is not autoboto.ShapeBase._NOT_SET:
                _params['player_id'] = player_id
            if player_session_id is not autoboto.ShapeBase._NOT_SET:
                _params['player_session_id'] = player_session_id
            if player_session_status_filter is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_scaling_policies(
        ...
        *,
        fleet_id: str,
        status_filter: shapes.ScalingStatusType = autoboto.ShapeBase._NOT_SET,
        limit: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
    ...
    def list_aliases(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if routing_strategy_type is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_builds(
        ...
        *,
        status: shapes.BuildStatus = autoboto.ShapeBase._NOT_SET,
        limit: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
    ...
    def list_fleets(
        ...
        *,
        build_id: str = autoboto.ShapeBase._NOT_SET,
        limit: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
    ...
    def put_scaling_policy(
        ...
        *,
        ...
        ShapeBase._NOT_SET,
        threshold: float = autoboto.ShapeBase._NOT_SET,
        comparison_operator: shapes.ComparisonOperatorType = autoboto.ShapeBase.
        _NOT_SET,
        evaluation_periods: int = autoboto.ShapeBase._NOT_SET,
        policy_type: shapes.PolicyType = autoboto.ShapeBase._NOT_SET,
        ...
        **Rule-based policy**
        ...
        if _request is None:
            ...
            if fleet_id is not autoboto.ShapeBase._NOT_SET:
                _params['fleet_id'] = fleet_id
            if metric_name is not autoboto.ShapeBase._NOT_SET:
            ...
            if scaling_adjustment_type is not autoboto.ShapeBase._NOT_SET:
                _params['scaling_adjustment_type'] = scaling_adjustment_type
            if threshold is not autoboto.ShapeBase._NOT_SET:
                _params['threshold'] = threshold
            if comparison_operator is not autoboto.ShapeBase._NOT_SET:
                _params['comparison_operator'] = comparison_operator
            if evaluation_periods is not autoboto.ShapeBase._NOT_SET:
            ...
            if target_configuration is not autoboto.ShapeBase._NOT_SET:
    ...
    def search_game_sessions(
        ...
        *,
        ...
        sort_expression: str = autoboto.ShapeBase._NOT_SET,
        limit: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if sort_expression is not autoboto.ShapeBase._NOT_SET:
    ...
    def start_fleet_actions(
        ...
        *,
        ...
        if _request is None:
            ...
            if fleet_id is not autoboto.ShapeBase._NOT_SET:
                _params['fleet_id'] = fleet_id
            if actions is not autoboto.ShapeBase._NOT_SET:
    ...
    def start_game_session_placement(
        ...
        *,
        ...
        game_session_name: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if placement_id is not autoboto.ShapeBase._NOT_SET:
                _params['placement_id'] = placement_id
            if game_session_queue_name is not autoboto.ShapeBase._NOT_SET:
            ...
            if game_properties is not autoboto.ShapeBase._NOT_SET:
                _params['game_properties'] = game_properties
            if game_session_name is not autoboto.ShapeBase._NOT_SET:
                _params['game_session_name'] = game_session_name
            if player_latencies is not autoboto.ShapeBase._NOT_SET:
                _params['player_latencies'] = player_latencies
            if desired_player_sessions is not autoboto.ShapeBase._NOT_SET:
    ...
    def start_match_backfill(
        ...
        *,
        ...
        ticket_id: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if configuration_name is not autoboto.ShapeBase._NOT_SET:
                _params['configuration_name'] = configuration_name
            if game_session_arn is not autoboto.ShapeBase._NOT_SET:
                _params['game_session_arn'] = game_session_arn
            if players is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_alias(
        ...
        *,
        ...
        name: str = autoboto.ShapeBase._NOT_SET,
        description: str = autoboto.ShapeBase._NOT_SET,
        routing_strategy: shapes.RoutingStrategy = autoboto.ShapeBase._NOT_SET,
    ...
    def update_fleet_capacity(
        ...
        *,
        fleet_id: str,
        desired_instances: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if fleet_id is not autoboto.ShapeBase._NOT_SET:
                _params['fleet_id'] = fleet_id
            if desired_instances is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_fleet_port_settings(
        ...
        *,
        ...
        if _request is None:
            ...
            if fleet_id is not autoboto.ShapeBase._NOT_SET:
                _params['fleet_id'] = fleet_id
            if inbound_permission_authorizations is not autoboto.ShapeBase._NOT_SET:
                _params['inbound_permission_authorizations'
                       ] = inbound_permission_authorizations
            if inbound_permission_revocations is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_game_session(
        ...
        *,
        game_session_id: str,
        maximum_player_session_count: int = autoboto.ShapeBase._NOT_SET,
        name: str = autoboto.ShapeBase._NOT_SET,
        player_session_creation_policy: shapes.
        PlayerSessionCreationPolicy = autoboto.ShapeBase._NOT_SET,
        protection_policy: shapes.ProtectionPolicy = autoboto.ShapeBase.
        _NOT_SET,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if player_session_creation_policy is not autoboto.ShapeBase._NOT_SET:
                _params['player_session_creation_policy'
                       ] = player_session_creation_policy
            if protection_policy is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_matchmaking_configuration(
        ...
        *,
        name: str,
        description: str = autoboto.ShapeBase._NOT_SET,
        game_session_queue_arns: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        request_timeout_seconds: int = autoboto.ShapeBase._NOT_SET,
        acceptance_timeout_seconds: int = autoboto.ShapeBase._NOT_SET,
