...
class BotAliasMetadata(autoboto.ShapeBase):
    ...
    bot_version: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # The name of the bot to which the alias points.
    bot_name: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class BotChannelAssociation(autoboto.ShapeBase):
    ...
    bot_alias: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class CreateBotVersionResponse(autoboto.ShapeBase):
    ...
    # the user.
    voice_id: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class GetImportRequest(autoboto.ShapeBase):
    ...
    import_id: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class Intent(autoboto.ShapeBase):
    ...
    # The name of the intent.
    intent_name: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class Message(autoboto.ShapeBase):
    ...
    # the response.
    group_number: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class Prompt(autoboto.ShapeBase):
    ...
    response_card: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
class Slot(autoboto.ShapeBase):
    ...
    slot_type: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
