...
class Client:
    ...
    def allocate_static_ip(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if static_ip_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def attach_instances_to_load_balancer(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if load_balancer_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def close_instance_public_ports(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if port_info is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_disk(
        ...
        *,
        ...
        if _request is None:
            ...
            if size_in_gb is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_disk_from_snapshot(
        ...
        *,
        ...
        if _request is None:
            ...
            if disk_name is not autoboto.ShapeBase._NOT_SET:
                _params['disk_name'] = disk_name
            if disk_snapshot_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_domain_entry(
        ...
        *,
        ...
        if _request is None:
            ...
            if domain_name is not autoboto.ShapeBase._NOT_SET:
                _params['domain_name'] = domain_name
            if domain_entry is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_instance_snapshot(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if instance_snapshot_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_instances(
        ...
        *,
        ...
        blueprint_id: str,
        bundle_id: str,
        custom_image_name: str = autoboto.ShapeBase._NOT_SET,
        user_data: str = autoboto.ShapeBase._NOT_SET,
        key_pair_name: str = autoboto.ShapeBase._NOT_SET,
    ...
    def create_instances_from_snapshot(
        ...
        *,
        ...
        if _request is None:
            ...
            if bundle_id is not autoboto.ShapeBase._NOT_SET:
                _params['bundle_id'] = bundle_id
            if attached_disk_mapping is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_load_balancer(
        ...
        *,
        ...
        certificate_domain_name: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if load_balancer_name is not autoboto.ShapeBase._NOT_SET:
                _params['load_balancer_name'] = load_balancer_name
            if instance_port is not autoboto.ShapeBase._NOT_SET:
            ...
            if certificate_name is not autoboto.ShapeBase._NOT_SET:
                _params['certificate_name'] = certificate_name
            if certificate_domain_name is not autoboto.ShapeBase._NOT_SET:
                _params['certificate_domain_name'] = certificate_domain_name
            if certificate_alternative_names is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_blueprints(
        ...
        *,
        include_inactive: bool = autoboto.ShapeBase._NOT_SET,
        page_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if include_inactive is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_instance_access_details(
        ...
        *,
        instance_name: str,
        protocol: shapes.InstanceAccessProtocol = autoboto.ShapeBase._NOT_SET,
    ...
    def get_regions(
        ...
        *,
        include_availability_zones: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if include_availability_zones is not autoboto.ShapeBase._NOT_SET:
    ...
    def import_key_pair(
        ...
        *,
        ...
        if _request is None:
            ...
            if key_pair_name is not autoboto.ShapeBase._NOT_SET:
                _params['key_pair_name'] = key_pair_name
            if public_key_base64 is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_instance_public_ports(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if port_infos is not autoboto.ShapeBase._NOT_SET:
