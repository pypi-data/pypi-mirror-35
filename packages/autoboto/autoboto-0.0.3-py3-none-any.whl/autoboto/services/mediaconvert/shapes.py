...
class AacSettings(autoboto.ShapeBase):
    ...
    sample_rate: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class AiffSettings(autoboto.ShapeBase):
    ...
    bit_depth: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    channels: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class AudioDescription(autoboto.ShapeBase):
    ...
    audio_type: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class AudioSelector(autoboto.ShapeBase):
    ...
    # video.
    offset: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class BurninDestinationSettings(autoboto.ShapeBase):
    ...
    # match.
    font_size: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class CmafGroupSettings(autoboto.ShapeBase):
    ...
    base_url: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class ColorCorrector(autoboto.ShapeBase):
    ...
    # Brightness level.
    brightness: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    # Contrast level.
    contrast: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    # Hue in degrees.
    hue: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # Saturation level.
    saturation: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class CreateJobRequest(autoboto.ShapeBase):
    ...
    job_template: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    queue: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class DvbNitSettings(autoboto.ShapeBase):
    ...
    # transport stream.
    nit_interval: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class DvbSdtSettings(autoboto.ShapeBase):
    ...
    # The number of milliseconds between instances of this table in the output
    # transport stream.
    sdt_interval: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class DvbTdtSettings(autoboto.ShapeBase):
    ...
    # The number of milliseconds between instances of this table in the output
    # transport stream.
    tdt_interval: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class FileSourceSettings(autoboto.ShapeBase):
    ...
    source_file: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # Specifies a time delta in seconds to offset the captions from the source
    # file.
    time_delta: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class FrameCaptureSettings(autoboto.ShapeBase):
    ...
    max_captures: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # JPEG Quality - a higher value equals higher quality.
    quality: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class H265Settings(autoboto.ShapeBase):
    ...
    tiles: "H265Tiles" = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
class Hdr10Metadata(autoboto.ShapeBase):
    ...
    # 0.00002 in CIE1931 color coordinate. Note that this setting is not for
    # color correction.
    red_primary_x: int = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
    ...
    # 0.00002 in CIE1931 color coordinate. Note that this setting is not for
    # color correction.
    red_primary_y: int = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
    ...
    # 0.00002 in CIE1931 color coordinate. Note that this setting is not for
    # color correction.
    white_point_x: int = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
    ...
    # 0.00002 in CIE1931 color coordinate. Note that this setting is not for
    # color correction.
    white_point_y: int = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
class Id3Insertion(autoboto.ShapeBase):
    ...
    id3: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # Provide a Timecode (TimeCode) in HH:MM:SS:FF or HH:MM:SS;FF format.
    timecode: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class Input(autoboto.ShapeBase):
    ...
    file_input: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class InputClipping(autoboto.ShapeBase):
    ...
    end_timecode: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class Job(autoboto.ShapeBase):
    ...
    error_code: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class ListJobTemplatesRequest(autoboto.ShapeBase):
    ...
    # resource.
    order: "Order" = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class M2tsSettings(autoboto.ShapeBase):
    ...
    pcr_pid: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    # stream.
    pmt_pid: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    scte35_pid: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    # stream.
    video_pid: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class NielsenConfiguration(autoboto.ShapeBase):
    ...
    breakout_code: int = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
class NoiseReducerFilterSettings(autoboto.ShapeBase):
    ...
    # filtering.
    strength: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class NoiseReducerSpatialFilterSettings(autoboto.ShapeBase):
    ...
    speed: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class Output(autoboto.ShapeBase):
    ...
    preset: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class OutputGroup(autoboto.ShapeBase):
    ...
    custom_name: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class Rectangle(autoboto.ShapeBase):
    ...
    x: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # The distance, in pixels, between the rectangle and the top edge of the
    # video frame. Specify only even numbers.
    y: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class TimecodeConfig(autoboto.ShapeBase):
    ...
    # input.
    anchor: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class VideoDescription(autoboto.ShapeBase):
    ...
    fixed_afd: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class VideoDetail(autoboto.ShapeBase):
    ...
    height_in_px: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # Width in pixels for the output
    width_in_px: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
