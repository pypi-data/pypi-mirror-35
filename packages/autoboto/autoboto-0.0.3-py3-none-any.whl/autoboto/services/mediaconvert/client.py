...
class Client:
    ...
    def create_job(
        ...
        *,
        ...
        job_template: str = autoboto.ShapeBase._NOT_SET,
        queue: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if job_template is not autoboto.ShapeBase._NOT_SET:
                _params['job_template'] = job_template
            if queue is not autoboto.ShapeBase._NOT_SET:
                _params['queue'] = queue
    ...
    def create_job_template(
        ...
        *,
        ...
        category: str = autoboto.ShapeBase._NOT_SET,
    ...
    def list_job_templates(
        ...
        *,
        category: str = autoboto.ShapeBase._NOT_SET,
        list_by: shapes.JobTemplateListBy = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        order: shapes.Order = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if category is not autoboto.ShapeBase._NOT_SET:
                _params['category'] = category
            if list_by is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_presets(
        ...
        *,
        category: str = autoboto.ShapeBase._NOT_SET,
        list_by: shapes.PresetListBy = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        order: shapes.Order = autoboto.ShapeBase._NOT_SET,
    ...
    def list_queues(
        ...
        *,
        list_by: shapes.QueueListBy = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        order: shapes.Order = autoboto.ShapeBase._NOT_SET,
    ...
    def update_job_template(
        ...
        *,
        ...
        description: str = autoboto.ShapeBase._NOT_SET,
        queue: str = autoboto.ShapeBase._NOT_SET,
        settings: shapes.JobTemplateSettings = autoboto.ShapeBase._NOT_SET,
    ...
    def update_preset(
        ...
        *,
        ...
        category: str = autoboto.ShapeBase._NOT_SET,
        description: str = autoboto.ShapeBase._NOT_SET,
        settings: shapes.PresetSettings = autoboto.ShapeBase._NOT_SET,
    ...
    def update_queue(
        ...
        *,
        name: str,
        description: str = autoboto.ShapeBase._NOT_SET,
        status: shapes.QueueStatus = autoboto.ShapeBase._NOT_SET,
