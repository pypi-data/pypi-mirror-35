...
class Client:
    ...
    def create_endpoint(
        ...
        *,
        ...
        if _request is None:
            ...
            if endpoint_config_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_endpoint_config(
        ...
        *,
        ...
        if _request is None:
            ...
            if endpoint_config_name is not autoboto.ShapeBase._NOT_SET:
                _params['endpoint_config_name'] = endpoint_config_name
            if production_variants is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_hyper_parameter_tuning_job(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if hyper_parameter_tuning_job_name is not autoboto.ShapeBase._NOT_SET:
                _params['hyper_parameter_tuning_job_name'
                       ] = hyper_parameter_tuning_job_name
            if hyper_parameter_tuning_job_config is not autoboto.ShapeBase._NOT_SET:
                _params['hyper_parameter_tuning_job_config'
                       ] = hyper_parameter_tuning_job_config
            if training_job_definition is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_model(
        ...
        *,
        ...
        tags: typing.List[shapes.Tag] = autoboto.ShapeBase._NOT_SET,
        vpc_config: shapes.VpcConfig = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if primary_container is not autoboto.ShapeBase._NOT_SET:
            ...
            if tags is not autoboto.ShapeBase._NOT_SET:
                _params['tags'] = tags
            if vpc_config is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_notebook_instance(
        ...
        *,
        ...
        kms_key_id: str = autoboto.ShapeBase._NOT_SET,
        tags: typing.List[shapes.Tag] = autoboto.ShapeBase._NOT_SET,
        lifecycle_config_name: str = autoboto.ShapeBase._NOT_SET,
        direct_internet_access: shapes.DirectInternetAccess = autoboto.
        ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if notebook_instance_name is not autoboto.ShapeBase._NOT_SET:
            ...
            if tags is not autoboto.ShapeBase._NOT_SET:
                _params['tags'] = tags
            if lifecycle_config_name is not autoboto.ShapeBase._NOT_SET:
                _params['lifecycle_config_name'] = lifecycle_config_name
            if direct_internet_access is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_notebook_instance_lifecycle_config(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if notebook_instance_lifecycle_config_name is not autoboto.ShapeBase._NOT_SET:
                _params['notebook_instance_lifecycle_config_name'
                       ] = notebook_instance_lifecycle_config_name
            if on_create is not autoboto.ShapeBase._NOT_SET:
                _params['on_create'] = on_create
            if on_start is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_presigned_notebook_instance_url(
        ...
        *,
        notebook_instance_name: str,
        session_expiration_duration_in_seconds: int = autoboto.ShapeBase.
        _NOT_SET,
        ...
        if _request is None:
            ...
            if notebook_instance_name is not autoboto.ShapeBase._NOT_SET:
                _params['notebook_instance_name'] = notebook_instance_name
            if session_expiration_duration_in_seconds is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_training_job(
        ...
        *,
        ...
        hyper_parameters: typing.Dict[str, str] = autoboto.ShapeBase._NOT_SET,
        vpc_config: shapes.VpcConfig = autoboto.ShapeBase._NOT_SET,
        tags: typing.List[shapes.Tag] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if training_job_name is not autoboto.ShapeBase._NOT_SET:
                _params['training_job_name'] = training_job_name
            if algorithm_specification is not autoboto.ShapeBase._NOT_SET:
                _params['algorithm_specification'] = algorithm_specification
            if role_arn is not autoboto.ShapeBase._NOT_SET:
                _params['role_arn'] = role_arn
            if input_data_config is not autoboto.ShapeBase._NOT_SET:
                _params['input_data_config'] = input_data_config
            if output_data_config is not autoboto.ShapeBase._NOT_SET:
                _params['output_data_config'] = output_data_config
            if resource_config is not autoboto.ShapeBase._NOT_SET:
                _params['resource_config'] = resource_config
            if stopping_condition is not autoboto.ShapeBase._NOT_SET:
                _params['stopping_condition'] = stopping_condition
            if hyper_parameters is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_transform_job(
        ...
        *,
        ...
        max_concurrent_transforms: int = autoboto.ShapeBase._NOT_SET,
        max_payload_in_mb: int = autoboto.ShapeBase._NOT_SET,
        batch_strategy: shapes.BatchStrategy = autoboto.ShapeBase._NOT_SET,
        environment: typing.Dict[str, str] = autoboto.ShapeBase._NOT_SET,
        tags: typing.List[shapes.Tag] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if transform_job_name is not autoboto.ShapeBase._NOT_SET:
                _params['transform_job_name'] = transform_job_name
            if model_name is not autoboto.ShapeBase._NOT_SET:
                _params['model_name'] = model_name
            if transform_input is not autoboto.ShapeBase._NOT_SET:
                _params['transform_input'] = transform_input
            if transform_output is not autoboto.ShapeBase._NOT_SET:
                _params['transform_output'] = transform_output
            if transform_resources is not autoboto.ShapeBase._NOT_SET:
                _params['transform_resources'] = transform_resources
            if max_concurrent_transforms is not autoboto.ShapeBase._NOT_SET:
                _params['max_concurrent_transforms'] = max_concurrent_transforms
            if max_payload_in_mb is not autoboto.ShapeBase._NOT_SET:
                _params['max_payload_in_mb'] = max_payload_in_mb
            if batch_strategy is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_endpoint_configs(
        ...
        *,
        sort_by: shapes.EndpointConfigSortKey = autoboto.ShapeBase._NOT_SET,
        sort_order: shapes.OrderKey = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        name_contains: str = autoboto.ShapeBase._NOT_SET,
        creation_time_before: datetime.datetime = autoboto.ShapeBase._NOT_SET,
        creation_time_after: datetime.datetime = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if name_contains is not autoboto.ShapeBase._NOT_SET:
                _params['name_contains'] = name_contains
            if creation_time_before is not autoboto.ShapeBase._NOT_SET:
                _params['creation_time_before'] = creation_time_before
            if creation_time_after is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_endpoints(
        ...
        *,
        sort_by: shapes.EndpointSortKey = autoboto.ShapeBase._NOT_SET,
        sort_order: shapes.OrderKey = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        name_contains: str = autoboto.ShapeBase._NOT_SET,
        creation_time_before: datetime.datetime = autoboto.ShapeBase._NOT_SET,
        creation_time_after: datetime.datetime = autoboto.ShapeBase._NOT_SET,
        last_modified_time_before: datetime.datetime = autoboto.ShapeBase.
        _NOT_SET,
        last_modified_time_after: datetime.datetime = autoboto.ShapeBase.
        _NOT_SET,
        status_equals: shapes.EndpointStatus = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if creation_time_after is not autoboto.ShapeBase._NOT_SET:
                _params['creation_time_after'] = creation_time_after
            if last_modified_time_before is not autoboto.ShapeBase._NOT_SET:
                _params['last_modified_time_before'] = last_modified_time_before
            if last_modified_time_after is not autoboto.ShapeBase._NOT_SET:
                _params['last_modified_time_after'] = last_modified_time_after
            if status_equals is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_hyper_parameter_tuning_jobs(
        ...
        *,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        sort_by: shapes.HyperParameterTuningJobSortByOptions = autoboto.
        ShapeBase._NOT_SET,
        ...
        last_modified_time_before: datetime.datetime = autoboto.ShapeBase.
        _NOT_SET,
        status_equals: shapes.HyperParameterTuningJobStatus = autoboto.
        ShapeBase._NOT_SET,
    ...
    def list_models(
        ...
        *,
        sort_by: shapes.ModelSortKey = autoboto.ShapeBase._NOT_SET,
        sort_order: shapes.OrderKey = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        name_contains: str = autoboto.ShapeBase._NOT_SET,
    ...
    def list_notebook_instance_lifecycle_configs(
        ...
        *,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        sort_by: shapes.NotebookInstanceLifecycleConfigSortKey = autoboto.
        ShapeBase._NOT_SET,
        sort_order: shapes.NotebookInstanceLifecycleConfigSortOrder = autoboto.
        ShapeBase._NOT_SET,
        name_contains: str = autoboto.ShapeBase._NOT_SET,
        creation_time_before: datetime.datetime = autoboto.ShapeBase._NOT_SET,
        creation_time_after: datetime.datetime = autoboto.ShapeBase._NOT_SET,
    ...
    def list_notebook_instances(
        ...
        *,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        sort_by: shapes.NotebookInstanceSortKey = autoboto.ShapeBase._NOT_SET,
        sort_order: shapes.NotebookInstanceSortOrder = autoboto.ShapeBase.
        _NOT_SET,
        name_contains: str = autoboto.ShapeBase._NOT_SET,
        creation_time_before: datetime.datetime = autoboto.ShapeBase._NOT_SET,
        creation_time_after: datetime.datetime = autoboto.ShapeBase._NOT_SET,
        ...
        last_modified_time_after: datetime.datetime = autoboto.ShapeBase.
        _NOT_SET,
        status_equals: shapes.NotebookInstanceStatus = autoboto.ShapeBase.
        _NOT_SET,
        notebook_instance_lifecycle_config_name_contains: str = autoboto.
        ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if status_equals is not autoboto.ShapeBase._NOT_SET:
                _params['status_equals'] = status_equals
            if notebook_instance_lifecycle_config_name_contains is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_training_jobs(
        ...
        *,
        ...
        _NOT_SET,
        name_contains: str = autoboto.ShapeBase._NOT_SET,
        status_equals: shapes.TrainingJobStatus = autoboto.ShapeBase._NOT_SET,
        sort_by: shapes.SortBy = autoboto.ShapeBase._NOT_SET,
        sort_order: shapes.SortOrder = autoboto.ShapeBase._NOT_SET,
    ...
    def list_training_jobs_for_hyper_parameter_tuning_job(
        ...
        *,
        ...
        max_results: int = autoboto.ShapeBase._NOT_SET,
        status_equals: shapes.TrainingJobStatus = autoboto.ShapeBase._NOT_SET,
        sort_by: shapes.TrainingJobSortByOptions = autoboto.ShapeBase._NOT_SET,
        sort_order: shapes.SortOrder = autoboto.ShapeBase._NOT_SET,
    ...
    def list_transform_jobs(
        ...
        *,
        ...
        _NOT_SET,
        name_contains: str = autoboto.ShapeBase._NOT_SET,
        status_equals: shapes.TransformJobStatus = autoboto.ShapeBase._NOT_SET,
        sort_by: shapes.SortBy = autoboto.ShapeBase._NOT_SET,
        sort_order: shapes.SortOrder = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
    ...
    def update_endpoint_weights_and_capacities(
        ...
        *,
        ...
        if _request is None:
            ...
            if endpoint_name is not autoboto.ShapeBase._NOT_SET:
                _params['endpoint_name'] = endpoint_name
            if desired_weights_and_capacities is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_notebook_instance(
        ...
        *,
        ...
        lifecycle_config_name: str = autoboto.ShapeBase._NOT_SET,
        disassociate_lifecycle_config: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if lifecycle_config_name is not autoboto.ShapeBase._NOT_SET:
                _params['lifecycle_config_name'] = lifecycle_config_name
            if disassociate_lifecycle_config is not autoboto.ShapeBase._NOT_SET:
