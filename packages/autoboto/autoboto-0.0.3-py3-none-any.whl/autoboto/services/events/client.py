...
class Client:
    ...
    def enable_rule(
        ...
        *,
        ...
        a newly enabled rule. Please allow a short period of time for changes to take
        effect.
        """
        if _request is None:
            _params = {}
    ...
    def list_rules(
        ...
        *,
        name_prefix: str = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        limit: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if name_prefix is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_rule(
        ...
        *,
        ...
        event_pattern: str = autoboto.ShapeBase._NOT_SET,
        state: shapes.RuleState = autoboto.ShapeBase._NOT_SET,
        ...
        If you are updating an existing rule, the rule is completely replaced with what
        you specify in this `PutRule` command. If you omit arguments in `PutRule`, the
        old values for those arguments are not kept. Instead, they are replaced with
        null values.
        ...
        if _request is None:
            ...
            if event_pattern is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_targets(
        ...
        *,
        ...
        instances, Amazon Kinesis streams, and AWS Step Functions state machines,
        ...
        `Arn` when you run `PutTargets`. If your account sends events to another
        account, your account is charged for each sent event. Each event sent to antoher
        account is charged as a custom event. The account receiving the event is not
        charged. For more information on pricing, see [Amazon CloudWatch
        ...
        **Input** , **InputPath** and **InputTransformer** are mutually exclusive and
        ...
        or updated targets might not be immediately invoked. Please allow a short period
    ...
    def remove_targets(
        ...
        *,
        ...
        might continue to be invoked. Please allow a short period of time for changes to
        take effect.
    ...
    def test_event_pattern(
        ...
        *,
        ...
        if _request is None:
            ...
            if event_pattern is not autoboto.ShapeBase._NOT_SET:
                _params['event_pattern'] = event_pattern
            if event is not autoboto.ShapeBase._NOT_SET:
                _params['event'] = event
