...
class AssumeRoleRequest(autoboto.ShapeBase):
    ...
    token_code: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )


@dataclasses.dataclass
class AssumeRoleResponse(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class AssumeRoleWithSAMLResponse(autoboto.ShapeBase):
    """
    ...
    audience: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
@dataclasses.dataclass
class AssumeRoleWithWebIdentityResponse(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class DecodeAuthorizationMessageResponse(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class GetCallerIdentityResponse(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class GetSessionTokenResponse(autoboto.ShapeBase):
    """
