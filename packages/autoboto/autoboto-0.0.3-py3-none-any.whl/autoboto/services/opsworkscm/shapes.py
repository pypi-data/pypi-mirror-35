...
class AssociateNodeRequest(autoboto.ShapeBase):
    ...
    node_name: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
@dataclasses.dataclass
class AssociateNodeResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
class Backup(autoboto.ShapeBase):
    ...
    backup_id: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    # created.
    engine_model: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    key_pair: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    s3_data_size: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # This field is deprecated and is no longer used.
    s3_data_url: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # The Amazon S3 URL of the backup's log file.
    s3_log_url: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    tools_version: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
@dataclasses.dataclass
class CreateBackupResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class CreateServerResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DeleteBackupResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return []
...
@dataclasses.dataclass
class DeleteServerResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return []
...
@dataclasses.dataclass
class DescribeBackupsResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DescribeNodeAssociationStatusResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DescribeServersResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DisassociateNodeResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class RestoreServerResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return []
...
class Server(autoboto.ShapeBase):
    ...
    server_arn: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
@dataclasses.dataclass
class StartMaintenanceResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class UpdateServerEngineAttributesResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class UpdateServerResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
