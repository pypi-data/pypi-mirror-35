...
class AttemptDetail(autoboto.ShapeBase):
    ...
    # `RUNNING` state).
    started_at: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # The Unix time stamp (in seconds and milliseconds) for when the attempt was
    # stopped (when the attempt transitioned from the `RUNNING` state to a
    # terminal state, such as `SUCCEEDED` or `FAILED`).
    stopped_at: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class ComputeEnvironmentDetail(autoboto.ShapeBase):
    ...
    type: "CEType" = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    # jobs.
    state: "CEState" = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # The current status of the compute environment (for example, `CREATING` or
    # `VALID`).
    status: "CEStatus" = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
class ComputeResource(autoboto.ShapeBase):
    ...
    type: "CRType" = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # The minimum number of EC2 vCPUs that an environment should maintain.
    minv_cpus: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # The maximum number of EC2 vCPUs that an environment can reach.
    maxv_cpus: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    instance_role: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )

    # The desired number of EC2 vCPUS in the compute environment.
    desiredv_cpus: int = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
    ...
    # environment.
    ec2_key_pair: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class ContainerDetail(autoboto.ShapeBase):
    ...
    vcpus: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    job_role_arn: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class CreateJobQueueRequest(autoboto.ShapeBase):
    ...
    # to accept jobs.
    state: "JQState" = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class CreateJobQueueResponse(autoboto.ShapeBase):
    ...
    job_queue_arn: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
class DeleteJobQueueRequest(autoboto.ShapeBase):
    ...
    job_queue: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class JobDetail(autoboto.ShapeBase):
    ...
    created_at: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class JobQueueDetail(autoboto.ShapeBase):
    ...
    status: "JQStatus" = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
class ListJobsRequest(autoboto.ShapeBase):
    ...
    array_job_id: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
