...
class Client:
    ...
    def apply_security_groups_to_load_balancer(
        ...
        *,
        ...
        security-groups.html#elb-vpc-security-groups) in the _Classic Load Balancer
        Guide_.
        """
        if _request is None:
            _params = {}
    ...
    def attach_load_balancer_to_subnets(
        ...
        *,
        ...
        subnets.html) in the _Classic Load Balancer Guide_.
        """
        if _request is None:
            _params = {}
            if load_balancer_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def configure_health_check(
        ...
        *,
        ...
        healthchecks.html) in the _Classic Load Balancer Guide_.
        """
        if _request is None:
            _params = {}
            if load_balancer_name is not autoboto.ShapeBase._NOT_SET:
                _params['load_balancer_name'] = load_balancer_name
            if health_check is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_app_cookie_stickiness_policy(
        ...
        *,
        ...
        if _request is None:
            ...
            if cookie_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_lb_cookie_stickiness_policy(
        ...
        *,
        load_balancer_name: str,
        policy_name: str,
        cookie_expiration_period: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if policy_name is not autoboto.ShapeBase._NOT_SET:
                _params['policy_name'] = policy_name
            if cookie_expiration_period is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_load_balancer(
        ...
        *,
        ...
        scheme: str = autoboto.ShapeBase._NOT_SET,
        ...
        Balancer](http://docs.aws.amazon.com/elasticloadbalancing/latest/classic/elb-
        limits.html) in the _Classic Load Balancer Guide_.
        """
        if _request is None:
            _params = {}
            if load_balancer_name is not autoboto.ShapeBase._NOT_SET:
                _params['load_balancer_name'] = load_balancer_name
            if listeners is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_load_balancer_policy(
        ...
        *,
        ...
        if _request is None:
            ...
            if policy_name is not autoboto.ShapeBase._NOT_SET:
                _params['policy_name'] = policy_name
            if policy_type_name is not autoboto.ShapeBase._NOT_SET:
                _params['policy_type_name'] = policy_type_name
            if policy_attributes is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_load_balancer_listeners(
        ...
        *,
        ...
        if _request is None:
            ...
            if load_balancer_name is not autoboto.ShapeBase._NOT_SET:
                _params['load_balancer_name'] = load_balancer_name
            if load_balancer_ports is not autoboto.ShapeBase._NOT_SET:
    ...
    def deregister_instances_from_load_balancer(
        ...
        *,
        ...
        deregister-register-instances.html) in the _Classic Load Balancer Guide_.
        """
        if _request is None:
            _params = {}
            if load_balancer_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_instance_health(
        ...
        *,
        load_balancer_name: str,
        instances: typing.List[shapes.Instance] = autoboto.ShapeBase._NOT_SET,
    ...
    def describe_load_balancer_policies(
        ...
        *,
        load_balancer_name: str = autoboto.ShapeBase._NOT_SET,
    ...
    def describe_load_balancer_policy_types(
        ...
        *,
        policy_type_names: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if policy_type_names is not autoboto.ShapeBase._NOT_SET:
    ...
    def disable_availability_zones_for_load_balancer(
        ...
        *,
        ...
        disable-az.html) in the _Classic Load Balancer Guide_.
        """
        if _request is None:
            _params = {}
            if load_balancer_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def modify_load_balancer_attributes(
        ...
        *,
        ...
        For more information, see the following in the _Classic Load Balancer Guide_ :
        ...
        if _request is None:
            ...
            if load_balancer_name is not autoboto.ShapeBase._NOT_SET:
                _params['load_balancer_name'] = load_balancer_name
            if load_balancer_attributes is not autoboto.ShapeBase._NOT_SET:
    ...
    def set_load_balancer_listener_ssl_certificate(
        ...
        *,
        ...
        Balancer](http://docs.aws.amazon.com/elasticloadbalancing/latest/classic/elb-
        update-ssl-cert.html) in the _Classic Load Balancer Guide_.
        """
        if _request is None:
            _params = {}
            if load_balancer_name is not autoboto.ShapeBase._NOT_SET:
                _params['load_balancer_name'] = load_balancer_name
            if load_balancer_port is not autoboto.ShapeBase._NOT_SET:
                _params['load_balancer_port'] = load_balancer_port
            if ssl_certificate_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def set_load_balancer_policies_for_backend_server(
        ...
        *,
        ...
        Load Balancer Guide_. For more information about Proxy Protocol, see [Configure
        Proxy Protocol
        Support](http://docs.aws.amazon.com/elasticloadbalancing/latest/classic/enable-
        proxy-protocol.html) in the _Classic Load Balancer Guide_.
        """
        if _request is None:
            _params = {}
            if load_balancer_name is not autoboto.ShapeBase._NOT_SET:
