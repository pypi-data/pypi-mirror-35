...
class Client:
    ...
    def list_records(
        ...
        *,
        ...
        identity_id: str,
        dataset_name: str,
        last_sync_count: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        sync_session_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if dataset_name is not autoboto.ShapeBase._NOT_SET:
                _params['dataset_name'] = dataset_name
            if last_sync_count is not autoboto.ShapeBase._NOT_SET:
                _params['last_sync_count'] = last_sync_count
            if next_token is not autoboto.ShapeBase._NOT_SET:
                _params['next_token'] = next_token
            if max_results is not autoboto.ShapeBase._NOT_SET:
                _params['max_results'] = max_results
            if sync_session_token is not autoboto.ShapeBase._NOT_SET:
    ...
    def set_cognito_events(
        ...
        *,
        ...
        if _request is None:
            ...
            if identity_pool_id is not autoboto.ShapeBase._NOT_SET:
                _params['identity_pool_id'] = identity_pool_id
            if events is not autoboto.ShapeBase._NOT_SET:
    ...
    def set_identity_pool_configuration(
        ...
        *,
        identity_pool_id: str,
        push_sync: shapes.PushSync = autoboto.ShapeBase._NOT_SET,
        cognito_streams: shapes.CognitoStreams = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if identity_pool_id is not autoboto.ShapeBase._NOT_SET:
                _params['identity_pool_id'] = identity_pool_id
            if push_sync is not autoboto.ShapeBase._NOT_SET:
                _params['push_sync'] = push_sync
            if cognito_streams is not autoboto.ShapeBase._NOT_SET:
    ...
    def subscribe_to_dataset(
        ...
        *,
        ...
        if _request is None:
            ...
            if dataset_name is not autoboto.ShapeBase._NOT_SET:
                _params['dataset_name'] = dataset_name
            if device_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_records(
        ...
        *,
        ...
        device_id: str = autoboto.ShapeBase._NOT_SET,
        record_patches: typing.List[shapes.RecordPatch
        ...
        if _request is None:
            ...
            if device_id is not autoboto.ShapeBase._NOT_SET:
                _params['device_id'] = device_id
            if record_patches is not autoboto.ShapeBase._NOT_SET:
