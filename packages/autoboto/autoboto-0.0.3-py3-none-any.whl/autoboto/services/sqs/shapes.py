...
class CreateQueueRequest(autoboto.ShapeBase):
    ...
    queue_name: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class Message(autoboto.ShapeBase):
    ...
    md5_of_body: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class SendMessageBatchRequestEntry(autoboto.ShapeBase):
    ...
    delay_seconds: int = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
