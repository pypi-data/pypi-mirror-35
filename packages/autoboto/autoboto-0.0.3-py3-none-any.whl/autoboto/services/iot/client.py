...
class Client:
    ...
    def accept_certificate_transfer(
        ...
        *,
        certificate_id: str,
        set_as_active: bool = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            _params = {}
            if certificate_id is not autoboto.ShapeBase._NOT_SET:
                _params['certificate_id'] = certificate_id
            if set_as_active is not autoboto.ShapeBase._NOT_SET:
    ...
    def add_thing_to_thing_group(
        ...
        *,
        thing_group_name: str = autoboto.ShapeBase._NOT_SET,
        thing_group_arn: str = autoboto.ShapeBase._NOT_SET,
        thing_name: str = autoboto.ShapeBase._NOT_SET,
        thing_arn: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if thing_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['thing_group_name'] = thing_group_name
            if thing_group_arn is not autoboto.ShapeBase._NOT_SET:
                _params['thing_group_arn'] = thing_group_arn
            if thing_name is not autoboto.ShapeBase._NOT_SET:
                _params['thing_name'] = thing_name
            if thing_arn is not autoboto.ShapeBase._NOT_SET:
    ...
    def associate_targets_with_job(
        ...
        *,
        ...
        job_id: str,
        comment: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if targets is not autoboto.ShapeBase._NOT_SET:
                _params['targets'] = targets
            if job_id is not autoboto.ShapeBase._NOT_SET:
                _params['job_id'] = job_id
            if comment is not autoboto.ShapeBase._NOT_SET:
    ...
    def attach_policy(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if policy_name is not autoboto.ShapeBase._NOT_SET:
                _params['policy_name'] = policy_name
            if target is not autoboto.ShapeBase._NOT_SET:
    ...
    def attach_principal_policy(
        ...
        **Note:** This API is deprecated. Please use AttachPolicy instead.
        ...
        if _request is None:
            ...
            if policy_name is not autoboto.ShapeBase._NOT_SET:
                _params['policy_name'] = policy_name
            if principal is not autoboto.ShapeBase._NOT_SET:
    ...
    def attach_security_profile(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if security_profile_name is not autoboto.ShapeBase._NOT_SET:
                _params['security_profile_name'] = security_profile_name
            if security_profile_target_arn is not autoboto.ShapeBase._NOT_SET:
    ...
    def cancel_audit_task(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if task_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def cancel_job_execution(
        ...
        *,
        ...
        thing_name: str,
        force: bool = autoboto.ShapeBase._NOT_SET,
        expected_version: int = autoboto.ShapeBase._NOT_SET,
        status_details: typing.Dict[str, str] = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            ...
            if force is not autoboto.ShapeBase._NOT_SET:
                _params['force'] = force
            if expected_version is not autoboto.ShapeBase._NOT_SET:
                _params['expected_version'] = expected_version
            if status_details is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_authorizer(
        ...
        *,
        ...
        status: shapes.AuthorizerStatus = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if authorizer_name is not autoboto.ShapeBase._NOT_SET:
                _params['authorizer_name'] = authorizer_name
            if authorizer_function_arn is not autoboto.ShapeBase._NOT_SET:
                _params['authorizer_function_arn'] = authorizer_function_arn
            if token_key_name is not autoboto.ShapeBase._NOT_SET:
                _params['token_key_name'] = token_key_name
            if token_signing_public_keys is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_certificate_from_csr(
        ...
        **Note:** Reusing the same certificate signing request (CSR) results in a
        ...
        if _request is None:
            _params = {}
            if certificate_signing_request is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_job(
        ...
        *,
        job_id: str,
        targets: typing.List[str],
        document_source: str = autoboto.ShapeBase._NOT_SET,
        document: str = autoboto.ShapeBase._NOT_SET,
        description: str = autoboto.ShapeBase._NOT_SET,
        presigned_url_config: shapes.PresignedUrlConfig = autoboto.ShapeBase.
        _NOT_SET,
        target_selection: shapes.TargetSelection = autoboto.ShapeBase._NOT_SET,
        job_executions_rollout_config: shapes.
        JobExecutionsRolloutConfig = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if targets is not autoboto.ShapeBase._NOT_SET:
                _params['targets'] = targets
            if document_source is not autoboto.ShapeBase._NOT_SET:
                _params['document_source'] = document_source
            if document is not autoboto.ShapeBase._NOT_SET:
                _params['document'] = document
            if description is not autoboto.ShapeBase._NOT_SET:
                _params['description'] = description
            if presigned_url_config is not autoboto.ShapeBase._NOT_SET:
                _params['presigned_url_config'] = presigned_url_config
            if target_selection is not autoboto.ShapeBase._NOT_SET:
                _params['target_selection'] = target_selection
            if job_executions_rollout_config is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_ota_update(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if ota_update_id is not autoboto.ShapeBase._NOT_SET:
                _params['ota_update_id'] = ota_update_id
            if targets is not autoboto.ShapeBase._NOT_SET:
                _params['targets'] = targets
            if files is not autoboto.ShapeBase._NOT_SET:
                _params['files'] = files
            ...
            if target_selection is not autoboto.ShapeBase._NOT_SET:
                _params['target_selection'] = target_selection
            if additional_parameters is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_policy_version(
        ...
        *,
        policy_name: str,
        policy_document: str,
        set_as_default: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if policy_document is not autoboto.ShapeBase._NOT_SET:
                _params['policy_document'] = policy_document
            if set_as_default is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_role_alias(
        ...
        *,
        role_alias: str,
        role_arn: str,
        credential_duration_seconds: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if role_alias is not autoboto.ShapeBase._NOT_SET:
                _params['role_alias'] = role_alias
            if role_arn is not autoboto.ShapeBase._NOT_SET:
                _params['role_arn'] = role_arn
            if credential_duration_seconds is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_scheduled_audit(
        ...
        *,
        ...
        day_of_month: str = autoboto.ShapeBase._NOT_SET,
        day_of_week: shapes.DayOfWeek = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if frequency is not autoboto.ShapeBase._NOT_SET:
                _params['frequency'] = frequency
            if target_check_names is not autoboto.ShapeBase._NOT_SET:
                _params['target_check_names'] = target_check_names
            if scheduled_audit_name is not autoboto.ShapeBase._NOT_SET:
                _params['scheduled_audit_name'] = scheduled_audit_name
            if day_of_month is not autoboto.ShapeBase._NOT_SET:
                _params['day_of_month'] = day_of_month
            if day_of_week is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_security_profile(
        ...
        *,
        ...
        security_profile_description: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if security_profile_name is not autoboto.ShapeBase._NOT_SET:
                _params['security_profile_name'] = security_profile_name
            if behaviors is not autoboto.ShapeBase._NOT_SET:
                _params['behaviors'] = behaviors
            if security_profile_description is not autoboto.ShapeBase._NOT_SET:
                _params['security_profile_description'
                       ] = security_profile_description
            if alert_targets is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_stream(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if stream_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_thing(
        ...
        *,
        thing_name: str,
        thing_type_name: str = autoboto.ShapeBase._NOT_SET,
        attribute_payload: shapes.AttributePayload = autoboto.ShapeBase.
        _NOT_SET,
        ...
        if _request is None:
            ...
            if thing_name is not autoboto.ShapeBase._NOT_SET:
                _params['thing_name'] = thing_name
            if thing_type_name is not autoboto.ShapeBase._NOT_SET:
                _params['thing_type_name'] = thing_type_name
            if attribute_payload is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_thing_group(
        ...
        *,
        ...
        parent_group_name: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if thing_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['thing_group_name'] = thing_group_name
            if parent_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['parent_group_name'] = parent_group_name
            if thing_group_properties is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_thing_type(
        ...
        *,
        ...
        if _request is None:
            ...
            if thing_type_name is not autoboto.ShapeBase._NOT_SET:
                _params['thing_type_name'] = thing_type_name
            if thing_type_properties is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_topic_rule(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if rule_name is not autoboto.ShapeBase._NOT_SET:
                _params['rule_name'] = rule_name
            if topic_rule_payload is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_account_audit_configuration(
        ...
        *,
        delete_scheduled_audits: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if delete_scheduled_audits is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_certificate(
        ...
        *,
        certificate_id: str,
        force_delete: bool = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            ...
            if certificate_id is not autoboto.ShapeBase._NOT_SET:
                _params['certificate_id'] = certificate_id
            if force_delete is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_job_execution(
        ...
        *,
        ...
        if _request is None:
            ...
            if thing_name is not autoboto.ShapeBase._NOT_SET:
                _params['thing_name'] = thing_name
            if execution_number is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_policy_version(
        ...
        *,
        ...
        if _request is None:
            ...
            if policy_name is not autoboto.ShapeBase._NOT_SET:
                _params['policy_name'] = policy_name
            if policy_version_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_v2_logging_level(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if target_type is not autoboto.ShapeBase._NOT_SET:
                _params['target_type'] = target_type
            if target_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def deprecate_thing_type(
        ...
        *,
        thing_type_name: str,
        undo_deprecate: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if thing_type_name is not autoboto.ShapeBase._NOT_SET:
                _params['thing_type_name'] = thing_type_name
            if undo_deprecate is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_endpoint(
        ...
        *,
        endpoint_type: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if endpoint_type is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_index(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if index_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_job_execution(
        ...
        *,
        job_id: str,
        thing_name: str,
        execution_number: int = autoboto.ShapeBase._NOT_SET,
    ...
    def get_effective_policies(
        ...
        *,
        principal: str = autoboto.ShapeBase._NOT_SET,
        cognito_identity_pool_id: str = autoboto.ShapeBase._NOT_SET,
        thing_name: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if principal is not autoboto.ShapeBase._NOT_SET:
                _params['principal'] = principal
            if cognito_identity_pool_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_active_violations(
        ...
        *,
        thing_name: str = autoboto.ShapeBase._NOT_SET,
        security_profile_name: str = autoboto.ShapeBase._NOT_SET,
    ...
    def list_attached_policies(
        ...
        *,
        target: str,
        recursive: bool = autoboto.ShapeBase._NOT_SET,
        marker: str = autoboto.ShapeBase._NOT_SET,
        page_size: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if target is not autoboto.ShapeBase._NOT_SET:
                _params['target'] = target
            if recursive is not autoboto.ShapeBase._NOT_SET:
                _params['recursive'] = recursive
            if marker is not autoboto.ShapeBase._NOT_SET:
                _params['marker'] = marker
            if page_size is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_audit_findings(
        ...
        *,
        task_id: str = autoboto.ShapeBase._NOT_SET,
        check_name: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if task_id is not autoboto.ShapeBase._NOT_SET:
                _params['task_id'] = task_id
            if check_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_audit_tasks(
        ...
        *,
        ...
        task_type: shapes.AuditTaskType = autoboto.ShapeBase._NOT_SET,
        task_status: shapes.AuditTaskStatus = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if end_time is not autoboto.ShapeBase._NOT_SET:
                _params['end_time'] = end_time
            if task_type is not autoboto.ShapeBase._NOT_SET:
                _params['task_type'] = task_type
            if task_status is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_authorizers(
        ...
        *,
        page_size: int = autoboto.ShapeBase._NOT_SET,
        marker: str = autoboto.ShapeBase._NOT_SET,
        ascending_order: bool = autoboto.ShapeBase._NOT_SET,
        status: shapes.AuthorizerStatus = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if marker is not autoboto.ShapeBase._NOT_SET:
                _params['marker'] = marker
            if ascending_order is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_certificates_by_ca(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if ca_certificate_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_job_executions_for_job(
        ...
        *,
        job_id: str,
        status: shapes.JobExecutionStatus = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
    ...
    def list_jobs(
        ...
        *,
        status: shapes.JobStatus = autoboto.ShapeBase._NOT_SET,
        target_selection: shapes.TargetSelection = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        thing_group_name: str = autoboto.ShapeBase._NOT_SET,
        thing_group_id: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if thing_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['thing_group_name'] = thing_group_name
            if thing_group_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_ota_updates(
        ...
        *,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        ota_update_status: shapes.OTAUpdateStatus = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if next_token is not autoboto.ShapeBase._NOT_SET:
                _params['next_token'] = next_token
            if ota_update_status is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_thing_groups(
        ...
        *,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        parent_group: str = autoboto.ShapeBase._NOT_SET,
        name_prefix_filter: str = autoboto.ShapeBase._NOT_SET,
        recursive: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if max_results is not autoboto.ShapeBase._NOT_SET:
                _params['max_results'] = max_results
            if parent_group is not autoboto.ShapeBase._NOT_SET:
                _params['parent_group'] = parent_group
            if name_prefix_filter is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_thing_registration_task_reports(
        ...
        *,
        ...
        if _request is None:
            ...
            if task_id is not autoboto.ShapeBase._NOT_SET:
                _params['task_id'] = task_id
            if report_type is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_thing_registration_tasks(
        ...
        *,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        status: shapes.Status = autoboto.ShapeBase._NOT_SET,
    ...
    def list_things(
        ...
        *,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        attribute_name: str = autoboto.ShapeBase._NOT_SET,
        attribute_value: str = autoboto.ShapeBase._NOT_SET,
        thing_type_name: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if attribute_value is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_topic_rules(
        ...
        *,
        topic: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        rule_disabled: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if topic is not autoboto.ShapeBase._NOT_SET:
                _params['topic'] = topic
            if max_results is not autoboto.ShapeBase._NOT_SET:
                _params['max_results'] = max_results
            if next_token is not autoboto.ShapeBase._NOT_SET:
                _params['next_token'] = next_token
            if rule_disabled is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_v2_logging_levels(
        ...
        *,
        target_type: shapes.LogTargetType = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
    ...
    def register_ca_certificate(
        ...
        *,
        ...
        set_as_active: bool = autoboto.ShapeBase._NOT_SET,
        allow_auto_registration: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if ca_certificate is not autoboto.ShapeBase._NOT_SET:
                _params['ca_certificate'] = ca_certificate
            if verification_certificate is not autoboto.ShapeBase._NOT_SET:
                _params['verification_certificate'] = verification_certificate
            if set_as_active is not autoboto.ShapeBase._NOT_SET:
                _params['set_as_active'] = set_as_active
            if allow_auto_registration is not autoboto.ShapeBase._NOT_SET:
                _params['allow_auto_registration'] = allow_auto_registration
            if registration_config is not autoboto.ShapeBase._NOT_SET:
    ...
    def register_certificate(
        ...
        *,
        certificate_pem: str,
        ca_certificate_pem: str = autoboto.ShapeBase._NOT_SET,
        set_as_active: bool = autoboto.ShapeBase._NOT_SET,
        status: shapes.CertificateStatus = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if certificate_pem is not autoboto.ShapeBase._NOT_SET:
                _params['certificate_pem'] = certificate_pem
            if ca_certificate_pem is not autoboto.ShapeBase._NOT_SET:
    ...
    def register_thing(
        ...
        *,
        template_body: str,
        parameters: typing.Dict[str, str] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if template_body is not autoboto.ShapeBase._NOT_SET:
    ...
    def reject_certificate_transfer(
        ...
        *,
        certificate_id: str,
        reject_reason: str = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        **INACTIVE**.
        ...
        if _request is None:
            ...
            if certificate_id is not autoboto.ShapeBase._NOT_SET:
                _params['certificate_id'] = certificate_id
            if reject_reason is not autoboto.ShapeBase._NOT_SET:
    ...
    def search_index(
        ...
        *,
        query_string: str,
        index_name: str = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        query_version: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if query_string is not autoboto.ShapeBase._NOT_SET:
            ...
            if max_results is not autoboto.ShapeBase._NOT_SET:
                _params['max_results'] = max_results
            if query_version is not autoboto.ShapeBase._NOT_SET:
    ...
    def set_logging_options(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if logging_options_payload is not autoboto.ShapeBase._NOT_SET:
    ...
    def set_v2_logging_level(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if log_target is not autoboto.ShapeBase._NOT_SET:
                _params['log_target'] = log_target
            if log_level is not autoboto.ShapeBase._NOT_SET:
    ...
    def set_v2_logging_options(
        ...
        *,
        role_arn: str = autoboto.ShapeBase._NOT_SET,
        default_log_level: shapes.LogLevel = autoboto.ShapeBase._NOT_SET,
        disable_all_logs: bool = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            ...
            if role_arn is not autoboto.ShapeBase._NOT_SET:
                _params['role_arn'] = role_arn
            if default_log_level is not autoboto.ShapeBase._NOT_SET:
                _params['default_log_level'] = default_log_level
            if disable_all_logs is not autoboto.ShapeBase._NOT_SET:
    ...
    def start_thing_registration_task(
        ...
        *,
        ...
        if _request is None:
            ...
            if template_body is not autoboto.ShapeBase._NOT_SET:
                _params['template_body'] = template_body
            if input_file_bucket is not autoboto.ShapeBase._NOT_SET:
                _params['input_file_bucket'] = input_file_bucket
            if input_file_key is not autoboto.ShapeBase._NOT_SET:
    ...
    def test_authorization(
        ...
        *,
        ...
        principal: str = autoboto.ShapeBase._NOT_SET,
        cognito_identity_pool_id: str = autoboto.ShapeBase._NOT_SET,
        client_id: str = autoboto.ShapeBase._NOT_SET,
        policy_names_to_add: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        policy_names_to_skip: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if auth_infos is not autoboto.ShapeBase._NOT_SET:
                _params['auth_infos'] = auth_infos
            if principal is not autoboto.ShapeBase._NOT_SET:
                _params['principal'] = principal
            if cognito_identity_pool_id is not autoboto.ShapeBase._NOT_SET:
                _params['cognito_identity_pool_id'] = cognito_identity_pool_id
            if client_id is not autoboto.ShapeBase._NOT_SET:
                _params['client_id'] = client_id
            if policy_names_to_add is not autoboto.ShapeBase._NOT_SET:
                _params['policy_names_to_add'] = policy_names_to_add
            if policy_names_to_skip is not autoboto.ShapeBase._NOT_SET:
    ...
    def test_invoke_authorizer(
        ...
        *,
        ...
        if _request is None:
            ...
            if authorizer_name is not autoboto.ShapeBase._NOT_SET:
                _params['authorizer_name'] = authorizer_name
            if token is not autoboto.ShapeBase._NOT_SET:
                _params['token'] = token
            if token_signature is not autoboto.ShapeBase._NOT_SET:
    ...
    def transfer_certificate(
        ...
        *,
        ...
        transfer_message: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if certificate_id is not autoboto.ShapeBase._NOT_SET:
                _params['certificate_id'] = certificate_id
            if target_aws_account is not autoboto.ShapeBase._NOT_SET:
                _params['target_aws_account'] = target_aws_account
            if transfer_message is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_account_audit_configuration(
        ...
        *,
        ...
        Dict[str, shapes.AuditCheckConfiguration] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if role_arn is not autoboto.ShapeBase._NOT_SET:
                _params['role_arn'] = role_arn
            if audit_notification_target_configurations is not autoboto.ShapeBase._NOT_SET:
                _params['audit_notification_target_configurations'
                       ] = audit_notification_target_configurations
            if audit_check_configurations is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_authorizer(
        ...
        *,
        authorizer_name: str,
        authorizer_function_arn: str = autoboto.ShapeBase._NOT_SET,
        token_key_name: str = autoboto.ShapeBase._NOT_SET,
        token_signing_public_keys: typing.Dict[str, str
                                              ] = autoboto.ShapeBase._NOT_SET,
        status: shapes.AuthorizerStatus = autoboto.ShapeBase._NOT_SET,
    ...
    def update_ca_certificate(
        ...
        *,
        certificate_id: str,
        new_status: shapes.CACertificateStatus = autoboto.ShapeBase._NOT_SET,
        new_auto_registration_status: shapes.AutoRegistrationStatus = autoboto.
        ShapeBase._NOT_SET,
        registration_config: shapes.RegistrationConfig = autoboto.ShapeBase.
        _NOT_SET,
        remove_auto_registration: bool = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            ...
            if certificate_id is not autoboto.ShapeBase._NOT_SET:
                _params['certificate_id'] = certificate_id
            if new_status is not autoboto.ShapeBase._NOT_SET:
                _params['new_status'] = new_status
            if new_auto_registration_status is not autoboto.ShapeBase._NOT_SET:
                _params['new_auto_registration_status'
                       ] = new_auto_registration_status
            if registration_config is not autoboto.ShapeBase._NOT_SET:
                _params['registration_config'] = registration_config
            if remove_auto_registration is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_event_configurations(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if event_configurations is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_indexing_configuration(
        ...
        *,
        ...
        ThingIndexingConfiguration = autoboto.ShapeBase._NOT_SET,
        thing_group_indexing_configuration: shapes.
        ThingGroupIndexingConfiguration = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if thing_indexing_configuration is not autoboto.ShapeBase._NOT_SET:
                _params['thing_indexing_configuration'
                       ] = thing_indexing_configuration
            if thing_group_indexing_configuration is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_scheduled_audit(
        ...
        *,
        scheduled_audit_name: str,
        frequency: shapes.AuditFrequency = autoboto.ShapeBase._NOT_SET,
        day_of_month: str = autoboto.ShapeBase._NOT_SET,
        day_of_week: shapes.DayOfWeek = autoboto.ShapeBase._NOT_SET,
        target_check_names: typing.List[str] = autoboto.ShapeBase._NOT_SET,
    ...
    def update_security_profile(
        ...
        *,
        security_profile_name: str,
        security_profile_description: str = autoboto.ShapeBase._NOT_SET,
        behaviors: typing.List[shapes.Behavior] = autoboto.ShapeBase._NOT_SET,
        alert_targets: typing.Dict[shapes.AlertTargetType, shapes.AlertTarget
                                  ] = autoboto.ShapeBase._NOT_SET,
        expected_version: int = autoboto.ShapeBase._NOT_SET,
    ...
    def update_stream(
        ...
        *,
        stream_id: str,
        description: str = autoboto.ShapeBase._NOT_SET,
        files: typing.List[shapes.StreamFile] = autoboto.ShapeBase._NOT_SET,
        role_arn: str = autoboto.ShapeBase._NOT_SET,
    ...
    def update_thing(
        ...
        *,
        ...
        _NOT_SET,
        expected_version: int = autoboto.ShapeBase._NOT_SET,
        remove_thing_type: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if expected_version is not autoboto.ShapeBase._NOT_SET:
                _params['expected_version'] = expected_version
            if remove_thing_type is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_thing_groups_for_thing(
        ...
        *,
        thing_name: str = autoboto.ShapeBase._NOT_SET,
        thing_groups_to_add: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        thing_groups_to_remove: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if thing_name is not autoboto.ShapeBase._NOT_SET:
                _params['thing_name'] = thing_name
            if thing_groups_to_add is not autoboto.ShapeBase._NOT_SET:
                _params['thing_groups_to_add'] = thing_groups_to_add
            if thing_groups_to_remove is not autoboto.ShapeBase._NOT_SET:
