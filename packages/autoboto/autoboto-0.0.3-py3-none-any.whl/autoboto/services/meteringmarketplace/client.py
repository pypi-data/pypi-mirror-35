...
class Client:
    ...
    def batch_meter_usage(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if usage_records is not autoboto.ShapeBase._NOT_SET:
    ...
    def meter_usage(
        ...
        *,
        ...
        if _request is None:
            ...
            if usage_dimension is not autoboto.ShapeBase._NOT_SET:
                _params['usage_dimension'] = usage_dimension
            if usage_quantity is not autoboto.ShapeBase._NOT_SET:
    ...
    def resolve_customer(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if registration_token is not autoboto.ShapeBase._NOT_SET:
