...
class Client:
    ...
    def clone_receipt_rule_set(
        ...
        *,
        ...
        if _request is None:
            ...
            if original_rule_set_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_configuration_set(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if configuration_set is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_configuration_set_event_destination(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if configuration_set_name is not autoboto.ShapeBase._NOT_SET:
                _params['configuration_set_name'] = configuration_set_name
            if event_destination is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_configuration_set_tracking_options(
        ...
        *,
        ...
        if _request is None:
            ...
            if configuration_set_name is not autoboto.ShapeBase._NOT_SET:
                _params['configuration_set_name'] = configuration_set_name
            if tracking_options is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_custom_verification_email_template(
        ...
        *,
        ...
        if _request is None:
            ...
            if from_email_address is not autoboto.ShapeBase._NOT_SET:
                _params['from_email_address'] = from_email_address
            if template_subject is not autoboto.ShapeBase._NOT_SET:
                _params['template_subject'] = template_subject
            if template_content is not autoboto.ShapeBase._NOT_SET:
                _params['template_content'] = template_content
            if success_redirection_url is not autoboto.ShapeBase._NOT_SET:
                _params['success_redirection_url'] = success_redirection_url
            if failure_redirection_url is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_receipt_rule(
        ...
        *,
        ...
        after: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if rule_set_name is not autoboto.ShapeBase._NOT_SET:
                _params['rule_set_name'] = rule_set_name
            if rule is not autoboto.ShapeBase._NOT_SET:
                _params['rule'] = rule
            if after is not autoboto.ShapeBase._NOT_SET:
                _params['after'] = after
    ...
    def create_template(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if template is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_configuration_set_event_destination(
        ...
        *,
        ...
        if _request is None:
            ...
            if configuration_set_name is not autoboto.ShapeBase._NOT_SET:
                _params['configuration_set_name'] = configuration_set_name
            if event_destination_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_identity(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if identity is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_receipt_filter(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if filter_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_configuration_set(
        ...
        *,
        ...
        if _request is None:
            ...
            if configuration_set_name is not autoboto.ShapeBase._NOT_SET:
                _params['configuration_set_name'] = configuration_set_name
            if configuration_set_attribute_names is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_identity_dkim_attributes(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if identities is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_identities(
        ...
        *,
        identity_type: shapes.IdentityType = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_items: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if identity_type is not autoboto.ShapeBase._NOT_SET:
    ...
    def reorder_receipt_rule_set(
        ...
        *,
        ...
        if _request is None:
            ...
            if rule_set_name is not autoboto.ShapeBase._NOT_SET:
                _params['rule_set_name'] = rule_set_name
            if rule_names is not autoboto.ShapeBase._NOT_SET:
    ...
    def send_bounce(
        ...
        *,
        ...
        explanation: str = autoboto.ShapeBase._NOT_SET,
        message_dsn: shapes.MessageDsn = autoboto.ShapeBase._NOT_SET,
        bounce_sender_arn: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if original_message_id is not autoboto.ShapeBase._NOT_SET:
                _params['original_message_id'] = original_message_id
            if bounce_sender is not autoboto.ShapeBase._NOT_SET:
                _params['bounce_sender'] = bounce_sender
            if bounced_recipient_info_list is not autoboto.ShapeBase._NOT_SET:
                _params['bounced_recipient_info_list'
                       ] = bounced_recipient_info_list
            if explanation is not autoboto.ShapeBase._NOT_SET:
                _params['explanation'] = explanation
            if message_dsn is not autoboto.ShapeBase._NOT_SET:
                _params['message_dsn'] = message_dsn
            if bounce_sender_arn is not autoboto.ShapeBase._NOT_SET:
    ...
    def send_bulk_templated_email(
        ...
        *,
        ...
        source_arn: str = autoboto.ShapeBase._NOT_SET,
        reply_to_addresses: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        return_path: str = autoboto.ShapeBase._NOT_SET,
        return_path_arn: str = autoboto.ShapeBase._NOT_SET,
        configuration_set_name: str = autoboto.ShapeBase._NOT_SET,
        default_tags: typing.List[shapes.MessageTag
                                 ] = autoboto.ShapeBase._NOT_SET,
        template_arn: str = autoboto.ShapeBase._NOT_SET,
        default_template_data: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if source_arn is not autoboto.ShapeBase._NOT_SET:
                _params['source_arn'] = source_arn
            if reply_to_addresses is not autoboto.ShapeBase._NOT_SET:
                _params['reply_to_addresses'] = reply_to_addresses
            if return_path is not autoboto.ShapeBase._NOT_SET:
                _params['return_path'] = return_path
            if return_path_arn is not autoboto.ShapeBase._NOT_SET:
                _params['return_path_arn'] = return_path_arn
            if configuration_set_name is not autoboto.ShapeBase._NOT_SET:
                _params['configuration_set_name'] = configuration_set_name
            if default_tags is not autoboto.ShapeBase._NOT_SET:
                _params['default_tags'] = default_tags
            if template_arn is not autoboto.ShapeBase._NOT_SET:
                _params['template_arn'] = template_arn
            if default_template_data is not autoboto.ShapeBase._NOT_SET:
    ...
    def send_email(
        ...
        *,
        ...
        source_arn: str = autoboto.ShapeBase._NOT_SET,
        return_path_arn: str = autoboto.ShapeBase._NOT_SET,
        tags: typing.List[shapes.MessageTag] = autoboto.ShapeBase._NOT_SET,
        configuration_set_name: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if source is not autoboto.ShapeBase._NOT_SET:
                _params['source'] = source
            if destination is not autoboto.ShapeBase._NOT_SET:
                _params['destination'] = destination
            if message is not autoboto.ShapeBase._NOT_SET:
    ...
    def send_raw_email(
        ...
        *,
        ...
        destinations: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        from_arn: str = autoboto.ShapeBase._NOT_SET,
        source_arn: str = autoboto.ShapeBase._NOT_SET,
        return_path_arn: str = autoboto.ShapeBase._NOT_SET,
        tags: typing.List[shapes.MessageTag] = autoboto.ShapeBase._NOT_SET,
        configuration_set_name: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if raw_message is not autoboto.ShapeBase._NOT_SET:
                _params['raw_message'] = raw_message
            if source is not autoboto.ShapeBase._NOT_SET:
                _params['source'] = source
            if destinations is not autoboto.ShapeBase._NOT_SET:
                _params['destinations'] = destinations
            if from_arn is not autoboto.ShapeBase._NOT_SET:
    ...
    def send_templated_email(
        ...
        *,
        ...
        if _request is None:
            ...
            if template is not autoboto.ShapeBase._NOT_SET:
                _params['template'] = template
            if template_data is not autoboto.ShapeBase._NOT_SET:
    ...
    def set_identity_dkim_enabled(
        ...
        *,
        ...
        if _request is None:
            ...
            if identity is not autoboto.ShapeBase._NOT_SET:
                _params['identity'] = identity
            if dkim_enabled is not autoboto.ShapeBase._NOT_SET:
    ...
    def set_identity_feedback_forwarding_enabled(
        ...
        *,
        ...
        if _request is None:
            ...
            if identity is not autoboto.ShapeBase._NOT_SET:
                _params['identity'] = identity
            if forwarding_enabled is not autoboto.ShapeBase._NOT_SET:
    ...
    def set_identity_headers_in_notifications_enabled(
        ...
        *,
        ...
        if _request is None:
            ...
            if identity is not autoboto.ShapeBase._NOT_SET:
                _params['identity'] = identity
            if notification_type is not autoboto.ShapeBase._NOT_SET:
    ...
    def set_identity_mail_from_domain(
        ...
        *,
        identity: str,
        mail_from_domain: str = autoboto.ShapeBase._NOT_SET,
        behavior_on_mx_failure: shapes.BehaviorOnMXFailure = autoboto.ShapeBase.
        _NOT_SET,
        ...
        if _request is None:
            ...
            if identity is not autoboto.ShapeBase._NOT_SET:
                _params['identity'] = identity
            if mail_from_domain is not autoboto.ShapeBase._NOT_SET:
                _params['mail_from_domain'] = mail_from_domain
            if behavior_on_mx_failure is not autoboto.ShapeBase._NOT_SET:
    ...
    def set_identity_notification_topic(
        ...
        *,
        identity: str,
        notification_type: shapes.NotificationType,
        sns_topic: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if notification_type is not autoboto.ShapeBase._NOT_SET:
                _params['notification_type'] = notification_type
            if sns_topic is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_custom_verification_email_template(
        ...
        *,
        template_name: str,
        from_email_address: str = autoboto.ShapeBase._NOT_SET,
        template_subject: str = autoboto.ShapeBase._NOT_SET,
        template_content: str = autoboto.ShapeBase._NOT_SET,
        success_redirection_url: str = autoboto.ShapeBase._NOT_SET,
        failure_redirection_url: str = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
