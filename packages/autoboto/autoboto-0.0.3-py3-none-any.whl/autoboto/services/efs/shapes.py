...
@dataclasses.dataclass
class DescribeFileSystemsResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DescribeMountTargetSecurityGroupsResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DescribeMountTargetsResponse(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class FileSystemDescription(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class MountTargetDescription(autoboto.ShapeBase):
    """
