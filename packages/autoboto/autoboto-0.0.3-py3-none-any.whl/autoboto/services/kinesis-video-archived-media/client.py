...
class Client:
    ...
    def get_hls_streaming_session_url(
        ...
        *,
        ...
        playback_mode: shapes.PlaybackMode = autoboto.ShapeBase._NOT_SET,
        hls_fragment_selector: shapes.HLSFragmentSelector = autoboto.ShapeBase.
        _NOT_SET,
        discontinuity_mode: shapes.DiscontinuityMode = autoboto.ShapeBase.
        _NOT_SET,
        expires: int = autoboto.ShapeBase._NOT_SET,
        max_media_playlist_fragment_results: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if playback_mode is not autoboto.ShapeBase._NOT_SET:
                _params['playback_mode'] = playback_mode
            if hls_fragment_selector is not autoboto.ShapeBase._NOT_SET:
                _params['hls_fragment_selector'] = hls_fragment_selector
            if discontinuity_mode is not autoboto.ShapeBase._NOT_SET:
                _params['discontinuity_mode'] = discontinuity_mode
            if expires is not autoboto.ShapeBase._NOT_SET:
                _params['expires'] = expires
            if max_media_playlist_fragment_results is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_media_for_fragment_list(
        ...
        *,
        ...
        if _request is None:
            ...
            if stream_name is not autoboto.ShapeBase._NOT_SET:
                _params['stream_name'] = stream_name
            if fragments is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_fragments(
        ...
        *,
        ...
        fragment_selector: shapes.FragmentSelector = autoboto.ShapeBase.
        _NOT_SET,
        ...
        if _request is None:
            ...
            if fragment_selector is not autoboto.ShapeBase._NOT_SET:
