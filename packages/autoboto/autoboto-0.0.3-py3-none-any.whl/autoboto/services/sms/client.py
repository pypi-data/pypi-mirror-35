...
class Client:
    ...
    def create_replication_job(
        ...
        *,
        ...
        frequency: int,
        license_type: shapes.LicenseType = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if server_id is not autoboto.ShapeBase._NOT_SET:
                _params['server_id'] = server_id
            if seed_replication_time is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_replication_job(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if replication_job_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def disassociate_connector(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if connector_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_replication_jobs(
        ...
        *,
        replication_job_id: str = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
    ...
    def update_replication_job(
        ...
        *,
        replication_job_id: str,
        frequency: int = autoboto.ShapeBase._NOT_SET,
        next_replication_run_start_time: datetime.datetime = autoboto.ShapeBase.
        _NOT_SET,
        license_type: shapes.LicenseType = autoboto.ShapeBase._NOT_SET,
        role_name: str = autoboto.ShapeBase._NOT_SET,
        description: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if frequency is not autoboto.ShapeBase._NOT_SET:
                _params['frequency'] = frequency
            if next_replication_run_start_time is not autoboto.ShapeBase._NOT_SET:
