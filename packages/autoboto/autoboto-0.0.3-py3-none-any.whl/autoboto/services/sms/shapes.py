...
class Connector(autoboto.ShapeBase):
    ...
    vm_manager_id: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
class CreateReplicationJobRequest(autoboto.ShapeBase):
    ...
    server_id: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    frequency: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
@dataclasses.dataclass
class CreateReplicationJobResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DeleteReplicationJobResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return []
...
@dataclasses.dataclass
class DeleteServerCatalogResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return []
...
@dataclasses.dataclass
class DisassociateConnectorResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return []
...
@dataclasses.dataclass
class GetConnectorsResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class GetReplicationJobsResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class GetReplicationRunsResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class GetServersResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class ImportServerCatalogResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return []
...
class ReplicationJob(autoboto.ShapeBase):
    ...
    latest_ami_id: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
@dataclasses.dataclass
class StartOnDemandReplicationRunResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class UpdateReplicationJobResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return []
...
class VmServer(autoboto.ShapeBase):
    ...
    vm_name: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    # Path to VM
    vm_path: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class VmServerAddress(autoboto.ShapeBase):
    ...
    vm_id: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
