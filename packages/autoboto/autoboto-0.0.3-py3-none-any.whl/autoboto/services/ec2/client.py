...
class Client:
    ...
    def accept_reserved_instances_exchange_quote(
        ...
        *,
        ...
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        target_configurations: typing.List[shapes.TargetConfigurationRequest
                                          ] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if reserved_instance_ids is not autoboto.ShapeBase._NOT_SET:
                _params['reserved_instance_ids'] = reserved_instance_ids
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if target_configurations is not autoboto.ShapeBase._NOT_SET:
    ...
    def accept_vpc_endpoint_connections(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if service_id is not autoboto.ShapeBase._NOT_SET:
                _params['service_id'] = service_id
            if vpc_endpoint_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def accept_vpc_peering_connection(
        ...
        *,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        vpc_peering_connection_id: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if vpc_peering_connection_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def allocate_address(
        ...
        *,
        domain: shapes.DomainType = autoboto.ShapeBase._NOT_SET,
        address: str = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if domain is not autoboto.ShapeBase._NOT_SET:
                _params['domain'] = domain
            if address is not autoboto.ShapeBase._NOT_SET:
    ...
    def allocate_hosts(
        ...
        *,
        ...
        instance_type: str,
        quantity: int,
        auto_placement: shapes.AutoPlacement = autoboto.ShapeBase._NOT_SET,
        client_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if availability_zone is not autoboto.ShapeBase._NOT_SET:
                _params['availability_zone'] = availability_zone
            if instance_type is not autoboto.ShapeBase._NOT_SET:
                _params['instance_type'] = instance_type
            if quantity is not autoboto.ShapeBase._NOT_SET:
                _params['quantity'] = quantity
            if auto_placement is not autoboto.ShapeBase._NOT_SET:
                _params['auto_placement'] = auto_placement
            if client_token is not autoboto.ShapeBase._NOT_SET:
    ...
    def assign_ipv6_addresses(
        ...
        *,
        ...
        ipv6_address_count: int = autoboto.ShapeBase._NOT_SET,
        ipv6_addresses: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if network_interface_id is not autoboto.ShapeBase._NOT_SET:
                _params['network_interface_id'] = network_interface_id
            if ipv6_address_count is not autoboto.ShapeBase._NOT_SET:
                _params['ipv6_address_count'] = ipv6_address_count
            if ipv6_addresses is not autoboto.ShapeBase._NOT_SET:
    ...
    def assign_private_ip_addresses(
        ...
        *,
        network_interface_id: str,
        allow_reassignment: bool = autoboto.ShapeBase._NOT_SET,
        private_ip_addresses: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        secondary_private_ip_address_count: int = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            ...
            if network_interface_id is not autoboto.ShapeBase._NOT_SET:
                _params['network_interface_id'] = network_interface_id
            if allow_reassignment is not autoboto.ShapeBase._NOT_SET:
                _params['allow_reassignment'] = allow_reassignment
            if private_ip_addresses is not autoboto.ShapeBase._NOT_SET:
                _params['private_ip_addresses'] = private_ip_addresses
            if secondary_private_ip_address_count is not autoboto.ShapeBase._NOT_SET:
    ...
    def associate_address(
        ...
        *,
        allocation_id: str = autoboto.ShapeBase._NOT_SET,
        instance_id: str = autoboto.ShapeBase._NOT_SET,
        public_ip: str = autoboto.ShapeBase._NOT_SET,
        allow_reassociation: bool = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        network_interface_id: str = autoboto.ShapeBase._NOT_SET,
        private_ip_address: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if allocation_id is not autoboto.ShapeBase._NOT_SET:
                _params['allocation_id'] = allocation_id
            if instance_id is not autoboto.ShapeBase._NOT_SET:
                _params['instance_id'] = instance_id
            if public_ip is not autoboto.ShapeBase._NOT_SET:
                _params['public_ip'] = public_ip
            if allow_reassociation is not autoboto.ShapeBase._NOT_SET:
                _params['allow_reassociation'] = allow_reassociation
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if network_interface_id is not autoboto.ShapeBase._NOT_SET:
                _params['network_interface_id'] = network_interface_id
            if private_ip_address is not autoboto.ShapeBase._NOT_SET:
    ...
    def associate_dhcp_options(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if dhcp_options_id is not autoboto.ShapeBase._NOT_SET:
                _params['dhcp_options_id'] = dhcp_options_id
            if vpc_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def associate_iam_instance_profile(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if iam_instance_profile is not autoboto.ShapeBase._NOT_SET:
    ...
    def associate_route_table(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if route_table_id is not autoboto.ShapeBase._NOT_SET:
                _params['route_table_id'] = route_table_id
            if subnet_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def associate_subnet_cidr_block(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if ipv6_cidr_block is not autoboto.ShapeBase._NOT_SET:
    ...
    def associate_vpc_cidr_block(
        ...
        *,
        vpc_id: str,
        amazon_provided_ipv6_cidr_block: bool = autoboto.ShapeBase._NOT_SET,
        cidr_block: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if vpc_id is not autoboto.ShapeBase._NOT_SET:
                _params['vpc_id'] = vpc_id
            if amazon_provided_ipv6_cidr_block is not autoboto.ShapeBase._NOT_SET:
                _params['amazon_provided_ipv6_cidr_block'
                       ] = amazon_provided_ipv6_cidr_block
            if cidr_block is not autoboto.ShapeBase._NOT_SET:
    ...
    def attach_classic_link_vpc(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if groups is not autoboto.ShapeBase._NOT_SET:
    ...
    def attach_internet_gateway(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if internet_gateway_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def attach_network_interface(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if device_index is not autoboto.ShapeBase._NOT_SET:
    ...
    def attach_volume(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if device is not autoboto.ShapeBase._NOT_SET:
                _params['device'] = device
            if instance_id is not autoboto.ShapeBase._NOT_SET:
                _params['instance_id'] = instance_id
            if volume_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def attach_vpn_gateway(
        ...
        *,
        ...
        if _request is None:
            ...
            if vpc_id is not autoboto.ShapeBase._NOT_SET:
                _params['vpc_id'] = vpc_id
            if vpn_gateway_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def authorize_security_group_egress(
        ...
        *,
        ...
        cidr_ip: str = autoboto.ShapeBase._NOT_SET,
        from_port: int = autoboto.ShapeBase._NOT_SET,
        ip_protocol: str = autoboto.ShapeBase._NOT_SET,
        to_port: int = autoboto.ShapeBase._NOT_SET,
        source_security_group_name: str = autoboto.ShapeBase._NOT_SET,
        source_security_group_owner_id: str = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            _params = {}
            if group_id is not autoboto.ShapeBase._NOT_SET:
                _params['group_id'] = group_id
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if ip_permissions is not autoboto.ShapeBase._NOT_SET:
                _params['ip_permissions'] = ip_permissions
            if cidr_ip is not autoboto.ShapeBase._NOT_SET:
                _params['cidr_ip'] = cidr_ip
            if from_port is not autoboto.ShapeBase._NOT_SET:
                _params['from_port'] = from_port
            if ip_protocol is not autoboto.ShapeBase._NOT_SET:
                _params['ip_protocol'] = ip_protocol
            if to_port is not autoboto.ShapeBase._NOT_SET:
                _params['to_port'] = to_port
            if source_security_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['source_security_group_name'
                       ] = source_security_group_name
            if source_security_group_owner_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def authorize_security_group_ingress(
        ...
        *,
        cidr_ip: str = autoboto.ShapeBase._NOT_SET,
        from_port: int = autoboto.ShapeBase._NOT_SET,
        group_id: str = autoboto.ShapeBase._NOT_SET,
        group_name: str = autoboto.ShapeBase._NOT_SET,
        ip_permissions: typing.List[shapes.IpPermission
                                   ] = autoboto.ShapeBase._NOT_SET,
        ip_protocol: str = autoboto.ShapeBase._NOT_SET,
        source_security_group_name: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if group_id is not autoboto.ShapeBase._NOT_SET:
                _params['group_id'] = group_id
            if group_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def bundle_instance(
        ...
        *,
        ...
        if _request is None:
            ...
            if instance_id is not autoboto.ShapeBase._NOT_SET:
                _params['instance_id'] = instance_id
            if storage is not autoboto.ShapeBase._NOT_SET:
    ...
    def cancel_bundle_task(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if bundle_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def cancel_conversion_task(
        ...
        *,
        ...
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        reason_message: str = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            _params = {}
            if conversion_task_id is not autoboto.ShapeBase._NOT_SET:
                _params['conversion_task_id'] = conversion_task_id
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if reason_message is not autoboto.ShapeBase._NOT_SET:
    ...
    def cancel_export_task(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if export_task_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def cancel_import_task(
        ...
        *,
        cancel_reason: str = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        import_task_id: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if cancel_reason is not autoboto.ShapeBase._NOT_SET:
                _params['cancel_reason'] = cancel_reason
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if import_task_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def cancel_reserved_instances_listing(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if reserved_instances_listing_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def cancel_spot_fleet_requests(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if spot_fleet_request_ids is not autoboto.ShapeBase._NOT_SET:
                _params['spot_fleet_request_ids'] = spot_fleet_request_ids
            if terminate_instances is not autoboto.ShapeBase._NOT_SET:
    ...
    def cancel_spot_instance_requests(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if spot_instance_request_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def confirm_product_instance(
        ...
        *,
        ...
        if _request is None:
            ...
            if instance_id is not autoboto.ShapeBase._NOT_SET:
                _params['instance_id'] = instance_id
            if product_code is not autoboto.ShapeBase._NOT_SET:
    ...
    def copy_fpga_image(
        ...
        *,
        ...
        source_region: str,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        description: str = autoboto.ShapeBase._NOT_SET,
        name: str = autoboto.ShapeBase._NOT_SET,
        client_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if source_fpga_image_id is not autoboto.ShapeBase._NOT_SET:
                _params['source_fpga_image_id'] = source_fpga_image_id
            if source_region is not autoboto.ShapeBase._NOT_SET:
                _params['source_region'] = source_region
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if description is not autoboto.ShapeBase._NOT_SET:
                _params['description'] = description
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if client_token is not autoboto.ShapeBase._NOT_SET:
                _params['client_token'] = client_token
    ...
    def copy_image(
        ...
        *,
        ...
        client_token: str = autoboto.ShapeBase._NOT_SET,
        description: str = autoboto.ShapeBase._NOT_SET,
        encrypted: bool = autoboto.ShapeBase._NOT_SET,
        kms_key_id: str = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if source_image_id is not autoboto.ShapeBase._NOT_SET:
            ...
            if description is not autoboto.ShapeBase._NOT_SET:
                _params['description'] = description
            if encrypted is not autoboto.ShapeBase._NOT_SET:
                _params['encrypted'] = encrypted
            if kms_key_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def copy_snapshot(
        ...
        *,
        ...
        description: str = autoboto.ShapeBase._NOT_SET,
        destination_region: str = autoboto.ShapeBase._NOT_SET,
        encrypted: bool = autoboto.ShapeBase._NOT_SET,
        kms_key_id: str = autoboto.ShapeBase._NOT_SET,
        presigned_url: str = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if source_region is not autoboto.ShapeBase._NOT_SET:
                _params['source_region'] = source_region
            if source_snapshot_id is not autoboto.ShapeBase._NOT_SET:
                _params['source_snapshot_id'] = source_snapshot_id
            if description is not autoboto.ShapeBase._NOT_SET:
                _params['description'] = description
            if destination_region is not autoboto.ShapeBase._NOT_SET:
                _params['destination_region'] = destination_region
            if encrypted is not autoboto.ShapeBase._NOT_SET:
                _params['encrypted'] = encrypted
            if kms_key_id is not autoboto.ShapeBase._NOT_SET:
                _params['kms_key_id'] = kms_key_id
            if presigned_url is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_customer_gateway(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if bgp_asn is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_dhcp_options(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if dhcp_configurations is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_fleet(
        ...
        *,
        ...
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        client_token: str = autoboto.ShapeBase._NOT_SET,
        spot_options: shapes.SpotOptionsRequest = autoboto.ShapeBase._NOT_SET,
        on_demand_options: shapes.OnDemandOptionsRequest = autoboto.ShapeBase.
        _NOT_SET,
        excess_capacity_termination_policy: shapes.
        FleetExcessCapacityTerminationPolicy = autoboto.ShapeBase._NOT_SET,
        terminate_instances_with_expiration: bool = autoboto.ShapeBase._NOT_SET,
        type: shapes.FleetType = autoboto.ShapeBase._NOT_SET,
        valid_from: datetime.datetime = autoboto.ShapeBase._NOT_SET,
        valid_until: datetime.datetime = autoboto.ShapeBase._NOT_SET,
        replace_unhealthy_instances: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if launch_template_configs is not autoboto.ShapeBase._NOT_SET:
                _params['launch_template_configs'] = launch_template_configs
            if target_capacity_specification is not autoboto.ShapeBase._NOT_SET:
            ...
            if client_token is not autoboto.ShapeBase._NOT_SET:
                _params['client_token'] = client_token
            if spot_options is not autoboto.ShapeBase._NOT_SET:
                _params['spot_options'] = spot_options
            if on_demand_options is not autoboto.ShapeBase._NOT_SET:
                _params['on_demand_options'] = on_demand_options
            if excess_capacity_termination_policy is not autoboto.ShapeBase._NOT_SET:
                _params['excess_capacity_termination_policy'
                       ] = excess_capacity_termination_policy
            if terminate_instances_with_expiration is not autoboto.ShapeBase._NOT_SET:
                _params['terminate_instances_with_expiration'
                       ] = terminate_instances_with_expiration
            if type is not autoboto.ShapeBase._NOT_SET:
                _params['type'] = type
            if valid_from is not autoboto.ShapeBase._NOT_SET:
                _params['valid_from'] = valid_from
            if valid_until is not autoboto.ShapeBase._NOT_SET:
                _params['valid_until'] = valid_until
            if replace_unhealthy_instances is not autoboto.ShapeBase._NOT_SET:
                _params['replace_unhealthy_instances'
                       ] = replace_unhealthy_instances
            if tag_specifications is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_flow_logs(
        ...
        *,
        ...
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        client_token: str = autoboto.ShapeBase._NOT_SET,
        deliver_logs_permission_arn: str = autoboto.ShapeBase._NOT_SET,
        log_group_name: str = autoboto.ShapeBase._NOT_SET,
        log_destination_type: shapes.LogDestinationType = autoboto.ShapeBase.
        _NOT_SET,
        log_destination: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if resource_ids is not autoboto.ShapeBase._NOT_SET:
                _params['resource_ids'] = resource_ids
            if resource_type is not autoboto.ShapeBase._NOT_SET:
                _params['resource_type'] = resource_type
            if traffic_type is not autoboto.ShapeBase._NOT_SET:
                _params['traffic_type'] = traffic_type
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if client_token is not autoboto.ShapeBase._NOT_SET:
                _params['client_token'] = client_token
            if deliver_logs_permission_arn is not autoboto.ShapeBase._NOT_SET:
                _params['deliver_logs_permission_arn'
                       ] = deliver_logs_permission_arn
            if log_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['log_group_name'] = log_group_name
            if log_destination_type is not autoboto.ShapeBase._NOT_SET:
                _params['log_destination_type'] = log_destination_type
            if log_destination is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_fpga_image(
        ...
        *,
        ...
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        logs_storage_location: shapes.StorageLocation = autoboto.ShapeBase.
        _NOT_SET,
        description: str = autoboto.ShapeBase._NOT_SET,
        name: str = autoboto.ShapeBase._NOT_SET,
        client_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if input_storage_location is not autoboto.ShapeBase._NOT_SET:
                _params['input_storage_location'] = input_storage_location
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if logs_storage_location is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_image(
        ...
        *,
        ...
        description: str = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        no_reboot: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if block_device_mappings is not autoboto.ShapeBase._NOT_SET:
                _params['block_device_mappings'] = block_device_mappings
            if description is not autoboto.ShapeBase._NOT_SET:
                _params['description'] = description
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if no_reboot is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_instance_export_task(
        ...
        *,
        instance_id: str,
        description: str = autoboto.ShapeBase._NOT_SET,
        export_to_s3_task: shapes.ExportToS3TaskSpecification = autoboto.
        ShapeBase._NOT_SET,
        target_environment: shapes.ExportEnvironment = autoboto.ShapeBase.
        _NOT_SET,
        ...
        if _request is None:
            ...
            if description is not autoboto.ShapeBase._NOT_SET:
                _params['description'] = description
            if export_to_s3_task is not autoboto.ShapeBase._NOT_SET:
                _params['export_to_s3_task'] = export_to_s3_task
            if target_environment is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_key_pair(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if key_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_launch_template(
        ...
        *,
        ...
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        client_token: str = autoboto.ShapeBase._NOT_SET,
        version_description: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if launch_template_name is not autoboto.ShapeBase._NOT_SET:
                _params['launch_template_name'] = launch_template_name
            if launch_template_data is not autoboto.ShapeBase._NOT_SET:
                _params['launch_template_data'] = launch_template_data
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if client_token is not autoboto.ShapeBase._NOT_SET:
                _params['client_token'] = client_token
            if version_description is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_launch_template_version(
        ...
        *,
        ...
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        client_token: str = autoboto.ShapeBase._NOT_SET,
        launch_template_id: str = autoboto.ShapeBase._NOT_SET,
        launch_template_name: str = autoboto.ShapeBase._NOT_SET,
        source_version: str = autoboto.ShapeBase._NOT_SET,
        version_description: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if client_token is not autoboto.ShapeBase._NOT_SET:
                _params['client_token'] = client_token
            if launch_template_id is not autoboto.ShapeBase._NOT_SET:
                _params['launch_template_id'] = launch_template_id
            if launch_template_name is not autoboto.ShapeBase._NOT_SET:
                _params['launch_template_name'] = launch_template_name
            if source_version is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_network_acl_entry(
        ...
        *,
        ...
        cidr_block: str = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        icmp_type_code: shapes.IcmpTypeCode = autoboto.ShapeBase._NOT_SET,
        ipv6_cidr_block: str = autoboto.ShapeBase._NOT_SET,
        port_range: shapes.PortRange = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            _params = {}
            if egress is not autoboto.ShapeBase._NOT_SET:
                _params['egress'] = egress
            if network_acl_id is not autoboto.ShapeBase._NOT_SET:
                _params['network_acl_id'] = network_acl_id
            if protocol is not autoboto.ShapeBase._NOT_SET:
                _params['protocol'] = protocol
            if rule_action is not autoboto.ShapeBase._NOT_SET:
                _params['rule_action'] = rule_action
            if rule_number is not autoboto.ShapeBase._NOT_SET:
                _params['rule_number'] = rule_number
            if cidr_block is not autoboto.ShapeBase._NOT_SET:
                _params['cidr_block'] = cidr_block
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if icmp_type_code is not autoboto.ShapeBase._NOT_SET:
                _params['icmp_type_code'] = icmp_type_code
            if ipv6_cidr_block is not autoboto.ShapeBase._NOT_SET:
                _params['ipv6_cidr_block'] = ipv6_cidr_block
            if port_range is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_network_interface(
        ...
        *,
        ...
        description: str = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        groups: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ipv6_address_count: int = autoboto.ShapeBase._NOT_SET,
    ...
    def create_network_interface_permission(
        ...
        *,
        ...
        aws_account_id: str = autoboto.ShapeBase._NOT_SET,
        aws_service: str = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if network_interface_id is not autoboto.ShapeBase._NOT_SET:
                _params['network_interface_id'] = network_interface_id
            if permission is not autoboto.ShapeBase._NOT_SET:
                _params['permission'] = permission
            if aws_account_id is not autoboto.ShapeBase._NOT_SET:
                _params['aws_account_id'] = aws_account_id
            if aws_service is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_placement_group(
        ...
        *,
        ...
        if _request is None:
            ...
            if group_name is not autoboto.ShapeBase._NOT_SET:
                _params['group_name'] = group_name
            if strategy is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_reserved_instances_listing(
        ...
        *,
        ...
        if _request is None:
            ...
            if client_token is not autoboto.ShapeBase._NOT_SET:
                _params['client_token'] = client_token
            if instance_count is not autoboto.ShapeBase._NOT_SET:
                _params['instance_count'] = instance_count
            if price_schedules is not autoboto.ShapeBase._NOT_SET:
                _params['price_schedules'] = price_schedules
            if reserved_instances_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_route(
        ...
        *,
        route_table_id: str,
        destination_cidr_block: str = autoboto.ShapeBase._NOT_SET,
        destination_ipv6_cidr_block: str = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        egress_only_internet_gateway_id: str = autoboto.ShapeBase._NOT_SET,
        gateway_id: str = autoboto.ShapeBase._NOT_SET,
        instance_id: str = autoboto.ShapeBase._NOT_SET,
        nat_gateway_id: str = autoboto.ShapeBase._NOT_SET,
        network_interface_id: str = autoboto.ShapeBase._NOT_SET,
        vpc_peering_connection_id: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if route_table_id is not autoboto.ShapeBase._NOT_SET:
                _params['route_table_id'] = route_table_id
            if destination_cidr_block is not autoboto.ShapeBase._NOT_SET:
                _params['destination_cidr_block'] = destination_cidr_block
            if destination_ipv6_cidr_block is not autoboto.ShapeBase._NOT_SET:
                _params['destination_ipv6_cidr_block'
                       ] = destination_ipv6_cidr_block
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if egress_only_internet_gateway_id is not autoboto.ShapeBase._NOT_SET:
                _params['egress_only_internet_gateway_id'
                       ] = egress_only_internet_gateway_id
            if gateway_id is not autoboto.ShapeBase._NOT_SET:
                _params['gateway_id'] = gateway_id
            if instance_id is not autoboto.ShapeBase._NOT_SET:
                _params['instance_id'] = instance_id
            if nat_gateway_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_security_group(
        ...
        *,
        description: str,
        group_name: str,
        vpc_id: str = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
    ...
    def create_spot_datafeed_subscription(
        ...
        *,
        bucket: str,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        prefix: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if bucket is not autoboto.ShapeBase._NOT_SET:
                _params['bucket'] = bucket
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if prefix is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_subnet(
        ...
        *,
        cidr_block: str,
        vpc_id: str,
        availability_zone: str = autoboto.ShapeBase._NOT_SET,
        ipv6_cidr_block: str = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
    ...
    def create_tags(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if resources is not autoboto.ShapeBase._NOT_SET:
                _params['resources'] = resources
            if tags is not autoboto.ShapeBase._NOT_SET:
                _params['tags'] = tags
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
    ...
    def create_volume(
        ...
        *,
        availability_zone: str,
        encrypted: bool = autoboto.ShapeBase._NOT_SET,
        iops: int = autoboto.ShapeBase._NOT_SET,
        kms_key_id: str = autoboto.ShapeBase._NOT_SET,
        size: int = autoboto.ShapeBase._NOT_SET,
        snapshot_id: str = autoboto.ShapeBase._NOT_SET,
        volume_type: shapes.VolumeType = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        tag_specifications: typing.List[shapes.TagSpecification
                                       ] = autoboto.ShapeBase._NOT_SET,
    ) -> shapes.Volume:
        ...
        if _request is None:
            ...
            if encrypted is not autoboto.ShapeBase._NOT_SET:
                _params['encrypted'] = encrypted
            if iops is not autoboto.ShapeBase._NOT_SET:
                _params['iops'] = iops
            if kms_key_id is not autoboto.ShapeBase._NOT_SET:
                _params['kms_key_id'] = kms_key_id
            if size is not autoboto.ShapeBase._NOT_SET:
                _params['size'] = size
            if snapshot_id is not autoboto.ShapeBase._NOT_SET:
                _params['snapshot_id'] = snapshot_id
            if volume_type is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_vpc(
        ...
        *,
        ...
        amazon_provided_ipv6_cidr_block: bool = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        instance_tenancy: shapes.Tenancy = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if instance_tenancy is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_vpc_endpoint(
        ...
        *,
        ...
        service_name: str,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        vpc_endpoint_type: shapes.VpcEndpointType = autoboto.ShapeBase._NOT_SET,
        policy_document: str = autoboto.ShapeBase._NOT_SET,
        route_table_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        subnet_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        security_group_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        client_token: str = autoboto.ShapeBase._NOT_SET,
        private_dns_enabled: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if vpc_id is not autoboto.ShapeBase._NOT_SET:
                _params['vpc_id'] = vpc_id
            if service_name is not autoboto.ShapeBase._NOT_SET:
                _params['service_name'] = service_name
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if vpc_endpoint_type is not autoboto.ShapeBase._NOT_SET:
                _params['vpc_endpoint_type'] = vpc_endpoint_type
            if policy_document is not autoboto.ShapeBase._NOT_SET:
                _params['policy_document'] = policy_document
            if route_table_ids is not autoboto.ShapeBase._NOT_SET:
                _params['route_table_ids'] = route_table_ids
            if subnet_ids is not autoboto.ShapeBase._NOT_SET:
                _params['subnet_ids'] = subnet_ids
            if security_group_ids is not autoboto.ShapeBase._NOT_SET:
                _params['security_group_ids'] = security_group_ids
            if client_token is not autoboto.ShapeBase._NOT_SET:
                _params['client_token'] = client_token
            if private_dns_enabled is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_vpc_endpoint_connection_notification(
        ...
        *,
        ...
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        service_id: str = autoboto.ShapeBase._NOT_SET,
        vpc_endpoint_id: str = autoboto.ShapeBase._NOT_SET,
        client_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if connection_notification_arn is not autoboto.ShapeBase._NOT_SET:
                _params['connection_notification_arn'
                       ] = connection_notification_arn
            if connection_events is not autoboto.ShapeBase._NOT_SET:
                _params['connection_events'] = connection_events
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if service_id is not autoboto.ShapeBase._NOT_SET:
                _params['service_id'] = service_id
            if vpc_endpoint_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_vpc_endpoint_service_configuration(
        ...
        *,
        ...
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        acceptance_required: bool = autoboto.ShapeBase._NOT_SET,
        client_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if network_load_balancer_arns is not autoboto.ShapeBase._NOT_SET:
                _params['network_load_balancer_arns'
                       ] = network_load_balancer_arns
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if acceptance_required is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_vpc_peering_connection(
        ...
        *,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        peer_owner_id: str = autoboto.ShapeBase._NOT_SET,
        peer_vpc_id: str = autoboto.ShapeBase._NOT_SET,
        vpc_id: str = autoboto.ShapeBase._NOT_SET,
        peer_region: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if peer_owner_id is not autoboto.ShapeBase._NOT_SET:
                _params['peer_owner_id'] = peer_owner_id
            if peer_vpc_id is not autoboto.ShapeBase._NOT_SET:
                _params['peer_vpc_id'] = peer_vpc_id
            if vpc_id is not autoboto.ShapeBase._NOT_SET:
                _params['vpc_id'] = vpc_id
            if peer_region is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_vpn_connection(
        ...
        *,
        ...
        vpn_gateway_id: str,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        options: shapes.VpnConnectionOptionsSpecification = autoboto.ShapeBase.
        _NOT_SET,
        ...
        if _request is None:
            _params = {}
            if customer_gateway_id is not autoboto.ShapeBase._NOT_SET:
            ...
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if options is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_vpn_connection_route(
        ...
        *,
        ...
        if _request is None:
            ...
            if destination_cidr_block is not autoboto.ShapeBase._NOT_SET:
                _params['destination_cidr_block'] = destination_cidr_block
            if vpn_connection_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_vpn_gateway(
        ...
        *,
        type: shapes.GatewayType,
        availability_zone: str = autoboto.ShapeBase._NOT_SET,
        amazon_side_asn: int = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if availability_zone is not autoboto.ShapeBase._NOT_SET:
                _params['availability_zone'] = availability_zone
            if amazon_side_asn is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_fleets(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if fleet_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_flow_logs(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if flow_log_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_fpga_image(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if fpga_image_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_launch_template_versions(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if versions is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_network_interface_permission(
        ...
        *,
        ...
        force: bool = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if network_interface_permission_id is not autoboto.ShapeBase._NOT_SET:
                _params['network_interface_permission_id'
                       ] = network_interface_permission_id
            if force is not autoboto.ShapeBase._NOT_SET:
                _params['force'] = force
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
    ...
    def delete_tags(
        ...
        *,
        resources: typing.List[str],
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        tags: typing.List[shapes.Tag] = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
    ...
    def delete_vpc_endpoint_connection_notifications(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if connection_notification_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_vpc_endpoint_service_configurations(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if service_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def deregister_image(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if image_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_account_attributes(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if attribute_names is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_addresses(
        ...
        *,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        public_ips: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        allocation_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if filters is not autoboto.ShapeBase._NOT_SET:
                _params['filters'] = filters
            if public_ips is not autoboto.ShapeBase._NOT_SET:
                _params['public_ips'] = public_ips
            if allocation_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_availability_zones(
        ...
        *,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        zone_names: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if filters is not autoboto.ShapeBase._NOT_SET:
                _params['filters'] = filters
            if zone_names is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_bundle_tasks(
        ...
        *,
        bundle_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if bundle_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_classic_link_instances(
        ...
        *,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        instance_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if instance_ids is not autoboto.ShapeBase._NOT_SET:
                _params['instance_ids'] = instance_ids
            if max_results is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_conversion_tasks(
        ...
        *,
        conversion_task_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if conversion_task_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_customer_gateways(
        ...
        *,
        customer_gateway_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if customer_gateway_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_dhcp_options(
        ...
        *,
        dhcp_options_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if dhcp_options_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_egress_only_internet_gateways(
        ...
        *,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        egress_only_internet_gateway_ids: typing.List[str] = autoboto.ShapeBase.
        _NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if egress_only_internet_gateway_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_elastic_gpus(
        ...
        *,
        elastic_gpu_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if elastic_gpu_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_export_tasks(
        ...
        *,
        export_task_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if export_task_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_fleet_history(
        ...
        *,
        ...
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        event_type: shapes.FleetEventType = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
    ...
    def describe_fleets(
        ...
        *,
        ...
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        fleet_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
    ...
    def describe_flow_logs(
        ...
        *,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        filter: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        flow_log_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if filter is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_fpga_image_attribute(
        ...
        *,
        ...
        if _request is None:
            ...
            if fpga_image_id is not autoboto.ShapeBase._NOT_SET:
                _params['fpga_image_id'] = fpga_image_id
            if attribute is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_fpga_images(
        ...
        *,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        fpga_image_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        owners: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if fpga_image_ids is not autoboto.ShapeBase._NOT_SET:
                _params['fpga_image_ids'] = fpga_image_ids
            if owners is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_host_reservation_offerings(
        ...
        *,
        filter: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        max_duration: int = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        min_duration: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        offering_id: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if filter is not autoboto.ShapeBase._NOT_SET:
                _params['filter'] = filter
            if max_duration is not autoboto.ShapeBase._NOT_SET:
                _params['max_duration'] = max_duration
            if max_results is not autoboto.ShapeBase._NOT_SET:
                _params['max_results'] = max_results
            if min_duration is not autoboto.ShapeBase._NOT_SET:
                _params['min_duration'] = min_duration
            if next_token is not autoboto.ShapeBase._NOT_SET:
                _params['next_token'] = next_token
            if offering_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_host_reservations(
        ...
        *,
        filter: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        host_reservation_id_set: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if filter is not autoboto.ShapeBase._NOT_SET:
                _params['filter'] = filter
            if host_reservation_id_set is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_hosts(
        ...
        *,
        filter: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        host_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if filter is not autoboto.ShapeBase._NOT_SET:
                _params['filter'] = filter
            if host_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_iam_instance_profile_associations(
        ...
        *,
        association_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if association_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_id_format(
        ...
        *,
        resource: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if resource is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_identity_id_format(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if principal_arn is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_images(
        ...
        *,
        executable_users: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        image_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        owners: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if executable_users is not autoboto.ShapeBase._NOT_SET:
                _params['executable_users'] = executable_users
            if filters is not autoboto.ShapeBase._NOT_SET:
                _params['filters'] = filters
            if image_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_import_image_tasks(
        ...
        *,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        import_task_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if filters is not autoboto.ShapeBase._NOT_SET:
                _params['filters'] = filters
            if import_task_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_instance_status(
        ...
        *,
        ...
        next_token: str = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        include_all_instances: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if include_all_instances is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_internet_gateways(
        ...
        *,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        internet_gateway_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if internet_gateway_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_key_pairs(
        ...
        *,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        key_names: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if filters is not autoboto.ShapeBase._NOT_SET:
                _params['filters'] = filters
            if key_names is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_launch_template_versions(
        ...
        *,
        ...
        launch_template_id: str = autoboto.ShapeBase._NOT_SET,
        launch_template_name: str = autoboto.ShapeBase._NOT_SET,
        versions: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        min_version: str = autoboto.ShapeBase._NOT_SET,
        max_version: str = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if versions is not autoboto.ShapeBase._NOT_SET:
                _params['versions'] = versions
            if min_version is not autoboto.ShapeBase._NOT_SET:
                _params['min_version'] = min_version
            if max_version is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_launch_templates(
        ...
        *,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        launch_template_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        launch_template_names: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if launch_template_ids is not autoboto.ShapeBase._NOT_SET:
                _params['launch_template_ids'] = launch_template_ids
            if launch_template_names is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_nat_gateways(
        ...
        *,
        filter: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        nat_gateway_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if max_results is not autoboto.ShapeBase._NOT_SET:
                _params['max_results'] = max_results
            if nat_gateway_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_network_acls(
        ...
        *,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        network_acl_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if network_acl_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_network_interface_attribute(
        ...
        *,
        network_interface_id: str,
        attribute: shapes.NetworkInterfaceAttribute = autoboto.ShapeBase.
        _NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
    ...
    def describe_network_interface_permissions(
        ...
        *,
        network_interface_permission_ids: typing.List[str] = autoboto.ShapeBase.
        _NOT_SET,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if network_interface_permission_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_network_interfaces(
        ...
        *,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        network_interface_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if network_interface_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_placement_groups(
        ...
        *,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        group_names: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if group_names is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_prefix_lists(
        ...
        *,
        ...
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        prefix_list_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if next_token is not autoboto.ShapeBase._NOT_SET:
                _params['next_token'] = next_token
            if prefix_list_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_principal_id_format(
        ...
        *,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        resources: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
    ...
    def describe_regions(
        ...
        *,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        region_names: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if filters is not autoboto.ShapeBase._NOT_SET:
                _params['filters'] = filters
            if region_names is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_reserved_instances(
        ...
        *,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        offering_class: shapes.OfferingClassType = autoboto.ShapeBase._NOT_SET,
        reserved_instances_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        offering_type: shapes.OfferingTypeValues = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if filters is not autoboto.ShapeBase._NOT_SET:
                _params['filters'] = filters
            if offering_class is not autoboto.ShapeBase._NOT_SET:
                _params['offering_class'] = offering_class
            if reserved_instances_ids is not autoboto.ShapeBase._NOT_SET:
                _params['reserved_instances_ids'] = reserved_instances_ids
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if offering_type is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_reserved_instances_listings(
        ...
        *,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        reserved_instances_id: str = autoboto.ShapeBase._NOT_SET,
        reserved_instances_listing_id: str = autoboto.ShapeBase._NOT_SET,
    ...
    def describe_reserved_instances_modifications(
        ...
        *,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        reserved_instances_modification_ids: typing.List[str] = autoboto.
        ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if filters is not autoboto.ShapeBase._NOT_SET:
                _params['filters'] = filters
            if reserved_instances_modification_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_reserved_instances_offerings(
        ...
        *,
        availability_zone: str = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        include_marketplace: bool = autoboto.ShapeBase._NOT_SET,
        instance_type: shapes.InstanceType = autoboto.ShapeBase._NOT_SET,
        max_duration: int = autoboto.ShapeBase._NOT_SET,
        max_instance_count: int = autoboto.ShapeBase._NOT_SET,
        min_duration: int = autoboto.ShapeBase._NOT_SET,
        offering_class: shapes.OfferingClassType = autoboto.ShapeBase._NOT_SET,
        product_description: shapes.RIProductDescription = autoboto.ShapeBase.
        _NOT_SET,
        reserved_instances_offering_ids: typing.List[str] = autoboto.ShapeBase.
        _NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        instance_tenancy: shapes.Tenancy = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if filters is not autoboto.ShapeBase._NOT_SET:
                _params['filters'] = filters
            if include_marketplace is not autoboto.ShapeBase._NOT_SET:
                _params['include_marketplace'] = include_marketplace
            if instance_type is not autoboto.ShapeBase._NOT_SET:
                _params['instance_type'] = instance_type
            if max_duration is not autoboto.ShapeBase._NOT_SET:
                _params['max_duration'] = max_duration
            if max_instance_count is not autoboto.ShapeBase._NOT_SET:
                _params['max_instance_count'] = max_instance_count
            if min_duration is not autoboto.ShapeBase._NOT_SET:
                _params['min_duration'] = min_duration
            if offering_class is not autoboto.ShapeBase._NOT_SET:
                _params['offering_class'] = offering_class
            if product_description is not autoboto.ShapeBase._NOT_SET:
                _params['product_description'] = product_description
            if reserved_instances_offering_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_scheduled_instance_availability(
        ...
        *,
        ...
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        max_slot_duration_in_hours: int = autoboto.ShapeBase._NOT_SET,
        min_slot_duration_in_hours: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if first_slot_start_time_range is not autoboto.ShapeBase._NOT_SET:
                _params['first_slot_start_time_range'
                       ] = first_slot_start_time_range
            if recurrence is not autoboto.ShapeBase._NOT_SET:
            ...
            if max_results is not autoboto.ShapeBase._NOT_SET:
                _params['max_results'] = max_results
            if max_slot_duration_in_hours is not autoboto.ShapeBase._NOT_SET:
                _params['max_slot_duration_in_hours'
                       ] = max_slot_duration_in_hours
            if min_slot_duration_in_hours is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_scheduled_instances(
        ...
        *,
        ...
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        scheduled_instance_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        slot_start_time_range: shapes.SlotStartTimeRangeRequest = autoboto.
        ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if next_token is not autoboto.ShapeBase._NOT_SET:
                _params['next_token'] = next_token
            if scheduled_instance_ids is not autoboto.ShapeBase._NOT_SET:
                _params['scheduled_instance_ids'] = scheduled_instance_ids
            if slot_start_time_range is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_security_groups(
        ...
        *,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        group_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        group_names: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if filters is not autoboto.ShapeBase._NOT_SET:
                _params['filters'] = filters
            if group_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_snapshots(
        ...
        *,
        ...
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        owner_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        restorable_by_user_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        snapshot_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if next_token is not autoboto.ShapeBase._NOT_SET:
                _params['next_token'] = next_token
            if owner_ids is not autoboto.ShapeBase._NOT_SET:
                _params['owner_ids'] = owner_ids
            if restorable_by_user_ids is not autoboto.ShapeBase._NOT_SET:
                _params['restorable_by_user_ids'] = restorable_by_user_ids
            if snapshot_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_spot_fleet_instances(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if spot_fleet_request_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_spot_fleet_request_history(
        ...
        *,
        ...
        start_time: datetime.datetime,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        event_type: shapes.EventType = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
    ...
    def describe_spot_fleet_requests(
        ...
        *,
        ...
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        spot_fleet_request_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
    ...
    def describe_spot_price_history(
        ...
        *,
        ...
        availability_zone: str = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        end_time: datetime.datetime = autoboto.ShapeBase._NOT_SET,
        instance_types: typing.List[shapes.InstanceType
                                   ] = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        product_descriptions: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        start_time: datetime.datetime = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if instance_types is not autoboto.ShapeBase._NOT_SET:
                _params['instance_types'] = instance_types
            if max_results is not autoboto.ShapeBase._NOT_SET:
                _params['max_results'] = max_results
            if next_token is not autoboto.ShapeBase._NOT_SET:
                _params['next_token'] = next_token
            if product_descriptions is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_volume_status(
        ...
        *,
        ...
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        volume_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if next_token is not autoboto.ShapeBase._NOT_SET:
                _params['next_token'] = next_token
            if volume_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_vpc_classic_link(
        ...
        *,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        vpc_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if vpc_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_vpc_endpoint_connection_notifications(
        ...
        *,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        connection_notification_id: str = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if connection_notification_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_vpc_endpoint_service_configurations(
        ...
        *,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        service_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
    ...
    def describe_vpc_endpoint_services(
        ...
        *,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        service_names: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if service_names is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_vpc_endpoints(
        ...
        *,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        vpc_endpoint_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
    ...
    def describe_vpc_peering_connections(
        ...
        *,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        vpc_peering_connection_ids: typing.List[str
                                               ] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if vpc_peering_connection_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_vpn_connections(
        ...
        *,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        vpn_connection_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if filters is not autoboto.ShapeBase._NOT_SET:
                _params['filters'] = filters
            if vpn_connection_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_vpn_gateways(
        ...
        *,
        filters: typing.List[shapes.Filter] = autoboto.ShapeBase._NOT_SET,
        vpn_gateway_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if filters is not autoboto.ShapeBase._NOT_SET:
                _params['filters'] = filters
            if vpn_gateway_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def detach_network_interface(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if attachment_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def detach_volume(
        ...
        *,
        volume_id: str,
        device: str = autoboto.ShapeBase._NOT_SET,
        force: bool = autoboto.ShapeBase._NOT_SET,
        instance_id: str = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
    ) -> shapes.VolumeAttachment:
    ...
    def disassociate_address(
        ...
        *,
        association_id: str = autoboto.ShapeBase._NOT_SET,
        public_ip: str = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            _params = {}
            if association_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_console_output(
        ...
        *,
        instance_id: str,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        latest: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if latest is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_console_screenshot(
        ...
        *,
        instance_id: str,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        wake_up: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if wake_up is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_host_reservation_purchase_preview(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if host_id_set is not autoboto.ShapeBase._NOT_SET:
    ...
    def import_image(
        ...
        *,
        architecture: str = autoboto.ShapeBase._NOT_SET,
        client_data: shapes.ClientData = autoboto.ShapeBase._NOT_SET,
        client_token: str = autoboto.ShapeBase._NOT_SET,
        description: str = autoboto.ShapeBase._NOT_SET,
        disk_containers: typing.List[shapes.ImageDiskContainer
                                    ] = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        hypervisor: str = autoboto.ShapeBase._NOT_SET,
        license_type: str = autoboto.ShapeBase._NOT_SET,
        platform: str = autoboto.ShapeBase._NOT_SET,
        role_name: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if architecture is not autoboto.ShapeBase._NOT_SET:
                _params['architecture'] = architecture
            if client_data is not autoboto.ShapeBase._NOT_SET:
                _params['client_data'] = client_data
            if client_token is not autoboto.ShapeBase._NOT_SET:
                _params['client_token'] = client_token
            if description is not autoboto.ShapeBase._NOT_SET:
                _params['description'] = description
            if disk_containers is not autoboto.ShapeBase._NOT_SET:
                _params['disk_containers'] = disk_containers
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if hypervisor is not autoboto.ShapeBase._NOT_SET:
                _params['hypervisor'] = hypervisor
            if license_type is not autoboto.ShapeBase._NOT_SET:
                _params['license_type'] = license_type
            if platform is not autoboto.ShapeBase._NOT_SET:
                _params['platform'] = platform
            if role_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def import_instance(
        ...
        *,
        ...
        description: str = autoboto.ShapeBase._NOT_SET,
        disk_images: typing.List[shapes.DiskImage
                                ] = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        launch_specification: shapes.
        ImportInstanceLaunchSpecification = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if description is not autoboto.ShapeBase._NOT_SET:
                _params['description'] = description
            if disk_images is not autoboto.ShapeBase._NOT_SET:
                _params['disk_images'] = disk_images
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if launch_specification is not autoboto.ShapeBase._NOT_SET:
    ...
    def import_key_pair(
        ...
        *,
        ...
        if _request is None:
            ...
            if key_name is not autoboto.ShapeBase._NOT_SET:
                _params['key_name'] = key_name
            if public_key_material is not autoboto.ShapeBase._NOT_SET:
    ...
    def import_snapshot(
        ...
        *,
        ...
        client_token: str = autoboto.ShapeBase._NOT_SET,
        description: str = autoboto.ShapeBase._NOT_SET,
        disk_container: shapes.SnapshotDiskContainer = autoboto.ShapeBase.
        _NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        role_name: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if description is not autoboto.ShapeBase._NOT_SET:
                _params['description'] = description
            if disk_container is not autoboto.ShapeBase._NOT_SET:
    ...
    def import_volume(
        ...
        *,
        ...
        if _request is None:
            ...
            if availability_zone is not autoboto.ShapeBase._NOT_SET:
                _params['availability_zone'] = availability_zone
            if image is not autoboto.ShapeBase._NOT_SET:
                _params['image'] = image
            if volume is not autoboto.ShapeBase._NOT_SET:
    ...
    def modify_fpga_image_attribute(
        ...
        *,
        fpga_image_id: str,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        attribute: shapes.FpgaImageAttributeName = autoboto.ShapeBase._NOT_SET,
        operation_type: shapes.OperationType = autoboto.ShapeBase._NOT_SET,
        user_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        user_groups: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        product_codes: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        load_permission: shapes.LoadPermissionModifications = autoboto.
        ShapeBase._NOT_SET,
        description: str = autoboto.ShapeBase._NOT_SET,
        name: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if attribute is not autoboto.ShapeBase._NOT_SET:
                _params['attribute'] = attribute
            if operation_type is not autoboto.ShapeBase._NOT_SET:
                _params['operation_type'] = operation_type
            if user_ids is not autoboto.ShapeBase._NOT_SET:
                _params['user_ids'] = user_ids
            if user_groups is not autoboto.ShapeBase._NOT_SET:
                _params['user_groups'] = user_groups
            if product_codes is not autoboto.ShapeBase._NOT_SET:
                _params['product_codes'] = product_codes
            if load_permission is not autoboto.ShapeBase._NOT_SET:
    ...
    def modify_id_format(
        ...
        *,
        ...
        if _request is None:
            ...
            if resource is not autoboto.ShapeBase._NOT_SET:
                _params['resource'] = resource
            if use_long_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def modify_image_attribute(
        ...
        *,
        image_id: str,
        attribute: str = autoboto.ShapeBase._NOT_SET,
        description: shapes.AttributeValue = autoboto.ShapeBase._NOT_SET,
        launch_permission: shapes.LaunchPermissionModifications = autoboto.
        ShapeBase._NOT_SET,
        operation_type: shapes.OperationType = autoboto.ShapeBase._NOT_SET,
        product_codes: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        user_groups: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        user_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        value: str = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            ...
            if description is not autoboto.ShapeBase._NOT_SET:
                _params['description'] = description
            if launch_permission is not autoboto.ShapeBase._NOT_SET:
            ...
            if user_ids is not autoboto.ShapeBase._NOT_SET:
                _params['user_ids'] = user_ids
            if value is not autoboto.ShapeBase._NOT_SET:
                _params['value'] = value
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
    ...
    def modify_instance_attribute(
        ...
        *,
        instance_id: str,
        source_dest_check: shapes.AttributeBooleanValue = autoboto.ShapeBase.
        _NOT_SET,
        attribute: shapes.InstanceAttributeName = autoboto.ShapeBase._NOT_SET,
        block_device_mappings: typing.List[
            shapes.InstanceBlockDeviceMappingSpecification
        ] = autoboto.ShapeBase._NOT_SET,
        disable_api_termination: shapes.AttributeBooleanValue = autoboto.
        ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        ebs_optimized: shapes.AttributeBooleanValue = autoboto.ShapeBase.
        _NOT_SET,
        ena_support: shapes.AttributeBooleanValue = autoboto.ShapeBase._NOT_SET,
        groups: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        instance_initiated_shutdown_behavior: shapes.AttributeValue = autoboto.
        ShapeBase._NOT_SET,
        instance_type: shapes.AttributeValue = autoboto.ShapeBase._NOT_SET,
        kernel: shapes.AttributeValue = autoboto.ShapeBase._NOT_SET,
        ramdisk: shapes.AttributeValue = autoboto.ShapeBase._NOT_SET,
        sriov_net_support: shapes.AttributeValue = autoboto.ShapeBase._NOT_SET,
        user_data: shapes.BlobAttributeValue = autoboto.ShapeBase._NOT_SET,
        value: str = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        **Note:** Using this action to change the security groups associated with an
        ...
        if _request is None:
            ...
            if instance_id is not autoboto.ShapeBase._NOT_SET:
                _params['instance_id'] = instance_id
            if source_dest_check is not autoboto.ShapeBase._NOT_SET:
                _params['source_dest_check'] = source_dest_check
            if attribute is not autoboto.ShapeBase._NOT_SET:
                _params['attribute'] = attribute
            if block_device_mappings is not autoboto.ShapeBase._NOT_SET:
                _params['block_device_mappings'] = block_device_mappings
            if disable_api_termination is not autoboto.ShapeBase._NOT_SET:
                _params['disable_api_termination'] = disable_api_termination
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if ebs_optimized is not autoboto.ShapeBase._NOT_SET:
                _params['ebs_optimized'] = ebs_optimized
            if ena_support is not autoboto.ShapeBase._NOT_SET:
                _params['ena_support'] = ena_support
            if groups is not autoboto.ShapeBase._NOT_SET:
                _params['groups'] = groups
            if instance_initiated_shutdown_behavior is not autoboto.ShapeBase._NOT_SET:
                _params['instance_initiated_shutdown_behavior'
                       ] = instance_initiated_shutdown_behavior
            if instance_type is not autoboto.ShapeBase._NOT_SET:
                _params['instance_type'] = instance_type
            if kernel is not autoboto.ShapeBase._NOT_SET:
                _params['kernel'] = kernel
            if ramdisk is not autoboto.ShapeBase._NOT_SET:
                _params['ramdisk'] = ramdisk
            if sriov_net_support is not autoboto.ShapeBase._NOT_SET:
                _params['sriov_net_support'] = sriov_net_support
            if user_data is not autoboto.ShapeBase._NOT_SET:
    ...
    def modify_instance_credit_specification(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if instance_credit_specifications is not autoboto.ShapeBase._NOT_SET:
    ...
    def modify_instance_placement(
        ...
        *,
        instance_id: str,
        affinity: shapes.Affinity = autoboto.ShapeBase._NOT_SET,
        group_name: str = autoboto.ShapeBase._NOT_SET,
        host_id: str = autoboto.ShapeBase._NOT_SET,
        tenancy: shapes.HostTenancy = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if instance_id is not autoboto.ShapeBase._NOT_SET:
                _params['instance_id'] = instance_id
            if affinity is not autoboto.ShapeBase._NOT_SET:
                _params['affinity'] = affinity
            if group_name is not autoboto.ShapeBase._NOT_SET:
                _params['group_name'] = group_name
            if host_id is not autoboto.ShapeBase._NOT_SET:
                _params['host_id'] = host_id
            if tenancy is not autoboto.ShapeBase._NOT_SET:
    ...
    def modify_launch_template(
        ...
        *,
        ...
        launch_template_id: str = autoboto.ShapeBase._NOT_SET,
        launch_template_name: str = autoboto.ShapeBase._NOT_SET,
        default_version: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if launch_template_name is not autoboto.ShapeBase._NOT_SET:
                _params['launch_template_name'] = launch_template_name
            if default_version is not autoboto.ShapeBase._NOT_SET:
    ...
    def modify_network_interface_attribute(
        ...
        *,
        network_interface_id: str,
        attachment: shapes.NetworkInterfaceAttachmentChanges = autoboto.
        ShapeBase._NOT_SET,
        description: shapes.AttributeValue = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        groups: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if network_interface_id is not autoboto.ShapeBase._NOT_SET:
                _params['network_interface_id'] = network_interface_id
            if attachment is not autoboto.ShapeBase._NOT_SET:
    ...
    def modify_snapshot_attribute(
        ...
        *,
        snapshot_id: str,
        attribute: shapes.SnapshotAttributeName = autoboto.ShapeBase._NOT_SET,
        create_volume_permission: shapes.
        CreateVolumePermissionModifications = autoboto.ShapeBase._NOT_SET,
        group_names: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        operation_type: shapes.OperationType = autoboto.ShapeBase._NOT_SET,
        user_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if attribute is not autoboto.ShapeBase._NOT_SET:
                _params['attribute'] = attribute
            if create_volume_permission is not autoboto.ShapeBase._NOT_SET:
    ...
    def modify_spot_fleet_request(
        ...
        *,
        spot_fleet_request_id: str,
        excess_capacity_termination_policy: shapes.
        ExcessCapacityTerminationPolicy = autoboto.ShapeBase._NOT_SET,
        target_capacity: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if target_capacity is not autoboto.ShapeBase._NOT_SET:
    ...
    def modify_subnet_attribute(
        ...
        *,
        ...
        AttributeBooleanValue = autoboto.ShapeBase._NOT_SET,
        map_public_ip_on_launch: shapes.AttributeBooleanValue = autoboto.
        ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            ...
            if subnet_id is not autoboto.ShapeBase._NOT_SET:
                _params['subnet_id'] = subnet_id
            if assign_ipv6_address_on_creation is not autoboto.ShapeBase._NOT_SET:
                _params['assign_ipv6_address_on_creation'
                       ] = assign_ipv6_address_on_creation
            if map_public_ip_on_launch is not autoboto.ShapeBase._NOT_SET:
    ...
    def modify_volume_attribute(
        ...
        *,
        volume_id: str,
        auto_enable_io: shapes.AttributeBooleanValue = autoboto.ShapeBase.
        _NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            ...
            if volume_id is not autoboto.ShapeBase._NOT_SET:
                _params['volume_id'] = volume_id
            if auto_enable_io is not autoboto.ShapeBase._NOT_SET:
    ...
    def modify_vpc_attribute(
        ...
        *,
        vpc_id: str,
        enable_dns_hostnames: shapes.AttributeBooleanValue = autoboto.ShapeBase.
        _NOT_SET,
        enable_dns_support: shapes.AttributeBooleanValue = autoboto.ShapeBase.
        _NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            ...
            if vpc_id is not autoboto.ShapeBase._NOT_SET:
                _params['vpc_id'] = vpc_id
            if enable_dns_hostnames is not autoboto.ShapeBase._NOT_SET:
                _params['enable_dns_hostnames'] = enable_dns_hostnames
            if enable_dns_support is not autoboto.ShapeBase._NOT_SET:
    ...
    def modify_vpc_endpoint(
        ...
        *,
        vpc_endpoint_id: str,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        reset_policy: bool = autoboto.ShapeBase._NOT_SET,
        policy_document: str = autoboto.ShapeBase._NOT_SET,
        add_route_table_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        remove_route_table_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        add_subnet_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        remove_subnet_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        add_security_group_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        remove_security_group_ids: typing.List[str
                                              ] = autoboto.ShapeBase._NOT_SET,
        private_dns_enabled: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if reset_policy is not autoboto.ShapeBase._NOT_SET:
                _params['reset_policy'] = reset_policy
            if policy_document is not autoboto.ShapeBase._NOT_SET:
                _params['policy_document'] = policy_document
            if add_route_table_ids is not autoboto.ShapeBase._NOT_SET:
                _params['add_route_table_ids'] = add_route_table_ids
            if remove_route_table_ids is not autoboto.ShapeBase._NOT_SET:
                _params['remove_route_table_ids'] = remove_route_table_ids
            if add_subnet_ids is not autoboto.ShapeBase._NOT_SET:
                _params['add_subnet_ids'] = add_subnet_ids
            if remove_subnet_ids is not autoboto.ShapeBase._NOT_SET:
                _params['remove_subnet_ids'] = remove_subnet_ids
            if add_security_group_ids is not autoboto.ShapeBase._NOT_SET:
                _params['add_security_group_ids'] = add_security_group_ids
            if remove_security_group_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def modify_vpc_endpoint_connection_notification(
        ...
        *,
        ...
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        connection_notification_arn: str = autoboto.ShapeBase._NOT_SET,
        connection_events: typing.List[str] = autoboto.ShapeBase._NOT_SET,
    ...
    def modify_vpc_endpoint_service_configuration(
        ...
        *,
        ...
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        acceptance_required: bool = autoboto.ShapeBase._NOT_SET,
        add_network_load_balancer_arns: typing.List[str] = autoboto.ShapeBase.
        _NOT_SET,
        remove_network_load_balancer_arns: typing.List[str] = autoboto.
        ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if acceptance_required is not autoboto.ShapeBase._NOT_SET:
                _params['acceptance_required'] = acceptance_required
            if add_network_load_balancer_arns is not autoboto.ShapeBase._NOT_SET:
                _params['add_network_load_balancer_arns'
                       ] = add_network_load_balancer_arns
            if remove_network_load_balancer_arns is not autoboto.ShapeBase._NOT_SET:
    ...
    def modify_vpc_endpoint_service_permissions(
        ...
        *,
        service_id: str,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        add_allowed_principals: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        remove_allowed_principals: typing.List[str
                                              ] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if add_allowed_principals is not autoboto.ShapeBase._NOT_SET:
                _params['add_allowed_principals'] = add_allowed_principals
            if remove_allowed_principals is not autoboto.ShapeBase._NOT_SET:
    ...
    def modify_vpc_peering_connection_options(
        ...
        *,
        ...
        PeeringConnectionOptionsRequest = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if vpc_peering_connection_id is not autoboto.ShapeBase._NOT_SET:
                _params['vpc_peering_connection_id'] = vpc_peering_connection_id
            if accepter_peering_connection_options is not autoboto.ShapeBase._NOT_SET:
                _params['accepter_peering_connection_options'
                       ] = accepter_peering_connection_options
            if dry_run is not autoboto.ShapeBase._NOT_SET:
                _params['dry_run'] = dry_run
            if requester_peering_connection_options is not autoboto.ShapeBase._NOT_SET:
    ...
    def purchase_host_reservation(
        ...
        *,
        ...
        offering_id: str,
        client_token: str = autoboto.ShapeBase._NOT_SET,
        currency_code: shapes.CurrencyCodeValues = autoboto.ShapeBase._NOT_SET,
        limit_price: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if client_token is not autoboto.ShapeBase._NOT_SET:
                _params['client_token'] = client_token
            if currency_code is not autoboto.ShapeBase._NOT_SET:
                _params['currency_code'] = currency_code
            if limit_price is not autoboto.ShapeBase._NOT_SET:
    ...
    def purchase_reserved_instances_offering(
        ...
        *,
        ...
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        limit_price: shapes.ReservedInstanceLimitPrice = autoboto.ShapeBase.
        _NOT_SET,
        ...
        if _request is None:
            ...
            if instance_count is not autoboto.ShapeBase._NOT_SET:
                _params['instance_count'] = instance_count
            if reserved_instances_offering_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def purchase_scheduled_instances(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if purchase_requests is not autoboto.ShapeBase._NOT_SET:
    ...
    def register_image(
        ...
        *,
        name: str,
        image_location: str = autoboto.ShapeBase._NOT_SET,
        architecture: shapes.ArchitectureValues = autoboto.ShapeBase._NOT_SET,
        block_device_mappings: typing.List[shapes.BlockDeviceMapping
                                          ] = autoboto.ShapeBase._NOT_SET,
        description: str = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        ena_support: bool = autoboto.ShapeBase._NOT_SET,
        kernel_id: str = autoboto.ShapeBase._NOT_SET,
        billing_products: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ramdisk_id: str = autoboto.ShapeBase._NOT_SET,
        root_device_name: str = autoboto.ShapeBase._NOT_SET,
        sriov_net_support: str = autoboto.ShapeBase._NOT_SET,
        virtualization_type: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if image_location is not autoboto.ShapeBase._NOT_SET:
            ...
            if ena_support is not autoboto.ShapeBase._NOT_SET:
                _params['ena_support'] = ena_support
            if kernel_id is not autoboto.ShapeBase._NOT_SET:
                _params['kernel_id'] = kernel_id
            if billing_products is not autoboto.ShapeBase._NOT_SET:
                _params['billing_products'] = billing_products
            if ramdisk_id is not autoboto.ShapeBase._NOT_SET:
                _params['ramdisk_id'] = ramdisk_id
            if root_device_name is not autoboto.ShapeBase._NOT_SET:
                _params['root_device_name'] = root_device_name
            if sriov_net_support is not autoboto.ShapeBase._NOT_SET:
                _params['sriov_net_support'] = sriov_net_support
            if virtualization_type is not autoboto.ShapeBase._NOT_SET:
    ...
    def report_instance_status(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if instances is not autoboto.ShapeBase._NOT_SET:
                _params['instances'] = instances
            if reason_codes is not autoboto.ShapeBase._NOT_SET:
                _params['reason_codes'] = reason_codes
            if status is not autoboto.ShapeBase._NOT_SET:
    ...
    def request_spot_fleet(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if spot_fleet_request_config is not autoboto.ShapeBase._NOT_SET:
    ...
    def request_spot_instances(
        ...
        *,
        availability_zone_group: str = autoboto.ShapeBase._NOT_SET,
        block_duration_minutes: int = autoboto.ShapeBase._NOT_SET,
        client_token: str = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        instance_count: int = autoboto.ShapeBase._NOT_SET,
        launch_group: str = autoboto.ShapeBase._NOT_SET,
        launch_specification: shapes.RequestSpotLaunchSpecification = autoboto.
        ShapeBase._NOT_SET,
        spot_price: str = autoboto.ShapeBase._NOT_SET,
        type: shapes.SpotInstanceType = autoboto.ShapeBase._NOT_SET,
        valid_from: datetime.datetime = autoboto.ShapeBase._NOT_SET,
        valid_until: datetime.datetime = autoboto.ShapeBase._NOT_SET,
        instance_interruption_behavior: shapes.
        InstanceInterruptionBehavior = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if availability_zone_group is not autoboto.ShapeBase._NOT_SET:
                _params['availability_zone_group'] = availability_zone_group
            if block_duration_minutes is not autoboto.ShapeBase._NOT_SET:
            ...
            if instance_count is not autoboto.ShapeBase._NOT_SET:
                _params['instance_count'] = instance_count
            if launch_group is not autoboto.ShapeBase._NOT_SET:
                _params['launch_group'] = launch_group
            if launch_specification is not autoboto.ShapeBase._NOT_SET:
                _params['launch_specification'] = launch_specification
            if spot_price is not autoboto.ShapeBase._NOT_SET:
            ...
            if valid_until is not autoboto.ShapeBase._NOT_SET:
                _params['valid_until'] = valid_until
            if instance_interruption_behavior is not autoboto.ShapeBase._NOT_SET:
    ...
    def reset_fpga_image_attribute(
        ...
        *,
        fpga_image_id: str,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        attribute: shapes.ResetFpgaImageAttributeName = autoboto.ShapeBase.
        _NOT_SET,
    ...
    def reset_network_interface_attribute(
        ...
        *,
        network_interface_id: str,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        source_dest_check: str = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
    ...
    def run_instances(
        ...
        *,
        ...
        image_id: str = autoboto.ShapeBase._NOT_SET,
        instance_type: shapes.InstanceType = autoboto.ShapeBase._NOT_SET,
        ipv6_address_count: int = autoboto.ShapeBase._NOT_SET,
        ipv6_addresses: typing.List[shapes.InstanceIpv6Address
                                   ] = autoboto.ShapeBase._NOT_SET,
        kernel_id: str = autoboto.ShapeBase._NOT_SET,
        key_name: str = autoboto.ShapeBase._NOT_SET,
        monitoring: shapes.RunInstancesMonitoringEnabled = autoboto.ShapeBase.
        _NOT_SET,
        placement: shapes.Placement = autoboto.ShapeBase._NOT_SET,
        ramdisk_id: str = autoboto.ShapeBase._NOT_SET,
        security_group_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        security_groups: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        subnet_id: str = autoboto.ShapeBase._NOT_SET,
        user_data: str = autoboto.ShapeBase._NOT_SET,
        additional_info: str = autoboto.ShapeBase._NOT_SET,
        client_token: str = autoboto.ShapeBase._NOT_SET,
        disable_api_termination: bool = autoboto.ShapeBase._NOT_SET,
        dry_run: bool = autoboto.ShapeBase._NOT_SET,
        ebs_optimized: bool = autoboto.ShapeBase._NOT_SET,
        iam_instance_profile: shapes.IamInstanceProfileSpecification = autoboto.
        ShapeBase._NOT_SET,
        instance_initiated_shutdown_behavior: shapes.
        ShutdownBehavior = autoboto.ShapeBase._NOT_SET,
        ...
        launch_template: shapes.LaunchTemplateSpecification = autoboto.
        ShapeBase._NOT_SET,
        instance_market_options: shapes.InstanceMarketOptionsRequest = autoboto.
        ShapeBase._NOT_SET,
        credit_specification: shapes.CreditSpecificationRequest = autoboto.
        ShapeBase._NOT_SET,
        cpu_options: shapes.CpuOptionsRequest = autoboto.ShapeBase._NOT_SET,
    ) -> shapes.Reservation:
        """
        ...
        if _request is None:
            _params = {}
            if max_count is not autoboto.ShapeBase._NOT_SET:
                _params['max_count'] = max_count
            if min_count is not autoboto.ShapeBase._NOT_SET:
            ...
            if key_name is not autoboto.ShapeBase._NOT_SET:
                _params['key_name'] = key_name
            if monitoring is not autoboto.ShapeBase._NOT_SET:
                _params['monitoring'] = monitoring
            if placement is not autoboto.ShapeBase._NOT_SET:
                _params['placement'] = placement
            if ramdisk_id is not autoboto.ShapeBase._NOT_SET:
                _params['ramdisk_id'] = ramdisk_id
            if security_group_ids is not autoboto.ShapeBase._NOT_SET:
                _params['security_group_ids'] = security_group_ids
            if security_groups is not autoboto.ShapeBase._NOT_SET:
                _params['security_groups'] = security_groups
            if subnet_id is not autoboto.ShapeBase._NOT_SET:
                _params['subnet_id'] = subnet_id
            if user_data is not autoboto.ShapeBase._NOT_SET:
                _params['user_data'] = user_data
            if additional_info is not autoboto.ShapeBase._NOT_SET:
            ...
            if network_interfaces is not autoboto.ShapeBase._NOT_SET:
                _params['network_interfaces'] = network_interfaces
            if private_ip_address is not autoboto.ShapeBase._NOT_SET:
                _params['private_ip_address'] = private_ip_address
            if elastic_gpu_specification is not autoboto.ShapeBase._NOT_SET:
                _params['elastic_gpu_specification'] = elastic_gpu_specification
            if tag_specifications is not autoboto.ShapeBase._NOT_SET:
                _params['tag_specifications'] = tag_specifications
            if launch_template is not autoboto.ShapeBase._NOT_SET:
                _params['launch_template'] = launch_template
            if instance_market_options is not autoboto.ShapeBase._NOT_SET:
                _params['instance_market_options'] = instance_market_options
            if credit_specification is not autoboto.ShapeBase._NOT_SET:
                _params['credit_specification'] = credit_specification
            if cpu_options is not autoboto.ShapeBase._NOT_SET:
    ...
    def run_scheduled_instances(
        ...
        *,
        ...
        if _request is None:
            ...
            if launch_specification is not autoboto.ShapeBase._NOT_SET:
                _params['launch_specification'] = launch_specification
            if scheduled_instance_id is not autoboto.ShapeBase._NOT_SET:
