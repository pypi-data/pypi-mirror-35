...
class Client:
    ...
    def create_device_pool(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if project_arn is not autoboto.ShapeBase._NOT_SET:
                _params['project_arn'] = project_arn
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if rules is not autoboto.ShapeBase._NOT_SET:
                _params['rules'] = rules
    ...
    def create_instance_profile(
        ...
        *,
        name: str,
        description: str = autoboto.ShapeBase._NOT_SET,
        package_cleanup: bool = autoboto.ShapeBase._NOT_SET,
        exclude_app_packages_from_cleanup: typing.List[str] = autoboto.
        ShapeBase._NOT_SET,
        reboot_after_use: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if description is not autoboto.ShapeBase._NOT_SET:
                _params['description'] = description
            if package_cleanup is not autoboto.ShapeBase._NOT_SET:
                _params['package_cleanup'] = package_cleanup
            if exclude_app_packages_from_cleanup is not autoboto.ShapeBase._NOT_SET:
                _params['exclude_app_packages_from_cleanup'
                       ] = exclude_app_packages_from_cleanup
            if reboot_after_use is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_network_profile(
        ...
        *,
        ...
        name: str,
        description: str = autoboto.ShapeBase._NOT_SET,
        type: shapes.NetworkProfileType = autoboto.ShapeBase._NOT_SET,
        uplink_bandwidth_bits: int = autoboto.ShapeBase._NOT_SET,
        downlink_bandwidth_bits: int = autoboto.ShapeBase._NOT_SET,
        uplink_delay_ms: int = autoboto.ShapeBase._NOT_SET,
        downlink_delay_ms: int = autoboto.ShapeBase._NOT_SET,
        uplink_jitter_ms: int = autoboto.ShapeBase._NOT_SET,
        downlink_jitter_ms: int = autoboto.ShapeBase._NOT_SET,
        uplink_loss_percent: int = autoboto.ShapeBase._NOT_SET,
        downlink_loss_percent: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if type is not autoboto.ShapeBase._NOT_SET:
                _params['type'] = type
            if uplink_bandwidth_bits is not autoboto.ShapeBase._NOT_SET:
                _params['uplink_bandwidth_bits'] = uplink_bandwidth_bits
            if downlink_bandwidth_bits is not autoboto.ShapeBase._NOT_SET:
                _params['downlink_bandwidth_bits'] = downlink_bandwidth_bits
            if uplink_delay_ms is not autoboto.ShapeBase._NOT_SET:
                _params['uplink_delay_ms'] = uplink_delay_ms
            if downlink_delay_ms is not autoboto.ShapeBase._NOT_SET:
                _params['downlink_delay_ms'] = downlink_delay_ms
            if uplink_jitter_ms is not autoboto.ShapeBase._NOT_SET:
                _params['uplink_jitter_ms'] = uplink_jitter_ms
            if downlink_jitter_ms is not autoboto.ShapeBase._NOT_SET:
                _params['downlink_jitter_ms'] = downlink_jitter_ms
            if uplink_loss_percent is not autoboto.ShapeBase._NOT_SET:
                _params['uplink_loss_percent'] = uplink_loss_percent
            if downlink_loss_percent is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_project(
        ...
        *,
        name: str,
        default_job_timeout_minutes: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if default_job_timeout_minutes is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_remote_access_session(
        ...
        *,
        project_arn: str,
        device_arn: str,
        instance_arn: str = autoboto.ShapeBase._NOT_SET,
        ssh_public_key: str = autoboto.ShapeBase._NOT_SET,
        remote_debug_enabled: bool = autoboto.ShapeBase._NOT_SET,
        remote_record_enabled: bool = autoboto.ShapeBase._NOT_SET,
        remote_record_app_arn: str = autoboto.ShapeBase._NOT_SET,
        name: str = autoboto.ShapeBase._NOT_SET,
        client_id: str = autoboto.ShapeBase._NOT_SET,
        configuration: shapes.CreateRemoteAccessSessionConfiguration = autoboto.
        ShapeBase._NOT_SET,
        interaction_mode: shapes.InteractionMode = autoboto.ShapeBase._NOT_SET,
        skip_app_resign: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if project_arn is not autoboto.ShapeBase._NOT_SET:
                _params['project_arn'] = project_arn
            if device_arn is not autoboto.ShapeBase._NOT_SET:
                _params['device_arn'] = device_arn
            if instance_arn is not autoboto.ShapeBase._NOT_SET:
            ...
            if remote_debug_enabled is not autoboto.ShapeBase._NOT_SET:
                _params['remote_debug_enabled'] = remote_debug_enabled
            if remote_record_enabled is not autoboto.ShapeBase._NOT_SET:
                _params['remote_record_enabled'] = remote_record_enabled
            if remote_record_app_arn is not autoboto.ShapeBase._NOT_SET:
            ...
            if interaction_mode is not autoboto.ShapeBase._NOT_SET:
                _params['interaction_mode'] = interaction_mode
            if skip_app_resign is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_vpce_configuration(
        ...
        *,
        ...
        vpce_configuration_description: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if vpce_configuration_name is not autoboto.ShapeBase._NOT_SET:
                _params['vpce_configuration_name'] = vpce_configuration_name
            if vpce_service_name is not autoboto.ShapeBase._NOT_SET:
                _params['vpce_service_name'] = vpce_service_name
            if service_dns_name is not autoboto.ShapeBase._NOT_SET:
                _params['service_dns_name'] = service_dns_name
            if vpce_configuration_description is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_device_pool(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if arn is not autoboto.ShapeBase._NOT_SET:
                _params['arn'] = arn
    ...
    def get_device_pool_compatibility(
        ...
        *,
        device_pool_arn: str,
        app_arn: str = autoboto.ShapeBase._NOT_SET,
        test_type: shapes.TestType = autoboto.ShapeBase._NOT_SET,
        test: shapes.ScheduleRunTest = autoboto.ShapeBase._NOT_SET,
        configuration: shapes.ScheduleRunConfiguration = autoboto.ShapeBase.
        _NOT_SET,
        ...
        if _request is None:
            _params = {}
            if device_pool_arn is not autoboto.ShapeBase._NOT_SET:
                _params['device_pool_arn'] = device_pool_arn
            if app_arn is not autoboto.ShapeBase._NOT_SET:
                _params['app_arn'] = app_arn
            if test_type is not autoboto.ShapeBase._NOT_SET:
    ...
    def install_to_remote_access_session(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if remote_access_session_arn is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_device_pools(
        ...
        *,
        arn: str,
        type: shapes.DevicePoolType = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
    ...
    def list_devices(
        ...
        *,
        arn: str = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
    ...
    def list_uploads(
        ...
        *,
        arn: str,
        type: shapes.UploadType = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
    ...
    def purchase_offering(
        ...
        *,
        ...
        quantity: int = autoboto.ShapeBase._NOT_SET,
        offering_promotion_id: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if offering_promotion_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def schedule_run(
        ...
        *,
        ...
        configuration: shapes.ScheduleRunConfiguration = autoboto.ShapeBase.
        _NOT_SET,
        execution_configuration: shapes.ExecutionConfiguration = autoboto.
        ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if configuration is not autoboto.ShapeBase._NOT_SET:
                _params['configuration'] = configuration
            if execution_configuration is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_device_instance(
        ...
        *,
        arn: str,
        profile_arn: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if arn is not autoboto.ShapeBase._NOT_SET:
                _params['arn'] = arn
            if profile_arn is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_device_pool(
        ...
        *,
        ...
        name: str = autoboto.ShapeBase._NOT_SET,
        description: str = autoboto.ShapeBase._NOT_SET,
        rules: typing.List[shapes.Rule] = autoboto.ShapeBase._NOT_SET,
    ...
    def update_upload(
        ...
        *,
        ...
        name: str = autoboto.ShapeBase._NOT_SET,
        content_type: str = autoboto.ShapeBase._NOT_SET,
        edit_content: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if content_type is not autoboto.ShapeBase._NOT_SET:
                _params['content_type'] = content_type
            if edit_content is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_vpce_configuration(
        ...
        *,
        arn: str,
        vpce_configuration_name: str = autoboto.ShapeBase._NOT_SET,
        vpce_service_name: str = autoboto.ShapeBase._NOT_SET,
        service_dns_name: str = autoboto.ShapeBase._NOT_SET,
        vpce_configuration_description: str = autoboto.ShapeBase._NOT_SET,
