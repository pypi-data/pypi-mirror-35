...
class AdditionalLimit(autoboto.ShapeBase):
    ...
    limit_name: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class EBSOptions(autoboto.ShapeBase):
    ...
    ebs_enabled: bool = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class GetUpgradeStatusResponse(autoboto.ShapeBase):
    ...
    upgrade_name: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
