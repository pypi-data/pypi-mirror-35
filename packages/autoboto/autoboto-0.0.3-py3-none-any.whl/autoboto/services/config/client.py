...
class Client:
    ...
    def batch_get_resource_config(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if resource_keys is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_aggregation_authorization(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if authorized_account_id is not autoboto.ShapeBase._NOT_SET:
                _params['authorized_account_id'] = authorized_account_id
            if authorized_aws_region is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_config_rule(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if config_rule_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_configuration_aggregator(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if configuration_aggregator_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_configuration_recorder(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if configuration_recorder_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_delivery_channel(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if delivery_channel_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_pending_aggregation_request(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if requester_account_id is not autoboto.ShapeBase._NOT_SET:
                _params['requester_account_id'] = requester_account_id
            if requester_aws_region is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_retention_configuration(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if retention_configuration_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_aggregate_compliance_by_config_rules(
        ...
        *,
        configuration_aggregator_name: str,
        filters: shapes.ConfigRuleComplianceFilters = autoboto.ShapeBase.
        _NOT_SET,
    ...
    def describe_compliance_by_config_rule(
        ...
        *,
        config_rule_names: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if config_rule_names is not autoboto.ShapeBase._NOT_SET:
                _params['config_rule_names'] = config_rule_names
            if compliance_types is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_compliance_by_resource(
        ...
        *,
        ...
        resource_id: str = autoboto.ShapeBase._NOT_SET,
        compliance_types: typing.List[shapes.ComplianceType
                                     ] = autoboto.ShapeBase._NOT_SET,
        limit: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
    ...
    def describe_configuration_aggregator_sources_status(
        ...
        *,
        ...
        if _request is None:
            ...
            if update_status is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_configuration_aggregators(
        ...
        *,
        configuration_aggregator_names: typing.List[str] = autoboto.ShapeBase.
        _NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        limit: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if configuration_aggregator_names is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_configuration_recorder_status(
        ...
        *,
        configuration_recorder_names: typing.List[str] = autoboto.ShapeBase.
        _NOT_SET,
        ...
        if _request is None:
            _params = {}
            if configuration_recorder_names is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_delivery_channel_status(
        ...
        *,
        delivery_channel_names: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if delivery_channel_names is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_retention_configurations(
        ...
        *,
        retention_configuration_names: typing.List[str] = autoboto.ShapeBase.
        _NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if retention_configuration_names is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_aggregate_compliance_details_by_config_rule(
        ...
        *,
        ...
        account_id: str,
        aws_region: str,
        compliance_type: shapes.ComplianceType = autoboto.ShapeBase._NOT_SET,
        limit: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if aws_region is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_aggregate_config_rule_compliance_summary(
        ...
        *,
        configuration_aggregator_name: str,
        filters: shapes.ConfigRuleComplianceSummaryFilters = autoboto.ShapeBase.
        _NOT_SET,
        group_by_key: shapes.ConfigRuleComplianceSummaryGroupKey = autoboto.
        ShapeBase._NOT_SET,
        limit: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if filters is not autoboto.ShapeBase._NOT_SET:
                _params['filters'] = filters
            if group_by_key is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_resource_config_history(
        ...
        *,
        ...
        resource_id: str,
        later_time: datetime.datetime = autoboto.ShapeBase._NOT_SET,
        earlier_time: datetime.datetime = autoboto.ShapeBase._NOT_SET,
        chronological_order: shapes.ChronologicalOrder = autoboto.ShapeBase.
        _NOT_SET,
        limit: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if resource_id is not autoboto.ShapeBase._NOT_SET:
                _params['resource_id'] = resource_id
            if later_time is not autoboto.ShapeBase._NOT_SET:
                _params['later_time'] = later_time
            if earlier_time is not autoboto.ShapeBase._NOT_SET:
                _params['earlier_time'] = earlier_time
            if chronological_order is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_discovered_resources(
        ...
        *,
        ...
        limit: int = autoboto.ShapeBase._NOT_SET,
        include_deleted_resources: bool = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if limit is not autoboto.ShapeBase._NOT_SET:
                _params['limit'] = limit
            if include_deleted_resources is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_config_rule(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if config_rule is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_configuration_aggregator(
        ...
        *,
        ...
        OrganizationAggregationSource = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if account_aggregation_sources is not autoboto.ShapeBase._NOT_SET:
                _params['account_aggregation_sources'
                       ] = account_aggregation_sources
            if organization_aggregation_source is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_configuration_recorder(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if configuration_recorder is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_delivery_channel(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if delivery_channel is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_evaluations(
        ...
        *,
        result_token: str,
        evaluations: typing.List[shapes.Evaluation
                                ] = autoboto.ShapeBase._NOT_SET,
        test_mode: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if result_token is not autoboto.ShapeBase._NOT_SET:
                _params['result_token'] = result_token
            if evaluations is not autoboto.ShapeBase._NOT_SET:
                _params['evaluations'] = evaluations
            if test_mode is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_retention_configuration(
        ...
        **default**. When you have a `RetentionConfiguration` object named **default** ,
        ...
        if _request is None:
            _params = {}
            if retention_period_in_days is not autoboto.ShapeBase._NOT_SET:
