...
class Client:
    ...
    def add_instance_fleet(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if cluster_id is not autoboto.ShapeBase._NOT_SET:
                _params['cluster_id'] = cluster_id
            if instance_fleet is not autoboto.ShapeBase._NOT_SET:
    ...
    def add_instance_groups(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if instance_groups is not autoboto.ShapeBase._NOT_SET:
                _params['instance_groups'] = instance_groups
            if job_flow_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def add_job_flow_steps(
        ...
        *,
        ...
        if _request is None:
            ...
            if job_flow_id is not autoboto.ShapeBase._NOT_SET:
                _params['job_flow_id'] = job_flow_id
            if steps is not autoboto.ShapeBase._NOT_SET:
                _params['steps'] = steps
    ...
    def cancel_steps(
        ...
        *,
        cluster_id: str = autoboto.ShapeBase._NOT_SET,
        step_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if cluster_id is not autoboto.ShapeBase._NOT_SET:
                _params['cluster_id'] = cluster_id
            if step_ids is not autoboto.ShapeBase._NOT_SET:
        ...
        *,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if security_configuration is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_job_flows(
        ...
        *,
        created_after: datetime.datetime = autoboto.ShapeBase._NOT_SET,
        created_before: datetime.datetime = autoboto.ShapeBase._NOT_SET,
        job_flow_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if created_after is not autoboto.ShapeBase._NOT_SET:
                _params['created_after'] = created_after
            if created_before is not autoboto.ShapeBase._NOT_SET:
                _params['created_before'] = created_before
            if job_flow_ids is not autoboto.ShapeBase._NOT_SET:
                _params['job_flow_ids'] = job_flow_ids
            if job_flow_states is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_step(
        ...
        *,
        ...
        if _request is None:
            ...
            if cluster_id is not autoboto.ShapeBase._NOT_SET:
                _params['cluster_id'] = cluster_id
            if step_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_clusters(
        ...
        *,
        created_after: datetime.datetime = autoboto.ShapeBase._NOT_SET,
        created_before: datetime.datetime = autoboto.ShapeBase._NOT_SET,
        cluster_states: typing.List[shapes.ClusterState
                                   ] = autoboto.ShapeBase._NOT_SET,
        marker: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if created_before is not autoboto.ShapeBase._NOT_SET:
                _params['created_before'] = created_before
            if cluster_states is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_instances(
        ...
        *,
        cluster_id: str,
        instance_group_id: str = autoboto.ShapeBase._NOT_SET,
        instance_group_types: typing.List[shapes.InstanceGroupType
                                         ] = autoboto.ShapeBase._NOT_SET,
        instance_fleet_id: str = autoboto.ShapeBase._NOT_SET,
        instance_fleet_type: shapes.InstanceFleetType = autoboto.ShapeBase.
        _NOT_SET,
        instance_states: typing.List[shapes.InstanceState
                                    ] = autoboto.ShapeBase._NOT_SET,
        marker: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if cluster_id is not autoboto.ShapeBase._NOT_SET:
                _params['cluster_id'] = cluster_id
            if instance_group_id is not autoboto.ShapeBase._NOT_SET:
                _params['instance_group_id'] = instance_group_id
            if instance_group_types is not autoboto.ShapeBase._NOT_SET:
                _params['instance_group_types'] = instance_group_types
            if instance_fleet_id is not autoboto.ShapeBase._NOT_SET:
                _params['instance_fleet_id'] = instance_fleet_id
            if instance_fleet_type is not autoboto.ShapeBase._NOT_SET:
                _params['instance_fleet_type'] = instance_fleet_type
            if instance_states is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_steps(
        ...
        *,
        cluster_id: str,
        step_states: typing.List[shapes.StepState
                                ] = autoboto.ShapeBase._NOT_SET,
        step_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        marker: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if cluster_id is not autoboto.ShapeBase._NOT_SET:
                _params['cluster_id'] = cluster_id
            if step_states is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_auto_scaling_policy(
        ...
        *,
        ...
        if _request is None:
            ...
            if instance_group_id is not autoboto.ShapeBase._NOT_SET:
                _params['instance_group_id'] = instance_group_id
            if auto_scaling_policy is not autoboto.ShapeBase._NOT_SET:
    ...
    def run_job_flow(
        ...
        *,
        ...
        ami_version: str = autoboto.ShapeBase._NOT_SET,
        release_label: str = autoboto.ShapeBase._NOT_SET,
        steps: typing.List[shapes.StepConfig] = autoboto.ShapeBase._NOT_SET,
        bootstrap_actions: typing.List[shapes.BootstrapActionConfig
                                      ] = autoboto.ShapeBase._NOT_SET,
        supported_products: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        new_supported_products: typing.List[shapes.SupportedProductConfig
                                           ] = autoboto.ShapeBase._NOT_SET,
        applications: typing.List[shapes.Application
                                 ] = autoboto.ShapeBase._NOT_SET,
        configurations: typing.List[shapes.Configuration
                                   ] = autoboto.ShapeBase._NOT_SET,
        visible_to_all_users: bool = autoboto.ShapeBase._NOT_SET,
        job_flow_role: str = autoboto.ShapeBase._NOT_SET,
        service_role: str = autoboto.ShapeBase._NOT_SET,
        tags: typing.List[shapes.Tag] = autoboto.ShapeBase._NOT_SET,
        security_configuration: str = autoboto.ShapeBase._NOT_SET,
        auto_scaling_role: str = autoboto.ShapeBase._NOT_SET,
        scale_down_behavior: shapes.ScaleDownBehavior = autoboto.ShapeBase.
        _NOT_SET,
        custom_ami_id: str = autoboto.ShapeBase._NOT_SET,
        ebs_root_volume_size: int = autoboto.ShapeBase._NOT_SET,
        repo_upgrade_on_boot: shapes.RepoUpgradeOnBoot = autoboto.ShapeBase.
        _NOT_SET,
        kerberos_attributes: shapes.KerberosAttributes = autoboto.ShapeBase.
        _NOT_SET,
        ...
        if _request is None:
            ...
            if ami_version is not autoboto.ShapeBase._NOT_SET:
                _params['ami_version'] = ami_version
            if release_label is not autoboto.ShapeBase._NOT_SET:
                _params['release_label'] = release_label
            if steps is not autoboto.ShapeBase._NOT_SET:
                _params['steps'] = steps
            if bootstrap_actions is not autoboto.ShapeBase._NOT_SET:
                _params['bootstrap_actions'] = bootstrap_actions
            if supported_products is not autoboto.ShapeBase._NOT_SET:
                _params['supported_products'] = supported_products
            if new_supported_products is not autoboto.ShapeBase._NOT_SET:
                _params['new_supported_products'] = new_supported_products
            if applications is not autoboto.ShapeBase._NOT_SET:
                _params['applications'] = applications
            if configurations is not autoboto.ShapeBase._NOT_SET:
                _params['configurations'] = configurations
            if visible_to_all_users is not autoboto.ShapeBase._NOT_SET:
                _params['visible_to_all_users'] = visible_to_all_users
            if job_flow_role is not autoboto.ShapeBase._NOT_SET:
            ...
            if security_configuration is not autoboto.ShapeBase._NOT_SET:
                _params['security_configuration'] = security_configuration
            if auto_scaling_role is not autoboto.ShapeBase._NOT_SET:
                _params['auto_scaling_role'] = auto_scaling_role
            if scale_down_behavior is not autoboto.ShapeBase._NOT_SET:
                _params['scale_down_behavior'] = scale_down_behavior
            if custom_ami_id is not autoboto.ShapeBase._NOT_SET:
                _params['custom_ami_id'] = custom_ami_id
            if ebs_root_volume_size is not autoboto.ShapeBase._NOT_SET:
                _params['ebs_root_volume_size'] = ebs_root_volume_size
            if repo_upgrade_on_boot is not autoboto.ShapeBase._NOT_SET:
                _params['repo_upgrade_on_boot'] = repo_upgrade_on_boot
            if kerberos_attributes is not autoboto.ShapeBase._NOT_SET:
    ...
    def set_termination_protection(
        ...
        *,
        ...
        if _request is None:
            ...
            if job_flow_ids is not autoboto.ShapeBase._NOT_SET:
                _params['job_flow_ids'] = job_flow_ids
            if termination_protected is not autoboto.ShapeBase._NOT_SET:
