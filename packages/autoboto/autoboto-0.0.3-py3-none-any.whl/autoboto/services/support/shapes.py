...
class AddAttachmentsToSetResponse(autoboto.ShapeBase):
    ...
    expiry_time: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class AddCommunicationToCaseRequest(autoboto.ShapeBase):
    ...
    case_id: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class CaseDetails(autoboto.ShapeBase):
    ...
    # string.
    display_id: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    service_code: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # The category of problem for the AWS Support case.
    category_code: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )

    # The code for the severity level returned by the call to
    # DescribeSeverityLevels.
    severity_code: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )

    # The email address of the account that submitted the case.
    submitted_by: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # The time that the case was case created in the AWS Support Center.
    time_created: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class CreateCaseRequest(autoboto.ShapeBase):
    ...
    issue_type: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class DescribeCasesRequest(autoboto.ShapeBase):
    ...
    after_time: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # The end date for a filtered date search on support case communications.
    # Case communications are available for 12 months after creation.
    before_time: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class DescribeTrustedAdvisorCheckResultRequest(autoboto.ShapeBase):
    ...
    check_id: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
