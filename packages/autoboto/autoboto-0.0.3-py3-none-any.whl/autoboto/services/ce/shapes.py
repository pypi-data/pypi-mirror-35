...
class DimensionValues(autoboto.ShapeBase):
    ...
    key: "Dimension" = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class ESInstanceDetails(autoboto.ShapeBase):
    ...
    instance_size: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
class GetDimensionValuesResponse(autoboto.ShapeBase):
    ...
    return_size: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # The total number of search results.
    total_size: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class ReservationAggregates(autoboto.ShapeBase):
    ...
    unused_hours: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class ReservationPurchaseRecommendationDetail(autoboto.ShapeBase):
    ...
    upfront_cost: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class ResultByTime(autoboto.ShapeBase):
    ...
    estimated: bool = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
