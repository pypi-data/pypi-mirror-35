...
class Client:
    ...
    def add_application_cloud_watch_logging_option(
        ...
        *,
        ...
        if _request is None:
            ...
            if current_application_version_id is not autoboto.ShapeBase._NOT_SET:
                _params['current_application_version_id'
                       ] = current_application_version_id
            if cloud_watch_logging_option is not autoboto.ShapeBase._NOT_SET:
    ...
    def add_application_input_processing_configuration(
        ...
        *,
        ...
        if _request is None:
            ...
            if input_processing_configuration is not autoboto.ShapeBase._NOT_SET:
    ...
    def add_application_reference_data_source(
        ...
        *,
        ...
        if _request is None:
            ...
            if reference_data_source is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_application(
        ...
        *,
        application_name: str,
        application_description: str = autoboto.ShapeBase._NOT_SET,
        inputs: typing.List[shapes.Input] = autoboto.ShapeBase._NOT_SET,
        outputs: typing.List[shapes.Output] = autoboto.ShapeBase._NOT_SET,
        cloud_watch_logging_options: typing.List[shapes.CloudWatchLoggingOption
                                                ] = autoboto.ShapeBase._NOT_SET,
        application_code: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if application_name is not autoboto.ShapeBase._NOT_SET:
                _params['application_name'] = application_name
            if application_description is not autoboto.ShapeBase._NOT_SET:
            ...
            if cloud_watch_logging_options is not autoboto.ShapeBase._NOT_SET:
                _params['cloud_watch_logging_options'
                       ] = cloud_watch_logging_options
            if application_code is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_application(
        ...
        *,
        ...
        if _request is None:
            ...
            if application_name is not autoboto.ShapeBase._NOT_SET:
                _params['application_name'] = application_name
            if create_timestamp is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_application_cloud_watch_logging_option(
        ...
        *,
        ...
        if _request is None:
            ...
            if cloud_watch_logging_option_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_application_output(
        ...
        *,
        ...
        if _request is None:
            ...
            if output_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_application_reference_data_source(
        ...
        *,
        ...
        if _request is None:
            ...
            if reference_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def discover_input_schema(
        ...
        *,
        ...
        InputStartingPositionConfiguration = autoboto.ShapeBase._NOT_SET,
        s3_configuration: shapes.S3Configuration = autoboto.ShapeBase._NOT_SET,
        input_processing_configuration: shapes.
        InputProcessingConfiguration = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if input_starting_position_configuration is not autoboto.ShapeBase._NOT_SET:
                _params['input_starting_position_configuration'
                       ] = input_starting_position_configuration
            if s3_configuration is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_applications(
        ...
        *,
        ...
        exclusive_start_application_name: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if limit is not autoboto.ShapeBase._NOT_SET:
                _params['limit'] = limit
            if exclusive_start_application_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def start_application(
        ...
        *,
        ...
        if _request is None:
            ...
            if application_name is not autoboto.ShapeBase._NOT_SET:
                _params['application_name'] = application_name
            if input_configurations is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_application(
        ...
        *,
        ...
        if _request is None:
            ...
            if application_update is not autoboto.ShapeBase._NOT_SET:
