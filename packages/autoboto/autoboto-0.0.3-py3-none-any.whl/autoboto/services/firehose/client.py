...
class Client:
    ...
    def create_delivery_stream(
        ...
        *,
        ...
        delivery_stream_type: shapes.DeliveryStreamType = autoboto.ShapeBase.
        _NOT_SET,
        kinesis_stream_source_configuration: shapes.
        KinesisStreamSourceConfiguration = autoboto.ShapeBase._NOT_SET,
        s3_destination_configuration: shapes.
        S3DestinationConfiguration = autoboto.ShapeBase._NOT_SET,
        extended_s3_destination_configuration: shapes.
        ExtendedS3DestinationConfiguration = autoboto.ShapeBase._NOT_SET,
        redshift_destination_configuration: shapes.
        RedshiftDestinationConfiguration = autoboto.ShapeBase._NOT_SET,
        elasticsearch_destination_configuration: shapes.
        ElasticsearchDestinationConfiguration = autoboto.ShapeBase._NOT_SET,
        splunk_destination_configuration: shapes.
        SplunkDestinationConfiguration = autoboto.ShapeBase._NOT_SET,
        ...
        **RedshiftDestinationConfiguration** , or **SplunkDestinationConfiguration**.
        ...
        if _request is None:
            _params = {}
            if delivery_stream_name is not autoboto.ShapeBase._NOT_SET:
                _params['delivery_stream_name'] = delivery_stream_name
            if delivery_stream_type is not autoboto.ShapeBase._NOT_SET:
                _params['delivery_stream_type'] = delivery_stream_type
            if kinesis_stream_source_configuration is not autoboto.ShapeBase._NOT_SET:
                _params['kinesis_stream_source_configuration'
                       ] = kinesis_stream_source_configuration
            if s3_destination_configuration is not autoboto.ShapeBase._NOT_SET:
                _params['s3_destination_configuration'
                       ] = s3_destination_configuration
            if extended_s3_destination_configuration is not autoboto.ShapeBase._NOT_SET:
                _params['extended_s3_destination_configuration'
                       ] = extended_s3_destination_configuration
            if redshift_destination_configuration is not autoboto.ShapeBase._NOT_SET:
                _params['redshift_destination_configuration'
                       ] = redshift_destination_configuration
            if elasticsearch_destination_configuration is not autoboto.ShapeBase._NOT_SET:
                _params['elasticsearch_destination_configuration'
                       ] = elasticsearch_destination_configuration
            if splunk_destination_configuration is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_delivery_stream(
        ...
        *,
        ...
        exclusive_start_destination_id: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if limit is not autoboto.ShapeBase._NOT_SET:
                _params['limit'] = limit
            if exclusive_start_destination_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_delivery_streams(
        ...
        *,
        ...
        delivery_stream_type: shapes.DeliveryStreamType = autoboto.ShapeBase.
        _NOT_SET,
        exclusive_start_delivery_stream_name: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if delivery_stream_type is not autoboto.ShapeBase._NOT_SET:
                _params['delivery_stream_type'] = delivery_stream_type
            if exclusive_start_delivery_stream_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_destination(
        ...
        *,
        ...
        destination_id: str,
        s3_destination_update: shapes.S3DestinationUpdate = autoboto.ShapeBase.
        _NOT_SET,
        extended_s3_destination_update: shapes.
        ExtendedS3DestinationUpdate = autoboto.ShapeBase._NOT_SET,
        redshift_destination_update: shapes.
        RedshiftDestinationUpdate = autoboto.ShapeBase._NOT_SET,
        elasticsearch_destination_update: shapes.
        ElasticsearchDestinationUpdate = autoboto.ShapeBase._NOT_SET,
        splunk_destination_update: shapes.SplunkDestinationUpdate = autoboto.
        ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if delivery_stream_name is not autoboto.ShapeBase._NOT_SET:
                _params['delivery_stream_name'] = delivery_stream_name
            if current_delivery_stream_version_id is not autoboto.ShapeBase._NOT_SET:
                _params['current_delivery_stream_version_id'
                       ] = current_delivery_stream_version_id
            if destination_id is not autoboto.ShapeBase._NOT_SET:
                _params['destination_id'] = destination_id
            if s3_destination_update is not autoboto.ShapeBase._NOT_SET:
                _params['s3_destination_update'] = s3_destination_update
            if extended_s3_destination_update is not autoboto.ShapeBase._NOT_SET:
                _params['extended_s3_destination_update'
                       ] = extended_s3_destination_update
            if redshift_destination_update is not autoboto.ShapeBase._NOT_SET:
                _params['redshift_destination_update'
                       ] = redshift_destination_update
            if elasticsearch_destination_update is not autoboto.ShapeBase._NOT_SET:
                _params['elasticsearch_destination_update'
                       ] = elasticsearch_destination_update
            if splunk_destination_update is not autoboto.ShapeBase._NOT_SET:
