...
class BufferingHints(autoboto.ShapeBase):
    ...
    # MB or higher.
    size_in_m_bs: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class CopyCommand(autoboto.ShapeBase):
    ...
    copy_options: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
@dataclasses.dataclass
class CreateDeliveryStreamOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DeleteDeliveryStreamOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return []
...
@dataclasses.dataclass
class DescribeDeliveryStreamOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
class ElasticsearchDestinationConfiguration(autoboto.ShapeBase):
    ...
    domain_arn: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
@dataclasses.dataclass
class ListDeliveryStreamsOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class ListTagsForDeliveryStreamOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class PutRecordBatchOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
class PutRecordBatchResponseEntry(autoboto.ShapeBase):
    ...
    record_id: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
@dataclasses.dataclass
class PutRecordOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
class Record(autoboto.ShapeBase):
    ...
    data: typing.Any = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class SplunkDestinationConfiguration(autoboto.ShapeBase):
    ...
    # sends your data.
    hec_endpoint: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    # new HEC endpoint.
    hec_token: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
@dataclasses.dataclass
class TagDeliveryStreamOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return []
...
@dataclasses.dataclass
class UntagDeliveryStreamOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return []
...
@dataclasses.dataclass
class UpdateDestinationOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return []
