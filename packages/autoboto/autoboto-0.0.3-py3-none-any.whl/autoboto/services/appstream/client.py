...
class Client:
    ...
    def associate_fleet(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if fleet_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def copy_image(
        ...
        *,
        ...
        destination_image_description: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if source_image_name is not autoboto.ShapeBase._NOT_SET:
                _params['source_image_name'] = source_image_name
            if destination_image_name is not autoboto.ShapeBase._NOT_SET:
            ...
            if destination_image_description is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_directory_config(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if directory_name is not autoboto.ShapeBase._NOT_SET:
                _params['directory_name'] = directory_name
            if organizational_unit_distinguished_names is not autoboto.ShapeBase._NOT_SET:
                _params['organizational_unit_distinguished_names'
                       ] = organizational_unit_distinguished_names
            if service_account_credentials is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_fleet(
        ...
        *,
        ...
        image_name: str = autoboto.ShapeBase._NOT_SET,
        image_arn: str = autoboto.ShapeBase._NOT_SET,
        fleet_type: shapes.FleetType = autoboto.ShapeBase._NOT_SET,
        vpc_config: shapes.VpcConfig = autoboto.ShapeBase._NOT_SET,
        max_user_duration_in_seconds: int = autoboto.ShapeBase._NOT_SET,
        disconnect_timeout_in_seconds: int = autoboto.ShapeBase._NOT_SET,
        description: str = autoboto.ShapeBase._NOT_SET,
        display_name: str = autoboto.ShapeBase._NOT_SET,
        enable_default_internet_access: bool = autoboto.ShapeBase._NOT_SET,
        domain_join_info: shapes.DomainJoinInfo = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if compute_capacity is not autoboto.ShapeBase._NOT_SET:
                _params['compute_capacity'] = compute_capacity
            if image_name is not autoboto.ShapeBase._NOT_SET:
                _params['image_name'] = image_name
            if image_arn is not autoboto.ShapeBase._NOT_SET:
            ...
            if max_user_duration_in_seconds is not autoboto.ShapeBase._NOT_SET:
                _params['max_user_duration_in_seconds'
                       ] = max_user_duration_in_seconds
            if disconnect_timeout_in_seconds is not autoboto.ShapeBase._NOT_SET:
            ...
            if enable_default_internet_access is not autoboto.ShapeBase._NOT_SET:
                _params['enable_default_internet_access'
                       ] = enable_default_internet_access
            if domain_join_info is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_image_builder(
        ...
        *,
        ...
        enable_default_internet_access: bool = autoboto.ShapeBase._NOT_SET,
        domain_join_info: shapes.DomainJoinInfo = autoboto.ShapeBase._NOT_SET,
        appstream_agent_version: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if domain_join_info is not autoboto.ShapeBase._NOT_SET:
                _params['domain_join_info'] = domain_join_info
            if appstream_agent_version is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_image_builder_streaming_url(
        ...
        *,
        name: str,
        validity: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if validity is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_stack(
        ...
        *,
        ...
        redirect_url: str = autoboto.ShapeBase._NOT_SET,
        feedback_url: str = autoboto.ShapeBase._NOT_SET,
        user_settings: typing.List[shapes.UserSetting
                                  ] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if display_name is not autoboto.ShapeBase._NOT_SET:
                _params['display_name'] = display_name
            if storage_connectors is not autoboto.ShapeBase._NOT_SET:
                _params['storage_connectors'] = storage_connectors
            if redirect_url is not autoboto.ShapeBase._NOT_SET:
                _params['redirect_url'] = redirect_url
            if feedback_url is not autoboto.ShapeBase._NOT_SET:
                _params['feedback_url'] = feedback_url
            if user_settings is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_streaming_url(
        ...
        *,
        ...
        fleet_name: str,
        user_id: str,
        application_id: str = autoboto.ShapeBase._NOT_SET,
        validity: int = autoboto.ShapeBase._NOT_SET,
        session_context: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if application_id is not autoboto.ShapeBase._NOT_SET:
                _params['application_id'] = application_id
            if validity is not autoboto.ShapeBase._NOT_SET:
                _params['validity'] = validity
            if session_context is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_image_permissions(
        ...
        *,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if shared_account_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_directory_configs(
        ...
        *,
        directory_names: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if directory_names is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_image_permissions(
        ...
        *,
        name: str,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        shared_aws_account_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
    ) -> shapes.DescribeImagePermissionsResult:
        """
        Retrieves a list that describes the permissions for a private image that you
        own.
        """
        if _request is None:
            _params = {}
            ...
            if max_results is not autoboto.ShapeBase._NOT_SET:
                _params['max_results'] = max_results
            if shared_aws_account_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_images(
        ...
        *,
        names: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        arns: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        type: shapes.VisibilityType = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if names is not autoboto.ShapeBase._NOT_SET:
                _params['names'] = names
            if arns is not autoboto.ShapeBase._NOT_SET:
                _params['arns'] = arns
    ...
    def describe_sessions(
        ...
        *,
        ...
        authentication_type: shapes.AuthenticationType = autoboto.ShapeBase.
        _NOT_SET,
        ...
        if _request is None:
            ...
            if limit is not autoboto.ShapeBase._NOT_SET:
                _params['limit'] = limit
            if authentication_type is not autoboto.ShapeBase._NOT_SET:
    ...
    def expire_session(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if session_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_directory_config(
        ...
        *,
        directory_name: str,
        organizational_unit_distinguished_names: typing.List[str] = autoboto.
        ShapeBase._NOT_SET,
        service_account_credentials: shapes.
        ServiceAccountCredentials = autoboto.ShapeBase._NOT_SET,
    ...
    def update_fleet(
        ...
        *,
        ...
        compute_capacity: shapes.ComputeCapacity = autoboto.ShapeBase._NOT_SET,
        vpc_config: shapes.VpcConfig = autoboto.ShapeBase._NOT_SET,
        max_user_duration_in_seconds: int = autoboto.ShapeBase._NOT_SET,
        disconnect_timeout_in_seconds: int = autoboto.ShapeBase._NOT_SET,
        delete_vpc_config: bool = autoboto.ShapeBase._NOT_SET,
        description: str = autoboto.ShapeBase._NOT_SET,
        display_name: str = autoboto.ShapeBase._NOT_SET,
        enable_default_internet_access: bool = autoboto.ShapeBase._NOT_SET,
        domain_join_info: shapes.DomainJoinInfo = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if delete_vpc_config is not autoboto.ShapeBase._NOT_SET:
            ...
            if domain_join_info is not autoboto.ShapeBase._NOT_SET:
                _params['domain_join_info'] = domain_join_info
            if attributes_to_delete is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_image_permissions(
        ...
        *,
        ...
        if _request is None:
            ...
            if shared_account_id is not autoboto.ShapeBase._NOT_SET:
                _params['shared_account_id'] = shared_account_id
            if image_permissions is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_stack(
        ...
        *,
        ...
        delete_storage_connectors: bool = autoboto.ShapeBase._NOT_SET,
        redirect_url: str = autoboto.ShapeBase._NOT_SET,
        feedback_url: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if storage_connectors is not autoboto.ShapeBase._NOT_SET:
                _params['storage_connectors'] = storage_connectors
            if delete_storage_connectors is not autoboto.ShapeBase._NOT_SET:
