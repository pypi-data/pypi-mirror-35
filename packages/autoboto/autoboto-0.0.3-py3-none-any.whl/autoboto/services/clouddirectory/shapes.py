...
class AddFacetToObjectRequest(autoboto.ShapeBase):
    ...
    directory_arn: str = dataclasses.field(
...
class AttachObjectRequest(autoboto.ShapeBase):
    ...
    link_name: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class AttributeKey(autoboto.ShapeBase):
    ...
    # attribute.
    schema_arn: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # The name of the facet that the attribute exists within.
    facet_name: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class BatchCreateIndex(autoboto.ShapeBase):
    ...
    # not.
    is_unique: bool = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class BatchWriteException(autoboto.ShapeBase):
    ...
    index: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class FacetAttributeDefinition(autoboto.ShapeBase):
    ...
    is_immutable: bool = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
class PolicyAttachment(autoboto.ShapeBase):
    ...
    policy_id: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class PublishSchemaRequest(autoboto.ShapeBase):
    ...
    # them.
    minor_version: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
class Rule(autoboto.ShapeBase):
    ...
    type: "RuleType" = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class TypedAttributeValue(autoboto.ShapeBase):
    ...
    # A number data value.
    number_value: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
