...
class Client:
    ...
    def add_facet_to_object(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if directory_arn is not autoboto.ShapeBase._NOT_SET:
                _params['directory_arn'] = directory_arn
            if schema_facet is not autoboto.ShapeBase._NOT_SET:
                _params['schema_facet'] = schema_facet
            if object_reference is not autoboto.ShapeBase._NOT_SET:
                _params['object_reference'] = object_reference
            if object_attribute_list is not autoboto.ShapeBase._NOT_SET:
    ...
    def apply_schema(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if published_schema_arn is not autoboto.ShapeBase._NOT_SET:
    ...
    def attach_object(
        ...
        *,
        ...
        if _request is None:
            ...
            if directory_arn is not autoboto.ShapeBase._NOT_SET:
                _params['directory_arn'] = directory_arn
            if parent_reference is not autoboto.ShapeBase._NOT_SET:
                _params['parent_reference'] = parent_reference
            if child_reference is not autoboto.ShapeBase._NOT_SET:
                _params['child_reference'] = child_reference
            if link_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def attach_policy(
        ...
        *,
        ...
        if _request is None:
            ...
            if directory_arn is not autoboto.ShapeBase._NOT_SET:
                _params['directory_arn'] = directory_arn
            if policy_reference is not autoboto.ShapeBase._NOT_SET:
    ...
    def attach_to_index(
        ...
        *,
        ...
        if _request is None:
            ...
            if directory_arn is not autoboto.ShapeBase._NOT_SET:
                _params['directory_arn'] = directory_arn
            if index_reference is not autoboto.ShapeBase._NOT_SET:
                _params['index_reference'] = index_reference
            if target_reference is not autoboto.ShapeBase._NOT_SET:
    ...
    def attach_typed_link(
        ...
        *,
        ...
        if _request is None:
            ...
            if directory_arn is not autoboto.ShapeBase._NOT_SET:
                _params['directory_arn'] = directory_arn
            if source_object_reference is not autoboto.ShapeBase._NOT_SET:
                _params['source_object_reference'] = source_object_reference
            if target_object_reference is not autoboto.ShapeBase._NOT_SET:
                _params['target_object_reference'] = target_object_reference
            if typed_link_facet is not autoboto.ShapeBase._NOT_SET:
    ...
    def batch_read(
        ...
        *,
        ...
        consistency_level: shapes.ConsistencyLevel = autoboto.ShapeBase.
        _NOT_SET,
        ...
        if _request is None:
            ...
            if consistency_level is not autoboto.ShapeBase._NOT_SET:
        ...
        *,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if schema_arn is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_facet(
        ...
        *,
        schema_arn: str,
        name: str,
        attributes: typing.List[shapes.FacetAttribute
                               ] = autoboto.ShapeBase._NOT_SET,
        object_type: shapes.ObjectType = autoboto.ShapeBase._NOT_SET,
        facet_style: shapes.FacetStyle = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if attributes is not autoboto.ShapeBase._NOT_SET:
                _params['attributes'] = attributes
            if object_type is not autoboto.ShapeBase._NOT_SET:
                _params['object_type'] = object_type
            if facet_style is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_index(
        ...
        *,
        ...
        is_unique: bool,
        parent_reference: shapes.ObjectReference = autoboto.ShapeBase._NOT_SET,
        link_name: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if directory_arn is not autoboto.ShapeBase._NOT_SET:
                _params['directory_arn'] = directory_arn
            if ordered_indexed_attribute_list is not autoboto.ShapeBase._NOT_SET:
                _params['ordered_indexed_attribute_list'
                       ] = ordered_indexed_attribute_list
            if is_unique is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_object(
        ...
        *,
        ...
        if _request is None:
            ...
            if directory_arn is not autoboto.ShapeBase._NOT_SET:
                _params['directory_arn'] = directory_arn
            if schema_facets is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_typed_link_facet(
        ...
        *,
        ...
        if _request is None:
            ...
            if schema_arn is not autoboto.ShapeBase._NOT_SET:
                _params['schema_arn'] = schema_arn
            if facet is not autoboto.ShapeBase._NOT_SET:
                _params['facet'] = facet
    ...
    def detach_typed_link(
        ...
        *,
        ...
        if _request is None:
            ...
            if directory_arn is not autoboto.ShapeBase._NOT_SET:
                _params['directory_arn'] = directory_arn
            if typed_link_specifier is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_applied_schema_arns(
        ...
        *,
        directory_arn: str,
        schema_arn: str = autoboto.ShapeBase._NOT_SET,
    ...
    def list_directories(
        ...
        *,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        state: shapes.DirectoryState = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if max_results is not autoboto.ShapeBase._NOT_SET:
                _params['max_results'] = max_results
            if state is not autoboto.ShapeBase._NOT_SET:
                _params['state'] = state
    ...
    def list_incoming_typed_links(
        ...
        *,
        ...
        filter_typed_link: shapes.TypedLinkSchemaAndFacetName = autoboto.
        ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        consistency_level: shapes.ConsistencyLevel = autoboto.ShapeBase.
        ...
        if _request is None:
            ...
            if object_reference is not autoboto.ShapeBase._NOT_SET:
                _params['object_reference'] = object_reference
            if filter_attribute_ranges is not autoboto.ShapeBase._NOT_SET:
                _params['filter_attribute_ranges'] = filter_attribute_ranges
            if filter_typed_link is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_index(
        ...
        *,
        ...
        if _request is None:
            ...
            if index_reference is not autoboto.ShapeBase._NOT_SET:
                _params['index_reference'] = index_reference
            if ranges_on_indexed_values is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_object_attributes(
        ...
        *,
        ...
        consistency_level: shapes.ConsistencyLevel = autoboto.ShapeBase.
        _NOT_SET,
        facet_filter: shapes.SchemaFacet = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if consistency_level is not autoboto.ShapeBase._NOT_SET:
                _params['consistency_level'] = consistency_level
            if facet_filter is not autoboto.ShapeBase._NOT_SET:
    ...
    def publish_schema(
        ...
        *,
        ...
        version: str,
        minor_version: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if development_schema_arn is not autoboto.ShapeBase._NOT_SET:
                _params['development_schema_arn'] = development_schema_arn
            if version is not autoboto.ShapeBase._NOT_SET:
                _params['version'] = version
            if minor_version is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_typed_link_facet(
        ...
        *,
        ...
        if _request is None:
            ...
            if attribute_updates is not autoboto.ShapeBase._NOT_SET:
                _params['attribute_updates'] = attribute_updates
            if identity_attribute_order is not autoboto.ShapeBase._NOT_SET:
