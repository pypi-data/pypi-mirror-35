...
@dataclasses.dataclass
class ApplicationDescriptionMessage(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class ApplicationDescriptionsMessage(autoboto.ShapeBase):
    """
...
class ApplicationMetrics(autoboto.ShapeBase):
    ...
    # last 10 seconds.
    request_count: int = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
@dataclasses.dataclass
class ApplicationResourceLifecycleDescriptionMessage(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
class ApplicationVersionDescription(autoboto.ShapeBase):
    ...
    build_arn: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
@dataclasses.dataclass
class ApplicationVersionDescriptionMessage(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class ApplicationVersionDescriptionsMessage(autoboto.ShapeBase):
    """
...
class ApplyEnvironmentManagedActionRequest(autoboto.ShapeBase):
    ...
    action_id: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
@dataclasses.dataclass
class ApplyEnvironmentManagedActionResult(autoboto.ShapeBase):
    """
...
class CPUUtilization(autoboto.ShapeBase):
    ...
    # 10 seconds.
    user: float = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # Available on Linux environments only.

    # Percentage of time that the CPU has spent in the `Nice` state over the last
    # 10 seconds.
    nice: float = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # Available on Linux environments only.

    # Percentage of time that the CPU has spent in the `System` state over the
    # last 10 seconds.
    system: float = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # Percentage of time that the CPU has spent in the `Idle` state over the last
    # 10 seconds.
    idle: float = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # Available on Linux environments only.

    # Percentage of time that the CPU has spent in the `I/O Wait` state over the
    # last 10 seconds.
    io_wait: float = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # Available on Linux environments only.

    # Percentage of time that the CPU has spent in the `IRQ` state over the last
    # 10 seconds.
    irq: float = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # Available on Linux environments only.

    # Percentage of time that the CPU has spent in the `SoftIRQ` state over the
    # last 10 seconds.
    soft_irq: float = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # Available on Windows environments only.

    # Percentage of time that the CPU has spent in the `Privileged` state over
    # the last 10 seconds.
    privileged: float = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class CheckDNSAvailabilityMessage(autoboto.ShapeBase):
    ...
    cname_prefix: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )


@dataclasses.dataclass
class CheckDNSAvailabilityResultMessage(autoboto.ShapeBase):
    """
    ...
    available: bool = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class ConfigurationOptionDescription(autoboto.ShapeBase):
    ...
    user_defined: bool = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
@dataclasses.dataclass
class ConfigurationOptionsDescription(autoboto.ShapeBase):
    """
    ...
    platform_arn: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
@dataclasses.dataclass
class ConfigurationSettingsDescription(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class ConfigurationSettingsDescriptions(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class ConfigurationSettingsValidationMessages(autoboto.ShapeBase):
    """
...
class CreateApplicationVersionMessage(autoboto.ShapeBase):
    ...
    process: bool = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
@dataclasses.dataclass
class CreatePlatformVersionResult(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class CreateStorageLocationResultMessage(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class DeletePlatformVersionResult(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
class Deployment(autoboto.ShapeBase):
    ...
    deployment_id: int = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
@dataclasses.dataclass
class DescribeAccountAttributesResult(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DescribeEnvironmentHealthResult(autoboto.ShapeBase):
    """
    ...
    color: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
@dataclasses.dataclass
class DescribeEnvironmentManagedActionHistoryResult(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class DescribeEnvironmentManagedActionsResult(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class DescribeInstancesHealthResult(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class DescribePlatformVersionResult(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class EnvironmentDescription(autoboto.ShapeBase):
    """
    ...
    cname: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
@dataclasses.dataclass
class EnvironmentDescriptionsMessage(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class EnvironmentResourceDescriptionsMessage(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class EventDescriptionsMessage(autoboto.ShapeBase):
    """
...
class InstanceHealthSummary(autoboto.ShapeBase):
    ...
    # on an instance.
    no_data: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # **Grey.** AWS Elastic Beanstalk and the health agent are reporting an
    # insufficient amount of data on an instance.
    unknown: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    ok: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # **Green.** An operation is in progress on an instance.
    info: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # **Yellow.** The health agent is reporting a moderate number of request
    # failures or other issues for an instance or environment.
    warning: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # **Red.** The health agent is reporting a high number of request failures or
    # other issues for an instance or environment.
    degraded: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # **Red.** The health agent is reporting a very high number of request
    # failures or other issues for an instance or environment.
    severe: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
@dataclasses.dataclass
class ListAvailableSolutionStacksResultMessage(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class ListPlatformVersionsResult(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
class MaxCountRule(autoboto.ShapeBase):
    ...
    max_count: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class PlatformDescription(autoboto.ShapeBase):
    ...
    maintainer: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class PlatformFilter(autoboto.ShapeBase):
    ...
    operator: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
@dataclasses.dataclass
class ResourceTagsDescriptionMessage(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class RetrieveEnvironmentInfoResultMessage(autoboto.ShapeBase):
    """
