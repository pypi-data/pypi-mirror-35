...
class AddPermissionRequest(autoboto.ShapeBase):
    ...
    revision_id: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class AddPermissionResponse(autoboto.ShapeBase):
    ...
    # JSON.
    statement: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class CreateFunctionRequest(autoboto.ShapeBase):
    ...
    # handler-types.html).
    handler: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    publish: bool = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    # default service key.
    kms_key_arn: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class DeleteEventSourceMappingRequest(autoboto.ShapeBase):
    ...
    uuid: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class FunctionCode(autoboto.ShapeBase):
    ...
    s3_key: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class FunctionConfiguration(autoboto.ShapeBase):
    ...
    code_size: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    last_modified: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )

    # It is the SHA256 hash of your function deployment package.
    code_sha256: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    master_arn: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class ListFunctionsRequest(autoboto.ShapeBase):
    ...
    master_region: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
