...
class Client:
    ...
    def add_permission(
        ...
        *,
        ...
        source_account: str = autoboto.ShapeBase.NOT_SET,
        event_source_token: str = autoboto.ShapeBase.NOT_SET,
        qualifier: str = autoboto.ShapeBase.NOT_SET,
        revision_id: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if statement_id is not autoboto.ShapeBase.NOT_SET:
                _params['statement_id'] = statement_id
            if action is not autoboto.ShapeBase.NOT_SET:
            ...
            if source_account is not autoboto.ShapeBase.NOT_SET:
                _params['source_account'] = source_account
            if event_source_token is not autoboto.ShapeBase.NOT_SET:
                _params['event_source_token'] = event_source_token
            if qualifier is not autoboto.ShapeBase.NOT_SET:
                _params['qualifier'] = qualifier
            if revision_id is not autoboto.ShapeBase.NOT_SET:
        ...
        *,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase.NOT_SET:
                _params['name'] = name
            if function_version is not autoboto.ShapeBase.NOT_SET:
                _params['function_version'] = function_version
            if description is not autoboto.ShapeBase.NOT_SET:
                _params['description'] = description
            if routing_config is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_event_source_mapping(
        ...
        *,
        ...
        batch_size: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if event_source_arn is not autoboto.ShapeBase.NOT_SET:
                _params['event_source_arn'] = event_source_arn
            if function_name is not autoboto.ShapeBase.NOT_SET:
                _params['function_name'] = function_name
            if enabled is not autoboto.ShapeBase.NOT_SET:
                _params['enabled'] = enabled
            if batch_size is not autoboto.ShapeBase.NOT_SET:
                _params['batch_size'] = batch_size
            if starting_position is not autoboto.ShapeBase.NOT_SET:
                _params['starting_position'] = starting_position
            if starting_position_timestamp is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_function(
        ...
        *,
        ...
        memory_size: int = autoboto.ShapeBase.NOT_SET,
        publish: bool = autoboto.ShapeBase.NOT_SET,
        vpc_config: shapes.VpcConfig = autoboto.ShapeBase.NOT_SET,
        dead_letter_config: shapes.DeadLetterConfig = autoboto.ShapeBase.
        NOT_SET,
        environment: shapes.Environment = autoboto.ShapeBase.NOT_SET,
        kms_key_arn: str = autoboto.ShapeBase.NOT_SET,
        tracing_config: shapes.TracingConfig = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if function_name is not autoboto.ShapeBase.NOT_SET:
                _params['function_name'] = function_name
            if runtime is not autoboto.ShapeBase.NOT_SET:
                _params['runtime'] = runtime
            if role is not autoboto.ShapeBase.NOT_SET:
                _params['role'] = role
            if handler is not autoboto.ShapeBase.NOT_SET:
            ...
            if memory_size is not autoboto.ShapeBase.NOT_SET:
                _params['memory_size'] = memory_size
            if publish is not autoboto.ShapeBase.NOT_SET:
                _params['publish'] = publish
            if vpc_config is not autoboto.ShapeBase.NOT_SET:
                _params['vpc_config'] = vpc_config
            if dead_letter_config is not autoboto.ShapeBase.NOT_SET:
            ...
            if kms_key_arn is not autoboto.ShapeBase.NOT_SET:
                _params['kms_key_arn'] = kms_key_arn
            if tracing_config is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_event_source_mapping(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if uuid is not autoboto.ShapeBase.NOT_SET:
                _params['uuid'] = uuid
    ...
    def invoke(
        ...
        *,
        function_name: str,
        invocation_type: shapes.InvocationType = autoboto.ShapeBase.NOT_SET,
        log_type: shapes.LogType = autoboto.ShapeBase.NOT_SET,
        client_context: str = autoboto.ShapeBase.NOT_SET,
        payload: typing.Any = autoboto.ShapeBase.NOT_SET,
        qualifier: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if function_name is not autoboto.ShapeBase.NOT_SET:
                _params['function_name'] = function_name
            if invocation_type is not autoboto.ShapeBase.NOT_SET:
                _params['invocation_type'] = invocation_type
            if log_type is not autoboto.ShapeBase.NOT_SET:
                _params['log_type'] = log_type
            if client_context is not autoboto.ShapeBase.NOT_SET:
    ...
    def invoke_async(
        ...
        *,
        ...
        if _request is None:
            ...
            if function_name is not autoboto.ShapeBase.NOT_SET:
                _params['function_name'] = function_name
            if invoke_args is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_aliases(
        ...
        *,
        function_name: str,
        function_version: str = autoboto.ShapeBase.NOT_SET,
    ...
    def list_event_source_mappings(
        ...
        *,
        event_source_arn: str = autoboto.ShapeBase.NOT_SET,
        function_name: str = autoboto.ShapeBase.NOT_SET,
        marker: str = autoboto.ShapeBase.NOT_SET,
        max_items: int = autoboto.ShapeBase.NOT_SET,
    ...
    def list_functions(
        ...
        *,
        master_region: str = autoboto.ShapeBase.NOT_SET,
        function_version: shapes.FunctionVersion = autoboto.ShapeBase.NOT_SET,
        marker: str = autoboto.ShapeBase.NOT_SET,
        max_items: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if master_region is not autoboto.ShapeBase.NOT_SET:
    ...
    def publish_version(
        ...
        *,
        function_name: str,
        code_sha256: str = autoboto.ShapeBase.NOT_SET,
        description: str = autoboto.ShapeBase.NOT_SET,
        revision_id: str = autoboto.ShapeBase.NOT_SET,
    ) -> shapes.FunctionConfiguration:
        """
        ...
        if _request is None:
            ...
            if function_name is not autoboto.ShapeBase.NOT_SET:
                _params['function_name'] = function_name
            if code_sha256 is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_function_concurrency(
        ...
        *,
        ...
        if _request is None:
            ...
            if function_name is not autoboto.ShapeBase.NOT_SET:
                _params['function_name'] = function_name
            if reserved_concurrent_executions is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_function_code(
        ...
        *,
        function_name: str,
        zip_file: typing.Any = autoboto.ShapeBase.NOT_SET,
        s3_bucket: str = autoboto.ShapeBase.NOT_SET,
        s3_key: str = autoboto.ShapeBase.NOT_SET,
        s3_object_version: str = autoboto.ShapeBase.NOT_SET,
        publish: bool = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if function_name is not autoboto.ShapeBase.NOT_SET:
                _params['function_name'] = function_name
            if zip_file is not autoboto.ShapeBase.NOT_SET:
                _params['zip_file'] = zip_file
            if s3_bucket is not autoboto.ShapeBase.NOT_SET:
                _params['s3_bucket'] = s3_bucket
            if s3_key is not autoboto.ShapeBase.NOT_SET:
                _params['s3_key'] = s3_key
            if s3_object_version is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_function_configuration(
        ...
        *,
        ...
        handler: str = autoboto.ShapeBase.NOT_SET,
        description: str = autoboto.ShapeBase.NOT_SET,
        timeout: int = autoboto.ShapeBase.NOT_SET,
        memory_size: int = autoboto.ShapeBase.NOT_SET,
        vpc_config: shapes.VpcConfig = autoboto.ShapeBase.NOT_SET,
        environment: shapes.Environment = autoboto.ShapeBase.NOT_SET,
        runtime: shapes.Runtime = autoboto.ShapeBase.NOT_SET,
        dead_letter_config: shapes.DeadLetterConfig = autoboto.ShapeBase.
        NOT_SET,
        kms_key_arn: str = autoboto.ShapeBase.NOT_SET,
        tracing_config: shapes.TracingConfig = autoboto.ShapeBase.NOT_SET,
