...
class Client:
    ...
    def cancel_command(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if command_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_activation(
        ...
        *,
        ...
        default_instance_name: str = autoboto.ShapeBase.NOT_SET,
        registration_limit: int = autoboto.ShapeBase.NOT_SET,
        expiration_date: datetime.datetime = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if iam_role is not autoboto.ShapeBase.NOT_SET:
                _params['iam_role'] = iam_role
            if description is not autoboto.ShapeBase.NOT_SET:
                _params['description'] = description
            if default_instance_name is not autoboto.ShapeBase.NOT_SET:
                _params['default_instance_name'] = default_instance_name
            if registration_limit is not autoboto.ShapeBase.NOT_SET:
                _params['registration_limit'] = registration_limit
            if expiration_date is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_association(
        ...
        *,
        name: str,
        document_version: str = autoboto.ShapeBase.NOT_SET,
        instance_id: str = autoboto.ShapeBase.NOT_SET,
        parameters: typing.Dict[str, typing.List[str]
                               ] = autoboto.ShapeBase.NOT_SET,
        targets: typing.List[shapes.Target] = autoboto.ShapeBase.NOT_SET,
        schedule_expression: str = autoboto.ShapeBase.NOT_SET,
        output_location: shapes.InstanceAssociationOutputLocation = autoboto.
        ShapeBase.NOT_SET,
        association_name: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase.NOT_SET:
                _params['name'] = name
            if document_version is not autoboto.ShapeBase.NOT_SET:
            ...
            if schedule_expression is not autoboto.ShapeBase.NOT_SET:
                _params['schedule_expression'] = schedule_expression
            if output_location is not autoboto.ShapeBase.NOT_SET:
                _params['output_location'] = output_location
            if association_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_association_batch(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if entries is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_document(
        ...
        *,
        content: str,
        name: str,
        document_type: shapes.DocumentType = autoboto.ShapeBase.NOT_SET,
        document_format: shapes.DocumentFormat = autoboto.ShapeBase.NOT_SET,
        target_type: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if content is not autoboto.ShapeBase.NOT_SET:
                _params['content'] = content
            if name is not autoboto.ShapeBase.NOT_SET:
                _params['name'] = name
            if document_type is not autoboto.ShapeBase.NOT_SET:
                _params['document_type'] = document_type
            if document_format is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_maintenance_window(
        ...
        *,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase.NOT_SET:
                _params['name'] = name
            if schedule is not autoboto.ShapeBase.NOT_SET:
                _params['schedule'] = schedule
            if duration is not autoboto.ShapeBase.NOT_SET:
                _params['duration'] = duration
            if cutoff is not autoboto.ShapeBase.NOT_SET:
                _params['cutoff'] = cutoff
            if allow_unassociated_targets is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_patch_baseline(
        ...
        *,
        name: str,
        operating_system: shapes.OperatingSystem = autoboto.ShapeBase.NOT_SET,
        global_filters: shapes.PatchFilterGroup = autoboto.ShapeBase.NOT_SET,
        approval_rules: shapes.PatchRuleGroup = autoboto.ShapeBase.NOT_SET,
        approved_patches: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        approved_patches_compliance_level: shapes.
        PatchComplianceLevel = autoboto.ShapeBase.NOT_SET,
        approved_patches_enable_non_security: bool = autoboto.ShapeBase.NOT_SET,
        rejected_patches: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        description: str = autoboto.ShapeBase.NOT_SET,
        sources: typing.List[shapes.PatchSource] = autoboto.ShapeBase.NOT_SET,
        client_token: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase.NOT_SET:
                _params['name'] = name
            if operating_system is not autoboto.ShapeBase.NOT_SET:
                _params['operating_system'] = operating_system
            if global_filters is not autoboto.ShapeBase.NOT_SET:
                _params['global_filters'] = global_filters
            if approval_rules is not autoboto.ShapeBase.NOT_SET:
                _params['approval_rules'] = approval_rules
            if approved_patches is not autoboto.ShapeBase.NOT_SET:
                _params['approved_patches'] = approved_patches
            if approved_patches_compliance_level is not autoboto.ShapeBase.NOT_SET:
                _params['approved_patches_compliance_level'
                       ] = approved_patches_compliance_level
            if approved_patches_enable_non_security is not autoboto.ShapeBase.NOT_SET:
                _params['approved_patches_enable_non_security'
                       ] = approved_patches_enable_non_security
            if rejected_patches is not autoboto.ShapeBase.NOT_SET:
                _params['rejected_patches'] = rejected_patches
            if description is not autoboto.ShapeBase.NOT_SET:
                _params['description'] = description
            if sources is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_resource_data_sync(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if sync_name is not autoboto.ShapeBase.NOT_SET:
                _params['sync_name'] = sync_name
            if s3_destination is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_activation(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if activation_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_inventory(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if type_name is not autoboto.ShapeBase.NOT_SET:
                _params['type_name'] = type_name
            if schema_delete_option is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_maintenance_window(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if window_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_parameters(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if names is not autoboto.ShapeBase.NOT_SET:
                _params['names'] = names
    ...
    def delete_patch_baseline(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if baseline_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def deregister_patch_baseline_for_patch_group(
        ...
        *,
        ...
        if _request is None:
            ...
            if baseline_id is not autoboto.ShapeBase.NOT_SET:
                _params['baseline_id'] = baseline_id
            if patch_group is not autoboto.ShapeBase.NOT_SET:
    ...
    def deregister_target_from_maintenance_window(
        ...
        *,
        ...
        safe: bool = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if window_id is not autoboto.ShapeBase.NOT_SET:
                _params['window_id'] = window_id
            if window_target_id is not autoboto.ShapeBase.NOT_SET:
                _params['window_target_id'] = window_target_id
            if safe is not autoboto.ShapeBase.NOT_SET:
                _params['safe'] = safe
    ...
    def deregister_task_from_maintenance_window(
        ...
        *,
        ...
        if _request is None:
            ...
            if window_id is not autoboto.ShapeBase.NOT_SET:
                _params['window_id'] = window_id
            if window_task_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_association(
        ...
        *,
        ...
        instance_id: str = autoboto.ShapeBase.NOT_SET,
        association_id: str = autoboto.ShapeBase.NOT_SET,
        association_version: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if association_id is not autoboto.ShapeBase.NOT_SET:
                _params['association_id'] = association_id
            if association_version is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_association_execution_targets(
        ...
        *,
        ...
        if _request is None:
            ...
            if association_id is not autoboto.ShapeBase.NOT_SET:
                _params['association_id'] = association_id
            if execution_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_automation_step_executions(
        ...
        *,
        ...
        next_token: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
        reverse_order: bool = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if automation_execution_id is not autoboto.ShapeBase.NOT_SET:
            ...
            if max_results is not autoboto.ShapeBase.NOT_SET:
                _params['max_results'] = max_results
            if reverse_order is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_document_permission(
        ...
        *,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase.NOT_SET:
                _params['name'] = name
            if permission_type is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_instance_information(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if instance_information_filter_list is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_inventory_deletions(
        ...
        *,
        deletion_id: str = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if deletion_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_maintenance_window_execution_task_invocations(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if window_execution_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_parameters(
        ...
        *,
        ...
        if _request is None:
            ...
            if filters is not autoboto.ShapeBase.NOT_SET:
                _params['filters'] = filters
            if parameter_filters is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_command_invocation(
        ...
        *,
        command_id: str,
        instance_id: str,
        plugin_name: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if instance_id is not autoboto.ShapeBase.NOT_SET:
                _params['instance_id'] = instance_id
            if plugin_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_inventory(
        ...
        *,
        ...
        if _request is None:
            ...
            if filters is not autoboto.ShapeBase.NOT_SET:
                _params['filters'] = filters
            if aggregators is not autoboto.ShapeBase.NOT_SET:
                _params['aggregators'] = aggregators
            if result_attributes is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_inventory_schema(
        ...
        *,
        type_name: str = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
        aggregator: bool = autoboto.ShapeBase.NOT_SET,
        sub_type: bool = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if max_results is not autoboto.ShapeBase.NOT_SET:
                _params['max_results'] = max_results
            if aggregator is not autoboto.ShapeBase.NOT_SET:
                _params['aggregator'] = aggregator
            if sub_type is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_maintenance_window_execution_task_invocation(
        ...
        *,
        ...
        if _request is None:
            ...
            if task_id is not autoboto.ShapeBase.NOT_SET:
                _params['task_id'] = task_id
            if invocation_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_parameter(
        ...
        *,
        name: str,
        with_decryption: bool = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase.NOT_SET:
                _params['name'] = name
            if with_decryption is not autoboto.ShapeBase.NOT_SET:
    ...
    def label_parameter_version(
        ...
        *,
        ...
        parameter_version: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase.NOT_SET:
                _params['name'] = name
            if labels is not autoboto.ShapeBase.NOT_SET:
                _params['labels'] = labels
            if parameter_version is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_associations(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if association_filter_list is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_command_invocations(
        ...
        *,
        command_id: str = autoboto.ShapeBase.NOT_SET,
        instance_id: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        filters: typing.List[shapes.CommandFilter] = autoboto.ShapeBase.NOT_SET,
        details: bool = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if filters is not autoboto.ShapeBase.NOT_SET:
                _params['filters'] = filters
            if details is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_compliance_items(
        ...
        *,
        ...
        resource_ids: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        resource_types: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if resource_types is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_documents(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if document_filter_list is not autoboto.ShapeBase.NOT_SET:
    ...
    def modify_document_permission(
        ...
        *,
        name: str,
        permission_type: shapes.DocumentPermissionType,
        account_ids_to_add: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        account_ids_to_remove: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if permission_type is not autoboto.ShapeBase.NOT_SET:
                _params['permission_type'] = permission_type
            if account_ids_to_add is not autoboto.ShapeBase.NOT_SET:
                _params['account_ids_to_add'] = account_ids_to_add
            if account_ids_to_remove is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_compliance_items(
        ...
        *,
        ...
        item_content_hash: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if resource_type is not autoboto.ShapeBase.NOT_SET:
                _params['resource_type'] = resource_type
            if compliance_type is not autoboto.ShapeBase.NOT_SET:
                _params['compliance_type'] = compliance_type
            if execution_summary is not autoboto.ShapeBase.NOT_SET:
                _params['execution_summary'] = execution_summary
            if items is not autoboto.ShapeBase.NOT_SET:
                _params['items'] = items
            if item_content_hash is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_parameter(
        ...
        *,
        ...
        overwrite: bool = autoboto.ShapeBase.NOT_SET,
        allowed_pattern: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if overwrite is not autoboto.ShapeBase.NOT_SET:
                _params['overwrite'] = overwrite
            if allowed_pattern is not autoboto.ShapeBase.NOT_SET:
    ...
    def register_target_with_maintenance_window(
        ...
        *,
        ...
        owner_information: str = autoboto.ShapeBase.NOT_SET,
        name: str = autoboto.ShapeBase.NOT_SET,
        description: str = autoboto.ShapeBase.NOT_SET,
        client_token: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if targets is not autoboto.ShapeBase.NOT_SET:
                _params['targets'] = targets
            if owner_information is not autoboto.ShapeBase.NOT_SET:
    ...
    def register_task_with_maintenance_window(
        ...
        *,
        ...
        MaintenanceWindowTaskInvocationParameters = autoboto.ShapeBase.NOT_SET,
        priority: int = autoboto.ShapeBase.NOT_SET,
        logging_info: shapes.LoggingInfo = autoboto.ShapeBase.NOT_SET,
        name: str = autoboto.ShapeBase.NOT_SET,
        description: str = autoboto.ShapeBase.NOT_SET,
        client_token: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if targets is not autoboto.ShapeBase.NOT_SET:
                _params['targets'] = targets
            if task_arn is not autoboto.ShapeBase.NOT_SET:
                _params['task_arn'] = task_arn
            if task_type is not autoboto.ShapeBase.NOT_SET:
                _params['task_type'] = task_type
            if max_concurrency is not autoboto.ShapeBase.NOT_SET:
                _params['max_concurrency'] = max_concurrency
            if max_errors is not autoboto.ShapeBase.NOT_SET:
            ...
            if task_parameters is not autoboto.ShapeBase.NOT_SET:
                _params['task_parameters'] = task_parameters
            if task_invocation_parameters is not autoboto.ShapeBase.NOT_SET:
                _params['task_invocation_parameters'
                       ] = task_invocation_parameters
            if priority is not autoboto.ShapeBase.NOT_SET:
                _params['priority'] = priority
            if logging_info is not autoboto.ShapeBase.NOT_SET:
    ...
    def send_automation_signal(
        ...
        *,
        ...
        if _request is None:
            ...
            if automation_execution_id is not autoboto.ShapeBase.NOT_SET:
                _params['automation_execution_id'] = automation_execution_id
            if signal_type is not autoboto.ShapeBase.NOT_SET:
                _params['signal_type'] = signal_type
            if payload is not autoboto.ShapeBase.NOT_SET:
    ...
    def send_command(
        ...
        *,
        ...
        targets: typing.List[shapes.Target] = autoboto.ShapeBase.NOT_SET,
        document_version: str = autoboto.ShapeBase.NOT_SET,
        document_hash: str = autoboto.ShapeBase.NOT_SET,
        document_hash_type: shapes.DocumentHashType = autoboto.ShapeBase.
        NOT_SET,
        timeout_seconds: int = autoboto.ShapeBase.NOT_SET,
        comment: str = autoboto.ShapeBase.NOT_SET,
        parameters: typing.Dict[str, typing.List[str]
                               ] = autoboto.ShapeBase.NOT_SET,
        output_s3_region: str = autoboto.ShapeBase.NOT_SET,
        output_s3_bucket_name: str = autoboto.ShapeBase.NOT_SET,
        output_s3_key_prefix: str = autoboto.ShapeBase.NOT_SET,
        max_concurrency: str = autoboto.ShapeBase.NOT_SET,
        max_errors: str = autoboto.ShapeBase.NOT_SET,
        service_role_arn: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if document_name is not autoboto.ShapeBase.NOT_SET:
            ...
            if document_version is not autoboto.ShapeBase.NOT_SET:
                _params['document_version'] = document_version
            if document_hash is not autoboto.ShapeBase.NOT_SET:
                _params['document_hash'] = document_hash
            if document_hash_type is not autoboto.ShapeBase.NOT_SET:
                _params['document_hash_type'] = document_hash_type
            if timeout_seconds is not autoboto.ShapeBase.NOT_SET:
                _params['timeout_seconds'] = timeout_seconds
            if comment is not autoboto.ShapeBase.NOT_SET:
                _params['comment'] = comment
            if parameters is not autoboto.ShapeBase.NOT_SET:
                _params['parameters'] = parameters
            if output_s3_region is not autoboto.ShapeBase.NOT_SET:
                _params['output_s3_region'] = output_s3_region
            if output_s3_bucket_name is not autoboto.ShapeBase.NOT_SET:
                _params['output_s3_bucket_name'] = output_s3_bucket_name
            if output_s3_key_prefix is not autoboto.ShapeBase.NOT_SET:
            ...
            if service_role_arn is not autoboto.ShapeBase.NOT_SET:
                _params['service_role_arn'] = service_role_arn
            if notification_config is not autoboto.ShapeBase.NOT_SET:
                _params['notification_config'] = notification_config
            if cloud_watch_output_config is not autoboto.ShapeBase.NOT_SET:
    ...
    def start_automation_execution(
        ...
        *,
        ...
        client_token: str = autoboto.ShapeBase.NOT_SET,
        mode: shapes.ExecutionMode = autoboto.ShapeBase.NOT_SET,
        target_parameter_name: str = autoboto.ShapeBase.NOT_SET,
        targets: typing.List[shapes.Target] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if mode is not autoboto.ShapeBase.NOT_SET:
                _params['mode'] = mode
            if target_parameter_name is not autoboto.ShapeBase.NOT_SET:
                _params['target_parameter_name'] = target_parameter_name
            if targets is not autoboto.ShapeBase.NOT_SET:
                _params['targets'] = targets
            if target_maps is not autoboto.ShapeBase.NOT_SET:
    ...
    def stop_automation_execution(
        ...
        *,
        automation_execution_id: str,
        type: shapes.StopType = autoboto.ShapeBase.NOT_SET,
    ...
    def update_association_status(
        ...
        *,
        ...
        if _request is None:
            ...
            if instance_id is not autoboto.ShapeBase.NOT_SET:
                _params['instance_id'] = instance_id
            if association_status is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_maintenance_window(
        ...
        *,
        ...
        name: str = autoboto.ShapeBase.NOT_SET,
        description: str = autoboto.ShapeBase.NOT_SET,
        schedule: str = autoboto.ShapeBase.NOT_SET,
        duration: int = autoboto.ShapeBase.NOT_SET,
        cutoff: int = autoboto.ShapeBase.NOT_SET,
        allow_unassociated_targets: bool = autoboto.ShapeBase.NOT_SET,
        enabled: bool = autoboto.ShapeBase.NOT_SET,
        replace: bool = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if replace is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_maintenance_window_task(
        ...
        *,
        ...
        window_task_id: str,
        targets: typing.List[shapes.Target] = autoboto.ShapeBase.NOT_SET,
        task_arn: str = autoboto.ShapeBase.NOT_SET,
        service_role_arn: str = autoboto.ShapeBase.NOT_SET,
        task_parameters: typing.Dict[
            str, shapes.MaintenanceWindowTaskParameterValueExpression
        ] = autoboto.ShapeBase.NOT_SET,
