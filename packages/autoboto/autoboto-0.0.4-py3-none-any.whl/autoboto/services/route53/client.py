...
class Client:
    ...
    def associate_vpc_with_hosted_zone(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if hosted_zone_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def change_resource_record_sets(
        ...
        **Limits on ChangeResourceRecordSets Requests**
        ...
        if _request is None:
            ...
            if hosted_zone_id is not autoboto.ShapeBase.NOT_SET:
                _params['hosted_zone_id'] = hosted_zone_id
            if change_batch is not autoboto.ShapeBase.NOT_SET:
    ...
    def change_tags_for_resource(
        ...
        *,
        ...
        resource_id: str,
        add_tags: typing.List[shapes.Tag] = autoboto.ShapeBase.NOT_SET,
        remove_tag_keys: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if add_tags is not autoboto.ShapeBase.NOT_SET:
                _params['add_tags'] = add_tags
            if remove_tag_keys is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_health_check(
        ...
        **Private Hosted Zones**
        ...
        if _request is None:
            _params = {}
            if caller_reference is not autoboto.ShapeBase.NOT_SET:
                _params['caller_reference'] = caller_reference
            if health_check_config is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_hosted_zone(
        ...
        *,
        name: str,
        caller_reference: str,
        vpc: shapes.VPC = autoboto.ShapeBase.NOT_SET,
        hosted_zone_config: shapes.HostedZoneConfig = autoboto.ShapeBase.
        NOT_SET,
        delegation_set_id: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if vpc is not autoboto.ShapeBase.NOT_SET:
                _params['vpc'] = vpc
            if hosted_zone_config is not autoboto.ShapeBase.NOT_SET:
                _params['hosted_zone_config'] = hosted_zone_config
            if delegation_set_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_query_logging_config(
        ...
        *,
        ...
        if _request is None:
            ...
            if hosted_zone_id is not autoboto.ShapeBase.NOT_SET:
                _params['hosted_zone_id'] = hosted_zone_id
            if cloud_watch_logs_log_group_arn is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_reusable_delegation_set(
        ...
        *,
        caller_reference: str,
        hosted_zone_id: str = autoboto.ShapeBase.NOT_SET,
    ...
    def create_traffic_policy_instance(
        ...
        *,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase.NOT_SET:
                _params['name'] = name
            if ttl is not autoboto.ShapeBase.NOT_SET:
                _params['ttl'] = ttl
            if traffic_policy_id is not autoboto.ShapeBase.NOT_SET:
                _params['traffic_policy_id'] = traffic_policy_id
            if traffic_policy_version is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_health_check(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if health_check_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_geo_location(
        ...
        *,
        continent_code: str = autoboto.ShapeBase.NOT_SET,
        country_code: str = autoboto.ShapeBase.NOT_SET,
        subdivision_code: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if continent_code is not autoboto.ShapeBase.NOT_SET:
                _params['continent_code'] = continent_code
            if country_code is not autoboto.ShapeBase.NOT_SET:
                _params['country_code'] = country_code
            if subdivision_code is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_geo_locations(
        ...
        *,
        start_continent_code: str = autoboto.ShapeBase.NOT_SET,
        start_country_code: str = autoboto.ShapeBase.NOT_SET,
        start_subdivision_code: str = autoboto.ShapeBase.NOT_SET,
        max_items: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if start_continent_code is not autoboto.ShapeBase.NOT_SET:
                _params['start_continent_code'] = start_continent_code
            if start_country_code is not autoboto.ShapeBase.NOT_SET:
                _params['start_country_code'] = start_country_code
            if start_subdivision_code is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_hosted_zones_by_name(
        ...
        *,
        dns_name: str = autoboto.ShapeBase.NOT_SET,
        hosted_zone_id: str = autoboto.ShapeBase.NOT_SET,
        max_items: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if dns_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_query_logging_configs(
        ...
        *,
        ...
        max_results: str = autoboto.ShapeBase.NOT_SET,
    ...
    def list_resource_record_sets(
        ...
        *,
        hosted_zone_id: str,
        start_record_name: str = autoboto.ShapeBase.NOT_SET,
        start_record_type: shapes.RRType = autoboto.ShapeBase.NOT_SET,
        start_record_identifier: str = autoboto.ShapeBase.NOT_SET,
        max_items: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if hosted_zone_id is not autoboto.ShapeBase.NOT_SET:
                _params['hosted_zone_id'] = hosted_zone_id
            if start_record_name is not autoboto.ShapeBase.NOT_SET:
                _params['start_record_name'] = start_record_name
            if start_record_type is not autoboto.ShapeBase.NOT_SET:
                _params['start_record_type'] = start_record_type
            if start_record_identifier is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_traffic_policies(
        ...
        *,
        traffic_policy_id_marker: str = autoboto.ShapeBase.NOT_SET,
        max_items: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if traffic_policy_id_marker is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_traffic_policy_instances(
        ...
        *,
        hosted_zone_id_marker: str = autoboto.ShapeBase.NOT_SET,
        traffic_policy_instance_name_marker: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if hosted_zone_id_marker is not autoboto.ShapeBase.NOT_SET:
                _params['hosted_zone_id_marker'] = hosted_zone_id_marker
            if traffic_policy_instance_name_marker is not autoboto.ShapeBase.NOT_SET:
                _params['traffic_policy_instance_name_marker'
                       ] = traffic_policy_instance_name_marker
            if traffic_policy_instance_type_marker is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_traffic_policy_versions(
        ...
        *,
        id: str,
        traffic_policy_version_marker: str = autoboto.ShapeBase.NOT_SET,
        max_items: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if id is not autoboto.ShapeBase.NOT_SET:
                _params['id'] = id
            if traffic_policy_version_marker is not autoboto.ShapeBase.NOT_SET:
    ...
    def test_dns_answer(
        ...
        *,
        ...
        resolver_ip: str = autoboto.ShapeBase.NOT_SET,
        edns0_client_subnet_ip: str = autoboto.ShapeBase.NOT_SET,
        edns0_client_subnet_mask: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if hosted_zone_id is not autoboto.ShapeBase.NOT_SET:
                _params['hosted_zone_id'] = hosted_zone_id
            if record_name is not autoboto.ShapeBase.NOT_SET:
                _params['record_name'] = record_name
            if record_type is not autoboto.ShapeBase.NOT_SET:
                _params['record_type'] = record_type
            if resolver_ip is not autoboto.ShapeBase.NOT_SET:
                _params['resolver_ip'] = resolver_ip
            if edns0_client_subnet_ip is not autoboto.ShapeBase.NOT_SET:
                _params['edns0_client_subnet_ip'] = edns0_client_subnet_ip
            if edns0_client_subnet_mask is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_health_check(
        ...
        *,
        health_check_id: str,
        health_check_version: int = autoboto.ShapeBase.NOT_SET,
        ip_address: str = autoboto.ShapeBase.NOT_SET,
        port: int = autoboto.ShapeBase.NOT_SET,
        resource_path: str = autoboto.ShapeBase.NOT_SET,
        fully_qualified_domain_name: str = autoboto.ShapeBase.NOT_SET,
        search_string: str = autoboto.ShapeBase.NOT_SET,
        failure_threshold: int = autoboto.ShapeBase.NOT_SET,
        inverted: bool = autoboto.ShapeBase.NOT_SET,
        health_threshold: int = autoboto.ShapeBase.NOT_SET,
        child_health_checks: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        enable_sni: bool = autoboto.ShapeBase.NOT_SET,
        regions: typing.List[shapes.HealthCheckRegion
                            ] = autoboto.ShapeBase.NOT_SET,
        alarm_identifier: shapes.AlarmIdentifier = autoboto.ShapeBase.NOT_SET,
        insufficient_data_health_status: shapes.
        InsufficientDataHealthStatus = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if health_check_id is not autoboto.ShapeBase.NOT_SET:
                _params['health_check_id'] = health_check_id
            if health_check_version is not autoboto.ShapeBase.NOT_SET:
                _params['health_check_version'] = health_check_version
            if ip_address is not autoboto.ShapeBase.NOT_SET:
                _params['ip_address'] = ip_address
            if port is not autoboto.ShapeBase.NOT_SET:
                _params['port'] = port
            if resource_path is not autoboto.ShapeBase.NOT_SET:
                _params['resource_path'] = resource_path
            if fully_qualified_domain_name is not autoboto.ShapeBase.NOT_SET:
                _params['fully_qualified_domain_name'
                       ] = fully_qualified_domain_name
            if search_string is not autoboto.ShapeBase.NOT_SET:
                _params['search_string'] = search_string
            if failure_threshold is not autoboto.ShapeBase.NOT_SET:
                _params['failure_threshold'] = failure_threshold
            if inverted is not autoboto.ShapeBase.NOT_SET:
                _params['inverted'] = inverted
            if health_threshold is not autoboto.ShapeBase.NOT_SET:
                _params['health_threshold'] = health_threshold
            if child_health_checks is not autoboto.ShapeBase.NOT_SET:
                _params['child_health_checks'] = child_health_checks
            if enable_sni is not autoboto.ShapeBase.NOT_SET:
                _params['enable_sni'] = enable_sni
            if regions is not autoboto.ShapeBase.NOT_SET:
                _params['regions'] = regions
            if alarm_identifier is not autoboto.ShapeBase.NOT_SET:
                _params['alarm_identifier'] = alarm_identifier
            if insufficient_data_health_status is not autoboto.ShapeBase.NOT_SET:
                _params['insufficient_data_health_status'
                       ] = insufficient_data_health_status
            if reset_elements is not autoboto.ShapeBase.NOT_SET:
