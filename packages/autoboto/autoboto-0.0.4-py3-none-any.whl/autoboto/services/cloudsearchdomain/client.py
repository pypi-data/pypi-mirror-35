...
class Client:
    ...
    def search(
        ...
        *,
        query: str,
        cursor: str = autoboto.ShapeBase.NOT_SET,
        expr: str = autoboto.ShapeBase.NOT_SET,
        facet: str = autoboto.ShapeBase.NOT_SET,
        filter_query: str = autoboto.ShapeBase.NOT_SET,
        highlight: str = autoboto.ShapeBase.NOT_SET,
        partial: bool = autoboto.ShapeBase.NOT_SET,
        query_options: str = autoboto.ShapeBase.NOT_SET,
        query_parser: shapes.QueryParser = autoboto.ShapeBase.NOT_SET,
        return_: str = autoboto.ShapeBase.NOT_SET,
        size: int = autoboto.ShapeBase.NOT_SET,
        sort: str = autoboto.ShapeBase.NOT_SET,
        start: int = autoboto.ShapeBase.NOT_SET,
        stats: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if query is not autoboto.ShapeBase.NOT_SET:
                _params['query'] = query
            if cursor is not autoboto.ShapeBase.NOT_SET:
                _params['cursor'] = cursor
            if expr is not autoboto.ShapeBase.NOT_SET:
                _params['expr'] = expr
            if facet is not autoboto.ShapeBase.NOT_SET:
                _params['facet'] = facet
            if filter_query is not autoboto.ShapeBase.NOT_SET:
                _params['filter_query'] = filter_query
            if highlight is not autoboto.ShapeBase.NOT_SET:
                _params['highlight'] = highlight
            if partial is not autoboto.ShapeBase.NOT_SET:
                _params['partial'] = partial
            if query_options is not autoboto.ShapeBase.NOT_SET:
                _params['query_options'] = query_options
            if query_parser is not autoboto.ShapeBase.NOT_SET:
                _params['query_parser'] = query_parser
            if return_ is not autoboto.ShapeBase.NOT_SET:
            ...
            if start is not autoboto.ShapeBase.NOT_SET:
                _params['start'] = start
            if stats is not autoboto.ShapeBase.NOT_SET:
                _params['stats'] = stats
    ...
    def upload_documents(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if documents is not autoboto.ShapeBase.NOT_SET:
