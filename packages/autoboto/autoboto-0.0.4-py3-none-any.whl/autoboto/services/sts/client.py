...
class Client:
    ...
    def assume_role(
        ...
        *,
        ...
        serial_number: str = autoboto.ShapeBase.NOT_SET,
        token_code: str = autoboto.ShapeBase.NOT_SET,
        ...
        **Using MFA with AssumeRole**
        ...
        if _request is None:
            ...
            if role_session_name is not autoboto.ShapeBase.NOT_SET:
            ...
            if token_code is not autoboto.ShapeBase.NOT_SET:
    ...
    def assume_role_with_saml(
        ...
        *,
        ...
        if _request is None:
            ...
            if saml_assertion is not autoboto.ShapeBase.NOT_SET:
    ...
    def assume_role_with_web_identity(
        ...
        *,
        ...
        provider_id: str = autoboto.ShapeBase.NOT_SET,
        policy: str = autoboto.ShapeBase.NOT_SET,
        duration_seconds: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if role_session_name is not autoboto.ShapeBase.NOT_SET:
                _params['role_session_name'] = role_session_name
            if web_identity_token is not autoboto.ShapeBase.NOT_SET:
                _params['web_identity_token'] = web_identity_token
            if provider_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def decode_authorization_message(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if encoded_message is not autoboto.ShapeBase.NOT_SET:
