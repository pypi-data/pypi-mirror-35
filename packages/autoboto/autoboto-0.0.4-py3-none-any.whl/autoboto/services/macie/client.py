...
class Client:
    ...
    def associate_member_account(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if member_account_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def associate_s3_resources(
        ...
        *,
        ...
        member_account_id: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if s3_resources is not autoboto.ShapeBase.NOT_SET:
    ...
    def disassociate_s3_resources(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if associated_s3_resources is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_s3_resources(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if s3_resources_update is not autoboto.ShapeBase.NOT_SET:
