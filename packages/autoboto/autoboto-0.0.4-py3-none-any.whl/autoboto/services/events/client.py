...
class Client:
    ...
    def list_rules(
        ...
        *,
        name_prefix: str = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        limit: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if name_prefix is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_rule(
        ...
        *,
        ...
        event_pattern: str = autoboto.ShapeBase.NOT_SET,
        state: shapes.RuleState = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if event_pattern is not autoboto.ShapeBase.NOT_SET:
    ...
    def test_event_pattern(
        ...
        *,
        ...
        if _request is None:
            ...
            if event_pattern is not autoboto.ShapeBase.NOT_SET:
                _params['event_pattern'] = event_pattern
            if event is not autoboto.ShapeBase.NOT_SET:
                _params['event'] = event
