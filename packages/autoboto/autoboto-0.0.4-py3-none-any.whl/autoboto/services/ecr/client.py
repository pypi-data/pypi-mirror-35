...
class Client:
    ...
    def batch_check_layer_availability(
        ...
        *,
        ...
        registry_id: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if layer_digests is not autoboto.ShapeBase.NOT_SET:
                _params['layer_digests'] = layer_digests
            if registry_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def batch_get_image(
        ...
        *,
        ...
        image_ids: typing.List[shapes.ImageIdentifier],
        registry_id: str = autoboto.ShapeBase.NOT_SET,
        accepted_media_types: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if registry_id is not autoboto.ShapeBase.NOT_SET:
                _params['registry_id'] = registry_id
            if accepted_media_types is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_images(
        ...
        *,
        ...
        filter: shapes.DescribeImagesFilter = autoboto.ShapeBase.NOT_SET,
    ...
    def describe_repositories(
        ...
        *,
        registry_id: str = autoboto.ShapeBase.NOT_SET,
        repository_names: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
    ...
    def get_authorization_token(
        ...
        *,
        registry_ids: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if registry_ids is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_download_url_for_layer(
        ...
        *,
        ...
        if _request is None:
            ...
            if repository_name is not autoboto.ShapeBase.NOT_SET:
                _params['repository_name'] = repository_name
            if layer_digest is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_images(
        ...
        *,
        ...
        next_token: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
        filter: shapes.ListImagesFilter = autoboto.ShapeBase.NOT_SET,
    ...
    def put_image(
        ...
        *,
        ...
        image_manifest: str,
        registry_id: str = autoboto.ShapeBase.NOT_SET,
        image_tag: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if repository_name is not autoboto.ShapeBase.NOT_SET:
                _params['repository_name'] = repository_name
            if image_manifest is not autoboto.ShapeBase.NOT_SET:
                _params['image_manifest'] = image_manifest
            if registry_id is not autoboto.ShapeBase.NOT_SET:
                _params['registry_id'] = registry_id
            if image_tag is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_lifecycle_policy(
        ...
        *,
        ...
        if _request is None:
            ...
            if repository_name is not autoboto.ShapeBase.NOT_SET:
                _params['repository_name'] = repository_name
            if lifecycle_policy_text is not autoboto.ShapeBase.NOT_SET:
    ...
    def set_repository_policy(
        ...
        *,
        ...
        if _request is None:
            ...
            if repository_name is not autoboto.ShapeBase.NOT_SET:
                _params['repository_name'] = repository_name
            if policy_text is not autoboto.ShapeBase.NOT_SET:
    ...
    def start_lifecycle_policy_preview(
        ...
        *,
        repository_name: str,
        registry_id: str = autoboto.ShapeBase.NOT_SET,
        lifecycle_policy_text: str = autoboto.ShapeBase.NOT_SET,
    ...
    def upload_layer_part(
        ...
        *,
        ...
        if _request is None:
            ...
            if upload_id is not autoboto.ShapeBase.NOT_SET:
                _params['upload_id'] = upload_id
            if part_first_byte is not autoboto.ShapeBase.NOT_SET:
                _params['part_first_byte'] = part_first_byte
            if part_last_byte is not autoboto.ShapeBase.NOT_SET:
                _params['part_last_byte'] = part_last_byte
            if layer_part_blob is not autoboto.ShapeBase.NOT_SET:
