...
class Client:
    ...
    def create_hsm(
        ...
        *,
        ...
        eni_ip: str = autoboto.ShapeBase.NOT_SET,
        external_id: str = autoboto.ShapeBase.NOT_SET,
        client_token: str = autoboto.ShapeBase.NOT_SET,
        syslog_ip: str = autoboto.ShapeBase.NOT_SET,
        ...
        **For information about the current version of AWS CloudHSM** , see [AWS
        ...
        if _request is None:
            ...
            if ssh_key is not autoboto.ShapeBase.NOT_SET:
            ...
            if eni_ip is not autoboto.ShapeBase.NOT_SET:
                _params['eni_ip'] = eni_ip
            if external_id is not autoboto.ShapeBase.NOT_SET:
                _params['external_id'] = external_id
            if client_token is not autoboto.ShapeBase.NOT_SET:
                _params['client_token'] = client_token
            if syslog_ip is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_luna_client(
        ...
        *,
        certificate: str,
        label: str = autoboto.ShapeBase.NOT_SET,
        ...
        **For information about the current version of AWS CloudHSM** , see [AWS
        ...
        if _request is None:
            _params = {}
            if certificate is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_hapg(
        ...
        **For information about the current version of AWS CloudHSM** , see [AWS
        ...
        if _request is None:
            _params = {}
            if hapg_arn is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_hsm(
        ...
        **For information about the current version of AWS CloudHSM** , see [AWS
        ...
        if _request is None:
            _params = {}
            if hsm_arn is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_luna_client(
        ...
        **For information about the current version of AWS CloudHSM** , see [AWS
        ...
        if _request is None:
            _params = {}
            if client_arn is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_hsm(
        ...
        *,
        hsm_arn: str = autoboto.ShapeBase.NOT_SET,
        hsm_serial_number: str = autoboto.ShapeBase.NOT_SET,
        ...
        **For information about the current version of AWS CloudHSM** , see [AWS
        ...
        if _request is None:
            ...
            if hsm_arn is not autoboto.ShapeBase.NOT_SET:
                _params['hsm_arn'] = hsm_arn
            if hsm_serial_number is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_luna_client(
        ...
        *,
        client_arn: str = autoboto.ShapeBase.NOT_SET,
        certificate_fingerprint: str = autoboto.ShapeBase.NOT_SET,
        ...
        **For information about the current version of AWS CloudHSM** , see [AWS
        ...
        if _request is None:
            ...
            if client_arn is not autoboto.ShapeBase.NOT_SET:
                _params['client_arn'] = client_arn
            if certificate_fingerprint is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_config(
        ...
        **For information about the current version of AWS CloudHSM** , see [AWS
        ...
        if _request is None:
            ...
            if client_arn is not autoboto.ShapeBase.NOT_SET:
                _params['client_arn'] = client_arn
            if client_version is not autoboto.ShapeBase.NOT_SET:
                _params['client_version'] = client_version
            if hapg_list is not autoboto.ShapeBase.NOT_SET:
    ...
    def modify_hapg(
        ...
        *,
        hapg_arn: str,
        label: str = autoboto.ShapeBase.NOT_SET,
        partition_serial_list: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        ...
        **For information about the current version of AWS CloudHSM** , see [AWS
        ...
        if _request is None:
            ...
            if label is not autoboto.ShapeBase.NOT_SET:
                _params['label'] = label
            if partition_serial_list is not autoboto.ShapeBase.NOT_SET:
    ...
    def modify_hsm(
        ...
        *,
        ...
        eni_ip: str = autoboto.ShapeBase.NOT_SET,
        iam_role_arn: str = autoboto.ShapeBase.NOT_SET,
        external_id: str = autoboto.ShapeBase.NOT_SET,
        syslog_ip: str = autoboto.ShapeBase.NOT_SET,
    ...
    def remove_tags_from_resource(
        ...
        **For information about the current version of AWS CloudHSM** , see [AWS
        ...
        if _request is None:
            ...
            if resource_arn is not autoboto.ShapeBase.NOT_SET:
                _params['resource_arn'] = resource_arn
            if tag_key_list is not autoboto.ShapeBase.NOT_SET:
