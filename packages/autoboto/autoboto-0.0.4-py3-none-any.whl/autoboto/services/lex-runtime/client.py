...
class Client:
    ...
    def post_content(
        ...
        *,
        ...
        session_attributes: str = autoboto.ShapeBase.NOT_SET,
        request_attributes: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if input_stream is not autoboto.ShapeBase.NOT_SET:
                _params['input_stream'] = input_stream
            if session_attributes is not autoboto.ShapeBase.NOT_SET:
                _params['session_attributes'] = session_attributes
            if request_attributes is not autoboto.ShapeBase.NOT_SET:
    ...
    def post_text(
        ...
        *,
        ...
        user_id: str,
        input_text: str,
        session_attributes: typing.Dict[str, str] = autoboto.ShapeBase.NOT_SET,
        request_attributes: typing.Dict[str, str] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if user_id is not autoboto.ShapeBase.NOT_SET:
                _params['user_id'] = user_id
            if input_text is not autoboto.ShapeBase.NOT_SET:
