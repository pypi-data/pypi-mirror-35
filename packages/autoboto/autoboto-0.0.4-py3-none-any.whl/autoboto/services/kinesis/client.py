...
class Client:
    ...
    def add_tags_to_stream(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if stream_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_stream(
        ...
        *,
        ...
        if _request is None:
            ...
            if stream_name is not autoboto.ShapeBase.NOT_SET:
                _params['stream_name'] = stream_name
            if shard_count is not autoboto.ShapeBase.NOT_SET:
    ...
    def decrease_stream_retention_period(
        ...
        *,
        ...
        if _request is None:
            ...
            if stream_name is not autoboto.ShapeBase.NOT_SET:
                _params['stream_name'] = stream_name
            if retention_period_hours is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_stream(
        ...
        *,
        stream_name: str,
        enforce_consumer_deletion: bool = autoboto.ShapeBase.NOT_SET,
    ) -> None:
        """
        ...
        **Note:** Kinesis Data Streams might continue to accept data read and write
        ...
        if _request is None:
            ...
            if stream_name is not autoboto.ShapeBase.NOT_SET:
                _params['stream_name'] = stream_name
            if enforce_consumer_deletion is not autoboto.ShapeBase.NOT_SET:
    ...
    def deregister_stream_consumer(
        ...
        *,
        stream_arn: str = autoboto.ShapeBase.NOT_SET,
        consumer_name: str = autoboto.ShapeBase.NOT_SET,
        consumer_arn: str = autoboto.ShapeBase.NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            _params = {}
            if stream_arn is not autoboto.ShapeBase.NOT_SET:
                _params['stream_arn'] = stream_arn
            if consumer_name is not autoboto.ShapeBase.NOT_SET:
                _params['consumer_name'] = consumer_name
            if consumer_arn is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_stream(
        ...
        *,
        ...
        exclusive_start_shard_id: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if limit is not autoboto.ShapeBase.NOT_SET:
                _params['limit'] = limit
            if exclusive_start_shard_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def disable_enhanced_monitoring(
        ...
        *,
        ...
        if _request is None:
            ...
            if stream_name is not autoboto.ShapeBase.NOT_SET:
                _params['stream_name'] = stream_name
            if shard_level_metrics is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_records(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if shard_iterator is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_shard_iterator(
        ...
        *,
        ...
        starting_sequence_number: str = autoboto.ShapeBase.NOT_SET,
        timestamp: datetime.datetime = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if stream_name is not autoboto.ShapeBase.NOT_SET:
                _params['stream_name'] = stream_name
            if shard_id is not autoboto.ShapeBase.NOT_SET:
                _params['shard_id'] = shard_id
            if shard_iterator_type is not autoboto.ShapeBase.NOT_SET:
                _params['shard_iterator_type'] = shard_iterator_type
            if starting_sequence_number is not autoboto.ShapeBase.NOT_SET:
                _params['starting_sequence_number'] = starting_sequence_number
            if timestamp is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_shards(
        ...
        *,
        stream_name: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if stream_creation_timestamp is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_streams(
        ...
        *,
        limit: int = autoboto.ShapeBase.NOT_SET,
        exclusive_start_stream_name: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if limit is not autoboto.ShapeBase.NOT_SET:
                _params['limit'] = limit
            if exclusive_start_stream_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_tags_for_stream(
        ...
        *,
        stream_name: str,
        exclusive_start_tag_key: str = autoboto.ShapeBase.NOT_SET,
        limit: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if stream_name is not autoboto.ShapeBase.NOT_SET:
                _params['stream_name'] = stream_name
            if exclusive_start_tag_key is not autoboto.ShapeBase.NOT_SET:
    ...
    def merge_shards(
        ...
        *,
        ...
        if _request is None:
            ...
            if stream_name is not autoboto.ShapeBase.NOT_SET:
                _params['stream_name'] = stream_name
            if shard_to_merge is not autoboto.ShapeBase.NOT_SET:
                _params['shard_to_merge'] = shard_to_merge
            if adjacent_shard_to_merge is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_record(
        ...
        *,
        ...
        data: typing.Any,
        partition_key: str,
        explicit_hash_key: str = autoboto.ShapeBase.NOT_SET,
        sequence_number_for_ordering: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if stream_name is not autoboto.ShapeBase.NOT_SET:
                _params['stream_name'] = stream_name
            if data is not autoboto.ShapeBase.NOT_SET:
                _params['data'] = data
            if partition_key is not autoboto.ShapeBase.NOT_SET:
                _params['partition_key'] = partition_key
            if explicit_hash_key is not autoboto.ShapeBase.NOT_SET:
                _params['explicit_hash_key'] = explicit_hash_key
            if sequence_number_for_ordering is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_records(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if records is not autoboto.ShapeBase.NOT_SET:
    ...
    def split_shard(
        ...
        *,
        ...
        if _request is None:
            ...
            if stream_name is not autoboto.ShapeBase.NOT_SET:
                _params['stream_name'] = stream_name
            if shard_to_split is not autoboto.ShapeBase.NOT_SET:
                _params['shard_to_split'] = shard_to_split
            if new_starting_hash_key is not autoboto.ShapeBase.NOT_SET:
    ...
    def start_stream_encryption(
        ...
        *,
        ...
        if _request is None:
            ...
            if stream_name is not autoboto.ShapeBase.NOT_SET:
                _params['stream_name'] = stream_name
            if encryption_type is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_shard_count(
        ...
        *,
        ...
        if _request is None:
            ...
            if stream_name is not autoboto.ShapeBase.NOT_SET:
                _params['stream_name'] = stream_name
            if target_shard_count is not autoboto.ShapeBase.NOT_SET:
                _params['target_shard_count'] = target_shard_count
            if scaling_type is not autoboto.ShapeBase.NOT_SET:
