...
class Client:
    ...
    def add_permission(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if queue_url is not autoboto.ShapeBase.NOT_SET:
                _params['queue_url'] = queue_url
            if label is not autoboto.ShapeBase.NOT_SET:
                _params['label'] = label
            if aws_account_ids is not autoboto.ShapeBase.NOT_SET:
    ...
    def change_message_visibility(
        ...
        *,
        ...
        if _request is None:
            ...
            if queue_url is not autoboto.ShapeBase.NOT_SET:
                _params['queue_url'] = queue_url
            if receipt_handle is not autoboto.ShapeBase.NOT_SET:
                _params['receipt_handle'] = receipt_handle
            if visibility_timeout is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_queue(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if queue_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_queue_url(
        ...
        *,
        queue_name: str,
        queue_owner_aws_account_id: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if queue_name is not autoboto.ShapeBase.NOT_SET:
                _params['queue_name'] = queue_name
            if queue_owner_aws_account_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_queues(
        ...
        *,
        queue_name_prefix: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if queue_name_prefix is not autoboto.ShapeBase.NOT_SET:
    ...
    def receive_message(
        ...
        *,
        ...
        message_attribute_names: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        max_number_of_messages: int = autoboto.ShapeBase.NOT_SET,
        visibility_timeout: int = autoboto.ShapeBase.NOT_SET,
        wait_time_seconds: int = autoboto.ShapeBase.NOT_SET,
        receive_request_attempt_id: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if attribute_names is not autoboto.ShapeBase.NOT_SET:
                _params['attribute_names'] = attribute_names
            if message_attribute_names is not autoboto.ShapeBase.NOT_SET:
                _params['message_attribute_names'] = message_attribute_names
            if max_number_of_messages is not autoboto.ShapeBase.NOT_SET:
                _params['max_number_of_messages'] = max_number_of_messages
            if visibility_timeout is not autoboto.ShapeBase.NOT_SET:
                _params['visibility_timeout'] = visibility_timeout
            if wait_time_seconds is not autoboto.ShapeBase.NOT_SET:
                _params['wait_time_seconds'] = wait_time_seconds
            if receive_request_attempt_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def send_message(
        ...
        *,
        queue_url: str,
        message_body: str,
        delay_seconds: int = autoboto.ShapeBase.NOT_SET,
        message_attributes: typing.Dict[str, shapes.MessageAttributeValue
                                       ] = autoboto.ShapeBase.NOT_SET,
        message_deduplication_id: str = autoboto.ShapeBase.NOT_SET,
        message_group_id: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if queue_url is not autoboto.ShapeBase.NOT_SET:
                _params['queue_url'] = queue_url
            if message_body is not autoboto.ShapeBase.NOT_SET:
                _params['message_body'] = message_body
            if delay_seconds is not autoboto.ShapeBase.NOT_SET:
            ...
            if message_deduplication_id is not autoboto.ShapeBase.NOT_SET:
                _params['message_deduplication_id'] = message_deduplication_id
            if message_group_id is not autoboto.ShapeBase.NOT_SET:
