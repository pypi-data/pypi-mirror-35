...
class Client:
    ...
    def delete_attributes(
        ...
        *,
        ...
        expected: shapes.UpdateCondition = autoboto.ShapeBase.NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            ...
            if domain_name is not autoboto.ShapeBase.NOT_SET:
                _params['domain_name'] = domain_name
            if item_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_attributes(
        ...
        *,
        domain_name: str,
        item_name: str,
        attribute_names: typing.List[str] = autoboto.ShapeBase.NOT_SET,
    ...
    def list_domains(
        ...
        *,
        max_number_of_domains: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if max_number_of_domains is not autoboto.ShapeBase.NOT_SET:
    ...
    def select(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if select_expression is not autoboto.ShapeBase.NOT_SET:
