...
@dataclasses.dataclass
class Fragment(autoboto.ShapeBase):
    """
    ...
    fragment_number: str = dataclasses.field(
    ...
    fragment_size_in_bytes: int = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
...
@dataclasses.dataclass
class FragmentSelector(autoboto.ShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            (
                ...
                autoboto.TypeInfo(FragmentSelectorType),
            ),
            (
                "timestamp_range",
                "TimestampRange",
...
@dataclasses.dataclass
class GetHLSStreamingSessionURLInput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
            ...
            (
                "playback_mode",
                "PlaybackMode",
                autoboto.TypeInfo(PlaybackMode),
            ),
            (
                "hls_fragment_selector",
                "HLSFragmentSelector",
                autoboto.TypeInfo(HLSFragmentSelector),
            ),
            (
                "discontinuity_mode",
                "DiscontinuityMode",
                autoboto.TypeInfo(DiscontinuityMode),
            ),
            (
                "expires",
                "Expires",
...
@dataclasses.dataclass
class GetHLSStreamingSessionURLOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class GetMediaForFragmentListInput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class GetMediaForFragmentListOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class HLSFragmentSelector(autoboto.ShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "fragment_selector_type",
                "FragmentSelectorType",
                autoboto.TypeInfo(HLSFragmentSelectorType),
            ),
            (
                "timestamp_range",
                "TimestampRange",
                autoboto.TypeInfo(HLSTimestampRange),
            ),
        ]
...
@dataclasses.dataclass
class HLSTimestampRange(autoboto.ShapeBase):
    """
    The start and end of the time stamp range for the requested media.
...
@dataclasses.dataclass
class InvalidCodecPrivateDataException(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class ListFragmentsInput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
            ...
            (
                "fragment_selector",
                "FragmentSelector",
                autoboto.TypeInfo(FragmentSelector),
            ),
        ]
...
@dataclasses.dataclass
class ListFragmentsOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
            ...
            (
                "fragments",
                "Fragments",
                autoboto.TypeInfo(typing.List[Fragment]),
            ),
            (
                "next_token",
                "NextToken",
...
@dataclasses.dataclass
class MissingCodecPrivateDataException(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class NoDataRetentionException(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class UnsupportedStreamMediaTypeException(autoboto.ShapeBase):
    """
