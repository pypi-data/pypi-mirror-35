...
class Client:
    ...
    def authorize_ip_rules(
        ...
        *,
        ...
        if _request is None:
            ...
            if user_rules is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_ip_group(
        ...
        *,
        group_name: str,
        group_desc: str = autoboto.ShapeBase.NOT_SET,
        user_rules: typing.List[shapes.IpRuleItem] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if group_desc is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_workspaces(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if workspaces is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_workspaces(
        ...
        *,
        workspace_ids: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        directory_id: str = autoboto.ShapeBase.NOT_SET,
        user_name: str = autoboto.ShapeBase.NOT_SET,
        bundle_id: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if workspace_ids is not autoboto.ShapeBase.NOT_SET:
    ...
    def modify_workspace_properties(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if workspace_id is not autoboto.ShapeBase.NOT_SET:
                _params['workspace_id'] = workspace_id
            if workspace_properties is not autoboto.ShapeBase.NOT_SET:
    ...
    def modify_workspace_state(
        ...
        *,
        ...
        if _request is None:
            ...
            if workspace_id is not autoboto.ShapeBase.NOT_SET:
                _params['workspace_id'] = workspace_id
            if workspace_state is not autoboto.ShapeBase.NOT_SET:
    ...
    def reboot_workspaces(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if reboot_workspace_requests is not autoboto.ShapeBase.NOT_SET:
    ...
    def rebuild_workspaces(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if rebuild_workspace_requests is not autoboto.ShapeBase.NOT_SET:
    ...
    def start_workspaces(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if start_workspace_requests is not autoboto.ShapeBase.NOT_SET:
    ...
    def stop_workspaces(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if stop_workspace_requests is not autoboto.ShapeBase.NOT_SET:
    ...
    def terminate_workspaces(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if terminate_workspace_requests is not autoboto.ShapeBase.NOT_SET:
