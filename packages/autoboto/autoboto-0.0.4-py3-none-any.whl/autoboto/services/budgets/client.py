    ...
    def create_budget(
        ...
        *,
        ...
        if _request is None:
            ...
            if budget is not autoboto.ShapeBase.NOT_SET:
                _params['budget'] = budget
            if notifications_with_subscribers is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_subscriber(
        ...
        *,
        ...
        if _request is None:
            ...
            if notification is not autoboto.ShapeBase.NOT_SET:
                _params['notification'] = notification
            if subscriber is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_budget(
        ...
        *,
        ...
        if _request is None:
            ...
            if account_id is not autoboto.ShapeBase.NOT_SET:
                _params['account_id'] = account_id
            if new_budget is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_notification(
        ...
        *,
        ...
        if _request is None:
            ...
            if budget_name is not autoboto.ShapeBase.NOT_SET:
                _params['budget_name'] = budget_name
            if old_notification is not autoboto.ShapeBase.NOT_SET:
                _params['old_notification'] = old_notification
            if new_notification is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_subscriber(
        ...
        *,
        ...
        if _request is None:
            ...
            if notification is not autoboto.ShapeBase.NOT_SET:
                _params['notification'] = notification
            if old_subscriber is not autoboto.ShapeBase.NOT_SET:
                _params['old_subscriber'] = old_subscriber
            if new_subscriber is not autoboto.ShapeBase.NOT_SET:
