...
class Client:
    ...
    def associate_delegate_to_resource(
        ...
        *,
        ...
        if _request is None:
            ...
            if entity_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def associate_member_to_group(
        ...
        *,
        ...
        if _request is None:
            ...
            if member_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_mailbox_permissions(
        ...
        *,
        ...
        if _request is None:
            ...
            if entity_id is not autoboto.ShapeBase.NOT_SET:
                _params['entity_id'] = entity_id
            if grantee_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_mailbox_permissions(
        ...
        *,
        ...
        if _request is None:
            ...
            if grantee_id is not autoboto.ShapeBase.NOT_SET:
                _params['grantee_id'] = grantee_id
            if permission_values is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_resource(
        ...
        *,
        ...
        booking_options: shapes.BookingOptions = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase.NOT_SET:
                _params['name'] = name
            if booking_options is not autoboto.ShapeBase.NOT_SET:
