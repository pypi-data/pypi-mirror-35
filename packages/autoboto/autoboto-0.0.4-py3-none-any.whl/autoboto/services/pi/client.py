...
class Client:
    ...
    def describe_dimension_keys(
        ...
        *,
        ...
        period_in_seconds: int = autoboto.ShapeBase.NOT_SET,
        partition_by: shapes.DimensionGroup = autoboto.ShapeBase.NOT_SET,
        filter: typing.Dict[str, str] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if service_type is not autoboto.ShapeBase.NOT_SET:
            ...
            if metric is not autoboto.ShapeBase.NOT_SET:
                _params['metric'] = metric
            if group_by is not autoboto.ShapeBase.NOT_SET:
                _params['group_by'] = group_by
            if period_in_seconds is not autoboto.ShapeBase.NOT_SET:
                _params['period_in_seconds'] = period_in_seconds
            if partition_by is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_resource_metrics(
        ...
        *,
        ...
        if _request is None:
            ...
            if identifier is not autoboto.ShapeBase.NOT_SET:
                _params['identifier'] = identifier
            if metric_queries is not autoboto.ShapeBase.NOT_SET:
