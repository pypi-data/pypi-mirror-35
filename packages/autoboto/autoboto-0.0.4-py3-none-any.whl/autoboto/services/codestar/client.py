...
class Client:
    ...
    def associate_team_member(
        ...
        *,
        ...
        remote_access_allowed: bool = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if remote_access_allowed is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_project(
        ...
        *,
        id: str,
        client_request_token: str = autoboto.ShapeBase.NOT_SET,
        delete_stack: bool = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if client_request_token is not autoboto.ShapeBase.NOT_SET:
                _params['client_request_token'] = client_request_token
            if delete_stack is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_team_member(
        ...
        *,
        project_id: str,
        user_arn: str,
        project_role: str = autoboto.ShapeBase.NOT_SET,
        remote_access_allowed: bool = autoboto.ShapeBase.NOT_SET,
