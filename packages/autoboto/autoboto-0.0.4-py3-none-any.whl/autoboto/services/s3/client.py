...
class Client:
    ...
    def abort_multipart_upload(
        ...
        *,
        ...
        key: str,
        upload_id: str,
        request_payer: shapes.RequestPayer = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if key is not autoboto.ShapeBase.NOT_SET:
                _params['key'] = key
            if upload_id is not autoboto.ShapeBase.NOT_SET:
                _params['upload_id'] = upload_id
            if request_payer is not autoboto.ShapeBase.NOT_SET:
    ...
    def complete_multipart_upload(
        ...
        *,
        ...
        if _request is None:
            ...
            if upload_id is not autoboto.ShapeBase.NOT_SET:
                _params['upload_id'] = upload_id
            if multipart_upload is not autoboto.ShapeBase.NOT_SET:
    ...
    def copy_object(
        ...
        *,
        ...
        copy_source: str,
        key: str,
        acl: shapes.ObjectCannedACL = autoboto.ShapeBase.NOT_SET,
        cache_control: str = autoboto.ShapeBase.NOT_SET,
        content_disposition: str = autoboto.ShapeBase.NOT_SET,
        content_encoding: str = autoboto.ShapeBase.NOT_SET,
        content_language: str = autoboto.ShapeBase.NOT_SET,
        content_type: str = autoboto.ShapeBase.NOT_SET,
        copy_source_if_match: str = autoboto.ShapeBase.NOT_SET,
        copy_source_if_modified_since: datetime.datetime = autoboto.ShapeBase.
        NOT_SET,
        copy_source_if_none_match: str = autoboto.ShapeBase.NOT_SET,
        copy_source_if_unmodified_since: datetime.datetime = autoboto.ShapeBase.
        NOT_SET,
        expires: datetime.datetime = autoboto.ShapeBase.NOT_SET,
        grant_full_control: str = autoboto.ShapeBase.NOT_SET,
        grant_read: str = autoboto.ShapeBase.NOT_SET,
        grant_read_acp: str = autoboto.ShapeBase.NOT_SET,
        grant_write_acp: str = autoboto.ShapeBase.NOT_SET,
        metadata: typing.Dict[str, str] = autoboto.ShapeBase.NOT_SET,
        metadata_directive: shapes.MetadataDirective = autoboto.ShapeBase.
        NOT_SET,
        tagging_directive: shapes.TaggingDirective = autoboto.ShapeBase.NOT_SET,
        server_side_encryption: shapes.ServerSideEncryption = autoboto.
        ShapeBase.NOT_SET,
        storage_class: shapes.StorageClass = autoboto.ShapeBase.NOT_SET,
        website_redirect_location: str = autoboto.ShapeBase.NOT_SET,
        sse_customer_algorithm: str = autoboto.ShapeBase.NOT_SET,
        sse_customer_key: str = autoboto.ShapeBase.NOT_SET,
        sse_customer_key_md5: str = autoboto.ShapeBase.NOT_SET,
        ssekms_key_id: str = autoboto.ShapeBase.NOT_SET,
        copy_source_sse_customer_algorithm: str = autoboto.ShapeBase.NOT_SET,
        copy_source_sse_customer_key: str = autoboto.ShapeBase.NOT_SET,
        copy_source_sse_customer_key_md5: str = autoboto.ShapeBase.NOT_SET,
        request_payer: shapes.RequestPayer = autoboto.ShapeBase.NOT_SET,
        tagging: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if bucket is not autoboto.ShapeBase.NOT_SET:
                _params['bucket'] = bucket
            if copy_source is not autoboto.ShapeBase.NOT_SET:
                _params['copy_source'] = copy_source
            if key is not autoboto.ShapeBase.NOT_SET:
                _params['key'] = key
            if acl is not autoboto.ShapeBase.NOT_SET:
                _params['acl'] = acl
            if cache_control is not autoboto.ShapeBase.NOT_SET:
                _params['cache_control'] = cache_control
            if content_disposition is not autoboto.ShapeBase.NOT_SET:
                _params['content_disposition'] = content_disposition
            if content_encoding is not autoboto.ShapeBase.NOT_SET:
                _params['content_encoding'] = content_encoding
            if content_language is not autoboto.ShapeBase.NOT_SET:
            ...
            if copy_source_if_match is not autoboto.ShapeBase.NOT_SET:
                _params['copy_source_if_match'] = copy_source_if_match
            if copy_source_if_modified_since is not autoboto.ShapeBase.NOT_SET:
                _params['copy_source_if_modified_since'
                       ] = copy_source_if_modified_since
            if copy_source_if_none_match is not autoboto.ShapeBase.NOT_SET:
                _params['copy_source_if_none_match'] = copy_source_if_none_match
            if copy_source_if_unmodified_since is not autoboto.ShapeBase.NOT_SET:
                _params['copy_source_if_unmodified_since'
                       ] = copy_source_if_unmodified_since
            if expires is not autoboto.ShapeBase.NOT_SET:
                _params['expires'] = expires
            if grant_full_control is not autoboto.ShapeBase.NOT_SET:
                _params['grant_full_control'] = grant_full_control
            if grant_read is not autoboto.ShapeBase.NOT_SET:
                _params['grant_read'] = grant_read
            if grant_read_acp is not autoboto.ShapeBase.NOT_SET:
                _params['grant_read_acp'] = grant_read_acp
            if grant_write_acp is not autoboto.ShapeBase.NOT_SET:
                _params['grant_write_acp'] = grant_write_acp
            if metadata is not autoboto.ShapeBase.NOT_SET:
                _params['metadata'] = metadata
            if metadata_directive is not autoboto.ShapeBase.NOT_SET:
                _params['metadata_directive'] = metadata_directive
            if tagging_directive is not autoboto.ShapeBase.NOT_SET:
                _params['tagging_directive'] = tagging_directive
            if server_side_encryption is not autoboto.ShapeBase.NOT_SET:
                _params['server_side_encryption'] = server_side_encryption
            if storage_class is not autoboto.ShapeBase.NOT_SET:
                _params['storage_class'] = storage_class
            if website_redirect_location is not autoboto.ShapeBase.NOT_SET:
                _params['website_redirect_location'] = website_redirect_location
            if sse_customer_algorithm is not autoboto.ShapeBase.NOT_SET:
                _params['sse_customer_algorithm'] = sse_customer_algorithm
            if sse_customer_key is not autoboto.ShapeBase.NOT_SET:
                _params['sse_customer_key'] = sse_customer_key
            if sse_customer_key_md5 is not autoboto.ShapeBase.NOT_SET:
                _params['sse_customer_key_md5'] = sse_customer_key_md5
            if ssekms_key_id is not autoboto.ShapeBase.NOT_SET:
                _params['ssekms_key_id'] = ssekms_key_id
            if copy_source_sse_customer_algorithm is not autoboto.ShapeBase.NOT_SET:
                _params['copy_source_sse_customer_algorithm'
                       ] = copy_source_sse_customer_algorithm
            if copy_source_sse_customer_key is not autoboto.ShapeBase.NOT_SET:
                _params['copy_source_sse_customer_key'
                       ] = copy_source_sse_customer_key
            if copy_source_sse_customer_key_md5 is not autoboto.ShapeBase.NOT_SET:
                _params['copy_source_sse_customer_key_md5'
                       ] = copy_source_sse_customer_key_md5
            if request_payer is not autoboto.ShapeBase.NOT_SET:
                _params['request_payer'] = request_payer
            if tagging is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_bucket(
        ...
        *,
        bucket: str,
        acl: shapes.BucketCannedACL = autoboto.ShapeBase.NOT_SET,
        create_bucket_configuration: shapes.
        CreateBucketConfiguration = autoboto.ShapeBase.NOT_SET,
        grant_full_control: str = autoboto.ShapeBase.NOT_SET,
        grant_read: str = autoboto.ShapeBase.NOT_SET,
        grant_read_acp: str = autoboto.ShapeBase.NOT_SET,
        grant_write: str = autoboto.ShapeBase.NOT_SET,
        grant_write_acp: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if acl is not autoboto.ShapeBase.NOT_SET:
                _params['acl'] = acl
            if create_bucket_configuration is not autoboto.ShapeBase.NOT_SET:
            ...
            if grant_read_acp is not autoboto.ShapeBase.NOT_SET:
                _params['grant_read_acp'] = grant_read_acp
            if grant_write is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_object(
        ...
        *,
        bucket: str,
        key: str,
        mfa: str = autoboto.ShapeBase.NOT_SET,
        version_id: str = autoboto.ShapeBase.NOT_SET,
        request_payer: shapes.RequestPayer = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if key is not autoboto.ShapeBase.NOT_SET:
                _params['key'] = key
            if mfa is not autoboto.ShapeBase.NOT_SET:
                _params['mfa'] = mfa
            if version_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_objects(
        ...
        *,
        ...
        if _request is None:
            ...
            if bucket is not autoboto.ShapeBase.NOT_SET:
                _params['bucket'] = bucket
            if delete is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_object(
        ...
        *,
        bucket: str,
        key: str,
        if_match: str = autoboto.ShapeBase.NOT_SET,
        if_modified_since: datetime.datetime = autoboto.ShapeBase.NOT_SET,
        if_none_match: str = autoboto.ShapeBase.NOT_SET,
        if_unmodified_since: datetime.datetime = autoboto.ShapeBase.NOT_SET,
        range: str = autoboto.ShapeBase.NOT_SET,
        response_cache_control: str = autoboto.ShapeBase.NOT_SET,
        response_content_disposition: str = autoboto.ShapeBase.NOT_SET,
        response_content_encoding: str = autoboto.ShapeBase.NOT_SET,
        response_content_language: str = autoboto.ShapeBase.NOT_SET,
        response_content_type: str = autoboto.ShapeBase.NOT_SET,
        response_expires: datetime.datetime = autoboto.ShapeBase.NOT_SET,
        version_id: str = autoboto.ShapeBase.NOT_SET,
        sse_customer_algorithm: str = autoboto.ShapeBase.NOT_SET,
        sse_customer_key: str = autoboto.ShapeBase.NOT_SET,
        sse_customer_key_md5: str = autoboto.ShapeBase.NOT_SET,
        request_payer: shapes.RequestPayer = autoboto.ShapeBase.NOT_SET,
        part_number: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if key is not autoboto.ShapeBase.NOT_SET:
                _params['key'] = key
            if if_match is not autoboto.ShapeBase.NOT_SET:
                _params['if_match'] = if_match
            if if_modified_since is not autoboto.ShapeBase.NOT_SET:
                _params['if_modified_since'] = if_modified_since
            if if_none_match is not autoboto.ShapeBase.NOT_SET:
                _params['if_none_match'] = if_none_match
            if if_unmodified_since is not autoboto.ShapeBase.NOT_SET:
                _params['if_unmodified_since'] = if_unmodified_since
            if range is not autoboto.ShapeBase.NOT_SET:
                _params['range'] = range
            if response_cache_control is not autoboto.ShapeBase.NOT_SET:
                _params['response_cache_control'] = response_cache_control
            if response_content_disposition is not autoboto.ShapeBase.NOT_SET:
                _params['response_content_disposition'
                       ] = response_content_disposition
            if response_content_encoding is not autoboto.ShapeBase.NOT_SET:
                _params['response_content_encoding'] = response_content_encoding
            if response_content_language is not autoboto.ShapeBase.NOT_SET:
                _params['response_content_language'] = response_content_language
            if response_content_type is not autoboto.ShapeBase.NOT_SET:
                _params['response_content_type'] = response_content_type
            if response_expires is not autoboto.ShapeBase.NOT_SET:
            ...
            if request_payer is not autoboto.ShapeBase.NOT_SET:
                _params['request_payer'] = request_payer
            if part_number is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_bucket_analytics_configurations(
        ...
        *,
        bucket: str,
        continuation_token: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if bucket is not autoboto.ShapeBase.NOT_SET:
                _params['bucket'] = bucket
            if continuation_token is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_multipart_uploads(
        ...
        *,
        bucket: str,
        delimiter: str = autoboto.ShapeBase.NOT_SET,
        encoding_type: shapes.EncodingType = autoboto.ShapeBase.NOT_SET,
        key_marker: str = autoboto.ShapeBase.NOT_SET,
        max_uploads: int = autoboto.ShapeBase.NOT_SET,
        prefix: str = autoboto.ShapeBase.NOT_SET,
        upload_id_marker: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if bucket is not autoboto.ShapeBase.NOT_SET:
                _params['bucket'] = bucket
            if delimiter is not autoboto.ShapeBase.NOT_SET:
                _params['delimiter'] = delimiter
            if encoding_type is not autoboto.ShapeBase.NOT_SET:
                _params['encoding_type'] = encoding_type
            if key_marker is not autoboto.ShapeBase.NOT_SET:
                _params['key_marker'] = key_marker
            if max_uploads is not autoboto.ShapeBase.NOT_SET:
                _params['max_uploads'] = max_uploads
            if prefix is not autoboto.ShapeBase.NOT_SET:
                _params['prefix'] = prefix
            if upload_id_marker is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_object_versions(
        ...
        *,
        ...
        encoding_type: shapes.EncodingType = autoboto.ShapeBase.NOT_SET,
        key_marker: str = autoboto.ShapeBase.NOT_SET,
        max_keys: int = autoboto.ShapeBase.NOT_SET,
        prefix: str = autoboto.ShapeBase.NOT_SET,
        version_id_marker: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if key_marker is not autoboto.ShapeBase.NOT_SET:
                _params['key_marker'] = key_marker
            if max_keys is not autoboto.ShapeBase.NOT_SET:
                _params['max_keys'] = max_keys
            if prefix is not autoboto.ShapeBase.NOT_SET:
                _params['prefix'] = prefix
            if version_id_marker is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_objects_v2(
        ...
        *,
        ...
        prefix: str = autoboto.ShapeBase.NOT_SET,
        continuation_token: str = autoboto.ShapeBase.NOT_SET,
        fetch_owner: bool = autoboto.ShapeBase.NOT_SET,
        start_after: str = autoboto.ShapeBase.NOT_SET,
        request_payer: shapes.RequestPayer = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if continuation_token is not autoboto.ShapeBase.NOT_SET:
                _params['continuation_token'] = continuation_token
            if fetch_owner is not autoboto.ShapeBase.NOT_SET:
                _params['fetch_owner'] = fetch_owner
            if start_after is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_parts(
        ...
        *,
        ...
        key: str,
        upload_id: str,
        max_parts: int = autoboto.ShapeBase.NOT_SET,
        part_number_marker: int = autoboto.ShapeBase.NOT_SET,
        request_payer: shapes.RequestPayer = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if upload_id is not autoboto.ShapeBase.NOT_SET:
                _params['upload_id'] = upload_id
            if max_parts is not autoboto.ShapeBase.NOT_SET:
                _params['max_parts'] = max_parts
            if part_number_marker is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_bucket_accelerate_configuration(
        ...
        *,
        ...
        if _request is None:
            ...
            if bucket is not autoboto.ShapeBase.NOT_SET:
                _params['bucket'] = bucket
            if accelerate_configuration is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_bucket_acl(
        ...
        *,
        ...
        NOT_SET,
        content_md5: str = autoboto.ShapeBase.NOT_SET,
        grant_full_control: str = autoboto.ShapeBase.NOT_SET,
        grant_read: str = autoboto.ShapeBase.NOT_SET,
        grant_read_acp: str = autoboto.ShapeBase.NOT_SET,
        grant_write: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if acl is not autoboto.ShapeBase.NOT_SET:
                _params['acl'] = acl
            if access_control_policy is not autoboto.ShapeBase.NOT_SET:
                _params['access_control_policy'] = access_control_policy
            if content_md5 is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_bucket_cors(
        ...
        *,
        ...
        if _request is None:
            ...
            if bucket is not autoboto.ShapeBase.NOT_SET:
                _params['bucket'] = bucket
            if cors_configuration is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_bucket_encryption(
        ...
        *,
        ...
        if _request is None:
            ...
            if bucket is not autoboto.ShapeBase.NOT_SET:
                _params['bucket'] = bucket
            if server_side_encryption_configuration is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_bucket_inventory_configuration(
        ...
        *,
        ...
        if _request is None:
            ...
            if id is not autoboto.ShapeBase.NOT_SET:
                _params['id'] = id
            if inventory_configuration is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_bucket_lifecycle(
        ...
        *,
        ...
        if _request is None:
            ...
            if content_md5 is not autoboto.ShapeBase.NOT_SET:
                _params['content_md5'] = content_md5
            if lifecycle_configuration is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_bucket_logging(
        ...
        *,
        ...
        if _request is None:
            ...
            if bucket is not autoboto.ShapeBase.NOT_SET:
                _params['bucket'] = bucket
            if bucket_logging_status is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_bucket_metrics_configuration(
        ...
        *,
        ...
        if _request is None:
            ...
            if id is not autoboto.ShapeBase.NOT_SET:
                _params['id'] = id
            if metrics_configuration is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_bucket_notification(
        ...
        *,
        ...
        if _request is None:
            ...
            if bucket is not autoboto.ShapeBase.NOT_SET:
                _params['bucket'] = bucket
            if notification_configuration is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_bucket_policy(
        ...
        *,
        ...
        policy: str,
        content_md5: str = autoboto.ShapeBase.NOT_SET,
        confirm_remove_self_bucket_access: bool = autoboto.ShapeBase.NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            ...
            if content_md5 is not autoboto.ShapeBase.NOT_SET:
                _params['content_md5'] = content_md5
            if confirm_remove_self_bucket_access is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_bucket_replication(
        ...
        *,
        ...
        if _request is None:
            ...
            if bucket is not autoboto.ShapeBase.NOT_SET:
                _params['bucket'] = bucket
            if replication_configuration is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_bucket_request_payment(
        ...
        *,
        ...
        if _request is None:
            ...
            if bucket is not autoboto.ShapeBase.NOT_SET:
                _params['bucket'] = bucket
            if request_payment_configuration is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_bucket_versioning(
        ...
        *,
        ...
        if _request is None:
            ...
            if bucket is not autoboto.ShapeBase.NOT_SET:
                _params['bucket'] = bucket
            if versioning_configuration is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_bucket_website(
        ...
        *,
        ...
        if _request is None:
            ...
            if bucket is not autoboto.ShapeBase.NOT_SET:
                _params['bucket'] = bucket
            if website_configuration is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_object(
        ...
        *,
        ...
        key: str,
        acl: shapes.ObjectCannedACL = autoboto.ShapeBase.NOT_SET,
        body: typing.Any = autoboto.ShapeBase.NOT_SET,
        cache_control: str = autoboto.ShapeBase.NOT_SET,
        content_disposition: str = autoboto.ShapeBase.NOT_SET,
        content_encoding: str = autoboto.ShapeBase.NOT_SET,
        content_language: str = autoboto.ShapeBase.NOT_SET,
        content_length: int = autoboto.ShapeBase.NOT_SET,
        content_md5: str = autoboto.ShapeBase.NOT_SET,
        content_type: str = autoboto.ShapeBase.NOT_SET,
        expires: datetime.datetime = autoboto.ShapeBase.NOT_SET,
        grant_full_control: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if content_language is not autoboto.ShapeBase.NOT_SET:
                _params['content_language'] = content_language
            if content_length is not autoboto.ShapeBase.NOT_SET:
    ...
    def restore_object(
        ...
        *,
        ...
        key: str,
        version_id: str = autoboto.ShapeBase.NOT_SET,
        restore_request: shapes.RestoreRequest = autoboto.ShapeBase.NOT_SET,
        request_payer: shapes.RequestPayer = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if version_id is not autoboto.ShapeBase.NOT_SET:
                _params['version_id'] = version_id
            if restore_request is not autoboto.ShapeBase.NOT_SET:
    ...
    def select_object_content(
        ...
        *,
        ...
        sse_customer_key: str = autoboto.ShapeBase.NOT_SET,
        sse_customer_key_md5: str = autoboto.ShapeBase.NOT_SET,
        request_progress: shapes.RequestProgress = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if key is not autoboto.ShapeBase.NOT_SET:
                _params['key'] = key
            if expression is not autoboto.ShapeBase.NOT_SET:
                _params['expression'] = expression
            if expression_type is not autoboto.ShapeBase.NOT_SET:
                _params['expression_type'] = expression_type
            if input_serialization is not autoboto.ShapeBase.NOT_SET:
                _params['input_serialization'] = input_serialization
            if output_serialization is not autoboto.ShapeBase.NOT_SET:
            ...
            if sse_customer_key_md5 is not autoboto.ShapeBase.NOT_SET:
                _params['sse_customer_key_md5'] = sse_customer_key_md5
            if request_progress is not autoboto.ShapeBase.NOT_SET:
    ...
    def upload_part_copy(
        ...
        *,
        ...
        copy_source_if_unmodified_since: datetime.datetime = autoboto.ShapeBase.
        NOT_SET,
        copy_source_range: str = autoboto.ShapeBase.NOT_SET,
        sse_customer_algorithm: str = autoboto.ShapeBase.NOT_SET,
        sse_customer_key: str = autoboto.ShapeBase.NOT_SET,
        sse_customer_key_md5: str = autoboto.ShapeBase.NOT_SET,
        copy_source_sse_customer_algorithm: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if copy_source_range is not autoboto.ShapeBase.NOT_SET:
