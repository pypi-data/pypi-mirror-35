...
class Client:
    ...
    def create_cluster(
        ...
        *,
        ...
        snowball_type: shapes.SnowballType = autoboto.ShapeBase.NOT_SET,
        notification: shapes.Notification = autoboto.ShapeBase.NOT_SET,
        forwarding_address_id: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if address_id is not autoboto.ShapeBase.NOT_SET:
                _params['address_id'] = address_id
            if role_arn is not autoboto.ShapeBase.NOT_SET:
                _params['role_arn'] = role_arn
            if shipping_option is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_job(
        ...
        *,
        job_type: shapes.JobType = autoboto.ShapeBase.NOT_SET,
        resources: shapes.JobResource = autoboto.ShapeBase.NOT_SET,
        description: str = autoboto.ShapeBase.NOT_SET,
        address_id: str = autoboto.ShapeBase.NOT_SET,
        kms_key_arn: str = autoboto.ShapeBase.NOT_SET,
        role_arn: str = autoboto.ShapeBase.NOT_SET,
        snowball_capacity_preference: shapes.SnowballCapacity = autoboto.
        ShapeBase.NOT_SET,
        shipping_option: shapes.ShippingOption = autoboto.ShapeBase.NOT_SET,
        notification: shapes.Notification = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if role_arn is not autoboto.ShapeBase.NOT_SET:
                _params['role_arn'] = role_arn
            if snowball_capacity_preference is not autoboto.ShapeBase.NOT_SET:
