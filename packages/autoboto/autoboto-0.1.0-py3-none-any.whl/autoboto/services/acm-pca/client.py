...
class Client:
    ...
    def create_certificate_authority(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if certificate_authority_configuration is not autoboto.ShapeBase.NOT_SET:
                _params['certificate_authority_configuration'
                       ] = certificate_authority_configuration
            if certificate_authority_type is not autoboto.ShapeBase.NOT_SET:
                _params['certificate_authority_type'
                       ] = certificate_authority_type
            if revocation_configuration is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_certificate_authority_audit_report(
        ...
        *,
        ...
        if _request is None:
            ...
            if audit_report_response_format is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_certificate_authority(
        ...
        *,
        certificate_authority_arn: str,
        permanent_deletion_time_in_days: int = autoboto.ShapeBase.NOT_SET,
    ) -> None:
        """
        ...
        **Status** field of the CertificateAuthority is `CREATING`). You can also delete
        ...
        if _request is None:
            ...
            if certificate_authority_arn is not autoboto.ShapeBase.NOT_SET:
                _params['certificate_authority_arn'] = certificate_authority_arn
            if permanent_deletion_time_in_days is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_certificate_authority_audit_report(
        ...
        *,
        ...
        if _request is None:
            ...
            if certificate_authority_arn is not autoboto.ShapeBase.NOT_SET:
                _params['certificate_authority_arn'] = certificate_authority_arn
            if audit_report_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def issue_certificate(
        ...
        *,
        ...
        if _request is None:
            ...
            if certificate_authority_arn is not autoboto.ShapeBase.NOT_SET:
                _params['certificate_authority_arn'] = certificate_authority_arn
            if csr is not autoboto.ShapeBase.NOT_SET:
                _params['csr'] = csr
            if signing_algorithm is not autoboto.ShapeBase.NOT_SET:
    ...
    def revoke_certificate(
        ...
        *,
        ...
        if _request is None:
            ...
            if certificate_authority_arn is not autoboto.ShapeBase.NOT_SET:
                _params['certificate_authority_arn'] = certificate_authority_arn
            if certificate_serial is not autoboto.ShapeBase.NOT_SET:
                _params['certificate_serial'] = certificate_serial
            if revocation_reason is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_certificate_authority(
        ...
        *,
        ...
        revocation_configuration: shapes.RevocationConfiguration = autoboto.
        ShapeBase.NOT_SET,
        status: shapes.CertificateAuthorityStatus = autoboto.ShapeBase.NOT_SET,
    ) -> None:
        """
