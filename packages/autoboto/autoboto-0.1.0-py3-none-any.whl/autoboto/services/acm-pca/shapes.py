...
class ASN1Subject(autoboto.ShapeBase):
    ...
    # affiliated.
    organization: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    ...
    # located.
    locality: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    ...
    # of the **SurName**.
    initials: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    ...
    # Liz, or Eliza.
    pseudonym: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class CreateCertificateAuthorityAuditReportResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class CreateCertificateAuthorityResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
class CrlConfiguration(autoboto.ShapeBase):
    ...
    custom_cname: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class DescribeCertificateAuthorityAuditReportResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DescribeCertificateAuthorityResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class GetCertificateAuthorityCertificateResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class GetCertificateAuthorityCsrResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
    ...
    # CA certificate.
    csr: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class GetCertificateResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
class IssueCertificateRequest(autoboto.ShapeBase):
    ...
    # csr/test_cert_.csr`
    csr: typing.Any = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class IssueCertificateResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class ListCertificateAuthoritiesResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
