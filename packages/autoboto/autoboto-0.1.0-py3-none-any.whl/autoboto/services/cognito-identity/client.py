...
class Client:
    ...
    def create_identity_pool(
        ...
        *,
        ...
        developer_provider_name: str = autoboto.ShapeBase.NOT_SET,
        ...
        saml_provider_arns: typing.List[str] = autoboto.ShapeBase.NOT_SET,
    ) -> shapes.IdentityPool:
        """
        ...
        if _request is None:
            _params = {}
            if identity_pool_name is not autoboto.ShapeBase.NOT_SET:
                _params['identity_pool_name'] = identity_pool_name
            if allow_unauthenticated_identities is not autoboto.ShapeBase.NOT_SET:
                _params['allow_unauthenticated_identities'
                       ] = allow_unauthenticated_identities
            if supported_login_providers is not autoboto.ShapeBase.NOT_SET:
                _params['supported_login_providers'] = supported_login_providers
            if developer_provider_name is not autoboto.ShapeBase.NOT_SET:
                _params['developer_provider_name'] = developer_provider_name
            if open_id_connect_provider_arns is not autoboto.ShapeBase.NOT_SET:
                _params['open_id_connect_provider_arns'
                       ] = open_id_connect_provider_arns
            if cognito_identity_providers is not autoboto.ShapeBase.NOT_SET:
                _params['cognito_identity_providers'
                       ] = cognito_identity_providers
            if saml_provider_arns is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_identities(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if identity_ids_to_delete is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_identity_pool(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if identity_pool_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_identity(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if identity_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_credentials_for_identity(
        ...
        *,
        identity_id: str,
        logins: typing.Dict[str, str] = autoboto.ShapeBase.NOT_SET,
        custom_role_arn: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if identity_id is not autoboto.ShapeBase.NOT_SET:
                _params['identity_id'] = identity_id
            if logins is not autoboto.ShapeBase.NOT_SET:
                _params['logins'] = logins
            if custom_role_arn is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_id(
        ...
        *,
        identity_pool_id: str,
        account_id: str = autoboto.ShapeBase.NOT_SET,
        logins: typing.Dict[str, str] = autoboto.ShapeBase.NOT_SET,
    ...
    def get_open_id_token_for_developer_identity(
        ...
        *,
        ...
        identity_id: str = autoboto.ShapeBase.NOT_SET,
        token_duration: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if identity_id is not autoboto.ShapeBase.NOT_SET:
                _params['identity_id'] = identity_id
            if token_duration is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_identities(
        ...
        *,
        ...
        hide_disabled: bool = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if hide_disabled is not autoboto.ShapeBase.NOT_SET:
    ...
    def lookup_developer_identity(
        ...
        *,
        identity_pool_id: str,
        identity_id: str = autoboto.ShapeBase.NOT_SET,
        developer_user_identifier: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if identity_id is not autoboto.ShapeBase.NOT_SET:
                _params['identity_id'] = identity_id
            if developer_user_identifier is not autoboto.ShapeBase.NOT_SET:
    ...
    def merge_developer_identities(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if source_user_identifier is not autoboto.ShapeBase.NOT_SET:
                _params['source_user_identifier'] = source_user_identifier
            if destination_user_identifier is not autoboto.ShapeBase.NOT_SET:
    ...
    def set_identity_pool_roles(
        ...
        *,
        ...
        if _request is None:
            ...
            if identity_pool_id is not autoboto.ShapeBase.NOT_SET:
                _params['identity_pool_id'] = identity_pool_id
            if roles is not autoboto.ShapeBase.NOT_SET:
                _params['roles'] = roles
            if role_mappings is not autoboto.ShapeBase.NOT_SET:
    ...
    def unlink_identity(
        ...
        *,
        ...
        if _request is None:
            ...
            if logins is not autoboto.ShapeBase.NOT_SET:
                _params['logins'] = logins
            if logins_to_remove is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_identity_pool(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if response_metadata is not autoboto.ShapeBase.NOT_SET:
