...
class AffectedEntity(autoboto.ShapeBase):
    ...
    entity_arn: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    ...
    event_arn: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )

    # The ID of the affected entity.
    entity_value: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class DescribeAffectedEntitiesResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DescribeEntityAggregatesResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DescribeEventAggregatesResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DescribeEventDetailsResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DescribeEventTypesResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
class EventDetailsErrorItem(autoboto.ShapeBase):
    ...
    error_name: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
