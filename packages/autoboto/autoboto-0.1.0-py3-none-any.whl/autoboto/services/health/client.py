...
class Client:
    ...
    def describe_affected_entities(
        ...
        *,
        ...
        locale: str = autoboto.ShapeBase.NOT_SET,
    ...
    def describe_entity_aggregates(
        ...
        *,
        event_arns: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if event_arns is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_event_aggregates(
        ...
        *,
        ...
        filter: shapes.EventFilter = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if aggregate_field is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_event_types(
        ...
        *,
        filter: shapes.EventTypeFilter = autoboto.ShapeBase.NOT_SET,
        locale: str = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
