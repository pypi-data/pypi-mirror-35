...
@dataclasses.dataclass
class AddTagsResponse(autoboto.OutputShapeBase):
    """
...
@dataclasses.dataclass
class CreateTrailResponse(autoboto.OutputShapeBase):
    """
    Returns the objects or data listed below if successful. Otherwise, returns an
    error.
    """
    ...
    # `arn:aws:cloudtrail:us-east-1:123456789012:trail/MyTrail`
    trail_arn: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class DeleteTrailResponse(autoboto.OutputShapeBase):
    """
    Returns the objects or data listed below if successful. Otherwise, returns an
    error.
    """
...
@dataclasses.dataclass
class DescribeTrailsResponse(autoboto.OutputShapeBase):
    """
    Returns the objects or data listed below if successful. Otherwise, returns an
    error.
    """
...
class Event(autoboto.ShapeBase):
    ...
    event_name: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    ...
    event_source: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
class GetEventSelectorsRequest(autoboto.ShapeBase):
    ...
    # `arn:aws:cloudtrail:us-east-1:123456789012:trail/MyTrail`
    trail_name: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )


@dataclasses.dataclass
class GetEventSelectorsResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class GetTrailStatusResponse(autoboto.OutputShapeBase):
    """
    Returns the objects or data listed below if successful. Otherwise, returns an
    error.
    """
    ...
    is_logging: bool = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class ListPublicKeysResponse(autoboto.OutputShapeBase):
    """
    Returns the objects or data listed below if successful. Otherwise, returns an
    error.
    """
...
@dataclasses.dataclass
class LookupEventsResponse(autoboto.OutputShapeBase):
    """
...
class PublicKey(autoboto.ShapeBase):
    ...
    value: typing.Any = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class PutEventSelectorsResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class RemoveTagsResponse(autoboto.OutputShapeBase):
    """
    Returns the objects or data listed below if successful. Otherwise, returns an
    error.
    """
...
@dataclasses.dataclass
class StartLoggingResponse(autoboto.OutputShapeBase):
    """
    Returns the objects or data listed below if successful. Otherwise, returns an
    error.
    """
...
@dataclasses.dataclass
class StopLoggingResponse(autoboto.OutputShapeBase):
    """
    Returns the objects or data listed below if successful. Otherwise, returns an
    error.
    """
...
class Trail(autoboto.ShapeBase):
    ...
    home_region: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class UpdateTrailResponse(autoboto.OutputShapeBase):
    """
    Returns the objects or data listed below if successful. Otherwise, returns an
    error.
    """
