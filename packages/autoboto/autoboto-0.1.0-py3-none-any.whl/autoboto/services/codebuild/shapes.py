...
class AccountLimitExceededException(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class BatchDeleteBuildsInput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class BatchDeleteBuildsOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
            ...
            (
                "builds_not_deleted",
                "buildsNotDeleted",
                autoboto.TypeInfo(typing.List[BuildNotDeleted]),
            ),
        ]
...
@dataclasses.dataclass
class BatchGetBuildsInput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class BatchGetBuildsOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class BatchGetProjectsInput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class BatchGetProjectsOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
class Build(autoboto.ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "phases",
                "phases",
                autoboto.TypeInfo(typing.List[BuildPhase]),
            ),
            (
                "source",
                "source",
                autoboto.TypeInfo(ProjectSource),
            ),
            (
                "secondary_sources",
                "secondarySources",
                autoboto.TypeInfo(typing.List[ProjectSource]),
            ),
            (
                "secondary_source_versions",
                "secondarySourceVersions",
                autoboto.TypeInfo(typing.List[ProjectSourceVersion]),
            ),
            (
                "artifacts",
                "artifacts",
                autoboto.TypeInfo(BuildArtifacts),
            ),
            (
                "secondary_artifacts",
                "secondaryArtifacts",
                autoboto.TypeInfo(typing.List[BuildArtifacts]),
            ),
            (
                "cache",
                "cache",
                autoboto.TypeInfo(ProjectCache),
            ),
            (
                "environment",
                "environment",
                autoboto.TypeInfo(ProjectEnvironment),
            ),
            (
                "service_role",
                "serviceRole",
            ...
            (
                "logs",
                "logs",
                autoboto.TypeInfo(LogsLocation),
            ),
            (
                "timeout_in_minutes",
                "timeoutInMinutes",
            ...
            (
                "network_interface",
                "networkInterface",
                autoboto.TypeInfo(NetworkInterface),
            ),
            (
                "encryption_key",
                "encryptionKey",
    ...
    current_phase: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    ...
    build_status: "StatusType" = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
    ...
    initiator: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    ...
    encryption_key: str = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )


@dataclasses.dataclass
class BuildArtifacts(autoboto.ShapeBase):
    """
    ...
    # set to `ZIP`.
    sha256sum: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    ...
    # This value is available only if the build project's `packaging` value is
    # set to `ZIP`.
    md5sum: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    ...
    encryption_disabled: bool = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )

    # An identifier for this artifact definition.
    artifact_identifier: str = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )


@dataclasses.dataclass
class BuildNotDeleted(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class BuildPhase(autoboto.ShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "phase_type",
                "phaseType",
                autoboto.TypeInfo(BuildPhaseType),
            ),
            (
                "phase_status",
                "phaseStatus",
            ...
            (
                "contexts",
                "contexts",
                autoboto.TypeInfo(typing.List[PhaseContext]),
            ),
        ]
    ...
    phase_status: "StatusType" = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
...
@dataclasses.dataclass
class CreateProjectInput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
            ...
            (
                "artifacts",
                "artifacts",
                autoboto.TypeInfo(ProjectArtifacts),
            ),
            (
                "environment",
                "environment",
            ...
            (
                "secondary_artifacts",
                "secondaryArtifacts",
                autoboto.TypeInfo(typing.List[ProjectArtifacts]),
            ),
            (
                "cache",
                "cache",
    ...
    # build badge.
    badge_enabled: bool = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )


@dataclasses.dataclass
class CreateProjectOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class CreateWebhookInput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
    ...
    branch_filter: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )


@dataclasses.dataclass
class CreateWebhookOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DeleteProjectInput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DeleteProjectOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class EnvironmentImage(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class EnvironmentLanguage(autoboto.ShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "language",
                "language",
                autoboto.TypeInfo(LanguageType),
            ),
            (
                "images",
                "images",
                autoboto.TypeInfo(typing.List[EnvironmentImage]),
            ),
        ]

    # The programming language for the Docker images.
    language: "LanguageType" = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
...
@dataclasses.dataclass
class EnvironmentPlatform(autoboto.ShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "languages",
                "languages",
                autoboto.TypeInfo(typing.List[EnvironmentLanguage]),
            ),
        ]
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "type",
                "type",
                autoboto.TypeInfo(EnvironmentVariableType),
            ),
        ]
...
@dataclasses.dataclass
class InvalidateProjectCacheInput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class InvalidateProjectCacheOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class ListBuildsForProjectInput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
            ...
            (
                "sort_order",
                "sortOrder",
                autoboto.TypeInfo(SortOrderType),
            ),
            (
                "next_token",
                "nextToken",
    ...
    sort_order: "SortOrderType" = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
...
@dataclasses.dataclass
class ListBuildsForProjectOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class ListCuratedEnvironmentImagesInput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return []
...
@dataclasses.dataclass
class ListCuratedEnvironmentImagesOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
            ...
            (
                "platforms",
                "platforms",
                autoboto.TypeInfo(typing.List[EnvironmentPlatform]),
            ),
        ]
...
@dataclasses.dataclass
class ListProjectsInput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
                "sort_by",
                "sortBy",
                autoboto.TypeInfo(ProjectSortByType),
            ),
            (
                "sort_order",
                "sortOrder",
...
@dataclasses.dataclass
class ListProjectsOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class LogsLocation(autoboto.ShapeBase):
    """
    ...
    deep_link: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class OAuthProviderException(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class PhaseContext(autoboto.ShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "badge",
                "badge",
                autoboto.TypeInfo(ProjectBadge),
            ),
        ]
...
@dataclasses.dataclass
class ProjectArtifacts(autoboto.ShapeBase):
    """
    Information about the build output artifacts for the build project.
    """
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "type",
                "type",
                autoboto.TypeInfo(ArtifactsType),
            ),
            (
                "location",
                "location",
            ...
            (
                "namespace_type",
                "namespaceType",
                autoboto.TypeInfo(ArtifactNamespace),
            ),
            (
                "name",
                "name",
            ...
            (
                "packaging",
                "packaging",
                autoboto.TypeInfo(ArtifactPackaging),
            ),
            (
                "override_artifact_name",
                "overrideArtifactName",
    ...
    type: "ArtifactsType" = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
...
@dataclasses.dataclass
class ProjectBadge(autoboto.ShapeBase):
    """
    Information about the build badge for the build project.
    """
    ...
    # for your project.
    badge_request_url: str = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )


@dataclasses.dataclass
class ProjectCache(autoboto.ShapeBase):
    """
    Information about the cache for the build project.
    """
    ...
    type: "CacheType" = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class ProjectEnvironment(autoboto.ShapeBase):
    """
    ...
    # "until docker info; do echo .; sleep 1; done"`
    privileged_mode: bool = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
...
@dataclasses.dataclass
class ProjectSource(autoboto.ShapeBase):
    """
    Information about the build input source code for the build project.
    """
    ...
    git_clone_depth: int = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
    ...
    buildspec: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    ...
    report_build_status: bool = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )

    # Enable this flag to ignore SSL warnings while connecting to the project
    # source code.
    insecure_ssl: bool = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class ProjectSourceVersion(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class SourceAuth(autoboto.ShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "type",
                "type",
                autoboto.TypeInfo(SourceAuthType),
            ),
            (
                "resource",
                "resource",
    ...
    type: "SourceAuthType" = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
...
@dataclasses.dataclass
class StartBuildInput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
    ...
    buildspec_override: str = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
    ...
    insecure_ssl_override: bool = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
    ...
    # build project.
    image_override: str = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
    ...
    # in the build project.
    certificate_override: str = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
    ...
    # in the build project.
    service_role_override: str = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
...
@dataclasses.dataclass
class StartBuildOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class StopBuildInput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class StopBuildOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class UpdateProjectInput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class UpdateProjectOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class UpdateWebhookInput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
    ...
    rotate_secret: bool = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )


@dataclasses.dataclass
class UpdateWebhookOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class Webhook(autoboto.ShapeBase):
    """
    ...
    payload_url: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
