...
class Client:
    ...
    def create_endpoint(
        ...
        *,
        ...
        engine_name: str,
        username: str = autoboto.ShapeBase.NOT_SET,
        password: str = autoboto.ShapeBase.NOT_SET,
        server_name: str = autoboto.ShapeBase.NOT_SET,
        port: int = autoboto.ShapeBase.NOT_SET,
        database_name: str = autoboto.ShapeBase.NOT_SET,
        extra_connection_attributes: str = autoboto.ShapeBase.NOT_SET,
        ...
        ssl_mode: shapes.DmsSslModeValue = autoboto.ShapeBase.NOT_SET,
        service_access_role_arn: str = autoboto.ShapeBase.NOT_SET,
        external_table_definition: str = autoboto.ShapeBase.NOT_SET,
        dynamo_db_settings: shapes.DynamoDbSettings = autoboto.ShapeBase.
        NOT_SET,
        s3_settings: shapes.S3Settings = autoboto.ShapeBase.NOT_SET,
        dms_transfer_settings: shapes.DmsTransferSettings = autoboto.ShapeBase.
        NOT_SET,
        mongo_db_settings: shapes.MongoDbSettings = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if endpoint_identifier is not autoboto.ShapeBase.NOT_SET:
            ...
            if server_name is not autoboto.ShapeBase.NOT_SET:
            ...
            if extra_connection_attributes is not autoboto.ShapeBase.NOT_SET:
            ...
            if ssl_mode is not autoboto.ShapeBase.NOT_SET:
                _params['ssl_mode'] = ssl_mode
            if service_access_role_arn is not autoboto.ShapeBase.NOT_SET:
                _params['service_access_role_arn'] = service_access_role_arn
            if external_table_definition is not autoboto.ShapeBase.NOT_SET:
                _params['external_table_definition'] = external_table_definition
            if dynamo_db_settings is not autoboto.ShapeBase.NOT_SET:
                _params['dynamo_db_settings'] = dynamo_db_settings
            if s3_settings is not autoboto.ShapeBase.NOT_SET:
                _params['s3_settings'] = s3_settings
            if dms_transfer_settings is not autoboto.ShapeBase.NOT_SET:
                _params['dms_transfer_settings'] = dms_transfer_settings
            if mongo_db_settings is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_replication_instance(
        ...
        *,
        ...
        replication_subnet_group_identifier: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if replication_instance_identifier is not autoboto.ShapeBase.NOT_SET:
                _params['replication_instance_identifier'
                       ] = replication_instance_identifier
            if replication_instance_class is not autoboto.ShapeBase.NOT_SET:
            ...
            if replication_subnet_group_identifier is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_replication_subnet_group(
        ...
        *,
        ...
        if _request is None:
            ...
            if replication_subnet_group_description is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_replication_task(
        ...
        *,
        ...
        table_mappings: str,
        replication_task_settings: str = autoboto.ShapeBase.NOT_SET,
        cdc_start_time: datetime.datetime = autoboto.ShapeBase.NOT_SET,
        cdc_start_position: str = autoboto.ShapeBase.NOT_SET,
        cdc_stop_position: str = autoboto.ShapeBase.NOT_SET,
        tags: typing.List[shapes.Tag] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if replication_task_identifier is not autoboto.ShapeBase.NOT_SET:
                _params['replication_task_identifier'
                       ] = replication_task_identifier
            if source_endpoint_arn is not autoboto.ShapeBase.NOT_SET:
                _params['source_endpoint_arn'] = source_endpoint_arn
            if target_endpoint_arn is not autoboto.ShapeBase.NOT_SET:
                _params['target_endpoint_arn'] = target_endpoint_arn
            if replication_instance_arn is not autoboto.ShapeBase.NOT_SET:
                _params['replication_instance_arn'] = replication_instance_arn
            if migration_type is not autoboto.ShapeBase.NOT_SET:
                _params['migration_type'] = migration_type
            if table_mappings is not autoboto.ShapeBase.NOT_SET:
                _params['table_mappings'] = table_mappings
            if replication_task_settings is not autoboto.ShapeBase.NOT_SET:
                _params['replication_task_settings'] = replication_task_settings
            if cdc_start_time is not autoboto.ShapeBase.NOT_SET:
                _params['cdc_start_time'] = cdc_start_time
            if cdc_start_position is not autoboto.ShapeBase.NOT_SET:
                _params['cdc_start_position'] = cdc_start_position
            if cdc_stop_position is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_endpoint(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if endpoint_arn is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_replication_task(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if replication_task_arn is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_replication_task_assessment_results(
        ...
        *,
        replication_task_arn: str = autoboto.ShapeBase.NOT_SET,
        max_records: int = autoboto.ShapeBase.NOT_SET,
        marker: str = autoboto.ShapeBase.NOT_SET,
    ...
    def import_certificate(
        ...
        *,
        ...
        certificate_pem: str = autoboto.ShapeBase.NOT_SET,
        certificate_wallet: typing.Any = autoboto.ShapeBase.NOT_SET,
        tags: typing.List[shapes.Tag] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if certificate_wallet is not autoboto.ShapeBase.NOT_SET:
    ...
    def modify_endpoint(
        ...
        *,
        endpoint_arn: str,
        endpoint_identifier: str = autoboto.ShapeBase.NOT_SET,
        endpoint_type: shapes.ReplicationEndpointTypeValue = autoboto.ShapeBase.
        NOT_SET,
    ...
    def modify_replication_instance(
        ...
        *,
        ...
        replication_instance_class: str = autoboto.ShapeBase.NOT_SET,
        vpc_security_group_ids: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        preferred_maintenance_window: str = autoboto.ShapeBase.NOT_SET,
        multi_az: bool = autoboto.ShapeBase.NOT_SET,
        engine_version: str = autoboto.ShapeBase.NOT_SET,
        ...
        auto_minor_version_upgrade: bool = autoboto.ShapeBase.NOT_SET,
        replication_instance_identifier: str = autoboto.ShapeBase.NOT_SET,
    ...
    def modify_replication_subnet_group(
        ...
        *,
        replication_subnet_group_identifier: str,
        subnet_ids: typing.List[str],
        replication_subnet_group_description: str = autoboto.ShapeBase.NOT_SET,
    ...
    def modify_replication_task(
        ...
        *,
        replication_task_arn: str,
        replication_task_identifier: str = autoboto.ShapeBase.NOT_SET,
        migration_type: shapes.MigrationTypeValue = autoboto.ShapeBase.NOT_SET,
        table_mappings: str = autoboto.ShapeBase.NOT_SET,
        replication_task_settings: str = autoboto.ShapeBase.NOT_SET,
        cdc_start_time: datetime.datetime = autoboto.ShapeBase.NOT_SET,
        cdc_start_position: str = autoboto.ShapeBase.NOT_SET,
        cdc_stop_position: str = autoboto.ShapeBase.NOT_SET,
    ...
    def reload_tables(
        ...
        *,
        ...
        reload_option: shapes.ReloadOptionValue = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if replication_task_arn is not autoboto.ShapeBase.NOT_SET:
                _params['replication_task_arn'] = replication_task_arn
            if tables_to_reload is not autoboto.ShapeBase.NOT_SET:
                _params['tables_to_reload'] = tables_to_reload
            if reload_option is not autoboto.ShapeBase.NOT_SET:
    ...
    def start_replication_task(
        ...
        *,
        ...
        if _request is None:
            ...
            if replication_task_arn is not autoboto.ShapeBase.NOT_SET:
                _params['replication_task_arn'] = replication_task_arn
            if start_replication_task_type is not autoboto.ShapeBase.NOT_SET:
