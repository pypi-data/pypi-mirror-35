...
class Client:
    ...
    def export_certificate(
        ...
        *,
        ...
        if _request is None:
            ...
            if certificate_arn is not autoboto.ShapeBase.NOT_SET:
                _params['certificate_arn'] = certificate_arn
            if passphrase is not autoboto.ShapeBase.NOT_SET:
    ...
    def import_certificate(
        ...
        *,
        ...
        certificate_chain: typing.Any = autoboto.ShapeBase.NOT_SET,
    ...
    def list_certificates(
        ...
        *,
        ...
        includes: shapes.Filters = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if certificate_statuses is not autoboto.ShapeBase.NOT_SET:
                _params['certificate_statuses'] = certificate_statuses
            if includes is not autoboto.ShapeBase.NOT_SET:
    ...
    def request_certificate(
        ...
        *,
        domain_name: str,
        validation_method: shapes.ValidationMethod = autoboto.ShapeBase.NOT_SET,
        ...
        options: shapes.CertificateOptions = autoboto.ShapeBase.NOT_SET,
        certificate_authority_arn: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if validation_method is not autoboto.ShapeBase.NOT_SET:
                _params['validation_method'] = validation_method
            if subject_alternative_names is not autoboto.ShapeBase.NOT_SET:
            ...
            if domain_validation_options is not autoboto.ShapeBase.NOT_SET:
            ...
            if certificate_authority_arn is not autoboto.ShapeBase.NOT_SET:
    ...
    def resend_validation_email(
        ...
        *,
        ...
        if _request is None:
            ...
            if validation_domain is not autoboto.ShapeBase.NOT_SET:
