...
class Client:
    ...
    def create_vocabulary(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if vocabulary_name is not autoboto.ShapeBase.NOT_SET:
            ...
            if phrases is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_transcription_job(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if transcription_job_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_transcription_jobs(
        ...
        *,
        status: shapes.TranscriptionJobStatus = autoboto.ShapeBase.NOT_SET,
        job_name_contains: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if job_name_contains is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_vocabularies(
        ...
        *,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
        state_equals: shapes.VocabularyState = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if max_results is not autoboto.ShapeBase.NOT_SET:
                _params['max_results'] = max_results
            if state_equals is not autoboto.ShapeBase.NOT_SET:
    ...
    def start_transcription_job(
        ...
        *,
        ...
        media: shapes.Media,
        media_sample_rate_hertz: int = autoboto.ShapeBase.NOT_SET,
        output_bucket_name: str = autoboto.ShapeBase.NOT_SET,
        settings: shapes.Settings = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if language_code is not autoboto.ShapeBase.NOT_SET:
                _params['language_code'] = language_code
            if media_format is not autoboto.ShapeBase.NOT_SET:
                _params['media_format'] = media_format
            if media is not autoboto.ShapeBase.NOT_SET:
                _params['media'] = media
            if media_sample_rate_hertz is not autoboto.ShapeBase.NOT_SET:
                _params['media_sample_rate_hertz'] = media_sample_rate_hertz
            if output_bucket_name is not autoboto.ShapeBase.NOT_SET:
