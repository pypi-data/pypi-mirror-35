...
@dataclasses.dataclass
class Button(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class DependencyFailedException(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class GenericAttachment(autoboto.ShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "buttons",
                "buttons",
                autoboto.TypeInfo(typing.List[Button]),
            ),
        ]
    ...
    sub_title: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )

    # The URL of an attachment to the response card.
    attachment_link_url: str = dataclasses.field(
...
@dataclasses.dataclass
class LoopDetectedException(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class NotAcceptableException(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class PostContentRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
    ...
    # locally.
    input_stream: typing.Any = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
    ...
    session_attributes: str = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
    ...
    request_attributes: str = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
...
@dataclasses.dataclass
class PostContentResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
            ...
            (
                "message_format",
                "messageFormat",
                autoboto.TypeInfo(MessageFormatType),
            ),
            (
                "dialog_state",
                "dialogState",
                autoboto.TypeInfo(DialogState),
            ),
            (
                "slot_to_elicit",
                "slotToElicit",
    ...
    # that you send.
    input_transcript: str = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
...
@dataclasses.dataclass
class PostTextRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
    ...
    input_text: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class PostTextResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
            ...
            (
                "response_card",
                "responseCard",
                autoboto.TypeInfo(ResponseCard),
            ),
        ]
...
@dataclasses.dataclass
class ResponseCard(autoboto.ShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "generic_attachments",
                "genericAttachments",
                autoboto.TypeInfo(typing.List[GenericAttachment]),
            ),
        ]
