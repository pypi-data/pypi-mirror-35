...
@dataclasses.dataclass
class BucketInfo(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class DocumentServiceException(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class DocumentServiceWarning(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class FieldStats(autoboto.ShapeBase):
    """
    ...
    min: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    ...
    # in the result set.
    missing: int = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    ...
    sum_of_squares: float = dataclasses.field(
    ...
    # representation of a date with the format specified in [IETF
    # RFC3339](http://tools.ietf.org/html/rfc3339): yyyy-mm-ddTHH:mm:ss.SSSZ.
    mean: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )

    # The standard deviation of the values in the specified field in the result
    # set.
    stddev: float = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
class Hits(autoboto.ShapeBase):
    ...
    found: int = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )

    # The index of the first matching document.
    start: int = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )

    # A cursor that can be used to retrieve the next set of matching documents
    # when you want to page through a large result set.
    cursor: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class SearchException(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class SearchRequest(autoboto.ShapeBase):
    """
    ...
    # Guide_.
    expr: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    ...
    # in the _Amazon CloudSearch Developer Guide_.
    facet: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    ...
    # results.html) in the _Amazon CloudSearch Developer Guide_.
    filter_query: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    ...
    # **","post_tag": "** "} }`
    highlight: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    ...
    partial: bool = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    ...
    query_options: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    ...
    query_parser: "QueryParser" = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
    ...
    return_: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    ...
    # results.html) in the _Amazon CloudSearch Developer Guide_.
    sort: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    ...
    stats: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )


@dataclasses.dataclass
class SearchResponse(autoboto.OutputShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "status",
                "status",
                autoboto.TypeInfo(SearchStatus),
            ),
            (
                "hits",
                "hits",
                autoboto.TypeInfo(Hits),
            ),
            (
                "facets",
                "facets",
                autoboto.TypeInfo(typing.Dict[str, BucketInfo]),
            ),
            (
                "stats",
                "stats",
                autoboto.TypeInfo(typing.Dict[str, FieldStats]),
            ),
        ]
...
@dataclasses.dataclass
class SearchStatus(autoboto.ShapeBase):
    """
    ...
    timems: int = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )

    # The encrypted resource ID for the request.
    rid: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )


@dataclasses.dataclass
class SuggestModel(autoboto.ShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "suggestions",
                "suggestions",
                autoboto.TypeInfo(typing.List[SuggestionMatch]),
            ),
        ]
...
@dataclasses.dataclass
class SuggestRequest(autoboto.ShapeBase):
    """
    ...
    suggester: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class SuggestResponse(autoboto.OutputShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "status",
                "status",
                autoboto.TypeInfo(SuggestStatus),
            ),
            (
                "suggest",
                "suggest",
                autoboto.TypeInfo(SuggestModel),
            ),
        ]
...
@dataclasses.dataclass
class SuggestStatus(autoboto.ShapeBase):
    """
    Contains the resource id (`rid`) and the time it took to process the request
    (`timems`).
    """
...
@dataclasses.dataclass
class SuggestionMatch(autoboto.ShapeBase):
    """
    ...
    suggestion: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )

    # The relevance score of a suggested match.
    score: int = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class UploadDocumentsRequest(autoboto.ShapeBase):
    """
    ...
    documents: typing.Any = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
...
@dataclasses.dataclass
class UploadDocumentsResponse(autoboto.OutputShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "warnings",
                "warnings",
                autoboto.TypeInfo(typing.List[DocumentServiceWarning]),
            ),
        ]
    ...
    adds: int = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
