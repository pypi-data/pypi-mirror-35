...
class Client:
    ...
    def add_listener_certificates(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if listener_arn is not autoboto.ShapeBase.NOT_SET:
                _params['listener_arn'] = listener_arn
            if certificates is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_listener(
        ...
        *,
        ...
        ssl_policy: str = autoboto.ShapeBase.NOT_SET,
        certificates: typing.List[shapes.Certificate
        ...
        if _request is None:
            _params = {}
            if load_balancer_arn is not autoboto.ShapeBase.NOT_SET:
            ...
            if port is not autoboto.ShapeBase.NOT_SET:
                _params['port'] = port
            if default_actions is not autoboto.ShapeBase.NOT_SET:
                _params['default_actions'] = default_actions
            if ssl_policy is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_load_balancer(
        ...
        *,
        name: str,
        subnets: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        subnet_mappings: typing.List[shapes.SubnetMapping
                                    ] = autoboto.ShapeBase.NOT_SET,
        security_groups: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        scheme: shapes.LoadBalancerSchemeEnum = autoboto.ShapeBase.NOT_SET,
        tags: typing.List[shapes.Tag] = autoboto.ShapeBase.NOT_SET,
        type: shapes.LoadBalancerTypeEnum = autoboto.ShapeBase.NOT_SET,
        ip_address_type: shapes.IpAddressType = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase.NOT_SET:
                _params['name'] = name
            if subnets is not autoboto.ShapeBase.NOT_SET:
                _params['subnets'] = subnets
            if subnet_mappings is not autoboto.ShapeBase.NOT_SET:
            ...
            if scheme is not autoboto.ShapeBase.NOT_SET:
                _params['scheme'] = scheme
            if tags is not autoboto.ShapeBase.NOT_SET:
                _params['tags'] = tags
            if type is not autoboto.ShapeBase.NOT_SET:
                _params['type'] = type
            if ip_address_type is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_rule(
        ...
        *,
        ...
        if _request is None:
            ...
            if listener_arn is not autoboto.ShapeBase.NOT_SET:
                _params['listener_arn'] = listener_arn
            if conditions is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_target_group(
        ...
        *,
        ...
        port: int,
        vpc_id: str,
        health_check_protocol: shapes.ProtocolEnum = autoboto.ShapeBase.NOT_SET,
        health_check_port: str = autoboto.ShapeBase.NOT_SET,
        health_check_path: str = autoboto.ShapeBase.NOT_SET,
        health_check_interval_seconds: int = autoboto.ShapeBase.NOT_SET,
        health_check_timeout_seconds: int = autoboto.ShapeBase.NOT_SET,
        healthy_threshold_count: int = autoboto.ShapeBase.NOT_SET,
        unhealthy_threshold_count: int = autoboto.ShapeBase.NOT_SET,
        matcher: shapes.Matcher = autoboto.ShapeBase.NOT_SET,
        target_type: shapes.TargetTypeEnum = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if health_check_protocol is not autoboto.ShapeBase.NOT_SET:
                _params['health_check_protocol'] = health_check_protocol
            if health_check_port is not autoboto.ShapeBase.NOT_SET:
                _params['health_check_port'] = health_check_port
            if health_check_path is not autoboto.ShapeBase.NOT_SET:
                _params['health_check_path'] = health_check_path
            if health_check_interval_seconds is not autoboto.ShapeBase.NOT_SET:
                _params['health_check_interval_seconds'
                       ] = health_check_interval_seconds
            if health_check_timeout_seconds is not autoboto.ShapeBase.NOT_SET:
                _params['health_check_timeout_seconds'
                       ] = health_check_timeout_seconds
            if healthy_threshold_count is not autoboto.ShapeBase.NOT_SET:
                _params['healthy_threshold_count'] = healthy_threshold_count
            if unhealthy_threshold_count is not autoboto.ShapeBase.NOT_SET:
                _params['unhealthy_threshold_count'] = unhealthy_threshold_count
            if matcher is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_rule(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if rule_arn is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_target_group(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if target_group_arn is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_listeners(
        ...
        *,
        load_balancer_arn: str = autoboto.ShapeBase.NOT_SET,
        listener_arns: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        marker: str = autoboto.ShapeBase.NOT_SET,
        page_size: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if load_balancer_arn is not autoboto.ShapeBase.NOT_SET:
                _params['load_balancer_arn'] = load_balancer_arn
            if listener_arns is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_load_balancers(
        ...
        *,
        load_balancer_arns: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if load_balancer_arns is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_rules(
        ...
        *,
        listener_arn: str = autoboto.ShapeBase.NOT_SET,
        rule_arns: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        marker: str = autoboto.ShapeBase.NOT_SET,
        page_size: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if listener_arn is not autoboto.ShapeBase.NOT_SET:
                _params['listener_arn'] = listener_arn
            if rule_arns is not autoboto.ShapeBase.NOT_SET:
    ...
    def modify_listener(
        ...
        *,
        ...
        protocol: shapes.ProtocolEnum = autoboto.ShapeBase.NOT_SET,
        ssl_policy: str = autoboto.ShapeBase.NOT_SET,
        certificates: typing.List[shapes.Certificate
                                 ] = autoboto.ShapeBase.NOT_SET,
        default_actions: typing.List[shapes.Action
    ...
    def modify_rule(
        ...
        *,
        ...
        actions: typing.List[shapes.Action] = autoboto.ShapeBase.NOT_SET,
    ...
    def set_rule_priorities(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if rule_priorities is not autoboto.ShapeBase.NOT_SET:
