...
class BillingRecord(autoboto.ShapeBase):
    """
    ...
    operation: "OperationType" = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )

    # The ID of the invoice that is associated with the billing record.
    invoice_id: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class CheckDomainAvailabilityRequest(autoboto.ShapeBase):
    """
    ...
    idn_lang_code: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )


@dataclasses.dataclass
class CheckDomainAvailabilityResponse(autoboto.OutputShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "availability",
                "Availability",
                autoboto.TypeInfo(DomainAvailability),
            ),
        ]
...
@dataclasses.dataclass
class CheckDomainTransferabilityRequest(autoboto.ShapeBase):
    """
    ...
    auth_code: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )


@dataclasses.dataclass
class CheckDomainTransferabilityResponse(autoboto.OutputShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "transferability",
                "Transferability",
                autoboto.TypeInfo(DomainTransferability),
            ),
        ]
...
@dataclasses.dataclass
class ContactDetail(autoboto.ShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "extra_params",
                "ExtraParams",
                autoboto.TypeInfo(typing.List[ExtraParam]),
            ),
        ]
    ...
    # contact.
    contact_type: "ContactType" = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
    ...
    address_line1: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )

    # Second line of contact's address, if any.
    address_line2: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    ...
    country_code: "CountryCode" = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
    ...
    # dialing code].[number including any area code]". For example, a US phone
    # number might appear as `"+1.1234567890"`.
    fax: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class DeleteTagsForDomainRequest(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class DeleteTagsForDomainResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DisableDomainAutoRenewRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DisableDomainAutoRenewResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DisableDomainTransferLockRequest(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class DisableDomainTransferLockResponse(autoboto.OutputShapeBase):
    """
...
@dataclasses.dataclass
class DomainLimitExceeded(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class DomainSuggestion(autoboto.ShapeBase):
    """
    ...
    # The domain name is forbidden.
    availability: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )


@dataclasses.dataclass
class DomainSummary(autoboto.ShapeBase):
    """
    ...
    auto_renew: bool = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )

    # Indicates whether a domain is locked from unauthorized transfer to another
    # party.
    transfer_lock: bool = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )

    # Expiration date of the domain in Coordinated Universal Time (UTC).
    expiry: datetime.datetime = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )


@dataclasses.dataclass
class DomainTransferability(autoboto.ShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "transferable",
                "Transferable",
                autoboto.TypeInfo(Transferable),
            ),
        ]
...
@dataclasses.dataclass
class DuplicateRequest(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class EnableDomainAutoRenewRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class EnableDomainAutoRenewResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class EnableDomainTransferLockRequest(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class EnableDomainTransferLockResponse(autoboto.OutputShapeBase):
    """
...
@dataclasses.dataclass
class ExtraParam(autoboto.ShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "name",
                "Name",
                autoboto.TypeInfo(ExtraParamName),
            ),
            (
                "value",
                "Value",
    ...
    name: "ExtraParamName" = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
...
@dataclasses.dataclass
class GetContactReachabilityStatusRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class GetContactReachabilityStatusResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
            ...
            (
                "status",
                "status",
                autoboto.TypeInfo(ReachabilityStatus),
            ),
        ]
...
@dataclasses.dataclass
class GetDomainDetailRequest(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class GetDomainDetailResponse(autoboto.OutputShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "nameservers",
                "Nameservers",
                autoboto.TypeInfo(typing.List[Nameserver]),
            ),
            (
                "admin_contact",
                "AdminContact",
                autoboto.TypeInfo(ContactDetail),
            ),
            (
                "registrant_contact",
                "RegistrantContact",
    ...
    # contact.
    admin_privacy: bool = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
    ...
    registrant_privacy: bool = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
    ...
    # contact.
    tech_privacy: bool = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    ...
    registrar_name: str = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )

    # The fully qualified name of the WHOIS server that can answer the WHOIS
    # query for the domain.
    who_is_server: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )

    # Web address of the registrar.
    registrar_url: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    ...
    # of abuse.
    abuse_contact_email: str = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )

    # Phone number for reporting abuse.
    abuse_contact_phone: str = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )

    # Reserved for future use.
    registry_domain_id: str = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
    ...
    reseller: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )

    # Reserved for future use.
    dns_sec: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class GetDomainSuggestionsRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
    ...
    # return.
    suggestion_count: int = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
    ...
    only_available: bool = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )


@dataclasses.dataclass
class GetDomainSuggestionsResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
            ...
            (
                "suggestions_list",
                "SuggestionsList",
                autoboto.TypeInfo(typing.List[DomainSuggestion]),
            ),
        ]
...
@dataclasses.dataclass
class GetOperationDetailRequest(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class GetOperationDetailResponse(autoboto.OutputShapeBase):
    """
    ...
    type: "OperationType" = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
...
@dataclasses.dataclass
class ListDomainsResponse(autoboto.OutputShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "domains",
                "Domains",
                autoboto.TypeInfo(typing.List[DomainSummary]),
            ),
            (
                "next_page_marker",
                "NextPageMarker",
    ...
    # value of `Marker`.
    next_page_marker: str = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )


@dataclasses.dataclass
class ListOperationsRequest(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class ListOperationsResponse(autoboto.OutputShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "operations",
                "Operations",
                autoboto.TypeInfo(typing.List[OperationSummary]),
            ),
            (
                "next_page_marker",
                "NextPageMarker",
...
@dataclasses.dataclass
class ListTagsForDomainRequest(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class ListTagsForDomainResponse(autoboto.OutputShapeBase):
    """
...
@dataclasses.dataclass
class Nameserver(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class OperationLimitExceeded(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class OperationSummary(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class RegisterDomainRequest(autoboto.ShapeBase):
    """
    ...
    # Default: 1
    duration_in_years: int = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
...
@dataclasses.dataclass
class RegisterDomainResponse(autoboto.OutputShapeBase):
    """
...
@dataclasses.dataclass
class RenewDomainRequest(autoboto.ShapeBase):
    """
    ...
    current_expiry_year: int = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
...
@dataclasses.dataclass
class RenewDomainResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class ResendContactReachabilityEmailRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class ResendContactReachabilityEmailResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
    ...
    is_already_verified: bool = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )


@dataclasses.dataclass
class RetrieveDomainAuthCodeRequest(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class RetrieveDomainAuthCodeResponse(autoboto.OutputShapeBase):
    """
...
@dataclasses.dataclass
class TLDRulesViolation(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class TransferDomainRequest(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class TransferDomainResponse(autoboto.OutputShapeBase):
    """
...
@dataclasses.dataclass
class UnsupportedTLD(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class UpdateDomainContactPrivacyRequest(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class UpdateDomainContactPrivacyResponse(autoboto.OutputShapeBase):
    """
...
@dataclasses.dataclass
class UpdateDomainContactRequest(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class UpdateDomainContactResponse(autoboto.OutputShapeBase):
    """
...
@dataclasses.dataclass
class UpdateDomainNameserversRequest(autoboto.ShapeBase):
    """
    ...
    fi_auth_key: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )


@dataclasses.dataclass
class UpdateDomainNameserversResponse(autoboto.OutputShapeBase):
    """
...
@dataclasses.dataclass
class UpdateTagsForDomainRequest(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class UpdateTagsForDomainResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class ViewBillingRequest(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class ViewBillingResponse(autoboto.OutputShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "billing_records",
                "BillingRecords",
                autoboto.TypeInfo(typing.List[BillingRecord]),
            ),
        ]
