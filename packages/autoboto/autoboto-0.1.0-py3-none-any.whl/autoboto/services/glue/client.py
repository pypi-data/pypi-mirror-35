...
class Client:
    ...
    def batch_create_partition(
        ...
        *,
        ...
        catalog_id: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if table_name is not autoboto.ShapeBase.NOT_SET:
                _params['table_name'] = table_name
            if partition_input_list is not autoboto.ShapeBase.NOT_SET:
                _params['partition_input_list'] = partition_input_list
            if catalog_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def batch_delete_connection(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if connection_name_list is not autoboto.ShapeBase.NOT_SET:
    ...
    def batch_delete_partition(
        ...
        *,
        ...
        if _request is None:
            ...
            if table_name is not autoboto.ShapeBase.NOT_SET:
                _params['table_name'] = table_name
            if partitions_to_delete is not autoboto.ShapeBase.NOT_SET:
    ...
    def batch_delete_table(
        ...
        *,
        ...
        if _request is None:
            ...
            if database_name is not autoboto.ShapeBase.NOT_SET:
                _params['database_name'] = database_name
            if tables_to_delete is not autoboto.ShapeBase.NOT_SET:
    ...
    def batch_delete_table_version(
        ...
        *,
        ...
        if _request is None:
            ...
            if table_name is not autoboto.ShapeBase.NOT_SET:
                _params['table_name'] = table_name
            if version_ids is not autoboto.ShapeBase.NOT_SET:
    ...
    def batch_get_partition(
        ...
        *,
        ...
        if _request is None:
            ...
            if table_name is not autoboto.ShapeBase.NOT_SET:
                _params['table_name'] = table_name
            if partitions_to_get is not autoboto.ShapeBase.NOT_SET:
    ...
    def batch_stop_job_run(
        ...
        *,
        ...
        if _request is None:
            ...
            if job_run_ids is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_classifier(
        ...
        *,
        grok_classifier: shapes.CreateGrokClassifierRequest = autoboto.
        ShapeBase.NOT_SET,
        xml_classifier: shapes.CreateXMLClassifierRequest = autoboto.ShapeBase.
        NOT_SET,
        json_classifier: shapes.CreateJsonClassifierRequest = autoboto.
        ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if grok_classifier is not autoboto.ShapeBase.NOT_SET:
                _params['grok_classifier'] = grok_classifier
            if xml_classifier is not autoboto.ShapeBase.NOT_SET:
                _params['xml_classifier'] = xml_classifier
            if json_classifier is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_connection(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if connection_input is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_crawler(
        ...
        *,
        ...
        classifiers: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        table_prefix: str = autoboto.ShapeBase.NOT_SET,
        schema_change_policy: shapes.SchemaChangePolicy = autoboto.ShapeBase.
        NOT_SET,
        configuration: str = autoboto.ShapeBase.NOT_SET,
        crawler_security_configuration: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase.NOT_SET:
                _params['name'] = name
            if role is not autoboto.ShapeBase.NOT_SET:
                _params['role'] = role
            if database_name is not autoboto.ShapeBase.NOT_SET:
                _params['database_name'] = database_name
            ...
            if classifiers is not autoboto.ShapeBase.NOT_SET:
                _params['classifiers'] = classifiers
            if table_prefix is not autoboto.ShapeBase.NOT_SET:
                _params['table_prefix'] = table_prefix
            if schema_change_policy is not autoboto.ShapeBase.NOT_SET:
                _params['schema_change_policy'] = schema_change_policy
            if configuration is not autoboto.ShapeBase.NOT_SET:
                _params['configuration'] = configuration
            if crawler_security_configuration is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_database(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if database_input is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_dev_endpoint(
        ...
        *,
        ...
        public_key: str = autoboto.ShapeBase.NOT_SET,
        public_keys: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        number_of_nodes: int = autoboto.ShapeBase.NOT_SET,
        extra_python_libs_s3_path: str = autoboto.ShapeBase.NOT_SET,
        extra_jars_s3_path: str = autoboto.ShapeBase.NOT_SET,
        security_configuration: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if public_key is not autoboto.ShapeBase.NOT_SET:
                _params['public_key'] = public_key
            if public_keys is not autoboto.ShapeBase.NOT_SET:
            ...
            if extra_python_libs_s3_path is not autoboto.ShapeBase.NOT_SET:
                _params['extra_python_libs_s3_path'] = extra_python_libs_s3_path
            if extra_jars_s3_path is not autoboto.ShapeBase.NOT_SET:
                _params['extra_jars_s3_path'] = extra_jars_s3_path
            if security_configuration is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_job(
        ...
        *,
        ...
        description: str = autoboto.ShapeBase.NOT_SET,
        log_uri: str = autoboto.ShapeBase.NOT_SET,
        execution_property: shapes.ExecutionProperty = autoboto.ShapeBase.
        NOT_SET,
        default_arguments: typing.Dict[str, str] = autoboto.ShapeBase.NOT_SET,
        connections: shapes.ConnectionsList = autoboto.ShapeBase.NOT_SET,
        max_retries: int = autoboto.ShapeBase.NOT_SET,
        allocated_capacity: int = autoboto.ShapeBase.NOT_SET,
        timeout: int = autoboto.ShapeBase.NOT_SET,
        notification_property: shapes.NotificationProperty = autoboto.ShapeBase.
        NOT_SET,
        security_configuration: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if description is not autoboto.ShapeBase.NOT_SET:
                _params['description'] = description
            if log_uri is not autoboto.ShapeBase.NOT_SET:
                _params['log_uri'] = log_uri
            if execution_property is not autoboto.ShapeBase.NOT_SET:
                _params['execution_property'] = execution_property
            if default_arguments is not autoboto.ShapeBase.NOT_SET:
                _params['default_arguments'] = default_arguments
            if connections is not autoboto.ShapeBase.NOT_SET:
                _params['connections'] = connections
            if max_retries is not autoboto.ShapeBase.NOT_SET:
                _params['max_retries'] = max_retries
            if allocated_capacity is not autoboto.ShapeBase.NOT_SET:
                _params['allocated_capacity'] = allocated_capacity
            if timeout is not autoboto.ShapeBase.NOT_SET:
                _params['timeout'] = timeout
            if notification_property is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_partition(
        ...
        *,
        ...
        if _request is None:
            ...
            if table_name is not autoboto.ShapeBase.NOT_SET:
                _params['table_name'] = table_name
            if partition_input is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_script(
        ...
        *,
        dag_nodes: typing.List[shapes.CodeGenNode] = autoboto.ShapeBase.NOT_SET,
        dag_edges: typing.List[shapes.CodeGenEdge] = autoboto.ShapeBase.NOT_SET,
        language: shapes.Language = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if dag_nodes is not autoboto.ShapeBase.NOT_SET:
                _params['dag_nodes'] = dag_nodes
            if dag_edges is not autoboto.ShapeBase.NOT_SET:
                _params['dag_edges'] = dag_edges
            if language is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_security_configuration(
        ...
        *,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase.NOT_SET:
                _params['name'] = name
            if encryption_configuration is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_table(
        ...
        *,
        ...
        if _request is None:
            ...
            if database_name is not autoboto.ShapeBase.NOT_SET:
                _params['database_name'] = database_name
            if table_input is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_trigger(
        ...
        *,
        ...
        schedule: str = autoboto.ShapeBase.NOT_SET,
        predicate: shapes.Predicate = autoboto.ShapeBase.NOT_SET,
        description: str = autoboto.ShapeBase.NOT_SET,
        start_on_creation: bool = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if schedule is not autoboto.ShapeBase.NOT_SET:
                _params['schedule'] = schedule
            if predicate is not autoboto.ShapeBase.NOT_SET:
                _params['predicate'] = predicate
            if description is not autoboto.ShapeBase.NOT_SET:
                _params['description'] = description
            if start_on_creation is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_user_defined_function(
        ...
        *,
        ...
        if _request is None:
            ...
            if database_name is not autoboto.ShapeBase.NOT_SET:
                _params['database_name'] = database_name
            if function_input is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_connection(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if connection_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_partition(
        ...
        *,
        ...
        if _request is None:
            ...
            if table_name is not autoboto.ShapeBase.NOT_SET:
                _params['table_name'] = table_name
            if partition_values is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_user_defined_function(
        ...
        *,
        ...
        if _request is None:
            ...
            if database_name is not autoboto.ShapeBase.NOT_SET:
                _params['database_name'] = database_name
            if function_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_connections(
        ...
        *,
        catalog_id: str = autoboto.ShapeBase.NOT_SET,
        filter: shapes.GetConnectionsFilter = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
    ...
    def get_crawler_metrics(
        ...
        *,
        crawler_name_list: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if crawler_name_list is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_dataflow_graph(
        ...
        *,
        python_script: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if python_script is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_job_run(
        ...
        *,
        job_name: str,
        run_id: str,
        predecessors_included: bool = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if job_name is not autoboto.ShapeBase.NOT_SET:
                _params['job_name'] = job_name
            if run_id is not autoboto.ShapeBase.NOT_SET:
                _params['run_id'] = run_id
            if predecessors_included is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_mapping(
        ...
        *,
        ...
        sinks: typing.List[shapes.CatalogEntry] = autoboto.ShapeBase.NOT_SET,
        location: shapes.Location = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if sinks is not autoboto.ShapeBase.NOT_SET:
                _params['sinks'] = sinks
    ...
    def get_partitions(
        ...
        *,
        ...
        table_name: str,
        catalog_id: str = autoboto.ShapeBase.NOT_SET,
        expression: str = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        segment: shapes.Segment = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if next_token is not autoboto.ShapeBase.NOT_SET:
                _params['next_token'] = next_token
            if segment is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_plan(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if mapping is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_triggers(
        ...
        *,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        dependent_job_name: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if next_token is not autoboto.ShapeBase.NOT_SET:
                _params['next_token'] = next_token
            if dependent_job_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_user_defined_functions(
        ...
        *,
        ...
        if _request is None:
            ...
            if database_name is not autoboto.ShapeBase.NOT_SET:
                _params['database_name'] = database_name
            if pattern is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_data_catalog_encryption_settings(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if data_catalog_encryption_settings is not autoboto.ShapeBase.NOT_SET:
    ...
    def start_crawler_schedule(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if crawler_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def start_job_run(
        ...
        *,
        job_name: str,
        job_run_id: str = autoboto.ShapeBase.NOT_SET,
        arguments: typing.Dict[str, str] = autoboto.ShapeBase.NOT_SET,
        allocated_capacity: int = autoboto.ShapeBase.NOT_SET,
        timeout: int = autoboto.ShapeBase.NOT_SET,
        notification_property: shapes.NotificationProperty = autoboto.ShapeBase.
        NOT_SET,
        ...
        if _request is None:
            ...
            if job_name is not autoboto.ShapeBase.NOT_SET:
                _params['job_name'] = job_name
            if job_run_id is not autoboto.ShapeBase.NOT_SET:
                _params['job_run_id'] = job_run_id
            if arguments is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_classifier(
        ...
        *,
        grok_classifier: shapes.UpdateGrokClassifierRequest = autoboto.
        ShapeBase.NOT_SET,
        xml_classifier: shapes.UpdateXMLClassifierRequest = autoboto.ShapeBase.
        NOT_SET,
        json_classifier: shapes.UpdateJsonClassifierRequest = autoboto.
        ShapeBase.NOT_SET,
    ...
    def update_crawler(
        ...
        *,
        name: str,
        role: str = autoboto.ShapeBase.NOT_SET,
        database_name: str = autoboto.ShapeBase.NOT_SET,
        description: str = autoboto.ShapeBase.NOT_SET,
        targets: shapes.CrawlerTargets = autoboto.ShapeBase.NOT_SET,
        schedule: str = autoboto.ShapeBase.NOT_SET,
        classifiers: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        table_prefix: str = autoboto.ShapeBase.NOT_SET,
        schema_change_policy: shapes.SchemaChangePolicy = autoboto.ShapeBase.
    ...
    def update_dev_endpoint(
        ...
        *,
        endpoint_name: str,
        public_key: str = autoboto.ShapeBase.NOT_SET,
        add_public_keys: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        delete_public_keys: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        custom_libraries: shapes.DevEndpointCustomLibraries = autoboto.
        ShapeBase.NOT_SET,
        update_etl_libraries: bool = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if public_key is not autoboto.ShapeBase.NOT_SET:
                _params['public_key'] = public_key
            if add_public_keys is not autoboto.ShapeBase.NOT_SET:
                _params['add_public_keys'] = add_public_keys
            if delete_public_keys is not autoboto.ShapeBase.NOT_SET:
                _params['delete_public_keys'] = delete_public_keys
            if custom_libraries is not autoboto.ShapeBase.NOT_SET:
                _params['custom_libraries'] = custom_libraries
            if update_etl_libraries is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_job(
        ...
        *,
        ...
        if _request is None:
            ...
            if job_name is not autoboto.ShapeBase.NOT_SET:
                _params['job_name'] = job_name
            if job_update is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_partition(
        ...
        *,
        ...
        if _request is None:
            ...
            if table_name is not autoboto.ShapeBase.NOT_SET:
                _params['table_name'] = table_name
            if partition_value_list is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_table(
        ...
        *,
        ...
        table_input: shapes.TableInput,
        catalog_id: str = autoboto.ShapeBase.NOT_SET,
        skip_archive: bool = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if catalog_id is not autoboto.ShapeBase.NOT_SET:
                _params['catalog_id'] = catalog_id
            if skip_archive is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_trigger(
        ...
        *,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase.NOT_SET:
                _params['name'] = name
            if trigger_update is not autoboto.ShapeBase.NOT_SET:
