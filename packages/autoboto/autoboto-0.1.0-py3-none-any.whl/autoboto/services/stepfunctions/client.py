...
class Client:
    ...
    def delete_activity(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if activity_arn is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_state_machine(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if state_machine_arn is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_execution(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if execution_arn is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_activity_task(
        ...
        *,
        activity_arn: str,
        worker_name: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if activity_arn is not autoboto.ShapeBase.NOT_SET:
                _params['activity_arn'] = activity_arn
            if worker_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_executions(
        ...
        *,
        state_machine_arn: str,
        status_filter: shapes.ExecutionStatus = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
    ...
    def send_task_failure(
        ...
        *,
        task_token: str,
        error: str = autoboto.ShapeBase.NOT_SET,
        cause: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if error is not autoboto.ShapeBase.NOT_SET:
                _params['error'] = error
            if cause is not autoboto.ShapeBase.NOT_SET:
                _params['cause'] = cause
