...
class Client:
    ...
    def get_shard_iterator(
        ...
        *,
        ...
        sequence_number: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if sequence_number is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_streams(
        ...
        *,
        ...
        limit: int = autoboto.ShapeBase.NOT_SET,
        exclusive_start_stream_arn: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if limit is not autoboto.ShapeBase.NOT_SET:
                _params['limit'] = limit
            if exclusive_start_stream_arn is not autoboto.ShapeBase.NOT_SET:
