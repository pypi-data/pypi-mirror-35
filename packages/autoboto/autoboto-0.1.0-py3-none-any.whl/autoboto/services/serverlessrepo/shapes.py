...
class Application(autoboto.ShapeBase):
    ...
    author: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    ...
    creation_time: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )

    # A URL with more information about the application, for example the location
    # of your GitHub repository for the application.
    home_page_url: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    ...
    # Maximum size 5 MB
    readme_url: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
class CreateApplicationInput(autoboto.ShapeBase):
    ...
    # error will result.
    license_body: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    ...
    # error will result.
    readme_body: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class CreateApplicationVersionResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class CreateCloudFormationChangeSetResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class GetApplicationPolicyResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class GetApplicationResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class ListApplicationVersionsResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
class ParameterDefinition(autoboto.ShapeBase):
    ...
    # want to allow for String types.
    min_length: int = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class PutApplicationPolicyResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
