...
class Client:
    ...
    def create_application(
        ...
        *,
        ...
        description: str,
        name: str,
        home_page_url: str = autoboto.ShapeBase.NOT_SET,
        labels: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        license_body: str = autoboto.ShapeBase.NOT_SET,
        license_url: str = autoboto.ShapeBase.NOT_SET,
        readme_body: str = autoboto.ShapeBase.NOT_SET,
        readme_url: str = autoboto.ShapeBase.NOT_SET,
        semantic_version: str = autoboto.ShapeBase.NOT_SET,
        source_code_url: str = autoboto.ShapeBase.NOT_SET,
        spdx_license_id: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if author is not autoboto.ShapeBase.NOT_SET:
                _params['author'] = author
            if description is not autoboto.ShapeBase.NOT_SET:
                _params['description'] = description
            if name is not autoboto.ShapeBase.NOT_SET:
                _params['name'] = name
            if home_page_url is not autoboto.ShapeBase.NOT_SET:
                _params['home_page_url'] = home_page_url
            if labels is not autoboto.ShapeBase.NOT_SET:
                _params['labels'] = labels
            if license_body is not autoboto.ShapeBase.NOT_SET:
                _params['license_body'] = license_body
            if license_url is not autoboto.ShapeBase.NOT_SET:
                _params['license_url'] = license_url
            if readme_body is not autoboto.ShapeBase.NOT_SET:
                _params['readme_body'] = readme_body
            if readme_url is not autoboto.ShapeBase.NOT_SET:
                _params['readme_url'] = readme_url
            if semantic_version is not autoboto.ShapeBase.NOT_SET:
                _params['semantic_version'] = semantic_version
            if source_code_url is not autoboto.ShapeBase.NOT_SET:
                _params['source_code_url'] = source_code_url
            if spdx_license_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_application_policy(
        ...
        *,
        ...
        if _request is None:
            ...
            if application_id is not autoboto.ShapeBase.NOT_SET:
                _params['application_id'] = application_id
            if statements is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_application(
        ...
        *,
        application_id: str,
        author: str = autoboto.ShapeBase.NOT_SET,
