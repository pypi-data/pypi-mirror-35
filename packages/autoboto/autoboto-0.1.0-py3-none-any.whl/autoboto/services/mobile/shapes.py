...
@dataclasses.dataclass
class DescribeBundleResult(autoboto.OutputShapeBase):
    """
...
@dataclasses.dataclass
class ExportBundleResult(autoboto.OutputShapeBase):
    """
...
@dataclasses.dataclass
class ExportProjectResult(autoboto.OutputShapeBase):
    """
...
@dataclasses.dataclass
class ListBundlesResult(autoboto.OutputShapeBase):
    """
