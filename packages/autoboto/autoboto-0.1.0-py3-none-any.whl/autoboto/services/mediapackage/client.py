...
class Client:
    ...
    def create_origin_endpoint(
        ...
        *,
        ...
        ShapeBase.NOT_SET,
        dash_package: shapes.DashPackage = autoboto.ShapeBase.NOT_SET,
        description: str = autoboto.ShapeBase.NOT_SET,
        hls_package: shapes.HlsPackage = autoboto.ShapeBase.NOT_SET,
        manifest_name: str = autoboto.ShapeBase.NOT_SET,
        mss_package: shapes.MssPackage = autoboto.ShapeBase.NOT_SET,
        startover_window_seconds: int = autoboto.ShapeBase.NOT_SET,
        time_delay_seconds: int = autoboto.ShapeBase.NOT_SET,
        whitelist: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if id is not autoboto.ShapeBase.NOT_SET:
                _params['id'] = id
            if cmaf_package is not autoboto.ShapeBase.NOT_SET:
                _params['cmaf_package'] = cmaf_package
            if dash_package is not autoboto.ShapeBase.NOT_SET:
                _params['dash_package'] = dash_package
            if description is not autoboto.ShapeBase.NOT_SET:
                _params['description'] = description
            if hls_package is not autoboto.ShapeBase.NOT_SET:
                _params['hls_package'] = hls_package
            if manifest_name is not autoboto.ShapeBase.NOT_SET:
                _params['manifest_name'] = manifest_name
            if mss_package is not autoboto.ShapeBase.NOT_SET:
                _params['mss_package'] = mss_package
            if startover_window_seconds is not autoboto.ShapeBase.NOT_SET:
                _params['startover_window_seconds'] = startover_window_seconds
            if time_delay_seconds is not autoboto.ShapeBase.NOT_SET:
                _params['time_delay_seconds'] = time_delay_seconds
            if whitelist is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_origin_endpoints(
        ...
        *,
        channel_id: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
    ...
    def rotate_ingest_endpoint_credentials(
        ...
        *,
        ...
        if _request is None:
            ...
            if id is not autoboto.ShapeBase.NOT_SET:
                _params['id'] = id
            if ingest_endpoint_id is not autoboto.ShapeBase.NOT_SET:
