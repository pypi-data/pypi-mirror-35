...
class Client:
    ...
    def describe_job_execution(
        ...
        *,
        job_id: str,
        thing_name: str,
        include_job_document: bool = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if include_job_document is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_job_execution(
        ...
        *,
        ...
        include_job_execution_state: bool = autoboto.ShapeBase.NOT_SET,
        include_job_document: bool = autoboto.ShapeBase.NOT_SET,
        execution_number: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if include_job_execution_state is not autoboto.ShapeBase.NOT_SET:
