...
class Backup(autoboto.ShapeBase):
    ...
    backup_state: "BackupState" = dataclasses.field(
    ...
    source_backup: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    source_cluster: str = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
...
@dataclasses.dataclass
class Certificates(autoboto.ShapeBase):
    """
    ...
    cluster_csr: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )

    # The HSM certificate issued (signed) by the HSM hardware.
    hsm_certificate: str = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
    ...
    cluster_certificate: str = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )


@dataclasses.dataclass
class CloudHsmAccessDeniedException(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class CloudHsmInternalFailureException(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class CloudHsmInvalidRequestException(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class CloudHsmResourceNotFoundException(autoboto.ShapeBase):
    """
...
class Cluster(autoboto.ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "backup_policy",
                "BackupPolicy",
                autoboto.TypeInfo(BackupPolicy),
            ),
            (
                "cluster_id",
                "ClusterId",
            ...
            (
                "hsms",
                "Hsms",
                autoboto.TypeInfo(typing.List[Hsm]),
            ),
            (
                "hsm_type",
                "HsmType",
            ...
            (
                "certificates",
                "Certificates",
                autoboto.TypeInfo(Certificates),
            ),
        ]
    ...
    hsm_type: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )

    # The default password for the cluster's Pre-Crypto Officer (PRECO) user.
    pre_co_password: str = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )

    # The identifier (ID) of the cluster's security group.
    security_group: str = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
    ...
    source_backup_id: str = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
    ...
    state_message: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class CopyBackupToRegionRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class CopyBackupToRegionResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
            ...
            (
                "destination_backup",
                "DestinationBackup",
                autoboto.TypeInfo(DestinationBackup),
            ),
        ]
...
@dataclasses.dataclass
class CreateHsmResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
class DeleteHsmRequest(autoboto.ShapeBase):
    ...
    hsm_id: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    ...
    # are deleting.
    eni_ip: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )


@dataclasses.dataclass
class DeleteHsmResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
class DescribeBackupsRequest(autoboto.ShapeBase):
    ...
    sort_ascending: bool = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
...
@dataclasses.dataclass
class DestinationBackup(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
class Hsm(autoboto.ShapeBase):
    ...
    # The HSM's state.
    state: "HsmState" = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class InitializeClusterRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
    ...
    signed_cert: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    ...
    # maximum of 5000 characters.
    trust_anchor: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )


@dataclasses.dataclass
class InitializeClusterResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
