...
class GenerateDataSetRequest(autoboto.ShapeBase):
    """
    ...
    role_name_arn: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    ...
    destination_s3_prefix: str = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
...
@dataclasses.dataclass
class GenerateDataSetResult(autoboto.OutputShapeBase):
    """
    ...
    data_set_request_id: str = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )


@dataclasses.dataclass
class MarketplaceCommerceAnalyticsException(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class StartSupportDataExportRequest(autoboto.ShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "data_set_type",
                "dataSetType",
                autoboto.TypeInfo(SupportDataSetType),
            ),
            (
                "from_date",
                "fromDate",
...
@dataclasses.dataclass
class StartSupportDataExportResult(autoboto.OutputShapeBase):
    """
