...
class AssociateAdminAccountRequest(autoboto.ShapeBase):
    @classmethod
    ...
    admin_account: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )


@dataclasses.dataclass
class ComplianceViolator(autoboto.ShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "violation_reason",
                "ViolationReason",
                autoboto.TypeInfo(ViolationReason),
            ),
            (
                "resource_type",
                "ResourceType",
...
@dataclasses.dataclass
class DeleteNotificationChannelRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return []
...
@dataclasses.dataclass
class DisassociateAdminAccountRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return []
...
class EvaluationResult(autoboto.ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "compliance_status",
                "ComplianceStatus",
                autoboto.TypeInfo(PolicyComplianceStatusType),
            ),
            (
                "violator_count",
                "ViolatorCount",
    ...
    # specified policy.
    violator_count: int = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
...
@dataclasses.dataclass
class GetAdminAccountRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return []
...
@dataclasses.dataclass
class GetAdminAccountResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class GetComplianceDetailRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
    ...
    # for.
    member_account: str = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )


@dataclasses.dataclass
class GetComplianceDetailResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
            ...
            (
                ...
                autoboto.TypeInfo(PolicyComplianceDetail),
            ),
        ]
...
@dataclasses.dataclass
class GetNotificationChannelRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return []
...
@dataclasses.dataclass
class GetNotificationChannelResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
    ...
    # SNS.
    sns_role_name: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class ListComplianceStatusRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class ListComplianceStatusResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
            ...
            (
                ...
                autoboto.TypeInfo(typing.List[PolicyComplianceStatus]),
            ),
            (
                "next_token",
                "NextToken",
...
class Policy(autoboto.ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                ...
                autoboto.TypeInfo(SecurityServicePolicyData),
            ),
            (
                "resource_type",
                "ResourceType",
    ...
    exclude_resource_tags: bool = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )

    # Indicates if the policy should be automatically applied to new resources.
    remediation_enabled: bool = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
    ...
    # request.
    policy_update_token: str = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
...
@dataclasses.dataclass
class PolicyComplianceDetail(autoboto.ShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "violators",
                "Violators",
                autoboto.TypeInfo(typing.List[ComplianceViolator]),
            ),
            (
                "evaluation_limit_exceeded",
                "EvaluationLimitExceeded",
    ...
    policy_owner: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class PolicyComplianceStatus(autoboto.ShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                ...
                "SecurityServiceType",
                autoboto.TypeInfo(SecurityServiceType),
            ),
            (
                "remediation_enabled",
                "RemediationEnabled",
...
@dataclasses.dataclass
class PutNotificationChannelRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class PutPolicyRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class PutPolicyResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class SecurityServicePolicyData(autoboto.ShapeBase):
    """
    ...
    # The service that the policy is using to protect the resources. This value
    # is `WAF`.
    type: "SecurityServiceType" = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
    ...
    managed_service_data: str = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
