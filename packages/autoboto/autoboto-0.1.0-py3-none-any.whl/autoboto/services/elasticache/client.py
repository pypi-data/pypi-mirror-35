...
class Client:
    ...
    def authorize_cache_security_group_ingress(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if cache_security_group_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def copy_snapshot(
        ...
        *,
        ...
        target_bucket: str = autoboto.ShapeBase.NOT_SET,
        ...
        **Solution:** Add View Permissions on the bucket. For more information, see
        ...
        if _request is None:
            _params = {}
            if source_snapshot_name is not autoboto.ShapeBase.NOT_SET:
                _params['source_snapshot_name'] = source_snapshot_name
            if target_snapshot_name is not autoboto.ShapeBase.NOT_SET:
                _params['target_snapshot_name'] = target_snapshot_name
            if target_bucket is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_cache_cluster(
        ...
        *,
        ...
        replication_group_id: str = autoboto.ShapeBase.NOT_SET,
        az_mode: shapes.AZMode = autoboto.ShapeBase.NOT_SET,
        preferred_availability_zone: str = autoboto.ShapeBase.NOT_SET,
        preferred_availability_zones: typing.List[str
                                                 ] = autoboto.ShapeBase.NOT_SET,
        num_cache_nodes: int = autoboto.ShapeBase.NOT_SET,
        cache_node_type: str = autoboto.ShapeBase.NOT_SET,
        engine: str = autoboto.ShapeBase.NOT_SET,
        engine_version: str = autoboto.ShapeBase.NOT_SET,
        cache_parameter_group_name: str = autoboto.ShapeBase.NOT_SET,
        cache_subnet_group_name: str = autoboto.ShapeBase.NOT_SET,
        ...
        snapshot_arns: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        snapshot_name: str = autoboto.ShapeBase.NOT_SET,
        preferred_maintenance_window: str = autoboto.ShapeBase.NOT_SET,
        port: int = autoboto.ShapeBase.NOT_SET,
        notification_topic_arn: str = autoboto.ShapeBase.NOT_SET,
        auto_minor_version_upgrade: bool = autoboto.ShapeBase.NOT_SET,
        snapshot_retention_limit: int = autoboto.ShapeBase.NOT_SET,
        snapshot_window: str = autoboto.ShapeBase.NOT_SET,
        auth_token: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if cache_cluster_id is not autoboto.ShapeBase.NOT_SET:
                _params['cache_cluster_id'] = cache_cluster_id
            if replication_group_id is not autoboto.ShapeBase.NOT_SET:
                _params['replication_group_id'] = replication_group_id
            if az_mode is not autoboto.ShapeBase.NOT_SET:
                _params['az_mode'] = az_mode
            if preferred_availability_zone is not autoboto.ShapeBase.NOT_SET:
                _params['preferred_availability_zone'
                       ] = preferred_availability_zone
            if preferred_availability_zones is not autoboto.ShapeBase.NOT_SET:
                _params['preferred_availability_zones'
                       ] = preferred_availability_zones
            if num_cache_nodes is not autoboto.ShapeBase.NOT_SET:
                _params['num_cache_nodes'] = num_cache_nodes
            if cache_node_type is not autoboto.ShapeBase.NOT_SET:
            ...
            if cache_parameter_group_name is not autoboto.ShapeBase.NOT_SET:
                _params['cache_parameter_group_name'
                       ] = cache_parameter_group_name
            if cache_subnet_group_name is not autoboto.ShapeBase.NOT_SET:
                _params['cache_subnet_group_name'] = cache_subnet_group_name
            if cache_security_group_names is not autoboto.ShapeBase.NOT_SET:
            ...
            if tags is not autoboto.ShapeBase.NOT_SET:
                _params['tags'] = tags
            if snapshot_arns is not autoboto.ShapeBase.NOT_SET:
                _params['snapshot_arns'] = snapshot_arns
            if snapshot_name is not autoboto.ShapeBase.NOT_SET:
            ...
            if port is not autoboto.ShapeBase.NOT_SET:
                _params['port'] = port
            if notification_topic_arn is not autoboto.ShapeBase.NOT_SET:
            ...
            if snapshot_retention_limit is not autoboto.ShapeBase.NOT_SET:
                _params['snapshot_retention_limit'] = snapshot_retention_limit
            if snapshot_window is not autoboto.ShapeBase.NOT_SET:
                _params['snapshot_window'] = snapshot_window
            if auth_token is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_cache_parameter_group(
        ...
        *,
        ...
        if _request is None:
            ...
            if cache_parameter_group_family is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_cache_subnet_group(
        ...
        *,
        ...
        if _request is None:
            ...
            if cache_subnet_group_name is not autoboto.ShapeBase.NOT_SET:
                _params['cache_subnet_group_name'] = cache_subnet_group_name
            if cache_subnet_group_description is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_replication_group(
        ...
        *,
        ...
        primary_cluster_id: str = autoboto.ShapeBase.NOT_SET,
        automatic_failover_enabled: bool = autoboto.ShapeBase.NOT_SET,
        num_cache_clusters: int = autoboto.ShapeBase.NOT_SET,
        preferred_cache_cluster_a_zs: typing.List[str
                                                 ] = autoboto.ShapeBase.NOT_SET,
        num_node_groups: int = autoboto.ShapeBase.NOT_SET,
        replicas_per_node_group: int = autoboto.ShapeBase.NOT_SET,
        ...
        snapshot_window: str = autoboto.ShapeBase.NOT_SET,
        auth_token: str = autoboto.ShapeBase.NOT_SET,
        transit_encryption_enabled: bool = autoboto.ShapeBase.NOT_SET,
        at_rest_encryption_enabled: bool = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if replication_group_id is not autoboto.ShapeBase.NOT_SET:
                _params['replication_group_id'] = replication_group_id
            if replication_group_description is not autoboto.ShapeBase.NOT_SET:
                _params['replication_group_description'
                       ] = replication_group_description
            if primary_cluster_id is not autoboto.ShapeBase.NOT_SET:
                _params['primary_cluster_id'] = primary_cluster_id
            if automatic_failover_enabled is not autoboto.ShapeBase.NOT_SET:
                _params['automatic_failover_enabled'
                       ] = automatic_failover_enabled
            if num_cache_clusters is not autoboto.ShapeBase.NOT_SET:
                _params['num_cache_clusters'] = num_cache_clusters
            if preferred_cache_cluster_a_zs is not autoboto.ShapeBase.NOT_SET:
                _params['preferred_cache_cluster_a_zs'
                       ] = preferred_cache_cluster_a_zs
            if num_node_groups is not autoboto.ShapeBase.NOT_SET:
                _params['num_node_groups'] = num_node_groups
            if replicas_per_node_group is not autoboto.ShapeBase.NOT_SET:
                _params['replicas_per_node_group'] = replicas_per_node_group
            if node_group_configuration is not autoboto.ShapeBase.NOT_SET:
            ...
            if auth_token is not autoboto.ShapeBase.NOT_SET:
                _params['auth_token'] = auth_token
            if transit_encryption_enabled is not autoboto.ShapeBase.NOT_SET:
                _params['transit_encryption_enabled'
                       ] = transit_encryption_enabled
            if at_rest_encryption_enabled is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_snapshot(
        ...
        *,
        snapshot_name: str,
        replication_group_id: str = autoboto.ShapeBase.NOT_SET,
        cache_cluster_id: str = autoboto.ShapeBase.NOT_SET,
    ...
    def delete_cache_cluster(
        ...
        *,
        cache_cluster_id: str,
        final_snapshot_identifier: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if cache_cluster_id is not autoboto.ShapeBase.NOT_SET:
                _params['cache_cluster_id'] = cache_cluster_id
            if final_snapshot_identifier is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_replication_group(
        ...
        *,
        replication_group_id: str,
        retain_primary_cluster: bool = autoboto.ShapeBase.NOT_SET,
        final_snapshot_identifier: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if replication_group_id is not autoboto.ShapeBase.NOT_SET:
                _params['replication_group_id'] = replication_group_id
            if retain_primary_cluster is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_cache_clusters(
        ...
        *,
        ...
        show_cache_node_info: bool = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if show_cache_node_info is not autoboto.ShapeBase.NOT_SET:
                _params['show_cache_node_info'] = show_cache_node_info
            if show_cache_clusters_not_in_replication_groups is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_cache_engine_versions(
        ...
        *,
        engine: str = autoboto.ShapeBase.NOT_SET,
        engine_version: str = autoboto.ShapeBase.NOT_SET,
        cache_parameter_group_family: str = autoboto.ShapeBase.NOT_SET,
        max_records: int = autoboto.ShapeBase.NOT_SET,
        marker: str = autoboto.ShapeBase.NOT_SET,
    ...
    def describe_cache_security_groups(
        ...
        *,
        cache_security_group_name: str = autoboto.ShapeBase.NOT_SET,
        max_records: int = autoboto.ShapeBase.NOT_SET,
        marker: str = autoboto.ShapeBase.NOT_SET,
    ...
    def describe_reserved_cache_nodes(
        ...
        *,
        reserved_cache_node_id: str = autoboto.ShapeBase.NOT_SET,
        reserved_cache_nodes_offering_id: str = autoboto.ShapeBase.NOT_SET,
        cache_node_type: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if reserved_cache_node_id is not autoboto.ShapeBase.NOT_SET:
                _params['reserved_cache_node_id'] = reserved_cache_node_id
            if reserved_cache_nodes_offering_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_snapshots(
        ...
        *,
        ...
        cache_cluster_id: str = autoboto.ShapeBase.NOT_SET,
        snapshot_name: str = autoboto.ShapeBase.NOT_SET,
        snapshot_source: str = autoboto.ShapeBase.NOT_SET,
        marker: str = autoboto.ShapeBase.NOT_SET,
        max_records: int = autoboto.ShapeBase.NOT_SET,
        show_node_group_config: bool = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if snapshot_name is not autoboto.ShapeBase.NOT_SET:
                _params['snapshot_name'] = snapshot_name
            if snapshot_source is not autoboto.ShapeBase.NOT_SET:
                _params['snapshot_source'] = snapshot_source
            if marker is not autoboto.ShapeBase.NOT_SET:
                _params['marker'] = marker
            if max_records is not autoboto.ShapeBase.NOT_SET:
                _params['max_records'] = max_records
            if show_node_group_config is not autoboto.ShapeBase.NOT_SET:
    ...
    def modify_cache_cluster(
        ...
        *,
        cache_cluster_id: str,
        num_cache_nodes: int = autoboto.ShapeBase.NOT_SET,
        cache_node_ids_to_remove: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        az_mode: shapes.AZMode = autoboto.ShapeBase.NOT_SET,
        new_availability_zones: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        cache_security_group_names: typing.List[str
                                               ] = autoboto.ShapeBase.NOT_SET,
        security_group_ids: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        preferred_maintenance_window: str = autoboto.ShapeBase.NOT_SET,
        notification_topic_arn: str = autoboto.ShapeBase.NOT_SET,
        cache_parameter_group_name: str = autoboto.ShapeBase.NOT_SET,
        notification_topic_status: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if num_cache_nodes is not autoboto.ShapeBase.NOT_SET:
                _params['num_cache_nodes'] = num_cache_nodes
            if cache_node_ids_to_remove is not autoboto.ShapeBase.NOT_SET:
                _params['cache_node_ids_to_remove'] = cache_node_ids_to_remove
            if az_mode is not autoboto.ShapeBase.NOT_SET:
                _params['az_mode'] = az_mode
            if new_availability_zones is not autoboto.ShapeBase.NOT_SET:
            ...
            if notification_topic_status is not autoboto.ShapeBase.NOT_SET:
    ...
    def modify_cache_parameter_group(
        ...
        *,
        ...
        if _request is None:
            ...
            if parameter_name_values is not autoboto.ShapeBase.NOT_SET:
    ...
    def modify_cache_subnet_group(
        ...
        *,
        cache_subnet_group_name: str,
        cache_subnet_group_description: str = autoboto.ShapeBase.NOT_SET,
    ...
    def modify_replication_group(
        ...
        *,
        replication_group_id: str,
        replication_group_description: str = autoboto.ShapeBase.NOT_SET,
        primary_cluster_id: str = autoboto.ShapeBase.NOT_SET,
        snapshotting_cluster_id: str = autoboto.ShapeBase.NOT_SET,
        automatic_failover_enabled: bool = autoboto.ShapeBase.NOT_SET,
        cache_security_group_names: typing.List[str
                                               ] = autoboto.ShapeBase.NOT_SET,
        security_group_ids: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        ...
        snapshot_window: str = autoboto.ShapeBase.NOT_SET,
        cache_node_type: str = autoboto.ShapeBase.NOT_SET,
        node_group_id: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if primary_cluster_id is not autoboto.ShapeBase.NOT_SET:
                _params['primary_cluster_id'] = primary_cluster_id
            if snapshotting_cluster_id is not autoboto.ShapeBase.NOT_SET:
            ...
            if cache_node_type is not autoboto.ShapeBase.NOT_SET:
                _params['cache_node_type'] = cache_node_type
            if node_group_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def modify_replication_group_shard_configuration(
        ...
        *,
        ...
        node_groups_to_remove: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if replication_group_id is not autoboto.ShapeBase.NOT_SET:
                _params['replication_group_id'] = replication_group_id
            if node_group_count is not autoboto.ShapeBase.NOT_SET:
                _params['node_group_count'] = node_group_count
            if apply_immediately is not autoboto.ShapeBase.NOT_SET:
                _params['apply_immediately'] = apply_immediately
            if resharding_configuration is not autoboto.ShapeBase.NOT_SET:
                _params['resharding_configuration'] = resharding_configuration
            if node_groups_to_remove is not autoboto.ShapeBase.NOT_SET:
    ...
    def purchase_reserved_cache_nodes_offering(
        ...
        *,
        ...
        reserved_cache_node_id: str = autoboto.ShapeBase.NOT_SET,
        cache_node_count: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if reserved_cache_node_id is not autoboto.ShapeBase.NOT_SET:
                _params['reserved_cache_node_id'] = reserved_cache_node_id
            if cache_node_count is not autoboto.ShapeBase.NOT_SET:
    ...
    def reboot_cache_cluster(
        ...
        *,
        ...
        if _request is None:
            ...
            if cache_cluster_id is not autoboto.ShapeBase.NOT_SET:
                _params['cache_cluster_id'] = cache_cluster_id
            if cache_node_ids_to_reboot is not autoboto.ShapeBase.NOT_SET:
