...
class CancelJobInput(autoboto.ShapeBase):
    ...
    api_version: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )


@dataclasses.dataclass
class CancelJobOutput(autoboto.OutputShapeBase):
    """
    ...
    success: bool = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
class CreateJobInput(autoboto.ShapeBase):
    ...
    manifest: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class GetShippingLabelOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class GetStatusOutput(autoboto.OutputShapeBase):
    """
    ...
    progress_code: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    ...
    log_key: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
class Job(autoboto.ShapeBase):
    ...
    is_canceled: bool = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
class ListJobsInput(autoboto.ShapeBase):
    ...
    # jobs, see Marker.
    max_jobs: int = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class UpdateJobOutput(autoboto.OutputShapeBase):
    """
