...
class Client:
    ...
    def create_stream(
        ...
        *,
        ...
        media_type: str = autoboto.ShapeBase.NOT_SET,
        kms_key_id: str = autoboto.ShapeBase.NOT_SET,
        data_retention_in_hours: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if media_type is not autoboto.ShapeBase.NOT_SET:
                _params['media_type'] = media_type
            if kms_key_id is not autoboto.ShapeBase.NOT_SET:
                _params['kms_key_id'] = kms_key_id
            if data_retention_in_hours is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_stream(
        ...
        *,
        stream_arn: str,
        current_version: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if current_version is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_data_endpoint(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if api_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_streams(
        ...
        *,
        ...
        if _request is None:
            ...
            if stream_name_condition is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_data_retention(
        ...
        *,
        ...
        if _request is None:
            ...
            if current_version is not autoboto.ShapeBase.NOT_SET:
                _params['current_version'] = current_version
            if operation is not autoboto.ShapeBase.NOT_SET:
                _params['operation'] = operation
            if data_retention_change_in_hours is not autoboto.ShapeBase.NOT_SET:
