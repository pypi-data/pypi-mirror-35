...
class Client:
    ...
    def cancel_rotate_secret(
        ...
        **Related operations**
        ...
        if _request is None:
            _params = {}
            if secret_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_secret(
        ...
        *,
        ...
        secret_binary: typing.Any = autoboto.ShapeBase._NOT_SET,
        secret_string: str = autoboto.ShapeBase._NOT_SET,
        ...
        **Related operations**
        ...
        if _request is None:
            ...
            if secret_binary is not autoboto.ShapeBase._NOT_SET:
                _params['secret_binary'] = secret_binary
            if secret_string is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_secret(
        ...
        *,
        secret_id: str,
        recovery_window_in_days: int = autoboto.ShapeBase._NOT_SET,
        force_delete_without_recovery: bool = autoboto.ShapeBase._NOT_SET,
        ...
        **Related operations**
        ...
        if _request is None:
            ...
            if secret_id is not autoboto.ShapeBase._NOT_SET:
                _params['secret_id'] = secret_id
            if recovery_window_in_days is not autoboto.ShapeBase._NOT_SET:
                _params['recovery_window_in_days'] = recovery_window_in_days
            if force_delete_without_recovery is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_random_password(
        ...
        *,
        password_length: int = autoboto.ShapeBase._NOT_SET,
        exclude_characters: str = autoboto.ShapeBase._NOT_SET,
        exclude_numbers: bool = autoboto.ShapeBase._NOT_SET,
        exclude_punctuation: bool = autoboto.ShapeBase._NOT_SET,
        exclude_uppercase: bool = autoboto.ShapeBase._NOT_SET,
        exclude_lowercase: bool = autoboto.ShapeBase._NOT_SET,
        include_space: bool = autoboto.ShapeBase._NOT_SET,
        require_each_included_type: bool = autoboto.ShapeBase._NOT_SET,
        ...
        **Minimum permissions**
        ...
        if _request is None:
            _params = {}
            if password_length is not autoboto.ShapeBase._NOT_SET:
                _params['password_length'] = password_length
            if exclude_characters is not autoboto.ShapeBase._NOT_SET:
                _params['exclude_characters'] = exclude_characters
            if exclude_numbers is not autoboto.ShapeBase._NOT_SET:
                _params['exclude_numbers'] = exclude_numbers
            if exclude_punctuation is not autoboto.ShapeBase._NOT_SET:
                _params['exclude_punctuation'] = exclude_punctuation
            if exclude_uppercase is not autoboto.ShapeBase._NOT_SET:
                _params['exclude_uppercase'] = exclude_uppercase
            if exclude_lowercase is not autoboto.ShapeBase._NOT_SET:
                _params['exclude_lowercase'] = exclude_lowercase
            if include_space is not autoboto.ShapeBase._NOT_SET:
                _params['include_space'] = include_space
            if require_each_included_type is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_secret_value(
        ...
        *,
        ...
        version_stage: str = autoboto.ShapeBase._NOT_SET,
        ...
        **Related operations**
        ...
        if _request is None:
            ...
            if version_stage is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_secret_version_ids(
        ...
        *,
        ...
        include_deprecated: bool = autoboto.ShapeBase._NOT_SET,
        ...
        **Related operations**
        ...
        if _request is None:
            ...
            if include_deprecated is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_secret_value(
        ...
        *,
        ...
        secret_binary: typing.Any = autoboto.ShapeBase._NOT_SET,
        secret_string: str = autoboto.ShapeBase._NOT_SET,
        version_stages: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        **Related operations**
        ...
        if _request is None:
            ...
            if secret_string is not autoboto.ShapeBase._NOT_SET:
                _params['secret_string'] = secret_string
            if version_stages is not autoboto.ShapeBase._NOT_SET:
    ...
    def rotate_secret(
        ...
        *,
        secret_id: str,
        client_request_token: str = autoboto.ShapeBase._NOT_SET,
        rotation_lambda_arn: str = autoboto.ShapeBase._NOT_SET,
        rotation_rules: shapes.RotationRulesType = autoboto.ShapeBase._NOT_SET,
        ...
        **Related operations**
        ...
        if _request is None:
            ...
            if client_request_token is not autoboto.ShapeBase._NOT_SET:
                _params['client_request_token'] = client_request_token
            if rotation_lambda_arn is not autoboto.ShapeBase._NOT_SET:
                _params['rotation_lambda_arn'] = rotation_lambda_arn
            if rotation_rules is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_secret_version_stage(
        ...
        *,
        secret_id: str,
        version_stage: str,
        remove_from_version_id: str = autoboto.ShapeBase._NOT_SET,
        move_to_version_id: str = autoboto.ShapeBase._NOT_SET,
        ...
        **Related operations**
        ...
        if _request is None:
            ...
            if version_stage is not autoboto.ShapeBase._NOT_SET:
                _params['version_stage'] = version_stage
            if remove_from_version_id is not autoboto.ShapeBase._NOT_SET:
                _params['remove_from_version_id'] = remove_from_version_id
            if move_to_version_id is not autoboto.ShapeBase._NOT_SET:
