...
class Client:
    ...
    def create_batch_prediction(
        ...
        *,
        ...
        output_uri: str,
        batch_prediction_name: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if batch_prediction_id is not autoboto.ShapeBase._NOT_SET:
                _params['batch_prediction_id'] = batch_prediction_id
            if ml_model_id is not autoboto.ShapeBase._NOT_SET:
                _params['ml_model_id'] = ml_model_id
            if batch_prediction_data_source_id is not autoboto.ShapeBase._NOT_SET:
                _params['batch_prediction_data_source_id'
                       ] = batch_prediction_data_source_id
            if output_uri is not autoboto.ShapeBase._NOT_SET:
                _params['output_uri'] = output_uri
            if batch_prediction_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_data_source_from_rds(
        ...
        *,
        ...
        role_arn: str,
        data_source_name: str = autoboto.ShapeBase._NOT_SET,
        compute_statistics: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if data_source_id is not autoboto.ShapeBase._NOT_SET:
                _params['data_source_id'] = data_source_id
            if rds_data is not autoboto.ShapeBase._NOT_SET:
                _params['rds_data'] = rds_data
            if role_arn is not autoboto.ShapeBase._NOT_SET:
                _params['role_arn'] = role_arn
            if data_source_name is not autoboto.ShapeBase._NOT_SET:
                _params['data_source_name'] = data_source_name
            if compute_statistics is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_data_source_from_redshift(
        ...
        *,
        ...
        if _request is None:
            ...
            if data_source_id is not autoboto.ShapeBase._NOT_SET:
                _params['data_source_id'] = data_source_id
            if data_spec is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_evaluation(
        ...
        *,
        ...
        evaluation_name: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if evaluation_id is not autoboto.ShapeBase._NOT_SET:
                _params['evaluation_id'] = evaluation_id
            if ml_model_id is not autoboto.ShapeBase._NOT_SET:
                _params['ml_model_id'] = ml_model_id
            if evaluation_data_source_id is not autoboto.ShapeBase._NOT_SET:
                _params['evaluation_data_source_id'] = evaluation_data_source_id
            if evaluation_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_ml_model(
        ...
        *,
        ...
        ml_model_name: str = autoboto.ShapeBase._NOT_SET,
        parameters: typing.Dict[str, str] = autoboto.ShapeBase._NOT_SET,
        recipe: str = autoboto.ShapeBase._NOT_SET,
        recipe_uri: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if ml_model_id is not autoboto.ShapeBase._NOT_SET:
                _params['ml_model_id'] = ml_model_id
            if ml_model_type is not autoboto.ShapeBase._NOT_SET:
                _params['ml_model_type'] = ml_model_type
            if training_data_source_id is not autoboto.ShapeBase._NOT_SET:
                _params['training_data_source_id'] = training_data_source_id
            if ml_model_name is not autoboto.ShapeBase._NOT_SET:
                _params['ml_model_name'] = ml_model_name
            if parameters is not autoboto.ShapeBase._NOT_SET:
                _params['parameters'] = parameters
            if recipe is not autoboto.ShapeBase._NOT_SET:
                _params['recipe'] = recipe
            if recipe_uri is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_batch_predictions(
        ...
        *,
        filter_variable: shapes.BatchPredictionFilterVariable = autoboto.
        ShapeBase._NOT_SET,
        eq: str = autoboto.ShapeBase._NOT_SET,
        gt: str = autoboto.ShapeBase._NOT_SET,
        lt: str = autoboto.ShapeBase._NOT_SET,
        ge: str = autoboto.ShapeBase._NOT_SET,
        le: str = autoboto.ShapeBase._NOT_SET,
        ne: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if filter_variable is not autoboto.ShapeBase._NOT_SET:
                _params['filter_variable'] = filter_variable
            if eq is not autoboto.ShapeBase._NOT_SET:
                _params['eq'] = eq
            if gt is not autoboto.ShapeBase._NOT_SET:
                _params['gt'] = gt
            if lt is not autoboto.ShapeBase._NOT_SET:
                _params['lt'] = lt
            if ge is not autoboto.ShapeBase._NOT_SET:
                _params['ge'] = ge
            if le is not autoboto.ShapeBase._NOT_SET:
                _params['le'] = le
            if ne is not autoboto.ShapeBase._NOT_SET:
                _params['ne'] = ne
    ...
    def describe_data_sources(
        ...
        *,
        filter_variable: shapes.DataSourceFilterVariable = autoboto.ShapeBase.
        _NOT_SET,
        eq: str = autoboto.ShapeBase._NOT_SET,
        gt: str = autoboto.ShapeBase._NOT_SET,
        lt: str = autoboto.ShapeBase._NOT_SET,
    ...
    def describe_evaluations(
        ...
        *,
        filter_variable: shapes.EvaluationFilterVariable = autoboto.ShapeBase.
        _NOT_SET,
        eq: str = autoboto.ShapeBase._NOT_SET,
        gt: str = autoboto.ShapeBase._NOT_SET,
        lt: str = autoboto.ShapeBase._NOT_SET,
    ...
    def describe_ml_models(
        ...
        *,
        filter_variable: shapes.MLModelFilterVariable = autoboto.ShapeBase.
        _NOT_SET,
        eq: str = autoboto.ShapeBase._NOT_SET,
        gt: str = autoboto.ShapeBase._NOT_SET,
        lt: str = autoboto.ShapeBase._NOT_SET,
    ...
    def predict(
        ...
        *,
        ...
        if _request is None:
            ...
            if ml_model_id is not autoboto.ShapeBase._NOT_SET:
                _params['ml_model_id'] = ml_model_id
            if record is not autoboto.ShapeBase._NOT_SET:
                _params['record'] = record
            if predict_endpoint is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_ml_model(
        ...
        *,
        ml_model_id: str,
        ml_model_name: str = autoboto.ShapeBase._NOT_SET,
        score_threshold: float = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if ml_model_name is not autoboto.ShapeBase._NOT_SET:
                _params['ml_model_name'] = ml_model_name
            if score_threshold is not autoboto.ShapeBase._NOT_SET:
