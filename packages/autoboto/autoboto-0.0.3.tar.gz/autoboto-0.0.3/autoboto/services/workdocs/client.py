...
class Client:
    ...
    def abort_document_version_upload(
        ...
        *,
        document_id: str,
        version_id: str,
        authentication_token: str = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
    ...
    def activate_user(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if user_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def add_resource_permissions(
        ...
        *,
        ...
        authentication_token: str = autoboto.ShapeBase._NOT_SET,
        notification_options: shapes.NotificationOptions = autoboto.ShapeBase.
        _NOT_SET,
        ...
        if _request is None:
            ...
            if principals is not autoboto.ShapeBase._NOT_SET:
                _params['principals'] = principals
            if authentication_token is not autoboto.ShapeBase._NOT_SET:
                _params['authentication_token'] = authentication_token
            if notification_options is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_comment(
        ...
        *,
        ...
        text: str,
        authentication_token: str = autoboto.ShapeBase._NOT_SET,
        parent_id: str = autoboto.ShapeBase._NOT_SET,
        thread_id: str = autoboto.ShapeBase._NOT_SET,
        visibility: shapes.CommentVisibilityType = autoboto.ShapeBase._NOT_SET,
        notify_collaborators: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if version_id is not autoboto.ShapeBase._NOT_SET:
                _params['version_id'] = version_id
            if text is not autoboto.ShapeBase._NOT_SET:
                _params['text'] = text
            if authentication_token is not autoboto.ShapeBase._NOT_SET:
                _params['authentication_token'] = authentication_token
            if parent_id is not autoboto.ShapeBase._NOT_SET:
                _params['parent_id'] = parent_id
            if thread_id is not autoboto.ShapeBase._NOT_SET:
                _params['thread_id'] = thread_id
            if visibility is not autoboto.ShapeBase._NOT_SET:
                _params['visibility'] = visibility
            if notify_collaborators is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_custom_metadata(
        ...
        *,
        ...
        if _request is None:
            ...
            if resource_id is not autoboto.ShapeBase._NOT_SET:
                _params['resource_id'] = resource_id
            if custom_metadata is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_folder(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if parent_folder_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_notification_subscription(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if organization_id is not autoboto.ShapeBase._NOT_SET:
                _params['organization_id'] = organization_id
            if endpoint is not autoboto.ShapeBase._NOT_SET:
                _params['endpoint'] = endpoint
            if protocol is not autoboto.ShapeBase._NOT_SET:
                _params['protocol'] = protocol
            if subscription_type is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_user(
        ...
        *,
        ...
        surname: str,
        password: str,
        organization_id: str = autoboto.ShapeBase._NOT_SET,
        email_address: str = autoboto.ShapeBase._NOT_SET,
        time_zone_id: str = autoboto.ShapeBase._NOT_SET,
        storage_rule: shapes.StorageRuleType = autoboto.ShapeBase._NOT_SET,
        authentication_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if given_name is not autoboto.ShapeBase._NOT_SET:
                _params['given_name'] = given_name
            if surname is not autoboto.ShapeBase._NOT_SET:
                _params['surname'] = surname
            if password is not autoboto.ShapeBase._NOT_SET:
                _params['password'] = password
            if organization_id is not autoboto.ShapeBase._NOT_SET:
                _params['organization_id'] = organization_id
            if email_address is not autoboto.ShapeBase._NOT_SET:
                _params['email_address'] = email_address
            if time_zone_id is not autoboto.ShapeBase._NOT_SET:
                _params['time_zone_id'] = time_zone_id
            if storage_rule is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_comment(
        ...
        *,
        ...
        if _request is None:
            ...
            if version_id is not autoboto.ShapeBase._NOT_SET:
                _params['version_id'] = version_id
            if comment_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_custom_metadata(
        ...
        *,
        ...
        authentication_token: str = autoboto.ShapeBase._NOT_SET,
        version_id: str = autoboto.ShapeBase._NOT_SET,
        keys: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        delete_all: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if version_id is not autoboto.ShapeBase._NOT_SET:
                _params['version_id'] = version_id
            if keys is not autoboto.ShapeBase._NOT_SET:
                _params['keys'] = keys
            if delete_all is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_folder(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if folder_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_labels(
        ...
        *,
        resource_id: str,
        authentication_token: str = autoboto.ShapeBase._NOT_SET,
        labels: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        delete_all: bool = autoboto.ShapeBase._NOT_SET,
    ...
    def delete_notification_subscription(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if subscription_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_activities(
        ...
        *,
        ...
        organization_id: str = autoboto.ShapeBase._NOT_SET,
        user_id: str = autoboto.ShapeBase._NOT_SET,
    ...
    def describe_document_versions(
        ...
        *,
        ...
        marker: str = autoboto.ShapeBase._NOT_SET,
        limit: int = autoboto.ShapeBase._NOT_SET,
        include: str = autoboto.ShapeBase._NOT_SET,
        fields: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if fields is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_folder_contents(
        ...
        *,
        folder_id: str,
        authentication_token: str = autoboto.ShapeBase._NOT_SET,
        sort: shapes.ResourceSortType = autoboto.ShapeBase._NOT_SET,
        order: shapes.OrderType = autoboto.ShapeBase._NOT_SET,
        limit: int = autoboto.ShapeBase._NOT_SET,
        marker: str = autoboto.ShapeBase._NOT_SET,
        type: shapes.FolderContentType = autoboto.ShapeBase._NOT_SET,
        include: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if sort is not autoboto.ShapeBase._NOT_SET:
                _params['sort'] = sort
            if order is not autoboto.ShapeBase._NOT_SET:
                _params['order'] = order
            if limit is not autoboto.ShapeBase._NOT_SET:
                _params['limit'] = limit
            if marker is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_groups(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if search_query is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_resource_permissions(
        ...
        *,
        resource_id: str,
        authentication_token: str = autoboto.ShapeBase._NOT_SET,
        principal_id: str = autoboto.ShapeBase._NOT_SET,
        limit: int = autoboto.ShapeBase._NOT_SET,
        marker: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if authentication_token is not autoboto.ShapeBase._NOT_SET:
                _params['authentication_token'] = authentication_token
            if principal_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_users(
        ...
        *,
        authentication_token: str = autoboto.ShapeBase._NOT_SET,
        organization_id: str = autoboto.ShapeBase._NOT_SET,
        user_ids: str = autoboto.ShapeBase._NOT_SET,
        query: str = autoboto.ShapeBase._NOT_SET,
        include: shapes.UserFilterType = autoboto.ShapeBase._NOT_SET,
        order: shapes.OrderType = autoboto.ShapeBase._NOT_SET,
        sort: shapes.UserSortType = autoboto.ShapeBase._NOT_SET,
        marker: str = autoboto.ShapeBase._NOT_SET,
        limit: int = autoboto.ShapeBase._NOT_SET,
        fields: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if query is not autoboto.ShapeBase._NOT_SET:
                _params['query'] = query
            if include is not autoboto.ShapeBase._NOT_SET:
                _params['include'] = include
            if order is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_document(
        ...
        *,
        document_id: str,
        authentication_token: str = autoboto.ShapeBase._NOT_SET,
        include_custom_metadata: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if authentication_token is not autoboto.ShapeBase._NOT_SET:
                _params['authentication_token'] = authentication_token
            if include_custom_metadata is not autoboto.ShapeBase._NOT_SET:
    ...
    def initiate_document_version_upload(
        ...
        *,
        parent_folder_id: str,
        authentication_token: str = autoboto.ShapeBase._NOT_SET,
        id: str = autoboto.ShapeBase._NOT_SET,
        name: str = autoboto.ShapeBase._NOT_SET,
        content_created_timestamp: datetime.datetime = autoboto.ShapeBase.
        _NOT_SET,
        content_modified_timestamp: datetime.datetime = autoboto.ShapeBase.
        _NOT_SET,
        content_type: str = autoboto.ShapeBase._NOT_SET,
        document_size_in_bytes: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if content_created_timestamp is not autoboto.ShapeBase._NOT_SET:
                _params['content_created_timestamp'] = content_created_timestamp
            if content_modified_timestamp is not autoboto.ShapeBase._NOT_SET:
            ...
            if document_size_in_bytes is not autoboto.ShapeBase._NOT_SET:
    ...
    def remove_resource_permission(
        ...
        *,
        ...
        principal_id: str,
        authentication_token: str = autoboto.ShapeBase._NOT_SET,
        principal_type: shapes.PrincipalType = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
    ...
    def update_document(
        ...
        *,
        ...
        authentication_token: str = autoboto.ShapeBase._NOT_SET,
        name: str = autoboto.ShapeBase._NOT_SET,
        parent_folder_id: str = autoboto.ShapeBase._NOT_SET,
        resource_state: shapes.ResourceStateType = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            ...
            if parent_folder_id is not autoboto.ShapeBase._NOT_SET:
                _params['parent_folder_id'] = parent_folder_id
            if resource_state is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_document_version(
        ...
        *,
        ...
        version_id: str,
        authentication_token: str = autoboto.ShapeBase._NOT_SET,
        version_status: shapes.DocumentVersionStatus = autoboto.ShapeBase.
        _NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            ...
            if authentication_token is not autoboto.ShapeBase._NOT_SET:
                _params['authentication_token'] = authentication_token
            if version_status is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_user(
        ...
        *,
        user_id: str,
        authentication_token: str = autoboto.ShapeBase._NOT_SET,
        given_name: str = autoboto.ShapeBase._NOT_SET,
        surname: str = autoboto.ShapeBase._NOT_SET,
        type: shapes.UserType = autoboto.ShapeBase._NOT_SET,
        storage_rule: shapes.StorageRuleType = autoboto.ShapeBase._NOT_SET,
        time_zone_id: str = autoboto.ShapeBase._NOT_SET,
        locale: shapes.LocaleType = autoboto.ShapeBase._NOT_SET,
        grant_poweruser_privileges: shapes.BooleanEnumType = autoboto.ShapeBase.
        _NOT_SET,
        ...
        if _request is None:
            ...
            if time_zone_id is not autoboto.ShapeBase._NOT_SET:
                _params['time_zone_id'] = time_zone_id
            if locale is not autoboto.ShapeBase._NOT_SET:
                _params['locale'] = locale
            if grant_poweruser_privileges is not autoboto.ShapeBase._NOT_SET:
