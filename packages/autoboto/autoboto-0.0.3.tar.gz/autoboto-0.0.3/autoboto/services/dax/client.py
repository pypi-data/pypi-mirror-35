...
class Client:
    ...
    def create_cluster(
        ...
        *,
        ...
        subnet_group_name: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if replication_factor is not autoboto.ShapeBase._NOT_SET:
                _params['replication_factor'] = replication_factor
            if iam_role_arn is not autoboto.ShapeBase._NOT_SET:
            ...
            if subnet_group_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def decrease_replication_factor(
        ...
        *,
        ...
        availability_zones: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        node_ids_to_remove: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if cluster_name is not autoboto.ShapeBase._NOT_SET:
                _params['cluster_name'] = cluster_name
            if new_replication_factor is not autoboto.ShapeBase._NOT_SET:
                _params['new_replication_factor'] = new_replication_factor
            if availability_zones is not autoboto.ShapeBase._NOT_SET:
                _params['availability_zones'] = availability_zones
            if node_ids_to_remove is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_clusters(
        ...
        *,
        cluster_names: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if cluster_names is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_events(
        ...
        *,
        source_name: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if source_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_parameter_groups(
        ...
        *,
        parameter_group_names: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if parameter_group_names is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_subnet_groups(
        ...
        *,
        subnet_group_names: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if subnet_group_names is not autoboto.ShapeBase._NOT_SET:
    ...
    def reboot_node(
        ...
        *,
        ...
        if _request is None:
            ...
            if cluster_name is not autoboto.ShapeBase._NOT_SET:
                _params['cluster_name'] = cluster_name
            if node_id is not autoboto.ShapeBase._NOT_SET:
