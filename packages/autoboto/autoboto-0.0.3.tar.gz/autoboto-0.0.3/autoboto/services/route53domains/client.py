...
class Client:
    ...
    def check_domain_availability(
        ...
        *,
        domain_name: str,
        idn_lang_code: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if idn_lang_code is not autoboto.ShapeBase._NOT_SET:
    ...
    def check_domain_transferability(
        ...
        *,
        domain_name: str,
        auth_code: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if domain_name is not autoboto.ShapeBase._NOT_SET:
                _params['domain_name'] = domain_name
            if auth_code is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_tags_for_domain(
        ...
        *,
        ...
        if _request is None:
            ...
            if domain_name is not autoboto.ShapeBase._NOT_SET:
                _params['domain_name'] = domain_name
            if tags_to_delete is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_contact_reachability_status(
        ...
        *,
        domain_name: str = autoboto.ShapeBase._NOT_SET,
    ...
    def get_domain_suggestions(
        ...
        *,
        ...
        if _request is None:
            ...
            if domain_name is not autoboto.ShapeBase._NOT_SET:
                _params['domain_name'] = domain_name
            if suggestion_count is not autoboto.ShapeBase._NOT_SET:
                _params['suggestion_count'] = suggestion_count
            if only_available is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_operations(
        ...
        *,
        submitted_since: datetime.datetime = autoboto.ShapeBase._NOT_SET,
        marker: str = autoboto.ShapeBase._NOT_SET,
        max_items: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if submitted_since is not autoboto.ShapeBase._NOT_SET:
    ...
    def register_domain(
        ...
        *,
        ...
        idn_lang_code: str = autoboto.ShapeBase._NOT_SET,
        auto_renew: bool = autoboto.ShapeBase._NOT_SET,
        privacy_protect_admin_contact: bool = autoboto.ShapeBase._NOT_SET,
        privacy_protect_registrant_contact: bool = autoboto.ShapeBase._NOT_SET,
        privacy_protect_tech_contact: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if domain_name is not autoboto.ShapeBase._NOT_SET:
                _params['domain_name'] = domain_name
            if duration_in_years is not autoboto.ShapeBase._NOT_SET:
                _params['duration_in_years'] = duration_in_years
            if admin_contact is not autoboto.ShapeBase._NOT_SET:
                _params['admin_contact'] = admin_contact
            if registrant_contact is not autoboto.ShapeBase._NOT_SET:
                _params['registrant_contact'] = registrant_contact
            if tech_contact is not autoboto.ShapeBase._NOT_SET:
                _params['tech_contact'] = tech_contact
            if idn_lang_code is not autoboto.ShapeBase._NOT_SET:
                _params['idn_lang_code'] = idn_lang_code
            if auto_renew is not autoboto.ShapeBase._NOT_SET:
                _params['auto_renew'] = auto_renew
            if privacy_protect_admin_contact is not autoboto.ShapeBase._NOT_SET:
                _params['privacy_protect_admin_contact'
                       ] = privacy_protect_admin_contact
            if privacy_protect_registrant_contact is not autoboto.ShapeBase._NOT_SET:
                _params['privacy_protect_registrant_contact'
                       ] = privacy_protect_registrant_contact
            if privacy_protect_tech_contact is not autoboto.ShapeBase._NOT_SET:
    ...
    def renew_domain(
        ...
        *,
        ...
        duration_in_years: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if domain_name is not autoboto.ShapeBase._NOT_SET:
                _params['domain_name'] = domain_name
            if current_expiry_year is not autoboto.ShapeBase._NOT_SET:
    ...
    def transfer_domain(
        ...
        *,
        ...
        if _request is None:
            ...
            if idn_lang_code is not autoboto.ShapeBase._NOT_SET:
                _params['idn_lang_code'] = idn_lang_code
            if nameservers is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_domain_contact(
        ...
        *,
        domain_name: str,
        admin_contact: shapes.ContactDetail = autoboto.ShapeBase._NOT_SET,
        registrant_contact: shapes.ContactDetail = autoboto.ShapeBase._NOT_SET,
        tech_contact: shapes.ContactDetail = autoboto.ShapeBase._NOT_SET,
    ...
    def update_domain_contact_privacy(
        ...
        *,
        domain_name: str,
        admin_privacy: bool = autoboto.ShapeBase._NOT_SET,
        registrant_privacy: bool = autoboto.ShapeBase._NOT_SET,
        tech_privacy: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if domain_name is not autoboto.ShapeBase._NOT_SET:
                _params['domain_name'] = domain_name
            if admin_privacy is not autoboto.ShapeBase._NOT_SET:
                _params['admin_privacy'] = admin_privacy
            if registrant_privacy is not autoboto.ShapeBase._NOT_SET:
                _params['registrant_privacy'] = registrant_privacy
            if tech_privacy is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_domain_nameservers(
        ...
        *,
        domain_name: str,
        nameservers: typing.List[shapes.Nameserver],
        fi_auth_key: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if nameservers is not autoboto.ShapeBase._NOT_SET:
                _params['nameservers'] = nameservers
            if fi_auth_key is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_tags_for_domain(
        ...
        *,
        domain_name: str,
        tags_to_update: typing.List[shapes.Tag] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if domain_name is not autoboto.ShapeBase._NOT_SET:
                _params['domain_name'] = domain_name
            if tags_to_update is not autoboto.ShapeBase._NOT_SET:
    ...
    def view_billing(
        ...
        *,
        start: datetime.datetime = autoboto.ShapeBase._NOT_SET,
        end: datetime.datetime = autoboto.ShapeBase._NOT_SET,
        marker: str = autoboto.ShapeBase._NOT_SET,
        max_items: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if start is not autoboto.ShapeBase._NOT_SET:
                _params['start'] = start
            if end is not autoboto.ShapeBase._NOT_SET:
                _params['end'] = end
            if marker is not autoboto.ShapeBase._NOT_SET:
                _params['marker'] = marker
            if max_items is not autoboto.ShapeBase._NOT_SET:
