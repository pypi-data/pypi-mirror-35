...
class Client:
    ...
    def create_service(
        ...
        *,
        ...
        creator_request_id: str = autoboto.ShapeBase._NOT_SET,
        description: str = autoboto.ShapeBase._NOT_SET,
        health_check_config: shapes.HealthCheckConfig = autoboto.ShapeBase.
        _NOT_SET,
        health_check_custom_config: shapes.HealthCheckCustomConfig = autoboto.
        ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if dns_config is not autoboto.ShapeBase._NOT_SET:
            ...
            if health_check_custom_config is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_instances_health_status(
        ...
        *,
        service_id: str,
        instances: typing.List[str] = autoboto.ShapeBase._NOT_SET,
    ...
    def list_namespaces(
        ...
        *,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.NamespaceFilter
    ...
    def list_operations(
        ...
        *,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.OperationFilter
                            ] = autoboto.ShapeBase._NOT_SET,
    ...
    def list_services(
        ...
        *,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        filters: typing.List[shapes.ServiceFilter
                            ] = autoboto.ShapeBase._NOT_SET,
