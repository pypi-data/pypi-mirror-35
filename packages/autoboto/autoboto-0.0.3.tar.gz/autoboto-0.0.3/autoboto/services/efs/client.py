...
class Client:
    ...
    def create_file_system(
        ...
        *,
        creation_token: str,
        performance_mode: shapes.PerformanceMode = autoboto.ShapeBase._NOT_SET,
        encrypted: bool = autoboto.ShapeBase._NOT_SET,
        kms_key_id: str = autoboto.ShapeBase._NOT_SET,
        throughput_mode: shapes.ThroughputMode = autoboto.ShapeBase._NOT_SET,
        provisioned_throughput_in_mibps: float = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if creation_token is not autoboto.ShapeBase._NOT_SET:
                _params['creation_token'] = creation_token
            if performance_mode is not autoboto.ShapeBase._NOT_SET:
            ...
            if throughput_mode is not autoboto.ShapeBase._NOT_SET:
                _params['throughput_mode'] = throughput_mode
            if provisioned_throughput_in_mibps is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_mount_target(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if file_system_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_mount_target(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if mount_target_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_file_systems(
        ...
        *,
        ...
        creation_token: str = autoboto.ShapeBase._NOT_SET,
        file_system_id: str = autoboto.ShapeBase._NOT_SET,
    ...
    def describe_mount_targets(
        ...
        *,
        ...
        marker: str = autoboto.ShapeBase._NOT_SET,
        file_system_id: str = autoboto.ShapeBase._NOT_SET,
        mount_target_id: str = autoboto.ShapeBase._NOT_SET,
