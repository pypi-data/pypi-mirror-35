...
class Client:
    ...
    def compare_faces(
        ...
        *,
        ...
        similarity_threshold: float = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if source_image is not autoboto.ShapeBase._NOT_SET:
                _params['source_image'] = source_image
            if target_image is not autoboto.ShapeBase._NOT_SET:
                _params['target_image'] = target_image
            if similarity_threshold is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_collection(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if collection_id is not autoboto.ShapeBase._NOT_SET:
        ...
        *,
        ...
        if _request is None:
            ...
            if input is not autoboto.ShapeBase._NOT_SET:
                _params['input'] = input
            if output is not autoboto.ShapeBase._NOT_SET:
                _params['output'] = output
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if settings is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_faces(
        ...
        *,
        ...
        if _request is None:
            ...
            if collection_id is not autoboto.ShapeBase._NOT_SET:
                _params['collection_id'] = collection_id
            if face_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def detect_labels(
        ...
        *,
        image: shapes.Image,
        max_labels: int = autoboto.ShapeBase._NOT_SET,
        min_confidence: float = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if image is not autoboto.ShapeBase._NOT_SET:
                _params['image'] = image
            if max_labels is not autoboto.ShapeBase._NOT_SET:
                _params['max_labels'] = max_labels
            if min_confidence is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_celebrity_recognition(
        ...
        *,
        ...
        sort_by: shapes.CelebrityRecognitionSortBy = autoboto.ShapeBase.
        _NOT_SET,
    ...
    def get_content_moderation(
        ...
        *,
        ...
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        sort_by: shapes.ContentModerationSortBy = autoboto.ShapeBase._NOT_SET,
    ...
    def get_face_search(
        ...
        *,
        ...
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        sort_by: shapes.FaceSearchSortBy = autoboto.ShapeBase._NOT_SET,
    ...
    def get_label_detection(
        ...
        *,
        ...
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        sort_by: shapes.LabelDetectionSortBy = autoboto.ShapeBase._NOT_SET,
    ...
    def get_person_tracking(
        ...
        *,
        ...
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        sort_by: shapes.PersonTrackingSortBy = autoboto.ShapeBase._NOT_SET,
    ...
    def index_faces(
        ...
        *,
        collection_id: str,
        image: shapes.Image,
        external_image_id: str = autoboto.ShapeBase._NOT_SET,
        detection_attributes: typing.List[shapes.Attribute
        ...
        of the model you are using, check the the value of `FaceModelVersion` in the
        ...
        if _request is None:
            ...
            if image is not autoboto.ShapeBase._NOT_SET:
                _params['image'] = image
            if external_image_id is not autoboto.ShapeBase._NOT_SET:
                _params['external_image_id'] = external_image_id
            if detection_attributes is not autoboto.ShapeBase._NOT_SET:
    ...
    def search_faces(
        ...
        *,
        collection_id: str,
        face_id: str,
        max_faces: int = autoboto.ShapeBase._NOT_SET,
        face_match_threshold: float = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if collection_id is not autoboto.ShapeBase._NOT_SET:
                _params['collection_id'] = collection_id
            if face_id is not autoboto.ShapeBase._NOT_SET:
                _params['face_id'] = face_id
            if max_faces is not autoboto.ShapeBase._NOT_SET:
                _params['max_faces'] = max_faces
            if face_match_threshold is not autoboto.ShapeBase._NOT_SET:
    ...
    def start_celebrity_recognition(
        ...
        *,
        ...
        notification_channel: shapes.NotificationChannel = autoboto.ShapeBase.
        _NOT_SET,
        enable_person_tracking: bool = autoboto.ShapeBase._NOT_SET,
        job_tag: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if video is not autoboto.ShapeBase._NOT_SET:
                _params['video'] = video
            if client_request_token is not autoboto.ShapeBase._NOT_SET:
                _params['client_request_token'] = client_request_token
            if notification_channel is not autoboto.ShapeBase._NOT_SET:
                _params['notification_channel'] = notification_channel
            if enable_person_tracking is not autoboto.ShapeBase._NOT_SET:
                _params['enable_person_tracking'] = enable_person_tracking
            if job_tag is not autoboto.ShapeBase._NOT_SET:
    ...
    def start_face_detection(
        ...
        *,
        ...
        notification_channel: shapes.NotificationChannel = autoboto.ShapeBase.
        _NOT_SET,
        face_attributes: shapes.FaceAttributes = autoboto.ShapeBase._NOT_SET,
        job_tag: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if notification_channel is not autoboto.ShapeBase._NOT_SET:
                _params['notification_channel'] = notification_channel
            if face_attributes is not autoboto.ShapeBase._NOT_SET:
