...
class Client:
    ...
    def describe_voices(
        ...
        *,
        language_code: shapes.LanguageCode = autoboto.ShapeBase._NOT_SET,
        include_additional_language_codes: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if language_code is not autoboto.ShapeBase._NOT_SET:
                _params['language_code'] = language_code
            if include_additional_language_codes is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_speech_synthesis_tasks(
        ...
        *,
        ...
        next_token: str = autoboto.ShapeBase._NOT_SET,
        status: shapes.TaskStatus = autoboto.ShapeBase._NOT_SET,
    ...
    def start_speech_synthesis_task(
        ...
        *,
        ...
        lexicon_names: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        output_s3_key_prefix: str = autoboto.ShapeBase._NOT_SET,
        sample_rate: str = autoboto.ShapeBase._NOT_SET,
        ...
        text_type: shapes.TextType = autoboto.ShapeBase._NOT_SET,
        language_code: shapes.LanguageCode = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if output_format is not autoboto.ShapeBase._NOT_SET:
            ...
            if lexicon_names is not autoboto.ShapeBase._NOT_SET:
