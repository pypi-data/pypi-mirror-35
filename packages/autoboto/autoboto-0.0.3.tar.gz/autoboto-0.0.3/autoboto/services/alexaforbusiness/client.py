...
class Client:
    ...
    def associate_contact_with_address_book(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if contact_arn is not autoboto.ShapeBase._NOT_SET:
                _params['contact_arn'] = contact_arn
            if address_book_arn is not autoboto.ShapeBase._NOT_SET:
    ...
    def associate_device_with_room(
        ...
        *,
        device_arn: str = autoboto.ShapeBase._NOT_SET,
        room_arn: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if room_arn is not autoboto.ShapeBase._NOT_SET:
    ...
    def associate_skill_group_with_room(
        ...
        *,
        skill_group_arn: str = autoboto.ShapeBase._NOT_SET,
        room_arn: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if skill_group_arn is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_contact(
        ...
        *,
        ...
        last_name: str = autoboto.ShapeBase._NOT_SET,
        client_request_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if first_name is not autoboto.ShapeBase._NOT_SET:
                _params['first_name'] = first_name
            if phone_number is not autoboto.ShapeBase._NOT_SET:
                _params['phone_number'] = phone_number
            if display_name is not autoboto.ShapeBase._NOT_SET:
                _params['display_name'] = display_name
            if last_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_profile(
        ...
        *,
        ...
        client_request_token: str = autoboto.ShapeBase._NOT_SET,
        setup_mode_disabled: bool = autoboto.ShapeBase._NOT_SET,
        max_volume_limit: int = autoboto.ShapeBase._NOT_SET,
        pstn_enabled: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if profile_name is not autoboto.ShapeBase._NOT_SET:
            ...
            if distance_unit is not autoboto.ShapeBase._NOT_SET:
                _params['distance_unit'] = distance_unit
            if temperature_unit is not autoboto.ShapeBase._NOT_SET:
                _params['temperature_unit'] = temperature_unit
            if wake_word is not autoboto.ShapeBase._NOT_SET:
                _params['wake_word'] = wake_word
            if client_request_token is not autoboto.ShapeBase._NOT_SET:
                _params['client_request_token'] = client_request_token
            if setup_mode_disabled is not autoboto.ShapeBase._NOT_SET:
                _params['setup_mode_disabled'] = setup_mode_disabled
            if max_volume_limit is not autoboto.ShapeBase._NOT_SET:
                _params['max_volume_limit'] = max_volume_limit
            if pstn_enabled is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_room(
        ...
        *,
        ...
        provider_calendar_id: str = autoboto.ShapeBase._NOT_SET,
        client_request_token: str = autoboto.ShapeBase._NOT_SET,
    ...
    def create_skill_group(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if skill_group_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_user(
        ...
        *,
        user_id: str,
        first_name: str = autoboto.ShapeBase._NOT_SET,
        last_name: str = autoboto.ShapeBase._NOT_SET,
        email: str = autoboto.ShapeBase._NOT_SET,
        client_request_token: str = autoboto.ShapeBase._NOT_SET,
        tags: typing.List[shapes.Tag] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if last_name is not autoboto.ShapeBase._NOT_SET:
                _params['last_name'] = last_name
            if email is not autoboto.ShapeBase._NOT_SET:
                _params['email'] = email
            if client_request_token is not autoboto.ShapeBase._NOT_SET:
                _params['client_request_token'] = client_request_token
            if tags is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_room_skill_parameter(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if skill_id is not autoboto.ShapeBase._NOT_SET:
                _params['skill_id'] = skill_id
            if parameter_key is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_user(
        ...
        *,
        enrollment_id: str,
        user_arn: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if enrollment_id is not autoboto.ShapeBase._NOT_SET:
                _params['enrollment_id'] = enrollment_id
            if user_arn is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_device_events(
        ...
        *,
        device_arn: str,
        event_type: shapes.DeviceEventType = autoboto.ShapeBase._NOT_SET,
    ...
    def put_room_skill_parameter(
        ...
        *,
        ...
        if _request is None:
            ...
            if skill_id is not autoboto.ShapeBase._NOT_SET:
                _params['skill_id'] = skill_id
            if room_skill_parameter is not autoboto.ShapeBase._NOT_SET:
    ...
    def revoke_invitation(
        ...
        *,
        user_arn: str = autoboto.ShapeBase._NOT_SET,
        enrollment_id: str = autoboto.ShapeBase._NOT_SET,
    ...
    def search_address_books(
        ...
        *,
        ...
        sort_criteria: typing.List[shapes.Sort] = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if sort_criteria is not autoboto.ShapeBase._NOT_SET:
    ...
    def start_device_sync(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if features is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_contact(
        ...
        *,
        ...
        first_name: str = autoboto.ShapeBase._NOT_SET,
        last_name: str = autoboto.ShapeBase._NOT_SET,
        phone_number: str = autoboto.ShapeBase._NOT_SET,
    ...
    def update_profile(
        ...
        *,
        profile_arn: str = autoboto.ShapeBase._NOT_SET,
        profile_name: str = autoboto.ShapeBase._NOT_SET,
        timezone: str = autoboto.ShapeBase._NOT_SET,
        address: str = autoboto.ShapeBase._NOT_SET,
        distance_unit: shapes.DistanceUnit = autoboto.ShapeBase._NOT_SET,
        temperature_unit: shapes.TemperatureUnit = autoboto.ShapeBase._NOT_SET,
        wake_word: shapes.WakeWord = autoboto.ShapeBase._NOT_SET,
        setup_mode_disabled: bool = autoboto.ShapeBase._NOT_SET,
        max_volume_limit: int = autoboto.ShapeBase._NOT_SET,
        pstn_enabled: bool = autoboto.ShapeBase._NOT_SET,
    ...
    def update_room(
        ...
        *,
        room_arn: str = autoboto.ShapeBase._NOT_SET,
        room_name: str = autoboto.ShapeBase._NOT_SET,
        description: str = autoboto.ShapeBase._NOT_SET,
        provider_calendar_id: str = autoboto.ShapeBase._NOT_SET,
        profile_arn: str = autoboto.ShapeBase._NOT_SET,
    ...
    def update_skill_group(
        ...
        *,
        skill_group_arn: str = autoboto.ShapeBase._NOT_SET,
        skill_group_name: str = autoboto.ShapeBase._NOT_SET,
        description: str = autoboto.ShapeBase._NOT_SET,
