...
class ComputeType(autoboto.ShapeBase):
    ...
    # The compute type.
    name: "Compute" = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class CreateIpGroupRequest(autoboto.ShapeBase):
    ...
    group_desc: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class DefaultWorkspaceCreationProperties(autoboto.ShapeBase):
    ...
    # accounts.
    default_ou: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class FailedWorkspaceChangeRequest(autoboto.ShapeBase):
    ...
    workspace_id: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class IpRuleItem(autoboto.ShapeBase):
    ...
    ip_rule: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # The description.
    rule_desc: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class RootStorage(autoboto.ShapeBase):
    ...
    capacity: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class WorkspaceDirectory(autoboto.ShapeBase):
    ...
    # behalf.
    iam_role_id: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
