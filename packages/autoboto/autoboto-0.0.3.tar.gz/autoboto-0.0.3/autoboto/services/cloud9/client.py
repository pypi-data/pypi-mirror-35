...
class Client:
    ...
    def create_environment_ec2(
        ...
        *,
        ...
        automatic_stop_time_minutes: int = autoboto.ShapeBase._NOT_SET,
        owner_arn: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if automatic_stop_time_minutes is not autoboto.ShapeBase._NOT_SET:
                _params['automatic_stop_time_minutes'
                       ] = automatic_stop_time_minutes
            if owner_arn is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_environment_membership(
        ...
        *,
        ...
        if _request is None:
            ...
            if permissions is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_environment_memberships(
        ...
        *,
        ...
        permissions: typing.List[shapes.Permissions
