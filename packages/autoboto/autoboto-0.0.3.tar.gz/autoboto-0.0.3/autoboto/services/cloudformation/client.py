...
class Client:
    ...
    def cancel_update_stack(
        ...
        *,
        stack_name: str,
        client_request_token: str = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            _params = {}
            if stack_name is not autoboto.ShapeBase._NOT_SET:
                _params['stack_name'] = stack_name
            if client_request_token is not autoboto.ShapeBase._NOT_SET:
    ...
    def continue_update_rollback(
        ...
        *,
        ...
        resources_to_skip: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        client_request_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if resources_to_skip is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_change_set(
        ...
        *,
        stack_name: str,
        change_set_name: str,
        template_body: str = autoboto.ShapeBase._NOT_SET,
        template_url: str = autoboto.ShapeBase._NOT_SET,
        use_previous_template: bool = autoboto.ShapeBase._NOT_SET,
        parameters: typing.List[shapes.Parameter] = autoboto.ShapeBase._NOT_SET,
        capabilities: typing.List[shapes.Capability
                                 ] = autoboto.ShapeBase._NOT_SET,
        resource_types: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        role_arn: str = autoboto.ShapeBase._NOT_SET,
        rollback_configuration: shapes.RollbackConfiguration = autoboto.
        ShapeBase._NOT_SET,
        ...
        change_set_type: shapes.ChangeSetType = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if stack_name is not autoboto.ShapeBase._NOT_SET:
                _params['stack_name'] = stack_name
            if change_set_name is not autoboto.ShapeBase._NOT_SET:
            ...
            if template_url is not autoboto.ShapeBase._NOT_SET:
                _params['template_url'] = template_url
            if use_previous_template is not autoboto.ShapeBase._NOT_SET:
            ...
            if capabilities is not autoboto.ShapeBase._NOT_SET:
            ...
            if role_arn is not autoboto.ShapeBase._NOT_SET:
                _params['role_arn'] = role_arn
            if rollback_configuration is not autoboto.ShapeBase._NOT_SET:
            ...
            if change_set_type is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_stack(
        ...
        *,
        ...
        template_url: str = autoboto.ShapeBase._NOT_SET,
        parameters: typing.List[shapes.Parameter] = autoboto.ShapeBase._NOT_SET,
        disable_rollback: bool = autoboto.ShapeBase._NOT_SET,
        rollback_configuration: shapes.RollbackConfiguration = autoboto.
        ShapeBase._NOT_SET,
        timeout_in_minutes: int = autoboto.ShapeBase._NOT_SET,
        notification_arns: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        capabilities: typing.List[shapes.Capability
                                 ] = autoboto.ShapeBase._NOT_SET,
        resource_types: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        role_arn: str = autoboto.ShapeBase._NOT_SET,
        on_failure: shapes.OnFailure = autoboto.ShapeBase._NOT_SET,
        stack_policy_body: str = autoboto.ShapeBase._NOT_SET,
        stack_policy_url: str = autoboto.ShapeBase._NOT_SET,
        tags: typing.List[shapes.Tag] = autoboto.ShapeBase._NOT_SET,
        client_request_token: str = autoboto.ShapeBase._NOT_SET,
        enable_termination_protection: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if parameters is not autoboto.ShapeBase._NOT_SET:
                _params['parameters'] = parameters
            if disable_rollback is not autoboto.ShapeBase._NOT_SET:
                _params['disable_rollback'] = disable_rollback
            if rollback_configuration is not autoboto.ShapeBase._NOT_SET:
                _params['rollback_configuration'] = rollback_configuration
            if timeout_in_minutes is not autoboto.ShapeBase._NOT_SET:
            ...
            if role_arn is not autoboto.ShapeBase._NOT_SET:
                _params['role_arn'] = role_arn
            if on_failure is not autoboto.ShapeBase._NOT_SET:
                _params['on_failure'] = on_failure
            if stack_policy_body is not autoboto.ShapeBase._NOT_SET:
                _params['stack_policy_body'] = stack_policy_body
            if stack_policy_url is not autoboto.ShapeBase._NOT_SET:
                _params['stack_policy_url'] = stack_policy_url
            if tags is not autoboto.ShapeBase._NOT_SET:
                _params['tags'] = tags
            if client_request_token is not autoboto.ShapeBase._NOT_SET:
                _params['client_request_token'] = client_request_token
            if enable_termination_protection is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_stack_instances(
        ...
        *,
        ...
        parameter_overrides: typing.List[shapes.Parameter
                                        ] = autoboto.ShapeBase._NOT_SET,
        operation_preferences: shapes.StackSetOperationPreferences = autoboto.
        ShapeBase._NOT_SET,
        operation_id: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if stack_set_name is not autoboto.ShapeBase._NOT_SET:
                _params['stack_set_name'] = stack_set_name
            if accounts is not autoboto.ShapeBase._NOT_SET:
                _params['accounts'] = accounts
            if regions is not autoboto.ShapeBase._NOT_SET:
                _params['regions'] = regions
            if parameter_overrides is not autoboto.ShapeBase._NOT_SET:
                _params['parameter_overrides'] = parameter_overrides
            if operation_preferences is not autoboto.ShapeBase._NOT_SET:
                _params['operation_preferences'] = operation_preferences
            if operation_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_stack_set(
        ...
        *,
        ...
        tags: typing.List[shapes.Tag] = autoboto.ShapeBase._NOT_SET,
        administration_role_arn: str = autoboto.ShapeBase._NOT_SET,
        execution_role_name: str = autoboto.ShapeBase._NOT_SET,
        client_request_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if tags is not autoboto.ShapeBase._NOT_SET:
                _params['tags'] = tags
            if administration_role_arn is not autoboto.ShapeBase._NOT_SET:
                _params['administration_role_arn'] = administration_role_arn
            if execution_role_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_change_set(
        ...
        *,
        change_set_name: str,
        stack_name: str = autoboto.ShapeBase._NOT_SET,
    ...
    def delete_stack(
        ...
        *,
        stack_name: str,
        retain_resources: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        role_arn: str = autoboto.ShapeBase._NOT_SET,
        client_request_token: str = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            ...
            if stack_name is not autoboto.ShapeBase._NOT_SET:
                _params['stack_name'] = stack_name
            if retain_resources is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_stack_instances(
        ...
        *,
        ...
        if _request is None:
            ...
            if regions is not autoboto.ShapeBase._NOT_SET:
                _params['regions'] = regions
            if retain_stacks is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_stack_instance(
        ...
        *,
        ...
        if _request is None:
            ...
            if stack_set_name is not autoboto.ShapeBase._NOT_SET:
                _params['stack_set_name'] = stack_set_name
            if stack_instance_account is not autoboto.ShapeBase._NOT_SET:
                _params['stack_instance_account'] = stack_instance_account
            if stack_instance_region is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_stack_resource(
        ...
        *,
        ...
        if _request is None:
            ...
            if stack_name is not autoboto.ShapeBase._NOT_SET:
                _params['stack_name'] = stack_name
            if logical_resource_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_stack_resources(
        ...
        *,
        stack_name: str = autoboto.ShapeBase._NOT_SET,
        logical_resource_id: str = autoboto.ShapeBase._NOT_SET,
        physical_resource_id: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if logical_resource_id is not autoboto.ShapeBase._NOT_SET:
                _params['logical_resource_id'] = logical_resource_id
            if physical_resource_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_template(
        ...
        *,
        stack_name: str = autoboto.ShapeBase._NOT_SET,
        change_set_name: str = autoboto.ShapeBase._NOT_SET,
        template_stage: shapes.TemplateStage = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if change_set_name is not autoboto.ShapeBase._NOT_SET:
                _params['change_set_name'] = change_set_name
            if template_stage is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_template_summary(
        ...
        *,
        ...
        template_url: str = autoboto.ShapeBase._NOT_SET,
        stack_name: str = autoboto.ShapeBase._NOT_SET,
        stack_set_name: str = autoboto.ShapeBase._NOT_SET,
    ...
    def list_imports(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if export_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_stack_instances(
        ...
        *,
        ...
        stack_instance_account: str = autoboto.ShapeBase._NOT_SET,
        stack_instance_region: str = autoboto.ShapeBase._NOT_SET,
    ...
    def list_stack_sets(
        ...
        *,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        status: shapes.StackSetStatus = autoboto.ShapeBase._NOT_SET,
    ...
    def list_stacks(
        ...
        *,
        ...
        if _request is None:
            ...
            if next_token is not autoboto.ShapeBase._NOT_SET:
                _params['next_token'] = next_token
            if stack_status_filter is not autoboto.ShapeBase._NOT_SET:
    ...
    def signal_resource(
        ...
        *,
        ...
        if _request is None:
            ...
            if logical_resource_id is not autoboto.ShapeBase._NOT_SET:
                _params['logical_resource_id'] = logical_resource_id
            if unique_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_stack(
        ...
        *,
        ...
        template_url: str = autoboto.ShapeBase._NOT_SET,
        use_previous_template: bool = autoboto.ShapeBase._NOT_SET,
        stack_policy_during_update_body: str = autoboto.ShapeBase._NOT_SET,
        stack_policy_during_update_url: str = autoboto.ShapeBase._NOT_SET,
        parameters: typing.List[shapes.Parameter] = autoboto.ShapeBase._NOT_SET,
        capabilities: typing.List[shapes.Capability
                                 ] = autoboto.ShapeBase._NOT_SET,
        resource_types: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if use_previous_template is not autoboto.ShapeBase._NOT_SET:
                _params['use_previous_template'] = use_previous_template
            if stack_policy_during_update_body is not autoboto.ShapeBase._NOT_SET:
                _params['stack_policy_during_update_body'
                       ] = stack_policy_during_update_body
            if stack_policy_during_update_url is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_stack_set(
        ...
        *,
        ...
        execution_role_name: str = autoboto.ShapeBase._NOT_SET,
        operation_id: str = autoboto.ShapeBase._NOT_SET,
        accounts: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        regions: typing.List[str] = autoboto.ShapeBase._NOT_SET,
