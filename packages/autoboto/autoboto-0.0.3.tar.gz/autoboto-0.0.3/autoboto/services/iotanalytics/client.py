...
class Client:
    ...
    def batch_put_message(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if channel_name is not autoboto.ShapeBase._NOT_SET:
                _params['channel_name'] = channel_name
            if messages is not autoboto.ShapeBase._NOT_SET:
    ...
    def cancel_pipeline_reprocessing(
        ...
        *,
        ...
        if _request is None:
            ...
            if reprocessing_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_channel(
        ...
        *,
        channel_name: str,
        retention_period: shapes.RetentionPeriod = autoboto.ShapeBase._NOT_SET,
    ...
    def create_dataset(
        ...
        *,
        ...
        triggers: typing.List[shapes.DatasetTrigger
        ...
        if _request is None:
            _params = {}
            if dataset_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_datastore(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if datastore_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_pipeline(
        ...
        *,
        ...
        if _request is None:
            ...
            if pipeline_name is not autoboto.ShapeBase._NOT_SET:
                _params['pipeline_name'] = pipeline_name
            if pipeline_activities is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_channel(
        ...
        *,
        channel_name: str,
        include_statistics: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if channel_name is not autoboto.ShapeBase._NOT_SET:
                _params['channel_name'] = channel_name
            if include_statistics is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_logging_options(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if logging_options is not autoboto.ShapeBase._NOT_SET:
    ...
    def run_pipeline_activity(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if pipeline_activity is not autoboto.ShapeBase._NOT_SET:
                _params['pipeline_activity'] = pipeline_activity
            if payloads is not autoboto.ShapeBase._NOT_SET:
    ...
    def sample_channel_data(
        ...
        *,
        channel_name: str,
        max_messages: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if channel_name is not autoboto.ShapeBase._NOT_SET:
                _params['channel_name'] = channel_name
            if max_messages is not autoboto.ShapeBase._NOT_SET:
