...
class Client:
    ...
    def abort_environment_update(
        ...
        *,
        environment_id: str = autoboto.ShapeBase._NOT_SET,
        environment_name: str = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            _params = {}
            if environment_id is not autoboto.ShapeBase._NOT_SET:
                _params['environment_id'] = environment_id
            if environment_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def apply_environment_managed_action(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if action_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def check_dns_availability(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if cname_prefix is not autoboto.ShapeBase._NOT_SET:
    ...
    def compose_environments(
        ...
        *,
        ...
        version_labels: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if version_labels is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_application(
        ...
        *,
        ...
        ApplicationResourceLifecycleConfig = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if resource_lifecycle_config is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_application_version(
        ...
        *,
        ...
        ShapeBase._NOT_SET,
        source_bundle: shapes.S3Location = autoboto.ShapeBase._NOT_SET,
        build_configuration: shapes.BuildConfiguration = autoboto.ShapeBase.
        _NOT_SET,
        auto_create_application: bool = autoboto.ShapeBase._NOT_SET,
        process: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if application_name is not autoboto.ShapeBase._NOT_SET:
                _params['application_name'] = application_name
            if version_label is not autoboto.ShapeBase._NOT_SET:
                _params['version_label'] = version_label
            if description is not autoboto.ShapeBase._NOT_SET:
                _params['description'] = description
            if source_build_information is not autoboto.ShapeBase._NOT_SET:
                _params['source_build_information'] = source_build_information
            if source_bundle is not autoboto.ShapeBase._NOT_SET:
                _params['source_bundle'] = source_bundle
            if build_configuration is not autoboto.ShapeBase._NOT_SET:
                _params['build_configuration'] = build_configuration
            if auto_create_application is not autoboto.ShapeBase._NOT_SET:
                _params['auto_create_application'] = auto_create_application
            if process is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_configuration_template(
        ...
        *,
        application_name: str,
        template_name: str,
        solution_stack_name: str = autoboto.ShapeBase._NOT_SET,
        platform_arn: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if application_name is not autoboto.ShapeBase._NOT_SET:
                _params['application_name'] = application_name
            if template_name is not autoboto.ShapeBase._NOT_SET:
                _params['template_name'] = template_name
            if solution_stack_name is not autoboto.ShapeBase._NOT_SET:
                _params['solution_stack_name'] = solution_stack_name
            if platform_arn is not autoboto.ShapeBase._NOT_SET:
                _params['platform_arn'] = platform_arn
            if source_configuration is not autoboto.ShapeBase._NOT_SET:
                _params['source_configuration'] = source_configuration
            if environment_id is not autoboto.ShapeBase._NOT_SET:
                _params['environment_id'] = environment_id
            if description is not autoboto.ShapeBase._NOT_SET:
                _params['description'] = description
            if option_settings is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_environment(
        ...
        *,
        ...
        group_name: str = autoboto.ShapeBase._NOT_SET,
        description: str = autoboto.ShapeBase._NOT_SET,
        cname_prefix: str = autoboto.ShapeBase._NOT_SET,
        tier: shapes.EnvironmentTier = autoboto.ShapeBase._NOT_SET,
        tags: typing.List[shapes.Tag] = autoboto.ShapeBase._NOT_SET,
        version_label: str = autoboto.ShapeBase._NOT_SET,
        template_name: str = autoboto.ShapeBase._NOT_SET,
        solution_stack_name: str = autoboto.ShapeBase._NOT_SET,
        platform_arn: str = autoboto.ShapeBase._NOT_SET,
        option_settings: typing.List[shapes.ConfigurationOptionSetting
                                    ] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if cname_prefix is not autoboto.ShapeBase._NOT_SET:
                _params['cname_prefix'] = cname_prefix
            if tier is not autoboto.ShapeBase._NOT_SET:
                _params['tier'] = tier
    ...
    def create_platform_version(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if platform_name is not autoboto.ShapeBase._NOT_SET:
            ...
            if platform_definition_bundle is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_application(
        ...
        *,
        application_name: str,
        terminate_env_by_force: bool = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            ...
            if application_name is not autoboto.ShapeBase._NOT_SET:
                _params['application_name'] = application_name
            if terminate_env_by_force is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_application_version(
        ...
        *,
        application_name: str,
        version_label: str,
        delete_source_bundle: bool = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            ...
            if version_label is not autoboto.ShapeBase._NOT_SET:
                _params['version_label'] = version_label
            if delete_source_bundle is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_applications(
        ...
        *,
        application_names: typing.List[str] = autoboto.ShapeBase._NOT_SET,
    ...
    def describe_environment_managed_actions(
        ...
        *,
        environment_name: str = autoboto.ShapeBase._NOT_SET,
        environment_id: str = autoboto.ShapeBase._NOT_SET,
        status: shapes.ActionStatus = autoboto.ShapeBase._NOT_SET,
    ...
    def describe_environments(
        ...
        *,
        application_name: str = autoboto.ShapeBase._NOT_SET,
        version_label: str = autoboto.ShapeBase._NOT_SET,
        environment_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        environment_names: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        include_deleted: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if version_label is not autoboto.ShapeBase._NOT_SET:
                _params['version_label'] = version_label
            if environment_ids is not autoboto.ShapeBase._NOT_SET:
                _params['environment_ids'] = environment_ids
            if environment_names is not autoboto.ShapeBase._NOT_SET:
                _params['environment_names'] = environment_names
            if include_deleted is not autoboto.ShapeBase._NOT_SET:
                _params['include_deleted'] = include_deleted
            if included_deleted_back_to is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_events(
        ...
        *,
        ...
        environment_name: str = autoboto.ShapeBase._NOT_SET,
        platform_arn: str = autoboto.ShapeBase._NOT_SET,
        request_id: str = autoboto.ShapeBase._NOT_SET,
        severity: shapes.EventSeverity = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if platform_arn is not autoboto.ShapeBase._NOT_SET:
                _params['platform_arn'] = platform_arn
            if request_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def request_environment_info(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if info_type is not autoboto.ShapeBase._NOT_SET:
    ...
    def swap_environment_cnames(
        ...
        *,
        source_environment_id: str = autoboto.ShapeBase._NOT_SET,
        source_environment_name: str = autoboto.ShapeBase._NOT_SET,
        destination_environment_id: str = autoboto.ShapeBase._NOT_SET,
        destination_environment_name: str = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            _params = {}
            if source_environment_id is not autoboto.ShapeBase._NOT_SET:
                _params['source_environment_id'] = source_environment_id
            if source_environment_name is not autoboto.ShapeBase._NOT_SET:
                _params['source_environment_name'] = source_environment_name
            if destination_environment_id is not autoboto.ShapeBase._NOT_SET:
                _params['destination_environment_id'
                       ] = destination_environment_id
            if destination_environment_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def terminate_environment(
        ...
        *,
        environment_id: str = autoboto.ShapeBase._NOT_SET,
        environment_name: str = autoboto.ShapeBase._NOT_SET,
        terminate_resources: bool = autoboto.ShapeBase._NOT_SET,
        force_terminate: bool = autoboto.ShapeBase._NOT_SET,
    ) -> shapes.EnvironmentDescription:
        """
        ...
        if _request is None:
            ...
            if environment_name is not autoboto.ShapeBase._NOT_SET:
                _params['environment_name'] = environment_name
            if terminate_resources is not autoboto.ShapeBase._NOT_SET:
                _params['terminate_resources'] = terminate_resources
            if force_terminate is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_tags_for_resource(
        ...
        *,
        resource_arn: str,
        tags_to_add: typing.List[shapes.Tag] = autoboto.ShapeBase._NOT_SET,
        tags_to_remove: typing.List[str] = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            ...
            if resource_arn is not autoboto.ShapeBase._NOT_SET:
                _params['resource_arn'] = resource_arn
            if tags_to_add is not autoboto.ShapeBase._NOT_SET:
                _params['tags_to_add'] = tags_to_add
            if tags_to_remove is not autoboto.ShapeBase._NOT_SET:
