...
class Client:
    ...
    def create_elasticsearch_domain(
        ...
        *,
        domain_name: str,
        elasticsearch_version: str = autoboto.ShapeBase._NOT_SET,
        elasticsearch_cluster_config: shapes.
        ElasticsearchClusterConfig = autoboto.ShapeBase._NOT_SET,
        ebs_options: shapes.EBSOptions = autoboto.ShapeBase._NOT_SET,
        access_policies: str = autoboto.ShapeBase._NOT_SET,
        snapshot_options: shapes.SnapshotOptions = autoboto.ShapeBase._NOT_SET,
        vpc_options: shapes.VPCOptions = autoboto.ShapeBase._NOT_SET,
        cognito_options: shapes.CognitoOptions = autoboto.ShapeBase._NOT_SET,
        encryption_at_rest_options: shapes.EncryptionAtRestOptions = autoboto.
        ShapeBase._NOT_SET,
        advanced_options: typing.Dict[str, str] = autoboto.ShapeBase._NOT_SET,
        log_publishing_options: typing.Dict[
            shapes.LogType, shapes.LogPublishingOption
        ...
        if _request is None:
            ...
            if elasticsearch_version is not autoboto.ShapeBase._NOT_SET:
                _params['elasticsearch_version'] = elasticsearch_version
            if elasticsearch_cluster_config is not autoboto.ShapeBase._NOT_SET:
                _params['elasticsearch_cluster_config'
                       ] = elasticsearch_cluster_config
            if ebs_options is not autoboto.ShapeBase._NOT_SET:
                _params['ebs_options'] = ebs_options
            if access_policies is not autoboto.ShapeBase._NOT_SET:
                _params['access_policies'] = access_policies
            if snapshot_options is not autoboto.ShapeBase._NOT_SET:
                _params['snapshot_options'] = snapshot_options
            if vpc_options is not autoboto.ShapeBase._NOT_SET:
                _params['vpc_options'] = vpc_options
            if cognito_options is not autoboto.ShapeBase._NOT_SET:
                _params['cognito_options'] = cognito_options
            if encryption_at_rest_options is not autoboto.ShapeBase._NOT_SET:
                _params['encryption_at_rest_options'
                       ] = encryption_at_rest_options
            if advanced_options is not autoboto.ShapeBase._NOT_SET:
                _params['advanced_options'] = advanced_options
            if log_publishing_options is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_elasticsearch_domains(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if domain_names is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_reserved_elasticsearch_instance_offerings(
        ...
        *,
        reserved_elasticsearch_instance_offering_id: str = autoboto.ShapeBase.
        _NOT_SET,
        ...
        if _request is None:
            _params = {}
            if reserved_elasticsearch_instance_offering_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_reserved_elasticsearch_instances(
        ...
        *,
        reserved_elasticsearch_instance_id: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if reserved_elasticsearch_instance_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def purchase_reserved_elasticsearch_instance_offering(
        ...
        *,
        ...
        if _request is None:
            ...
            if reservation_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def upgrade_elasticsearch_domain(
        ...
        *,
        domain_name: str,
        target_version: str,
        perform_check_only: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if domain_name is not autoboto.ShapeBase._NOT_SET:
                _params['domain_name'] = domain_name
            if target_version is not autoboto.ShapeBase._NOT_SET:
                _params['target_version'] = target_version
            if perform_check_only is not autoboto.ShapeBase._NOT_SET:
