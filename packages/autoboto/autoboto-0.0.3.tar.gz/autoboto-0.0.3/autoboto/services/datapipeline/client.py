...
class Client:
    ...
    def activate_pipeline(
        ...
        *,
        ...
        start_timestamp: datetime.datetime = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if parameter_values is not autoboto.ShapeBase._NOT_SET:
                _params['parameter_values'] = parameter_values
            if start_timestamp is not autoboto.ShapeBase._NOT_SET:
    ...
    def deactivate_pipeline(
        ...
        *,
        pipeline_id: str,
        cancel_active: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if pipeline_id is not autoboto.ShapeBase._NOT_SET:
                _params['pipeline_id'] = pipeline_id
            if cancel_active is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_objects(
        ...
        *,
        ...
        evaluate_expressions: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if pipeline_id is not autoboto.ShapeBase._NOT_SET:
                _params['pipeline_id'] = pipeline_id
            if object_ids is not autoboto.ShapeBase._NOT_SET:
                _params['object_ids'] = object_ids
            if evaluate_expressions is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_pipelines(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if pipeline_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def evaluate_expression(
        ...
        *,
        ...
        if _request is None:
            ...
            if pipeline_id is not autoboto.ShapeBase._NOT_SET:
                _params['pipeline_id'] = pipeline_id
            if object_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def poll_for_task(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if worker_group is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_pipeline_definition(
        ...
        *,
        ...
        if _request is None:
            ...
            if pipeline_id is not autoboto.ShapeBase._NOT_SET:
                _params['pipeline_id'] = pipeline_id
            if pipeline_objects is not autoboto.ShapeBase._NOT_SET:
                _params['pipeline_objects'] = pipeline_objects
            if parameter_objects is not autoboto.ShapeBase._NOT_SET:
    ...
    def query_objects(
        ...
        *,
        pipeline_id: str,
        sphere: str,
        query: shapes.Query = autoboto.ShapeBase._NOT_SET,
        marker: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if pipeline_id is not autoboto.ShapeBase._NOT_SET:
                _params['pipeline_id'] = pipeline_id
            if sphere is not autoboto.ShapeBase._NOT_SET:
    ...
    def report_task_progress(
        ...
        *,
        task_id: str,
        fields: typing.List[shapes.Field] = autoboto.ShapeBase._NOT_SET,
    ...
    def report_task_runner_heartbeat(
        ...
        *,
        taskrunner_id: str,
        worker_group: str = autoboto.ShapeBase._NOT_SET,
        hostname: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if taskrunner_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def set_task_status(
        ...
        *,
        ...
        error_id: str = autoboto.ShapeBase._NOT_SET,
        error_message: str = autoboto.ShapeBase._NOT_SET,
        error_stack_trace: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if error_id is not autoboto.ShapeBase._NOT_SET:
                _params['error_id'] = error_id
            if error_message is not autoboto.ShapeBase._NOT_SET:
                _params['error_message'] = error_message
            if error_stack_trace is not autoboto.ShapeBase._NOT_SET:
