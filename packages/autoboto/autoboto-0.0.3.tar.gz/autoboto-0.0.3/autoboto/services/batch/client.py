...
class Client:
    ...
    def create_compute_environment(
        ...
        *,
        ...
        type: shapes.CEType,
        service_role: str,
        state: shapes.CEState = autoboto.ShapeBase._NOT_SET,
        compute_resources: shapes.ComputeResource = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if compute_environment_name is not autoboto.ShapeBase._NOT_SET:
            ...
            if state is not autoboto.ShapeBase._NOT_SET:
                _params['state'] = state
            if compute_resources is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_job_queue(
        ...
        *,
        ...
        state: shapes.JQState = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if job_queue_name is not autoboto.ShapeBase._NOT_SET:
                _params['job_queue_name'] = job_queue_name
            if priority is not autoboto.ShapeBase._NOT_SET:
                _params['priority'] = priority
            if compute_environment_order is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_compute_environment(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if compute_environment is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_job_queue(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if job_queue is not autoboto.ShapeBase._NOT_SET:
    ...
    def deregister_job_definition(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if job_definition is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_compute_environments(
        ...
        *,
        compute_environments: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if compute_environments is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_job_definitions(
        ...
        *,
        job_definitions: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        job_definition_name: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if job_definitions is not autoboto.ShapeBase._NOT_SET:
                _params['job_definitions'] = job_definitions
            if max_results is not autoboto.ShapeBase._NOT_SET:
                _params['max_results'] = max_results
            if job_definition_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_job_queues(
        ...
        *,
        job_queues: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if job_queues is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_jobs(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if jobs is not autoboto.ShapeBase._NOT_SET:
                _params['jobs'] = jobs
    ...
    def list_jobs(
        ...
        *,
        job_queue: str = autoboto.ShapeBase._NOT_SET,
        array_job_id: str = autoboto.ShapeBase._NOT_SET,
        job_status: shapes.JobStatus = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if job_queue is not autoboto.ShapeBase._NOT_SET:
                _params['job_queue'] = job_queue
            if array_job_id is not autoboto.ShapeBase._NOT_SET:
                _params['array_job_id'] = array_job_id
            if job_status is not autoboto.ShapeBase._NOT_SET:
    ...
    def register_job_definition(
        ...
        *,
        ...
        container_properties: shapes.ContainerProperties = autoboto.ShapeBase.
        _NOT_SET,
        retry_strategy: shapes.RetryStrategy = autoboto.ShapeBase._NOT_SET,
        timeout: shapes.JobTimeout = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if container_properties is not autoboto.ShapeBase._NOT_SET:
                _params['container_properties'] = container_properties
            if retry_strategy is not autoboto.ShapeBase._NOT_SET:
    ...
    def submit_job(
        ...
        *,
        ...
        job_queue: str,
        job_definition: str,
        array_properties: shapes.ArrayProperties = autoboto.ShapeBase._NOT_SET,
        depends_on: typing.List[shapes.JobDependency
                               ] = autoboto.ShapeBase._NOT_SET,
        parameters: typing.Dict[str, str] = autoboto.ShapeBase._NOT_SET,
        container_overrides: shapes.ContainerOverrides = autoboto.ShapeBase.
        _NOT_SET,
        retry_strategy: shapes.RetryStrategy = autoboto.ShapeBase._NOT_SET,
        timeout: shapes.JobTimeout = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if job_definition is not autoboto.ShapeBase._NOT_SET:
                _params['job_definition'] = job_definition
            if array_properties is not autoboto.ShapeBase._NOT_SET:
                _params['array_properties'] = array_properties
            if depends_on is not autoboto.ShapeBase._NOT_SET:
                _params['depends_on'] = depends_on
            if parameters is not autoboto.ShapeBase._NOT_SET:
                _params['parameters'] = parameters
            if container_overrides is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_compute_environment(
        ...
        *,
        compute_environment: str,
        state: shapes.CEState = autoboto.ShapeBase._NOT_SET,
        compute_resources: shapes.ComputeResourceUpdate = autoboto.ShapeBase.
        _NOT_SET,
