...
class FieldStats(autoboto.ShapeBase):
    ...
    min: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    # in the result set.
    missing: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    # representation of a date with the format specified in [IETF
    # RFC3339](http://tools.ietf.org/html/rfc3339): yyyy-mm-ddTHH:mm:ss.SSSZ.
    mean: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # The standard deviation of the values in the specified field in the result
    # set.
    stddev: float = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class Hits(autoboto.ShapeBase):
    ...
    found: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # The index of the first matching document.
    start: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # A cursor that can be used to retrieve the next set of matching documents
    # when you want to page through a large result set.
    cursor: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class SearchRequest(autoboto.ShapeBase):
    ...
    # Guide_.
    expr: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    # in the _Amazon CloudSearch Developer Guide_.
    facet: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    # results.html) in the _Amazon CloudSearch Developer Guide_.
    filter_query: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    # **","post_tag": "** "} }`
    highlight: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    partial: bool = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    query_options: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
    ...
    return_: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    # results.html) in the _Amazon CloudSearch Developer Guide_.
    sort: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    stats: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class SearchStatus(autoboto.ShapeBase):
    ...
    timems: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # The encrypted resource ID for the request.
    rid: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class SuggestRequest(autoboto.ShapeBase):
    ...
    suggester: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class SuggestionMatch(autoboto.ShapeBase):
    ...
    suggestion: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # The relevance score of a suggested match.
    score: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class UploadDocumentsResponse(autoboto.ShapeBase):
    ...
    adds: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
