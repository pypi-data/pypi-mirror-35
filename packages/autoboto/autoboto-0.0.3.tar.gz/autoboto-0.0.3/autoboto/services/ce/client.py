...
class Client:
    ...
    def get_cost_and_usage(
        ...
        *,
        time_period: shapes.DateInterval = autoboto.ShapeBase._NOT_SET,
        granularity: shapes.Granularity = autoboto.ShapeBase._NOT_SET,
        filter: shapes.Expression = autoboto.ShapeBase._NOT_SET,
        metrics: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        group_by: typing.List[shapes.GroupDefinition
        ...
        if _request is None:
            _params = {}
            if time_period is not autoboto.ShapeBase._NOT_SET:
            ...
            if group_by is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_dimension_values(
        ...
        *,
        ...
        context: shapes.Context = autoboto.ShapeBase._NOT_SET,
        next_page_token: str = autoboto.ShapeBase._NOT_SET,
    ...
    def get_reservation_purchase_recommendation(
        ...
        *,
        ...
        account_scope: shapes.AccountScope = autoboto.ShapeBase._NOT_SET,
        lookback_period_in_days: shapes.LookbackPeriodInDays = autoboto.
        ShapeBase._NOT_SET,
        term_in_years: shapes.TermInYears = autoboto.ShapeBase._NOT_SET,
        payment_option: shapes.PaymentOption = autoboto.ShapeBase._NOT_SET,
        service_specification: shapes.ServiceSpecification = autoboto.ShapeBase.
        _NOT_SET,
        ...
        if _request is None:
            ...
            if account_scope is not autoboto.ShapeBase._NOT_SET:
                _params['account_scope'] = account_scope
            if lookback_period_in_days is not autoboto.ShapeBase._NOT_SET:
                _params['lookback_period_in_days'] = lookback_period_in_days
            if term_in_years is not autoboto.ShapeBase._NOT_SET:
                _params['term_in_years'] = term_in_years
            if payment_option is not autoboto.ShapeBase._NOT_SET:
                _params['payment_option'] = payment_option
            if service_specification is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_tags(
        ...
        *,
        time_period: shapes.DateInterval,
        search_string: str = autoboto.ShapeBase._NOT_SET,
        tag_key: str = autoboto.ShapeBase._NOT_SET,
        next_page_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if search_string is not autoboto.ShapeBase._NOT_SET:
                _params['search_string'] = search_string
            if tag_key is not autoboto.ShapeBase._NOT_SET:
