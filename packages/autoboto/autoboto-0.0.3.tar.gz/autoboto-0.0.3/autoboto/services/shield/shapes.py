...
class AttackDetail(autoboto.ShapeBase):
    ...
    attack_id: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class AttackVectorDescription(autoboto.ShapeBase):
    ...
    #   * REQUEST_FLOOD
    vector_type: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class CreateProtectionResponse(autoboto.ShapeBase):
    ...
    protection_id: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
class SummarizedCounter(autoboto.ShapeBase):
    ...
    max: float = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    n: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
