...
class BrokerInstance(autoboto.ShapeBase):
    ...
    console_url: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class BrokerSummary(autoboto.ShapeBase):
    ...
    # The Amazon Resource Name (ARN) of the broker.
    broker_arn: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # The unique ID that Amazon MQ generates for the broker.
    broker_id: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    broker_name: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
@dataclasses.dataclass
class CreateBrokerResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class CreateConfigurationResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DeleteBrokerResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DescribeBrokerResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DescribeConfigurationResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DescribeConfigurationRevisionResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class ListBrokersResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class ListConfigurationRevisionsResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
class Logs(autoboto.ShapeBase):
    ...
    audit: bool = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # Enables general logging.
    general: bool = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
@dataclasses.dataclass
class RebootBrokerResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return []
...
class SanitizationWarning(autoboto.ShapeBase):
    ...
    element_name: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
@dataclasses.dataclass
class UpdateBrokerResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class UpdateConfigurationResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
class WeeklyStartTime(autoboto.ShapeBase):
    ...
    time_of_day: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # The time zone, UTC by default, in either the Country/City format, or the
    # UTC offset format.
    time_zone: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
