...
class Consumer(autoboto.ShapeBase):
    ...
    # consumer.
    consumer_name: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
    ...
    consumer_arn: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class CreateStreamInput(autoboto.ShapeBase):
    ...
    # DefaultShardLimit;
    shard_count: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class DescribeLimitsOutput(autoboto.ShapeBase):
    ...
    shard_limit: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
@dataclasses.dataclass
class DescribeStreamConsumerOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DescribeStreamOutput(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class DescribeStreamSummaryOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class EnhancedMonitoringOutput(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class GetRecordsOutput(autoboto.ShapeBase):
    """
...
class GetShardIteratorInput(autoboto.ShapeBase):
    ...
    shard_id: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
@dataclasses.dataclass
class GetShardIteratorOutput(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class ListShardsOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class ListStreamConsumersOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class ListStreamsOutput(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class ListTagsForStreamOutput(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class PutRecordsOutput(autoboto.ShapeBase):
    """
    `PutRecords` results.
    """
...
@dataclasses.dataclass
class RegisterStreamConsumerOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class SubscribeToShardOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class UpdateShardCountOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
