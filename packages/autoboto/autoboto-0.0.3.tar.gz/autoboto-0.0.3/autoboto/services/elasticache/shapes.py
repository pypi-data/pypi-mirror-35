...
class CacheNode(autoboto.ShapeBase):
    ...
    **Notes:**
    ...
    cache_node_id: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
class CreateCacheClusterMessage(autoboto.ShapeBase):
    ...
    az_mode: "AZMode" = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    auth_token: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class NodeGroup(autoboto.ShapeBase):
    ...
    slots: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class NodeGroupConfiguration(autoboto.ShapeBase):
    ...
    replica_count: int = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
class NodeGroupMember(autoboto.ShapeBase):
    ...
    current_role: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class NodeSnapshot(autoboto.ShapeBase):
    ...
    cache_size: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
