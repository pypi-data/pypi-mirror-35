...
class Client:
    ...
    def create_bot_version(
        ...
        *,
        name: str,
        checksum: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if checksum is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_bot_alias(
        ...
        *,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if bot_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_bot_channel_association(
        ...
        *,
        ...
        if _request is None:
            ...
            if bot_name is not autoboto.ShapeBase._NOT_SET:
                _params['bot_name'] = bot_name
            if bot_alias is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_bot(
        ...
        *,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if version_or_alias is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_builtin_intent(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if signature is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_builtin_intents(
        ...
        *,
        locale: shapes.Locale = autoboto.ShapeBase._NOT_SET,
        signature_contains: str = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if signature_contains is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_import(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if import_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_utterances_view(
        ...
        *,
        ...
        if _request is None:
            ...
            if bot_name is not autoboto.ShapeBase._NOT_SET:
                _params['bot_name'] = bot_name
            if bot_versions is not autoboto.ShapeBase._NOT_SET:
                _params['bot_versions'] = bot_versions
            if status_type is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_bot(
        ...
        *,
        ...
        intents: typing.List[shapes.Intent] = autoboto.ShapeBase._NOT_SET,
        clarification_prompt: shapes.Prompt = autoboto.ShapeBase._NOT_SET,
        abort_statement: shapes.Statement = autoboto.ShapeBase._NOT_SET,
        idle_session_ttl_in_seconds: int = autoboto.ShapeBase._NOT_SET,
        voice_id: str = autoboto.ShapeBase._NOT_SET,
        checksum: str = autoboto.ShapeBase._NOT_SET,
        process_behavior: shapes.ProcessBehavior = autoboto.ShapeBase._NOT_SET,
        create_version: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if locale is not autoboto.ShapeBase._NOT_SET:
                _params['locale'] = locale
            if child_directed is not autoboto.ShapeBase._NOT_SET:
                _params['child_directed'] = child_directed
            if description is not autoboto.ShapeBase._NOT_SET:
                _params['description'] = description
            if intents is not autoboto.ShapeBase._NOT_SET:
                _params['intents'] = intents
            if clarification_prompt is not autoboto.ShapeBase._NOT_SET:
                _params['clarification_prompt'] = clarification_prompt
            if abort_statement is not autoboto.ShapeBase._NOT_SET:
                _params['abort_statement'] = abort_statement
            if idle_session_ttl_in_seconds is not autoboto.ShapeBase._NOT_SET:
                _params['idle_session_ttl_in_seconds'
                       ] = idle_session_ttl_in_seconds
            if voice_id is not autoboto.ShapeBase._NOT_SET:
                _params['voice_id'] = voice_id
            if checksum is not autoboto.ShapeBase._NOT_SET:
                _params['checksum'] = checksum
            if process_behavior is not autoboto.ShapeBase._NOT_SET:
                _params['process_behavior'] = process_behavior
            if create_version is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_bot_alias(
        ...
        *,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if bot_version is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_intent(
        ...
        *,
        name: str,
        description: str = autoboto.ShapeBase._NOT_SET,
        slots: typing.List[shapes.Slot] = autoboto.ShapeBase._NOT_SET,
        sample_utterances: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        confirmation_prompt: shapes.Prompt = autoboto.ShapeBase._NOT_SET,
        rejection_statement: shapes.Statement = autoboto.ShapeBase._NOT_SET,
        follow_up_prompt: shapes.FollowUpPrompt = autoboto.ShapeBase._NOT_SET,
        conclusion_statement: shapes.Statement = autoboto.ShapeBase._NOT_SET,
        dialog_code_hook: shapes.CodeHook = autoboto.ShapeBase._NOT_SET,
        fulfillment_activity: shapes.FulfillmentActivity = autoboto.ShapeBase.
        _NOT_SET,
        parent_intent_signature: str = autoboto.ShapeBase._NOT_SET,
        checksum: str = autoboto.ShapeBase._NOT_SET,
        create_version: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if description is not autoboto.ShapeBase._NOT_SET:
                _params['description'] = description
            if slots is not autoboto.ShapeBase._NOT_SET:
                _params['slots'] = slots
            if sample_utterances is not autoboto.ShapeBase._NOT_SET:
                _params['sample_utterances'] = sample_utterances
            if confirmation_prompt is not autoboto.ShapeBase._NOT_SET:
                _params['confirmation_prompt'] = confirmation_prompt
            if rejection_statement is not autoboto.ShapeBase._NOT_SET:
                _params['rejection_statement'] = rejection_statement
            if follow_up_prompt is not autoboto.ShapeBase._NOT_SET:
                _params['follow_up_prompt'] = follow_up_prompt
            if conclusion_statement is not autoboto.ShapeBase._NOT_SET:
                _params['conclusion_statement'] = conclusion_statement
            if dialog_code_hook is not autoboto.ShapeBase._NOT_SET:
                _params['dialog_code_hook'] = dialog_code_hook
            if fulfillment_activity is not autoboto.ShapeBase._NOT_SET:
                _params['fulfillment_activity'] = fulfillment_activity
            if parent_intent_signature is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_slot_type(
        ...
        *,
        ...
        checksum: str = autoboto.ShapeBase._NOT_SET,
        value_selection_strategy: shapes.SlotValueSelectionStrategy = autoboto.
        ShapeBase._NOT_SET,
        create_version: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if description is not autoboto.ShapeBase._NOT_SET:
                _params['description'] = description
            if enumeration_values is not autoboto.ShapeBase._NOT_SET:
                _params['enumeration_values'] = enumeration_values
            if checksum is not autoboto.ShapeBase._NOT_SET:
                _params['checksum'] = checksum
            if value_selection_strategy is not autoboto.ShapeBase._NOT_SET:
    ...
    def start_import(
        ...
        *,
        ...
        if _request is None:
            ...
            if resource_type is not autoboto.ShapeBase._NOT_SET:
                _params['resource_type'] = resource_type
            if merge_strategy is not autoboto.ShapeBase._NOT_SET:
