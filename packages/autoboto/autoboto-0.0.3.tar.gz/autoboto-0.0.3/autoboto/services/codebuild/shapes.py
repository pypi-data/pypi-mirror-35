...
@dataclasses.dataclass
class BatchDeleteBuildsOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class BatchGetBuildsOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class BatchGetProjectsOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
class Build(autoboto.ShapeBase):
    ...
    current_phase: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
    ...
    project_name: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    initiator: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class BuildArtifacts(autoboto.ShapeBase):
    ...
    # set to `ZIP`.
    sha256sum: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    # This value is available only if the build project's `packaging` value is
    # set to `ZIP`.
    md5sum: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
@dataclasses.dataclass
class CreateProjectOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
class CreateWebhookInput(autoboto.ShapeBase):
    ...
    branch_filter: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )


@dataclasses.dataclass
class CreateWebhookOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DeleteProjectOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return []
...
@dataclasses.dataclass
class DeleteWebhookOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return []
...
@dataclasses.dataclass
class InvalidateProjectCacheOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return []
...
@dataclasses.dataclass
class ListBuildsForProjectOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class ListCuratedEnvironmentImagesOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class ListProjectsOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
class LogsLocation(autoboto.ShapeBase):
    ...
    deep_link: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class ProjectCache(autoboto.ShapeBase):
    ...
    type: "CacheType" = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class ProjectSource(autoboto.ShapeBase):
    ...
    buildspec: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    # source code.
    insecure_ssl: bool = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
@dataclasses.dataclass
class StartBuildOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class StopBuildOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class UpdateProjectOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class UpdateWebhookOutput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
class Webhook(autoboto.ShapeBase):
    ...
    payload_url: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
