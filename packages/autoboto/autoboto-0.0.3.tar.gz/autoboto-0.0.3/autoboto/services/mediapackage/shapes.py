...
class CreateOriginEndpointRequest(autoboto.ShapeBase):
    ...
    # (defaults to "index").
    manifest_name: str = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
@dataclasses.dataclass
class CreateOriginEndpointResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DeleteOriginEndpointResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return []
...
@dataclasses.dataclass
class DescribeOriginEndpointResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class ListOriginEndpointsResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class RotateChannelCredentialsResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class UpdateOriginEndpointResponse(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
