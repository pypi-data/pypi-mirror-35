...
class Client:
    ...
    def add_tags(
        ...
        *,
        resource_id: str,
        tags_list: typing.List[shapes.Tag] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if tags_list is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_trail(
        ...
        *,
        ...
        sns_topic_name: str = autoboto.ShapeBase._NOT_SET,
        include_global_service_events: bool = autoboto.ShapeBase._NOT_SET,
        is_multi_region_trail: bool = autoboto.ShapeBase._NOT_SET,
        enable_log_file_validation: bool = autoboto.ShapeBase._NOT_SET,
        cloud_watch_logs_log_group_arn: str = autoboto.ShapeBase._NOT_SET,
        cloud_watch_logs_role_arn: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if sns_topic_name is not autoboto.ShapeBase._NOT_SET:
                _params['sns_topic_name'] = sns_topic_name
            if include_global_service_events is not autoboto.ShapeBase._NOT_SET:
                _params['include_global_service_events'
                       ] = include_global_service_events
            if is_multi_region_trail is not autoboto.ShapeBase._NOT_SET:
                _params['is_multi_region_trail'] = is_multi_region_trail
            if enable_log_file_validation is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_trails(
        ...
        *,
        trail_name_list: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        include_shadow_trails: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if trail_name_list is not autoboto.ShapeBase._NOT_SET:
                _params['trail_name_list'] = trail_name_list
            if include_shadow_trails is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_event_selectors(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if trail_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_tags(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if resource_id_list is not autoboto.ShapeBase._NOT_SET:
    ...
    def lookup_events(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if lookup_attributes is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_event_selectors(
        ...
        *,
        ...
        if _request is None:
            ...
            if trail_name is not autoboto.ShapeBase._NOT_SET:
                _params['trail_name'] = trail_name
            if event_selectors is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_trail(
        ...
        *,
        name: str,
        s3_bucket_name: str = autoboto.ShapeBase._NOT_SET,
        s3_key_prefix: str = autoboto.ShapeBase._NOT_SET,
        sns_topic_name: str = autoboto.ShapeBase._NOT_SET,
        include_global_service_events: bool = autoboto.ShapeBase._NOT_SET,
        is_multi_region_trail: bool = autoboto.ShapeBase._NOT_SET,
