...
class Client:
    ...
    def create_export_task(
        ...
        *,
        ...
        to: int,
        destination: str,
        task_name: str = autoboto.ShapeBase._NOT_SET,
        log_stream_name_prefix: str = autoboto.ShapeBase._NOT_SET,
        destination_prefix: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if log_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['log_group_name'] = log_group_name
            if from_ is not autoboto.ShapeBase._NOT_SET:
                _params['from_'] = from_
            if to is not autoboto.ShapeBase._NOT_SET:
                _params['to'] = to
            if destination is not autoboto.ShapeBase._NOT_SET:
                _params['destination'] = destination
            if task_name is not autoboto.ShapeBase._NOT_SET:
                _params['task_name'] = task_name
            if log_stream_name_prefix is not autoboto.ShapeBase._NOT_SET:
                _params['log_stream_name_prefix'] = log_stream_name_prefix
            if destination_prefix is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_log_stream(
        ...
        *,
        ...
        if _request is None:
            ...
            if log_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['log_group_name'] = log_group_name
            if log_stream_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_destination(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if destination_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_resource_policy(
        ...
        *,
        policy_name: str = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
    ...
    def describe_destinations(
        ...
        *,
        destination_name_prefix: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if destination_name_prefix is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_export_tasks(
        ...
        *,
        ...
        status_code: shapes.ExportTaskStatusCode = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        limit: int = autoboto.ShapeBase._NOT_SET,
    ...
    def describe_log_groups(
        ...
        *,
        log_group_name_prefix: str = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        limit: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if log_group_name_prefix is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_log_streams(
        ...
        *,
        log_group_name: str,
        log_stream_name_prefix: str = autoboto.ShapeBase._NOT_SET,
        order_by: shapes.OrderBy = autoboto.ShapeBase._NOT_SET,
        descending: bool = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        limit: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if log_stream_name_prefix is not autoboto.ShapeBase._NOT_SET:
                _params['log_stream_name_prefix'] = log_stream_name_prefix
            if order_by is not autoboto.ShapeBase._NOT_SET:
                _params['order_by'] = order_by
            if descending is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_metric_filters(
        ...
        *,
        ...
        filter_name_prefix: str = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        limit: int = autoboto.ShapeBase._NOT_SET,
        metric_name: str = autoboto.ShapeBase._NOT_SET,
        metric_namespace: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if log_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['log_group_name'] = log_group_name
            if filter_name_prefix is not autoboto.ShapeBase._NOT_SET:
            ...
            if metric_namespace is not autoboto.ShapeBase._NOT_SET:
    ...
    def filter_log_events(
        ...
        *,
        log_group_name: str,
        log_stream_names: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        start_time: int = autoboto.ShapeBase._NOT_SET,
        end_time: int = autoboto.ShapeBase._NOT_SET,
        filter_pattern: str = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        limit: int = autoboto.ShapeBase._NOT_SET,
        interleaved: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if log_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['log_group_name'] = log_group_name
            if log_stream_names is not autoboto.ShapeBase._NOT_SET:
            ...
            if filter_pattern is not autoboto.ShapeBase._NOT_SET:
                _params['filter_pattern'] = filter_pattern
            if next_token is not autoboto.ShapeBase._NOT_SET:
                _params['next_token'] = next_token
            if limit is not autoboto.ShapeBase._NOT_SET:
                _params['limit'] = limit
            if interleaved is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_log_events(
        ...
        *,
        ...
        next_token: str = autoboto.ShapeBase._NOT_SET,
        limit: int = autoboto.ShapeBase._NOT_SET,
        start_from_head: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if limit is not autoboto.ShapeBase._NOT_SET:
                _params['limit'] = limit
            if start_from_head is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_destination_policy(
        ...
        *,
        ...
        if _request is None:
            ...
            if destination_name is not autoboto.ShapeBase._NOT_SET:
                _params['destination_name'] = destination_name
            if access_policy is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_log_events(
        ...
        *,
        ...
        sequence_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if log_stream_name is not autoboto.ShapeBase._NOT_SET:
                _params['log_stream_name'] = log_stream_name
            if log_events is not autoboto.ShapeBase._NOT_SET:
                _params['log_events'] = log_events
            if sequence_token is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_metric_filter(
        ...
        *,
        ...
        if _request is None:
            ...
            if filter_pattern is not autoboto.ShapeBase._NOT_SET:
                _params['filter_pattern'] = filter_pattern
            if metric_transformations is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_retention_policy(
        ...
        *,
        ...
        if _request is None:
            ...
            if log_group_name is not autoboto.ShapeBase._NOT_SET:
                _params['log_group_name'] = log_group_name
            if retention_in_days is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_subscription_filter(
        ...
        *,
        ...
        distribution: shapes.Distribution = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            ...
            if filter_pattern is not autoboto.ShapeBase._NOT_SET:
                _params['filter_pattern'] = filter_pattern
            if destination_arn is not autoboto.ShapeBase._NOT_SET:
                _params['destination_arn'] = destination_arn
            if role_arn is not autoboto.ShapeBase._NOT_SET:
                _params['role_arn'] = role_arn
            if distribution is not autoboto.ShapeBase._NOT_SET:
    ...
    def test_metric_filter(
        ...
        *,
        ...
        if _request is None:
            ...
            if filter_pattern is not autoboto.ShapeBase._NOT_SET:
                _params['filter_pattern'] = filter_pattern
            if log_event_messages is not autoboto.ShapeBase._NOT_SET:
