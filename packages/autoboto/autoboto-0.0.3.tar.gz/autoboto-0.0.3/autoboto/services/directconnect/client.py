...
class Client:
    ...
    def allocate_connection_on_interconnect(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if bandwidth is not autoboto.ShapeBase._NOT_SET:
            ...
            if interconnect_id is not autoboto.ShapeBase._NOT_SET:
                _params['interconnect_id'] = interconnect_id
            if vlan is not autoboto.ShapeBase._NOT_SET:
                _params['vlan'] = vlan
    ...
    def allocate_private_virtual_interface(
        ...
        *,
        ...
        if _request is None:
            ...
            if owner_account is not autoboto.ShapeBase._NOT_SET:
                _params['owner_account'] = owner_account
            if new_private_virtual_interface_allocation is not autoboto.ShapeBase._NOT_SET:
    ...
    def allocate_public_virtual_interface(
        ...
        *,
        ...
        if _request is None:
            ...
            if owner_account is not autoboto.ShapeBase._NOT_SET:
                _params['owner_account'] = owner_account
            if new_public_virtual_interface_allocation is not autoboto.ShapeBase._NOT_SET:
    ...
    def associate_connection_with_lag(
        ...
        *,
        ...
        if _request is None:
            ...
            if connection_id is not autoboto.ShapeBase._NOT_SET:
                _params['connection_id'] = connection_id
            if lag_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def associate_hosted_connection(
        ...
        *,
        ...
        if _request is None:
            ...
            if connection_id is not autoboto.ShapeBase._NOT_SET:
                _params['connection_id'] = connection_id
            if parent_connection_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def associate_virtual_interface(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if virtual_interface_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def confirm_private_virtual_interface(
        ...
        *,
        virtual_interface_id: str,
        virtual_gateway_id: str = autoboto.ShapeBase._NOT_SET,
        direct_connect_gateway_id: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if virtual_interface_id is not autoboto.ShapeBase._NOT_SET:
                _params['virtual_interface_id'] = virtual_interface_id
            if virtual_gateway_id is not autoboto.ShapeBase._NOT_SET:
                _params['virtual_gateway_id'] = virtual_gateway_id
            if direct_connect_gateway_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_bgp_peer(
        ...
        *,
        virtual_interface_id: str = autoboto.ShapeBase._NOT_SET,
        new_bgp_peer: shapes.NewBGPPeer = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if virtual_interface_id is not autoboto.ShapeBase._NOT_SET:
                _params['virtual_interface_id'] = virtual_interface_id
            if new_bgp_peer is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_connection(
        ...
        *,
        ...
        bandwidth: str,
        connection_name: str,
        lag_id: str = autoboto.ShapeBase._NOT_SET,
    ) -> shapes.Connection:
        """
    ...
    def create_direct_connect_gateway(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if direct_connect_gateway_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_interconnect(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if interconnect_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_lag(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if number_of_connections is not autoboto.ShapeBase._NOT_SET:
                _params['number_of_connections'] = number_of_connections
            if location is not autoboto.ShapeBase._NOT_SET:
                _params['location'] = location
            if connections_bandwidth is not autoboto.ShapeBase._NOT_SET:
                _params['connections_bandwidth'] = connections_bandwidth
            if lag_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_private_virtual_interface(
        ...
        *,
        ...
        if _request is None:
            ...
            if connection_id is not autoboto.ShapeBase._NOT_SET:
                _params['connection_id'] = connection_id
            if new_private_virtual_interface is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_public_virtual_interface(
        ...
        *,
        ...
        if _request is None:
            ...
            if connection_id is not autoboto.ShapeBase._NOT_SET:
                _params['connection_id'] = connection_id
            if new_public_virtual_interface is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_bgp_peer(
        ...
        *,
        virtual_interface_id: str = autoboto.ShapeBase._NOT_SET,
        asn: int = autoboto.ShapeBase._NOT_SET,
        customer_address: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if virtual_interface_id is not autoboto.ShapeBase._NOT_SET:
                _params['virtual_interface_id'] = virtual_interface_id
            if asn is not autoboto.ShapeBase._NOT_SET:
                _params['asn'] = asn
            if customer_address is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_connection_loa(
        ...
        *,
        ...
        loa_content_type: shapes.LoaContentType = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if loa_content_type is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_interconnects(
        ...
        *,
        interconnect_id: str = autoboto.ShapeBase._NOT_SET,
    ...
    def update_lag(
        ...
        *,
        lag_id: str,
        lag_name: str = autoboto.ShapeBase._NOT_SET,
        minimum_links: int = autoboto.ShapeBase._NOT_SET,
    ) -> shapes.Lag:
        """
        ...
        if _request is None:
            ...
            if lag_name is not autoboto.ShapeBase._NOT_SET:
                _params['lag_name'] = lag_name
            if minimum_links is not autoboto.ShapeBase._NOT_SET:
