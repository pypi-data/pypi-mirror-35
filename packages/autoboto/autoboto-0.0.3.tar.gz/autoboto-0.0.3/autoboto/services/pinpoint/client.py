...
class Client:
    ...
    def create_app(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if create_application_request is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_campaign(
        ...
        *,
        ...
        if _request is None:
            ...
            if write_campaign_request is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_export_job(
        ...
        *,
        ...
        if _request is None:
            ...
            if application_id is not autoboto.ShapeBase._NOT_SET:
                _params['application_id'] = application_id
            if export_job_request is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_import_job(
        ...
        *,
        ...
        if _request is None:
            ...
            if application_id is not autoboto.ShapeBase._NOT_SET:
                _params['application_id'] = application_id
            if import_job_request is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_segment(
        ...
        *,
        ...
        if _request is None:
            ...
            if application_id is not autoboto.ShapeBase._NOT_SET:
                _params['application_id'] = application_id
            if write_segment_request is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_campaign(
        ...
        *,
        ...
        if _request is None:
            ...
            if application_id is not autoboto.ShapeBase._NOT_SET:
                _params['application_id'] = application_id
            if campaign_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_endpoint(
        ...
        *,
        ...
        if _request is None:
            ...
            if application_id is not autoboto.ShapeBase._NOT_SET:
                _params['application_id'] = application_id
            if endpoint_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_segment(
        ...
        *,
        ...
        if _request is None:
            ...
            if application_id is not autoboto.ShapeBase._NOT_SET:
                _params['application_id'] = application_id
            if segment_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_apps(
        ...
        *,
        page_size: str = autoboto.ShapeBase._NOT_SET,
        token: str = autoboto.ShapeBase._NOT_SET,
    ...
    def phone_number_validate(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if number_validate_request is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_event_stream(
        ...
        *,
        ...
        if _request is None:
            ...
            if application_id is not autoboto.ShapeBase._NOT_SET:
                _params['application_id'] = application_id
            if write_event_stream is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_events(
        ...
        *,
        ...
        if _request is None:
            ...
            if application_id is not autoboto.ShapeBase._NOT_SET:
                _params['application_id'] = application_id
            if events_request is not autoboto.ShapeBase._NOT_SET:
    ...
    def remove_attributes(
        ...
        *,
        ...
        if _request is None:
            ...
            if application_id is not autoboto.ShapeBase._NOT_SET:
                _params['application_id'] = application_id
            if attribute_type is not autoboto.ShapeBase._NOT_SET:
                _params['attribute_type'] = attribute_type
            if update_attributes_request is not autoboto.ShapeBase._NOT_SET:
    ...
    def send_messages(
        ...
        *,
        ...
        if _request is None:
            ...
            if application_id is not autoboto.ShapeBase._NOT_SET:
                _params['application_id'] = application_id
            if message_request is not autoboto.ShapeBase._NOT_SET:
    ...
    def send_users_messages(
        ...
        *,
        ...
        if _request is None:
            ...
            if application_id is not autoboto.ShapeBase._NOT_SET:
                _params['application_id'] = application_id
            if send_users_message_request is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_adm_channel(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if adm_channel_request is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_apns_channel(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if apns_channel_request is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_apns_sandbox_channel(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if apns_sandbox_channel_request is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_apns_voip_channel(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if apns_voip_channel_request is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_apns_voip_sandbox_channel(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if apns_voip_sandbox_channel_request is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_application_settings(
        ...
        *,
        ...
        if _request is None:
            ...
            if application_id is not autoboto.ShapeBase._NOT_SET:
                _params['application_id'] = application_id
            if write_application_settings_request is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_baidu_channel(
        ...
        *,
        ...
        if _request is None:
            ...
            if application_id is not autoboto.ShapeBase._NOT_SET:
                _params['application_id'] = application_id
            if baidu_channel_request is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_email_channel(
        ...
        *,
        ...
        if _request is None:
            ...
            if application_id is not autoboto.ShapeBase._NOT_SET:
                _params['application_id'] = application_id
            if email_channel_request is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_endpoint(
        ...
        *,
        ...
        if _request is None:
            ...
            if endpoint_id is not autoboto.ShapeBase._NOT_SET:
                _params['endpoint_id'] = endpoint_id
            if endpoint_request is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_endpoints_batch(
        ...
        *,
        ...
        if _request is None:
            ...
            if application_id is not autoboto.ShapeBase._NOT_SET:
                _params['application_id'] = application_id
            if endpoint_batch_request is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_gcm_channel(
        ...
        *,
        ...
        if _request is None:
            ...
            if application_id is not autoboto.ShapeBase._NOT_SET:
                _params['application_id'] = application_id
            if gcm_channel_request is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_sms_channel(
        ...
        *,
        ...
        if _request is None:
            ...
            if application_id is not autoboto.ShapeBase._NOT_SET:
                _params['application_id'] = application_id
            if sms_channel_request is not autoboto.ShapeBase._NOT_SET:
