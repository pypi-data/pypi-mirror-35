...
class BatchCheckLayerAvailabilityRequest(autoboto.ShapeBase):
    ...
    # assumed.
    registry_id: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class CompleteLayerUploadResponse(autoboto.ShapeBase):
    ...
    # The `sha256` digest of the image layer.
    layer_digest: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class DeleteRepositoryPolicyResponse(autoboto.ShapeBase):
    ...
    policy_text: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class GetDownloadUrlForLayerResponse(autoboto.ShapeBase):
    ...
    download_url: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class ImageDetail(autoboto.ShapeBase):
    ...
    image_digest: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class ImageIdentifier(autoboto.ShapeBase):
    ...
    image_tag: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class InitiateLayerUploadResponse(autoboto.ShapeBase):
    ...
    # be.
    part_size: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class Layer(autoboto.ShapeBase):
    ...
    layer_size: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
