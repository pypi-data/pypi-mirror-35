...
class Address(autoboto.ShapeBase):
    ...
    address_id: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    # This field is no longer used and the value is ignored.
    landmark: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class DataTransfer(autoboto.ShapeBase):
    ...
    # have been listed.
    total_bytes: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    total_objects: int = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
class GetJobManifestResult(autoboto.ShapeBase):
    ...
    manifest_uri: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class GetJobUnlockCodeResult(autoboto.ShapeBase):
    ...
    unlock_code: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class JobListEntry(autoboto.ShapeBase):
    ...
    is_master: bool = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class KeyRange(autoboto.ShapeBase):
    ...
    begin_marker: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # The key that ends an optional key range for an export job. Ranges are
    # inclusive and UTF-8 binary sorted.
    end_marker: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class LambdaResource(autoboto.ShapeBase):
    ...
    lambda_arn: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class Notification(autoboto.ShapeBase):
    ...
    notify_all: bool = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
