...
class Client:
    ...
    def create_api_key(
        ...
        *,
        ...
        generate_distinct_id: bool = autoboto.ShapeBase._NOT_SET,
        value: str = autoboto.ShapeBase._NOT_SET,
        stage_keys: typing.List[shapes.StageKey] = autoboto.ShapeBase._NOT_SET,
        customer_id: str = autoboto.ShapeBase._NOT_SET,
    ) -> shapes.ApiKey:
        """
        ...
        if _request is None:
            ...
            if generate_distinct_id is not autoboto.ShapeBase._NOT_SET:
                _params['generate_distinct_id'] = generate_distinct_id
            if value is not autoboto.ShapeBase._NOT_SET:
                _params['value'] = value
            if stage_keys is not autoboto.ShapeBase._NOT_SET:
                _params['stage_keys'] = stage_keys
            if customer_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_authorizer(
        ...
        *,
        ...
        provider_arns: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        auth_type: str = autoboto.ShapeBase._NOT_SET,
        authorizer_uri: str = autoboto.ShapeBase._NOT_SET,
        authorizer_credentials: str = autoboto.ShapeBase._NOT_SET,
        identity_source: str = autoboto.ShapeBase._NOT_SET,
        identity_validation_expression: str = autoboto.ShapeBase._NOT_SET,
        authorizer_result_ttl_in_seconds: int = autoboto.ShapeBase._NOT_SET,
    ) -> shapes.Authorizer:
        """
        ...
        if _request is None:
            _params = {}
            if rest_api_id is not autoboto.ShapeBase._NOT_SET:
                _params['rest_api_id'] = rest_api_id
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if type is not autoboto.ShapeBase._NOT_SET:
                _params['type'] = type
            if provider_arns is not autoboto.ShapeBase._NOT_SET:
                _params['provider_arns'] = provider_arns
            if auth_type is not autoboto.ShapeBase._NOT_SET:
                _params['auth_type'] = auth_type
            if authorizer_uri is not autoboto.ShapeBase._NOT_SET:
                _params['authorizer_uri'] = authorizer_uri
            if authorizer_credentials is not autoboto.ShapeBase._NOT_SET:
                _params['authorizer_credentials'] = authorizer_credentials
            if identity_source is not autoboto.ShapeBase._NOT_SET:
                _params['identity_source'] = identity_source
            if identity_validation_expression is not autoboto.ShapeBase._NOT_SET:
                _params['identity_validation_expression'
                       ] = identity_validation_expression
            if authorizer_result_ttl_in_seconds is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_base_path_mapping(
        ...
        *,
        domain_name: str,
        rest_api_id: str,
        base_path: str = autoboto.ShapeBase._NOT_SET,
        stage: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if domain_name is not autoboto.ShapeBase._NOT_SET:
                _params['domain_name'] = domain_name
            if rest_api_id is not autoboto.ShapeBase._NOT_SET:
                _params['rest_api_id'] = rest_api_id
            if base_path is not autoboto.ShapeBase._NOT_SET:
                _params['base_path'] = base_path
            if stage is not autoboto.ShapeBase._NOT_SET:
                _params['stage'] = stage
    ...
    def create_deployment(
        ...
        *,
        rest_api_id: str,
        stage_name: str = autoboto.ShapeBase._NOT_SET,
        stage_description: str = autoboto.ShapeBase._NOT_SET,
        description: str = autoboto.ShapeBase._NOT_SET,
        cache_cluster_enabled: bool = autoboto.ShapeBase._NOT_SET,
        cache_cluster_size: shapes.CacheClusterSize = autoboto.ShapeBase.
        _NOT_SET,
        variables: typing.Dict[str, str] = autoboto.ShapeBase._NOT_SET,
        canary_settings: shapes.DeploymentCanarySettings = autoboto.ShapeBase.
        _NOT_SET,
    ) -> shapes.Deployment:
        """
        ...
        if _request is None:
            ...
            if rest_api_id is not autoboto.ShapeBase._NOT_SET:
                _params['rest_api_id'] = rest_api_id
            if stage_name is not autoboto.ShapeBase._NOT_SET:
                _params['stage_name'] = stage_name
            if stage_description is not autoboto.ShapeBase._NOT_SET:
                _params['stage_description'] = stage_description
            if description is not autoboto.ShapeBase._NOT_SET:
                _params['description'] = description
            if cache_cluster_enabled is not autoboto.ShapeBase._NOT_SET:
                _params['cache_cluster_enabled'] = cache_cluster_enabled
            if cache_cluster_size is not autoboto.ShapeBase._NOT_SET:
                _params['cache_cluster_size'] = cache_cluster_size
            if variables is not autoboto.ShapeBase._NOT_SET:
                _params['variables'] = variables
            if canary_settings is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_documentation_part(
        ...
        *,
        ...
        if _request is None:
            ...
            if rest_api_id is not autoboto.ShapeBase._NOT_SET:
                _params['rest_api_id'] = rest_api_id
            if location is not autoboto.ShapeBase._NOT_SET:
                _params['location'] = location
            if properties is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_documentation_version(
        ...
        *,
        ...
        if _request is None:
            ...
            if rest_api_id is not autoboto.ShapeBase._NOT_SET:
                _params['rest_api_id'] = rest_api_id
            if documentation_version is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_domain_name(
        ...
        *,
        domain_name: str,
        certificate_name: str = autoboto.ShapeBase._NOT_SET,
        certificate_body: str = autoboto.ShapeBase._NOT_SET,
        certificate_private_key: str = autoboto.ShapeBase._NOT_SET,
        certificate_chain: str = autoboto.ShapeBase._NOT_SET,
        certificate_arn: str = autoboto.ShapeBase._NOT_SET,
        regional_certificate_name: str = autoboto.ShapeBase._NOT_SET,
        regional_certificate_arn: str = autoboto.ShapeBase._NOT_SET,
        endpoint_configuration: shapes.EndpointConfiguration = autoboto.
        ShapeBase._NOT_SET,
    ) -> shapes.DomainName:
        """
        ...
        if _request is None:
            ...
            if domain_name is not autoboto.ShapeBase._NOT_SET:
                _params['domain_name'] = domain_name
            if certificate_name is not autoboto.ShapeBase._NOT_SET:
                _params['certificate_name'] = certificate_name
            if certificate_body is not autoboto.ShapeBase._NOT_SET:
                _params['certificate_body'] = certificate_body
            if certificate_private_key is not autoboto.ShapeBase._NOT_SET:
                _params['certificate_private_key'] = certificate_private_key
            if certificate_chain is not autoboto.ShapeBase._NOT_SET:
                _params['certificate_chain'] = certificate_chain
            if certificate_arn is not autoboto.ShapeBase._NOT_SET:
                _params['certificate_arn'] = certificate_arn
            if regional_certificate_name is not autoboto.ShapeBase._NOT_SET:
                _params['regional_certificate_name'] = regional_certificate_name
            if regional_certificate_arn is not autoboto.ShapeBase._NOT_SET:
                _params['regional_certificate_arn'] = regional_certificate_arn
            if endpoint_configuration is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_model(
        ...
        *,
        ...
        content_type: str,
        description: str = autoboto.ShapeBase._NOT_SET,
        schema: str = autoboto.ShapeBase._NOT_SET,
    ) -> shapes.Model:
        """
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if content_type is not autoboto.ShapeBase._NOT_SET:
                _params['content_type'] = content_type
            if description is not autoboto.ShapeBase._NOT_SET:
                _params['description'] = description
            if schema is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_request_validator(
        ...
        *,
        rest_api_id: str,
        name: str = autoboto.ShapeBase._NOT_SET,
        validate_request_body: bool = autoboto.ShapeBase._NOT_SET,
        validate_request_parameters: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if validate_request_body is not autoboto.ShapeBase._NOT_SET:
                _params['validate_request_body'] = validate_request_body
            if validate_request_parameters is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_resource(
        ...
        *,
        ...
        if _request is None:
            ...
            if rest_api_id is not autoboto.ShapeBase._NOT_SET:
                _params['rest_api_id'] = rest_api_id
            if parent_id is not autoboto.ShapeBase._NOT_SET:
                _params['parent_id'] = parent_id
            if path_part is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_rest_api(
        ...
        *,
        name: str,
        description: str = autoboto.ShapeBase._NOT_SET,
        version: str = autoboto.ShapeBase._NOT_SET,
        clone_from: str = autoboto.ShapeBase._NOT_SET,
        binary_media_types: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        minimum_compression_size: int = autoboto.ShapeBase._NOT_SET,
        api_key_source: shapes.ApiKeySourceType = autoboto.ShapeBase._NOT_SET,
        endpoint_configuration: shapes.EndpointConfiguration = autoboto.
        ShapeBase._NOT_SET,
        policy: str = autoboto.ShapeBase._NOT_SET,
    ) -> shapes.RestApi:
        """
        ...
        if _request is None:
            ...
            if description is not autoboto.ShapeBase._NOT_SET:
                _params['description'] = description
            if version is not autoboto.ShapeBase._NOT_SET:
                _params['version'] = version
            if clone_from is not autoboto.ShapeBase._NOT_SET:
                _params['clone_from'] = clone_from
            if binary_media_types is not autoboto.ShapeBase._NOT_SET:
                _params['binary_media_types'] = binary_media_types
            if minimum_compression_size is not autoboto.ShapeBase._NOT_SET:
                _params['minimum_compression_size'] = minimum_compression_size
            if api_key_source is not autoboto.ShapeBase._NOT_SET:
                _params['api_key_source'] = api_key_source
            if endpoint_configuration is not autoboto.ShapeBase._NOT_SET:
                _params['endpoint_configuration'] = endpoint_configuration
            if policy is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_stage(
        ...
        *,
        ...
        _NOT_SET,
        variables: typing.Dict[str, str] = autoboto.ShapeBase._NOT_SET,
        documentation_version: str = autoboto.ShapeBase._NOT_SET,
        canary_settings: shapes.CanarySettings = autoboto.ShapeBase._NOT_SET,
        tags: typing.Dict[str, str] = autoboto.ShapeBase._NOT_SET,
    ) -> shapes.Stage:
        """
        ...
        if _request is None:
            ...
            if stage_name is not autoboto.ShapeBase._NOT_SET:
                _params['stage_name'] = stage_name
            if deployment_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_usage_plan(
        ...
        *,
        name: str,
        description: str = autoboto.ShapeBase._NOT_SET,
        api_stages: typing.List[shapes.ApiStage] = autoboto.ShapeBase._NOT_SET,
        throttle: shapes.ThrottleSettings = autoboto.ShapeBase._NOT_SET,
        quota: shapes.QuotaSettings = autoboto.ShapeBase._NOT_SET,
    ) -> shapes.UsagePlan:
        """
        ...
        if _request is None:
            ...
            if description is not autoboto.ShapeBase._NOT_SET:
                _params['description'] = description
            if api_stages is not autoboto.ShapeBase._NOT_SET:
                _params['api_stages'] = api_stages
            if throttle is not autoboto.ShapeBase._NOT_SET:
                _params['throttle'] = throttle
            if quota is not autoboto.ShapeBase._NOT_SET:
                _params['quota'] = quota
    ...
    def create_vpc_link(
        ...
        *,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if target_arns is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_api_key(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if api_key is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_authorizer(
        ...
        *,
        ...
        if _request is None:
            ...
            if rest_api_id is not autoboto.ShapeBase._NOT_SET:
                _params['rest_api_id'] = rest_api_id
            if authorizer_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_client_certificate(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if client_certificate_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_documentation_part(
        ...
        *,
        ...
        if _request is None:
            ...
            if rest_api_id is not autoboto.ShapeBase._NOT_SET:
                _params['rest_api_id'] = rest_api_id
            if documentation_part_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_gateway_response(
        ...
        *,
        ...
        if _request is None:
            ...
            if rest_api_id is not autoboto.ShapeBase._NOT_SET:
                _params['rest_api_id'] = rest_api_id
            if response_type is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_integration(
        ...
        *,
        ...
        if _request is None:
            ...
            if rest_api_id is not autoboto.ShapeBase._NOT_SET:
                _params['rest_api_id'] = rest_api_id
            if resource_id is not autoboto.ShapeBase._NOT_SET:
                _params['resource_id'] = resource_id
            if http_method is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_integration_response(
        ...
        *,
        ...
        if _request is None:
            ...
            if http_method is not autoboto.ShapeBase._NOT_SET:
                _params['http_method'] = http_method
            if status_code is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_model(
        ...
        *,
        ...
        if _request is None:
            ...
            if rest_api_id is not autoboto.ShapeBase._NOT_SET:
                _params['rest_api_id'] = rest_api_id
            if model_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_request_validator(
        ...
        *,
        ...
        if _request is None:
            ...
            if rest_api_id is not autoboto.ShapeBase._NOT_SET:
                _params['rest_api_id'] = rest_api_id
            if request_validator_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_vpc_link(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if vpc_link_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_api_key(
        ...
        *,
        api_key: str,
        include_value: bool = autoboto.ShapeBase._NOT_SET,
    ) -> shapes.ApiKey:
        """
        ...
        if _request is None:
            ...
            if api_key is not autoboto.ShapeBase._NOT_SET:
                _params['api_key'] = api_key
            if include_value is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_api_keys(
        ...
        *,
        position: str = autoboto.ShapeBase._NOT_SET,
        limit: int = autoboto.ShapeBase._NOT_SET,
        name_query: str = autoboto.ShapeBase._NOT_SET,
        customer_id: str = autoboto.ShapeBase._NOT_SET,
        include_values: bool = autoboto.ShapeBase._NOT_SET,
    ) -> shapes.ApiKeys:
        """
        ...
        if _request is None:
            _params = {}
            if position is not autoboto.ShapeBase._NOT_SET:
                _params['position'] = position
            if limit is not autoboto.ShapeBase._NOT_SET:
                _params['limit'] = limit
            if name_query is not autoboto.ShapeBase._NOT_SET:
                _params['name_query'] = name_query
            if customer_id is not autoboto.ShapeBase._NOT_SET:
                _params['customer_id'] = customer_id
            if include_values is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_deployment(
        ...
        *,
        rest_api_id: str,
        deployment_id: str,
        embed: typing.List[str] = autoboto.ShapeBase._NOT_SET,
    ) -> shapes.Deployment:
        """
        ...
        if _request is None:
            ...
            if deployment_id is not autoboto.ShapeBase._NOT_SET:
                _params['deployment_id'] = deployment_id
            if embed is not autoboto.ShapeBase._NOT_SET:
                _params['embed'] = embed
    ...
    def get_documentation_parts(
        ...
        *,
        rest_api_id: str,
        type: shapes.DocumentationPartType = autoboto.ShapeBase._NOT_SET,
        name_query: str = autoboto.ShapeBase._NOT_SET,
        path: str = autoboto.ShapeBase._NOT_SET,
        position: str = autoboto.ShapeBase._NOT_SET,
        limit: int = autoboto.ShapeBase._NOT_SET,
        location_status: shapes.LocationStatusType = autoboto.ShapeBase.
        _NOT_SET,
        ...
        if _request is None:
            ...
            if name_query is not autoboto.ShapeBase._NOT_SET:
                _params['name_query'] = name_query
            if path is not autoboto.ShapeBase._NOT_SET:
                _params['path'] = path
            if position is not autoboto.ShapeBase._NOT_SET:
                _params['position'] = position
            if limit is not autoboto.ShapeBase._NOT_SET:
                _params['limit'] = limit
            if location_status is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_export(
        ...
        *,
        ...
        accepts: str = autoboto.ShapeBase._NOT_SET,
    ...
    def get_model(
        ...
        *,
        rest_api_id: str,
        model_name: str,
        flatten: bool = autoboto.ShapeBase._NOT_SET,
    ) -> shapes.Model:
        """
        ...
        if _request is None:
            ...
            if model_name is not autoboto.ShapeBase._NOT_SET:
                _params['model_name'] = model_name
            if flatten is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_sdk(
        ...
        *,
        ...
        if _request is None:
            ...
            if stage_name is not autoboto.ShapeBase._NOT_SET:
                _params['stage_name'] = stage_name
            if sdk_type is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_sdk_type(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if id is not autoboto.ShapeBase._NOT_SET:
                _params['id'] = id
    ...
    def get_stages(
        ...
        *,
        rest_api_id: str,
        deployment_id: str = autoboto.ShapeBase._NOT_SET,
    ) -> shapes.Stages:
        """
    ...
    def get_usage(
        ...
        *,
        ...
        if _request is None:
            ...
            if usage_plan_id is not autoboto.ShapeBase._NOT_SET:
                _params['usage_plan_id'] = usage_plan_id
            if start_date is not autoboto.ShapeBase._NOT_SET:
                _params['start_date'] = start_date
            if end_date is not autoboto.ShapeBase._NOT_SET:
    ...
    def import_api_keys(
        ...
        *,
        ...
        fail_on_warnings: bool = autoboto.ShapeBase._NOT_SET,
    ) -> shapes.ApiKeyIds:
        """
        ...
        if _request is None:
            _params = {}
            if body is not autoboto.ShapeBase._NOT_SET:
                _params['body'] = body
            if format is not autoboto.ShapeBase._NOT_SET:
                _params['format'] = format
            if fail_on_warnings is not autoboto.ShapeBase._NOT_SET:
    ...
    def import_documentation_parts(
        ...
        *,
        rest_api_id: str,
        body: typing.Any,
        mode: shapes.PutMode = autoboto.ShapeBase._NOT_SET,
        fail_on_warnings: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if body is not autoboto.ShapeBase._NOT_SET:
                _params['body'] = body
            if mode is not autoboto.ShapeBase._NOT_SET:
                _params['mode'] = mode
            if fail_on_warnings is not autoboto.ShapeBase._NOT_SET:
                _params['fail_on_warnings'] = fail_on_warnings
    ...
    def put_gateway_response(
        ...
        *,
        rest_api_id: str,
        response_type: shapes.GatewayResponseType,
        status_code: str = autoboto.ShapeBase._NOT_SET,
        response_parameters: typing.Dict[str, str
                                        ] = autoboto.ShapeBase._NOT_SET,
        response_templates: typing.Dict[str, str] = autoboto.ShapeBase._NOT_SET,
    ) -> shapes.GatewayResponse:
        """
        ...
        if _request is None:
            ...
            if status_code is not autoboto.ShapeBase._NOT_SET:
                _params['status_code'] = status_code
            if response_parameters is not autoboto.ShapeBase._NOT_SET:
                _params['response_parameters'] = response_parameters
            if response_templates is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_integration(
        ...
        *,
        ...
        integration_http_method: str = autoboto.ShapeBase._NOT_SET,
        uri: str = autoboto.ShapeBase._NOT_SET,
        connection_type: shapes.ConnectionType = autoboto.ShapeBase._NOT_SET,
        connection_id: str = autoboto.ShapeBase._NOT_SET,
        credentials: str = autoboto.ShapeBase._NOT_SET,
        request_parameters: typing.Dict[str, str] = autoboto.ShapeBase._NOT_SET,
        request_templates: typing.Dict[str, str] = autoboto.ShapeBase._NOT_SET,
        passthrough_behavior: str = autoboto.ShapeBase._NOT_SET,
        cache_namespace: str = autoboto.ShapeBase._NOT_SET,
        cache_key_parameters: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        content_handling: shapes.ContentHandlingStrategy = autoboto.ShapeBase.
        _NOT_SET,
        timeout_in_millis: int = autoboto.ShapeBase._NOT_SET,
    ) -> shapes.Integration:
        """
        ...
        if _request is None:
            ...
            if type is not autoboto.ShapeBase._NOT_SET:
                _params['type'] = type
            if integration_http_method is not autoboto.ShapeBase._NOT_SET:
                _params['integration_http_method'] = integration_http_method
            if uri is not autoboto.ShapeBase._NOT_SET:
                _params['uri'] = uri
            if connection_type is not autoboto.ShapeBase._NOT_SET:
                _params['connection_type'] = connection_type
            if connection_id is not autoboto.ShapeBase._NOT_SET:
                _params['connection_id'] = connection_id
            if credentials is not autoboto.ShapeBase._NOT_SET:
                _params['credentials'] = credentials
            if request_parameters is not autoboto.ShapeBase._NOT_SET:
                _params['request_parameters'] = request_parameters
            if request_templates is not autoboto.ShapeBase._NOT_SET:
                _params['request_templates'] = request_templates
            if passthrough_behavior is not autoboto.ShapeBase._NOT_SET:
                _params['passthrough_behavior'] = passthrough_behavior
            if cache_namespace is not autoboto.ShapeBase._NOT_SET:
                _params['cache_namespace'] = cache_namespace
            if cache_key_parameters is not autoboto.ShapeBase._NOT_SET:
                _params['cache_key_parameters'] = cache_key_parameters
            if content_handling is not autoboto.ShapeBase._NOT_SET:
                _params['content_handling'] = content_handling
            if timeout_in_millis is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_integration_response(
        ...
        *,
        ...
        http_method: str,
        status_code: str,
        selection_pattern: str = autoboto.ShapeBase._NOT_SET,
        response_parameters: typing.Dict[str, str
                                        ] = autoboto.ShapeBase._NOT_SET,
        response_templates: typing.Dict[str, str] = autoboto.ShapeBase._NOT_SET,
        content_handling: shapes.ContentHandlingStrategy = autoboto.ShapeBase.
        ...
        if _request is None:
            ...
            if status_code is not autoboto.ShapeBase._NOT_SET:
                _params['status_code'] = status_code
            if selection_pattern is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_method(
        ...
        *,
        ...
        authorizer_id: str = autoboto.ShapeBase._NOT_SET,
        api_key_required: bool = autoboto.ShapeBase._NOT_SET,
        operation_name: str = autoboto.ShapeBase._NOT_SET,
        request_parameters: typing.Dict[str, bool
                                       ] = autoboto.ShapeBase._NOT_SET,
        request_models: typing.Dict[str, str] = autoboto.ShapeBase._NOT_SET,
        request_validator_id: str = autoboto.ShapeBase._NOT_SET,
        authorization_scopes: typing.List[str] = autoboto.ShapeBase._NOT_SET,
    ) -> shapes.Method:
        """
        ...
        if _request is None:
            ...
            if http_method is not autoboto.ShapeBase._NOT_SET:
                _params['http_method'] = http_method
            if authorization_type is not autoboto.ShapeBase._NOT_SET:
                _params['authorization_type'] = authorization_type
            if authorizer_id is not autoboto.ShapeBase._NOT_SET:
                _params['authorizer_id'] = authorizer_id
            if api_key_required is not autoboto.ShapeBase._NOT_SET:
                _params['api_key_required'] = api_key_required
            if operation_name is not autoboto.ShapeBase._NOT_SET:
                _params['operation_name'] = operation_name
            if request_parameters is not autoboto.ShapeBase._NOT_SET:
                _params['request_parameters'] = request_parameters
            if request_models is not autoboto.ShapeBase._NOT_SET:
                _params['request_models'] = request_models
            if request_validator_id is not autoboto.ShapeBase._NOT_SET:
                _params['request_validator_id'] = request_validator_id
            if authorization_scopes is not autoboto.ShapeBase._NOT_SET:
    ...
    def put_method_response(
        ...
        *,
        ...
        http_method: str,
        status_code: str,
        response_parameters: typing.Dict[str, bool
                                        ] = autoboto.ShapeBase._NOT_SET,
        response_models: typing.Dict[str, str] = autoboto.ShapeBase._NOT_SET,
    ) -> shapes.MethodResponse:
        """
        ...
        if _request is None:
            ...
            if response_parameters is not autoboto.ShapeBase._NOT_SET:
                _params['response_parameters'] = response_parameters
            if response_models is not autoboto.ShapeBase._NOT_SET:
    ...
    def test_invoke_authorizer(
        ...
        *,
        rest_api_id: str,
        authorizer_id: str,
        headers: typing.Dict[str, str] = autoboto.ShapeBase._NOT_SET,
        path_with_query_string: str = autoboto.ShapeBase._NOT_SET,
        body: str = autoboto.ShapeBase._NOT_SET,
        stage_variables: typing.Dict[str, str] = autoboto.ShapeBase._NOT_SET,
        additional_context: typing.Dict[str, str] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if authorizer_id is not autoboto.ShapeBase._NOT_SET:
                _params['authorizer_id'] = authorizer_id
            if headers is not autoboto.ShapeBase._NOT_SET:
                _params['headers'] = headers
            if path_with_query_string is not autoboto.ShapeBase._NOT_SET:
                _params['path_with_query_string'] = path_with_query_string
            if body is not autoboto.ShapeBase._NOT_SET:
                _params['body'] = body
            if stage_variables is not autoboto.ShapeBase._NOT_SET:
                _params['stage_variables'] = stage_variables
            if additional_context is not autoboto.ShapeBase._NOT_SET:
    ...
    def test_invoke_method(
        ...
        *,
        ...
        body: str = autoboto.ShapeBase._NOT_SET,
        headers: typing.Dict[str, str] = autoboto.ShapeBase._NOT_SET,
        client_certificate_id: str = autoboto.ShapeBase._NOT_SET,
        stage_variables: typing.Dict[str, str] = autoboto.ShapeBase._NOT_SET,
    ...
    def update_account(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if patch_operations is not autoboto.ShapeBase._NOT_SET:
