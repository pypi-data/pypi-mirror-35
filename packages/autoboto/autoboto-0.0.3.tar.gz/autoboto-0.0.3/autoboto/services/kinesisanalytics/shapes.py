...
class DeleteApplicationOutputRequest(autoboto.ShapeBase):
    ...
    output_id: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class DeleteApplicationReferenceDataSourceRequest(autoboto.ShapeBase):
    ...
    reference_id: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class InputParallelismUpdate(autoboto.ShapeBase):
    ...
    # source.
    count_update: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class OutputUpdate(autoboto.ShapeBase):
    ...
    # name.
    name_update: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class RecordColumn(autoboto.ShapeBase):
    ...
    # table.
    sql_type: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # Reference to the data element in the streaming input of the reference data
    # source.
    mapping: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class S3Configuration(autoboto.ShapeBase):
    ...
    bucket_arn: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # The name of the object that contains the data.
    file_key: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
