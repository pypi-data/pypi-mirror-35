...
class Client:
    ...
    def create_job(
        ...
        *,
        pipeline_id: str,
        input: shapes.JobInput = autoboto.ShapeBase._NOT_SET,
        inputs: typing.List[shapes.JobInput] = autoboto.ShapeBase._NOT_SET,
        output: shapes.CreateJobOutput = autoboto.ShapeBase._NOT_SET,
        outputs: typing.List[shapes.CreateJobOutput
                            ] = autoboto.ShapeBase._NOT_SET,
        output_key_prefix: str = autoboto.ShapeBase._NOT_SET,
        playlists: typing.List[shapes.CreateJobPlaylist
                              ] = autoboto.ShapeBase._NOT_SET,
        user_metadata: typing.Dict[str, str] = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if pipeline_id is not autoboto.ShapeBase._NOT_SET:
                _params['pipeline_id'] = pipeline_id
            if input is not autoboto.ShapeBase._NOT_SET:
                _params['input'] = input
            if inputs is not autoboto.ShapeBase._NOT_SET:
                _params['inputs'] = inputs
            if output is not autoboto.ShapeBase._NOT_SET:
                _params['output'] = output
            if outputs is not autoboto.ShapeBase._NOT_SET:
                _params['outputs'] = outputs
            if output_key_prefix is not autoboto.ShapeBase._NOT_SET:
                _params['output_key_prefix'] = output_key_prefix
            if playlists is not autoboto.ShapeBase._NOT_SET:
                _params['playlists'] = playlists
            if user_metadata is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_pipeline(
        ...
        *,
        ...
        input_bucket: str,
        role: str,
        output_bucket: str = autoboto.ShapeBase._NOT_SET,
        aws_kms_key_arn: str = autoboto.ShapeBase._NOT_SET,
        notifications: shapes.Notifications = autoboto.ShapeBase._NOT_SET,
        content_config: shapes.PipelineOutputConfig = autoboto.ShapeBase.
        _NOT_SET,
        thumbnail_config: shapes.PipelineOutputConfig = autoboto.ShapeBase.
        _NOT_SET,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if input_bucket is not autoboto.ShapeBase._NOT_SET:
                _params['input_bucket'] = input_bucket
            if role is not autoboto.ShapeBase._NOT_SET:
                _params['role'] = role
            if output_bucket is not autoboto.ShapeBase._NOT_SET:
                _params['output_bucket'] = output_bucket
            if aws_kms_key_arn is not autoboto.ShapeBase._NOT_SET:
                _params['aws_kms_key_arn'] = aws_kms_key_arn
            if notifications is not autoboto.ShapeBase._NOT_SET:
                _params['notifications'] = notifications
            if content_config is not autoboto.ShapeBase._NOT_SET:
                _params['content_config'] = content_config
            if thumbnail_config is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_preset(
        ...
        *,
        ...
        video: shapes.VideoParameters = autoboto.ShapeBase._NOT_SET,
        audio: shapes.AudioParameters = autoboto.ShapeBase._NOT_SET,
        thumbnails: shapes.Thumbnails = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if container is not autoboto.ShapeBase._NOT_SET:
            ...
            if video is not autoboto.ShapeBase._NOT_SET:
                _params['video'] = video
            if audio is not autoboto.ShapeBase._NOT_SET:
                _params['audio'] = audio
            if thumbnails is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_jobs_by_pipeline(
        ...
        *,
        pipeline_id: str,
        ascending: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if pipeline_id is not autoboto.ShapeBase._NOT_SET:
                _params['pipeline_id'] = pipeline_id
            if ascending is not autoboto.ShapeBase._NOT_SET:
    ...
    def test_role(
        ...
        *,
        ...
        if _request is None:
            ...
            if output_bucket is not autoboto.ShapeBase._NOT_SET:
                _params['output_bucket'] = output_bucket
            if topics is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_pipeline(
        ...
        *,
        ...
        input_bucket: str = autoboto.ShapeBase._NOT_SET,
