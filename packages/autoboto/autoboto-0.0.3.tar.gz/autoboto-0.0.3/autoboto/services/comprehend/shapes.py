...
class DetectDominantLanguageRequest(autoboto.ShapeBase):
    ...
    text: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class DominantLanguage(autoboto.ShapeBase):
    ...
    # detection.
    score: float = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class Entity(autoboto.ShapeBase):
    ...
    # The entity's type.
    type: "EntityType" = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
    ...
    begin_offset: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
    ...
    # code point.
    end_offset: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class SentimentScore(autoboto.ShapeBase):
    ...
    positive: float = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # The level of confidence that Amazon Comprehend has in the accuracy of its
    # detection of the `NEGATIVE` sentiment.
    negative: float = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # The level of confidence that Amazon Comprehend has in the accuracy of its
    # detection of the `NEUTRAL` sentiment.
    neutral: float = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )

    # The level of confidence that Amazon Comprehend has in the accuracy of its
    # detection of the `MIXED` sentiment.
    mixed: float = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class SyntaxToken(autoboto.ShapeBase):
    ...
    token_id: int = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
