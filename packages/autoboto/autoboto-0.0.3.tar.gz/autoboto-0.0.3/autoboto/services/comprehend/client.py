...
class Client:
    ...
    def batch_detect_dominant_language(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if text_list is not autoboto.ShapeBase._NOT_SET:
    ...
    def list_dominant_language_detection_jobs(
        ...
        *,
        filter: shapes.DominantLanguageDetectionJobFilter = autoboto.ShapeBase.
        _NOT_SET,
    ...
    def list_entities_detection_jobs(
        ...
        *,
        filter: shapes.EntitiesDetectionJobFilter = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
    ...
    def list_key_phrases_detection_jobs(
        ...
        *,
        filter: shapes.KeyPhrasesDetectionJobFilter = autoboto.ShapeBase.
        _NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
    ...
    def list_sentiment_detection_jobs(
        ...
        *,
        filter: shapes.SentimentDetectionJobFilter = autoboto.ShapeBase.
        _NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
    ...
    def list_topics_detection_jobs(
        ...
        *,
        filter: shapes.TopicsDetectionJobFilter = autoboto.ShapeBase._NOT_SET,
        next_token: str = autoboto.ShapeBase._NOT_SET,
        max_results: int = autoboto.ShapeBase._NOT_SET,
    ...
    def start_dominant_language_detection_job(
        ...
        *,
        ...
        job_name: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if data_access_role_arn is not autoboto.ShapeBase._NOT_SET:
    ...
    def start_topics_detection_job(
        ...
        *,
        ...
        data_access_role_arn: str,
        job_name: str = autoboto.ShapeBase._NOT_SET,
        number_of_topics: int = autoboto.ShapeBase._NOT_SET,
        client_request_token: str = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if job_name is not autoboto.ShapeBase._NOT_SET:
                _params['job_name'] = job_name
            if number_of_topics is not autoboto.ShapeBase._NOT_SET:
