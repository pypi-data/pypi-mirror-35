...
class AssociateDelegateToResourceRequest(autoboto.ShapeBase):
    ...
    entity_id: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class AssociateMemberToGroupRequest(autoboto.ShapeBase):
    ...
    member_id: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
...
class Delegate(autoboto.ShapeBase):
    ...
    type: "MemberType" = dataclasses.field(
        default=autoboto.ShapeBase._NOT_SET,
    )
...
class DeleteMailboxPermissionsRequest(autoboto.ShapeBase):
    ...
    # permissions.
    grantee_id: str = dataclasses.field(default=autoboto.ShapeBase._NOT_SET, )
