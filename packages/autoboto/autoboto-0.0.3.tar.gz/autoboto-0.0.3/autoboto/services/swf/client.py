...
class Client:
    ...
    def count_closed_workflow_executions(
        ...
        *,
        domain: str,
        start_time_filter: shapes.ExecutionTimeFilter = autoboto.ShapeBase.
        _NOT_SET,
        close_time_filter: shapes.ExecutionTimeFilter = autoboto.ShapeBase.
        _NOT_SET,
        execution_filter: shapes.WorkflowExecutionFilter = autoboto.ShapeBase.
        _NOT_SET,
        type_filter: shapes.WorkflowTypeFilter = autoboto.ShapeBase._NOT_SET,
        tag_filter: shapes.TagFilter = autoboto.ShapeBase._NOT_SET,
        close_status_filter: shapes.CloseStatusFilter = autoboto.ShapeBase.
        _NOT_SET,
        ...
        **Access Control**
        ...
        if _request is None:
            ...
            if start_time_filter is not autoboto.ShapeBase._NOT_SET:
                _params['start_time_filter'] = start_time_filter
            if close_time_filter is not autoboto.ShapeBase._NOT_SET:
                _params['close_time_filter'] = close_time_filter
            if execution_filter is not autoboto.ShapeBase._NOT_SET:
                _params['execution_filter'] = execution_filter
            if type_filter is not autoboto.ShapeBase._NOT_SET:
                _params['type_filter'] = type_filter
            if tag_filter is not autoboto.ShapeBase._NOT_SET:
                _params['tag_filter'] = tag_filter
            if close_status_filter is not autoboto.ShapeBase._NOT_SET:
    ...
    def count_pending_activity_tasks(
        ...
        **Access Control**
        ...
        if _request is None:
            ...
            if domain is not autoboto.ShapeBase._NOT_SET:
                _params['domain'] = domain
            if task_list is not autoboto.ShapeBase._NOT_SET:
    ...
    def deprecate_activity_type(
        ...
        **Access Control**
        ...
        if _request is None:
            ...
            if domain is not autoboto.ShapeBase._NOT_SET:
                _params['domain'] = domain
            if activity_type is not autoboto.ShapeBase._NOT_SET:
    ...
    def deprecate_workflow_type(
        ...
        **Access Control**
        ...
        if _request is None:
            ...
            if domain is not autoboto.ShapeBase._NOT_SET:
                _params['domain'] = domain
            if workflow_type is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_workflow_execution(
        ...
        **Access Control**
        ...
        if _request is None:
            ...
            if domain is not autoboto.ShapeBase._NOT_SET:
                _params['domain'] = domain
            if execution is not autoboto.ShapeBase._NOT_SET:
    ...
    def get_workflow_execution_history(
        ...
        *,
        domain: str,
        execution: shapes.WorkflowExecution,
        next_page_token: str = autoboto.ShapeBase._NOT_SET,
        maximum_page_size: int = autoboto.ShapeBase._NOT_SET,
        ...
        **Access Control**
        ...
        if _request is None:
            ...
            if execution is not autoboto.ShapeBase._NOT_SET:
                _params['execution'] = execution
            if next_page_token is not autoboto.ShapeBase._NOT_SET:
                _params['next_page_token'] = next_page_token
            if maximum_page_size is not autoboto.ShapeBase._NOT_SET:
    ...
    def poll_for_activity_task(
        ...
        *,
        domain: str,
        task_list: shapes.TaskList,
        identity: str = autoboto.ShapeBase._NOT_SET,
    ) -> shapes.ActivityTask:
        """
    ...
    def record_activity_task_heartbeat(
        ...
        *,
        task_token: str,
        details: str = autoboto.ShapeBase._NOT_SET,
        ...
        **Access Control**
        ...
        if _request is None:
            _params = {}
            if task_token is not autoboto.ShapeBase._NOT_SET:
    ...
    def register_activity_type(
        ...
        *,
        ...
        default_task_start_to_close_timeout: str = autoboto.ShapeBase._NOT_SET,
        default_task_heartbeat_timeout: str = autoboto.ShapeBase._NOT_SET,
        default_task_list: shapes.TaskList = autoboto.ShapeBase._NOT_SET,
        default_task_priority: str = autoboto.ShapeBase._NOT_SET,
        default_task_schedule_to_start_timeout: str = autoboto.ShapeBase.
        _NOT_SET,
        default_task_schedule_to_close_timeout: str = autoboto.ShapeBase.
        _NOT_SET,
    ) -> None:
        """
        ...
        **Access Control**
        ...
        if _request is None:
            ...
            if default_task_start_to_close_timeout is not autoboto.ShapeBase._NOT_SET:
                _params['default_task_start_to_close_timeout'
                       ] = default_task_start_to_close_timeout
            if default_task_heartbeat_timeout is not autoboto.ShapeBase._NOT_SET:
                _params['default_task_heartbeat_timeout'
                       ] = default_task_heartbeat_timeout
            if default_task_list is not autoboto.ShapeBase._NOT_SET:
                _params['default_task_list'] = default_task_list
            if default_task_priority is not autoboto.ShapeBase._NOT_SET:
                _params['default_task_priority'] = default_task_priority
            if default_task_schedule_to_start_timeout is not autoboto.ShapeBase._NOT_SET:
                _params['default_task_schedule_to_start_timeout'
                       ] = default_task_schedule_to_start_timeout
            if default_task_schedule_to_close_timeout is not autoboto.ShapeBase._NOT_SET:
    ...
    def register_domain(
        ...
        **Access Control**
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if workflow_execution_retention_period_in_days is not autoboto.ShapeBase._NOT_SET:
    ...
    def register_workflow_type(
        ...
        *,
        ...
        description: str = autoboto.ShapeBase._NOT_SET,
        default_task_start_to_close_timeout: str = autoboto.ShapeBase._NOT_SET,
        default_execution_start_to_close_timeout: str = autoboto.ShapeBase.
        _NOT_SET,
        default_task_list: shapes.TaskList = autoboto.ShapeBase._NOT_SET,
        default_task_priority: str = autoboto.ShapeBase._NOT_SET,
        default_child_policy: shapes.ChildPolicy = autoboto.ShapeBase._NOT_SET,
        default_lambda_role: str = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        **Access Control**
        ...
        if _request is None:
            ...
            if default_execution_start_to_close_timeout is not autoboto.ShapeBase._NOT_SET:
            ...
            if default_task_priority is not autoboto.ShapeBase._NOT_SET:
                _params['default_task_priority'] = default_task_priority
            if default_child_policy is not autoboto.ShapeBase._NOT_SET:
                _params['default_child_policy'] = default_child_policy
            if default_lambda_role is not autoboto.ShapeBase._NOT_SET:
    ...
    def request_cancel_workflow_execution(
        ...
        *,
        domain: str,
        workflow_id: str,
        run_id: str = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        **Access Control**
        ...
        if _request is None:
            ...
            if domain is not autoboto.ShapeBase._NOT_SET:
                _params['domain'] = domain
            if workflow_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def respond_activity_task_completed(
        ...
        *,
        task_token: str,
        result: str = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        Used by workers to tell the service that the ActivityTask identified by the
        ...
        **Access Control**
        ...
        if _request is None:
            ...
            if task_token is not autoboto.ShapeBase._NOT_SET:
                _params['task_token'] = task_token
            if result is not autoboto.ShapeBase._NOT_SET:
    ...
    def respond_decision_task_completed(
        ...
        *,
        task_token: str,
        decisions: typing.List[shapes.Decision] = autoboto.ShapeBase._NOT_SET,
        execution_context: str = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        **Access Control**
        ...
        if _request is None:
            ...
            if task_token is not autoboto.ShapeBase._NOT_SET:
                _params['task_token'] = task_token
            if decisions is not autoboto.ShapeBase._NOT_SET:
                _params['decisions'] = decisions
            if execution_context is not autoboto.ShapeBase._NOT_SET:
    ...
    def signal_workflow_execution(
        ...
        *,
        ...
        signal_name: str,
        run_id: str = autoboto.ShapeBase._NOT_SET,
        input: str = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        **Access Control**
        ...
        if _request is None:
            ...
            if workflow_id is not autoboto.ShapeBase._NOT_SET:
                _params['workflow_id'] = workflow_id
            if signal_name is not autoboto.ShapeBase._NOT_SET:
                _params['signal_name'] = signal_name
            if run_id is not autoboto.ShapeBase._NOT_SET:
                _params['run_id'] = run_id
            if input is not autoboto.ShapeBase._NOT_SET:
                _params['input'] = input
    ...
    def start_workflow_execution(
        ...
        *,
        ...
        workflow_id: str,
        workflow_type: shapes.WorkflowType,
        task_list: shapes.TaskList = autoboto.ShapeBase._NOT_SET,
        task_priority: str = autoboto.ShapeBase._NOT_SET,
        input: str = autoboto.ShapeBase._NOT_SET,
        execution_start_to_close_timeout: str = autoboto.ShapeBase._NOT_SET,
        tag_list: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        task_start_to_close_timeout: str = autoboto.ShapeBase._NOT_SET,
        child_policy: shapes.ChildPolicy = autoboto.ShapeBase._NOT_SET,
        lambda_role: str = autoboto.ShapeBase._NOT_SET,
    ) -> shapes.Run:
        """
        ...
        **Access Control**
        ...
        if _request is None:
            ...
            if task_list is not autoboto.ShapeBase._NOT_SET:
                _params['task_list'] = task_list
            if task_priority is not autoboto.ShapeBase._NOT_SET:
                _params['task_priority'] = task_priority
            if input is not autoboto.ShapeBase._NOT_SET:
                _params['input'] = input
            if execution_start_to_close_timeout is not autoboto.ShapeBase._NOT_SET:
                _params['execution_start_to_close_timeout'
                       ] = execution_start_to_close_timeout
            if tag_list is not autoboto.ShapeBase._NOT_SET:
                _params['tag_list'] = tag_list
            if task_start_to_close_timeout is not autoboto.ShapeBase._NOT_SET:
                _params['task_start_to_close_timeout'
                       ] = task_start_to_close_timeout
            if child_policy is not autoboto.ShapeBase._NOT_SET:
                _params['child_policy'] = child_policy
            if lambda_role is not autoboto.ShapeBase._NOT_SET:
