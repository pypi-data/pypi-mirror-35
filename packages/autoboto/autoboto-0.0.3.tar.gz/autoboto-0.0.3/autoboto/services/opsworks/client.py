...
class Client:
    ...
    def assign_instance(
        ...
        **Required Permissions** : To use this action, an AWS Identity and Access
        ...
        if _request is None:
            ...
            if layer_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def associate_elastic_ip(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        if _request is None:
            _params = {}
            if elastic_ip is not autoboto.ShapeBase._NOT_SET:
    ...
    def attach_elastic_load_balancer(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        if _request is None:
            _params = {}
            if elastic_load_balancer_name is not autoboto.ShapeBase._NOT_SET:
                _params['elastic_load_balancer_name'
                       ] = elastic_load_balancer_name
            if layer_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def clone_stack(
        ...
        *,
        ...
        region: str = autoboto.ShapeBase._NOT_SET,
        vpc_id: str = autoboto.ShapeBase._NOT_SET,
        attributes: typing.Dict[shapes.StackAttributesKeys, str
                               ] = autoboto.ShapeBase._NOT_SET,
        default_instance_profile_arn: str = autoboto.ShapeBase._NOT_SET,
        default_os: str = autoboto.ShapeBase._NOT_SET,
        hostname_theme: str = autoboto.ShapeBase._NOT_SET,
        default_availability_zone: str = autoboto.ShapeBase._NOT_SET,
        default_subnet_id: str = autoboto.ShapeBase._NOT_SET,
        custom_json: str = autoboto.ShapeBase._NOT_SET,
        configuration_manager: shapes.StackConfigurationManager = autoboto.
        ShapeBase._NOT_SET,
        chef_configuration: shapes.ChefConfiguration = autoboto.ShapeBase.
        _NOT_SET,
        use_custom_cookbooks: bool = autoboto.ShapeBase._NOT_SET,
        use_opsworks_security_groups: bool = autoboto.ShapeBase._NOT_SET,
        custom_cookbooks_source: shapes.Source = autoboto.ShapeBase._NOT_SET,
        default_ssh_key_name: str = autoboto.ShapeBase._NOT_SET,
        clone_permissions: bool = autoboto.ShapeBase._NOT_SET,
        clone_app_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        default_root_device_type: shapes.RootDeviceType = autoboto.ShapeBase.
        _NOT_SET,
        agent_version: str = autoboto.ShapeBase._NOT_SET,
        ...
        **Required Permissions** : To use this action, an IAM user must have an attached
        ...
        if _request is None:
            _params = {}
            if source_stack_id is not autoboto.ShapeBase._NOT_SET:
                _params['source_stack_id'] = source_stack_id
            if service_role_arn is not autoboto.ShapeBase._NOT_SET:
                _params['service_role_arn'] = service_role_arn
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if region is not autoboto.ShapeBase._NOT_SET:
                _params['region'] = region
            if vpc_id is not autoboto.ShapeBase._NOT_SET:
                _params['vpc_id'] = vpc_id
            if attributes is not autoboto.ShapeBase._NOT_SET:
                _params['attributes'] = attributes
            if default_instance_profile_arn is not autoboto.ShapeBase._NOT_SET:
                _params['default_instance_profile_arn'
                       ] = default_instance_profile_arn
            if default_os is not autoboto.ShapeBase._NOT_SET:
                _params['default_os'] = default_os
            if hostname_theme is not autoboto.ShapeBase._NOT_SET:
                _params['hostname_theme'] = hostname_theme
            if default_availability_zone is not autoboto.ShapeBase._NOT_SET:
                _params['default_availability_zone'] = default_availability_zone
            if default_subnet_id is not autoboto.ShapeBase._NOT_SET:
                _params['default_subnet_id'] = default_subnet_id
            if custom_json is not autoboto.ShapeBase._NOT_SET:
                _params['custom_json'] = custom_json
            if configuration_manager is not autoboto.ShapeBase._NOT_SET:
                _params['configuration_manager'] = configuration_manager
            if chef_configuration is not autoboto.ShapeBase._NOT_SET:
                _params['chef_configuration'] = chef_configuration
            if use_custom_cookbooks is not autoboto.ShapeBase._NOT_SET:
                _params['use_custom_cookbooks'] = use_custom_cookbooks
            if use_opsworks_security_groups is not autoboto.ShapeBase._NOT_SET:
                _params['use_opsworks_security_groups'
                       ] = use_opsworks_security_groups
            if custom_cookbooks_source is not autoboto.ShapeBase._NOT_SET:
                _params['custom_cookbooks_source'] = custom_cookbooks_source
            if default_ssh_key_name is not autoboto.ShapeBase._NOT_SET:
                _params['default_ssh_key_name'] = default_ssh_key_name
            if clone_permissions is not autoboto.ShapeBase._NOT_SET:
                _params['clone_permissions'] = clone_permissions
            if clone_app_ids is not autoboto.ShapeBase._NOT_SET:
                _params['clone_app_ids'] = clone_app_ids
            if default_root_device_type is not autoboto.ShapeBase._NOT_SET:
                _params['default_root_device_type'] = default_root_device_type
            if agent_version is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_app(
        ...
        *,
        ...
        name: str,
        type: shapes.AppType,
        shortname: str = autoboto.ShapeBase._NOT_SET,
        description: str = autoboto.ShapeBase._NOT_SET,
        data_sources: typing.List[shapes.DataSource
                                 ] = autoboto.ShapeBase._NOT_SET,
        app_source: shapes.Source = autoboto.ShapeBase._NOT_SET,
        domains: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        enable_ssl: bool = autoboto.ShapeBase._NOT_SET,
        ssl_configuration: shapes.SslConfiguration = autoboto.ShapeBase.
        _NOT_SET,
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        if _request is None:
            _params = {}
            if stack_id is not autoboto.ShapeBase._NOT_SET:
                _params['stack_id'] = stack_id
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if type is not autoboto.ShapeBase._NOT_SET:
                _params['type'] = type
            if shortname is not autoboto.ShapeBase._NOT_SET:
                _params['shortname'] = shortname
            if description is not autoboto.ShapeBase._NOT_SET:
                _params['description'] = description
            if data_sources is not autoboto.ShapeBase._NOT_SET:
                _params['data_sources'] = data_sources
            if app_source is not autoboto.ShapeBase._NOT_SET:
                _params['app_source'] = app_source
            if domains is not autoboto.ShapeBase._NOT_SET:
                _params['domains'] = domains
            if enable_ssl is not autoboto.ShapeBase._NOT_SET:
                _params['enable_ssl'] = enable_ssl
            if ssl_configuration is not autoboto.ShapeBase._NOT_SET:
                _params['ssl_configuration'] = ssl_configuration
            if attributes is not autoboto.ShapeBase._NOT_SET:
                _params['attributes'] = attributes
            if environment is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_deployment(
        ...
        *,
        ...
        app_id: str = autoboto.ShapeBase._NOT_SET,
        instance_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        layer_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        **Required Permissions** : To use this action, an IAM user must have a Deploy or
        ...
        if _request is None:
            ...
            if stack_id is not autoboto.ShapeBase._NOT_SET:
                _params['stack_id'] = stack_id
            if command is not autoboto.ShapeBase._NOT_SET:
                _params['command'] = command
            if app_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_instance(
        ...
        *,
        ...
        layer_ids: typing.List[str],
        instance_type: str,
        auto_scaling_type: shapes.AutoScalingType = autoboto.ShapeBase._NOT_SET,
        hostname: str = autoboto.ShapeBase._NOT_SET,
        os: str = autoboto.ShapeBase._NOT_SET,
        ami_id: str = autoboto.ShapeBase._NOT_SET,
        ssh_key_name: str = autoboto.ShapeBase._NOT_SET,
        ...
        architecture: shapes.Architecture = autoboto.ShapeBase._NOT_SET,
        root_device_type: shapes.RootDeviceType = autoboto.ShapeBase._NOT_SET,
        block_device_mappings: typing.List[shapes.BlockDeviceMapping
                                          ] = autoboto.ShapeBase._NOT_SET,
        install_updates_on_boot: bool = autoboto.ShapeBase._NOT_SET,
        ebs_optimized: bool = autoboto.ShapeBase._NOT_SET,
        agent_version: str = autoboto.ShapeBase._NOT_SET,
        tenancy: str = autoboto.ShapeBase._NOT_SET,
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        if _request is None:
            ...
            if auto_scaling_type is not autoboto.ShapeBase._NOT_SET:
                _params['auto_scaling_type'] = auto_scaling_type
            if hostname is not autoboto.ShapeBase._NOT_SET:
                _params['hostname'] = hostname
            if os is not autoboto.ShapeBase._NOT_SET:
                _params['os'] = os
            if ami_id is not autoboto.ShapeBase._NOT_SET:
                _params['ami_id'] = ami_id
            if ssh_key_name is not autoboto.ShapeBase._NOT_SET:
            ...
            if root_device_type is not autoboto.ShapeBase._NOT_SET:
            ...
            if install_updates_on_boot is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_layer(
        ...
        *,
        ...
        CloudWatchLogsConfiguration = autoboto.ShapeBase._NOT_SET,
        custom_instance_profile_arn: str = autoboto.ShapeBase._NOT_SET,
        custom_json: str = autoboto.ShapeBase._NOT_SET,
        custom_security_group_ids: typing.List[str
                                              ] = autoboto.ShapeBase._NOT_SET,
        packages: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        volume_configurations: typing.List[shapes.VolumeConfiguration
                                          ] = autoboto.ShapeBase._NOT_SET,
        enable_auto_healing: bool = autoboto.ShapeBase._NOT_SET,
        auto_assign_elastic_ips: bool = autoboto.ShapeBase._NOT_SET,
        auto_assign_public_ips: bool = autoboto.ShapeBase._NOT_SET,
        custom_recipes: shapes.Recipes = autoboto.ShapeBase._NOT_SET,
        install_updates_on_boot: bool = autoboto.ShapeBase._NOT_SET,
        use_ebs_optimized_instances: bool = autoboto.ShapeBase._NOT_SET,
        lifecycle_event_configuration: shapes.
        LifecycleEventConfiguration = autoboto.ShapeBase._NOT_SET,
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        if _request is None:
            ...
            if attributes is not autoboto.ShapeBase._NOT_SET:
                _params['attributes'] = attributes
            if cloud_watch_logs_configuration is not autoboto.ShapeBase._NOT_SET:
                _params['cloud_watch_logs_configuration'
                       ] = cloud_watch_logs_configuration
            if custom_instance_profile_arn is not autoboto.ShapeBase._NOT_SET:
                _params['custom_instance_profile_arn'
                       ] = custom_instance_profile_arn
            if custom_json is not autoboto.ShapeBase._NOT_SET:
                _params['custom_json'] = custom_json
            if custom_security_group_ids is not autoboto.ShapeBase._NOT_SET:
                _params['custom_security_group_ids'] = custom_security_group_ids
            if packages is not autoboto.ShapeBase._NOT_SET:
                _params['packages'] = packages
            if volume_configurations is not autoboto.ShapeBase._NOT_SET:
                _params['volume_configurations'] = volume_configurations
            if enable_auto_healing is not autoboto.ShapeBase._NOT_SET:
                _params['enable_auto_healing'] = enable_auto_healing
            if auto_assign_elastic_ips is not autoboto.ShapeBase._NOT_SET:
                _params['auto_assign_elastic_ips'] = auto_assign_elastic_ips
            if auto_assign_public_ips is not autoboto.ShapeBase._NOT_SET:
                _params['auto_assign_public_ips'] = auto_assign_public_ips
            if custom_recipes is not autoboto.ShapeBase._NOT_SET:
                _params['custom_recipes'] = custom_recipes
            if install_updates_on_boot is not autoboto.ShapeBase._NOT_SET:
                _params['install_updates_on_boot'] = install_updates_on_boot
            if use_ebs_optimized_instances is not autoboto.ShapeBase._NOT_SET:
                _params['use_ebs_optimized_instances'
                       ] = use_ebs_optimized_instances
            if lifecycle_event_configuration is not autoboto.ShapeBase._NOT_SET:
    ...
    def create_user_profile(
        ...
        *,
        iam_user_arn: str,
        ssh_username: str = autoboto.ShapeBase._NOT_SET,
        ssh_public_key: str = autoboto.ShapeBase._NOT_SET,
        allow_self_management: bool = autoboto.ShapeBase._NOT_SET,
        ...
        **Required Permissions** : To use this action, an IAM user must have an attached
        ...
        if _request is None:
            _params = {}
            if iam_user_arn is not autoboto.ShapeBase._NOT_SET:
                _params['iam_user_arn'] = iam_user_arn
            if ssh_username is not autoboto.ShapeBase._NOT_SET:
                _params['ssh_username'] = ssh_username
            if ssh_public_key is not autoboto.ShapeBase._NOT_SET:
                _params['ssh_public_key'] = ssh_public_key
            if allow_self_management is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_instance(
        ...
        *,
        instance_id: str,
        delete_elastic_ip: bool = autoboto.ShapeBase._NOT_SET,
        delete_volumes: bool = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        if _request is None:
            ...
            if instance_id is not autoboto.ShapeBase._NOT_SET:
                _params['instance_id'] = instance_id
            if delete_elastic_ip is not autoboto.ShapeBase._NOT_SET:
                _params['delete_elastic_ip'] = delete_elastic_ip
            if delete_volumes is not autoboto.ShapeBase._NOT_SET:
    ...
    def deregister_ecs_cluster(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        if _request is None:
            _params = {}
            if ecs_cluster_arn is not autoboto.ShapeBase._NOT_SET:
    ...
    def deregister_rds_db_instance(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        if _request is None:
            _params = {}
            if rds_db_instance_arn is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_agent_versions(
        ...
        *,
        stack_id: str = autoboto.ShapeBase._NOT_SET,
        configuration_manager: shapes.StackConfigurationManager = autoboto.
        ShapeBase._NOT_SET,
    ...
    def describe_apps(
        ...
        *,
        stack_id: str = autoboto.ShapeBase._NOT_SET,
        app_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        **Required Permissions** : To use this action, an IAM user must have a Show,
        ...
        if _request is None:
            ...
            if stack_id is not autoboto.ShapeBase._NOT_SET:
                _params['stack_id'] = stack_id
            if app_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_commands(
        ...
        *,
        ...
        instance_id: str = autoboto.ShapeBase._NOT_SET,
        command_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        **Required Permissions** : To use this action, an IAM user must have a Show,
        ...
        if _request is None:
            ...
            if instance_id is not autoboto.ShapeBase._NOT_SET:
                _params['instance_id'] = instance_id
            if command_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_deployments(
        ...
        *,
        stack_id: str = autoboto.ShapeBase._NOT_SET,
        app_id: str = autoboto.ShapeBase._NOT_SET,
        deployment_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        **Required Permissions** : To use this action, an IAM user must have a Show,
        ...
        if _request is None:
            ...
            if app_id is not autoboto.ShapeBase._NOT_SET:
                _params['app_id'] = app_id
            if deployment_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_ecs_clusters(
        ...
        *,
        ecs_cluster_arns: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        stack_id: str = autoboto.ShapeBase._NOT_SET,
        ...
        **Required Permissions** : To use this action, an IAM user must have a Show,
        ...
        if _request is None:
            _params = {}
            if ecs_cluster_arns is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_elastic_ips(
        ...
        *,
        instance_id: str = autoboto.ShapeBase._NOT_SET,
        stack_id: str = autoboto.ShapeBase._NOT_SET,
        ips: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        **Required Permissions** : To use this action, an IAM user must have a Show,
        ...
        if _request is None:
            ...
            if stack_id is not autoboto.ShapeBase._NOT_SET:
                _params['stack_id'] = stack_id
            if ips is not autoboto.ShapeBase._NOT_SET:
                _params['ips'] = ips
    ...
    def describe_instances(
        ...
        *,
        stack_id: str = autoboto.ShapeBase._NOT_SET,
        layer_id: str = autoboto.ShapeBase._NOT_SET,
        instance_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
    ...
    def describe_permissions(
        ...
        *,
        iam_user_arn: str = autoboto.ShapeBase._NOT_SET,
        stack_id: str = autoboto.ShapeBase._NOT_SET,
    ...
    def describe_raid_arrays(
        ...
        *,
        instance_id: str = autoboto.ShapeBase._NOT_SET,
        stack_id: str = autoboto.ShapeBase._NOT_SET,
        raid_array_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        **Required Permissions** : To use this action, an IAM user must have a Show,
        ...
        if _request is None:
            ...
            if stack_id is not autoboto.ShapeBase._NOT_SET:
                _params['stack_id'] = stack_id
            if raid_array_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_rds_db_instances(
        ...
        *,
        stack_id: str,
        rds_db_instance_arns: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        **Required Permissions** : To use this action, an IAM user must have a Show,
        ...
        if _request is None:
            ...
            if stack_id is not autoboto.ShapeBase._NOT_SET:
                _params['stack_id'] = stack_id
            if rds_db_instance_arns is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_service_errors(
        ...
        *,
        stack_id: str = autoboto.ShapeBase._NOT_SET,
        instance_id: str = autoboto.ShapeBase._NOT_SET,
        service_error_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        **Required Permissions** : To use this action, an IAM user must have a Show,
        ...
        if _request is None:
            ...
            if instance_id is not autoboto.ShapeBase._NOT_SET:
                _params['instance_id'] = instance_id
            if service_error_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_stacks(
        ...
        *,
        stack_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        **Required Permissions** : To use this action, an IAM user must have a Show,
        ...
        if _request is None:
            _params = {}
            if stack_ids is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_user_profiles(
        ...
        *,
        iam_user_arns: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        ...
        **Required Permissions** : To use this action, an IAM user must have an attached
        ...
        if _request is None:
            _params = {}
            if iam_user_arns is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_volumes(
        ...
        *,
        instance_id: str = autoboto.ShapeBase._NOT_SET,
        stack_id: str = autoboto.ShapeBase._NOT_SET,
        raid_array_id: str = autoboto.ShapeBase._NOT_SET,
        ...
        **Required Permissions** : To use this action, an IAM user must have a Show,
        ...
        if _request is None:
            ...
            if stack_id is not autoboto.ShapeBase._NOT_SET:
                _params['stack_id'] = stack_id
            if raid_array_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def grant_access(
        ...
        *,
        instance_id: str,
        valid_for_in_minutes: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if instance_id is not autoboto.ShapeBase._NOT_SET:
                _params['instance_id'] = instance_id
            if valid_for_in_minutes is not autoboto.ShapeBase._NOT_SET:
    ...
    def register_instance(
        ...
        *,
        ...
        private_ip: str = autoboto.ShapeBase._NOT_SET,
        rsa_public_key: str = autoboto.ShapeBase._NOT_SET,
        rsa_public_key_fingerprint: str = autoboto.ShapeBase._NOT_SET,
        instance_identity: shapes.InstanceIdentity = autoboto.ShapeBase.
        _NOT_SET,
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        if _request is None:
            ...
            if private_ip is not autoboto.ShapeBase._NOT_SET:
                _params['private_ip'] = private_ip
            if rsa_public_key is not autoboto.ShapeBase._NOT_SET:
                _params['rsa_public_key'] = rsa_public_key
            if rsa_public_key_fingerprint is not autoboto.ShapeBase._NOT_SET:
                _params['rsa_public_key_fingerprint'
                       ] = rsa_public_key_fingerprint
            if instance_identity is not autoboto.ShapeBase._NOT_SET:
    ...
    def register_rds_db_instance(
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        if _request is None:
            ...
            if rds_db_instance_arn is not autoboto.ShapeBase._NOT_SET:
                _params['rds_db_instance_arn'] = rds_db_instance_arn
            if db_user is not autoboto.ShapeBase._NOT_SET:
                _params['db_user'] = db_user
            if db_password is not autoboto.ShapeBase._NOT_SET:
    ...
    def register_volume(
        ...
        *,
        stack_id: str,
        ec2_volume_id: str = autoboto.ShapeBase._NOT_SET,
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        if _request is None:
            ...
            if stack_id is not autoboto.ShapeBase._NOT_SET:
                _params['stack_id'] = stack_id
            if ec2_volume_id is not autoboto.ShapeBase._NOT_SET:
    ...
    def set_load_based_auto_scaling(
        ...
        *,
        layer_id: str,
        enable: bool = autoboto.ShapeBase._NOT_SET,
        up_scaling: shapes.AutoScalingThresholds = autoboto.ShapeBase._NOT_SET,
        down_scaling: shapes.AutoScalingThresholds = autoboto.ShapeBase.
        _NOT_SET,
    ) -> None:
        """
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        if _request is None:
            ...
            if layer_id is not autoboto.ShapeBase._NOT_SET:
                _params['layer_id'] = layer_id
            if enable is not autoboto.ShapeBase._NOT_SET:
                _params['enable'] = enable
            if up_scaling is not autoboto.ShapeBase._NOT_SET:
                _params['up_scaling'] = up_scaling
            if down_scaling is not autoboto.ShapeBase._NOT_SET:
    ...
    def set_permission(
        ...
        *,
        stack_id: str,
        iam_user_arn: str,
        allow_ssh: bool = autoboto.ShapeBase._NOT_SET,
        allow_sudo: bool = autoboto.ShapeBase._NOT_SET,
        level: str = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        if _request is None:
            ...
            if iam_user_arn is not autoboto.ShapeBase._NOT_SET:
                _params['iam_user_arn'] = iam_user_arn
            if allow_ssh is not autoboto.ShapeBase._NOT_SET:
                _params['allow_ssh'] = allow_ssh
            if allow_sudo is not autoboto.ShapeBase._NOT_SET:
                _params['allow_sudo'] = allow_sudo
            if level is not autoboto.ShapeBase._NOT_SET:
                _params['level'] = level
    ...
    def set_time_based_auto_scaling(
        ...
        *,
        instance_id: str,
        auto_scaling_schedule: shapes.WeeklyAutoScalingSchedule = autoboto.
        ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        if _request is None:
            ...
            if instance_id is not autoboto.ShapeBase._NOT_SET:
                _params['instance_id'] = instance_id
            if auto_scaling_schedule is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_app(
        ...
        *,
        ...
        type: shapes.AppType = autoboto.ShapeBase._NOT_SET,
        app_source: shapes.Source = autoboto.ShapeBase._NOT_SET,
        domains: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        enable_ssl: bool = autoboto.ShapeBase._NOT_SET,
        ssl_configuration: shapes.SslConfiguration = autoboto.ShapeBase.
    ...
    def update_instance(
        ...
        *,
        instance_id: str,
        layer_ids: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        instance_type: str = autoboto.ShapeBase._NOT_SET,
        auto_scaling_type: shapes.AutoScalingType = autoboto.ShapeBase._NOT_SET,
        hostname: str = autoboto.ShapeBase._NOT_SET,
        os: str = autoboto.ShapeBase._NOT_SET,
        ami_id: str = autoboto.ShapeBase._NOT_SET,
    ...
    def update_rds_db_instance(
        ...
        *,
        rds_db_instance_arn: str,
        db_user: str = autoboto.ShapeBase._NOT_SET,
        db_password: str = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
    ...
    def update_stack(
        ...
        *,
        ...
        service_role_arn: str = autoboto.ShapeBase._NOT_SET,
        default_instance_profile_arn: str = autoboto.ShapeBase._NOT_SET,
        default_os: str = autoboto.ShapeBase._NOT_SET,
        hostname_theme: str = autoboto.ShapeBase._NOT_SET,
        default_availability_zone: str = autoboto.ShapeBase._NOT_SET,
    ...
    def update_volume(
        ...
        *,
        volume_id: str,
        name: str = autoboto.ShapeBase._NOT_SET,
        mount_point: str = autoboto.ShapeBase._NOT_SET,
    ) -> None:
        """
        ...
        **Required Permissions** : To use this action, an IAM user must have a Manage
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase._NOT_SET:
                _params['name'] = name
            if mount_point is not autoboto.ShapeBase._NOT_SET:
