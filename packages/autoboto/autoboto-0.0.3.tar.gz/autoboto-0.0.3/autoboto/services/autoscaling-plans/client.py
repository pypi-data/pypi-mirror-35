...
class Client:
    ...
    def create_scaling_plan(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if scaling_plan_name is not autoboto.ShapeBase._NOT_SET:
                _params['scaling_plan_name'] = scaling_plan_name
            if application_source is not autoboto.ShapeBase._NOT_SET:
                _params['application_source'] = application_source
            if scaling_instructions is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_scaling_plan(
        ...
        *,
        ...
        if _request is None:
            ...
            if scaling_plan_name is not autoboto.ShapeBase._NOT_SET:
                _params['scaling_plan_name'] = scaling_plan_name
            if scaling_plan_version is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_scaling_plans(
        ...
        *,
        scaling_plan_names: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        scaling_plan_version: int = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            _params = {}
            if scaling_plan_names is not autoboto.ShapeBase._NOT_SET:
                _params['scaling_plan_names'] = scaling_plan_names
            if scaling_plan_version is not autoboto.ShapeBase._NOT_SET:
                _params['scaling_plan_version'] = scaling_plan_version
            if application_sources is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_scaling_plan(
        ...
        *,
        scaling_plan_name: str,
        scaling_plan_version: int,
        application_source: shapes.ApplicationSource = autoboto.ShapeBase.
        _NOT_SET,
        scaling_instructions: typing.List[shapes.ScalingInstruction
                                         ] = autoboto.ShapeBase._NOT_SET,
