...
class Client:
    ...
    def define_analysis_scheme(
        ...
        *,
        ...
        if _request is None:
            ...
            if domain_name is not autoboto.ShapeBase._NOT_SET:
                _params['domain_name'] = domain_name
            if analysis_scheme is not autoboto.ShapeBase._NOT_SET:
    ...
    def define_index_field(
        ...
        *,
        ...
        if _request is None:
            ...
            if domain_name is not autoboto.ShapeBase._NOT_SET:
                _params['domain_name'] = domain_name
            if index_field is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_analysis_scheme(
        ...
        *,
        ...
        if _request is None:
            ...
            if domain_name is not autoboto.ShapeBase._NOT_SET:
                _params['domain_name'] = domain_name
            if analysis_scheme_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_expression(
        ...
        *,
        ...
        if _request is None:
            ...
            if domain_name is not autoboto.ShapeBase._NOT_SET:
                _params['domain_name'] = domain_name
            if expression_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_index_field(
        ...
        *,
        ...
        if _request is None:
            ...
            if domain_name is not autoboto.ShapeBase._NOT_SET:
                _params['domain_name'] = domain_name
            if index_field_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def delete_suggester(
        ...
        *,
        ...
        if _request is None:
            ...
            if domain_name is not autoboto.ShapeBase._NOT_SET:
                _params['domain_name'] = domain_name
            if suggester_name is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_analysis_schemes(
        ...
        *,
        domain_name: str,
        analysis_scheme_names: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        deployed: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if domain_name is not autoboto.ShapeBase._NOT_SET:
                _params['domain_name'] = domain_name
            if analysis_scheme_names is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_domains(
        ...
        *,
        domain_names: typing.List[str] = autoboto.ShapeBase._NOT_SET,
    ...
    def describe_expressions(
        ...
        *,
        domain_name: str,
        expression_names: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        deployed: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if domain_name is not autoboto.ShapeBase._NOT_SET:
                _params['domain_name'] = domain_name
            if expression_names is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_index_fields(
        ...
        *,
        domain_name: str,
        field_names: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        deployed: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if domain_name is not autoboto.ShapeBase._NOT_SET:
                _params['domain_name'] = domain_name
            if field_names is not autoboto.ShapeBase._NOT_SET:
    ...
    def describe_suggesters(
        ...
        *,
        domain_name: str,
        suggester_names: typing.List[str] = autoboto.ShapeBase._NOT_SET,
        deployed: bool = autoboto.ShapeBase._NOT_SET,
        ...
        if _request is None:
            ...
            if domain_name is not autoboto.ShapeBase._NOT_SET:
                _params['domain_name'] = domain_name
            if suggester_names is not autoboto.ShapeBase._NOT_SET:
    ...
    def update_scaling_parameters(
        ...
        *,
        ...
        if _request is None:
            ...
            if domain_name is not autoboto.ShapeBase._NOT_SET:
                _params['domain_name'] = domain_name
            if scaling_parameters is not autoboto.ShapeBase._NOT_SET:
