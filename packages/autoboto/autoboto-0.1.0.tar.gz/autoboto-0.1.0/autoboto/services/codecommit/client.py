...
class Client:
    ...
    def batch_get_repositories(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if repository_names is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_branch(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if repository_name is not autoboto.ShapeBase.NOT_SET:
                _params['repository_name'] = repository_name
            if branch_name is not autoboto.ShapeBase.NOT_SET:
                _params['branch_name'] = branch_name
            if commit_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_repository(
        ...
        *,
        repository_name: str,
        repository_description: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if repository_name is not autoboto.ShapeBase.NOT_SET:
                _params['repository_name'] = repository_name
            if repository_description is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_pull_request_events(
        ...
        *,
        ...
        ShapeBase.NOT_SET,
        actor_arn: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if pull_request_id is not autoboto.ShapeBase.NOT_SET:
                _params['pull_request_id'] = pull_request_id
            if pull_request_event_type is not autoboto.ShapeBase.NOT_SET:
                _params['pull_request_event_type'] = pull_request_event_type
            if actor_arn is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_blob(
        ...
        *,
        ...
        if _request is None:
            ...
            if repository_name is not autoboto.ShapeBase.NOT_SET:
                _params['repository_name'] = repository_name
            if blob_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_branch(
        ...
        *,
        repository_name: str = autoboto.ShapeBase.NOT_SET,
        branch_name: str = autoboto.ShapeBase.NOT_SET,
    ...
    def get_comments_for_compared_commit(
        ...
        *,
        repository_name: str,
        after_commit_id: str,
        before_commit_id: str = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if repository_name is not autoboto.ShapeBase.NOT_SET:
                _params['repository_name'] = repository_name
            if after_commit_id is not autoboto.ShapeBase.NOT_SET:
                _params['after_commit_id'] = after_commit_id
            if before_commit_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_comments_for_pull_request(
        ...
        *,
        ...
        repository_name: str = autoboto.ShapeBase.NOT_SET,
        before_commit_id: str = autoboto.ShapeBase.NOT_SET,
        after_commit_id: str = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
    ...
    def get_differences(
        ...
        *,
        ...
        before_commit_specifier: str = autoboto.ShapeBase.NOT_SET,
        before_path: str = autoboto.ShapeBase.NOT_SET,
        after_path: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if repository_name is not autoboto.ShapeBase.NOT_SET:
                _params['repository_name'] = repository_name
            if after_commit_specifier is not autoboto.ShapeBase.NOT_SET:
                _params['after_commit_specifier'] = after_commit_specifier
            if before_commit_specifier is not autoboto.ShapeBase.NOT_SET:
                _params['before_commit_specifier'] = before_commit_specifier
            if before_path is not autoboto.ShapeBase.NOT_SET:
                _params['before_path'] = before_path
            if after_path is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_merge_conflicts(
        ...
        *,
        ...
        if _request is None:
            ...
            if repository_name is not autoboto.ShapeBase.NOT_SET:
                _params['repository_name'] = repository_name
            if destination_commit_specifier is not autoboto.ShapeBase.NOT_SET:
                _params['destination_commit_specifier'
                       ] = destination_commit_specifier
            if source_commit_specifier is not autoboto.ShapeBase.NOT_SET:
                _params['source_commit_specifier'] = source_commit_specifier
            if merge_option is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_pull_requests(
        ...
        *,
        repository_name: str,
        author_arn: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if repository_name is not autoboto.ShapeBase.NOT_SET:
                _params['repository_name'] = repository_name
            if author_arn is not autoboto.ShapeBase.NOT_SET:
                _params['author_arn'] = author_arn
            if pull_request_status is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_repositories(
        ...
        *,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        sort_by: shapes.SortByEnum = autoboto.ShapeBase.NOT_SET,
        order: shapes.OrderEnum = autoboto.ShapeBase.NOT_SET,
    ...
    def merge_pull_request_by_fast_forward(
        ...
        *,
        pull_request_id: str,
        repository_name: str,
        source_commit_id: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if repository_name is not autoboto.ShapeBase.NOT_SET:
                _params['repository_name'] = repository_name
            if source_commit_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def post_comment_reply(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if in_reply_to is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_file(
        ...
        *,
        ...
        file_path: str,
        file_mode: shapes.FileModeTypeEnum = autoboto.ShapeBase.NOT_SET,
        parent_commit_id: str = autoboto.ShapeBase.NOT_SET,
        commit_message: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if branch_name is not autoboto.ShapeBase.NOT_SET:
                _params['branch_name'] = branch_name
            if file_content is not autoboto.ShapeBase.NOT_SET:
                _params['file_content'] = file_content
            if file_path is not autoboto.ShapeBase.NOT_SET:
                _params['file_path'] = file_path
            if file_mode is not autoboto.ShapeBase.NOT_SET:
                _params['file_mode'] = file_mode
            if parent_commit_id is not autoboto.ShapeBase.NOT_SET:
                _params['parent_commit_id'] = parent_commit_id
            if commit_message is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_repository_triggers(
        ...
        *,
        ...
        if _request is None:
            ...
            if repository_name is not autoboto.ShapeBase.NOT_SET:
                _params['repository_name'] = repository_name
            if triggers is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_default_branch(
        ...
        *,
        ...
        if _request is None:
            ...
            if repository_name is not autoboto.ShapeBase.NOT_SET:
                _params['repository_name'] = repository_name
            if default_branch_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_repository_name(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if old_name is not autoboto.ShapeBase.NOT_SET:
                _params['old_name'] = old_name
            if new_name is not autoboto.ShapeBase.NOT_SET:
