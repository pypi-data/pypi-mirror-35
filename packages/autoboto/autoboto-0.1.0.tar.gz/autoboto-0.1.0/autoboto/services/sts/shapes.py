...
class AssumeRoleRequest(autoboto.ShapeBase):
    @classmethod
    ...
    token_code: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )


@dataclasses.dataclass
class AssumeRoleResponse(autoboto.OutputShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "assumed_role_user",
                "AssumedRoleUser",
                autoboto.TypeInfo(AssumedRoleUser),
            ),
            (
                "packed_policy_size",
                "PackedPolicySize",
    ...
    packed_policy_size: int = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )


@dataclasses.dataclass
class AssumeRoleWithSAMLRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class AssumeRoleWithSAMLResponse(autoboto.OutputShapeBase):
    """
    ...
    audience: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    ...
    # ) )`
    name_qualifier: str = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )


@dataclasses.dataclass
class AssumeRoleWithWebIdentityRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class AssumeRoleWithWebIdentityResponse(autoboto.OutputShapeBase):
    """
...
@dataclasses.dataclass
class AssumedRoleUser(autoboto.ShapeBase):
    """
    The identifiers for the temporary security credentials that the operation
    returns.
    """
...
@dataclasses.dataclass
class DecodeAuthorizationMessageRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DecodeAuthorizationMessageResponse(autoboto.OutputShapeBase):
    """
    ...
    decoded_message: str = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
...
@dataclasses.dataclass
class FederatedUser(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class GetCallerIdentityRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return []
...
@dataclasses.dataclass
class GetCallerIdentityResponse(autoboto.OutputShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "federated_user",
                "FederatedUser",
                autoboto.TypeInfo(FederatedUser),
            ),
            (
                "packed_policy_size",
                "PackedPolicySize",
...
@dataclasses.dataclass
class GetSessionTokenRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class GetSessionTokenResponse(autoboto.OutputShapeBase):
    """
...
@dataclasses.dataclass
class IDPCommunicationErrorException(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class IDPRejectedClaimException(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class InvalidAuthorizationMessageException(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class InvalidIdentityTokenException(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class PackedPolicyTooLargeException(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class RegionDisabledException(autoboto.ShapeBase):
    """
