...
class Client:
    ...
    def associate_web_acl(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if web_acl_id is not autoboto.ShapeBase.NOT_SET:
        ...
        *,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase.NOT_SET:
                _params['name'] = name
            if change_token is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_rate_based_rule(
        ...
        *,
        ...
        if _request is None:
            ...
            if rate_key is not autoboto.ShapeBase.NOT_SET:
                _params['rate_key'] = rate_key
            if rate_limit is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_web_acl(
        ...
        *,
        ...
        if _request is None:
            ...
            if metric_name is not autoboto.ShapeBase.NOT_SET:
                _params['metric_name'] = metric_name
            if default_action is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_byte_match_set(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if byte_match_set_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_geo_match_set(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if geo_match_set_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_rate_based_rule(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if rule_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_regex_match_set(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if regex_match_set_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_regex_pattern_set(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if regex_pattern_set_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_rule_group(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if rule_group_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_size_constraint_set(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if size_constraint_set_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_sql_injection_match_set(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if sql_injection_match_set_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_xss_match_set(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if xss_match_set_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_rate_based_rule_managed_keys(
        ...
        *,
        rule_id: str,
        next_marker: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if rule_id is not autoboto.ShapeBase.NOT_SET:
                _params['rule_id'] = rule_id
            if next_marker is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_sampled_requests(
        ...
        *,
        ...
        if _request is None:
            ...
            if rule_id is not autoboto.ShapeBase.NOT_SET:
                _params['rule_id'] = rule_id
            if time_window is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_activated_rules_in_rule_group(
        ...
        *,
        rule_group_id: str = autoboto.ShapeBase.NOT_SET,
        next_marker: str = autoboto.ShapeBase.NOT_SET,
    ...
    def put_logging_configuration(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if logging_configuration is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_byte_match_set(
        ...
        *,
        ...
        if _request is None:
            ...
            if change_token is not autoboto.ShapeBase.NOT_SET:
                _params['change_token'] = change_token
            if updates is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_web_acl(
        ...
        *,
        web_acl_id: str,
        change_token: str,
        updates: typing.List[shapes.WebACLUpdate] = autoboto.ShapeBase.NOT_SET,
        default_action: shapes.WafAction = autoboto.ShapeBase.NOT_SET,
