...
class Client:
    ...
    def associate_created_artifact(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if progress_update_stream is not autoboto.ShapeBase.NOT_SET:
                _params['progress_update_stream'] = progress_update_stream
            if migration_task_name is not autoboto.ShapeBase.NOT_SET:
                _params['migration_task_name'] = migration_task_name
            if created_artifact is not autoboto.ShapeBase.NOT_SET:
    ...
    def associate_discovered_resource(
        ...
        *,
        ...
        if _request is None:
            ...
            if migration_task_name is not autoboto.ShapeBase.NOT_SET:
                _params['migration_task_name'] = migration_task_name
            if discovered_resource is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_progress_update_stream(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if progress_update_stream_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def disassociate_created_artifact(
        ...
        *,
        ...
        if _request is None:
            ...
            if migration_task_name is not autoboto.ShapeBase.NOT_SET:
                _params['migration_task_name'] = migration_task_name
            if created_artifact_name is not autoboto.ShapeBase.NOT_SET:
        ...
        *,
        ...
        if _request is None:
            ...
            if task is not autoboto.ShapeBase.NOT_SET:
                _params['task'] = task
            if update_date_time is not autoboto.ShapeBase.NOT_SET:
                _params['update_date_time'] = update_date_time
            if next_update_seconds is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_resource_attributes(
        ...
        *,
        ...
        if _request is None:
            ...
            if migration_task_name is not autoboto.ShapeBase.NOT_SET:
                _params['migration_task_name'] = migration_task_name
            if resource_attribute_list is not autoboto.ShapeBase.NOT_SET:
