...
class Client:
    ...
    def delete_alarms(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if alarm_names is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_dashboards(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if dashboard_names is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_alarm_history(
        ...
        *,
        alarm_name: str = autoboto.ShapeBase.NOT_SET,
        history_item_type: shapes.HistoryItemType = autoboto.ShapeBase.NOT_SET,
        start_date: datetime.datetime = autoboto.ShapeBase.NOT_SET,
        end_date: datetime.datetime = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if alarm_name is not autoboto.ShapeBase.NOT_SET:
                _params['alarm_name'] = alarm_name
            if history_item_type is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_alarms(
        ...
        *,
        alarm_names: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        alarm_name_prefix: str = autoboto.ShapeBase.NOT_SET,
        state_value: shapes.StateValue = autoboto.ShapeBase.NOT_SET,
        action_prefix: str = autoboto.ShapeBase.NOT_SET,
        max_records: int = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if alarm_names is not autoboto.ShapeBase.NOT_SET:
                _params['alarm_names'] = alarm_names
            if alarm_name_prefix is not autoboto.ShapeBase.NOT_SET:
                _params['alarm_name_prefix'] = alarm_name_prefix
            if state_value is not autoboto.ShapeBase.NOT_SET:
                _params['state_value'] = state_value
            if action_prefix is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_alarms_for_metric(
        ...
        *,
        metric_name: str,
        namespace: str,
        statistic: shapes.Statistic = autoboto.ShapeBase.NOT_SET,
        extended_statistic: str = autoboto.ShapeBase.NOT_SET,
        dimensions: typing.List[shapes.Dimension] = autoboto.ShapeBase.NOT_SET,
        period: int = autoboto.ShapeBase.NOT_SET,
        unit: shapes.StandardUnit = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if namespace is not autoboto.ShapeBase.NOT_SET:
                _params['namespace'] = namespace
            if statistic is not autoboto.ShapeBase.NOT_SET:
                _params['statistic'] = statistic
            if extended_statistic is not autoboto.ShapeBase.NOT_SET:
                _params['extended_statistic'] = extended_statistic
            if dimensions is not autoboto.ShapeBase.NOT_SET:
                _params['dimensions'] = dimensions
            if period is not autoboto.ShapeBase.NOT_SET:
                _params['period'] = period
            if unit is not autoboto.ShapeBase.NOT_SET:
                _params['unit'] = unit
    ...
    def get_dashboard(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if dashboard_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_metric_data(
        ...
        *,
        ...
        next_token: str = autoboto.ShapeBase.NOT_SET,
        scan_by: shapes.ScanBy = autoboto.ShapeBase.NOT_SET,
        max_datapoints: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if metric_data_queries is not autoboto.ShapeBase.NOT_SET:
            ...
            if next_token is not autoboto.ShapeBase.NOT_SET:
                _params['next_token'] = next_token
            if scan_by is not autoboto.ShapeBase.NOT_SET:
                _params['scan_by'] = scan_by
            if max_datapoints is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_metric_statistics(
        ...
        *,
        ...
        period: int,
        dimensions: typing.List[shapes.Dimension] = autoboto.ShapeBase.NOT_SET,
        statistics: typing.List[shapes.Statistic] = autoboto.ShapeBase.NOT_SET,
        extended_statistics: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        unit: shapes.StandardUnit = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if dimensions is not autoboto.ShapeBase.NOT_SET:
                _params['dimensions'] = dimensions
            if statistics is not autoboto.ShapeBase.NOT_SET:
                _params['statistics'] = statistics
            if extended_statistics is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_dashboards(
        ...
        *,
        dashboard_name_prefix: str = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if dashboard_name_prefix is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_metrics(
        ...
        *,
        namespace: str = autoboto.ShapeBase.NOT_SET,
        metric_name: str = autoboto.ShapeBase.NOT_SET,
    ...
    def put_dashboard(
        ...
        *,
        ...
        if _request is None:
            ...
            if dashboard_name is not autoboto.ShapeBase.NOT_SET:
                _params['dashboard_name'] = dashboard_name
            if dashboard_body is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_metric_alarm(
        ...
        *,
        ...
        alarm_description: str = autoboto.ShapeBase.NOT_SET,
        actions_enabled: bool = autoboto.ShapeBase.NOT_SET,
        ok_actions: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        alarm_actions: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        ...
        dimensions: typing.List[shapes.Dimension] = autoboto.ShapeBase.NOT_SET,
        unit: shapes.StandardUnit = autoboto.ShapeBase.NOT_SET,
        datapoints_to_alarm: int = autoboto.ShapeBase.NOT_SET,
        treat_missing_data: str = autoboto.ShapeBase.NOT_SET,
        evaluate_low_sample_count_percentile: str = autoboto.ShapeBase.NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            ...
            if alarm_description is not autoboto.ShapeBase.NOT_SET:
                _params['alarm_description'] = alarm_description
            if actions_enabled is not autoboto.ShapeBase.NOT_SET:
                _params['actions_enabled'] = actions_enabled
            if ok_actions is not autoboto.ShapeBase.NOT_SET:
                _params['ok_actions'] = ok_actions
            if alarm_actions is not autoboto.ShapeBase.NOT_SET:
                _params['alarm_actions'] = alarm_actions
            if insufficient_data_actions is not autoboto.ShapeBase.NOT_SET:
            ...
            if unit is not autoboto.ShapeBase.NOT_SET:
                _params['unit'] = unit
            if datapoints_to_alarm is not autoboto.ShapeBase.NOT_SET:
                _params['datapoints_to_alarm'] = datapoints_to_alarm
            if treat_missing_data is not autoboto.ShapeBase.NOT_SET:
                _params['treat_missing_data'] = treat_missing_data
            if evaluate_low_sample_count_percentile is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_metric_data(
        ...
        *,
        ...
        if _request is None:
            ...
            if namespace is not autoboto.ShapeBase.NOT_SET:
                _params['namespace'] = namespace
            if metric_data is not autoboto.ShapeBase.NOT_SET:
    ...
    def set_alarm_state(
        ...
        *,
        ...
        state_reason: str,
        state_reason_data: str = autoboto.ShapeBase.NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            ...
            if state_value is not autoboto.ShapeBase.NOT_SET:
                _params['state_value'] = state_value
            if state_reason is not autoboto.ShapeBase.NOT_SET:
                _params['state_reason'] = state_reason
            if state_reason_data is not autoboto.ShapeBase.NOT_SET:
