...
class AlarmHistoryItem(autoboto.ShapeBase):
    ...
    history_data: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
class DashboardEntry(autoboto.ShapeBase):
    ...
    dashboard_arn: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
class DashboardValidationMessage(autoboto.ShapeBase):
    ...
    data_path: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class DeleteDashboardsOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DescribeAlarmHistoryOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DescribeAlarmsForMetricOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
class DescribeAlarmsInput(autoboto.ShapeBase):
    ...
    action_prefix: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class DescribeAlarmsOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class GetDashboardOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
class GetMetricDataInput(autoboto.ShapeBase):
    ...
    scan_by: "ScanBy" = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class GetMetricDataOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class GetMetricStatisticsOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class ListDashboardsOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class ListMetricsOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
class MetricDataQuery(autoboto.ShapeBase):
    ...
    return_data: bool = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
class MetricStat(autoboto.ShapeBase):
    ...
    # extended statistic.
    stat: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class PutDashboardOutput(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
