...
class Client:
    ...
    def get_signing_platform(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if platform_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_signing_jobs(
        ...
        *,
        status: shapes.SigningStatus = autoboto.ShapeBase.NOT_SET,
        platform_id: str = autoboto.ShapeBase.NOT_SET,
        requested_by: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if platform_id is not autoboto.ShapeBase.NOT_SET:
                _params['platform_id'] = platform_id
            if requested_by is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_signing_platforms(
        ...
        *,
        ...
        partner: str = autoboto.ShapeBase.NOT_SET,
        target: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if partner is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_signing_profiles(
        ...
        *,
        include_canceled: bool = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if include_canceled is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_signing_profile(
        ...
        *,
        ...
        platform_id: str,
        overrides: shapes.SigningPlatformOverrides = autoboto.ShapeBase.NOT_SET,
        signing_parameters: typing.Dict[str, str] = autoboto.ShapeBase.NOT_SET,
