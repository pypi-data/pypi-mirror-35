...
@dataclasses.dataclass
class DescribeEventBusResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class DescribeRuleResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
    ...
    event_pattern: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
    ...
    state: "RuleState" = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
class EcsParameters(autoboto.ShapeBase):
    ...
    task_count: int = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class ListRuleNamesByTargetResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
class ListTargetsByRuleRequest(autoboto.ShapeBase):
    ...
    # The name of the rule.
    rule: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class ListTargetsByRuleResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
class PutEventsRequestEntry(autoboto.ShapeBase):
    ...
    detail_type: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )

    # A valid JSON string. There is no other schema imposed. The JSON string may
    # contain fields and nested subobjects.
    detail: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class PutRuleResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class PutTargetsResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class RemoveTargetsResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
class Target(autoboto.ShapeBase):
    ...
    input_path: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
class TestEventPatternRequest(autoboto.ShapeBase):
    ...
    event: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )


@dataclasses.dataclass
class TestEventPatternResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
