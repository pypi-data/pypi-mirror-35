...
class AddTagsToCertificateRequest(autoboto.ShapeBase):
    @classmethod
...
@dataclasses.dataclass
class CertificateDetail(autoboto.ShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                ...
                autoboto.TypeInfo(typing.List[DomainValidation]),
            ),
            (
                "serial",
                "Serial",
            ...
            (
                "type",
                "Type",
                autoboto.TypeInfo(CertificateType),
            ),
            (
                "renewal_summary",
                "RenewalSummary",
                autoboto.TypeInfo(RenewalSummary),
            ),
            (
                "key_usages",
                "KeyUsages",
                autoboto.TypeInfo(typing.List[KeyUsage]),
            ),
            (
                "extended_key_usages",
                "ExtendedKeyUsages",
                autoboto.TypeInfo(typing.List[ExtendedKeyUsage]),
            ),
            (
            ...
            (
                "renewal_eligibility",
                "RenewalEligibility",
                autoboto.TypeInfo(RenewalEligibility),
            ),
            (
                "options",
                "Options",
                autoboto.TypeInfo(CertificateOptions),
            ),
        ]
    ...
    type: "CertificateType" = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
...
@dataclasses.dataclass
class CertificateOptions(autoboto.ShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            (
                ...
                autoboto.TypeInfo(CertificateTransparencyLoggingPreference),
            ),
        ]
...
@dataclasses.dataclass
class CertificateSummary(autoboto.ShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "certificate",
                "Certificate",
                autoboto.TypeInfo(CertificateDetail),
            ),
        ]
...
@dataclasses.dataclass
class DomainValidation(autoboto.ShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "resource_record",
                "ResourceRecord",
                autoboto.TypeInfo(ResourceRecord),
            ),
            (
                "validation_method",
                "ValidationMethod",
                autoboto.TypeInfo(ValidationMethod),
            ),
        ]
    ...
    validation_domain: str = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
...
@dataclasses.dataclass
class DomainValidationOption(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class ExportCertificateRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
    ...
    passphrase: typing.Any = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )


@dataclasses.dataclass
class ExportCertificateResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class ExtendedKeyUsage(autoboto.ShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "name",
                "Name",
                autoboto.TypeInfo(ExtendedKeyUsageName),
            ),
            (
                "oid",
                "OID",
    ...
    oid: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class Filters(autoboto.ShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "extended_key_usage",
                "extendedKeyUsage",
                autoboto.TypeInfo(typing.List[ExtendedKeyUsageName]),
            ),
            (
                "key_usage",
                "keyUsage",
                autoboto.TypeInfo(typing.List[KeyUsageName]),
            ),
            (
                "key_types",
                "keyTypes",
                autoboto.TypeInfo(typing.List[KeyAlgorithm]),
            ),
        ]
...
@dataclasses.dataclass
class ImportCertificateRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
    ...
    private_key: typing.Any = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
...
@dataclasses.dataclass
class InvalidDomainValidationOptionsException(autoboto.ShapeBase):
    """
...
@dataclasses.dataclass
class KeyUsage(autoboto.ShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "name",
                "Name",
                autoboto.TypeInfo(KeyUsageName),
            ),
        ]

    # A string value that contains a Key Usage extension name.
    name: "KeyUsageName" = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
    ...
    def _get_boto_mapping(cls):
        return [
            (
                ...
                "CertificateStatuses",
                autoboto.TypeInfo(typing.List[CertificateStatus]),
            ),
            (
                "includes",
                "Includes",
                autoboto.TypeInfo(Filters),
            ),
            (
                "next_token",
                "NextToken",
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                ...
                autoboto.TypeInfo(typing.List[CertificateSummary]),
            ),
        ]
...
@dataclasses.dataclass
class ListTagsForCertificateRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class ListTagsForCertificateResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class RemoveTagsFromCertificateRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class RenewalSummary(autoboto.ShapeBase):
    """
    Contains information about the status of ACM's [managed
    ...
    def _get_boto_mapping(cls):
        return [
            (
                "renewal_status",
                "RenewalStatus",
                autoboto.TypeInfo(RenewalStatus),
            ),
            (
                "domain_validation_options",
                "DomainValidationOptions",
...
@dataclasses.dataclass
class RequestCertificateRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
            ...
            (
                "domain_validation_options",
                "DomainValidationOptions",
                autoboto.TypeInfo(typing.List[DomainValidationOption]),
            ),
            (
                "options",
                "Options",
...
@dataclasses.dataclass
class RequestCertificateResponse(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class ResendValidationEmailRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class UpdateCertificateOptionsRequest(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
