...
@dataclasses.dataclass
class BatchMeterUsageResult(autoboto.OutputShapeBase):
    """
...
@dataclasses.dataclass
class MeterUsageResult(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class ResolveCustomerResult(autoboto.OutputShapeBase):
    """
