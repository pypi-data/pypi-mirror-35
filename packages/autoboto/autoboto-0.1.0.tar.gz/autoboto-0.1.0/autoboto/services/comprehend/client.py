...
class Client:
    ...
    def batch_detect_dominant_language(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if text_list is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_entities_detection_jobs(
        ...
        *,
        filter: shapes.EntitiesDetectionJobFilter = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
    ...
    def list_sentiment_detection_jobs(
        ...
        *,
        filter: shapes.SentimentDetectionJobFilter = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
    ...
    def list_topics_detection_jobs(
        ...
        *,
        filter: shapes.TopicsDetectionJobFilter = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
    ...
    def start_dominant_language_detection_job(
        ...
        *,
        ...
        job_name: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if data_access_role_arn is not autoboto.ShapeBase.NOT_SET:
    ...
    def start_topics_detection_job(
        ...
        *,
        ...
        data_access_role_arn: str,
        job_name: str = autoboto.ShapeBase.NOT_SET,
        number_of_topics: int = autoboto.ShapeBase.NOT_SET,
        client_request_token: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if job_name is not autoboto.ShapeBase.NOT_SET:
                _params['job_name'] = job_name
            if number_of_topics is not autoboto.ShapeBase.NOT_SET:
