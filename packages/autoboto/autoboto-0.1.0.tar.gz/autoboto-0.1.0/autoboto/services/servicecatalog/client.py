...
class Client:
    ...
    def accept_portfolio_share(
        ...
        *,
        portfolio_id: str,
        accept_language: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if portfolio_id is not autoboto.ShapeBase.NOT_SET:
                _params['portfolio_id'] = portfolio_id
            if accept_language is not autoboto.ShapeBase.NOT_SET:
    ...
    def associate_principal_with_portfolio(
        ...
        *,
        ...
        if _request is None:
            ...
            if principal_type is not autoboto.ShapeBase.NOT_SET:
    ...
    def associate_product_with_portfolio(
        ...
        *,
        ...
        portfolio_id: str,
        accept_language: str = autoboto.ShapeBase.NOT_SET,
        source_portfolio_id: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if product_id is not autoboto.ShapeBase.NOT_SET:
                _params['product_id'] = product_id
            if portfolio_id is not autoboto.ShapeBase.NOT_SET:
                _params['portfolio_id'] = portfolio_id
            if accept_language is not autoboto.ShapeBase.NOT_SET:
                _params['accept_language'] = accept_language
            if source_portfolio_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def associate_tag_option_with_resource(
        ...
        *,
        ...
        if _request is None:
            ...
            if tag_option_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def copy_product(
        ...
        *,
        ...
        accept_language: str = autoboto.ShapeBase.NOT_SET,
        target_product_id: str = autoboto.ShapeBase.NOT_SET,
        target_product_name: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if source_product_arn is not autoboto.ShapeBase.NOT_SET:
            ...
            if accept_language is not autoboto.ShapeBase.NOT_SET:
                _params['accept_language'] = accept_language
            if target_product_id is not autoboto.ShapeBase.NOT_SET:
                _params['target_product_id'] = target_product_id
            if target_product_name is not autoboto.ShapeBase.NOT_SET:
                _params['target_product_name'] = target_product_name
            if source_provisioning_artifact_identifiers is not autoboto.ShapeBase.NOT_SET:
                _params['source_provisioning_artifact_identifiers'
                       ] = source_provisioning_artifact_identifiers
            if copy_options is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_portfolio(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if display_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_portfolio_share(
        ...
        *,
        ...
        if _request is None:
            ...
            if portfolio_id is not autoboto.ShapeBase.NOT_SET:
                _params['portfolio_id'] = portfolio_id
            if account_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_product(
        ...
        *,
        ...
        accept_language: str = autoboto.ShapeBase.NOT_SET,
        description: str = autoboto.ShapeBase.NOT_SET,
        distributor: str = autoboto.ShapeBase.NOT_SET,
        support_description: str = autoboto.ShapeBase.NOT_SET,
        support_email: str = autoboto.ShapeBase.NOT_SET,
        support_url: str = autoboto.ShapeBase.NOT_SET,
        tags: typing.List[shapes.Tag] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase.NOT_SET:
                _params['name'] = name
            if owner is not autoboto.ShapeBase.NOT_SET:
                _params['owner'] = owner
            if product_type is not autoboto.ShapeBase.NOT_SET:
                _params['product_type'] = product_type
            if provisioning_artifact_parameters is not autoboto.ShapeBase.NOT_SET:
            ...
            if description is not autoboto.ShapeBase.NOT_SET:
                _params['description'] = description
            if distributor is not autoboto.ShapeBase.NOT_SET:
                _params['distributor'] = distributor
            if support_description is not autoboto.ShapeBase.NOT_SET:
                _params['support_description'] = support_description
            if support_email is not autoboto.ShapeBase.NOT_SET:
                _params['support_email'] = support_email
            if support_url is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_provisioned_product_plan(
        ...
        *,
        ...
        idempotency_token: str,
        accept_language: str = autoboto.ShapeBase.NOT_SET,
        notification_arns: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        path_id: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if plan_name is not autoboto.ShapeBase.NOT_SET:
                _params['plan_name'] = plan_name
            if plan_type is not autoboto.ShapeBase.NOT_SET:
                _params['plan_type'] = plan_type
            if product_id is not autoboto.ShapeBase.NOT_SET:
                _params['product_id'] = product_id
            if provisioned_product_name is not autoboto.ShapeBase.NOT_SET:
                _params['provisioned_product_name'] = provisioned_product_name
            if provisioning_artifact_id is not autoboto.ShapeBase.NOT_SET:
                _params['provisioning_artifact_id'] = provisioning_artifact_id
            if idempotency_token is not autoboto.ShapeBase.NOT_SET:
                _params['idempotency_token'] = idempotency_token
            if accept_language is not autoboto.ShapeBase.NOT_SET:
                _params['accept_language'] = accept_language
            if notification_arns is not autoboto.ShapeBase.NOT_SET:
                _params['notification_arns'] = notification_arns
            if path_id is not autoboto.ShapeBase.NOT_SET:
                _params['path_id'] = path_id
            if provisioning_parameters is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_provisioned_product_plan(
        ...
        *,
        plan_id: str,
        accept_language: str = autoboto.ShapeBase.NOT_SET,
        ignore_errors: bool = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if plan_id is not autoboto.ShapeBase.NOT_SET:
                _params['plan_id'] = plan_id
            if accept_language is not autoboto.ShapeBase.NOT_SET:
                _params['accept_language'] = accept_language
            if ignore_errors is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_copy_product_status(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if copy_product_token is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_provisioned_product_plan(
        ...
        *,
        ...
        page_token: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if page_token is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_provisioning_artifact(
        ...
        *,
        ...
        product_id: str,
        accept_language: str = autoboto.ShapeBase.NOT_SET,
        verbose: bool = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if accept_language is not autoboto.ShapeBase.NOT_SET:
                _params['accept_language'] = accept_language
            if verbose is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_accepted_portfolio_shares(
        ...
        *,
        ...
        if _request is None:
            ...
            if page_size is not autoboto.ShapeBase.NOT_SET:
                _params['page_size'] = page_size
            if portfolio_share_type is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_constraints_for_portfolio(
        ...
        *,
        portfolio_id: str,
        accept_language: str = autoboto.ShapeBase.NOT_SET,
        product_id: str = autoboto.ShapeBase.NOT_SET,
        page_size: int = autoboto.ShapeBase.NOT_SET,
        page_token: str = autoboto.ShapeBase.NOT_SET,
    ...
    def list_provisioned_product_plans(
        ...
        *,
        accept_language: str = autoboto.ShapeBase.NOT_SET,
        provision_product_id: str = autoboto.ShapeBase.NOT_SET,
        page_size: int = autoboto.ShapeBase.NOT_SET,
        page_token: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if accept_language is not autoboto.ShapeBase.NOT_SET:
                _params['accept_language'] = accept_language
            if provision_product_id is not autoboto.ShapeBase.NOT_SET:
                _params['provision_product_id'] = provision_product_id
            if page_size is not autoboto.ShapeBase.NOT_SET:
                _params['page_size'] = page_size
            if page_token is not autoboto.ShapeBase.NOT_SET:
                _params['page_token'] = page_token
            if access_level_filter is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_record_history(
        ...
        *,
        ...
        if _request is None:
            ...
            if access_level_filter is not autoboto.ShapeBase.NOT_SET:
                _params['access_level_filter'] = access_level_filter
            if search_filter is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_tag_options(
        ...
        *,
        filters: shapes.ListTagOptionsFilters = autoboto.ShapeBase.NOT_SET,
        page_size: int = autoboto.ShapeBase.NOT_SET,
        page_token: str = autoboto.ShapeBase.NOT_SET,
    ...
    def provision_product(
        ...
        *,
        ...
        if _request is None:
            ...
            if provisioned_product_name is not autoboto.ShapeBase.NOT_SET:
                _params['provisioned_product_name'] = provisioned_product_name
            if provision_token is not autoboto.ShapeBase.NOT_SET:
    ...
    def search_products(
        ...
        *,
        ...
        page_size: int = autoboto.ShapeBase.NOT_SET,
        sort_by: shapes.ProductViewSortBy = autoboto.ShapeBase.NOT_SET,
    ...
    def search_products_as_admin(
        ...
        *,
        accept_language: str = autoboto.ShapeBase.NOT_SET,
        portfolio_id: str = autoboto.ShapeBase.NOT_SET,
        filters: typing.Dict[shapes.ProductViewFilterBy, typing.List[str]
                            ] = autoboto.ShapeBase.NOT_SET,
        sort_by: shapes.ProductViewSortBy = autoboto.ShapeBase.NOT_SET,
        sort_order: shapes.SortOrder = autoboto.ShapeBase.NOT_SET,
        page_token: str = autoboto.ShapeBase.NOT_SET,
        page_size: int = autoboto.ShapeBase.NOT_SET,
        product_source: shapes.ProductSource = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if page_size is not autoboto.ShapeBase.NOT_SET:
                _params['page_size'] = page_size
            if product_source is not autoboto.ShapeBase.NOT_SET:
    ...
    def search_provisioned_products(
        ...
        *,
        ...
        filters: typing.Dict[shapes.ProvisionedProductViewFilterBy,
                             typing.List[str]] = autoboto.ShapeBase.NOT_SET,
        sort_by: str = autoboto.ShapeBase.NOT_SET,
        sort_order: shapes.SortOrder = autoboto.ShapeBase.NOT_SET,
        page_size: int = autoboto.ShapeBase.NOT_SET,
        page_token: str = autoboto.ShapeBase.NOT_SET,
    ...
    def terminate_provisioned_product(
        ...
        *,
        terminate_token: str,
        provisioned_product_name: str = autoboto.ShapeBase.NOT_SET,
        provisioned_product_id: str = autoboto.ShapeBase.NOT_SET,
        ignore_errors: bool = autoboto.ShapeBase.NOT_SET,
        accept_language: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if terminate_token is not autoboto.ShapeBase.NOT_SET:
                _params['terminate_token'] = terminate_token
            if provisioned_product_name is not autoboto.ShapeBase.NOT_SET:
                _params['provisioned_product_name'] = provisioned_product_name
            if provisioned_product_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_portfolio(
        ...
        *,
        id: str,
        accept_language: str = autoboto.ShapeBase.NOT_SET,
        display_name: str = autoboto.ShapeBase.NOT_SET,
        description: str = autoboto.ShapeBase.NOT_SET,
        provider_name: str = autoboto.ShapeBase.NOT_SET,
        add_tags: typing.List[shapes.Tag] = autoboto.ShapeBase.NOT_SET,
        remove_tags: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if remove_tags is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_product(
        ...
        *,
        ...
        owner: str = autoboto.ShapeBase.NOT_SET,
        description: str = autoboto.ShapeBase.NOT_SET,
        distributor: str = autoboto.ShapeBase.NOT_SET,
        support_description: str = autoboto.ShapeBase.NOT_SET,
        support_email: str = autoboto.ShapeBase.NOT_SET,
    ...
    def update_provisioned_product(
        ...
        *,
        ...
        provisioned_product_id: str = autoboto.ShapeBase.NOT_SET,
        product_id: str = autoboto.ShapeBase.NOT_SET,
        provisioning_artifact_id: str = autoboto.ShapeBase.NOT_SET,
        path_id: str = autoboto.ShapeBase.NOT_SET,
        provisioning_parameters: typing.List[shapes.UpdateProvisioningParameter
                                            ] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if update_token is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_provisioning_artifact(
        ...
        *,
        ...
        name: str = autoboto.ShapeBase.NOT_SET,
        description: str = autoboto.ShapeBase.NOT_SET,
        active: bool = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if description is not autoboto.ShapeBase.NOT_SET:
                _params['description'] = description
            if active is not autoboto.ShapeBase.NOT_SET:
