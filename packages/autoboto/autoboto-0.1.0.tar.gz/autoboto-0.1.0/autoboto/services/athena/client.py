...
class Client:
    ...
    def batch_get_named_query(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if named_query_ids is not autoboto.ShapeBase.NOT_SET:
    ...
    def batch_get_query_execution(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if query_execution_ids is not autoboto.ShapeBase.NOT_SET:
        ...
        *,
        ...
        if _request is None:
            ...
            if name is not autoboto.ShapeBase.NOT_SET:
                _params['name'] = name
            if database is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_named_query(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if named_query_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_query_execution(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if query_execution_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def start_query_execution(
        ...
        *,
        ...
        if _request is None:
            ...
            if query_string is not autoboto.ShapeBase.NOT_SET:
                _params['query_string'] = query_string
            if result_configuration is not autoboto.ShapeBase.NOT_SET:
                _params['result_configuration'] = result_configuration
            if client_request_token is not autoboto.ShapeBase.NOT_SET:
                _params['client_request_token'] = client_request_token
            if query_execution_context is not autoboto.ShapeBase.NOT_SET:
