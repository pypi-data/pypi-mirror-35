...
class Client:
    ...
    def abort_multipart_upload(
        ...
        *,
        ...
        if _request is None:
            ...
            if vault_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def complete_multipart_upload(
        ...
        *,
        ...
        vault_name: str,
        upload_id: str,
        archive_size: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if upload_id is not autoboto.ShapeBase.NOT_SET:
                _params['upload_id'] = upload_id
            if archive_size is not autoboto.ShapeBase.NOT_SET:
    ...
    def complete_vault_lock(
        ...
        *,
        ...
        if _request is None:
            ...
            if vault_name is not autoboto.ShapeBase.NOT_SET:
                _params['vault_name'] = vault_name
            if lock_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_archive(
        ...
        *,
        ...
        if _request is None:
            ...
            if vault_name is not autoboto.ShapeBase.NOT_SET:
                _params['vault_name'] = vault_name
            if archive_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def initiate_job(
        ...
        *,
        account_id: str,
        vault_name: str,
        job_parameters: shapes.JobParameters = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if vault_name is not autoboto.ShapeBase.NOT_SET:
                _params['vault_name'] = vault_name
            if job_parameters is not autoboto.ShapeBase.NOT_SET:
    ...
    def initiate_multipart_upload(
        ...
        *,
        account_id: str,
        vault_name: str,
        archive_description: str = autoboto.ShapeBase.NOT_SET,
        part_size: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if vault_name is not autoboto.ShapeBase.NOT_SET:
                _params['vault_name'] = vault_name
            if archive_description is not autoboto.ShapeBase.NOT_SET:
                _params['archive_description'] = archive_description
            if part_size is not autoboto.ShapeBase.NOT_SET:
    ...
    def initiate_vault_lock(
        ...
        *,
        account_id: str,
        vault_name: str,
        policy: shapes.VaultLockPolicy = autoboto.ShapeBase.NOT_SET,
    ...
    def list_jobs(
        ...
        *,
        account_id: str,
        vault_name: str,
        limit: str = autoboto.ShapeBase.NOT_SET,
        marker: str = autoboto.ShapeBase.NOT_SET,
        statuscode: str = autoboto.ShapeBase.NOT_SET,
        completed: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if statuscode is not autoboto.ShapeBase.NOT_SET:
                _params['statuscode'] = statuscode
            if completed is not autoboto.ShapeBase.NOT_SET:
    ...
    def set_data_retrieval_policy(
        ...
        *,
        account_id: str,
        policy: shapes.DataRetrievalPolicy = autoboto.ShapeBase.NOT_SET,
    ) -> None:
        """
    ...
    def set_vault_access_policy(
        ...
        *,
        account_id: str,
        vault_name: str,
        policy: shapes.VaultAccessPolicy = autoboto.ShapeBase.NOT_SET,
    ) -> None:
        """
    ...
    def set_vault_notifications(
        ...
        *,
        ...
        if _request is None:
            ...
            if vault_name is not autoboto.ShapeBase.NOT_SET:
                _params['vault_name'] = vault_name
            if vault_notification_config is not autoboto.ShapeBase.NOT_SET:
