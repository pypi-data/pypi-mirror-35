...
class Client:
    ...
    def accept_reserved_node_exchange(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if reserved_node_id is not autoboto.ShapeBase.NOT_SET:
                _params['reserved_node_id'] = reserved_node_id
            if target_reserved_node_offering_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def authorize_cluster_security_group_ingress(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if cluster_security_group_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def authorize_snapshot_access(
        ...
        *,
        ...
        snapshot_cluster_identifier: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if account_with_restore_access is not autoboto.ShapeBase.NOT_SET:
                _params['account_with_restore_access'
                       ] = account_with_restore_access
            if snapshot_cluster_identifier is not autoboto.ShapeBase.NOT_SET:
    ...
    def copy_cluster_snapshot(
        ...
        *,
        ...
        source_snapshot_cluster_identifier: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if source_snapshot_identifier is not autoboto.ShapeBase.NOT_SET:
                _params['source_snapshot_identifier'
                       ] = source_snapshot_identifier
            if target_snapshot_identifier is not autoboto.ShapeBase.NOT_SET:
                _params['target_snapshot_identifier'
                       ] = target_snapshot_identifier
            if source_snapshot_cluster_identifier is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_cluster(
        ...
        *,
        ...
        cluster_type: str = autoboto.ShapeBase.NOT_SET,
        cluster_security_groups: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        vpc_security_group_ids: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        cluster_subnet_group_name: str = autoboto.ShapeBase.NOT_SET,
        availability_zone: str = autoboto.ShapeBase.NOT_SET,
        preferred_maintenance_window: str = autoboto.ShapeBase.NOT_SET,
        cluster_parameter_group_name: str = autoboto.ShapeBase.NOT_SET,
        automated_snapshot_retention_period: int = autoboto.ShapeBase.NOT_SET,
        port: int = autoboto.ShapeBase.NOT_SET,
        cluster_version: str = autoboto.ShapeBase.NOT_SET,
        allow_version_upgrade: bool = autoboto.ShapeBase.NOT_SET,
        number_of_nodes: int = autoboto.ShapeBase.NOT_SET,
        publicly_accessible: bool = autoboto.ShapeBase.NOT_SET,
        encrypted: bool = autoboto.ShapeBase.NOT_SET,
        hsm_client_certificate_identifier: str = autoboto.ShapeBase.NOT_SET,
        hsm_configuration_identifier: str = autoboto.ShapeBase.NOT_SET,
        elastic_ip: str = autoboto.ShapeBase.NOT_SET,
        tags: typing.List[shapes.Tag] = autoboto.ShapeBase.NOT_SET,
        kms_key_id: str = autoboto.ShapeBase.NOT_SET,
        enhanced_vpc_routing: bool = autoboto.ShapeBase.NOT_SET,
        additional_info: str = autoboto.ShapeBase.NOT_SET,
        iam_roles: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        maintenance_track_name: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if cluster_identifier is not autoboto.ShapeBase.NOT_SET:
                _params['cluster_identifier'] = cluster_identifier
            if node_type is not autoboto.ShapeBase.NOT_SET:
            ...
            if cluster_type is not autoboto.ShapeBase.NOT_SET:
                _params['cluster_type'] = cluster_type
            if cluster_security_groups is not autoboto.ShapeBase.NOT_SET:
            ...
            if cluster_subnet_group_name is not autoboto.ShapeBase.NOT_SET:
            ...
            if cluster_parameter_group_name is not autoboto.ShapeBase.NOT_SET:
                _params['cluster_parameter_group_name'
                       ] = cluster_parameter_group_name
            if automated_snapshot_retention_period is not autoboto.ShapeBase.NOT_SET:
                _params['automated_snapshot_retention_period'
                       ] = automated_snapshot_retention_period
            if port is not autoboto.ShapeBase.NOT_SET:
                _params['port'] = port
            if cluster_version is not autoboto.ShapeBase.NOT_SET:
                _params['cluster_version'] = cluster_version
            if allow_version_upgrade is not autoboto.ShapeBase.NOT_SET:
                _params['allow_version_upgrade'] = allow_version_upgrade
            if number_of_nodes is not autoboto.ShapeBase.NOT_SET:
            ...
            if hsm_client_certificate_identifier is not autoboto.ShapeBase.NOT_SET:
                _params['hsm_client_certificate_identifier'
                       ] = hsm_client_certificate_identifier
            if hsm_configuration_identifier is not autoboto.ShapeBase.NOT_SET:
            ...
            if enhanced_vpc_routing is not autoboto.ShapeBase.NOT_SET:
            ...
            if iam_roles is not autoboto.ShapeBase.NOT_SET:
                _params['iam_roles'] = iam_roles
            if maintenance_track_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_cluster_parameter_group(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if parameter_group_name is not autoboto.ShapeBase.NOT_SET:
                _params['parameter_group_name'] = parameter_group_name
            if parameter_group_family is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_event_subscription(
        ...
        *,
        ...
        severity: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if severity is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_hsm_configuration(
        ...
        *,
        ...
        if _request is None:
            ...
            if description is not autoboto.ShapeBase.NOT_SET:
                _params['description'] = description
            if hsm_ip_address is not autoboto.ShapeBase.NOT_SET:
                _params['hsm_ip_address'] = hsm_ip_address
            if hsm_partition_name is not autoboto.ShapeBase.NOT_SET:
                _params['hsm_partition_name'] = hsm_partition_name
            if hsm_partition_password is not autoboto.ShapeBase.NOT_SET:
                _params['hsm_partition_password'] = hsm_partition_password
            if hsm_server_public_certificate is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_snapshot_copy_grant(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if snapshot_copy_grant_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_cluster(
        ...
        *,
        cluster_identifier: str,
        skip_final_cluster_snapshot: bool = autoboto.ShapeBase.NOT_SET,
        final_cluster_snapshot_identifier: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if cluster_identifier is not autoboto.ShapeBase.NOT_SET:
                _params['cluster_identifier'] = cluster_identifier
            if skip_final_cluster_snapshot is not autoboto.ShapeBase.NOT_SET:
                _params['skip_final_cluster_snapshot'
                       ] = skip_final_cluster_snapshot
            if final_cluster_snapshot_identifier is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_cluster_db_revisions(
        ...
        *,
        cluster_identifier: str = autoboto.ShapeBase.NOT_SET,
    ...
    def describe_cluster_parameter_groups(
        ...
        *,
        parameter_group_name: str = autoboto.ShapeBase.NOT_SET,
        max_records: int = autoboto.ShapeBase.NOT_SET,
        marker: str = autoboto.ShapeBase.NOT_SET,
        tag_keys: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        tag_values: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if tag_keys is not autoboto.ShapeBase.NOT_SET:
                _params['tag_keys'] = tag_keys
            if tag_values is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_cluster_security_groups(
        ...
        *,
        cluster_security_group_name: str = autoboto.ShapeBase.NOT_SET,
        max_records: int = autoboto.ShapeBase.NOT_SET,
        marker: str = autoboto.ShapeBase.NOT_SET,
        tag_keys: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        tag_values: typing.List[str] = autoboto.ShapeBase.NOT_SET,
    ...
    def describe_cluster_snapshots(
        ...
        *,
        cluster_identifier: str = autoboto.ShapeBase.NOT_SET,
        snapshot_identifier: str = autoboto.ShapeBase.NOT_SET,
        ...
        max_records: int = autoboto.ShapeBase.NOT_SET,
        marker: str = autoboto.ShapeBase.NOT_SET,
        owner_account: str = autoboto.ShapeBase.NOT_SET,
        tag_keys: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        tag_values: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        cluster_exists: bool = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if marker is not autoboto.ShapeBase.NOT_SET:
                _params['marker'] = marker
            if owner_account is not autoboto.ShapeBase.NOT_SET:
                _params['owner_account'] = owner_account
            if tag_keys is not autoboto.ShapeBase.NOT_SET:
                _params['tag_keys'] = tag_keys
            if tag_values is not autoboto.ShapeBase.NOT_SET:
                _params['tag_values'] = tag_values
            if cluster_exists is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_cluster_versions(
        ...
        *,
        cluster_version: str = autoboto.ShapeBase.NOT_SET,
        cluster_parameter_group_family: str = autoboto.ShapeBase.NOT_SET,
        max_records: int = autoboto.ShapeBase.NOT_SET,
        marker: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if cluster_version is not autoboto.ShapeBase.NOT_SET:
                _params['cluster_version'] = cluster_version
            if cluster_parameter_group_family is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_orderable_cluster_options(
        ...
        *,
        cluster_version: str = autoboto.ShapeBase.NOT_SET,
        node_type: str = autoboto.ShapeBase.NOT_SET,
        max_records: int = autoboto.ShapeBase.NOT_SET,
        marker: str = autoboto.ShapeBase.NOT_SET,
    ...
    def describe_reserved_node_offerings(
        ...
        *,
        reserved_node_offering_id: str = autoboto.ShapeBase.NOT_SET,
        max_records: int = autoboto.ShapeBase.NOT_SET,
        marker: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if reserved_node_offering_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_reserved_nodes(
        ...
        *,
        reserved_node_id: str = autoboto.ShapeBase.NOT_SET,
        max_records: int = autoboto.ShapeBase.NOT_SET,
        marker: str = autoboto.ShapeBase.NOT_SET,
    ...
    def describe_snapshot_copy_grants(
        ...
        *,
        snapshot_copy_grant_name: str = autoboto.ShapeBase.NOT_SET,
        max_records: int = autoboto.ShapeBase.NOT_SET,
        marker: str = autoboto.ShapeBase.NOT_SET,
        tag_keys: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        tag_values: typing.List[str] = autoboto.ShapeBase.NOT_SET,
    ...
    def describe_table_restore_status(
        ...
        *,
        cluster_identifier: str = autoboto.ShapeBase.NOT_SET,
        table_restore_request_id: str = autoboto.ShapeBase.NOT_SET,
        max_records: int = autoboto.ShapeBase.NOT_SET,
        marker: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if cluster_identifier is not autoboto.ShapeBase.NOT_SET:
                _params['cluster_identifier'] = cluster_identifier
            if table_restore_request_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_tags(
        ...
        *,
        resource_name: str = autoboto.ShapeBase.NOT_SET,
        resource_type: str = autoboto.ShapeBase.NOT_SET,
        max_records: int = autoboto.ShapeBase.NOT_SET,
        marker: str = autoboto.ShapeBase.NOT_SET,
        tag_keys: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        tag_values: typing.List[str] = autoboto.ShapeBase.NOT_SET,
    ...
    def enable_logging(
        ...
        *,
        cluster_identifier: str,
        bucket_name: str,
        s3_key_prefix: str = autoboto.ShapeBase.NOT_SET,
    ) -> shapes.LoggingStatus:
        """
        ...
        if _request is None:
            ...
            if cluster_identifier is not autoboto.ShapeBase.NOT_SET:
                _params['cluster_identifier'] = cluster_identifier
            if bucket_name is not autoboto.ShapeBase.NOT_SET:
                _params['bucket_name'] = bucket_name
            if s3_key_prefix is not autoboto.ShapeBase.NOT_SET:
    ...
    def enable_snapshot_copy(
        ...
        *,
        ...
        retention_period: int = autoboto.ShapeBase.NOT_SET,
        snapshot_copy_grant_name: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if retention_period is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_cluster_credentials(
        ...
        *,
        ...
        cluster_identifier: str,
        db_name: str = autoboto.ShapeBase.NOT_SET,
        duration_seconds: int = autoboto.ShapeBase.NOT_SET,
        auto_create: bool = autoboto.ShapeBase.NOT_SET,
        db_groups: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if db_name is not autoboto.ShapeBase.NOT_SET:
                _params['db_name'] = db_name
            if duration_seconds is not autoboto.ShapeBase.NOT_SET:
                _params['duration_seconds'] = duration_seconds
            if auto_create is not autoboto.ShapeBase.NOT_SET:
                _params['auto_create'] = auto_create
            if db_groups is not autoboto.ShapeBase.NOT_SET:
    ...
    def modify_cluster(
        ...
        *,
        ...
        hsm_client_certificate_identifier: str = autoboto.ShapeBase.NOT_SET,
        hsm_configuration_identifier: str = autoboto.ShapeBase.NOT_SET,
        new_cluster_identifier: str = autoboto.ShapeBase.NOT_SET,
        publicly_accessible: bool = autoboto.ShapeBase.NOT_SET,
        elastic_ip: str = autoboto.ShapeBase.NOT_SET,
        enhanced_vpc_routing: bool = autoboto.ShapeBase.NOT_SET,
        maintenance_track_name: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if new_cluster_identifier is not autoboto.ShapeBase.NOT_SET:
    ...
    def modify_cluster_db_revision(
        ...
        *,
        ...
        if _request is None:
            ...
            if cluster_identifier is not autoboto.ShapeBase.NOT_SET:
                _params['cluster_identifier'] = cluster_identifier
            if revision_target is not autoboto.ShapeBase.NOT_SET:
    ...
    def modify_cluster_iam_roles(
        ...
        *,
        cluster_identifier: str,
        add_iam_roles: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        remove_iam_roles: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if cluster_identifier is not autoboto.ShapeBase.NOT_SET:
                _params['cluster_identifier'] = cluster_identifier
            if add_iam_roles is not autoboto.ShapeBase.NOT_SET:
                _params['add_iam_roles'] = add_iam_roles
            if remove_iam_roles is not autoboto.ShapeBase.NOT_SET:
    ...
    def purchase_reserved_node_offering(
        ...
        *,
        ...
        node_count: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if reserved_node_offering_id is not autoboto.ShapeBase.NOT_SET:
                _params['reserved_node_offering_id'] = reserved_node_offering_id
            if node_count is not autoboto.ShapeBase.NOT_SET:
    ...
    def resize_cluster(
        ...
        *,
        ...
        cluster_type: str = autoboto.ShapeBase.NOT_SET,
        node_type: str = autoboto.ShapeBase.NOT_SET,
        classic: bool = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if node_type is not autoboto.ShapeBase.NOT_SET:
                _params['node_type'] = node_type
            if classic is not autoboto.ShapeBase.NOT_SET:
    ...
    def restore_table_from_cluster_snapshot(
        ...
        *,
        ...
        new_table_name: str,
        source_schema_name: str = autoboto.ShapeBase.NOT_SET,
        target_database_name: str = autoboto.ShapeBase.NOT_SET,
        target_schema_name: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if snapshot_identifier is not autoboto.ShapeBase.NOT_SET:
                _params['snapshot_identifier'] = snapshot_identifier
            if source_database_name is not autoboto.ShapeBase.NOT_SET:
                _params['source_database_name'] = source_database_name
            if source_table_name is not autoboto.ShapeBase.NOT_SET:
                _params['source_table_name'] = source_table_name
            if new_table_name is not autoboto.ShapeBase.NOT_SET:
                _params['new_table_name'] = new_table_name
            if source_schema_name is not autoboto.ShapeBase.NOT_SET:
                _params['source_schema_name'] = source_schema_name
            if target_database_name is not autoboto.ShapeBase.NOT_SET:
                _params['target_database_name'] = target_database_name
            if target_schema_name is not autoboto.ShapeBase.NOT_SET:
