...
class Client:
    ...
    def generate_data_set(
        ...
        *,
        ...
        sns_topic_arn: str,
        destination_s3_prefix: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if data_set_type is not autoboto.ShapeBase.NOT_SET:
                _params['data_set_type'] = data_set_type
            if data_set_publication_date is not autoboto.ShapeBase.NOT_SET:
                _params['data_set_publication_date'] = data_set_publication_date
            if role_name_arn is not autoboto.ShapeBase.NOT_SET:
                _params['role_name_arn'] = role_name_arn
            if destination_s3_bucket_name is not autoboto.ShapeBase.NOT_SET:
            ...
            if destination_s3_prefix is not autoboto.ShapeBase.NOT_SET:
                _params['destination_s3_prefix'] = destination_s3_prefix
            if customer_defined_values is not autoboto.ShapeBase.NOT_SET:
    ...
    def start_support_data_export(
        ...
        *,
        ...
        if _request is None:
            ...
            if data_set_type is not autoboto.ShapeBase.NOT_SET:
                _params['data_set_type'] = data_set_type
            if from_date is not autoboto.ShapeBase.NOT_SET:
