...
class Client:
    ...
    def associate_configuration_items_to_application(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if application_configuration_id is not autoboto.ShapeBase.NOT_SET:
                _params['application_configuration_id'
                       ] = application_configuration_id
            if configuration_ids is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_agents(
        ...
        *,
        agent_ids: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if agent_ids is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_continuous_exports(
        ...
        *,
        export_ids: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if export_ids is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_export_tasks(
        ...
        *,
        export_ids: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        filters: typing.List[shapes.ExportFilter] = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
    ...
    def describe_tags(
        ...
        *,
        filters: typing.List[shapes.TagFilter] = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
    ...
    def list_configurations(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if configuration_type is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_server_neighbors(
        ...
        *,
        ...
        port_information_needed: bool = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if port_information_needed is not autoboto.ShapeBase.NOT_SET:
                _params['port_information_needed'] = port_information_needed
            if neighbor_configuration_ids is not autoboto.ShapeBase.NOT_SET:
    ...
    def start_export_task(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if export_data_format is not autoboto.ShapeBase.NOT_SET:
    ...
    def stop_continuous_export(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if export_id is not autoboto.ShapeBase.NOT_SET:
