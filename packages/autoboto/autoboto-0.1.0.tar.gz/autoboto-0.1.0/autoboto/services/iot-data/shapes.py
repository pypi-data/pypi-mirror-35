...
@dataclasses.dataclass
class DeleteThingShadowResponse(autoboto.OutputShapeBase):
    """
...
@dataclasses.dataclass
class GetThingShadowResponse(autoboto.OutputShapeBase):
    """
...
class PublishRequest(autoboto.ShapeBase):
    ...
    qos: int = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class UpdateThingShadowResponse(autoboto.OutputShapeBase):
    """
