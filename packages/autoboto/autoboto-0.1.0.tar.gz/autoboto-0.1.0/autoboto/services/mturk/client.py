...
class Client:
    ...
    def accept_qualification_request(
        ...
        *,
        ...
        integer_value: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if qualification_request_id is not autoboto.ShapeBase.NOT_SET:
                _params['qualification_request_id'] = qualification_request_id
            if integer_value is not autoboto.ShapeBase.NOT_SET:
    ...
    def approve_assignment(
        ...
        *,
        assignment_id: str,
        requester_feedback: str = autoboto.ShapeBase.NOT_SET,
        override_rejection: bool = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if assignment_id is not autoboto.ShapeBase.NOT_SET:
                _params['assignment_id'] = assignment_id
            if requester_feedback is not autoboto.ShapeBase.NOT_SET:
                _params['requester_feedback'] = requester_feedback
            if override_rejection is not autoboto.ShapeBase.NOT_SET:
    ...
    def associate_qualification_with_worker(
        ...
        *,
        ...
        worker_id: str,
        integer_value: int = autoboto.ShapeBase.NOT_SET,
        send_notification: bool = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if qualification_type_id is not autoboto.ShapeBase.NOT_SET:
                _params['qualification_type_id'] = qualification_type_id
            if worker_id is not autoboto.ShapeBase.NOT_SET:
                _params['worker_id'] = worker_id
            if integer_value is not autoboto.ShapeBase.NOT_SET:
                _params['integer_value'] = integer_value
            if send_notification is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_additional_assignments_for_hit(
        ...
        *,
        ...
        unique_request_token: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if hit_id is not autoboto.ShapeBase.NOT_SET:
                _params['hit_id'] = hit_id
            if number_of_additional_assignments is not autoboto.ShapeBase.NOT_SET:
                _params['number_of_additional_assignments'
                       ] = number_of_additional_assignments
            if unique_request_token is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_hit(
        ...
        *,
        ...
        title: str,
        description: str,
        max_assignments: int = autoboto.ShapeBase.NOT_SET,
        auto_approval_delay_in_seconds: int = autoboto.ShapeBase.NOT_SET,
        keywords: str = autoboto.ShapeBase.NOT_SET,
        question: str = autoboto.ShapeBase.NOT_SET,
        requester_annotation: str = autoboto.ShapeBase.NOT_SET,
        ...
        NOT_SET,
        hit_review_policy: shapes.ReviewPolicy = autoboto.ShapeBase.NOT_SET,
        hit_layout_id: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if lifetime_in_seconds is not autoboto.ShapeBase.NOT_SET:
                _params['lifetime_in_seconds'] = lifetime_in_seconds
            if assignment_duration_in_seconds is not autoboto.ShapeBase.NOT_SET:
                _params['assignment_duration_in_seconds'
                       ] = assignment_duration_in_seconds
            if reward is not autoboto.ShapeBase.NOT_SET:
                _params['reward'] = reward
            if title is not autoboto.ShapeBase.NOT_SET:
                _params['title'] = title
            if description is not autoboto.ShapeBase.NOT_SET:
                _params['description'] = description
            if max_assignments is not autoboto.ShapeBase.NOT_SET:
                _params['max_assignments'] = max_assignments
            if auto_approval_delay_in_seconds is not autoboto.ShapeBase.NOT_SET:
                _params['auto_approval_delay_in_seconds'
                       ] = auto_approval_delay_in_seconds
            if keywords is not autoboto.ShapeBase.NOT_SET:
                _params['keywords'] = keywords
            if question is not autoboto.ShapeBase.NOT_SET:
                _params['question'] = question
            if requester_annotation is not autoboto.ShapeBase.NOT_SET:
                _params['requester_annotation'] = requester_annotation
            if qualification_requirements is not autoboto.ShapeBase.NOT_SET:
                _params['qualification_requirements'
                       ] = qualification_requirements
            if unique_request_token is not autoboto.ShapeBase.NOT_SET:
                _params['unique_request_token'] = unique_request_token
            if assignment_review_policy is not autoboto.ShapeBase.NOT_SET:
                _params['assignment_review_policy'] = assignment_review_policy
            if hit_review_policy is not autoboto.ShapeBase.NOT_SET:
                _params['hit_review_policy'] = hit_review_policy
            if hit_layout_id is not autoboto.ShapeBase.NOT_SET:
                _params['hit_layout_id'] = hit_layout_id
            if hit_layout_parameters is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_hit_with_hit_type(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if hit_type_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_qualification_type(
        ...
        *,
        ...
        keywords: str = autoboto.ShapeBase.NOT_SET,
        retry_delay_in_seconds: int = autoboto.ShapeBase.NOT_SET,
        test: str = autoboto.ShapeBase.NOT_SET,
        answer_key: str = autoboto.ShapeBase.NOT_SET,
        test_duration_in_seconds: int = autoboto.ShapeBase.NOT_SET,
        auto_granted: bool = autoboto.ShapeBase.NOT_SET,
        auto_granted_value: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if description is not autoboto.ShapeBase.NOT_SET:
                _params['description'] = description
            if qualification_type_status is not autoboto.ShapeBase.NOT_SET:
                _params['qualification_type_status'] = qualification_type_status
            if keywords is not autoboto.ShapeBase.NOT_SET:
                _params['keywords'] = keywords
            if retry_delay_in_seconds is not autoboto.ShapeBase.NOT_SET:
                _params['retry_delay_in_seconds'] = retry_delay_in_seconds
            if test is not autoboto.ShapeBase.NOT_SET:
                _params['test'] = test
            if answer_key is not autoboto.ShapeBase.NOT_SET:
                _params['answer_key'] = answer_key
            if test_duration_in_seconds is not autoboto.ShapeBase.NOT_SET:
                _params['test_duration_in_seconds'] = test_duration_in_seconds
            if auto_granted is not autoboto.ShapeBase.NOT_SET:
                _params['auto_granted'] = auto_granted
            if auto_granted_value is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_file_upload_url(
        ...
        *,
        ...
        if _request is None:
            ...
            if assignment_id is not autoboto.ShapeBase.NOT_SET:
                _params['assignment_id'] = assignment_id
            if question_identifier is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_assignments_for_hit(
        ...
        *,
        ...
        if _request is None:
            ...
            if assignment_statuses is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_bonus_payments(
        ...
        *,
        hit_id: str = autoboto.ShapeBase.NOT_SET,
        assignment_id: str = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
    ...
    def list_qualification_requests(
        ...
        *,
        qualification_type_id: str = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
    ...
    def list_qualification_types(
        ...
        *,
        ...
        must_be_owned_by_caller: bool = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if must_be_requestable is not autoboto.ShapeBase.NOT_SET:
                _params['must_be_requestable'] = must_be_requestable
            if query is not autoboto.ShapeBase.NOT_SET:
                _params['query'] = query
            if must_be_owned_by_caller is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_review_policy_results_for_hit(
        ...
        *,
        ...
        retrieve_actions: bool = autoboto.ShapeBase.NOT_SET,
        retrieve_results: bool = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if hit_id is not autoboto.ShapeBase.NOT_SET:
                _params['hit_id'] = hit_id
            if policy_levels is not autoboto.ShapeBase.NOT_SET:
                _params['policy_levels'] = policy_levels
            if retrieve_actions is not autoboto.ShapeBase.NOT_SET:
                _params['retrieve_actions'] = retrieve_actions
            if retrieve_results is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_reviewable_hits(
        ...
        *,
        hit_type_id: str = autoboto.ShapeBase.NOT_SET,
        status: shapes.ReviewableHITStatus = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
    ...
    def list_workers_with_qualification_type(
        ...
        *,
        qualification_type_id: str,
        status: shapes.QualificationStatus = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
    ...
    def notify_workers(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if subject is not autoboto.ShapeBase.NOT_SET:
                _params['subject'] = subject
            if message_text is not autoboto.ShapeBase.NOT_SET:
                _params['message_text'] = message_text
            if worker_ids is not autoboto.ShapeBase.NOT_SET:
    ...
    def send_bonus(
        ...
        *,
        ...
        if _request is None:
            ...
            if worker_id is not autoboto.ShapeBase.NOT_SET:
                _params['worker_id'] = worker_id
            if bonus_amount is not autoboto.ShapeBase.NOT_SET:
    ...
    def send_test_event_notification(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if notification is not autoboto.ShapeBase.NOT_SET:
                _params['notification'] = notification
            if test_event_type is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_expiration_for_hit(
        ...
        *,
        ...
        if _request is None:
            ...
            if hit_id is not autoboto.ShapeBase.NOT_SET:
                _params['hit_id'] = hit_id
            if expire_at is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_hit_review_status(
        ...
        *,
        hit_id: str,
        revert: bool = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if hit_id is not autoboto.ShapeBase.NOT_SET:
                _params['hit_id'] = hit_id
            if revert is not autoboto.ShapeBase.NOT_SET:
