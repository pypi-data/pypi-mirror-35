...
class Client:
    ...
    def add_attachments_to_set(
        ...
        *,
        ...
        attachment_set_id: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if attachment_set_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def add_communication_to_case(
        ...
        *,
        ...
        case_id: str = autoboto.ShapeBase.NOT_SET,
        cc_email_addresses: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        attachment_set_id: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if communication_body is not autoboto.ShapeBase.NOT_SET:
                _params['communication_body'] = communication_body
            if case_id is not autoboto.ShapeBase.NOT_SET:
                _params['case_id'] = case_id
            if cc_email_addresses is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_case(
        ...
        *,
        subject: str,
        communication_body: str,
        service_code: str = autoboto.ShapeBase.NOT_SET,
        severity_code: str = autoboto.ShapeBase.NOT_SET,
        category_code: str = autoboto.ShapeBase.NOT_SET,
        cc_email_addresses: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        language: str = autoboto.ShapeBase.NOT_SET,
        issue_type: str = autoboto.ShapeBase.NOT_SET,
        attachment_set_id: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if communication_body is not autoboto.ShapeBase.NOT_SET:
                _params['communication_body'] = communication_body
            if service_code is not autoboto.ShapeBase.NOT_SET:
                _params['service_code'] = service_code
            if severity_code is not autoboto.ShapeBase.NOT_SET:
                _params['severity_code'] = severity_code
            if category_code is not autoboto.ShapeBase.NOT_SET:
                _params['category_code'] = category_code
            if cc_email_addresses is not autoboto.ShapeBase.NOT_SET:
                _params['cc_email_addresses'] = cc_email_addresses
            if language is not autoboto.ShapeBase.NOT_SET:
                _params['language'] = language
            if issue_type is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_cases(
        ...
        *,
        case_id_list: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        display_id: str = autoboto.ShapeBase.NOT_SET,
        after_time: str = autoboto.ShapeBase.NOT_SET,
        before_time: str = autoboto.ShapeBase.NOT_SET,
        include_resolved_cases: bool = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
        language: str = autoboto.ShapeBase.NOT_SET,
        include_communications: bool = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if case_id_list is not autoboto.ShapeBase.NOT_SET:
                _params['case_id_list'] = case_id_list
            if display_id is not autoboto.ShapeBase.NOT_SET:
                _params['display_id'] = display_id
            if after_time is not autoboto.ShapeBase.NOT_SET:
                _params['after_time'] = after_time
            if before_time is not autoboto.ShapeBase.NOT_SET:
                _params['before_time'] = before_time
            if include_resolved_cases is not autoboto.ShapeBase.NOT_SET:
            ...
            if language is not autoboto.ShapeBase.NOT_SET:
                _params['language'] = language
            if include_communications is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_services(
        ...
        *,
        service_code_list: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        language: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if service_code_list is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_trusted_advisor_check_refresh_statuses(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if check_ids is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_trusted_advisor_check_result(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if check_id is not autoboto.ShapeBase.NOT_SET:
