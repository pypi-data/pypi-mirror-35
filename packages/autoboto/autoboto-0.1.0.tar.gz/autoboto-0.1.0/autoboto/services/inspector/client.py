...
class Client:
    ...
    def add_attributes_to_findings(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if finding_arns is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_assessment_target(
        ...
        *,
        ...
        resource_group_arn: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if assessment_target_name is not autoboto.ShapeBase.NOT_SET:
                _params['assessment_target_name'] = assessment_target_name
            if resource_group_arn is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_assessment_template(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if assessment_target_arn is not autoboto.ShapeBase.NOT_SET:
                _params['assessment_target_arn'] = assessment_target_arn
            if assessment_template_name is not autoboto.ShapeBase.NOT_SET:
                _params['assessment_template_name'] = assessment_template_name
            if duration_in_seconds is not autoboto.ShapeBase.NOT_SET:
                _params['duration_in_seconds'] = duration_in_seconds
            if rules_package_arns is not autoboto.ShapeBase.NOT_SET:
                _params['rules_package_arns'] = rules_package_arns
            if user_attributes_for_findings is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_exclusions_preview(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if assessment_template_arn is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_resource_group(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if resource_group_tags is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_assessment_run(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if assessment_run_arn is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_assessment_runs(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if assessment_run_arns is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_assessment_targets(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if assessment_target_arns is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_assessment_templates(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if assessment_template_arns is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_exclusions(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if exclusion_arns is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_resource_groups(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if resource_group_arns is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_assessment_report(
        ...
        *,
        ...
        if _request is None:
            ...
            if assessment_run_arn is not autoboto.ShapeBase.NOT_SET:
                _params['assessment_run_arn'] = assessment_run_arn
            if report_file_format is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_exclusions_preview(
        ...
        *,
        ...
        if _request is None:
            ...
            if assessment_template_arn is not autoboto.ShapeBase.NOT_SET:
                _params['assessment_template_arn'] = assessment_template_arn
            if preview_token is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_assessment_run_agents(
        ...
        *,
        assessment_run_arn: str,
        filter: shapes.AgentFilter = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
    ...
    def list_assessment_runs(
        ...
        *,
        assessment_template_arns: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        filter: shapes.AssessmentRunFilter = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
    ...
    def list_assessment_targets(
        ...
        *,
        filter: shapes.AssessmentTargetFilter = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
    ...
    def list_assessment_templates(
        ...
        *,
        assessment_target_arns: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        filter: shapes.AssessmentTemplateFilter = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
    ...
    def list_findings(
        ...
        *,
        assessment_run_arns: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        filter: shapes.FindingFilter = autoboto.ShapeBase.NOT_SET,
        next_token: str = autoboto.ShapeBase.NOT_SET,
        max_results: int = autoboto.ShapeBase.NOT_SET,
    ...
    def preview_agents(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if preview_agents_arn is not autoboto.ShapeBase.NOT_SET:
    ...
    def remove_attributes_from_findings(
        ...
        *,
        ...
        if _request is None:
            ...
            if finding_arns is not autoboto.ShapeBase.NOT_SET:
                _params['finding_arns'] = finding_arns
            if attribute_keys is not autoboto.ShapeBase.NOT_SET:
    ...
    def start_assessment_run(
        ...
        *,
        assessment_template_arn: str,
        assessment_run_name: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if assessment_template_arn is not autoboto.ShapeBase.NOT_SET:
                _params['assessment_template_arn'] = assessment_template_arn
            if assessment_run_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def stop_assessment_run(
        ...
        *,
        assessment_run_arn: str,
        stop_action: shapes.StopAction = autoboto.ShapeBase.NOT_SET,
    ) -> None:
        """
        ...
        if _request is None:
            ...
            if assessment_run_arn is not autoboto.ShapeBase.NOT_SET:
                _params['assessment_run_arn'] = assessment_run_arn
            if stop_action is not autoboto.ShapeBase.NOT_SET:
