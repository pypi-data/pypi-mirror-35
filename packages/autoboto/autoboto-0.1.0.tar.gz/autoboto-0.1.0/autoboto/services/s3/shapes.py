    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "parquet",
                "Parquet",
                autoboto.TypeInfo(ParquetInput),
            ),
        ]
...
@dataclasses.dataclass
class NotificationConfiguration(autoboto.OutputShapeBase):
    """
...
@dataclasses.dataclass
class NotificationConfigurationDeprecated(autoboto.OutputShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return [
            (
...
@dataclasses.dataclass
class ParquetInput(autoboto.ShapeBase):
    @classmethod
    def _get_boto_mapping(cls):
        return []
