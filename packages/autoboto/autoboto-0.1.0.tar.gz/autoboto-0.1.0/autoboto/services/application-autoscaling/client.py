...
class Client:
    ...
    def delete_scaling_policy(
        ...
        *,
        ...
        if _request is None:
            ...
            if service_namespace is not autoboto.ShapeBase.NOT_SET:
            ...
            if scalable_dimension is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_scaling_policy(
        ...
        *,
        ...
        StepScalingPolicyConfiguration = autoboto.ShapeBase.NOT_SET,
        target_tracking_scaling_policy_configuration: shapes.
        TargetTrackingScalingPolicyConfiguration = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if step_scaling_policy_configuration is not autoboto.ShapeBase.NOT_SET:
                _params['step_scaling_policy_configuration'
                       ] = step_scaling_policy_configuration
            if target_tracking_scaling_policy_configuration is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_scheduled_action(
        ...
        *,
        ...
        if _request is None:
            ...
            if scalable_target_action is not autoboto.ShapeBase.NOT_SET:
    ...
    def register_scalable_target(
        ...
        *,
        ...
        resource_id: str,
        scalable_dimension: shapes.ScalableDimension,
        min_capacity: int = autoboto.ShapeBase.NOT_SET,
        max_capacity: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if scalable_dimension is not autoboto.ShapeBase.NOT_SET:
                _params['scalable_dimension'] = scalable_dimension
            if min_capacity is not autoboto.ShapeBase.NOT_SET:
                _params['min_capacity'] = min_capacity
            if max_capacity is not autoboto.ShapeBase.NOT_SET:
