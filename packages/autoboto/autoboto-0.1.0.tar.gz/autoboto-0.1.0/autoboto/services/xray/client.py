...
class Client:
    ...
    def batch_get_traces(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if trace_ids is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_sampling_rule(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if sampling_rule is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_sampling_rule(
        ...
        *,
        rule_name: str = autoboto.ShapeBase.NOT_SET,
        rule_arn: str = autoboto.ShapeBase.NOT_SET,
    ...
    def get_sampling_targets(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if sampling_statistics_documents is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_trace_summaries(
        ...
        *,
        start_time: datetime.datetime,
        end_time: datetime.datetime,
        sampling: bool = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if end_time is not autoboto.ShapeBase.NOT_SET:
                _params['end_time'] = end_time
            if sampling is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_telemetry_records(
        ...
        *,
        ...
        ec2_instance_id: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if telemetry_records is not autoboto.ShapeBase.NOT_SET:
                _params['telemetry_records'] = telemetry_records
            if ec2_instance_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def put_trace_segments(
        ...
        **Trace ID Format**
        ...
        if _request is None:
            _params = {}
            if trace_segment_documents is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_sampling_rule(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if sampling_rule_update is not autoboto.ShapeBase.NOT_SET:
