...
class Client:
    ...
    def associate_drt_log_bucket(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if log_bucket is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_protection(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if protection_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_attack(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if attack_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_attacks(
        ...
        *,
        ...
        start_time: shapes.TimeRange = autoboto.ShapeBase.NOT_SET,
        end_time: shapes.TimeRange = autoboto.ShapeBase.NOT_SET,
    ...
    def update_emergency_contact_settings(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if emergency_contact_list is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_subscription(
        ...
        *,
        auto_renew: shapes.AutoRenew = autoboto.ShapeBase.NOT_SET,
