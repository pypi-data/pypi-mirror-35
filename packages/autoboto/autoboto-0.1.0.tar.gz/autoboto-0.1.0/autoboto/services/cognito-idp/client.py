...
class Client:
    ...
    def add_custom_attributes(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if user_pool_id is not autoboto.ShapeBase.NOT_SET:
                _params['user_pool_id'] = user_pool_id
            if custom_attributes is not autoboto.ShapeBase.NOT_SET:
    ...
    def admin_add_user_to_group(
        ...
        *,
        ...
        if _request is None:
            ...
            if user_pool_id is not autoboto.ShapeBase.NOT_SET:
                _params['user_pool_id'] = user_pool_id
            if username is not autoboto.ShapeBase.NOT_SET:
    ...
    def admin_create_user(
        ...
        *,
        ...
        temporary_password: str = autoboto.ShapeBase.NOT_SET,
        force_alias_creation: bool = autoboto.ShapeBase.NOT_SET,
        message_action: shapes.MessageActionType = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if username is not autoboto.ShapeBase.NOT_SET:
                _params['username'] = username
            if user_attributes is not autoboto.ShapeBase.NOT_SET:
                _params['user_attributes'] = user_attributes
            if validation_data is not autoboto.ShapeBase.NOT_SET:
                _params['validation_data'] = validation_data
            if temporary_password is not autoboto.ShapeBase.NOT_SET:
                _params['temporary_password'] = temporary_password
            if force_alias_creation is not autoboto.ShapeBase.NOT_SET:
                _params['force_alias_creation'] = force_alias_creation
            if message_action is not autoboto.ShapeBase.NOT_SET:
                _params['message_action'] = message_action
            if desired_delivery_mediums is not autoboto.ShapeBase.NOT_SET:
    ...
    def admin_delete_user_attributes(
        ...
        *,
        ...
        if _request is None:
            ...
            if username is not autoboto.ShapeBase.NOT_SET:
                _params['username'] = username
            if user_attribute_names is not autoboto.ShapeBase.NOT_SET:
    ...
    def admin_disable_provider_for_user(
        ...
        *,
        ...
        if _request is None:
            ...
            if user_pool_id is not autoboto.ShapeBase.NOT_SET:
                _params['user_pool_id'] = user_pool_id
            if user is not autoboto.ShapeBase.NOT_SET:
                _params['user'] = user
    ...
    def admin_forget_device(
        ...
        *,
        ...
        if _request is None:
            ...
            if username is not autoboto.ShapeBase.NOT_SET:
                _params['username'] = username
            if device_key is not autoboto.ShapeBase.NOT_SET:
    ...
    def admin_initiate_auth(
        ...
        *,
        ...
        auth_parameters: typing.Dict[str, str] = autoboto.ShapeBase.NOT_SET,
        client_metadata: typing.Dict[str, str] = autoboto.ShapeBase.NOT_SET,
        analytics_metadata: shapes.AnalyticsMetadataType = autoboto.ShapeBase.
        NOT_SET,
        context_data: shapes.ContextDataType = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if auth_flow is not autoboto.ShapeBase.NOT_SET:
                _params['auth_flow'] = auth_flow
            if auth_parameters is not autoboto.ShapeBase.NOT_SET:
                _params['auth_parameters'] = auth_parameters
            if client_metadata is not autoboto.ShapeBase.NOT_SET:
                _params['client_metadata'] = client_metadata
            if analytics_metadata is not autoboto.ShapeBase.NOT_SET:
                _params['analytics_metadata'] = analytics_metadata
            if context_data is not autoboto.ShapeBase.NOT_SET:
    ...
    def admin_link_provider_for_user(
        ...
        *,
        ...
        if _request is None:
            ...
            if user_pool_id is not autoboto.ShapeBase.NOT_SET:
                _params['user_pool_id'] = user_pool_id
            if destination_user is not autoboto.ShapeBase.NOT_SET:
                _params['destination_user'] = destination_user
            if source_user is not autoboto.ShapeBase.NOT_SET:
    ...
    def admin_list_devices(
        ...
        *,
        ...
        pagination_token: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if limit is not autoboto.ShapeBase.NOT_SET:
                _params['limit'] = limit
            if pagination_token is not autoboto.ShapeBase.NOT_SET:
    ...
    def admin_respond_to_auth_challenge(
        ...
        *,
        ...
        challenge_responses: typing.Dict[str, str] = autoboto.ShapeBase.NOT_SET,
        session: str = autoboto.ShapeBase.NOT_SET,
        analytics_metadata: shapes.AnalyticsMetadataType = autoboto.ShapeBase.
        NOT_SET,
        context_data: shapes.ContextDataType = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if client_id is not autoboto.ShapeBase.NOT_SET:
                _params['client_id'] = client_id
            if challenge_name is not autoboto.ShapeBase.NOT_SET:
                _params['challenge_name'] = challenge_name
            if challenge_responses is not autoboto.ShapeBase.NOT_SET:
                _params['challenge_responses'] = challenge_responses
            if session is not autoboto.ShapeBase.NOT_SET:
    ...
    def admin_set_user_mfa_preference(
        ...
        *,
        ...
        SoftwareTokenMfaSettingsType = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if user_pool_id is not autoboto.ShapeBase.NOT_SET:
                _params['user_pool_id'] = user_pool_id
            if sms_mfa_settings is not autoboto.ShapeBase.NOT_SET:
                _params['sms_mfa_settings'] = sms_mfa_settings
            if software_token_mfa_settings is not autoboto.ShapeBase.NOT_SET:
    ...
    def admin_set_user_settings(
        ...
        *,
        ...
        if _request is None:
            ...
            if username is not autoboto.ShapeBase.NOT_SET:
                _params['username'] = username
            if mfa_options is not autoboto.ShapeBase.NOT_SET:
    ...
    def admin_update_auth_event_feedback(
        ...
        *,
        ...
        if _request is None:
            ...
            if username is not autoboto.ShapeBase.NOT_SET:
                _params['username'] = username
            if event_id is not autoboto.ShapeBase.NOT_SET:
                _params['event_id'] = event_id
            if feedback_value is not autoboto.ShapeBase.NOT_SET:
    ...
    def admin_update_device_status(
        ...
        *,
        ...
        if _request is None:
            ...
            if device_key is not autoboto.ShapeBase.NOT_SET:
                _params['device_key'] = device_key
            if device_remembered_status is not autoboto.ShapeBase.NOT_SET:
    ...
    def associate_software_token(
        ...
        *,
        access_token: str = autoboto.ShapeBase.NOT_SET,
        session: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if access_token is not autoboto.ShapeBase.NOT_SET:
    ...
    def change_password(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if previous_password is not autoboto.ShapeBase.NOT_SET:
                _params['previous_password'] = previous_password
            if proposed_password is not autoboto.ShapeBase.NOT_SET:
    ...
    def confirm_device(
        ...
        *,
        ...
        DeviceSecretVerifierConfigType = autoboto.ShapeBase.NOT_SET,
        device_name: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if device_key is not autoboto.ShapeBase.NOT_SET:
                _params['device_key'] = device_key
            if device_secret_verifier_config is not autoboto.ShapeBase.NOT_SET:
                _params['device_secret_verifier_config'
                       ] = device_secret_verifier_config
            if device_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def confirm_forgot_password(
        ...
        *,
        ...
        password: str,
        secret_hash: str = autoboto.ShapeBase.NOT_SET,
        analytics_metadata: shapes.AnalyticsMetadataType = autoboto.ShapeBase.
        NOT_SET,
        ...
        if _request is None:
            ...
            if username is not autoboto.ShapeBase.NOT_SET:
                _params['username'] = username
            if confirmation_code is not autoboto.ShapeBase.NOT_SET:
                _params['confirmation_code'] = confirmation_code
            if password is not autoboto.ShapeBase.NOT_SET:
                _params['password'] = password
            if secret_hash is not autoboto.ShapeBase.NOT_SET:
                _params['secret_hash'] = secret_hash
            if analytics_metadata is not autoboto.ShapeBase.NOT_SET:
                _params['analytics_metadata'] = analytics_metadata
            if user_context_data is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_group(
        ...
        *,
        ...
        precedence: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if precedence is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_identity_provider(
        ...
        *,
        ...
        attribute_mapping: typing.Dict[str, str] = autoboto.ShapeBase.NOT_SET,
        idp_identifiers: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if user_pool_id is not autoboto.ShapeBase.NOT_SET:
                _params['user_pool_id'] = user_pool_id
            if provider_name is not autoboto.ShapeBase.NOT_SET:
                _params['provider_name'] = provider_name
            if provider_type is not autoboto.ShapeBase.NOT_SET:
                _params['provider_type'] = provider_type
            if provider_details is not autoboto.ShapeBase.NOT_SET:
                _params['provider_details'] = provider_details
            if attribute_mapping is not autoboto.ShapeBase.NOT_SET:
                _params['attribute_mapping'] = attribute_mapping
            if idp_identifiers is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_resource_server(
        ...
        *,
        ...
        if _request is None:
            ...
            if user_pool_id is not autoboto.ShapeBase.NOT_SET:
                _params['user_pool_id'] = user_pool_id
            if identifier is not autoboto.ShapeBase.NOT_SET:
                _params['identifier'] = identifier
            if name is not autoboto.ShapeBase.NOT_SET:
                _params['name'] = name
            if scopes is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_user_import_job(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if job_name is not autoboto.ShapeBase.NOT_SET:
                _params['job_name'] = job_name
            if user_pool_id is not autoboto.ShapeBase.NOT_SET:
                _params['user_pool_id'] = user_pool_id
            if cloud_watch_logs_role_arn is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_user_pool(
        ...
        *,
        pool_name: str,
        policies: shapes.UserPoolPolicyType = autoboto.ShapeBase.NOT_SET,
        lambda_config: shapes.LambdaConfigType = autoboto.ShapeBase.NOT_SET,
        ...
        sms_verification_message: str = autoboto.ShapeBase.NOT_SET,
        email_verification_message: str = autoboto.ShapeBase.NOT_SET,
        email_verification_subject: str = autoboto.ShapeBase.NOT_SET,
        verification_message_template: shapes.
        VerificationMessageTemplateType = autoboto.ShapeBase.NOT_SET,
        sms_authentication_message: str = autoboto.ShapeBase.NOT_SET,
        mfa_configuration: shapes.UserPoolMfaType = autoboto.ShapeBase.NOT_SET,
        ...
        NOT_SET,
        user_pool_tags: typing.Dict[str, str] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if pool_name is not autoboto.ShapeBase.NOT_SET:
                _params['pool_name'] = pool_name
            if policies is not autoboto.ShapeBase.NOT_SET:
                _params['policies'] = policies
            if lambda_config is not autoboto.ShapeBase.NOT_SET:
                _params['lambda_config'] = lambda_config
            if auto_verified_attributes is not autoboto.ShapeBase.NOT_SET:
                _params['auto_verified_attributes'] = auto_verified_attributes
            if alias_attributes is not autoboto.ShapeBase.NOT_SET:
                _params['alias_attributes'] = alias_attributes
            if username_attributes is not autoboto.ShapeBase.NOT_SET:
                _params['username_attributes'] = username_attributes
            if sms_verification_message is not autoboto.ShapeBase.NOT_SET:
                _params['sms_verification_message'] = sms_verification_message
            if email_verification_message is not autoboto.ShapeBase.NOT_SET:
                _params['email_verification_message'
                       ] = email_verification_message
            if email_verification_subject is not autoboto.ShapeBase.NOT_SET:
                _params['email_verification_subject'
                       ] = email_verification_subject
            if verification_message_template is not autoboto.ShapeBase.NOT_SET:
                _params['verification_message_template'
                       ] = verification_message_template
            if sms_authentication_message is not autoboto.ShapeBase.NOT_SET:
                _params['sms_authentication_message'
                       ] = sms_authentication_message
            if mfa_configuration is not autoboto.ShapeBase.NOT_SET:
                _params['mfa_configuration'] = mfa_configuration
            if device_configuration is not autoboto.ShapeBase.NOT_SET:
                _params['device_configuration'] = device_configuration
            if email_configuration is not autoboto.ShapeBase.NOT_SET:
                _params['email_configuration'] = email_configuration
            if sms_configuration is not autoboto.ShapeBase.NOT_SET:
                _params['sms_configuration'] = sms_configuration
            if user_pool_tags is not autoboto.ShapeBase.NOT_SET:
                _params['user_pool_tags'] = user_pool_tags
            if admin_create_user_config is not autoboto.ShapeBase.NOT_SET:
            ...
            if user_pool_add_ons is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_user_pool_client(
        ...
        *,
        user_pool_id: str,
        client_name: str,
        generate_secret: bool = autoboto.ShapeBase.NOT_SET,
        refresh_token_validity: int = autoboto.ShapeBase.NOT_SET,
        read_attributes: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        write_attributes: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        explicit_auth_flows: typing.List[shapes.ExplicitAuthFlowsType
                                        ] = autoboto.ShapeBase.NOT_SET,
        supported_identity_providers: typing.List[str
                                                 ] = autoboto.ShapeBase.NOT_SET,
        callback_urls: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        logout_urls: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        default_redirect_uri: str = autoboto.ShapeBase.NOT_SET,
        allowed_o_auth_flows: typing.List[shapes.OAuthFlowType
                                         ] = autoboto.ShapeBase.NOT_SET,
        allowed_o_auth_scopes: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if user_pool_id is not autoboto.ShapeBase.NOT_SET:
                _params['user_pool_id'] = user_pool_id
            if client_name is not autoboto.ShapeBase.NOT_SET:
                _params['client_name'] = client_name
            if generate_secret is not autoboto.ShapeBase.NOT_SET:
                _params['generate_secret'] = generate_secret
            if refresh_token_validity is not autoboto.ShapeBase.NOT_SET:
                _params['refresh_token_validity'] = refresh_token_validity
            if read_attributes is not autoboto.ShapeBase.NOT_SET:
                _params['read_attributes'] = read_attributes
            if write_attributes is not autoboto.ShapeBase.NOT_SET:
                _params['write_attributes'] = write_attributes
            if explicit_auth_flows is not autoboto.ShapeBase.NOT_SET:
                _params['explicit_auth_flows'] = explicit_auth_flows
            if supported_identity_providers is not autoboto.ShapeBase.NOT_SET:
                _params['supported_identity_providers'
                       ] = supported_identity_providers
            if callback_urls is not autoboto.ShapeBase.NOT_SET:
                _params['callback_urls'] = callback_urls
            if logout_urls is not autoboto.ShapeBase.NOT_SET:
                _params['logout_urls'] = logout_urls
            if default_redirect_uri is not autoboto.ShapeBase.NOT_SET:
                _params['default_redirect_uri'] = default_redirect_uri
            if allowed_o_auth_flows is not autoboto.ShapeBase.NOT_SET:
                _params['allowed_o_auth_flows'] = allowed_o_auth_flows
            if allowed_o_auth_scopes is not autoboto.ShapeBase.NOT_SET:
                _params['allowed_o_auth_scopes'] = allowed_o_auth_scopes
            if allowed_o_auth_flows_user_pool_client is not autoboto.ShapeBase.NOT_SET:
                _params['allowed_o_auth_flows_user_pool_client'
                       ] = allowed_o_auth_flows_user_pool_client
            if analytics_configuration is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_user_pool_domain(
        ...
        *,
        domain: str,
        user_pool_id: str,
        custom_domain_config: shapes.CustomDomainConfigType = autoboto.
        ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if user_pool_id is not autoboto.ShapeBase.NOT_SET:
                _params['user_pool_id'] = user_pool_id
            if custom_domain_config is not autoboto.ShapeBase.NOT_SET:
    ...
    def get_identity_provider_by_identifier(
        ...
        *,
        ...
        if _request is None:
            ...
            if user_pool_id is not autoboto.ShapeBase.NOT_SET:
                _params['user_pool_id'] = user_pool_id
            if idp_identifier is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_users(
        ...
        *,
        user_pool_id: str,
        attributes_to_get: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        limit: int = autoboto.ShapeBase.NOT_SET,
        pagination_token: str = autoboto.ShapeBase.NOT_SET,
        filter: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if user_pool_id is not autoboto.ShapeBase.NOT_SET:
                _params['user_pool_id'] = user_pool_id
            if attributes_to_get is not autoboto.ShapeBase.NOT_SET:
    ...
    def set_risk_configuration(
        ...
        *,
        ...
        AccountTakeoverRiskConfigurationType = autoboto.ShapeBase.NOT_SET,
        risk_exception_configuration: shapes.
        RiskExceptionConfigurationType = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if client_id is not autoboto.ShapeBase.NOT_SET:
                _params['client_id'] = client_id
            if compromised_credentials_risk_configuration is not autoboto.ShapeBase.NOT_SET:
                _params['compromised_credentials_risk_configuration'
                       ] = compromised_credentials_risk_configuration
            if account_takeover_risk_configuration is not autoboto.ShapeBase.NOT_SET:
                _params['account_takeover_risk_configuration'
                       ] = account_takeover_risk_configuration
            if risk_exception_configuration is not autoboto.ShapeBase.NOT_SET:
    ...
    def set_ui_customization(
        ...
        *,
        user_pool_id: str,
        client_id: str = autoboto.ShapeBase.NOT_SET,
        css: str = autoboto.ShapeBase.NOT_SET,
        image_file: typing.Any = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if client_id is not autoboto.ShapeBase.NOT_SET:
                _params['client_id'] = client_id
            if css is not autoboto.ShapeBase.NOT_SET:
                _params['css'] = css
            if image_file is not autoboto.ShapeBase.NOT_SET:
    ...
    def set_user_pool_mfa_config(
        ...
        *,
        ...
        SoftwareTokenMfaConfigType = autoboto.ShapeBase.NOT_SET,
        mfa_configuration: shapes.UserPoolMfaType = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if user_pool_id is not autoboto.ShapeBase.NOT_SET:
                _params['user_pool_id'] = user_pool_id
            if sms_mfa_configuration is not autoboto.ShapeBase.NOT_SET:
                _params['sms_mfa_configuration'] = sms_mfa_configuration
            if software_token_mfa_configuration is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_auth_event_feedback(
        ...
        *,
        ...
        if _request is None:
            ...
            if event_id is not autoboto.ShapeBase.NOT_SET:
                _params['event_id'] = event_id
            if feedback_token is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_identity_provider(
        ...
        *,
        user_pool_id: str,
        provider_name: str,
        provider_details: typing.Dict[str, str] = autoboto.ShapeBase.NOT_SET,
        attribute_mapping: typing.Dict[str, str] = autoboto.ShapeBase.NOT_SET,
        idp_identifiers: typing.List[str] = autoboto.ShapeBase.NOT_SET,
    ...
    def update_user_pool_client(
        ...
        *,
        user_pool_id: str,
        client_id: str,
        client_name: str = autoboto.ShapeBase.NOT_SET,
        refresh_token_validity: int = autoboto.ShapeBase.NOT_SET,
        read_attributes: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        write_attributes: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        explicit_auth_flows: typing.List[shapes.ExplicitAuthFlowsType
    ...
    def verify_software_token(
        ...
        *,
        ...
        access_token: str = autoboto.ShapeBase.NOT_SET,
        session: str = autoboto.ShapeBase.NOT_SET,
        friendly_device_name: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if user_code is not autoboto.ShapeBase.NOT_SET:
                _params['user_code'] = user_code
            if access_token is not autoboto.ShapeBase.NOT_SET:
                _params['access_token'] = access_token
            if session is not autoboto.ShapeBase.NOT_SET:
                _params['session'] = session
            if friendly_device_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def verify_user_attribute(
        ...
        *,
        ...
        if _request is None:
            ...
            if attribute_name is not autoboto.ShapeBase.NOT_SET:
                _params['attribute_name'] = attribute_name
            if code is not autoboto.ShapeBase.NOT_SET:
                _params['code'] = code
