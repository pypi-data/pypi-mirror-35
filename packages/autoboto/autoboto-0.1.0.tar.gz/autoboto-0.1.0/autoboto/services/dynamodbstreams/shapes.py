...
@dataclasses.dataclass
class Identity(autoboto.ShapeBase):
    """
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "streams",
                "Streams",
                autoboto.TypeInfo(typing.List[Stream]),
            ),
            (
...
class Record(autoboto.ShapeBase):
    ...
    def _get_boto_mapping(cls):
        return [
            ...
            (
                "dynamodb",
                "dynamodb",
                autoboto.TypeInfo(StreamRecord),
            ),
            (
                "user_identity",
                "userIdentity",
                autoboto.TypeInfo(Identity),
            ),
        ]
    ...
    event_name: "OperationType" = dataclasses.field(
        default=autoboto.ShapeBase.NOT_SET,
    )
    ...
    # Streams API evolves.
    event_version: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
class Stream(autoboto.ShapeBase):
    ...
    #   * the `StreamLabel`
    stream_label: str = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class StreamRecord(autoboto.ShapeBase):
    """
    ...
    size_bytes: int = dataclasses.field(default=autoboto.ShapeBase.NOT_SET, )
...
@dataclasses.dataclass
class TrimmedDataAccessException(autoboto.ShapeBase):
    """
