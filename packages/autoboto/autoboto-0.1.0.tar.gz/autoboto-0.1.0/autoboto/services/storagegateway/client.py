...
class Client:
    ...
    def activate_gateway(
        ...
        *,
        ...
        gateway_region: str,
        gateway_type: str = autoboto.ShapeBase.NOT_SET,
        tape_drive_type: str = autoboto.ShapeBase.NOT_SET,
        medium_changer_type: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if activation_key is not autoboto.ShapeBase.NOT_SET:
                _params['activation_key'] = activation_key
            if gateway_name is not autoboto.ShapeBase.NOT_SET:
                _params['gateway_name'] = gateway_name
            if gateway_timezone is not autoboto.ShapeBase.NOT_SET:
                _params['gateway_timezone'] = gateway_timezone
            if gateway_region is not autoboto.ShapeBase.NOT_SET:
                _params['gateway_region'] = gateway_region
            if gateway_type is not autoboto.ShapeBase.NOT_SET:
                _params['gateway_type'] = gateway_type
            if tape_drive_type is not autoboto.ShapeBase.NOT_SET:
                _params['tape_drive_type'] = tape_drive_type
            if medium_changer_type is not autoboto.ShapeBase.NOT_SET:
    ...
    def add_cache(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if gateway_arn is not autoboto.ShapeBase.NOT_SET:
                _params['gateway_arn'] = gateway_arn
            if disk_ids is not autoboto.ShapeBase.NOT_SET:
    ...
    def cancel_archival(
        ...
        *,
        ...
        if _request is None:
            ...
            if gateway_arn is not autoboto.ShapeBase.NOT_SET:
                _params['gateway_arn'] = gateway_arn
            if tape_arn is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_cached_iscsi_volume(
        ...
        *,
        ...
        source_volume_arn: str = autoboto.ShapeBase.NOT_SET,
        kms_encrypted: bool = autoboto.ShapeBase.NOT_SET,
        kms_key: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if gateway_arn is not autoboto.ShapeBase.NOT_SET:
                _params['gateway_arn'] = gateway_arn
            if volume_size_in_bytes is not autoboto.ShapeBase.NOT_SET:
            ...
            if source_volume_arn is not autoboto.ShapeBase.NOT_SET:
                _params['source_volume_arn'] = source_volume_arn
            if kms_encrypted is not autoboto.ShapeBase.NOT_SET:
                _params['kms_encrypted'] = kms_encrypted
            if kms_key is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_nfs_file_share(
        ...
        *,
        ...
        kms_encrypted: bool = autoboto.ShapeBase.NOT_SET,
        kms_key: str = autoboto.ShapeBase.NOT_SET,
        default_storage_class: str = autoboto.ShapeBase.NOT_SET,
        object_acl: shapes.ObjectACL = autoboto.ShapeBase.NOT_SET,
        client_list: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        squash: str = autoboto.ShapeBase.NOT_SET,
        read_only: bool = autoboto.ShapeBase.NOT_SET,
        guess_mime_type_enabled: bool = autoboto.ShapeBase.NOT_SET,
        requester_pays: bool = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if role is not autoboto.ShapeBase.NOT_SET:
                _params['role'] = role
            if location_arn is not autoboto.ShapeBase.NOT_SET:
                _params['location_arn'] = location_arn
            if nfs_file_share_defaults is not autoboto.ShapeBase.NOT_SET:
                _params['nfs_file_share_defaults'] = nfs_file_share_defaults
            if kms_encrypted is not autoboto.ShapeBase.NOT_SET:
                _params['kms_encrypted'] = kms_encrypted
            if kms_key is not autoboto.ShapeBase.NOT_SET:
                _params['kms_key'] = kms_key
            if default_storage_class is not autoboto.ShapeBase.NOT_SET:
                _params['default_storage_class'] = default_storage_class
            if object_acl is not autoboto.ShapeBase.NOT_SET:
                _params['object_acl'] = object_acl
            if client_list is not autoboto.ShapeBase.NOT_SET:
                _params['client_list'] = client_list
            if squash is not autoboto.ShapeBase.NOT_SET:
                _params['squash'] = squash
            if read_only is not autoboto.ShapeBase.NOT_SET:
                _params['read_only'] = read_only
            if guess_mime_type_enabled is not autoboto.ShapeBase.NOT_SET:
                _params['guess_mime_type_enabled'] = guess_mime_type_enabled
            if requester_pays is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_smb_file_share(
        ...
        *,
        ...
        guess_mime_type_enabled: bool = autoboto.ShapeBase.NOT_SET,
        requester_pays: bool = autoboto.ShapeBase.NOT_SET,
        valid_user_list: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        invalid_user_list: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        authentication: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if requester_pays is not autoboto.ShapeBase.NOT_SET:
                _params['requester_pays'] = requester_pays
            if valid_user_list is not autoboto.ShapeBase.NOT_SET:
                _params['valid_user_list'] = valid_user_list
            if invalid_user_list is not autoboto.ShapeBase.NOT_SET:
                _params['invalid_user_list'] = invalid_user_list
            if authentication is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_snapshot(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if volume_arn is not autoboto.ShapeBase.NOT_SET:
                _params['volume_arn'] = volume_arn
            if snapshot_description is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_stored_iscsi_volume(
        ...
        *,
        ...
        if _request is None:
            ...
            if gateway_arn is not autoboto.ShapeBase.NOT_SET:
                _params['gateway_arn'] = gateway_arn
            if disk_id is not autoboto.ShapeBase.NOT_SET:
                _params['disk_id'] = disk_id
            if preserve_existing_data is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_tape_with_barcode(
        ...
        *,
        ...
        if _request is None:
            ...
            if gateway_arn is not autoboto.ShapeBase.NOT_SET:
                _params['gateway_arn'] = gateway_arn
            if tape_size_in_bytes is not autoboto.ShapeBase.NOT_SET:
                _params['tape_size_in_bytes'] = tape_size_in_bytes
            if tape_barcode is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_tapes(
        ...
        *,
        ...
        if _request is None:
            ...
            if client_token is not autoboto.ShapeBase.NOT_SET:
                _params['client_token'] = client_token
            if num_tapes_to_create is not autoboto.ShapeBase.NOT_SET:
                _params['num_tapes_to_create'] = num_tapes_to_create
            if tape_barcode_prefix is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_bandwidth_rate_limit(
        ...
        *,
        ...
        if _request is None:
            ...
            if gateway_arn is not autoboto.ShapeBase.NOT_SET:
                _params['gateway_arn'] = gateway_arn
            if bandwidth_type is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_chap_credentials(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if target_arn is not autoboto.ShapeBase.NOT_SET:
                _params['target_arn'] = target_arn
            if initiator_name is not autoboto.ShapeBase.NOT_SET:
    ...
    def delete_file_share(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if file_share_arn is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_cached_iscsi_volumes(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if volume_arns is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_nfs_file_shares(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if file_share_arn_list is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_tape_archives(
        ...
        *,
        tape_arns: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            _params = {}
            if tape_arns is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_vtl_devices(
        ...
        *,
        gateway_arn: str,
        vtl_device_arns: typing.List[str] = autoboto.ShapeBase.NOT_SET,
        marker: str = autoboto.ShapeBase.NOT_SET,
        limit: int = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if gateway_arn is not autoboto.ShapeBase.NOT_SET:
                _params['gateway_arn'] = gateway_arn
            if vtl_device_arns is not autoboto.ShapeBase.NOT_SET:
    ...
    def list_file_shares(
        ...
        *,
        gateway_arn: str = autoboto.ShapeBase.NOT_SET,
        limit: int = autoboto.ShapeBase.NOT_SET,
        marker: str = autoboto.ShapeBase.NOT_SET,
    ...
    def set_local_console_password(
        ...
        *,
        ...
        if _request is None:
            ...
            if gateway_arn is not autoboto.ShapeBase.NOT_SET:
                _params['gateway_arn'] = gateway_arn
            if local_console_password is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_bandwidth_rate_limit(
        ...
        *,
        ...
        if _request is None:
            ...
            if gateway_arn is not autoboto.ShapeBase.NOT_SET:
                _params['gateway_arn'] = gateway_arn
            if average_upload_rate_limit_in_bits_per_sec is not autoboto.ShapeBase.NOT_SET:
                _params['average_upload_rate_limit_in_bits_per_sec'
                       ] = average_upload_rate_limit_in_bits_per_sec
            if average_download_rate_limit_in_bits_per_sec is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_chap_credentials(
        ...
        *,
        ...
        initiator_name: str,
        secret_to_authenticate_target: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if target_arn is not autoboto.ShapeBase.NOT_SET:
                _params['target_arn'] = target_arn
            if secret_to_authenticate_initiator is not autoboto.ShapeBase.NOT_SET:
                _params['secret_to_authenticate_initiator'
                       ] = secret_to_authenticate_initiator
            if initiator_name is not autoboto.ShapeBase.NOT_SET:
                _params['initiator_name'] = initiator_name
            if secret_to_authenticate_target is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_gateway_information(
        ...
        *,
        gateway_arn: str,
        gateway_name: str = autoboto.ShapeBase.NOT_SET,
        gateway_timezone: str = autoboto.ShapeBase.NOT_SET,
    ...
    def update_maintenance_start_time(
        ...
        *,
        ...
        if _request is None:
            ...
            if gateway_arn is not autoboto.ShapeBase.NOT_SET:
                _params['gateway_arn'] = gateway_arn
            if hour_of_day is not autoboto.ShapeBase.NOT_SET:
                _params['hour_of_day'] = hour_of_day
            if minute_of_hour is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_snapshot_schedule(
        ...
        *,
        ...
        if _request is None:
            ...
            if volume_arn is not autoboto.ShapeBase.NOT_SET:
                _params['volume_arn'] = volume_arn
            if start_at is not autoboto.ShapeBase.NOT_SET:
                _params['start_at'] = start_at
            if recurrence_in_hours is not autoboto.ShapeBase.NOT_SET:
    ...
    def update_vtl_device_type(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if vtl_device_arn is not autoboto.ShapeBase.NOT_SET:
                _params['vtl_device_arn'] = vtl_device_arn
            if device_type is not autoboto.ShapeBase.NOT_SET:
