...
class Client:
    ...
    def associate_node(
        ...
        *,
        ...
        if _request is None:
            ...
            if node_name is not autoboto.ShapeBase.NOT_SET:
                _params['node_name'] = node_name
            if engine_attributes is not autoboto.ShapeBase.NOT_SET:
    ...
    def create_server(
        ...
        *,
        ...
        disable_automated_backup: bool = autoboto.ShapeBase.NOT_SET,
        engine: str = autoboto.ShapeBase.NOT_SET,
        engine_model: str = autoboto.ShapeBase.NOT_SET,
        engine_version: str = autoboto.ShapeBase.NOT_SET,
        engine_attributes: typing.List[shapes.EngineAttribute
                                      ] = autoboto.ShapeBase.NOT_SET,
        backup_retention_count: int = autoboto.ShapeBase.NOT_SET,
        key_pair: str = autoboto.ShapeBase.NOT_SET,
        ...
        backup_id: str = autoboto.ShapeBase.NOT_SET,
        ...
        if _request is None:
            ...
            if server_name is not autoboto.ShapeBase.NOT_SET:
                _params['server_name'] = server_name
            if instance_profile_arn is not autoboto.ShapeBase.NOT_SET:
            ...
            if disable_automated_backup is not autoboto.ShapeBase.NOT_SET:
            ...
            if engine_model is not autoboto.ShapeBase.NOT_SET:
            ...
            if engine_attributes is not autoboto.ShapeBase.NOT_SET:
                _params['engine_attributes'] = engine_attributes
            if backup_retention_count is not autoboto.ShapeBase.NOT_SET:
                _params['backup_retention_count'] = backup_retention_count
            if key_pair is not autoboto.ShapeBase.NOT_SET:
            ...
            if backup_id is not autoboto.ShapeBase.NOT_SET:
    ...
    def describe_node_association_status(
        ...
        *,
        ...
        if _request is None:
            _params = {}
            if node_association_status_token is not autoboto.ShapeBase.NOT_SET:
