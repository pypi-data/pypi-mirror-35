...
class SteamClient:
    ...
    def get_my_inventory_by_eshao(self, game: GameOptions, merge: bool = True) -> dict:
        ...
        while True:
            ...
            if 'success' not in response_dict:
                print('Get inventory api error', url)
                print(response_dict)
                time.sleep(5)
                continue
            if merge:
    ...
    def accept_trade_offer(self, trade_offer_id: str, allow_2fa=False) -> dict:
        ...
        partner = trade['response']['offer']['accountid_other'] + 76561197960265728
        ...
        if response.get('needs_mobile_confirmation'):
            ...
            while not finish:
                try:
                    ...
                    print('Error confirm_transaction', e)
                    time.sleep(10)
