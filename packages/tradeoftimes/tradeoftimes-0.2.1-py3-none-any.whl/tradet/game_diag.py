...
class GameDialog ( wx.Dialog ):
    ...
    def __init__( self, parent ):
        ...
        self.m_staticText3 = wx.StaticText( self, wx.ID_ANY, u"Public Address:", wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.gameButton = wx.Button( self, wx.ID_ANY, u"Connect", wx.DefaultPosition, wx.DefaultSize, 0 )
