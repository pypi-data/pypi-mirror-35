...
class Tenant(APIWrapper):
    ...
    def create_tenant(self, name, passwd='', extra={}):
        ...
        Based on Martin's postman JSON test file. No other proper documentation
        currently exists for this call (as of 25-Jul-2018).

        :param name: Tenant name.
        :type name: str | unicode
        :param passwd: What I presume is the tenant admin user password.
        :param extra: Extra config info. Only Martin knows what this is!
        :type extra: [dict]
