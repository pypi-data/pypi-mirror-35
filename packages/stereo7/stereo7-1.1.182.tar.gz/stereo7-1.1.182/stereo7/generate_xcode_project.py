...
def copy_resources(arg_parser):
    ...
    for size in icons:
        if Project.instance.with_pro_version:
            shutil.copy2('{}{}.png'.format(icons_lite, size), '{}ios/Images.xcassets/AppIcon.lite.appiconset/{}.png'.format(proj_folder, size))
            shutil.copy2('{}{}.png'.format(icons_pro, size), '{}ios/Images.xcassets/AppIcon.pro.appiconset/{}.png'.format(proj_folder, size))
        else:
            shutil.copy2('{}{}.png'.format(icons_lite, size), '{}ios/Images.xcassets/AppIcon.appiconset/{}.png'.format(proj_folder, size))
