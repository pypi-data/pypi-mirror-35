/*! For license information please see 463def995651b5962de9.chunk.js.LICENSE */
...
`}static get properties(){return{hass:{type:Object,observer:"_hassChanged"},_services:Array,value:{type:String,notify:!0}}}_hassChanged(e,t){if(!e)return void(this._services=[]);if(t&&e.config.services===t.config.services)return;const i=[];Object.keys(e.config.services).sort().forEach(t=>{const a=Object.keys(e.config.services[t]).sort();for(let e=0;e<a.length;e++)i.push(`${t}.${a[e]}`)}),this._services=i}})},619:function(e,t,i){"use strict";i.r(t),i(153),i(152),i(119),i(54),i(198);var a=i(0),o=i(3);i(209),i(129),i(269),i(118),i(268);const r={};customElements.define("ha-panel-dev-service",class extends o.a{static get template(){return a["a"]`
...
//# sourceMappingURL=463def995651b5962de9.chunk.js.map