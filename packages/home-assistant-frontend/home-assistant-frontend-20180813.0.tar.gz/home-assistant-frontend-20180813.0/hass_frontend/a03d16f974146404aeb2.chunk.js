...
`}static get properties(){return{hass:{type:Object},entityId:{type:String,value:""},entityName:{type:String,value:null},entityPicture:{type:String,value:null}}}ready(){super.ready(),this.addEventListener("click",t=>this.badgeTap(t))}badgeTap(t){t.stopPropagation(),this.entityId&&this.fire("hass-more-info",{entityId:this.entityId})}})},613:function(t,e,a){"use strict";a.r(e),a(119);var i=a(0),r=a(3),s=a(262),n=a.n(s),o=(a(129),a(86),a(305),a(26)),c=a(28),l=a(13),u=a(304);n.a.Icon.Default.imagePath="/static/images/leaflet",customElements.define("ha-panel-map",class extends(Object(l.a)(r.a)){static get template(){return i["a"]`
...
//# sourceMappingURL=a03d16f974146404aeb2.chunk.js.map