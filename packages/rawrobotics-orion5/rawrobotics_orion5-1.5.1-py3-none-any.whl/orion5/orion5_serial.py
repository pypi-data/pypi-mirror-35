...
class SerialThread(threading.Thread):
    ...
    def RequestFirmwareVersion(self):
        self.SendPacket(self.BuildPacket(6, 0, [], 'asking for firmware again'))


    def main(self):
        self.SendPacket(self.BuildPacket(6, 0, [], 'Main Init'))
    ...
    def BuildPacket(self, type, length, data, source = 'Haha', oldChecker = -1):
        ...
        hexReg = [0x69, 0x36, 0x22, 0x24, 0x42, 0x99, 0x89, 0x08]
