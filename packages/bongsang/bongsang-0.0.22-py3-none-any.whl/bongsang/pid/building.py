...
class RemoteControl_v02:
    def __init__(self, server_address='192.168.1.254', manager_id='AILAB', manager_password='ailab2018', AHU=23):
        if AHU == 15:
            ...
            station_id='ST3'
            thermal_supply_point='/ST3/OFa27/LPa-31387390'
            thermal_return_point='/ST3/OFa27/LPa-31387389'
            thermal_set_point='/ST3/OFa27/LPa-31387378'
            cooling_valve_point='/ST3/OFa27/LPa-31387384'
            heating_valve_point='/ST3/OFa27/LPa-31387383'
            mode_station_point='/ST3/OFa27/LPa-31387369'
            self.priority = 3
