...
def GameTickPacketAddTileInformation(builder, tileInformation): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(tileInformation), 0)
def GameTickPacketStartTileInformationVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def GameTickPacketAddBall(builder, ball): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(ball), 0)
def GameTickPacketAddGameInfo(builder, gameInfo): builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(gameInfo), 0)
