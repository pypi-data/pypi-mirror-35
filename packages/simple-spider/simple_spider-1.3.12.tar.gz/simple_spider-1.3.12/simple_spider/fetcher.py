...
class Fetcher:
    ...
    def fetch(self,url, method ='GET', data = None, headers=None, cookies = None):
        fetch_headers = {}
        ...
        if method.upper() == 'GET':
            ...
            resp = self.http.post(url, data=data, headers = fetch_headers, proxy = proxy, cookies = cookies,verify=False)
