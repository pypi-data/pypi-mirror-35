...
class BaseSpider:
    ...
    def crawl(self,url, callback, method = 'GET', data = {}, headers={}, cookies = {},options={}):
        ...
        if callable(cb):
            ...
            try:
                if err:
                    ...
                    ret = cb(err, SpiderResponse(err.reason, type= 'text'), task)
                else:
                    ret = cb(None, SpiderResponse(content, type= data_type), task)
            except Exception as e:
