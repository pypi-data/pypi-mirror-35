...
token_persisted = {}
settings = {}
def init_settings(_nid, _nauth_host_location, _nkey, _sitename):
    settings['nid'] = _nid
    settings['nauth_host_location'] = _nauth_host_location
    settings['nkey'] = _nkey
    settings['sitename'] = _sitename
    global nid, nauth_host_location, nkey, sitename
