...
from unicon.plugins.aireos.service_patterns import AireosReloadPatterns, \
    AireosPingPatterns, AireosCopyPatterns, AireosPatterns
...
class AireosReload(BaseService):
    ...
    def call_service(self,
        ...
        try:
            ...
            dialog.process(con.spawn, timeout=timeout)
            dialog_connection = con.connection_provider.get_connection_dialog()
            con.state_machine.go_to('any',
                                    con.spawn,
                                    context=self.context,
                                    timeout=con.settings.RELOAD_TIMEOUT,
                                    dialog=dialog_connection)
            config_commands = con.settings.HA_INIT_CONFIG_COMMANDS
