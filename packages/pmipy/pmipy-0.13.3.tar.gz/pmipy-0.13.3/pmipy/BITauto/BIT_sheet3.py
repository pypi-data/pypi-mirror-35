...
def processing_type3(qtag, sht, period_num, row_num, col_num_starting, vertical_length):
    qtag_list = list(df_qa.loc[qtag].dropna())
...
def BIT_automation(filepath1, filepath2, filepath3, filepath4, period_num):
    ...
    processing_type2('QB1', sht3, period_num, 6, 4, 7)  # 成功！
    processing_type2('QB2', sht3, period_num, 21, 4, 7)
    processing_type2('QB4', sht3, period_num, 36, 4, 7)  # 成功！
    processing_type2('QB3', sht3, period_num, 51, 4, 7)  # 成功！
    processing_type2('QB3.1', sht3, period_num, 66, 4, 7)  # 成功！
    processing_type2('QB5', sht3, period_num, 82, 4, 7)  # 成功！
    processing_type3('QB6.1', sht3, period_num, 97, 4, 10)
