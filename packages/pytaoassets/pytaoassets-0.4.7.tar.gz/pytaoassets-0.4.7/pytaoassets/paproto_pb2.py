...
# source: 0001-taoassets-transaction-specification.proto
...
DeckSpawn = _reflection.GeneratedProtocolMessageType('DeckSpawn', (_message.Message,), dict(
  ...
  __module__ = '0001_taoassets_transaction_specification_pb2'
