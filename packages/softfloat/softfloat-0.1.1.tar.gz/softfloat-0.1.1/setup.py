...
#Check if SoftFloat is installed
zip_file_url='https://gitlab.com/cerlane/SoftFloat/-/archive/master/SoftFloat-master.zip'
...
setuptools.setup(
    ...
    url="https://gitlab.com/cerlane/SoftFloat",    
    classifiers=(
