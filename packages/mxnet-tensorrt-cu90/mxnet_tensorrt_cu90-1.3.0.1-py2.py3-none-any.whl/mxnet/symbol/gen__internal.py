...
def _default_subgraph_op(*data, **kwargs):
    r"""_default_subgraph_op

    Defined in src/operator/subgraph/default_subgraph_op.cc:L96
    This function support variable length of positional input.
...
def _trt_op(name=None, attr=None, out=None, **kwargs):
    r"""TRT operation (one engine)


    Defined in src/operator/contrib/tensorrt.cc:L163
