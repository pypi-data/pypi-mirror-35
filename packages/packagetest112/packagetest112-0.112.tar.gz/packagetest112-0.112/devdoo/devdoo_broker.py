    ...
    def operation(self):
        ...
        for (socket, event) in self.poller.poll(timeout_ms):
            ...
            if socket == self.zmq_socket_client:
                ...
                print ('ID RECEBIDA DO CLIENTE ====>', msg[0])

                # Salva id recebido do ZMQ
                self.id_zmq = msg[0]
