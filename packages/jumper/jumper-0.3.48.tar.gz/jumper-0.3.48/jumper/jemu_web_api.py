...
class JemuWebApi(object):
    ...
    def upload_firmware(self, filepath, user_error_reporting):
        ...
        t = threading.Thread(target=self._upload_file, args=[filepath, filename, user_error_reporting, "fw"])
        t.start()
        self._threads.append(t)

    def upload_log_file(self, filepath, filename, user_error_reporting):
        t = threading.Thread(target=self._upload_file, args=[filepath, filename, user_error_reporting, "log"])
        t.start()
        self._threads.append(t)
    ...
    def _upload_file(self, filepath, filename, user_error_reporting, type):
