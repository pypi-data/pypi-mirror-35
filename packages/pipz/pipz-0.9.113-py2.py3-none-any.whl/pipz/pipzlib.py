...
def install_private_package(ctx, package, secret):
    admin = ctx.obj['admin']
    if secret is None:
        os.system(f"pip install {package} --no-cache-dir --upgrade --extra-index-url http://s3.amazonaws.com/whl/{package}/index.html --find-links http://s3.amazonaws.com/whl/{package}/index.html --trusted-host s3.amazonaws.com")
    else:
        os.system(f"pip install {package} --no-cache-dir --upgrade --extra-index-url http://s3.amazonaws.com/whl/{secret}/{package}/index.html --find-links http://s3.amazonaws.com/whl/{secret}/{package}/index.html --trusted-host s3.amazonaws.com")
...
def download_private_package(ctx, package, secret):
    admin = ctx.obj['admin']
    if secret is None:
        os.system(f"pip download {package} --no-cache-dir --no-deps --index-url http://s3.amazonaws.com/whl/{package}/index.html --find-links http://s3.amazonaws.com/whl/{package}/index.html --trusted-host s3.amazonaws.com")
    else:
        os.system(f"pip download {package} --no-cache-dir --no-deps  --index-url http://s3.amazonaws.com/whl/{secret}/{package}/index.html --find-links http://s3.amazonaws.com/whl/{secret}/{package}/index.html --trusted-host s3.amazonaws.com")
