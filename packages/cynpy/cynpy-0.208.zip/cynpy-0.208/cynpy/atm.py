        ...
        if not \
          (me.sfr.name=='CAN1108' or \
           me.sfr.name=='CAN1111'):
            ...
            me.sfrwx (me.sfr.SRCCTL, [rlst[1] | 0x03]) # discharge
            me.sfrwx (me.sfr.SRCCTL, [rlst[1] &~0x03]) # VBUS-off ??
            print 'pos-VIN:',
#           print '%5.2f' % (10.0 * me.get_adc10 (0) / 1000),
            for xx in range(3):
                print '%5.2f' % (10.0 * me.get_adc10 (0) / 1000),
...
#       raise NotImplementedError()
        ...
        me.sfrwx (me.sfr.PWR_V, [130]) # set VIN=9.6V
        ...
        me.sfrwx (me.sfr.SRCCTL, [rlst[1] &~0x42]) # recover V5 (HVLDO)
        me.sfrwx (me.sfr.PWR_V,  [rlst[0]]) # recover VIN
#       me.sfrwx (me.sfr.SRCCTL, [rlst[1] | 0x03]) # discharge
        me.sfrwx (me.sfr.SRCCTL, [rlst[1] &~0x03])
