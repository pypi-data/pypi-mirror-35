...
from cynpy.can11xx import cani2c, sfr, TRUE, FALSE

class updprl (cani2c):
    '''
    base class of ams and csp
    '''
    ...
    def __init__ (me, i2cmst, deva, ordrs=0):
        ...
        don't enable auto-TX-GoodCRC initially
            ...
            2. keep silence when DUT speak
        enable all ordrs RX for SOP* query
        '''
        me.MyMsgId = 0
        me.DataRole = 0 # '1' in SOP'/SOP"
        me.PortRole = 0 # 0/1: SOURCE/CABLE
        me.SpecRev = 1 # PD_R2
        me.TxOrdrs = ordrs & 0x07

        me.TxBuffer = []

        cani2c.__init__ (me, i2cmst, deva)
