...
MINIMUM_GROUP = 3
# = min number of subjects to estimate predictive population result
...
class PairedCompResultSet:
    ...
    def predictive_group_individual(self):
        """Predictive distributions for each group and attribute,
    ...
    def predictive_population_individual(self):
        ...
        :return: dict res with elements
            res[group][attribute] = single PopulationModel instance,
                which can generate quality_samples from the predictive model.
        """
        if any(any(len(ga_model.subjects) < MINIMUM_GROUP
                   for ga_model in g_models.values())
               for g_models in self.models.values()):
            logger.warning('Too few subjects for population estimate in some group, attribute')
...
class PopulationModel:
    ...
    def quality_samples(self):
        ...
        :return: 3D array q, with quality samples stored as
            ...
            pcf.test_condition_tuples[t], pcf.systems[s],
        ...
        q = q.reshape((-1,
                       self.pcf.n_test_condition_tuples,
...
class PairedCompIndModel:
    ...
    def n_q(self):
        ...
        """
        # return (self.pcf.n_systems - 1) * self.pcf.n_test_condition_tuples
    ...
    def adapt(self, md, prior):
        ...
        # n_tct = self.pcf.n_test_condition_tuples
...
def _n_quality_params(pcf):
    ...
    """
    return (pcf.n_systems - 1) * pcf.n_test_condition_tuples  # ************
...
def cat_limits_transform(log_w):
    ...
    :return: 1D or 2D array b, with all elements in (0, +inf]
        b[n, m] = UPPER limit for m-th interval,
...
class PairedCompMdata:
    ...
    def __init__(self, s_res, pcf):
        ...
        tct = list(pcf.test_condition_tuples())
