...
def run():
    args = ArgsUtil.loadArgumentParseModule([
            ...
            {'name':'hostname', 'default':os.environ['HOSTNAME'], 'help':'include hostname in cos file path. If it is null, skipped this part', 'required':False},
            ...
            {'name':'qcloud_appid', 'default':os.environ['QCLOUD_APPID'], 'help':'qcloud app id', 'required':False},
            {'name':'qcloud_secret_id', 'default':os.environ['QCLOUD_SECRET_ID'], 'help':'qcloud secret id', 'required':False},
            {'name':'qcloud_secret_key', 'default':os.environ['QCLOUD_SECRET_KEY'], 'help':'qcloud secret key', 'required':False},
            {'name':'qcloud_cos_region', 'default':os.environ['QCLOUD_COS_REGION'], 'help':'qcloud cos region', 'required':False},
            {'name':'qcloud_cos_scheme', 'default':os.environ['QCLOUD_COS_SCHEME'], 'help':'qcloud cos region', 'required':False},
            {'name':'qcloud_cos_bucket', 'default':os.environ['QCLOUD_COS_BUCKET'], 'help':'qcloud cos bucket', 'required':False},
            {'name':'qcloud_cos_folder', 'default':os.environ['QCLOUD_COS_FOLDER'], 'help':'qcloud cos folder', 'required':False}
    ])
