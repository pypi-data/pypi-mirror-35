    ...
    def __init__ (self, sConnectParams, **kwargs):
        ...
        try:
            ...
            if not bInitDone:
                ...
                prototype (None, goside.goResultMetaData  , ctypes.c_uint64, ctypes.c_uint64, ctypes.POINTER (ctypes.POINTER (ctypes.c_char)), ctypes.POINTER (ctypes.POINTER (ctypes.c_char)))
...
class TeradataCursor:
    ...
    def _obtainResultMetaData (self):
        ...
        goside.goResultMetaData (self.connection.uLog, self.uRowsHandle, ctypes.byref (pcError), ctypes.byref (pcColumnMetaData))
