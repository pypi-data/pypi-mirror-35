...
def get_file_path(file_to_locate):
    module_path = os.path.dirname(new_contributor_wizard.__file__)
    return os.path.join(module_path, file_to_locate)
