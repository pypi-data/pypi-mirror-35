...
def require_elody_authentication(subparser):
    subparser.add_argument('-e', '--email', default=None,
        help="The password of your Elody account. This can be skipped if you have already used the 'configure' command.")
...
subparser = subparsers.add_parser('configure',
    help="""Create a configuration file to store your login credentials, so you don't have to specify them every time.
...
subparser = subparsers.add_parser('delete-configuration',
    help="""Delete the configuration file that stores your login credentials.""")
...
subparser = subparsers.add_parser('create-symbols', help="Create all the Symbols specified in the file. See the tutorial of the lod-tools for details on how this works.")
...
subparser = subparsers.add_parser('upload-rule', help="""Upload a file describing a rule. If successful, this creates a new Rule on the server.""")
...
subparser = subparsers.add_parser('delete-rule', help="Delete a Rule you own.")
