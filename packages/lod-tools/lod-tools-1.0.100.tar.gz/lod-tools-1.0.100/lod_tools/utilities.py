    ...
    with cd(in_folder):
        ...
        if get_output:
            ...
            if sys.version_info[0] == 2:
                res = backport_of_subprocess_run_for_python_2(cmd, stdout=subprocess.DEVNULL, stderr=subprocess.PIPE, cwd=in_folder)
            else:
...
def backport_of_subprocess_run_for_python_2(*popenargs, input=None, check=False, **kwargs):
    """
