...
from qlib.data import Cache,mysql_to_sqlite
import logging
...
parser.add_argument("--to-sqlite", default=None,  help="import mysql files to sqlite ...")
...
def main():
    ...
    if args.to_elasticsearch:
        ...
        mysql_to_sqlite(args.to_sqlite, database=args.database, user=args.user, password=args.passwd)