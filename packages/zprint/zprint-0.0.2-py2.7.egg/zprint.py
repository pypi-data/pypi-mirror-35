...
def get_tree(frame=sys._getframe()):
...
def addinfo(message,flag=1,frame=sys_getframe()):
    funclist,spacelist=get_tree()
    flist=(funclist,spacelist)[flag]
    nowTime=datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S')
    info="[%s] %s :: %s"%(nowTime,spacelist,message)
    return info
def zprint(message,flag=1,frame=sys_getframe()):
    funclist,spacelist=get_tree(frame)
    flist=(funclist,spacelist)[flag]
    nowTime=datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S')
    ...
    #print info
def epprint(message,flag=1,frame=sys_getframe()):
    funclist,spacelist=get_tree(frame)
    flist=(funclist,spacelist)[flag]
    nowTime=datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S')
    info="[%s] %s :: %s"%(nowTime,flist,message)
