...
create_sink_from_config = partial(create_from_config, _SINK_CONSTRUCTORS_DICT)

create_source_from_config = partial(create_from_config, _SOURCE_CONSTRUCTORS_DICT)
