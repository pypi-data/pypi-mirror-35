...
class Lianjia():
    def __init__(self, city):
        ...
        self.city_id = city_dict[city]['city_id']
        self.city=city
...
def SaveCityBorderIntoDB(city):  # 读取某市各个区域轮廓
    ret = Lianjia(city).GetDistrictInfo(max_lat=city_dict[city]['max_lat'], min_lat=city_dict[city]['min_lat'],
                          max_lng=city_dict[city]['max_lng'], min_lng=city_dict[city]['min_lng'],)
