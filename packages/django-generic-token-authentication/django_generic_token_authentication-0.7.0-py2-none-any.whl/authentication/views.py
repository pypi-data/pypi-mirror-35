...
from authentication.validators import (image_dim_validator,
...
from authentication.services import (retrieve_token_service,
                                     ...
                                     store_profile_image_service,
                                     remove_profile_image_service)
...
class ProfileImageViewSet(viewsets.ViewSet):
    ...
    def _create_image(self, user, image):
        ...
        service = store_profile_image_service(self.image_repository,
    ...
    def destroy(self, request, pk=None, format=None):
        service = remove_profile_image_service(self.repository)
        view = GenericViewset(self.serializer_class, service, request)
    ...
    **Usage example for GET request**
    ...
    def list(self, request, format=None):
        ...
        if 'HTTP_AUTHORIZATION' not in request.META:
            return LogoutViewSet._handle_error('No auth header provided.', status.HTTP_401_UNAUTHORIZED)
...
class LogoutAllViewSet(viewsets.ViewSet):
    ...
    **Usage example for GET request**
    ...
    def list(self, request, format=None):
        ...
        """
        if 'HTTP_AUTHORIZATION' not in request.META:
            return LogoutAllViewSet._handle_error('No auth header provided.', status.HTTP_401_UNAUTHORIZED)
...
class RefreshViewSet(viewsets.ViewSet):
    ...
    **Return value example of POST request**
    ...
    def create(self, request, format=None):
        ...
        """
        if 'HTTP_AUTHORIZATION' not in request.META:
            return RefreshViewSet._handle_error('No auth header provided.', status.HTTP_401_UNAUTHORIZED)
...
class ResetPasswordViewSet(viewsets.ViewSet):
    ...
    **Usage example for POST request**
    ...
    def create(self, request, format=None):
        ...
        return ResetPasswordViewSet._handle_error('Validation failed.', status.HTTP_400_BAD_REQUEST)
