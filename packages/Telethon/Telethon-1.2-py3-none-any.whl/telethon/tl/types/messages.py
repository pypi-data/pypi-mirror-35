...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChat, TypeUser, TypeStickerSetCovered, TypeDialog, TypeFoundGif, TypeBotInlineResult, TypeMessage, TypeChatFull, TypeHighScore, TypeStickerPack, TypeStickerSet, TypeEncryptedFile, TypeInlineBotSwitchPM, TypeDocument
