...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChat, TypeUser, TypeContactBlocked, TypePopularContact, TypeContactLink, TypeImportedContact, TypePeer, TypeContact, TypeTopPeerCategoryPeers
