...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeMessagesFilter, TypeBool, TypeInputDocument, TypeInputPeer, TypeMessageEntity, TypeInputStickeredMedia, TypeInputEncryptedChat, TypeInputSingleMedia, TypeReportReason, TypeInputMedia, TypeInputGeoPoint, TypeInputDialogPeer, TypeInputChatPhoto, TypeReplyMarkup, TypeInputStickerSet, TypeInputEncryptedFile, TypeSendMessageAction, TypeInputMessage, TypeInputBotInlineMessageID, TypeInputBotInlineResult, TypeInputUser, TypeShippingOption, TypeInlineBotSwitchPM
