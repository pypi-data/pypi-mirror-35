...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeSecureValueHash, TypeSecureValueType, TypeInputSecureValue, TypeInputNotifyPeer, TypeInputPrivacyKey, TypeBool, TypeInputPrivacyRule, TypeInputPeerNotifySettings, TypeAccountDaysTTL, TypeInputPeer, TypeSecureCredentialsEncrypted, TypeReportReason
