...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChannelAdminLogEventsFilter, TypeChannelAdminRights, TypeInputChatPhoto, TypeInputMessage, TypeChannelParticipantsFilter, TypeInputUser, TypeChannelBannedRights, TypeBool, TypeInputStickerSet, TypeInputChannel
