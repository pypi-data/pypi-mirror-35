...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeReplyMarkup, TypeInputEncryptedFile, TypeInputBotInlineMessageID, TypeReportReason, TypeInputPeer, TypeInputBotInlineResult, TypeInlineBotSwitchPM, TypeInputStickeredMedia, TypeInputSingleMedia, TypeMessagesFilter, TypeInputDialogPeer, TypeInputDocument, TypeInputGeoPoint, TypeMessageEntity, TypeInputStickerSet, TypeInputUser, TypeInputChatPhoto, TypeBool, TypeInputEncryptedChat, TypeInputMessage, TypeShippingOption, TypeInputMedia, TypeSendMessageAction
