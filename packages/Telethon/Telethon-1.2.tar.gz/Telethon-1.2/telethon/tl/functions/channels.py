...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputChannel, TypeInputStickerSet, TypeChannelBannedRights, TypeInputUser, TypeInputChatPhoto, TypeBool, TypeChannelParticipantsFilter, TypeInputMessage, TypeChannelAdminRights, TypeChannelAdminLogEventsFilter
