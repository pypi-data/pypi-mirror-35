...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeReportReason, TypeInputSecureValue, TypeInputPeer, TypeSecureValueType, TypeSecureCredentialsEncrypted, TypeBool, TypeInputPrivacyRule, TypeAccountDaysTTL, TypeSecureValueHash, TypeInputPrivacyKey, TypeInputPeerNotifySettings, TypeInputNotifyPeer
