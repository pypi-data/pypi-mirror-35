...
import requests
from watson_machine_learning_client.utils import INSTANCE_DETAILS_TYPE, FUNCTION_DETAILS_TYPE, STR_TYPE, STR_TYPE_NAME, docstring_parameter, str_type_conv, is_of_python_basic_type
...
""".format(code, function.__name__)
    ...
    # def update(self): not very important on the beginning, probably this part needs much more work and refactoring
    #     pass # TODO func
