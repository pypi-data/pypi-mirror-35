...
def func():
    return f"""def {key.lower()}(request: http.Request, params: http.QueryParams{pkts}):
            ...
            return mock('{key}', request, params{pkws})"""


route = "Route('{prefix}', method='{method}', handler={key.lower()})"
...
def mock(api, request: http.Request, params, **kwarg):
    params = dict(params)
