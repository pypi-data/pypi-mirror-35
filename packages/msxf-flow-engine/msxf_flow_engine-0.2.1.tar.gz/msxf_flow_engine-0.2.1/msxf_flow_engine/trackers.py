...
import msxf_flow_engine.events as events
from msxf_flow_engine.conversation import Dialogue, Topic
from msxf_flow_engine.events import UserUttered, TopicSet, ActionExecuted, \
    Event, SlotSet, Restarted, ActionReverted, UserUtteranceReverted, BotUttered

logger = logging.getLogger(__name__)

if typing.TYPE_CHECKING:
    from msxf_flow_engine.actions import Action
...
class DialogueStateTracker(object):
    ...
    def init_copy(self):
        ...
        from msxf_flow_engine.channels.channel import UserMessage
    ...
    def export_stories(self):
        ...
        from msxf_flow_engine.training.structures import Story
