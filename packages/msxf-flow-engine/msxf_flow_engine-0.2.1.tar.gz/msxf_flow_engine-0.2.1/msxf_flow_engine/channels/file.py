...
from msxf_flow_engine.channels.channel import OutputChannel
from msxf_flow_engine.channels.channel import InputChannel, UserMessage
...
class FileInputChannel(InputChannel):
    ...
    def __init__(self,
        ...
        from msxf_flow_engine.channels.console import ConsoleOutputChannel
