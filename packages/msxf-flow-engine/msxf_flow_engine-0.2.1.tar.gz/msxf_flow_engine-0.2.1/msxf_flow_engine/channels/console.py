...
from msxf_flow_engine.channels.channel import InputChannel, OutputChannel
import msxf_flow_engine.utils as utils
from msxf_flow_engine.interpreter import INTENT_MESSAGE_PREFIX
...
class ConsoleInputChannel(InputChannel):
    ...
    def _record_messages(self, on_message, max_message_limit=None):
        utils.print_color("Bot loadedddd. Type a message and press enter: ",
