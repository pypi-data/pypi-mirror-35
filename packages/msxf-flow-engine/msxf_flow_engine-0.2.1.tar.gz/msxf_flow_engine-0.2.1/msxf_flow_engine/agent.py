...
import msxf_flow_engine.training as training 
from msxf_flow_engine.channels.channel import UserMessage, InputChannel, OutputChannel
from msxf_flow_engine.domain import TemplateDomain, Domain, check_domain_sanity
from msxf_flow_engine.events import Event
from msxf_flow_engine.interpreter import NaturalLanguageInterpreter
from msxf_flow_engine.policies.policy import Policy
from msxf_flow_engine.policies.ensemble import SimplePolicyEnsemble, PolicyEnsemble
from msxf_flow_engine.policies.memoization import MemoizationPolicy
from msxf_flow_engine.processor import MessageProcessor
from msxf_flow_engine.tracker_store import InMemoryTrackerStore, TrackerStore
from msxf_flow_engine.trackers import DialogueStateTracker

logger = logging.getLogger(__name__)

if typing.TYPE_CHECKING:
    from msxf_flow_engine.interpreter import NaturalLanguageInterpreter as NLI
...
class Agent(object):
    ...
    def __init__(
            self,
            processerId='1',
            domain='1',  # type: Union[Text, Domain]
        ...
        self.processor = self._create_processor_byId(processerId = processerId)
    ...
    def load(cls,
        ...
        return cls(processerId,domain, ensemble, _interpreter, _tracker_store)
    ...
    def handle_message(
        ...
        return self.processor.handle_message(
                UserMessage(text_message,robot_id,url, output_channel, sender_id))
    ...
    def handel_process_message(self,message):
    ...
    def train_online(self,
        ...
        # type: (...) -> None
        from policies.online_trainer import OnlinePolicyEnsemble
    ...
    def visualize(self,
        ...
        # type: (...) -> None
        from msxf_flow_engine.training.visualization import visualize_stories
    ...
    def _create_processor_byId(self, preprocessor=None,processerId='default'):
        # type: (Optional[Callable[[Text], Text]]) -> MessageProcessor
        """Instantiates a processor based on the set state of the agent."""
