...
from msxf_flow_engine.conversation import Dialogue
from msxf_flow_engine.events import UserUttered, ActionExecuted, Event
...
class StoryGraph(object):
    ...
    def visualize(self, output_file=None):
        ...
        from msxf_flow_engine.training import visualization
