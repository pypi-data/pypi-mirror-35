...
def un_tar(file_name):
    ...
    tar.close()
    shutil.copytree(filename + "/dafeiauto-2.0.8", prjtname)
    fileremove("autodemo")
...
def execute():
    import requests
    r = requests.get('https://files.pythonhosted.org/packages/63/24/e22584799bd35e46d2c01395dc26c6b967a65496fc192d0ee4f2b60a1523/dafeiauto-2.0.8.tar.gz')
