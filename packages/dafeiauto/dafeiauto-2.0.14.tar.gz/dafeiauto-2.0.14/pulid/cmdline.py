...
def un_tar(file_name):
    ...
    tar.close()
    shutil.copytree(filename + "/dafeiauto-1.0.14", prjtname)
    fileremove("autodemo")
...
def execute():
    import requests
    r = requests.get('https://files.pythonhosted.org/packages/63/d9/75041eef45ba9f9789382ea37dcb865dca5456c5800c5247b81f8634ba84/dafeiauto-1.0.14.tar.gz')
