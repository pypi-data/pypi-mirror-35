...
class BilinearCurve:
    ...
    def __init__(self, ay, au, dy, du, a0=0., d0=0.):
        self.ay = ay
        self.au = au
        self.dy = dy
        self.du = du
...
class Bilin:
    def __init__(self, xtarget=0.0, dropstrength=0.75, elastoplastic=False, allowa010=True):
        ...
        self.bilinear_curve = BilinearCurve(None,None,None,None)
    ...
    def calc(self):
        ...
        while error > self.EPSILON:
            ...
            self.bilinear_curve = BilinearCurve(ay=y_y, au=y_u,
                                                dy=x_y+x_ini0, du=x_u+x_ini0,
                                                a0=0., d0=+x_ini0)


            # self.x_results = self.bilinear_curve.d_array
            # self.y_results = self.bilinear_curve.a_array
            ...
            self.logtext.append(str(self.bilinear_curve.d_array))
            self.logtext.append(str(self.bilinear_curve.a_array))
