...
__license__ = ''
__copyright__ = 'Copyright 2017-2018 Ryan J. Slater'
...
from rygames.Warships2 import Warships2
from rygames import Warships2Account
from rygames import AdvancedAI
