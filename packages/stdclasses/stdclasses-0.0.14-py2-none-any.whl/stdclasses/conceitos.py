class IAList:
    ...
    @classmethod
    def classificacao_linear_nao_linear(cls):
        return """
           classificacao_linear_nao_linear
        """,
    ...
    def all(cls):
        return {
            "1. Reconhecimento de padroes?": cls.reconhecimento_padroes(),
            "2. Etapas reconhecimento de padroes": (
