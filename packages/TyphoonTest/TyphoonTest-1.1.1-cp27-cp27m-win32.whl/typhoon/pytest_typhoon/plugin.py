...
def no_compilation(request):
    return request.config.getoption("--no-compilation")
...
def pytest_unconfigure(config):
    ...
    if typhoon:
        ...
        if alluredir is not None:
            ...
            cmd_name = "open_{}.cmd".format(dir_name)
