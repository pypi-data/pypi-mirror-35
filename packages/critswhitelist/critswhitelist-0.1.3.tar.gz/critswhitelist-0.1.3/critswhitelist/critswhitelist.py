...
class CritsWhitelist:
    def __init__(self, whitelist_tags, mongo_connection=None, mongo_uri=None, mongo_db=None, urlshortener_tags=[]):
        ...
        # Check to see if we need to create a new CRITsDBAPI object.
        if not mongo_connection and mongo_uri and mongo_db:
        ...
        try:
            ...
            self.logger.exception('Could not connect to the CRITS API.')
            ...
            for indicator_type in indicator_types:
                if indicator_type in self.whitelist:
                    for indicator in self.whitelist[indicator_type]:
                        ...
                        # "thing" already whitelisted in CRITS.
