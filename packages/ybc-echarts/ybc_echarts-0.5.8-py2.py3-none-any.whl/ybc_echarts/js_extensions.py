...
# here are all plugins from ybc_echarts team
OFFICIAL_PLUGINS = ["jupyter_echarts_pypkg", "ybc_echarts_snapshot"]
THIRD_PARTY_PLUGIN_PREFIX = "echarts_"

JS_EXTENSION_PLUGIN_TYPE = "ybc_echarts_js_extension"
...
scan_plugins(
    ...
    "ybc_echarts",  # <- useful for pyinstaller only
