...
from ybc_echarts.js_extensions import EXTENSION_MANAGER
import ybc_echarts.constants as constants


class ybc_echartsConfig(object):
...
CURRENT_CONFIG = ybc_echartsConfig()
...
def configure(
    ...
    """
    Config all items for ybc_echarts when use chart.render() or page.render().
    ...
    :param output_image: Non None value asks ybc_echarts to use
                         ybc_echarts-snapshots to render as image directly.
...
def enable_nteract(host=None):
    configure(
        ...
        jshost="https://ybc_echarts.github.io/assets/js",
    )
