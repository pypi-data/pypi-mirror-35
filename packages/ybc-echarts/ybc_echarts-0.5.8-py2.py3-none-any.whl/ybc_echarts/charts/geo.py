...
from ybc_echarts.chart import Chart
from ybc_echarts.datasets.coordinates import get_coordinate
    ...
    def __add(
        ...
        **kwargs
        ...
        if geo_cities_coords:
            for _name, _coord in geo_cities_coords.items():
                self.add_coordinate(_name, _coord[0], _coord[1])
