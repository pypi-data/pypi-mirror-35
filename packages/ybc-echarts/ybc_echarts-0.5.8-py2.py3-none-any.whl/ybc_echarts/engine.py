...
import ybc_echarts.conf as conf
import ybc_echarts.constants as constants
import ybc_echarts.utils as utils
from ybc_echarts_javascripthon.api import TRANSLATOR
from ybc_echarts_javascripthon.api import FUNCTION_TRANSLATOR
...
def echarts_js_dependencies(env, *args):
    ...
    """
    current_config = env.ybc_echarts_config
...
def echarts_container(env, chart):
    ...
    :param env:
    :param chart: A ybc_echarts.base.Base object
    """
    _container_and_text = ""
...
class BaseEnvironment(Environment):
    ...
    def __init__(self, *args, **kwargs):
        self.ybc_echarts_config = kwargs.pop("ybc_echarts_config", None)
        if self.ybc_echarts_config is None:
            raise TypeError(
                "no ybc_echarts_config for this environment specified"
            )
...
class EchartsEnvironment(BaseEnvironment):
    """
    Built-in jinja2 template engine for ybc_echarts
    This class provides some shortcut methods for rendering charts.
    """

    def __init__(self, ybc_echarts_config=None, *args, **kwargs):
        ybc_echarts_config = ybc_echarts_config or conf.ybc_echartsConfig()
        loader = kwargs.pop("loader", None)
        if loader is None:
            loader = FileSystemLoader(ybc_echarts_config.echarts_template_dir)
        super(EchartsEnvironment, self).__init__(
            ybc_echarts_config=ybc_echarts_config,
...
class EnvironmentManager(PluginManager):
    """
    Extend the rendering capability of ybc_echarts by having
    loosely coupled environments
    """

    def __init__(self):
        """
        Register with lml that this class manages 'ybc_echarts_environment'
        extension
        """
    ...
    def get_a_environment(self, file_type, **kwargs):
        ...
        or image rendering SnapshotEnvironment from ybc_echarts-snapshot
...
def create_default_environment(file_type):
    """
    Create environment object with ybc_echarts default single ybc_echartsConfig.
