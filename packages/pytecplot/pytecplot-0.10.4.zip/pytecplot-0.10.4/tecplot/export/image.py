...
def save_jpeg(filename,
    ...
    _do_export(region)
    log.info('JPEG image file created: ' + setup.filename)
...
def save_tiff(filename,
    ...
    _do_export(region)
    log.info('TIFF image file created: ' + setup.filename)
...
def save_png(filename,
    ...
    _do_export(region)
    log.info('PNG image file created: ' + setup.filename)
...
def save_wmf(filename,
    ...
    _do_export(region)
    log.info('Windows metafile image created: ' + export_setup.filename)
...
def save_ps(filename,
    ...
    _do_export(region)
    log.info('Postscript file created: ' + export_setup.filename)
