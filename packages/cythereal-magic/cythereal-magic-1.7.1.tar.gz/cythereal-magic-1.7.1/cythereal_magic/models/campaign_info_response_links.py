...
class CampaignInfoResponseLinks(object):
    ...
    def __init__(self, members=None, yara=None, procedures=None):  # noqa: E501
    ...
    @property
    def yara(self):
        """Gets the yara of this CampaignInfoResponseLinks.  # noqa: E501

        Link to the endpoint for retrieving the yara rule. See the endpoint documentation for possible parameters.   # noqa: E501

        :return: The yara of this CampaignInfoResponseLinks.  # noqa: E501
        :rtype: str
        """
        return self._yara
    ...
    @yara.setter
    def yara(self, yara):
        """Sets the yara of this CampaignInfoResponseLinks.

        Link to the endpoint for retrieving the yara rule. See the endpoint documentation for possible parameters.   # noqa: E501

        :param yara: The yara of this CampaignInfoResponseLinks.  # noqa: E501
        :type: str
        """
    ...
    @property
    def procedures(self):
        """Gets the procedures of this CampaignInfoResponseLinks.  # noqa: E501

        Link to the endpoint for retrieving information about procedures in the campaign. Procedure signatures are located at this endpoint.   # noqa: E501

        :return: The procedures of this CampaignInfoResponseLinks.  # noqa: E501
        :rtype: str
        """
    ...
    def procedures(self, procedures):
        """Sets the procedures of this CampaignInfoResponseLinks.

        Link to the endpoint for retrieving information about procedures in the campaign. Procedure signatures are located at this endpoint.   # noqa: E501

        :param procedures: The procedures of this CampaignInfoResponseLinks.  # noqa: E501
        :type: str
        """
