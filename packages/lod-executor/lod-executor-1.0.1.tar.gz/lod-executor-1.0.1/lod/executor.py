...
subparser = subparsers.add_parser('create-certificate',
    help="""Create a self-signed certificate in the location specified by your configuration.
...
subparser = subparsers.add_parser('clean',
    help="""Delete the content of the folder that was specified as the exec_env_root_folder during configuration.
...
subparser = subparsers.add_parser('run', help="Start running the ExecEnv so that the website can connect to it.")
