...
class AccountRuleTestCase(ModuleTestCase):
    ...
    def test_accountrule_create_item(self):
        ...
        with set_company(company):
            ...
            accrule = create_accountrule(name='8-16', shortname='W1', \
                            ...
                            company=AccountRule.default_company(),
    ...
    def test_accountrule_create_item_no_weekdays(self):
        ...
        with set_company(company):
            # create accountrule
            AccountRule = Pool().get('employee_timetracking.accountrule')
            self.assertRaises(Exception, create_accountrule, 
    ...
    def test_accountrule_get_periods_to_check_by_rule(self):
        ...
        with set_company(tarobj1.company):
            ...
            # rule active at: sun, mon, tue, wed
            ...
            self.assertEqual(str(l1[2][0]), '2018-03-27 07:00:00')  # tue
            self.assertEqual(str(l1[2][1]), '2018-03-27 12:00:00')
            self.assertEqual(str(l1[3][0]), '2018-03-28 07:00:00')  # wed
            self.assertEqual(str(l1[3][1]), '2018-03-28 12:00:00')
