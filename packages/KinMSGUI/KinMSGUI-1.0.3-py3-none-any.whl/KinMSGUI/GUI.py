...
#KinMS Modules
from KinMSGUI.KinMS import KinMS
from KinMSGUI.makebeam import makebeam
...
import KinMSGUI.GUIFunctions as GUI
#For reliable importing
import os
import sys
...
def KeyWord(self):
    ...
    #load Database
    KeyWordDatabase = pd.read_csv(os.path.join(os.path.dirname(__file__), 'KeyWordLookUp.csv'))
...
class BootWindow:
    ...
    def __init__(self, master):
        ...
        #Load Photo
#        self.im = TK.PhotoImage(file=os.path.join(os.path.dirname(__file__), 'Header.gif'))
