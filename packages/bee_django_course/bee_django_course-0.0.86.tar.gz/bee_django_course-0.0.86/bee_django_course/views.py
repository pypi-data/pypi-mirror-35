...
from .forms import CourseForm, SectionForm, CourseSectionForm, CourseSectionOrderForm, VideoForm, UploadImageForm, \
    ...
    section_attach_form, UserSectionNoteForm, SectionVideoOrderForm, LivePlayLogsForm
from .utils import JSONResponse, page_it
from .cc import create_video_info, get_video_str, get_live_play_logs
...
class LivePlayLogs(TemplateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            total, play_log = get_live_play_logs(video_id=video_id, date=date)
