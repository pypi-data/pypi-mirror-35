...
# -*- coding: utf-8 -*-
################################################################################
#    readsltext Copyright (C) 2018 Suizokukan
...
from readsltext.readsltext import __projectname__, __version__, __author__, __email__, \
...
setup(
    ...
    url='https://github.com/suizokukan/readsltext',
    ...
    description="GPLv3/Python3/CLI text format to annotate texts and " \
                "produce easy-to-read versions of them",
    ...
    entry_points={
        'console_scripts': ['readsltext=readsltext.readsltext:clientrypoint',],
    },
)
