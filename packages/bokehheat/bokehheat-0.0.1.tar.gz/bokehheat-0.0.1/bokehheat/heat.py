...
def qabar(df_axis_annot, s_yx, s_z, r_low, r_high, ls_color_palette, s_root):
    """
    input:
    ...
    description:
        ...
        annotation bar plot for quantitative variable.
    """
    # color declaration
    ...
    if (s_root in {"left", "right"}):
        ...
        sys.exit("Error at bokehheat.qabar: {}".format(
...
def cabar(df_axis_annot, s_yx, s_z, s_zcolor,  s_root):
    """
    input:
        df_axis_annot: pandas dataframe for y or x axis annotation.
    ...
    description:
        this function will return an interactive bokeh based
        annotation bar for categorical variable.
    """
    # tooltip declaration
    lt_tooltip = [
        (s_yx, f"@{s_yx}"),
    ...
    if (s_root in {"left", "right"}):
        ...
        sys.exit("Error at bokehheat.cabar: {}".format(
            ds_error["root_unknown"].format(s_root)
        ))
    p.xaxis.visible = False
    p.yaxis.visible = False
...
def clustermap(
    ...
    input:
        ...
        tt_axis_annot: axis annotation tuple.
            ...
            df_axis_annot: pandas datafarme for y or x axis annotation.
                the df_axis_annot index have to carry df_matrx index or column related labels.
    ...
    p_heatmap.height = 8 * i_px
    p_heatmap.width = 8 * i_px
...
if __name__ == '__main__':
    ...
    #tt_catquant = (t_ycat, t_yquant)
    #tt_catquant = (t_xquant, t_xcat)
