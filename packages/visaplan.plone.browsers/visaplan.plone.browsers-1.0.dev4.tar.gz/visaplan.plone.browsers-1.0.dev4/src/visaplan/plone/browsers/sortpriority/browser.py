...
class Browser(BrowserView):
    ...
    def __call__(self):
        ...
        if dict_.has_key(context.portal_type):
        ...
        if context.portal_type in ['UnitraccFile']:
            ...
            if dict_.has_key('partOf=' + context.getLayout()):
                return dict_['partOf=' + context.getLayout()]
            if dict_.has_key('portal_type=' + context.getGuessType()):
