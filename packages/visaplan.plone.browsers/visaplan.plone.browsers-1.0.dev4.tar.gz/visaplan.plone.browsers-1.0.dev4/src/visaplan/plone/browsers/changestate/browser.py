...
from .utils import (
        make_reference_success_msg, make_reference_errors_msg,
        make_reference_success_msg_html, make_reference_errors_msg_html,
        )
...
class Browser(BrowserView):
    ...
    def set(self):
        ...
        if maintaskdone or success_list:
          _ = translate = context.getAdapter('translate')
          try:
            if maintaskdone:
            ...
            try:
                message(u'Error executing "${workflow_action}"!',
                    'error',
                    mapping=locals())
            except UnicodeError as e:
