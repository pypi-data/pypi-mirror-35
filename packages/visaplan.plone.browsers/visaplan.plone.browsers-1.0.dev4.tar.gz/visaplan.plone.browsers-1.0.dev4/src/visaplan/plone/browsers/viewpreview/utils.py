...
# Standardmodule:
from os.path import abspath, normpath, sep, split, join, isdir
...
if CONFIG['dir'] is None:
    if CONFIG['viewpreview_dir'] is None:
        logger.error('Unvollst. Konfiguration: %s', (CONFIG,))
        raise ValueError('dir oder (alte Version) viewpreview_dir benoetigt!')
    CONFIG['dir'] = CONFIG.pop('viewpreview_dir')
