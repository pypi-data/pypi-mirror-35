class OptimizeResult:
    ...
    def __init__(self, is_converge, amount_of_iterations, cost_list, exit_code, reason_of_exit, x):
    ...
    def __repr__(self):
        ...
        result = is_converge_str + amount_of_iterations_str + cost_function_str + reason_of_exit_str
        return result
