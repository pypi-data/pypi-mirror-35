...
pygame.mixer.music.load('1.mp3')    # 游戏背景主题曲
...
class GameEngine:
    ...
    def start(self):       # 开始运行
        ...
        while True:
            ...
            pygame.display.set_icon(pygame.image.load("top.jpg"))  # 读取、渲染窗口图片
            background_image = pygame.image.load("bg_logo.jpg")    # 读取首页背景图
            self.screen.blit(background_image, (0, 0))             # 渲染首页背景图
            kaishi = pygame.image.load("1.png")    # 读取首页开始游戏
