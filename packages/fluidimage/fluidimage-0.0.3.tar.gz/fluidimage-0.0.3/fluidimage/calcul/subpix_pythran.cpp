...
namespace __pythran_subpix_pythran
{
  struct compute_subpix_2d_gaussian2
  {
    ...
    struct type
    {
      ...
      typedef decltype((std::declval<__type4>() < std::declval<__type0>())) __type7;
      ...
      typedef decltype((std::declval<__type31>() + std::declval<__type29>())) __type32;
      ...
      typedef decltype((std::declval<__type35>() + std::declval<__type29>())) __type36;
      typedef typename __combined<__type35,__type36>::type __type37;
      typedef decltype((std::declval<__type37>() + std::declval<__type29>())) __type38;
      typedef typename __combined<__type37,__type38>::type __type39;
      typedef decltype((std::declval<__type39>() + std::declval<__type29>())) __type40;
      typedef typename __combined<__type39,__type40>::type __type41;
      typedef decltype((std::declval<__type41>() + std::declval<__type29>())) __type42;
      typedef typename __combined<__type41,__type42>::type __type43;
      typedef decltype((std::declval<__type43>() + std::declval<__type29>())) __type44;
      typedef typename __combined<__type43,__type44>::type __type45;
      typedef decltype((std::declval<__type45>() + std::declval<__type29>())) __type46;
      typedef typename __combined<__type45,__type46>::type __type47;
      typedef decltype((std::declval<__type47>() + std::declval<__type29>())) __type48;
      ...
      typedef decltype((std::declval<__type0>() * std::declval<__type56>())) __type57;
      ...
      typedef decltype((std::declval<__type57>() * std::declval<__type58>())) __type59;
      ...
      typedef decltype((std::declval<__type0>() * std::declval<__type61>())) __type62;
      typedef decltype((std::declval<__type62>() * std::declval<__type58>())) __type63;
      ...
      typedef decltype((std::declval<__type53>() * std::declval<__type56>())) __type68;
      typedef decltype((std::declval<__type0>() * std::declval<__type54>())) __type69;
      typedef decltype((std::declval<__type69>() * std::declval<__type61>())) __type70;
  ...
  typename compute_subpix_2d_gaussian2::type<argument_type0, argument_type1, argument_type2>::result_type compute_subpix_2d_gaussian2::operator()(argument_type0&& correl, argument_type1&& ix, argument_type2&& iy) const
  {
    ...
    typedef decltype((std::declval<__type5>() * std::declval<__type29>())) __type30;
    ...
    typedef decltype((std::declval<__type34>() + std::declval<__type30>())) __type35;
    typedef typename __combined<__type34,__type35>::type __type36;
    typedef decltype((std::declval<__type36>() + std::declval<__type30>())) __type37;
    typedef typename __combined<__type36,__type37>::type __type38;
    typedef decltype((std::declval<__type38>() + std::declval<__type30>())) __type39;
    typedef typename __combined<__type38,__type39>::type __type40;
    typedef decltype((std::declval<__type40>() + std::declval<__type30>())) __type41;
    typedef typename __combined<__type40,__type41>::type __type42;
    typedef decltype((std::declval<__type42>() + std::declval<__type30>())) __type43;
    typedef typename __combined<__type42,__type43>::type __type44;
    typedef decltype((std::declval<__type44>() + std::declval<__type30>())) __type45;
    typedef typename __combined<__type44,__type45>::type __type46;
    typedef decltype((std::declval<__type46>() + std::declval<__type30>())) __type47;
    ...
    typename pythonic::assignable<typename __combined<__type22,__type18>::type>::type correl_crop = correl(pythonic::types::contiguous_slice((iy - 1L),(iy + 2L)),pythonic::types::contiguous_slice((ix - 1L),(ix + 2L)));
    typename pythonic::lazy<decltype(pythonic::numpy::functor::where{}((correl_crop < 0L)))>::type tmp = pythonic::numpy::functor::where{}((correl_crop < 0L));
    {
    ...
    ;
    ;
    c10 += (-1L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(0L, 0L))));
    c01 += (-1L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(0L, 0L))));
    c11 += (1L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(0L, 0L))));
    c20 += (1L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(0L, 0L))));
    c02 += (1L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(0L, 0L))));
    ;
    ;
    c10 += (-1L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(1L, 0L))));
    c01 += (0L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(1L, 0L))));
    c11 += (0L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(1L, 0L))));
    c20 += (1L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(1L, 0L))));
    c02 += (-2L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(1L, 0L))));
    ;
    ;
    c10 += (-1L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(2L, 0L))));
    c01 += (1L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(2L, 0L))));
    c11 += (-1L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(2L, 0L))));
    c20 += (1L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(2L, 0L))));
    c02 += (1L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(2L, 0L))));
    ;
    ;
    ;
    c10 += (0L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(0L, 1L))));
    c01 += (-1L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(0L, 1L))));
    c11 += (0L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(0L, 1L))));
    c20 += (-2L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(0L, 1L))));
    c02 += (1L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(0L, 1L))));
    ;
    ;
    c10 += (0L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(1L, 1L))));
    c01 += (0L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(1L, 1L))));
    c11 += (0L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(1L, 1L))));
    c20 += (-2L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(1L, 1L))));
    c02 += (-2L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(1L, 1L))));
    ;
    ;
    c10 += (0L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(2L, 1L))));
    c01 += (1L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(2L, 1L))));
    c11 += (0L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(2L, 1L))));
    c20 += (-2L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(2L, 1L))));
    c02 += (1L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(2L, 1L))));
    ;
    ;
    ;
    c10 += (1L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(0L, 2L))));
    c01 += (-1L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(0L, 2L))));
    c11 += (-1L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(0L, 2L))));
    c20 += (1L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(0L, 2L))));
    c02 += (1L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(0L, 2L))));
    ;
    ;
    c10 += (1L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(1L, 2L))));
    c01 += (0L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(1L, 2L))));
    c11 += (0L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(1L, 2L))));
    c20 += (1L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(1L, 2L))));
    c02 += (-2L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(1L, 2L))));
    ;
    ;
    c10 += (1L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(2L, 2L))));
    c01 += (1L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(2L, 2L))));
    c11 += (1L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(2L, 2L))));
    c20 += (1L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(2L, 2L))));
    c02 += (1L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(2L, 2L))));
    ;
    typename pythonic::assignable<typename pythonic::assignable<decltype(pythonic::types::make_tuple(std::declval<__type49>(), std::declval<__type51>(), std::declval<__type51>(), std::declval<__type51>(), std::declval<__type51>(), std::declval<__type51>()))>::type>::type __tuple1 = pythonic::types::make_tuple((pythonic::operator_::div((-1L * pythonic::numpy::functor::log{}(correl_crop.fast(pythonic::types::make_tuple(2L, 2L)))), 9L)), (pythonic::operator_::div(c10, 6L)), (pythonic::operator_::div(c01, 6L)), (pythonic::operator_::div(c11, 4L)), (pythonic::operator_::div(c20, 6L)), (pythonic::operator_::div(c02, 6L)));
    ;
    ...
    ;
    ;
    return pythonic::types::make_tuple((pythonic::operator_::div(((c11_ * c01_) - ((2L * c10_) * c02_)), (((4L * c20_) * c02_) - pythonic::numpy::functor::square{}(c11_)))), (pythonic::operator_::div(((c11_ * c10_) - ((2L * c01_) * c20_)), (((4L * c20_) * c02_) - pythonic::numpy::functor::square{}(c11_)))), correl_crop);
  }
}
#include <pythonic/python/exception_handler.hpp>
#ifdef ENABLE_PYTHON_MODULE
typename __pythran_subpix_pythran::compute_subpix_2d_gaussian2::type<pythonic::types::ndarray<float,2>, long, long>::result_type compute_subpix_2d_gaussian20(pythonic::types::ndarray<float,2>&& correl, long&& ix, long&& iy) 
{
...
typename __pythran_subpix_pythran::compute_subpix_2d_gaussian2::type<pythonic::types::numpy_texpr<pythonic::types::ndarray<float,2>>, long, long>::result_type compute_subpix_2d_gaussian21(pythonic::types::numpy_texpr<pythonic::types::ndarray<float,2>>&& correl, long&& ix, long&& iy) 
{
...
__pythran_wrap_compute_subpix_2d_gaussian20(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if(! PyArg_ParseTupleAndKeywords(args, kw, "OOO",
        ...
        return nullptr;
    if(is_convertible<pythonic::types::ndarray<float,2>>(args_obj[0]) && is_convertible<long>(args_obj[1]) && is_convertible<long>(args_obj[2]))
        return to_python(compute_subpix_2d_gaussian20(from_python<pythonic::types::ndarray<float,2>>(args_obj[0]), from_python<long>(args_obj[1]), from_python<long>(args_obj[2])));
    else {
        return nullptr;
    }
}
...
__pythran_wrap_compute_subpix_2d_gaussian21(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if(! PyArg_ParseTupleAndKeywords(args, kw, "OOO",
                                     (char**)keywords, &args_obj[0], &args_obj[1], &args_obj[2]))
        return nullptr;
    if(is_convertible<pythonic::types::numpy_texpr<pythonic::types::ndarray<float,2>>>(args_obj[0]) && is_convertible<long>(args_obj[1]) && is_convertible<long>(args_obj[2]))
        return to_python(compute_subpix_2d_gaussian21(from_python<pythonic::types::numpy_texpr<pythonic::types::ndarray<float,2>>>(args_obj[0]), from_python<long>(args_obj[1]), from_python<long>(args_obj[2])));
    else {
        return nullptr;
    }
}
...
PyErr_Clear();
                ...
                return pythonic::python::raise_invalid_argument(
                               "compute_subpix_2d_gaussian2", "   compute_subpix_2d_gaussian2(float32[:,:],int,int)\n   compute_subpix_2d_gaussian2(float32[:,:].T,int,int)", args, kw);
                });
            }
...
PYTHRAN_MODULE_INIT(subpix_pythran)(void) {
    ...
    PyObject * theDoc = Py_BuildValue("(sss)",
                                      "0.8.6",
                                      "2018-08-29 11:47:14.997633",
                                      "b4a9bdd6cfc7995ceff40a6a5333bc0a93e6c95420c064ad7e1cd8909675e4f1");
    if(! theDoc)
        PYTHRAN_RETURN;
