...
from taopy.constants import TaoMainnet
from taopy.lib.base58 import b58decode_check, b58encode_check
from taopy.lib.types import HexSerializable
...
class PrivateKey(Key):
    ...
    def from_wif(network, wif):
        ...
        return PrivateKey(bytearray(privk), network, public_compressed)

    @staticmethod
    def unhexlify(hexa):
        return PrivateKey(bytearray(unhexlify(hexa)))

    def __init__(self, priv, network=TaoMainnet, public_compressed=True):
        self.key = priv
