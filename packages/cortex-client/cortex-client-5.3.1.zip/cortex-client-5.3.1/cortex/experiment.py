...
class Experiment:
    ...
    def __init__(self, name, client):
        ...
        self._work_dir = Path.cwd() / 'experiments' / self.name
    ...
    def save_run(self, run: Run):
        ...
        for name, artifact in run.artifacts.items():
            with closing(open(self._work_dir / self.dir_artifacts / "{}_{}.pk".format(name, run.id), 'wb')) as f:
    ...
    def load_artifact(self, run: Run, name: str):
        with closing(open(self._work_dir / self.dir_artifacts / "{}_{}.pk".format(name, run.id), 'rb')) as f:
