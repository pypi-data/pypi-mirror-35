...
class SessionApp(BaseApp):
        ...
        def run(self):
            try:
                ...
                logon_msg = Message(
                    (35, 'A'),
                    (98, '0'),
                    (108, str(self.app.heartbeat_time)),
                ...
                if self.app.reset_seq_nums:
                    logon_msg.append(141, "Y")
                
                if self.app.test_mode == True:
                    logon_msg.append(464, "Y")
                elif self.app.test_mode == False:
                    logon_msg.append(464, "N")
                ...
                while True:
                    try:
                        ...
                        self.store_and_send(Message((35, '0'))) # send keepalive on timeout 
                    ...
                    if self.app.confirm_request_msg_count <= len(self.app.oms) and not self.app.waiting_for_confirmation:
                        self.store_and_send( Message(
                            (35, '1'),
                            (112, 'CONFIRM ' + str(self.app.oms.next_seq_num))
                        ) )
    ...
    def __init__(self, 
        ...
        test_mode=None, 
        app_ver_id='9', # ROFEX default. Use "FIX50" for MERVAL
    ...
    def logout(self, msg="User generated logout", timeout=10):
        self.gtfo = True
        self.send(
            Message(
                (35, '5'),
    ...
    def on_msg_in(self, message):
        ...
        pos_dup = 'Y' == message.get_field(43, 'N')
        ...
        if MsgType.TestRequest == _type:
            ...
            try:
                ...
                if confirm.startswith("CONFIRM "):
                    conf_seq_num = int(confirm[len("CONFIRM "):])
