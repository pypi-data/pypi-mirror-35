...
class MuxMinos(object):
    def __init__(self):
        ...
        if 'xiaomi_username' not in self.__config or 'xiaomi_minos1_config_path' not in self.__config or 'xiaomi_minos2_config_path' not in self.__config:
...
{
...
  "xiaomi_minos1_config_path": "your_path..../deployment-config/",
  "xiaomi_minos2_config_path": "your_path..../deployment/",
  "xiaomi_username": "your_name"
...
}
                ''')
            sys.exit(0)
        self.__minos1 = self.__config['xiaomi_minos1_config_path']
        self.__minos2 = self.__config['xiaomi_minos2_config_path']
        ...
        self.__tmuxinator_config = os.path.join(expanduser("~"), '.config', 'tmuxinator')
    ...
    def __generate_4region(self, region_name, hostlist):
        ...
        for host in hostlist:
            ...
            block['panes'].append({host: ['ssh ' + self.__relay_commands, host, 'cd /home/work/app/nginx/logs/']})
            y['windows'].append({ host: block })
