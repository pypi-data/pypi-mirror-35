...
schema = {'setProps': {'nullable': True}, 'animate': {'nullable': True, 'type': 'boolean'}, 'clickData': {'nullable': True, 'type': 'dict'}, 'relayoutData': {'nullable': True, 'type': 'dict'}, 'style': {'nullable': True, 'type': 'dict'}, 'config': {'schema': {'queueLength': {'nullable': True, 'type': 'number'}, 'edits': {'schema': {'annotationText': {'nullable': True, 'type': 'boolean'}, 'legendPosition': {'nullable': True, 'type': 'boolean'}, 'shapePosition': {'nullable': True, 'type': 'boolean'}, 'annotationPosition': {'nullable': True, 'type': 'boolean'}, 'legendText': {'nullable': True, 'type': 'boolean'}, 'colorbarPosition': {'nullable': True, 'type': 'boolean'}, 'annotationTail': {'nullable': True, 'type': 'boolean'}, 'colorbarTitleText': {'nullable': True, 'type': 'boolean'}, 'axisTitleText': {'nullable': True, 'type': 'boolean'}, 'titleText': {'nullable': True, 'type': 'boolean'}}, 'allow_unknown': False, 'nullable': True, 'type': 'dict'}, 'displayModeBar': {'nullable': True, 'allowed': [None, 'true', 'false', 'hover']}, 'sendData': {'nullable': True, 'type': 'boolean'}, 'mapboxAccessToken': {'nullable': True, 'type': ('boolean', 'number', 'string', 'dict', 'list')}, 'doubleClick': {'nullable': True, 'allowed': [None, 'false', 'reset', 'autosize', 'reset+autosize']}, 'editable': {'nullable': True, 'type': 'boolean'}, 'modeBarButtonsToAdd': {'nullable': True, 'type': 'list'}, 'linkText': {'nullable': True, 'type': 'string'}, 'showAxisDragHandles': {'nullable': True, 'type': 'boolean'}, 'autosizable': {'nullable': True, 'type': 'boolean'}, 'fillFrame': {'nullable': True, 'type': 'boolean'}, 'showLink': {'nullable': True, 'type': 'boolean'}, 'staticPlot': {'nullable': True, 'type': 'boolean'}, 'showAxisRangeEntryBoxes': {'nullable': True, 'type': 'boolean'}, 'scrollZoom': {'nullable': True, 'type': 'boolean'}, 'modeBarButtonsToRemove': {'nullable': True, 'type': 'list'}, 'plotGlPixelRatio': {'nullable': True, 'type': 'number'}, 'frameMargins': {'nullable': True, 'type': 'number'}, 'modeBarButtons': {'nullable': True, 'type': ('boolean', 'number', 'string', 'dict', 'list')}, 'showTips': {'nullable': True, 'type': 'boolean'}, 'displaylogo': {'nullable': True, 'type': 'boolean'}, 'topojsonURL': {'nullable': True, 'type': 'string'}}, 'nullable': True, 'type': 'dict', 'allow_unknown': False}, 'animation_options': {'nullable': True, 'type': 'dict'}, 'hoverData': {'nullable': True, 'type': 'dict'}, 'clear_on_unhover': {'nullable': True, 'type': 'boolean'}, 'figure': {'nullable': True, 'type': 'dict'}, 'dashEvents': {'nullable': True, 'allowed': [None, 'click', 'hover', 'selected', 'relayout', 'unhover']}, 'className': {'nullable': True, 'type': 'string'}, 'id': {'required': True, 'nullable': True, 'type': 'string'}, 'fireEvent': {'nullable': True}, 'selectedData': {'nullable': True, 'type': 'dict'}}
