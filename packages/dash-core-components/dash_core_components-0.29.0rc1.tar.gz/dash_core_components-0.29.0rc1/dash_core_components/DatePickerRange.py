...
schema = {'with_portal': {'nullable': True, 'type': 'boolean'}, 'end_date_placeholder_text': {'nullable': True, 'type': 'string'}, 'reopen_calendar_on_clear': {'nullable': True, 'type': 'boolean'}, 'stay_open_on_select': {'nullable': True, 'type': 'boolean'}, 'calendar_orientation': {'nullable': True, 'allowed': [None, 'vertical', 'horizontal']}, 'is_RTL': {'nullable': True, 'type': 'boolean'}, 'initial_visible_month': {'nullable': True, 'type': 'string'}, 'clearable': {'nullable': True, 'type': 'boolean'}, 'first_day_of_week': {'nullable': True, 'allowed': [None, '0', '1', '2', '3', '4', '5', '6']}, 'start_date': {'nullable': True, 'type': 'string'}, 'minimum_nights': {'nullable': True, 'type': 'number'}, 'number_of_months_shown': {'nullable': True, 'type': 'number'}, 'min_date_allowed': {'nullable': True, 'type': 'string'}, 'disabled': {'nullable': True, 'type': 'boolean'}, 'id': {'nullable': True, 'type': 'string'}, 'display_format': {'nullable': True, 'type': 'string'}, 'setProps': {'nullable': True}, 'dashEvents': {'nullable': True, 'allowed': [None, 'change']}, 'start_date_placeholder_text': {'nullable': True, 'type': 'string'}, 'day_size': {'nullable': True, 'type': 'number'}, 'with_full_screen_portal': {'nullable': True, 'type': 'boolean'}, 'updatemode': {'nullable': True, 'allowed': [None, 'singledate', 'bothdates']}, 'max_date_allowed': {'nullable': True, 'type': 'string'}, 'show_outside_days': {'nullable': True, 'type': 'boolean'}, 'end_date': {'nullable': True, 'type': 'string'}, 'month_format': {'nullable': True, 'type': 'string'}}
