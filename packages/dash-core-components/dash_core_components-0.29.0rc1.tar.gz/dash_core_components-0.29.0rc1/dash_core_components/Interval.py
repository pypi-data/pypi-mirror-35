...
schema = {'disabled': {'nullable': True, 'type': 'boolean'}, 'setProps': {'nullable': True}, 'max_intervals': {'nullable': True, 'type': 'number'}, 'interval': {'nullable': True, 'type': 'number'}, 'dashEvents': {'nullable': True, 'allowed': [None, 'interval']}, 'id': {'nullable': True, 'type': 'string'}, 'fireEvent': {'nullable': True}, 'n_intervals': {'nullable': True, 'type': 'number'}}
