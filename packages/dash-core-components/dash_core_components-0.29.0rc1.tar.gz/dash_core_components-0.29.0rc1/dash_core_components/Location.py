...
schema = {'href': {'nullable': True, 'type': 'string'}, 'pathname': {'nullable': True, 'type': 'string'}, 'hash': {'nullable': True, 'type': 'string'}, 'refresh': {'nullable': True, 'type': 'boolean'}, 'search': {'nullable': True, 'type': 'string'}, 'id': {'required': True, 'nullable': True, 'type': 'string'}}
