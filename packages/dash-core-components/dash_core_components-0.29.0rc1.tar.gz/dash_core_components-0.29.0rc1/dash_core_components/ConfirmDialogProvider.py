...
schema = {'displayed': {'nullable': True, 'type': 'boolean'}, 'submit_n_clicks_timestamp': {'nullable': True, 'type': 'number'}, 'message': {'nullable': True, 'type': 'string'}, 'children': {'nullable': True, 'type': ('boolean', 'number', 'string', 'dict', 'list')}, 'setProps': {'nullable': True}, 'cancel_n_clicks_timestamp': {'nullable': True, 'type': 'number'}, 'id': {'nullable': True, 'type': 'string'}, 'submit_n_clicks': {'nullable': True, 'type': 'number'}, 'cancel_n_clicks': {'nullable': True, 'type': 'number'}}
