...
schema = {'filename': {'nullable': True, 'anyof': [{'nullable': True, 'type': 'string'}, {'schema': {'nullable': True, 'type': 'string'}, 'allow_unknown': False, 'nullable': True, 'type': 'list'}]}, 'className_reject': {'nullable': True, 'type': 'string'}, 'setProps': {'nullable': True}, 'className_disabled': {'nullable': True, 'type': 'string'}, 'style_active': {'nullable': True, 'type': 'dict'}, 'style_disabled': {'nullable': True, 'type': 'dict'}, 'disable_click': {'nullable': True, 'type': 'boolean'}, 'style_reject': {'nullable': True, 'type': 'dict'}, 'last_modified': {'nullable': True, 'anyof': [{'nullable': True, 'type': 'number'}, {'schema': {'nullable': True, 'type': 'number'}, 'allow_unknown': False, 'nullable': True, 'type': 'list'}]}, 'className_active': {'nullable': True, 'type': 'string'}, 'min_size': {'nullable': True, 'type': 'number'}, 'style': {'nullable': True, 'type': 'dict'}, 'disabled': {'nullable': True, 'type': 'boolean'}, 'multiple': {'nullable': True, 'type': 'boolean'}, 'children': {'nullable': True, 'anyof': [{'nullable': True, 'anyof': [{'type': 'component'}, {'type': 'boolean'}, {'type': 'number'}, {'type': 'string'}, {'schema': {'anyof': [{'type': 'component'}, {'type': 'boolean'}, {'type': 'number'}, {'type': 'string'}]}, 'nullable': True, 'type': 'list'}]}, {'nullable': True, 'type': 'string'}]}, 'accept': {'nullable': True, 'type': 'string'}, 'max_size': {'nullable': True, 'type': 'number'}, 'contents': {'nullable': True, 'anyof': [{'nullable': True, 'type': 'string'}, {'schema': {'nullable': True, 'type': 'string'}, 'allow_unknown': False, 'nullable': True, 'type': 'list'}]}, 'className': {'nullable': True, 'type': 'string'}, 'id': {'nullable': True, 'type': 'string'}}
