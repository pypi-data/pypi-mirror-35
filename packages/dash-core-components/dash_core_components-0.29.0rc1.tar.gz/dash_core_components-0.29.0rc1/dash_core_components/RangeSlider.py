...
schema = {'min': {'nullable': True, 'type': 'number'}, 'setProps': {'nullable': True}, 'vertical': {'nullable': True, 'type': 'boolean'}, 'step': {'nullable': True, 'type': 'number'}, 'fireEvent': {'nullable': True}, 'marks': {'schema': {'number': {'nullable': True, 'anyof': [{'nullable': True, 'type': 'string'}, {'schema': {'style': {'nullable': True, 'type': 'dict'}, 'label': {'nullable': True, 'type': 'string'}}, 'allow_unknown': False, 'nullable': True, 'type': 'dict'}]}}, 'nullable': True, 'type': 'dict', 'allow_unknown': False}, 'allowCross': {'nullable': True, 'type': 'boolean'}, 'count': {'nullable': True, 'type': 'number'}, 'value': {'schema': {'nullable': True, 'type': 'number'}, 'nullable': True, 'type': 'list', 'allow_unknown': False}, 'pushable': {'nullable': True, 'anyof': [{'nullable': True, 'type': 'boolean'}, {'nullable': True, 'type': 'number'}]}, 'disabled': {'nullable': True, 'type': 'boolean'}, 'dots': {'nullable': True, 'type': 'boolean'}, 'dashEvents': {'nullable': True, 'allowed': [None, 'change']}, 'updatemode': {'nullable': True, 'allowed': [None, 'mouseup', 'drag']}, 'max': {'nullable': True, 'type': 'number'}, 'className': {'nullable': True, 'type': 'string'}, 'id': {'nullable': True, 'type': 'string'}, 'included': {'nullable': True, 'type': 'boolean'}}
