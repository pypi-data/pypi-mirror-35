...
schema = {'cancel_n_clicks_timestamp': {'type': 'number'}, 'submit_n_clicks': {'type': 'number'}, 'displayed': {'type': 'boolean'}, 'setProps': {}, 'submit_n_clicks_timestamp': {'type': 'number'}, 'cancel_n_clicks': {'type': 'number'}, 'key': {'type': 'string'}, 'id': {'type': 'string'}, 'message': {'type': 'string'}}
