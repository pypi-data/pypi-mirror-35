...
schema = {'selectionStart': {'type': 'string'}, 'inputmode': {'allowed': ['verbatim', 'latin', 'latin-name', 'latin-prose', 'full-width-latin', 'kana', 'katakana', 'numeric', 'tel', 'email', 'url'], 'type': ('string', 'number')}, 'max': {'type': 'string'}, 'setProps': {}, 'min': {'type': 'string'}, 'spellcheck': {'type': 'string'}, 'readonly': {'type': 'string'}, 'selectionDirection': {'type': 'string'}, 'multiple': {'type': 'string'}, 'className': {'type': 'string'}, 'size': {'type': 'string'}, 'autocomplete': {'type': 'string'}, 'name': {'type': 'string'}, 'autofocus': {'type': 'string'}, 'list': {'type': 'string'}, 'disabled': {'type': 'boolean'}, 'dashEvents': {'allowed': ['blur', 'change'], 'type': ('string', 'number')}, 'required': {'type': 'string'}, 'step': {'type': 'string'}, 'id': {'type': 'string'}, 'placeholder': {'type': 'string'}, 'pattern': {'type': 'string'}, 'selectionEnd': {'type': 'string'}, 'value': {'type': 'string'}, 'fireEvent': {}, 'maxlength': {'type': 'string'}, 'type': {'allowed': ['text', 'number', 'password', 'email', 'range', 'search', 'tel', 'url', 'hidden'], 'type': ('string', 'number')}, 'style': {'type': 'dict'}, 'minlength': {'type': 'string'}}
