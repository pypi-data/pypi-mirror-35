...
schema = {'dashEvents': {'allowed': ['change'], 'type': ('string', 'number')}, 'dots': {'type': 'boolean'}, 'step': {'type': 'number'}, 'id': {'type': 'string'}, 'vertical': {'type': 'boolean'}, 'max': {'type': 'number'}, 'value': {'type': 'number'}, 'disabled': {'type': 'boolean'}, 'fireEvent': {}, 'updatemode': {'allowed': ['mouseup', 'drag'], 'type': ('string', 'number')}, 'className': {'type': 'string'}, 'included': {'type': 'boolean'}, 'setProps': {}, 'marks': {'nullable': False, 'allow_unknown': False, 'type': 'dict', 'schema': {'number': {'anyof': [{'type': 'string'}, {'nullable': False, 'schema': {'style': {'type': 'dict'}, 'label': {'type': 'string'}}, 'type': 'dict', 'allow_unknown': False}]}}}, 'min': {'type': 'number'}}
