...
schema = {'options': {'type': 'list', 'schema': {'nullable': False, 'allow_unknown': False, 'type': 'dict', 'schema': {'disabled': {'type': 'boolean'}, 'label': {'type': 'string'}, 'value': {'type': 'string'}}}}, 'dashEvents': {'allowed': ['change'], 'type': ('string', 'number')}, 'className': {'type': 'string'}, 'labelStyle': {'type': 'dict'}, 'id': {'type': 'string'}, 'inputStyle': {'type': 'dict'}, 'value': {'type': 'string'}, 'inputClassName': {'type': 'string'}, 'fireEvent': {}, 'setProps': {}, 'style': {'type': 'dict'}, 'labelClassName': {'type': 'string'}}
