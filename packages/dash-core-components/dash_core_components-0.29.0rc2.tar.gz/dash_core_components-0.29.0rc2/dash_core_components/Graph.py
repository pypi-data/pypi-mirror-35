...
schema = {'selectedData': {'type': 'dict'}, 'clear_on_unhover': {'type': 'boolean'}, 'clickData': {'type': 'dict'}, 'setProps': {}, 'id': {'required': True, 'type': 'string'}, 'relayoutData': {'type': 'dict'}, 'dashEvents': {'allowed': ['click', 'hover', 'selected', 'relayout', 'unhover'], 'type': ('string', 'number')}, 'animate': {'type': 'boolean'}, 'fireEvent': {}, 'figure': {'type': 'dict'}, 'className': {'type': 'string'}, 'hoverData': {'type': 'dict'}, 'animation_options': {'type': 'dict'}, 'config': {'nullable': False, 'allow_unknown': False, 'type': 'dict', 'schema': {'showLink': {'type': 'boolean'}, 'topojsonURL': {'type': 'string'}, 'mapboxAccessToken': {'type': ('boolean', 'number', 'string', 'dict', 'list')}, 'showAxisRangeEntryBoxes': {'type': 'boolean'}, 'queueLength': {'type': 'number'}, 'autosizable': {'type': 'boolean'}, 'modeBarButtons': {'type': ('boolean', 'number', 'string', 'dict', 'list')}, 'doubleClick': {'allowed': ['false', 'reset', 'autosize', 'reset+autosize'], 'type': ('string', 'number')}, 'linkText': {'type': 'string'}, 'frameMargins': {'type': 'number'}, 'modeBarButtonsToAdd': {'type': 'list'}, 'edits': {'nullable': False, 'schema': {'annotationPosition': {'type': 'boolean'}, 'axisTitleText': {'type': 'boolean'}, 'legendText': {'type': 'boolean'}, 'annotationText': {'type': 'boolean'}, 'colorbarPosition': {'type': 'boolean'}, 'colorbarTitleText': {'type': 'boolean'}, 'titleText': {'type': 'boolean'}, 'legendPosition': {'type': 'boolean'}, 'annotationTail': {'type': 'boolean'}, 'shapePosition': {'type': 'boolean'}}, 'type': 'dict', 'allow_unknown': False}, 'modeBarButtonsToRemove': {'type': 'list'}, 'editable': {'type': 'boolean'}, 'showTips': {'type': 'boolean'}, 'scrollZoom': {'type': 'boolean'}, 'plotGlPixelRatio': {'type': 'number'}, 'displayModeBar': {'allowed': ['true', 'false', 'hover'], 'type': ('string', 'number')}, 'sendData': {'type': 'boolean'}, 'fillFrame': {'type': 'boolean'}, 'showAxisDragHandles': {'type': 'boolean'}, 'displaylogo': {'type': 'boolean'}, 'staticPlot': {'type': 'boolean'}}}, 'style': {'type': 'dict'}}
