...
schema = {'disabled': {'type': 'boolean'}, 'className_disabled': {'type': 'string'}, 'multiple': {'type': 'boolean'}, 'setProps': {}, 'style_disabled': {'type': 'dict'}, 'id': {'type': 'string'}, 'last_modified': {'anyof': [{'type': 'number'}, {'type': 'list', 'schema': {'nullable': False, 'type': 'number'}}]}, 'min_size': {'type': 'number'}, 'className_active': {'type': 'string'}, 'filename': {'anyof': [{'type': 'string'}, {'type': 'list', 'schema': {'nullable': False, 'type': 'string'}}]}, 'className_reject': {'type': 'string'}, 'children': {'anyof': [{'anyof': [{'type': 'component'}, {'type': 'boolean'}, {'type': 'number'}, {'type': 'string'}, {'type': 'list', 'schema': {'type': ('component', 'boolean', 'number', 'string')}}]}, {'type': 'string'}]}, 'max_size': {'type': 'number'}, 'className': {'type': 'string'}, 'disable_click': {'type': 'boolean'}, 'contents': {'anyof': [{'type': 'string'}, {'type': 'list', 'schema': {'nullable': False, 'type': 'string'}}]}, 'accept': {'type': 'string'}, 'style_reject': {'type': 'dict'}, 'style': {'type': 'dict'}, 'style_active': {'type': 'dict'}}
