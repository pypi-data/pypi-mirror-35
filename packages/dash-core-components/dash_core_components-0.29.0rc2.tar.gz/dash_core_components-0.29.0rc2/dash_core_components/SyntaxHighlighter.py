...
schema = {'useInlineStyles': {'type': 'boolean'}, 'showLineNumbers': {'type': 'boolean'}, 'lineNumberStyle': {'type': 'dict'}, 'theme': {'allowed': ['light', 'dark'], 'type': ('string', 'number')}, 'lineStyle': {'type': 'dict'}, 'codeTagProps': {'type': 'dict'}, 'children': {'anyof': [{'type': 'string'}, {'type': 'list', 'schema': {'nullable': False, 'type': 'string'}}]}, 'lineNumberContainerStyle': {'type': 'dict'}, 'customStyle': {'type': 'dict'}, 'language': {'type': 'string'}, 'startingLineNumber': {'type': 'number'}, 'wrapLines': {'type': 'boolean'}, 'id': {'type': 'string'}}
