...
schema = {'disabled': {'type': 'boolean'}, 'dashEvents': {'allowed': ['interval'], 'type': ('string', 'number')}, 'fireEvent': {}, 'interval': {'type': 'number'}, 'setProps': {}, 'max_intervals': {'type': 'number'}, 'id': {'type': 'string'}, 'n_intervals': {'type': 'number'}}
