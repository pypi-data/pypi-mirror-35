...
schema = {'children': {'anyof': [{'type': 'component'}, {'type': 'boolean'}, {'type': 'number'}, {'type': 'string'}, {'type': 'list', 'schema': {'type': ('component', 'boolean', 'number', 'string')}}]}, 'href': {'type': 'string'}, 'className': {'type': 'string'}, 'id': {'type': 'string'}, 'style': {'type': 'dict'}, 'refresh': {'type': 'boolean'}}
