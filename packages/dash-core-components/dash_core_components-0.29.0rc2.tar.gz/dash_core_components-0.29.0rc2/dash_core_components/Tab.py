...
schema = {'disabled': {'type': 'boolean'}, 'disabled_style': {'type': 'dict'}, 'children': {'anyof': [{'type': 'component'}, {'type': 'boolean'}, {'type': 'number'}, {'type': 'string'}, {'type': 'list', 'schema': {'type': ('component', 'boolean', 'number', 'string')}}]}, 'label': {}, 'className': {'type': 'string'}, 'id': {'type': 'string'}, 'selected_className': {'type': 'string'}, 'disabled_className': {'type': 'string'}, 'style': {'type': 'dict'}, 'selected_style': {'type': 'dict'}, 'value': {'type': 'string'}}
