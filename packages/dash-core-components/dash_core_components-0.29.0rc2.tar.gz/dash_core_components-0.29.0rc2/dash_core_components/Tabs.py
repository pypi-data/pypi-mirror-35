...
schema = {'colors': {'nullable': False, 'allow_unknown': False, 'type': 'dict', 'schema': {'background': {'type': 'string'}, 'primary': {'type': 'string'}, 'border': {'type': 'string'}}}, 'content_style': {'type': 'dict'}, 'id': {'type': 'string'}, 'vertical': {'type': 'boolean'}, 'value': {'type': 'string'}, 'mobile_breakpoint': {'type': 'number'}, 'parent_className': {'type': 'string'}, 'children': {'anyof': [{'type': 'component'}, {'type': 'boolean'}, {'type': 'number'}, {'type': 'string'}, {'type': 'list', 'schema': {'type': ('component', 'boolean', 'number', 'string')}}]}, 'className': {'type': 'string'}, 'content_className': {'type': 'string'}, 'style': {'type': 'dict'}, 'parent_style': {'type': 'dict'}}
