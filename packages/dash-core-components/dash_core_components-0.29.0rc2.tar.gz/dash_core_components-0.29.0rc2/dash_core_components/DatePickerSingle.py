...
schema = {'display_format': {'type': 'string'}, 'date': {'type': 'string'}, 'show_outside_days': {'type': 'boolean'}, 'calendar_orientation': {'allowed': ['vertical', 'horizontal'], 'type': ('string', 'number')}, 'disabled': {'type': 'boolean'}, 'clearable': {'type': 'boolean'}, 'day_size': {'type': 'number'}, 'setProps': {}, 'number_of_months_shown': {'type': 'number'}, 'initial_visible_month': {'type': 'string'}, 'reopen_calendar_on_clear': {'type': 'boolean'}, 'stay_open_on_select': {'type': 'boolean'}, 'dashEvents': {'allowed': ['change'], 'type': ('string', 'number')}, 'first_day_of_week': {'allowed': ['0', '1', '2', '3', '4', '5', '6'], 'type': ('string', 'number')}, 'min_date_allowed': {'type': 'string'}, 'id': {'type': 'string'}, 'placeholder': {'type': 'string'}, 'is_RTL': {'type': 'boolean'}, 'with_portal': {'type': 'boolean'}, 'with_full_screen_portal': {'type': 'boolean'}, 'max_date_allowed': {'type': 'string'}, 'month_format': {'type': 'string'}}
