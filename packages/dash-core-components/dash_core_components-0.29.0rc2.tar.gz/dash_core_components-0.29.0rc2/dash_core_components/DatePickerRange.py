...
schema = {'display_format': {'type': 'string'}, 'show_outside_days': {'type': 'boolean'}, 'start_date_placeholder_text': {'type': 'string'}, 'calendar_orientation': {'allowed': ['vertical', 'horizontal'], 'type': ('string', 'number')}, 'disabled': {'type': 'boolean'}, 'clearable': {'type': 'boolean'}, 'first_day_of_week': {'allowed': ['0', '1', '2', '3', '4', '5', '6'], 'type': ('string', 'number')}, 'setProps': {}, 'reopen_calendar_on_clear': {'type': 'boolean'}, 'initial_visible_month': {'type': 'string'}, 'end_date_placeholder_text': {'type': 'string'}, 'stay_open_on_select': {'type': 'boolean'}, 'dashEvents': {'allowed': ['change'], 'type': ('string', 'number')}, 'day_size': {'type': 'number'}, 'min_date_allowed': {'type': 'string'}, 'max_date_allowed': {'type': 'string'}, 'id': {'type': 'string'}, 'minimum_nights': {'type': 'number'}, 'is_RTL': {'type': 'boolean'}, 'with_portal': {'type': 'boolean'}, 'with_full_screen_portal': {'type': 'boolean'}, 'start_date': {'type': 'string'}, 'end_date': {'type': 'string'}, 'month_format': {'type': 'string'}, 'updatemode': {'allowed': ['singledate', 'bothdates'], 'type': ('string', 'number')}, 'number_of_months_shown': {'type': 'number'}}
