...
schema = {'options': {'type': 'list', 'schema': {'nullable': False, 'allow_unknown': False, 'type': 'dict', 'schema': {'disabled': {'type': 'boolean'}, 'label': {'type': 'string'}, 'value': {'type': 'string'}}}}, 'disabled': {'type': 'boolean'}, 'clearable': {'type': 'boolean'}, 'setProps': {}, 'className': {'type': 'string'}, 'id': {'type': 'string'}, 'placeholder': {'type': 'string'}, 'searchable': {'type': 'boolean'}, 'dashEvents': {'allowed': ['change'], 'type': ('string', 'number')}, 'multi': {'type': 'boolean'}, 'value': {'anyof': [{'type': 'string'}, {'type': 'list', 'schema': {'nullable': False, 'type': 'string'}}]}}
