...
schema = {'updatemode': {'allowed': ['mouseup', 'drag'], 'type': ('string', 'number')}, 'dashEvents': {'allowed': ['change'], 'type': ('string', 'number')}, 'dots': {'type': 'boolean'}, 'pushable': {'anyof': [{'type': 'boolean'}, {'type': 'number'}]}, 'step': {'type': 'number'}, 'id': {'type': 'string'}, 'vertical': {'type': 'boolean'}, 'max': {'type': 'number'}, 'value': {'type': 'list', 'schema': {'nullable': False, 'type': 'number'}}, 'disabled': {'type': 'boolean'}, 'fireEvent': {}, 'allowCross': {'type': 'boolean'}, 'className': {'type': 'string'}, 'count': {'type': 'number'}, 'included': {'type': 'boolean'}, 'setProps': {}, 'marks': {'nullable': False, 'allow_unknown': False, 'type': 'dict', 'schema': {'number': {'anyof': [{'type': 'string'}, {'nullable': False, 'schema': {'style': {'type': 'dict'}, 'label': {'type': 'string'}}, 'type': 'dict', 'allow_unknown': False}]}}}, 'min': {'type': 'number'}}
