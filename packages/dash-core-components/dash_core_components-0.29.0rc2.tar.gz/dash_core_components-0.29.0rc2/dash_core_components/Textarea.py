...
schema = {'autoFocus': {'type': 'string'}, 'hidden': {'type': 'string'}, 'className': {'type': 'string'}, 'maxLength': {'type': 'string'}, 'disabled': {'type': 'string'}, 'tabIndex': {'type': 'string'}, 'minLength': {'type': 'string'}, 'setProps': {}, 'dir': {'type': 'string'}, 'contentEditable': {'type': 'string'}, 'draggable': {'type': 'string'}, 'name': {'type': 'string'}, 'form': {'type': 'string'}, 'dashEvents': {'allowed': ['click', 'blur', 'change'], 'type': ('string', 'number')}, 'style': {'type': 'dict'}, 'accessKey': {'type': 'string'}, 'id': {'type': 'string'}, 'placeholder': {'type': 'string'}, 'cols': {'type': 'string'}, 'readOnly': {'type': 'string'}, 'wrap': {'type': 'string'}, 'value': {'type': 'string'}, 'lang': {'type': 'string'}, 'fireEvent': {}, 'rows': {'type': 'string'}, 'spellCheck': {'type': 'string'}, 'contextMenu': {'type': 'string'}, 'title': {'type': 'string'}, 'required': {'type': 'string'}}
