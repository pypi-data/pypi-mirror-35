...
schema = {'options': {'type': 'list', 'schema': {'nullable': False, 'allow_unknown': False, 'type': 'dict', 'schema': {'disabled': {'type': 'boolean'}, 'label': {'type': 'string'}, 'value': {'type': 'string'}}}}, 'inputClassName': {'type': 'string'}, 'dashEvents': {'allowed': ['change'], 'type': ('string', 'number')}, 'setProps': {}, 'labelStyle': {'type': 'dict'}, 'id': {'type': 'string'}, 'inputStyle': {'type': 'dict'}, 'values': {'type': 'list', 'schema': {'nullable': False, 'type': 'string'}}, 'fireEvent': {}, 'className': {'type': 'string'}, 'style': {'type': 'dict'}, 'labelClassName': {'type': 'string'}}
