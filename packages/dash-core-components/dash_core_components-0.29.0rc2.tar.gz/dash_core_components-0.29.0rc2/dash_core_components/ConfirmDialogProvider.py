...
schema = {'cancel_n_clicks_timestamp': {'type': 'number'}, 'children': {'type': ('boolean', 'number', 'string', 'dict', 'list')}, 'submit_n_clicks': {'type': 'number'}, 'displayed': {'type': 'boolean'}, 'setProps': {}, 'submit_n_clicks_timestamp': {'type': 'number'}, 'cancel_n_clicks': {'type': 'number'}, 'id': {'type': 'string'}, 'message': {'type': 'string'}}
