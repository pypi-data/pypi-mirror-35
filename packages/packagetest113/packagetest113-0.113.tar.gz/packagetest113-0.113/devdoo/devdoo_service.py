...
class DevdooService(object):
    ...
    def __init(self):
        ...
        # Adaptador de conexão broker secundário
        ...
        print "Frontend:", self.service.database_connect_frontend()
        print "Backend:", self.service.broker_connect_backend()
