...
def make_scf_input(paral_kgb=0):
    ...
    # Need hints --> Monkey patch
    for p in pseudos:
        p.dojo_report = {}
        p.dojo_report["hints"] = dict(low={"ecut": 4}, normal={"ecut": 8}, high={"ecut": 10})
...
def build_flow(options):
    ...
    from abipy.flowtk.tasks import BoxcuttedPhononTask
    BoxcuttedPhononTask.patch_flow(flow)
