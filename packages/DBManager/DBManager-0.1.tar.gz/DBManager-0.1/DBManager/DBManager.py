r"""Module for the management of DataBases in Python.
...
class DBManager:
    ...
    def __init__(self, user: str, password: str, dbname: str, conex_type: DBType,
                 host: str = "localhost", port: str = None, sslmode: bool = False):
        self.__user = user
        self.__password = password
        self.__dbname = dbname
        self.__conex_type = conex_type
        self.__host = host
        if port:
            self.__port = port
        else:
    ...
    def _get_driver(self):
        ...
        try:
            ...
            print("Missing module/driver, -> {}\nPlease install it.".format(ex.name))
...
class MySQLConnection(DBManager):
    ...
    def __init__(self, user: str, password: str, dbname: str,
        ...
        super().__init__(user, password, dbname, DBType.MYSQL, host, port, sslmode)
...
class SQLite3(DBManager):
    ...
    def __init__(self, db: str):
        super().__init__("", "", db, DBType.SQLITE3)
...
class SQLServer(DBManager):
    ...
    def __init__(self, user: str, password: str, dbname: str,
        ...
        super().__init__(user, password, dbname, DBType.SQLSERVER, host, port, sslmode)
...
class PostgreSQL(DBManager):
    ...
    def __init__(self, user: str, password: str, dbname: str,
        ...
        super().__init__(user, password, dbname, DBType.POSTGRESQL, host, port, sslmode)
