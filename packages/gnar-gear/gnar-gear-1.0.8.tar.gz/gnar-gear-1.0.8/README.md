...
- Requires environment variables in the form `<< SERVICE >>_SERVICE_PORT`, e.g. `PISTE_SERVICE_PORT`
...
- Uses [requests](http://docs.python-requests.org/en/master/api/#main-interface) under the hood:
  ...
  - [**get**](http://docs.python-requests.org/en/master/api/#requests.get)(path, \*args, \*\*kwargs): Sends a GET request
  - [**post**](http://docs.python-requests.org/en/master/api/#requests.post)(path, \*args, \*\*kwargs): Sends a POST request
  - [**put**](http://docs.python-requests.org/en/master/api/#requests.put)(path, \*args, \*\*kwargs): Sends a PUT request
  - [**patch**](http://docs.python-requests.org/en/master/api/#requests.patch)(path, \*args, \*\*kwargs): Sends a PATCH request
