...
class ProtocolServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.SupportedLanguages = channel.unary_unary(
        ...
        request_serializer=generated__pb2.SupportedLanguagesRequest.SerializeToString,
        response_deserializer=generated__pb2.SupportedLanguagesResponse.FromString,
        )
...
def add_ProtocolServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'SupportedLanguages': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=generated__pb2.SupportedLanguagesRequest.FromString,
          response_serializer=generated__pb2.SupportedLanguagesResponse.SerializeToString,
      ),
