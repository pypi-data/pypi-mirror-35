...
### ===============================================================================
### python -mcynpy.csp prog_hex 1 940    ff 00 0a 00 00 ff
### python -mcynpy.csp prog_hex 1 944 ff 4d 00 0a 00 00
### python -mcynpy.csp prog_hex 1 94a    4d 00 0a 00 00 ff
...
### python -mcynpy.csp upload ..\fw\cy2311r3\Objects\cy2311r3_20180606.2.memh 1
### python -mcynpy.csp upload ..\fw\scp\phy20180605a_prl0605\scp\Objects\scp_20180613.2.memh 1
...
### mapping table
### ===============================================================================
### python -mcynpy.csp prog_asc 1 910 CAN1112A28L_BIN1
    python -mcynpy.csp prog_str 1 930 PY188_`date +%y%m%d%H%M`
...
### python -mcynpy.csp   prog_hex 1 a20    10 FA        51 C2     01 EE        13 E8 C1 F4 21 F4 12 E4

### 2-PDO (5V/3A, 9V/3A, 27W)
### python -mcynpy.csp   prog_hex 1 970 2C 91 01 0A  2C D1 02 00
...
### python -mcynpy.csp   prog_hex 1 970 2C 19 01 0A  2C 91 01 00  2C E1 01 00  2C 49 02 00  DC 20 03 00
### python -mcynpy.csp   prog_hex 1 a20    10 AF        50 FA        01 2C        11 6D        C1 F4     11 F4 62 E4

### python -mcynpy.csp 1 prog_hex 1 98c 2C 19 01 0A  2C 91 01 00  2C E1 01 00  2C 49 02 00  DC 20 03 00
### python -mcynpy.csp 1 prog_hex 1 98c 2C 91 01 0A  2C 91 01 00  3C 21 76 C0
### python -mcynpy.csp 1 prog_hex 1 9a8 2C 91 01 0A  3C 21 76 C0
...
### reset MCU
### ===============================================================================
### python -mcynpy.csp write F7 01 01 01
### python -mcynpy.csp reset
