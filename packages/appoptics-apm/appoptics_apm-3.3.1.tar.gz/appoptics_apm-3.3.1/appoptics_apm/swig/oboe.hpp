...
public:
     ...
     */
    static bool isReady(unsigned int timeout) {
        int ret = oboe_is_ready(timeout);
        switch (ret) {
        case OBOE_SERVER_RESPONSE_OK:
            return true;
        case OBOE_SERVER_RESPONSE_UNKNOWN:
        case OBOE_SERVER_RESPONSE_TRY_LATER:
        case OBOE_SERVER_RESPONSE_LIMIT_EXCEEDED:
        case OBOE_SERVER_RESPONSE_INVALID_API_KEY:
        case OBOE_SERVER_RESPONSE_CONNECT_ERROR:
        default:
            return false;
        }
