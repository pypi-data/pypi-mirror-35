...
if __name__ == '__main__':
    ...
    augmented_search = isogeo.search(token,
                                     augment=1,
                                     tags_as_dicts=1,
                                     check=1,
                                     page_size=5,
                                     #query="keyword:isogeo:tests license:isogeo:f6e0c665905a4feab1e9c1d6359a225f",
                                     #share="1e07910d365449b59b6596a9b428ecd9"
                                     )
    print(augmented_search.get("query"))
