...
if __name__ == '__main__':
    ...
    # load
    fixture = path.realpath("out_api_search_filtered.json")
    print(fixture, path.exists(fixture))
    with open(fixture, "r", encoding="utf8") as f:
        fixture = json.loads(f.read())
    query = fixture.get("query")
    print(query, query.get("_tags"))
    #tags_dict = utils.tags_to_dict(query.get("_tags"))
