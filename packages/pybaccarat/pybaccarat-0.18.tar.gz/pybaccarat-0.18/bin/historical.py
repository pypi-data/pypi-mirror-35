...
shoe = pybaccarat.playingcards.Shoe(
    #"PPTBPBPPPPPBPPPPPPBBBPPBBPBPTPBP")
    "BPBPPBBBBBPBBPBBPBBPPPBPBPPPPP"+"BBPBPBPB")

pybaccarat.baccarat.Game(shoe, pybaccarat.baccarat.Hand(),
    pybaccarat.baccarat.Hand(),baccsys).play()
