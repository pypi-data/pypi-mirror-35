...
from SETMOK_API.util.Scheduler import Scheduler
import json
import sys
...
class SETMOKE_API:
    ...
    def read_and_update_database(self,host, database_user, database_password, database_name):
        schedule=Scheduler(host,database_user,database_password,database_name)
        schedule.read_and_update_database()
