...
class ServicesResourceApi(object):
    ...
    def enter_maintenance_mode_0(self, cluster_name, role_name, service_name, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.enter_maintenance_mode_0(cluster_name, role_name, service_name, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.enter_maintenance_mode_0_with_http_info(cluster_name, role_name, service_name, **kwargs)
        else:
            (data) = self.enter_maintenance_mode_0_with_http_info(cluster_name, role_name, service_name, **kwargs)
            return data

    def enter_maintenance_mode_0_with_http_info(self, cluster_name, role_name, service_name, **kwargs):
        """
        Put the role into maintenance mode.
        Put the role into maintenance mode. This is a synchronous command. The result is known immediately upon return.  <p> Available since API v2. </p>
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.enter_maintenance_mode_0_with_http_info(cluster_name, role_name, service_name, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method enter_maintenance_mode_0" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'cluster_name' is set
        if ('cluster_name' not in params) or (params['cluster_name'] is None):
            raise ValueError("Missing the required parameter `cluster_name` when calling `enter_maintenance_mode_0`")
        # verify the required parameter 'role_name' is set
        if ('role_name' not in params) or (params['role_name'] is None):
            raise ValueError("Missing the required parameter `role_name` when calling `enter_maintenance_mode_0`")
        # verify the required parameter 'service_name' is set
        if ('service_name' not in params) or (params['service_name'] is None):
            raise ValueError("Missing the required parameter `service_name` when calling `enter_maintenance_mode_0`")
    ...
    def exit_maintenance_mode_0(self, cluster_name, role_name, service_name, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.exit_maintenance_mode_0(cluster_name, role_name, service_name, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.exit_maintenance_mode_0_with_http_info(cluster_name, role_name, service_name, **kwargs)
        else:
            (data) = self.exit_maintenance_mode_0_with_http_info(cluster_name, role_name, service_name, **kwargs)
            return data

    def exit_maintenance_mode_0_with_http_info(self, cluster_name, role_name, service_name, **kwargs):
        """
        Take the role out of maintenance mode.
        Take the role out of maintenance mode. This is a synchronous command. The result is known immediately upon return.  <p> Available since API v2. </p>
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.exit_maintenance_mode_0_with_http_info(cluster_name, role_name, service_name, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method exit_maintenance_mode_0" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'cluster_name' is set
        if ('cluster_name' not in params) or (params['cluster_name'] is None):
            raise ValueError("Missing the required parameter `cluster_name` when calling `exit_maintenance_mode_0`")
        # verify the required parameter 'role_name' is set
        if ('role_name' not in params) or (params['role_name'] is None):
            raise ValueError("Missing the required parameter `role_name` when calling `exit_maintenance_mode_0`")
        # verify the required parameter 'service_name' is set
        if ('service_name' not in params) or (params['service_name'] is None):
            raise ValueError("Missing the required parameter `service_name` when calling `exit_maintenance_mode_0`")
    ...
    def get_metrics_0(self, cluster_name, role_name, service_name, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_metrics_0(cluster_name, role_name, service_name, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_metrics_0_with_http_info(cluster_name, role_name, service_name, **kwargs)
        else:
            (data) = self.get_metrics_0_with_http_info(cluster_name, role_name, service_name, **kwargs)
            return data

    def get_metrics_0_with_http_info(self, cluster_name, role_name, service_name, **kwargs):
        """
        Fetch metric readings for a particular role.
        Fetch metric readings for a particular role. <p> By default, this call will look up all metrics available for the role. If only specific metrics are desired, use the <i>metrics</i> parameter. <p> By default, the returned results correspond to a 5 minute window based on the provided end time (which defaults to the current server time). The <i>from</i> and <i>to</i> parameters can be used to control the window being queried. A maximum window of 3 hours is enforced. <p> When requesting a \"full\" view, aside from the extended properties of the returned metric data, the collection will also contain information about all metrics available for the role, even if no readings are available in the requested window.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_metrics_0_with_http_info(cluster_name, role_name, service_name, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_metrics_0" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'cluster_name' is set
        if ('cluster_name' not in params) or (params['cluster_name'] is None):
            raise ValueError("Missing the required parameter `cluster_name` when calling `get_metrics_0`")
        # verify the required parameter 'role_name' is set
        if ('role_name' not in params) or (params['role_name'] is None):
            raise ValueError("Missing the required parameter `role_name` when calling `get_metrics_0`")
        # verify the required parameter 'service_name' is set
        if ('service_name' not in params) or (params['service_name'] is None):
            raise ValueError("Missing the required parameter `service_name` when calling `get_metrics_0`")
    ...
    def list_active_commands_0(self, cluster_name, role_name, service_name, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_active_commands_0(cluster_name, role_name, service_name, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.list_active_commands_0_with_http_info(cluster_name, role_name, service_name, **kwargs)
        else:
            (data) = self.list_active_commands_0_with_http_info(cluster_name, role_name, service_name, **kwargs)
            return data

    def list_active_commands_0_with_http_info(self, cluster_name, role_name, service_name, **kwargs):
        """
        List active role commands.
        List active role commands.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.list_active_commands_0_with_http_info(cluster_name, role_name, service_name, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_active_commands_0" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'cluster_name' is set
        if ('cluster_name' not in params) or (params['cluster_name'] is None):
            raise ValueError("Missing the required parameter `cluster_name` when calling `list_active_commands_0`")
        # verify the required parameter 'role_name' is set
        if ('role_name' not in params) or (params['role_name'] is None):
            raise ValueError("Missing the required parameter `role_name` when calling `list_active_commands_0`")
        # verify the required parameter 'service_name' is set
        if ('service_name' not in params) or (params['service_name'] is None):
            raise ValueError("Missing the required parameter `service_name` when calling `list_active_commands_0`")
