...
"""
-------------------------------------------------
   File Name：     versionChange.py
   Description :   Python2版本号变更
   Author :       lvchenggang
   date：          2018/8/14
-------------------------------------------------
   Change Activity:
...
class RootPomVersion(PomVersion):
  ...
  def __init__(self, pomFile, groupId, artifactPattern, propertyTag, oriVersion, destVersion):
    PomVersion.__init__(self, pomFile, groupId, artifactPattern, None, oriVersion, destVersion)
...
class PropertiesPomVersion(PomVersion):
  ...
  def __init__(self, pomFile, groupId, artifactPattern, propertyTag, oriVersion, destVersion):
    PomVersion.__init__(self, pomFile, groupId, artifactPattern, propertyTag, oriVersion, destVersion)
