...
def exp_einhuellende(t,y,ey,sens=0.1):
    ...
    Optional kann eine Sensibilität angegeben werden, die bestimmt,
    ...
    '''
    if not 0.<sens<1.:
        raise ValueError(u'Sensibilität muss zwischen 0 und 1 liegen!')
    ...
    # Lösche alle Elemente die unter der Sensibilitätsschwelle liegen
