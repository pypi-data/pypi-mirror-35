...
def assemble_casava_line(p7_bc, meta_info):
    ...
    run = random.randint(0, 10_000)
    flowcell_id = random.randint(0, 10_000)
    lane = random.randint(0, 10_000)
    tile = random.randint(0, 1_000_000)
    xpos = random.randint(0, 1_000_000)
    ypos = random.randint(0, 1_000_000)
    # fill the line template
    p5_line = casava_line.format("instrument", run, flowcell_id, lane, tile, xpos, ypos, 1, "N", 4711, p7_bc.decode())
    p7_line = casava_line.format("instrument", run, flowcell_id, lane, tile, xpos, ypos, 2, "N", 4711, p7_bc.decode())
