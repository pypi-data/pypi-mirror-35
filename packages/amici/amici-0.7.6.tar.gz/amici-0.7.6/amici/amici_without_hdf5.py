...
class SolverPtr(_object):
    ...
    def setup(self, fwd, model):
        return _amici.SolverPtr_setup(self, fwd, model)
    ...
    def sensReInit(self, ism, yS0, ypS0):
        return _amici.SolverPtr_sensReInit(self, ism, yS0, ypS0)
...
class Solver(_object):
    ...
    def setup(self, fwd, model):
        return _amici.Solver_setup(self, fwd, model)
    ...
    def sensReInit(self, ism, yS0, ypS0):
        return _amici.Solver_sensReInit(self, ism, yS0, ypS0)
...
class IDASolver(Solver):
    ...
    def create(self, lmm, iter):
        return _amici.IDASolver_create(self, lmm, iter)

    def setSStolerances(self, rtol, atol):
        return _amici.IDASolver_setSStolerances(self, rtol, atol)

    def setSensSStolerances(self, rtol, atol):
        return _amici.IDASolver_setSensSStolerances(self, rtol, atol)

    def setSensErrCon(self, error_corr):
        return _amici.IDASolver_setSensErrCon(self, error_corr)

    def setQuadErrConB(self, which, flag):
        return _amici.IDASolver_setQuadErrConB(self, which, flag)

    def getRootInfo(self, rootsfound):
        return _amici.IDASolver_getRootInfo(self, rootsfound)

    def setErrHandlerFn(self):
        return _amici.IDASolver_setErrHandlerFn(self)

    def setUserData(self, model):
        return _amici.IDASolver_setUserData(self, model)

    def setUserDataB(self, which, model):
        return _amici.IDASolver_setUserDataB(self, which, model)

    def setMaxNumSteps(self, mxsteps):
        return _amici.IDASolver_setMaxNumSteps(self, mxsteps)

    def setStabLimDet(self, stldet):
        return _amici.IDASolver_setStabLimDet(self, stldet)

    def setStabLimDetB(self, which, stldet):
        return _amici.IDASolver_setStabLimDetB(self, which, stldet)

    def setId(self, model):
        return _amici.IDASolver_setId(self, model)

    def setSuppressAlg(self, flag):
        return _amici.IDASolver_setSuppressAlg(self, flag)

    def reInit(self, t0, yy0, yp0):
        return _amici.IDASolver_reInit(self, t0, yy0, yp0)

    def sensReInit(self, ism, yS0, ypS0):
        return _amici.IDASolver_sensReInit(self, ism, yS0, ypS0)

    def setSensParams(self, p, pbar, plist):
        return _amici.IDASolver_setSensParams(self, p, pbar, plist)
    ...
    def adjInit(self, steps, interp):
        return _amici.IDASolver_adjInit(self, steps, interp)

    def createB(self, lmm, iter, which):
        return _amici.IDASolver_createB(self, lmm, iter, which)

    def reInitB(self, which, tB0, yyB0, ypB0):
        return _amici.IDASolver_reInitB(self, which, tB0, yyB0, ypB0)

    def setSStolerancesB(self, which, relTolB, absTolB):
        return _amici.IDASolver_setSStolerancesB(self, which, relTolB, absTolB)
    ...
    def setMaxNumStepsB(self, which, mxstepsB):
        return _amici.IDASolver_setMaxNumStepsB(self, which, mxstepsB)
    ...
    def dense(self, nx):
        return _amici.IDASolver_dense(self, nx)

    def denseB(self, which, nx):
        return _amici.IDASolver_denseB(self, which, nx)

    def band(self, nx, ubw, lbw):
        return _amici.IDASolver_band(self, nx, ubw, lbw)

    def bandB(self, which, nx, ubw, lbw):
        return _amici.IDASolver_bandB(self, which, nx, ubw, lbw)

    def diag(self):
        return _amici.IDASolver_diag(self)

    def diagB(self, which):
        return _amici.IDASolver_diagB(self, which)

    def spgmr(self, prectype, maxl):
        return _amici.IDASolver_spgmr(self, prectype, maxl)

    def spgmrB(self, which, prectype, maxl):
        return _amici.IDASolver_spgmrB(self, which, prectype, maxl)

    def spbcg(self, prectype, maxl):
        return _amici.IDASolver_spbcg(self, prectype, maxl)

    def spbcgB(self, which, prectype, maxl):
        return _amici.IDASolver_spbcgB(self, which, prectype, maxl)

    def sptfqmr(self, prectype, maxl):
        return _amici.IDASolver_sptfqmr(self, prectype, maxl)

    def sptfqmrB(self, which, prectype, maxl):
        return _amici.IDASolver_sptfqmrB(self, which, prectype, maxl)

    def klu(self, nx, nnz, sparsetype):
        return _amici.IDASolver_klu(self, nx, nnz, sparsetype)

    def kluSetOrdering(self, ordering):
        return _amici.IDASolver_kluSetOrdering(self, ordering)

    def kluSetOrderingB(self, which, ordering):
        return _amici.IDASolver_kluSetOrderingB(self, which, ordering)

    def kluB(self, which, nx, nnz, sparsetype):
        return _amici.IDASolver_kluB(self, which, nx, nnz, sparsetype)

    def getNumSteps(self, ami_mem, numsteps):
        return _amici.IDASolver_getNumSteps(self, ami_mem, numsteps)

    def getNumRhsEvals(self, ami_mem, numrhsevals):
        return _amici.IDASolver_getNumRhsEvals(self, ami_mem, numrhsevals)

    def getNumErrTestFails(self, ami_mem, numerrtestfails):
        return _amici.IDASolver_getNumErrTestFails(self, ami_mem, numerrtestfails)

    def getNumNonlinSolvConvFails(self, ami_mem, numnonlinsolvconvfails):
        return _amici.IDASolver_getNumNonlinSolvConvFails(self, ami_mem, numnonlinsolvconvfails)

    def getLastOrder(self, ami_mem, order):
        return _amici.IDASolver_getLastOrder(self, ami_mem, order)

    def getAdjBmem(self, ami_mem, which):
        return _amici.IDASolver_getAdjBmem(self, ami_mem, which)
...
class CVodeSolver(Solver):
    ...
    def create(self, lmm, iter):
        return _amici.CVodeSolver_create(self, lmm, iter)

    def setSStolerances(self, rtol, atol):
        return _amici.CVodeSolver_setSStolerances(self, rtol, atol)

    def setSensSStolerances(self, rtol, atol):
        return _amici.CVodeSolver_setSensSStolerances(self, rtol, atol)

    def setSensErrCon(self, error_corr):
        return _amici.CVodeSolver_setSensErrCon(self, error_corr)

    def setQuadErrConB(self, which, flag):
        return _amici.CVodeSolver_setQuadErrConB(self, which, flag)

    def getRootInfo(self, rootsfound):
        return _amici.CVodeSolver_getRootInfo(self, rootsfound)

    def setErrHandlerFn(self):
        return _amici.CVodeSolver_setErrHandlerFn(self)

    def setUserData(self, model):
        return _amici.CVodeSolver_setUserData(self, model)

    def setUserDataB(self, which, model):
        return _amici.CVodeSolver_setUserDataB(self, which, model)

    def setMaxNumSteps(self, mxsteps):
        return _amici.CVodeSolver_setMaxNumSteps(self, mxsteps)

    def setStabLimDet(self, stldet):
        return _amici.CVodeSolver_setStabLimDet(self, stldet)

    def setStabLimDetB(self, which, stldet):
        return _amici.CVodeSolver_setStabLimDetB(self, which, stldet)

    def setId(self, model):
        return _amici.CVodeSolver_setId(self, model)

    def setSuppressAlg(self, flag):
        return _amici.CVodeSolver_setSuppressAlg(self, flag)

    def reInit(self, t0, yy0, yp0):
        return _amici.CVodeSolver_reInit(self, t0, yy0, yp0)

    def sensReInit(self, ism, yS0, ypS0):
        return _amici.CVodeSolver_sensReInit(self, ism, yS0, ypS0)

    def setSensParams(self, p, pbar, plist):
        return _amici.CVodeSolver_setSensParams(self, p, pbar, plist)
    ...
    def adjInit(self, steps, interp):
        return _amici.CVodeSolver_adjInit(self, steps, interp)

    def createB(self, lmm, iter, which):
        return _amici.CVodeSolver_createB(self, lmm, iter, which)

    def reInitB(self, which, tB0, yyB0, ypB0):
        return _amici.CVodeSolver_reInitB(self, which, tB0, yyB0, ypB0)

    def setSStolerancesB(self, which, relTolB, absTolB):
        return _amici.CVodeSolver_setSStolerancesB(self, which, relTolB, absTolB)

    def quadReInitB(self, which, yQB0):
        return _amici.CVodeSolver_quadReInitB(self, which, yQB0)

    def quadSStolerancesB(self, which, reltolQB, abstolQB):
        return _amici.CVodeSolver_quadSStolerancesB(self, which, reltolQB, abstolQB)
    ...
    def setMaxNumStepsB(self, which, mxstepsB):
        return _amici.CVodeSolver_setMaxNumStepsB(self, which, mxstepsB)
    ...
    def dense(self, nx):
        return _amici.CVodeSolver_dense(self, nx)

    def denseB(self, which, nx):
        return _amici.CVodeSolver_denseB(self, which, nx)

    def band(self, nx, ubw, lbw):
        return _amici.CVodeSolver_band(self, nx, ubw, lbw)

    def bandB(self, which, nx, ubw, lbw):
        return _amici.CVodeSolver_bandB(self, which, nx, ubw, lbw)

    def diag(self):
        return _amici.CVodeSolver_diag(self)

    def diagB(self, which):
        return _amici.CVodeSolver_diagB(self, which)

    def spgmr(self, prectype, maxl):
        return _amici.CVodeSolver_spgmr(self, prectype, maxl)

    def spgmrB(self, which, prectype, maxl):
        return _amici.CVodeSolver_spgmrB(self, which, prectype, maxl)

    def spbcg(self, prectype, maxl):
        return _amici.CVodeSolver_spbcg(self, prectype, maxl)

    def spbcgB(self, which, prectype, maxl):
        return _amici.CVodeSolver_spbcgB(self, which, prectype, maxl)

    def sptfqmr(self, prectype, maxl):
        return _amici.CVodeSolver_sptfqmr(self, prectype, maxl)

    def sptfqmrB(self, which, prectype, maxl):
        return _amici.CVodeSolver_sptfqmrB(self, which, prectype, maxl)

    def klu(self, nx, nnz, sparsetype):
        return _amici.CVodeSolver_klu(self, nx, nnz, sparsetype)

    def kluSetOrdering(self, ordering):
        return _amici.CVodeSolver_kluSetOrdering(self, ordering)

    def kluSetOrderingB(self, which, ordering):
        return _amici.CVodeSolver_kluSetOrderingB(self, which, ordering)

    def kluB(self, which, nx, nnz, sparsetype):
        return _amici.CVodeSolver_kluB(self, which, nx, nnz, sparsetype)

    def getNumSteps(self, ami_mem, numsteps):
        return _amici.CVodeSolver_getNumSteps(self, ami_mem, numsteps)

    def getNumRhsEvals(self, ami_mem, numrhsevals):
        return _amici.CVodeSolver_getNumRhsEvals(self, ami_mem, numrhsevals)

    def getNumErrTestFails(self, ami_mem, numerrtestfails):
        return _amici.CVodeSolver_getNumErrTestFails(self, ami_mem, numerrtestfails)

    def getNumNonlinSolvConvFails(self, ami_mem, numnonlinsolvconvfails):
        return _amici.CVodeSolver_getNumNonlinSolvConvFails(self, ami_mem, numnonlinsolvconvfails)

    def getLastOrder(self, ami_ami_mem, order):
        return _amici.CVodeSolver_getLastOrder(self, ami_ami_mem, order)

    def getAdjBmem(self, ami_mem, which):
        return _amici.CVodeSolver_getAdjBmem(self, ami_mem, which)
