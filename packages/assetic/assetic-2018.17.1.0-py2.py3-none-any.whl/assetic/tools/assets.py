...
class AssetTools(object):
    ...
    def get_list_of_modified_complete_assets_for_category(self, category
        ...
        # not very efficient, will get a list of components and then get each
        # asset one at a time
        all_components = list()
        ...
        for component in all_components:
            if component["AssetId"] not in asset_ids:
                ...
                # add assetid to list
                asset_ids.append(component["AssetId"])
