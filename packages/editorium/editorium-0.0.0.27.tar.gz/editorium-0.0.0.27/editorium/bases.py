...
class EditMessages:
    ...
    def __init__( self, base: bool = False ):
        not_base = not base
        self.keep_left: bool = None if not_base else False
        self.hide: bool = None if not_base else False
        self.boolean_display: EBoolDisplay = None if not_base else EBoolDisplay.CHECKBOX
        self.boolean_texts: Tuple[str, str, str] = None if not_base else ("", "", "")
        self.enum_none: str = None if not_base else "None"
        self.hide_text: Tuple[str, str] = None if not_base else ("", "")
...
class Editorium:
    ...
    def __init__( self ) -> None:
        ...
        self.default_messages = EditMessages( base = True )
