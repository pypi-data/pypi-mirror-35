...
from pyhivehere import common
from pyhivehere.common import DBAPITypeObject
# Make all exceptions visible in this module per DB-API
from pyhivehere.exc import *  # noqa
import base64
import getpass
import logging
import requests
...
class Cursor(common.DBAPICursor):
    ...
    def __init__(self, host, port='8080', username=None, catalog='hive',
                 schema='default', poll_interval=1, source='pyhivehere', session_props=None,
