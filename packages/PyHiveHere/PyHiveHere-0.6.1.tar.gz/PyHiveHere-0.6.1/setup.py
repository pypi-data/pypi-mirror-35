...
setup(
    name="PyHiveHere",
    version=pyhivehere.__version__,
    ...
    packages=['pyhivehere', 'TCLIService'],
    classifiers=[
    ...
    entry_points={
        'sqlalchemy.dialects': [
            'hive = pyhivehere.sqlalchemy_hive:HiveDialect',
            'presto = pyhivehere.sqlalchemy_presto:PrestoDialect',
        ],
    }
)
