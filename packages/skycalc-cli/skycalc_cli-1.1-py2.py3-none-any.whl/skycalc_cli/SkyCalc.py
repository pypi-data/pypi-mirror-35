...
class AlmanacQuery:
    ...
    def __init__(self, indic):
        ...
        self.almdata = None
        self.almserver = 'http://etimecalret-p110-1.eso.org'
...
class SkyModel:
    ...
    def __init__(self):
        ...
        self.stop_on_errors_and_exceptions = False
        self.data = None
        # self.server='http://www.eso.org'
        self.server = 'http://etimecalret-p110-1.eso.org'
        self.url = self.server + '/observing/etc/api/skycalc'
        self.deleter_script_url = self.server + '/observing/etc/api/rmtmp'
        self.bugreport_text = 'If you think this indicates a bug in ' + \
                              'skycalc please report to usd-help@eso.org ' + \
                              ' including information to reproduce the problem'
        self.tmpdir = ''
        self.params = {
