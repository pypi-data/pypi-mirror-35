# Generated by Django 2.1 on 2018-08-21 11:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(choices=[(1, '店铺'), (2, '文章'), (3, '论坛')], default=1, verbose_name='类别')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(choices=[(3, '企业'), (1, '女性'), (2, '新闻')], default=1, verbose_name='站点类别')),
