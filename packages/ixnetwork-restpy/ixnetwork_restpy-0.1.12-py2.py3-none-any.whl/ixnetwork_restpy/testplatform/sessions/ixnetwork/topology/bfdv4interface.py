...
class Bfdv4Interface(Base):
	...
	def Bfdv4Session(self):
		"""Returns the one and only one Bfdv4Session object from the server.
		...
		return self._read(Bfdv4Session(self), None)
	...
	def Start(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('start', child='bfdv4Session', payload=locals(), response_object=None)
	...
	def Stop(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('stop', child='bfdv4Session', payload=locals(), response_object=None)
	...
	def remove(self):
		"""Deletes a child instance of Bfdv4Interface on the server.
