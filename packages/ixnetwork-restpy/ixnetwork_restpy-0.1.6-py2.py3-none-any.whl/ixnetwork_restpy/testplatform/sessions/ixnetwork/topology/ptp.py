...
class Ptp(Base):
	...
	def PtpNegBehaveList(self):
		"""Returns the one and only one PtpNegBehaveList object from the server.
		...
		return self._read(PtpNegBehaveList(self), None)

	@property
	def SendgPtpSignalingParams(self):
		"""Returns the one and only one SendgPtpSignalingParams object from the server.
		...
		return self._read(SendgPtpSignalingParams(self), None)
	...
	def remove(self):
		"""Deletes a child instance of Ptp on the server.
