...
class BgpV6IPRouteProperty(Base):
	...
	def Rfc8277LabelStack(self, Count=None, DescriptiveName=None, MplsLabelEnd=None, MplsLabelStart=None, MplsLabelStep=None, Name=None):
		...
		Args:
			...
			MplsLabelEnd (obj(ixnetwork_restpy.multivalue.Multivalue)): MPLS Label End
			MplsLabelStart (obj(ixnetwork_restpy.multivalue.Multivalue)): MPLS Label Start
			MplsLabelStep (obj(ixnetwork_restpy.multivalue.Multivalue)): MPLS Label Step
	...
	def BgpAigpList(self, Count=None, DescriptiveName=None, Name=None, Type=None, Value=None):
