...
class Ipv6sr(Base):
	...
	def IPv6SegmentsList(self, Count=None, DescriptiveName=None, Name=None, SID=None, SIDEnable=None):
		...
		Args:
			...
			SID (obj(ixnetwork_restpy.multivalue.Multivalue)): Segment Item Address
			SIDEnable (obj(ixnetwork_restpy.multivalue.Multivalue)): Enable This Segment
