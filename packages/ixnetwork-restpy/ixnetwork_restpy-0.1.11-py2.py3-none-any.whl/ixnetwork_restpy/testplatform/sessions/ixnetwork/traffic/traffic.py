...
class Traffic(Base):
	...
	def DuplicateItems(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('duplicateItems', child='trafficItem', payload=locals(), response_object=None)
	...
	def Generate(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('generate', child='trafficItem', payload=locals(), response_object=None)
	...
	def ResolveAptixiaEndpoints(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('resolveAptixiaEndpoints', child='trafficItem', payload=locals(), response_object=None)
	...
	def StartDefaultLearning(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('startDefaultLearning', child='trafficItem', payload=locals(), response_object=None)
	...
	def StartLearning(self, Arg1, Arg2, Arg3, Arg4):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('startLearning', child='trafficItem', payload=locals(), response_object=None)
	...
	def StartStatelessTraffic(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('startStatelessTraffic', child='trafficItem', payload=locals(), response_object=None)
	...
	def StartStatelessTrafficBlocking(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('startStatelessTrafficBlocking', child='trafficItem', payload=locals(), response_object=None)
	...
	def StopStatelessTraffic(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('stopStatelessTraffic', child='trafficItem', payload=locals(), response_object=None)
	...
	def StopStatelessTrafficBlocking(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('stopStatelessTrafficBlocking', child='trafficItem', payload=locals(), response_object=None)
