...
class TrafficItem(Base):
	...
	def DeleteQuickFlowGroups(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('deleteQuickFlowGroups', child='highLevelStream', payload=locals(), response_object=None)
	...
	def StartStatelessTraffic(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('startStatelessTraffic', child='highLevelStream', payload=locals(), response_object=None)
	...
	def StartStatelessTrafficBlocking(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('startStatelessTrafficBlocking', child='highLevelStream', payload=locals(), response_object=None)
	...
	def StopStatelessTraffic(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('stopStatelessTraffic', child='highLevelStream', payload=locals(), response_object=None)
	...
	def StopStatelessTrafficBlocking(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('stopStatelessTrafficBlocking', child='highLevelStream', payload=locals(), response_object=None)
