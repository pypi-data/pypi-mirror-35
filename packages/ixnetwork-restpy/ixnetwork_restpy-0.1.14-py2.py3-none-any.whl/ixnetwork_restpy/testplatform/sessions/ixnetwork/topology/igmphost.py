...
class IgmpHost(Base):
	...
	def IgmpJoinGroup(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('igmpJoinGroup', child='igmpMcastIPv4GroupList', payload=locals(), response_object=None)
	...
	def IgmpLeaveGroup(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('igmpLeaveGroup', child='igmpMcastIPv4GroupList', payload=locals(), response_object=None)
	...
	def StartIptv(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('startIptv', child='iptv', payload=locals(), response_object=None)
	...
	def StopIptv(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('stopIptv', child='iptv', payload=locals(), response_object=None)
