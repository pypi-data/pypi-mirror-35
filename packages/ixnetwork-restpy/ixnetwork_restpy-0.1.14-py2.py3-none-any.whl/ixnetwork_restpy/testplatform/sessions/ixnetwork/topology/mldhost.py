...
class MldHost(Base):
	...
	def MldJoinGroup(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('mldJoinGroup', child='mldMcastIPv6GroupList', payload=locals(), response_object=None)
	...
	def MldLeaveGroup(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('mldLeaveGroup', child='mldMcastIPv6GroupList', payload=locals(), response_object=None)
