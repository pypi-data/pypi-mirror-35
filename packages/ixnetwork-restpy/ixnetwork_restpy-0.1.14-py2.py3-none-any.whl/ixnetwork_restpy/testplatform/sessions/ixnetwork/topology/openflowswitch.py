...
class OpenFlowSwitch(Base):
	...
	def RestartDown(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('restartDown', child='OFSwitchChannel', payload=locals(), response_object=None)
	...
	def Start(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('start', child='OFSwitchChannel', payload=locals(), response_object=None)
	...
	def Stop(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('stop', child='OFSwitchChannel', payload=locals(), response_object=None)
