...
class SimInterfaceIPv6Config(Base):
	...
	def Disconnect(self, Arg1):
		...
		Args:
			Arg1 (list(str[None|/api/v1/sessions/1/ixnetwork/topology])): This parameter requires a list of /topology/./ospfv3PseudoInterface object references

		Raises:
			NotFoundError: The requested resource does not exist on the server
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('disconnect', child='ospfv3PseudoInterface', payload=locals(), response_object=None)
	...
	def Reconnect(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('reconnect', child='ospfv3PseudoInterface', payload=locals(), response_object=None)
	...
	def Start(self, Targets):
		...
		Args:
			Targets (list(str[None|/api/v1/sessions/1/ixnetwork/topology])): This parameter requires a list of /topology/./ospfv3PseudoInterface object references

		Raises:
			NotFoundError: The requested resource does not exist on the server
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('start', child='ospfv3PseudoInterface', payload=locals(), response_object=None)
	...
	def Stop(self, Targets):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('stop', child='ospfv3PseudoInterface', payload=locals(), response_object=None)
