...
class IsisL3PseudoRouter(Base):
	...
	def IPv4PseudoNodeRoutes(self, Active=None, Algorithm=None, ConfigureSIDIndexLabel=None, Count=None, DescriptiveName=None, Ipv4EFlag=None, Ipv4LFlag=None, Ipv4Metric=None, Ipv4NFlag=None, Ipv4PFlag=None, Ipv4RFlag=None, Ipv4Redistribution=None, Ipv4RouteOrigin=None, Ipv4VFlag=None, Name=None, NetworkAddress=None, PrefixLength=None, RangeSize=None, SIDIndexLabel=None):
		...
		Args:
			...
			Ipv4EFlag (obj(ixnetwork_restpy.multivalue.Multivalue)): Explicit NULL flag
			Ipv4LFlag (obj(ixnetwork_restpy.multivalue.Multivalue)): Local Flag
			Ipv4Metric (obj(ixnetwork_restpy.multivalue.Multivalue)): Route Metric
			Ipv4NFlag (obj(ixnetwork_restpy.multivalue.Multivalue)): Nodal prefix flag
			Ipv4PFlag (obj(ixnetwork_restpy.multivalue.Multivalue)): No-PHP flag. If set, then the penultimate hop MUST NOT pop the Prefix-SID before delivering the packet to the node that advertised the Prefix-SID.
			Ipv4RFlag (obj(ixnetwork_restpy.multivalue.Multivalue)): Redistribution flag
			Ipv4Redistribution (obj(ixnetwork_restpy.multivalue.Multivalue)): Redistribution
			Ipv4RouteOrigin (obj(ixnetwork_restpy.multivalue.Multivalue)): Route Origin
			Ipv4VFlag (obj(ixnetwork_restpy.multivalue.Multivalue)): Value Flag
	...
	def Start(self, Targets):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('start', child='IPv4PseudoNodeRoutes', payload=locals(), response_object=None)
	...
	def Stop(self, Targets):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('stop', child='IPv4PseudoNodeRoutes', payload=locals(), response_object=None)

	def IPv6PseudoNodeRoutes(self, Active=None, AdvIPv6Prefix=None, Algorithm=None, ConfigureSIDIndexLabel=None, Count=None, DBitInsideSRv6SidTLV=None, DescriptiveName=None, Funcflags=None, Function=None, Ipv6EFlag=None, Ipv6LFlag=None, Ipv6Metric=None, Ipv6NFlag=None, Ipv6PFlag=None, Ipv6RFlag=None, Ipv6Redistribution=None, Ipv6RouteOrigin=None, Ipv6SID=None, Ipv6Srh=None, Ipv6VFlag=None, Name=None, NetworkAddress=None, Prefix=None, RangeSize=None, ReservedInsideFlagsOfSRv6SidTLV=None, SIDIndexLabel=None):
		...
		Args:
			...
			Ipv6EFlag (obj(ixnetwork_restpy.multivalue.Multivalue)): Explicit NULL flag
			Ipv6LFlag (obj(ixnetwork_restpy.multivalue.Multivalue)): Local Flag
			Ipv6Metric (obj(ixnetwork_restpy.multivalue.Multivalue)): Route Metric
			Ipv6NFlag (obj(ixnetwork_restpy.multivalue.Multivalue)): Nodal prefix flag
			Ipv6PFlag (obj(ixnetwork_restpy.multivalue.Multivalue)): No-PHP flag. If set, then the penultimate hop MUST NOT pop the Prefix-SID before delivering the packet to the node that advertised the Prefix-SID.
			Ipv6RFlag (obj(ixnetwork_restpy.multivalue.Multivalue)): Redistribution flag
			Ipv6Redistribution (obj(ixnetwork_restpy.multivalue.Multivalue)): Redistribution
			Ipv6RouteOrigin (obj(ixnetwork_restpy.multivalue.Multivalue)): Route Origin
			...
			Ipv6VFlag (obj(ixnetwork_restpy.multivalue.Multivalue)): Value Flag
			Name (str): Name of NGPF element, guaranteed to be unique in Scenario
	...
	def Start(self, Targets):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('start', child='IPv6PseudoNodeRoutes', payload=locals(), response_object=None)
	...
	def Stop(self, Targets):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('stop', child='IPv6PseudoNodeRoutes', payload=locals(), response_object=None)

	def IsisSRAlgorithmList(self, Count=None, DescriptiveName=None, IsisSrAlgorithm=None, Name=None):
		...
		Args:
			Count (number): Number of elements inside associated multiplier-scaled container object, e.g. number of devices inside a Device Group
			DescriptiveName (str): Longer, more descriptive name for element. It's not guaranteed to be unique like -name-, but maybe offers more context
			IsisSrAlgorithm (obj(ixnetwork_restpy.multivalue.Multivalue)): SR Algorithm
			Name (str): Name of NGPF element, guaranteed to be unique in Scenario
	...
	def IsisSRGBRangeSubObjectsList(self, Count=None, DescriptiveName=None, Name=None, SIDCount=None, StartSIDLabel=None):
	...
	def IsisSRLBDescriptorList(self, Count=None, DescriptiveName=None, Name=None, SIDCount=None, StartSIDLabel=None):
