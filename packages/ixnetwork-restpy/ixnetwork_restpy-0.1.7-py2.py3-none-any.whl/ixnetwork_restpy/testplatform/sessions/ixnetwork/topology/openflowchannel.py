...
class OpenFlowChannel(Base):
	...
	def Groups(self, Active=None, ChannelName=None, Count=None, DescriptiveName=None, GroupAdvertise=None, GroupDescription=None, GroupId=None, GroupType=None, Multiplier=None, Name=None, NumberOfBuckets=None, OfChannel=None):
		...
		Args:
			...
			GroupAdvertise (obj(ixnetwork_restpy.multivalue.Multivalue)): If selected, group is advertised when the OpenFlow channel comes up.
			GroupDescription (obj(ixnetwork_restpy.multivalue.Multivalue)): A description of the group.
			GroupId (obj(ixnetwork_restpy.multivalue.Multivalue)): A 32-bit integer uniquely identifying the group.
			GroupType (obj(ixnetwork_restpy.multivalue.Multivalue)): Select the type of group to determine the group semantics.
			...
			OfChannel (obj(ixnetwork_restpy.multivalue.Multivalue)): The OF Channel to which the group belongs.
	...
	def Meters(self, Active=None, Advertise=None, Count=None, DescriptiveName=None, Flags=None, MeterDesc=None, MeterId=None, Multiplier=None, Name=None, NumberOfBands=None):
		...
		Args:
			Active (obj(ixnetwork_restpy.multivalue.Multivalue)): Activate/Deactivate Configuration
			Advertise (obj(ixnetwork_restpy.multivalue.Multivalue)): When this check box is cleared, no meter is advertised when the OpenFlow channel comes up or when the Enable check box is selected or cleared.
			Count (number): Number of elements inside associated multiplier-scaled container object, e.g. number of devices inside a Device Group
			DescriptiveName (str): Longer, more descriptive name for element. It's not guaranteed to be unique like -name-, but maybe offers more context
			Flags (obj(ixnetwork_restpy.multivalue.Multivalue)): Select the meter configuration flags from the list.
			MeterDesc (obj(ixnetwork_restpy.multivalue.Multivalue)): A description of the meter
			MeterId (obj(ixnetwork_restpy.multivalue.Multivalue)): The value by which a meter is uniquely identified .
			Multiplier (number): Number of instances per parent instance (multiplier)
			Name (str): Name of NGPF element, guaranteed to be unique in Scenario
	...
	def Tables(self, Active=None, Count=None, DescriptiveName=None, Name=None, NumberOfFlowSet=None, TableId=None, TableName=None):
		...
		Args:
			...
			TableId (obj(ixnetwork_restpy.multivalue.Multivalue)): Specify the controller table identifier. Lower numbered tables are consulted first.
			TableName (obj(ixnetwork_restpy.multivalue.Multivalue)): Specify the name of the controller table.
