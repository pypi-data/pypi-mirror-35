...
class IsisTrillRouter(Base):
	...
	def TrillMCastIpv4GroupList(self):
		"""Returns the one and only one TrillMCastIpv4GroupList object from the server.
		...
		return self._read(TrillMCastIpv4GroupList(self), None)

	@property
	def TrillMCastIpv6GroupList(self):
		"""Returns the one and only one TrillMCastIpv6GroupList object from the server.
		...
		return self._read(TrillMCastIpv6GroupList(self), None)

	@property
	def TrillMCastMacGroupList(self):
		"""Returns the one and only one TrillMCastMacGroupList object from the server.
		...
		return self._read(TrillMCastMacGroupList(self), None)

	@property
	def TrillTopologyList(self):
		"""Returns the one and only one TrillTopologyList object from the server.
		...
		return self._read(TrillTopologyList(self), None)
