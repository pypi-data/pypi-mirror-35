...
class Dhcpv6server(Base):
	...
	def Dhcp6ServerSessions(self):
		"""Returns the one and only one Dhcp6ServerSessions object from the server.
		...
		return self._read(Dhcp6ServerSessions(self), None)
	...
	def remove(self):
		"""Deletes a child instance of Dhcpv6server on the server.
