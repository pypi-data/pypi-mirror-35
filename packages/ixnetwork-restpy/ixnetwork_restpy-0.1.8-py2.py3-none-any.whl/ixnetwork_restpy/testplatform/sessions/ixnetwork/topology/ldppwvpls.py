...
class Ldppwvpls(Base):
	...
	def RestartDown(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('restartDown', child='mpls', payload=locals(), response_object=None)
	...
	def Start(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('start', child='mpls', payload=locals(), response_object=None)
	...
	def Stop(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('stop', child='mpls', payload=locals(), response_object=None)
