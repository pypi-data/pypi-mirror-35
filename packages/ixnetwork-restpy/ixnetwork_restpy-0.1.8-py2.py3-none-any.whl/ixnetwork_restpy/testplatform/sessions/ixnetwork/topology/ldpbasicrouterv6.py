...
class LdpBasicRouterV6(Base):
	...
	def ActivateLeafRange(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('activateLeafRange', child='ldpLeafRangeV6', payload=locals(), response_object=None)
	...
	def DeactivateLeafRange(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('deactivateLeafRange', child='ldpLeafRangeV6', payload=locals(), response_object=None)
