...
class Ethernet(Base):
	...
	def DotOneX(self, Active=None, CaCert=None, CertDir=None, CertificateKeySameFile=None, Count=None, DescriptiveName=None, FastInnerMethod=None, FastProMode=None, Faststateless=None, HostAuthMode=None, HostCert=None, HostKey=None, HostName=None, HostPwd=None, Multiplier=None, Name=None, ParentEth=None, PeerCert=None, PrivateKey=None, Protocol=None, RunTimeCertGen=None, SendCACertOnly=None, Status=None, TlsVersion=None, UserName=None, UserPwd=None, VerifyPeer=None, WaitId=None):
		...
		Args:
			Active (obj(ixnetwork_restpy.multivalue.Multivalue)): Activate/Deactivate Configuration
			CaCert (obj(ixnetwork_restpy.multivalue.Multivalue)): The CA certificate to be used
			CertDir (obj(ixnetwork_restpy.multivalue.Multivalue)): The location to the saved certificates
			CertificateKeySameFile (obj(ixnetwork_restpy.multivalue.Multivalue)): flag to determine whether to use same Certificate file for both Private Key and User Certificate
			Count (number): Number of elements inside associated multiplier-scaled container object, e.g. number of devices inside a Device Group
			DescriptiveName (str): Longer, more descriptive name for element. It's not guaranteed to be unique like -name-, but maybe offers more context
			FastInnerMethod (obj(ixnetwork_restpy.multivalue.Multivalue)): FAST Inner Method
			FastProMode (obj(ixnetwork_restpy.multivalue.Multivalue)): FAST Provision Mode
			Faststateless (obj(ixnetwork_restpy.multivalue.Multivalue)): FAST Stateless Resume
			HostAuthMode (obj(ixnetwork_restpy.multivalue.Multivalue)): Host Authentication Mode
			HostCert (obj(ixnetwork_restpy.multivalue.Multivalue)): The Peer certificate to be used by the host
			HostKey (obj(ixnetwork_restpy.multivalue.Multivalue)): The private key certificate to be used by the host
			HostName (obj(ixnetwork_restpy.multivalue.Multivalue)): Credential of the host for authentication
			HostPwd (obj(ixnetwork_restpy.multivalue.Multivalue)): Password of the host for authentication
			Multiplier (number): Number of layer instances per parent instance (multiplier)
			Name (str): Name of NGPF element, guaranteed to be unique in Scenario
			ParentEth (str(None|/api/v1/sessions/1/ixnetwork/topology?deepchild=*)): 
			PeerCert (obj(ixnetwork_restpy.multivalue.Multivalue)): The Peer certificate to be used
			PrivateKey (obj(ixnetwork_restpy.multivalue.Multivalue)): The private key certificate to be used
			Protocol (obj(ixnetwork_restpy.multivalue.Multivalue)): protocol for authentication
			RunTimeCertGen (obj(ixnetwork_restpy.multivalue.Multivalue)): Generate Certificate during Run time. Configure details in Global parameters. Common Name will be User Name. Certificate and Key file names will be generated based on corresponding Client User name. Eg: If Client User name is IxiaUser1 then Certificate File will be IxiaUser1.pem, Key File will be IxiaUser1_key.pem, CA certificate File will be root.pem
			SendCACertOnly (obj(ixnetwork_restpy.multivalue.Multivalue)): Use this option to send CA Certificate only to Port. Eg: For PEAPv0/v1 case there is no need to send User Certificate to port.
			Status (str(configured|error|mixed|notStarted|started|starting|stopping)): Running status of associated network element. Once in Started state, protocol sessions will begin to negotiate.
			TlsVersion (obj(ixnetwork_restpy.multivalue.Multivalue)): TLS version selecction
			UserName (obj(ixnetwork_restpy.multivalue.Multivalue)): Credential of the user for authentication
			UserPwd (obj(ixnetwork_restpy.multivalue.Multivalue)): Password of the user for authentication
			VerifyPeer (obj(ixnetwork_restpy.multivalue.Multivalue)): Verifies the provided peer certificate
			WaitId (obj(ixnetwork_restpy.multivalue.Multivalue)): When enabled, the supplicant does not send the initial EAPOL Start message. Instead, it waits for the authenticator (the DUT) to send an EAPOL Request / Identity message.
	...
	def RestartDown(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('restartDown', child='dotOneX', payload=locals(), response_object=None)
	...
	def Start(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('start', child='dotOneX', payload=locals(), response_object=None)
	...
	def Stop(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('stop', child='dotOneX', payload=locals(), response_object=None)
	...
	def RestartDown(self, Arg1):
		...
		Args:
			Arg1 (list(str[None|/api/v1/sessions/1/ixnetwork/topology])): This parameter requires a list of /topology/./lightweightDhcpv6relayAgent object references

		Raises:
			NotFoundError: The requested resource does not exist on the server
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('restartDown', child='lightweightDhcpv6relayAgent', payload=locals(), response_object=None)
	...
	def Start(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('start', child='lightweightDhcpv6relayAgent', payload=locals(), response_object=None)
	...
	def Stop(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('stop', child='lightweightDhcpv6relayAgent', payload=locals(), response_object=None)
	...
	def RestartDown(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('restartDown', child='pppoxclient', payload=locals(), response_object=None)
	...
	def Start(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('start', child='pppoxclient', payload=locals(), response_object=None)
	...
	def Stop(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('stop', child='pppoxclient', payload=locals(), response_object=None)
	...
	def RestartDown(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('restartDown', child='pppoxserver', payload=locals(), response_object=None)
	...
	def Start(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('start', child='pppoxserver', payload=locals(), response_object=None)
	...
	def Stop(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('stop', child='pppoxserver', payload=locals(), response_object=None)
