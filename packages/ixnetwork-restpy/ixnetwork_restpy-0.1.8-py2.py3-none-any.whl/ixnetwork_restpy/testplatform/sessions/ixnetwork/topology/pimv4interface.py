...
class PimV4Interface(Base):
	...
	def Start(self, Arg1):
		...
		Args:
			Arg1 (list(str[None|/api/v1/sessions/1/ixnetwork/topology])): This parameter requires a list of /topology/./pimV4CandidateRPsList object references

		Raises:
			NotFoundError: The requested resource does not exist on the server
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('start', child='pimV4CandidateRPsList', payload=locals(), response_object=None)
	...
	def Stop(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('stop', child='pimV4CandidateRPsList', payload=locals(), response_object=None)
	...
	def Join(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('join', child='pimV4JoinPruneList', payload=locals(), response_object=None)
	...
	def Leave(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('leave', child='pimV4JoinPruneList', payload=locals(), response_object=None)
	...
	def ResumePeriodicJoin(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('resumePeriodicJoin', child='pimV4JoinPruneList', payload=locals(), response_object=None)
	...
	def StopPeriodicJoin(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('stopPeriodicJoin', child='pimV4JoinPruneList', payload=locals(), response_object=None)
	...
	def Start(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('start', child='pimV4SourcesList', payload=locals(), response_object=None)
	...
	def Stop(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('stop', child='pimV4SourcesList', payload=locals(), response_object=None)
