...
class BgpSRTEPoliciesSegmentListV6(Base):
	...
	def BgpSRTEPoliciesSegmentsCollectionV6(self):
		"""Returns the one and only one BgpSRTEPoliciesSegmentsCollectionV6 object from the server.
		...
		return self._read(BgpSRTEPoliciesSegmentsCollectionV6(self), None)
