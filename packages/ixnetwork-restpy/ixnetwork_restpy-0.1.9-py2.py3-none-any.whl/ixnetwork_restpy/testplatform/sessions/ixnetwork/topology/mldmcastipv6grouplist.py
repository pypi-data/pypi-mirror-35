...
class MldMcastIPv6GroupList(Base):
	...
	def MldJoinSource(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('mldJoinSource', child='mldUcastIPv6SourceList', payload=locals(), response_object=None)
	...
	def MldLeaveSource(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('mldLeaveSource', child='mldUcastIPv6SourceList', payload=locals(), response_object=None)
