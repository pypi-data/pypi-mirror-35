...
class BgpSRTEPoliciesSegmentListV4(Base):
	...
	def BgpSRTEPoliciesSegmentsCollectionV4(self):
		"""Returns the one and only one BgpSRTEPoliciesSegmentsCollectionV4 object from the server.
		...
		return self._read(BgpSRTEPoliciesSegmentsCollectionV4(self), None)
