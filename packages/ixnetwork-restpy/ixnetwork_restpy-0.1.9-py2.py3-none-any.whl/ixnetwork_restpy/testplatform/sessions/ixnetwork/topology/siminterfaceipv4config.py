...
class SimInterfaceIPv4Config(Base):
	...
	def Disconnect(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('disconnect', child='ospfPseudoInterface', payload=locals(), response_object=None)
	...
	def Reconnect(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('reconnect', child='ospfPseudoInterface', payload=locals(), response_object=None)
	...
	def Start(self, Targets):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('start', child='ospfPseudoInterface', payload=locals(), response_object=None)
	...
	def Stop(self, Targets):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('stop', child='ospfPseudoInterface', payload=locals(), response_object=None)
