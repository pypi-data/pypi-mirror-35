...
class IgmpMcastIPv4GroupList(Base):
	...
	def IgmpJoinSource(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('igmpJoinSource', child='igmpUcastIPv4SourceList', payload=locals(), response_object=None)
	...
	def IgmpLeaveSource(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('igmpLeaveSource', child='igmpUcastIPv4SourceList', payload=locals(), response_object=None)
