...
class PccGroup(Base):
	...
	def ReturnDelegation(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('returnDelegation', child='pcReplyLspParameters', payload=locals(), response_object=None)
	...
	def ReturnDelegation(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('returnDelegation', child='pceInitiateLSPParameters', payload=locals(), response_object=None)
	...
	def TakeControl(self, Arg1):
		...
		Raises:
			...
			ServerError: The server has encountered an uncategorized error condition
		"""
		return self._execute('takeControl', child='pceInitiateLSPParameters', payload=locals(), response_object=None)
