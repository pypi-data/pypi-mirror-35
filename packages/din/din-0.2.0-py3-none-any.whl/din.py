...
class _ReprFormatter:
    ...
    def _format_default_repr_obj(self, obj: typing.Any, *, indent: str) -> str:
        ...
        non_callable = tuple(a for a in public_attributes if not callable(getattr(obj, a)))
        # Data to represent
        attributes = {k: getattr(obj, k) for k in non_callable}
        # Lines
