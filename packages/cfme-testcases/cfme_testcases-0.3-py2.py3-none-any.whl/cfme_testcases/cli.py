...
from cfme_testcases import cli_requirements, cli_testcases, cli_utils, consts, filters
...
def main(args=None):
    ...
    dump2polarion_config = (
        configuration.get_config(args.dump2polarion_config) if args.dump2polarion_config else None
    )
    ...
    try:
        requirements_root = cli_requirements.get_requirements_xml_root(dump2polarion_config)
        requirements_mapping = cli_requirements.get_requirements_mapping(
            args, submit_args, dump2polarion_config, requirements_root
        )
        ...
        if args.use_svn:
            ...
            missing = cli_testcases.get_missing_from_log(
                args, submit_args, dump2polarion_config, testsuite_root
            )
        ...
        cli_testcases.submit_filtered_xmls(args, submit_args, dump2polarion_config, filtered_xmls)
