...
class LogManager(object):
    ...
    def get_logger_and_add_handlers(self, log_level_int=1, is_add_stream_handler=True, log_path=get_logs_dir_by_folder_name('/app/'), log_filename=None, log_file_size=100, mongo_url=None,
