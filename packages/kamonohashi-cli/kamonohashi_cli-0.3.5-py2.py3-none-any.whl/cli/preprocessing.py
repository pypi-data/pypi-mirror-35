...
@click.option('--no-create-history', is_flag=True, help='Do not create history. Use existing one.')
...
@click.pass_obj
def build_history(api, id, data_id, source, no_create_history, memo, tags):
    """
    :param kamonohashi.PreprocessingApi api:
    """
    if not no_create_history:
