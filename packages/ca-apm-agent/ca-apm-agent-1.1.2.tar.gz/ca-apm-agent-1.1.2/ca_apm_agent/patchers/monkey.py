...
class Patcher:
    ...
    def patch(self):
        ...
        while i < len(self.to_instrument):
            ...
            if not conf_dict[PATCHED]:
                ...
                __builtin__.__import__ = import_hook._wily_import_orig__
                probe_list = []
                for k in conf_dict[PROBE_KEYS]:
                    if not self.probe_dict[k][LOADED]:
                        ...
                        probe_list.append(self.probe_dict[k][LOADED])
                __builtin__.__import__ = import_hook.wily_import_hook
    ...
    def patch_method(self, target_class, target_func, probe_list):
        for i in xrange(0, len(probe_list)):
        ...
        def function_template(*args, **kwargs):
            ...
            try:
                ...
                if hasattr(context, 'e'):
                    raise context.e, context.v, context.tb
                else:
                    return context.res
