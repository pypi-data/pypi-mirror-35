...
class Data:
    ...
    def _create_conn_msg(self):
        from constants import OP, DATA_CONN, PROBE, PYTHON, VER, ARF_VER, INSTID, PID
        from ca_apm_agent.utils import json_helpers
    ...
    def create_data_func_call_msg(pid, tid, seq, func_name=None, func_id=None, params=None):
        from constants import OP, FUNCTION_CALL, FUNCTION_NAME, FUNCTION_ID, TIMESTAMP, PID, TID, PRMS, SEQ
        from ca_apm_agent.utils import json_helpers
        l = [(OP, FUNCTION_CALL)]
    ...
    def create_data_func_return_msg(pid, tid, cseq, exception_dict=None):
        from constants import OP, FUNCTION_RET, TIMESTAMP, PID, TID, CSEQ, EXCEPTION
        from ca_apm_agent.utils import json_helpers
        l = [(OP, FUNCTION_RET)]
