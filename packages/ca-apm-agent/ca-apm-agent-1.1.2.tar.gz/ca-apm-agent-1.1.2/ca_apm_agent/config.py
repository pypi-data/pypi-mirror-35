...
from global_constants import CA_APM_PYTHON_ACFG, ACFG_MTIME, PRINT_PREFIX, LOGGER_NAME
...
def read_instrument_cfg(cfg, fn):
    ...
    from patchers.constants import MODULE, CLASS, METHOD, PROBE_CLASS, PROBE_MODULE, PROBE_KEYS, PATCHED, LOADED
        ...
        while True:
            if agent_object.acfg_mtime != os.path.getmtime(os.environ[CA_APM_PYTHON_ACFG]):
                ...
                if cfg is None:
                    ...
                    configure_logger(agent_object.log,str(os.getpid()))
