...
class CognitoController(object):
    ...
    def get(self, attribute_name, request, json_parse=False):
        ...
        if self.debug:
            header_value = '{"claims": {"custom:fullName": "local_user", "cognito:username": "local_user", "email": "local_user@lantern.tech", "email_verified": true}, "Authorization": ["Bearer eyJraWQiOiJ0U1p"]}'
        else:
