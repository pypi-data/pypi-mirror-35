...
class TestNewSwitch(BaseFrame):
    ...
    def __init__(self,
        ...
        self.label_1 = Label(value="Value:{state}".format(state=self.switch_1.switched_on),
        ...
        self.label_2 = Label(value="Value:{state}".format(state=self.switch_2.switched_on),
                             column=Position.NEXT)
        ...
        self.label_3 = Label(value="Value:{state}".format(state=self.switch_3.switched_on),
                             column=Position.NEXT)
