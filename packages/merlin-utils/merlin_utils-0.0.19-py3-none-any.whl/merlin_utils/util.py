...
def build_statistic_event(event, id_user, role, id_receptor=None, id_job=None, extra_params=None):
    ...
    if id_receptor:
        id_receptor_name = "idUserCandidate " if role == "Candidate" else "idUserEmployer"
...
def emails_substitutions(substitutions, id_user):
    emails_substitutions = {
        ...
        "https://www.merlinjobs.com/": "https://www.merlinjobs.com/" if PROJECT_ID == "merlin-pro" else "https"
                                                                                                        "://merlin-qa."
                                                                                                        "appspot.com/ ",
        **substitutions
    }
    return emails_substitutions
