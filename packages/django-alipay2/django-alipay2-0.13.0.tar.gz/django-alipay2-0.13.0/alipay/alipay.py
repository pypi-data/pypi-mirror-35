...
class AlipayClient(object):
    ...
    def create_pay_url(self, service, out_trade_no, subject, body, total_fee, notify_url, return_url,
    ...
    def create_direct_pay_url(self, out_trade_no, subject, body, total_fee, notify_url, return_url,
                              show_url=None, expire='15m', **kwargs):
        return self.create_pay_url(self.SERVICE_DIRECT, out_trade_no, subject, body, total_fee, notify_url, return_url,
    ...
    def create_wap_pay_url(self, out_trade_no, subject, body, total_fee, notify_url, return_url,
                           show_url=None, expire='15m', **kwargs):
        return self.create_pay_url(self.SERVICE_WAP, out_trade_no, subject, body, total_fee, notify_url, return_url,
                                   show_url, expire, **kwargs)
