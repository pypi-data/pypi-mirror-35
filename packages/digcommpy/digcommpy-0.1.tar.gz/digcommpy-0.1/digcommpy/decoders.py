...
#    def _train_system(self, training_code, training_info, training_info_bit,
#                      neurons=[(100, 'sigm')], **kwargs):
#        _shapes = {"inputs": self.code_length,
#                   "outputs": self.info_length}
#        kwargs.update(_shapes)
#        _decoder = self._create_decoder(ELM, **kwargs)
#        for _neurons in neurons:
#            _decoder.add_neurons(*_neurons)
#        _decoder.train(training_code, training_info_bit)
...
class NeuralNetDecoder(MachineLearningDecoder):
    ...
    kwargs : keyword arguments
        ...
        method.
    """
    def __init__(self, code_length, info_length, layer,
    ...
    def _train_system(self, training_code, training_info, training_info_bit,
        ...
        #decoder, train_model = self.decoder
